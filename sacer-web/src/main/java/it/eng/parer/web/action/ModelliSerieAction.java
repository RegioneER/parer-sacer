...
public class ModelliSerieAction extends ModelliSerieAbstractAction {
    ...
    private static final Logger log = LoggerFactory.getLogger(ModelliSerieAction.class);
            ...
            if (getNavigationEvent().equals(ListAction.NE_DETTAGLIO_VIEW)
                ...
                if (getTableName().equals(getForm().getModelliTipiSerieList().getName())) {
                    ...
                    loadDettaglioModello(currentRow.getIdModelloTipoSerie());
                        ...
                        .equals(getForm().getNoteModelloTipoSerieList().getName())) {
                    ...
                    getForm().getNoteModelloTipoSerieDetail().getId_tipo_nota_serie()
                            .setDecodeMap(DecodeMap.Factory.newInstance(
                                    tipoSerieEjb.getDecTipoNotaSerieTableBean(null),
                    ...
                    if (idModelloTipoSerie != null) {
                        getForm().getFiltriDatiSpecList().getTi_oper()
                                .setDecodeMap(ComboGetter.getMappaSortedGenericEnum("operatore",
                                        CostantiDB.TipoOperatoreDatiSpec.values()));
                        BigDecimal idTipoUnitaDoc = getForm().getModelliTipiSerieDetail()
                                .getId_tipo_unita_doc_dati_spec().parse();
                        BigDecimal idTipoDoc = getForm().getModelliTipiSerieDetail()
                                .getId_tipo_doc_dati_spec().parse();
                        getForm().getFiltriDatiSpecList()
                                .setTable(modelliSerieEjb.getDecModelloFiltroSelUdattbTableBean(
                                        idModelloTipoSerie, idTipoUnitaDoc, idTipoDoc));
    ...
    private void loadDettaglioModello(BigDecimal idModelloTipoSerie)
        ...
        getForm().getNoteModelloTipoSerieList().setTable(modelliSerieEjb
                .getDecNotaModelloTipoSerieTableBean(detailRow.getIdModelloTipoSerie()));
        getForm().getNoteModelloTipoSerieList().getTable()
                .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        getForm().getNoteModelloTipoSerieList().getTable().first();

        getForm().getRegoleRapprList().setTable(
                modelliSerieEjb.getDecModelloOutSelUdTableBean(detailRow.getIdModelloTipoSerie()));
        getForm().getRegoleRapprList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        getForm().getRegoleRapprList().getTable().first();
        // Se sono state già inserite tutte le regole di rappresentazione allora nasconde il bottone
        // di insert
        getForm().getRegoleRapprList()
                .setHideInsertButton(getForm().getRegoleRapprList().getTable()
                        .size() == CostantiDB.TipoDiRappresentazione
                                .getComboTipoDiRappresentazione().length);

        getForm().getRegoleFiltraggioList().setTable(modelliSerieEjb
                .getDecModelloFiltroTiDocSingleRowTableBean(detailRow.getIdModelloTipoSerie()));
        ...
        if (detailRow.getTiRglFiltroTiDoc()
        ...
        getForm().getDatiSpecList().setTable(modelliSerieEjb
                .getDecModelloFiltroSelUdattbTableBean(detailRow.getIdModelloTipoSerie()));
        getForm().getDatiSpecList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        getForm().getDatiSpecList().getTable().first();

        getForm().getRegoleAcquisizioneList().setTable(modelliSerieEjb
                .getDecModelloCampoInpUdTableBean(detailRow.getIdModelloTipoSerie()));
        getForm().getRegoleAcquisizioneList().getTable()
                .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        ...
        getForm().getStrutModelloList().setTable(modelliSerieEjb
                .getDecUsoModelloTipoSerieTableBean(detailRow.getIdModelloTipoSerie()));
    ...
    private void initModelloSerieDetail() {
        ...
        getForm().getModelliTipiSerieDetail().getTi_rgl_cd_serie()
                .setDecodeMap(ComboGetter.getMappaSortedGenericEnum(
                        ModelliTipiSerieDetail.ti_rgl_cd_serie.toLowerCase(),
        ...
        getForm().getModelliTipiSerieDetail().getTi_sel_ud()
                .setDecodeMap(ComboGetter.getMappaTiSelUd());
        getForm().getModelliTipiSerieDetail().getConserv_unlimited()
                .setDecodeMap(ComboGetter.getMappaGenericFlagSiNo());
        getForm().getModelliTipiSerieDetail().getFl_controllo_consist_obblig()
                .setDecodeMap(ComboGetter.getMappaGenericFlagSiNo());
        getForm().getModelliTipiSerieDetail().getFl_crea_autom()
                .setDecodeMap(ComboGetter.getMappaGenericFlagSiNo());
        getForm().getModelliTipiSerieDetail().getNi_transcoded_mm_crea_autom()
    ...
    public void insertDettaglio() throws EMFError {
        try {
            if (getTableName().equals(getForm().getModelliTipiSerieList().getName())) {
                ...
                getForm().getModelliTipiSerieDetail().getDt_soppres()
                        .setValue(ActionUtils.getStringDate(null));
                getForm().getModelliTipiSerieDetail().getTi_rgl_nm_tipo_serie().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_rgl_ds_tipo_serie().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_rgl_cd_serie().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_rgl_ds_serie().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_rgl_anni_conserv().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_rgl_conservazione_serie().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_rgl_range_anni_crea_autom().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_rgl_filtro_ti_doc().setValue(
                        CostantiDB.TipoRegolaModelloTipoSerie.DEFINITO_NEL_MODELLO.name());
                getForm().getModelliTipiSerieDetail().getTi_stato_ver_serie_autom()
                ...
                BigDecimal idAmbiente = getForm().getModelliTipiSerieDetail().getId_ambiente()
                        .parse();
                BigDecimal idModelloTipoSerie = getForm().getModelliTipiSerieDetail()
                        .getId_modello_tipo_serie().parse();
                getForm().getStrutModelloDetail().getId_modello_tipo_serie()
                        .setValue(idModelloTipoSerie.toPlainString());
                getForm().getStrutModelloDetail().getId_ambiente()
                        .setValue(idAmbiente.toPlainString());
                OrgEnteTableBean orgEnteTableBean = ambienteEjb.getEntiAbilitati(
                        getUser().getIdUtente(), idAmbiente.longValue(), Boolean.FALSE);
                getForm().getStrutModelloDetail().getNm_ente().setDecodeMap(
                        DecodeMap.Factory.newInstance(orgEnteTableBean, "id_ente", "nm_ente"));

                getForm().getStrutRicercateList().setTable(new OrgStrutTableBean());
                getForm().getStrutRicercateList().getTable()
                        .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                getForm().getStrutSelezionateList().setTable(new OrgStrutTableBean());
                getForm().getStrutSelezionateList().getTable()
                        .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
    ...
    // <editor-fold defaultstate="collapsed" desc="Salvataggio/Modifica/Elimina modello di tipo
    // serie">
                ...
                if (!getMessageBox().hasError()) {
                    ...
                    if (!getMessageBox().hasError()) {
                        ...
                        if (getForm().getModelliTipiSerieList().getStatus().equals(Status.insert)) {
                            ...
                            Long idModelloTipoSerie = modelliSerieEjb.saveModelloTipoSerie(param,
                                    creazioneBean);
                            if (idModelloTipoSerie != null) {
                        ...
                        } else if (getForm().getModelliTipiSerieList().getStatus()
                                .equals(Status.update)) {
                            param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                            BigDecimal idModelloTipoSerie = getForm().getModelliTipiSerieDetail()
                                    .getId_modello_tipo_serie().parse();
                            modelliSerieEjb.saveModelloTipoSerie(param, idModelloTipoSerie,
                                    creazioneBean);
                        }
                        BigDecimal idModelloTipoSerie = getForm().getModelliTipiSerieDetail()
                                .getId_modello_tipo_serie().parse();
    ...
    private void checkModelloTipoSerie() throws EMFError, ParerUserError {
        log.debug("Eseguo i controlli sul salvataggio del modello");
        ...
        DecModelloTipoSerieRowBean tmpRow = modelliSerieEjb.getDecModelloTipoSerieRowBean(nmModello,
                idAmbiente);
        if (idModelloUpdate != null) {
            if (tmpRow != null && !idModelloUpdate.equals(tmpRow.getIdModelloTipoSerie())) {
                throw new ParerUserError(
                        "Il nome del modello di tipo serie \u00E8 gi\u00E0 presente nell'ambiente");
            }
        } else if (tmpRow != null) {
            throw new ParerUserError(
                    "Il nome del modello di tipo serie \u00E8 gi\u00E0 presente nell'ambiente");
        ...
        if (tiRglCdSerie.equals(CostantiDB.TipoRegolaModelloTipoSerie.EREDITA_DA_TIPO_UD_REG.name())
            ...
            if (!CD_SERIE_PATTERN.matcher(cdSerie).matches()) {
                throw new ParerUserError(
                        "Caratteri consentiti per il codice serie: lettere, numeri,.,-,_,: ");
            }
        }
        ...
        if (tiRglAnniConserv.equals(CostantiDB.TipoRegolaModelloTipoSerie.EREDITA_DA_REG.name())
            ...
            if (StringUtils.isBlank(conservUnlimited) && niAnniConserv == null) {
                ...
                if (conservUnlimited != null && niAnniConserv != null) {
                    if ((conservUnlimited.equals("1")
                            && !niAnniConserv.equals(new BigDecimal(9999)))
                            || ((conservUnlimited.equals("0")
                                    && niAnniConserv.equals(new BigDecimal(9999))))) {
                        error = true;
                    }
                }
                if ((niAnniConserv == null && StringUtils.isBlank(conservUnlimited))
                        || ((conservUnlimited != null && conservUnlimited.equals("0")
                                && niAnniConserv == null))) {
                    error = true;
                }
                if (error) {
        ...
        String tiRglRangeAnniCreaAutom = modelliTipiSerieDetail.getTi_rgl_range_anni_crea_autom()
                .parse();
    ...
    public void updateModelliTipiSerieList() throws EMFError {
        ...
        utile.triggerAmbienteGenerico(getForm().getModelliTipiSerieDetail(),
                getUser().getIdUtente(), Boolean.FALSE);
            ...
            try {
                if (tipoSerieEjb.existDecTipoSerieForIdModello(idModelloTipoSerie)) {
                    ...
                    if (param.getNomePagina()
                            .equalsIgnoreCase(Application.Publisher.MODELLO_SERIE_DETAIL)) {
                ...
                getMessageBox().addError(
                        "Il modello non pu\u00F2 essere eliminato: " + ex.getDescription());
            }
        }
        if (!getMessageBox().hasError()
                && getLastPublisher().equals(Application.Publisher.MODELLO_SERIE_DETAIL)) {
            goBack();
        } else {
            forwardToPublisher(getLastPublisher());
        }
    ...
    // <editor-fold defaultstate="collapsed" desc="Salvataggio/Modifica/Elimina note modello di tipo
    // serie">
    private void saveNotaModelloTipoSerie() throws EMFError {
        log.debug("Eseguo i controlli sul salvataggio della nota del modello");
        BigDecimal idModelloTipoSerie = getForm().getModelliTipiSerieDetail()
                .getId_modello_tipo_serie().parse();
        if (getForm().getNoteModelloTipoSerieDetail().postAndValidate(getRequest(),
                getMessageBox())) {
            BigDecimal idTipoNotaSerie = getForm().getNoteModelloTipoSerieDetail()
                    .getId_tipo_nota_serie().parse();
            BigDecimal pgNota = getForm().getNoteModelloTipoSerieDetail().getPg_nota_tipo_serie()
                    .parse();
            String dsNota = getForm().getNoteModelloTipoSerieDetail().getDs_nota_tipo_serie()
                    .parse();
            Date dtNota = new Date(getForm().getNoteModelloTipoSerieDetail().getDt_nota_tipo_serie()
                    .parse().getTime());
            try {
                int rowIndex = getForm().getNoteModelloTipoSerieList().getTable()
                        .getCurrentRowIndex();
                /*
                 * Codice aggiuntivo per il logging...
                 */
                ...
                if (getForm().getNoteModelloTipoSerieList().getStatus().equals(Status.insert)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarInsert());
                    BigDecimal idNota = modelliSerieEjb.saveNotaModelloTipoSerie(param,
                            getUser().getIdUtente(), idModelloTipoSerie, idTipoNotaSerie, pgNota,
                            dsNota, dtNota);
                    if (idNota != null) {
                ...
                } else if (getForm().getNoteModelloTipoSerieList().getStatus()
                        .equals(Status.update)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                    BigDecimal idNota = getForm().getNoteModelloTipoSerieDetail()
                            .getId_nota_modello_tipo_serie().parse();
                    modelliSerieEjb.saveNotaModelloTipoSerie(param, idNota, dsNota,
                            getUser().getIdUtente(), dtNota);
                }
                ...
                getMessageBox().addError("L'elemento di descrizione non pu\u00F2 essere salvato: "
                        + ex.getDescription());
            }
            // Salvataggio nota
            if (!getMessageBox().hasError()) {
    ...
    @Override
    public JSONObject triggerNoteModelloTipoSerieDetailId_tipo_nota_serieOnTrigger()
            throws EMFError {
        ...
        if (idTipoNotaSerie != null) {
            BigDecimal lastPgNota = modelliSerieEjb.getMaxPgNotaModelloTipoSerie(idModelloTipoSerie,
                    idTipoNotaSerie);
            ...
            getForm().getNoteModelloTipoSerieDetail().getPg_nota_tipo_serie()
    ...
    public void deleteNoteModelloTipoSerieList() throws EMFError {
        ...
        if (getLastPublisher().equals(Application.Publisher.NOTA_MODELLO_SERIE_DETAIL)) {
            if (!idNota.equals(getForm().getNoteModelloTipoSerieDetail()
                    .getId_nota_modello_tipo_serie().parse())) {
                getMessageBox().addError(
        ...
        if (!getMessageBox().hasError() && idNota != null) {
            try {
                ...
                param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
                if (param.getNomePagina()
                        .equalsIgnoreCase(Application.Publisher.NOTA_MODELLO_SERIE_DETAIL)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
                } else {
                    param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(getForm(),
                ...
                getMessageBox().addError("L'elemento di descrizione non pu\u00F2 essere eliminato: "
                        + ex.getDescription());
            }
        }
        if (!getMessageBox().hasError()
                && getLastPublisher().equals(Application.Publisher.NOTA_MODELLO_SERIE_DETAIL)) {
            goBack();
        } else {
            forwardToPublisher(getLastPublisher());
        }
    ...
    // <editor-fold defaultstate="collapsed" desc="Salvataggio/Modifica/Elimina regole acquisizione
    // modello di tipo
    // serie">
    private void editRegoleAcquisizione(Status status) throws EMFError, ParerUserError {
        ...
        BigDecimal idModelloTipoSerie = getForm().getModelliTipiSerieDetail()
                .getId_modello_tipo_serie().parse();
        if (idModelloTipoSerie != null) {
            getForm().getDatiProfiloList()
                    .setTable(modelliSerieEjb.getDecModelloCampoInpUdTableBean(idModelloTipoSerie,
            ...
            if (idTipoUnitaDoc != null) {
                ...
                getForm().getAttributiTipoUnitaDocList()
                        .setTable(modelliSerieEjb.getDecModelloCampoInpUdDatiSpecTableBean(
                                idModelloTipoSerie, idTipoUnitaDoc,
                                CostantiDB.TipoCampo.DATO_SPEC_UNI_DOC.name()));
                getForm().getAttributiTipoUnitaDocList().getTable().setPageSize(300);
                getForm().getAttributiTipoUnitaDocList().getFl_tipo_ud_selezionato()
                        .setHidden(true);
                getForm().getAttributiTipoUnitaDocList().getFl_tipo_ud_selezionato().setViewMode();
                getForm().getAttributiTipoUnitaDocList().getPg_ord_campo_unita_doc()
                        .setHidden(false);
            ...
            BigDecimal idTipoDoc = getForm().getModelliTipiSerieDetail().getId_tipo_doc_dati_spec()
                    .parse();
            if (idTipoDoc != null) {
    ...
    private void saveRegoleModelloAcquisizione() throws EMFError {
        log.debug("Eseguo i controlli sul salvataggio della regola del modello");
        BigDecimal idModelloTipoSerie = getForm().getModelliTipiSerieDetail()
                .getId_modello_tipo_serie().parse();
        ...
        String[] pgOrdDatiSpecUniDoc = getRequest().getParameterValues(
                getForm().getAttributiTipoUnitaDocList().getPg_ord_campo_unita_doc().getName());
        String[] tiTrasformDatiSpecUniDoc = getRequest().getParameterValues(getForm()
                .getAttributiTipoUnitaDocList().getTi_trasform_campo_unita_doc().getName());
        String[] pgOrdDatiSpecDoc = getRequest().getParameterValues(
                getForm().getAttributiTipoDocList().getPg_ord_campo_doc().getName());
        String[] tiTrasformDatiSpecDoc = getRequest().getParameterValues(
                getForm().getAttributiTipoDocList().getTi_trasform_campo_doc().getName());
    ...
    private void checkRegoleAcquisizione(DecModelloCampoInpUdTableBean table, String[] pgOrdTable,
            String[] tiTrasformTable, DecModelloCampoInpUdTableBean fillingTable,
            Set<String> pgOrds, String tiCampo) {
        // Scorro ogni record
    ...
    public void deleteRegoleAcquisizioneList() throws EMFError {
        DecModelloCampoInpUdRowBean currentRow = (DecModelloCampoInpUdRowBean) getForm()
                .getRegoleAcquisizioneList().getTable().getCurrentRow();
        ...
        if (!getMessageBox().hasError() && idModelloCampoInpUd != null) {
            try {
                ...
                getMessageBox().addError("La regola di acquisizione non pu\u00F2 essere eliminata: "
                        + ex.getDescription());
            }
        }
        forwardToPublisher(getLastPublisher());
    ...
    // <editor-fold defaultstate="collapsed" desc="Salvataggio/Modifica/Elimina regole filtraggio
    // doc principale modello
    // di tipo serie">
    private void initRegoleFiltraggioDetail(BigDecimal idModelloTipoSerie)
            throws EMFError, ParerUserError {
        if (idModelloTipoSerie != null) {
            BaseTableInterface ambienteTableBean = ambienteEjb.getAmbientiAbilitatiPerStrut(
                    getUser().getIdUtente(),
            ...
            getForm().getRegoleFiltraggioDetail().getNm_tipo_doc_dati_spec()
                    .setDecodeMap(DecodeMap.Factory.newInstance(decModelloFiltroTiDocTableBean,
                            "nm_tipo_doc", "nm_tipo_doc"));
            getForm().getRegoleFiltraggioDetail().getNm_tipo_doc_dati_spec()
                    .setValues(toList.toArray(new String[toList.size()]));
            getForm().getRegoleFiltraggioDetail().getId_ambiente().setDecodeMap(
                    DecodeMap.Factory.newInstance(ambienteTableBean, "id_ambiente", "nm_ambiente"));
            getForm().getRegoleFiltraggioDetail().getId_ambiente().setValue(
                    getForm().getModelliTipiSerieDetail().getId_ambiente().parse().toPlainString());
            getForm().getRegoleFiltraggioDetail().getNm_ambiente().setValue(
                    getForm().getModelliTipiSerieDetail().getId_ambiente().getDecodedValue());

            ActionUtils utile = new ActionUtils();
            utile.triggerAmbienteGenerico(getForm().getRegoleFiltraggioDetail(),
                    getUser().getIdUtente(), Boolean.FALSE);
    ...
    private void saveRegoleModelloFiltraggio() throws EMFError {
        ...
        List<String> nmTipiDocs = getForm().getRegoleFiltraggioDetail().getNm_tipo_doc_dati_spec()
                .parse();
        try {
            /*
             * Codice aggiuntivo per il logging...
    ...
    public void deleteRegoleFiltraggioList() throws EMFError {
        ...
        try {
            ...
            LogParam param = SpagoliteLogUtil.getLogParam(
                    ...
                    getUser().getUsername(), SpagoliteLogUtil.getPageName(this),
                    SpagoliteLogUtil.getDetailActionNameDelete(getForm(),
                            getForm().getRegoleFiltraggioList()));
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
    ...
    // <editor-fold defaultstate="collapsed" desc="Salvataggio/Modifica/Elimina dati specifici
    // modello di tipo serie">
    private void saveDatiSpecificiModello() throws EMFError {
        log.debug("Eseguo i controlli sul salvataggio dei dati specifici del modello");
        BigDecimal idModelloTipoSerie = getForm().getModelliTipiSerieDetail()
                .getId_modello_tipo_serie().parse();
        String[] tiOper = getRequest()
                .getParameterValues(getForm().getFiltriDatiSpecList().getTi_oper().getName());
        String[] dlValore = getRequest()
                .getParameterValues(getForm().getFiltriDatiSpecList().getDl_valore().getName());
        ...
        try {
            ...
            if (tiOper != null) {
                for (int index = 0; index < tiOper.length; index++) {
                    ...
                    if (!getMessageBox().hasError() && (StringUtils.isNotBlank(tiOperCampo)
                            || StringUtils.isNotBlank(dlValoreCampo))) {
                ...
                if (!getMessageBox().hasError()) {
                    ...
                    modelliSerieEjb.saveDecModelloFiltroSelUdattb(param, idModelloTipoSerie,
                            datiCompilati);
                ...
                getMessageBox().addInfo(
                        "Nessuna modifica apportata in quando non erano presenti dati specifici");
            }
        } catch (ParerUserError ex) {
            getMessageBox().addError(ex.getDescription());
        }
    ...
    public void deleteDatiSpecList() throws EMFError {
        DecModelloFiltroSelUdattbRowBean currentRow = (DecModelloFiltroSelUdattbRowBean) getForm()
                .getDatiSpecList().getTable().getCurrentRow();
        ...
        if (!getMessageBox().hasError() && idModelloFiltroSelUdattb != null) {
            try {
                ...
                getMessageBox()
                        .addError("Il filtro sui dati specifici non pu\u00F2 essere eliminato: "
                                + ex.getDescription());
            }
        }
        forwardToPublisher(getLastPublisher());
    ...
    // <editor-fold defaultstate="collapsed" desc="Salvataggio/Modifica/Elimina regole
    // rappresentazione modello di tipo
    // serie">
    private void editRegoleRappresentazione(Status status) throws EMFError, ParerUserError {
        ...
        DecModelloOutSelUdTableBean table = (DecModelloOutSelUdTableBean) getForm()
        ...
        getForm().getRegoleRapprDetail().getId_modello_tipo_serie()
                .setValue(idModelloTipoSerie.toPlainString());
        if (status.equals(Status.update)) {
            DecModelloOutSelUdRowBean currentRow = (DecModelloOutSelUdRowBean) getForm()
                    .getRegoleRapprList().getTable().getCurrentRow();
            ...
            getForm().getRegoleRapprDetail().getTi_out().setDecodeMap(
                    DecodeMap.Factory.newInstance(regoleMancanti, "ti_out", "desc_ti_out"));
        }

        getForm().getDatiProfiloList().setTable(modelliSerieEjb.getDecModelloCampoOutSelUdTableBean(
                idModelloOutSelUd, CostantiDB.TipoCampo.DATO_PROFILO.name()));
        getForm().getDatiProfiloList().getTable().setPageSize(300);
        ...
        if (idTipoUnitaDoc != null) {
            ...
            getForm().getAttributiTipoUnitaDocList()
                    .setTable(modelliSerieEjb.getDecModelloCampoOutSelUdTableBean(idModelloOutSelUd,
        ...
        if (idTipoDoc != null) {
            ...
            getForm().getAttributiTipoDocList()
                    .setTable(modelliSerieEjb.getDecModelloCampoOutSelUdTableBean(idModelloOutSelUd,
                            idTipoDoc, CostantiDB.TipoCampo.DATO_SPEC_DOC_PRINC.name()));
            getForm().getAttributiTipoDocList().getTable().setPageSize(300);
    ...
    private void saveRegoleModelloRappresentazione() throws EMFError {
        log.debug("Eseguo i controlli sul salvataggio della regola del modello");
        BigDecimal idModelloTipoSerie = getForm().getRegoleRapprDetail().getId_modello_tipo_serie()
                .parse();
        BigDecimal idModelloOutSelUd = getForm().getRegoleRapprDetail().getId_modello_out_sel_ud()
                .parse();
        if (getForm().getRegoleRapprDetail().postAndValidate(getRequest(), getMessageBox())) {
            ...
            String[] flSelezionatoDatiProfilo = ArrayUtils
                    .nullToEmpty(getRequest().getParameterValues(
                            getForm().getDatiProfiloList().getFl_selezionato().getName()));
            String[] flSelezionatoDatiSpecUniDoc = ArrayUtils
                    .nullToEmpty(getRequest().getParameterValues(getForm()
                            .getAttributiTipoUnitaDocList().getFl_tipo_ud_selezionato().getName()));
            String[] tiTrasformDatiSpecUniDoc = ArrayUtils.nullToEmpty(
                    getRequest().getParameterValues(getForm().getAttributiTipoUnitaDocList()
                            .getTi_trasform_campo_unita_doc().getName()));
            String[] flSelezionatoDatiSpecDoc = ArrayUtils
                    .nullToEmpty(getRequest().getParameterValues(getForm().getAttributiTipoDocList()
                            .getFl_tipo_doc_selezionato().getName()));
            String[] tiTrasformDatiSpecDoc = ArrayUtils.nullToEmpty(getRequest().getParameterValues(
                    getForm().getAttributiTipoDocList().getTi_trasform_campo_doc().getName()));
            ...
            try {
                ...
                int numeroTagSelezionati = flSelezionatoDatiProfilo.length
                        + flSelezionatoDatiSpecUniDoc.length + flSelezionatoDatiSpecDoc.length;
                if (numeroTagSelezionati == 0 && listaTagTextArea.isEmpty()) {
                    ...
                    // Se non sono stati selezionati attributi ma è stata popolata la textArea do
                    // errore
                    getMessageBox().addError(
                    ...
                    if (flSelezionatoDatiProfilo.length > 0) {
                        ...
                        tiTrasform = (tiTrasformDatiSpecUniDoc != null
                                && tiTrasformDatiSpecUniDoc.length > 0)
                                        ? tiTrasformDatiSpecUniDoc[0]
                                        : null;
                    } else {
                        flSelezionato = flSelezionatoDatiSpecDoc[0];
                        table = datiSpecTipoDocTable;
                        tiTrasform = (tiTrasformDatiSpecDoc != null
                                && tiTrasformDatiSpecDoc.length > 0) ? tiTrasformDatiSpecDoc[0]
                                        : null;
                    }
                    if (StringUtils.isNumeric(flSelezionato)) {
                        DecModelloCampoOutSelUdRowBean row = table
                                .getRow(Integer.parseInt(flSelezionato));
                    ...
                    // Eseguo i controlli regole su ogni tabella - DATI PROFILO, DATI SPEC TIPI UD e
                    // DATI SPEC TIPI DOC
                    // if (!getMessageBox().hasError()) {
                    checkRegolaRappresentazione(listaTagTextArea, listaTagAssentiTextArea, tiOut,
                            datiProfiloTable, flSelezionatoDatiProfilo, null, datiCompilati, true);
                    // }
                    // if (!getMessageBox().hasError()) {
                    checkRegolaRappresentazione(listaTagTextArea, listaTagAssentiTextArea, tiOut,
                            datiSpecTipoUdTable, flSelezionatoDatiSpecUniDoc,
                            tiTrasformDatiSpecUniDoc, datiCompilati, false);
                    // }
                    // if (!getMessageBox().hasError()) {
                    checkRegolaRappresentazione(listaTagTextArea, listaTagAssentiTextArea, tiOut,
                            datiSpecTipoDocTable, flSelezionatoDatiSpecDoc, tiTrasformDatiSpecDoc,
                            datiCompilati, false);
                    // }
                ...
                if (!getMessageBox().hasError()) {
                    ...
                    // DS_KEY_ORD_UD_SERIE deve avere
                    // lo stesso valore
                    DecModelloOutSelUdTableBean regoleRapprList = (DecModelloOutSelUdTableBean) getForm()
                            .getRegoleRapprList().getTable();
                    List<Object> tiOutList = regoleRapprList
                            .toList(DecModelloOutSelUdTableDescriptor.COL_TI_OUT);

                    int indexElement = -1;
                    String dlFormatoOutProgressivo = null;
                    String dlFormatoOutKeyOrd = null;
                    if (CostantiDB.TipoDiRappresentazione.DS_KEY_ORD_UD_SERIE.name()
                            .equals(tiOut)) {
                        if ((indexElement = tiOutList.indexOf(
                                CostantiDB.TipoDiRappresentazione.PG_UD_SERIE.name())) != -1) {
                        ...
                        if ((indexElement = tiOutList
                                .indexOf(CostantiDB.TipoDiRappresentazione.DS_KEY_ORD_UD_SERIE
                                        .name())) != -1) {
                            List<Object> dlFormatoOutList = regoleRapprList
                                    .toList(DecModelloOutSelUdTableDescriptor.COL_DL_FORMATO_OUT);
                ...
                if (!getMessageBox().hasError()) {
                    ...
                    if (getForm().getRegoleRapprDetail().getStatus().equals(Status.update)
                        ...
                        param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                        modelliSerieEjb.saveDecModelloOutSelUd(param, idModelloOutSelUd, tiOut,
                                dlFormatoOut, datiCompilati);
                    } else if (getForm().getRegoleRapprDetail().getStatus().equals(Status.insert)
                            && idModelloTipoSerie != null) {
                        param.setNomeAzione(SpagoliteLogUtil.getToolbarInsert());
                        modelliSerieEjb.saveDecModelloOutSelUd(param, tiOut, dlFormatoOut,
                                datiCompilati, idModelloTipoSerie);
                    } else {
                        throw new ParerUserError(
                                "Errore inaspettato nel salvataggio della regola di rappresentazione");
                    }
    ...
    private void checkRegolaRappresentazione(List<String> listaTagTextArea,
            List<String> listaTagAssentiTextArea, String tiOut,
            DecModelloCampoOutSelUdTableBean table, String[] flSelezionatoTable,
            String[] tiTrasformTable, DecModelloCampoOutSelUdTableBean datiCompilati,
            boolean datiProfilo) throws ParerUserError {
    ...
    private void checkCampoSelezionato(DecModelloCampoOutSelUdRowBean row, String tiOut,
            String tiTrasform, boolean datiProfilo) {
    ...
    public void deleteRegoleRapprList() throws EMFError {
        ...
        if (!getMessageBox().hasError() && idModelloOutSelUd != null) {
            try {
                ...
                getMessageBox()
                        .addError("La regola di rappresentazione non pu\u00F2 essere eliminata: "
                                + ex.getDescription());
            }
        }
        forwardToPublisher(getLastPublisher());
    ...
    // <editor-fold defaultstate="collapsed" desc="Salvataggio//Elimina associazioni strutture
    // modello di tipo serie">
    private void saveAssociazioniStrutturaModello() throws EMFError {
        if (!getForm().getStrutSelezionateList().getTable().isEmpty()) {
            BigDecimal idModelloTipoSerie = getForm().getStrutModelloDetail()
                    .getId_modello_tipo_serie().parse();
            try {
                if (idModelloTipoSerie != null) {
                    OrgStrutTableBean table = (OrgStrutTableBean) getForm()
                            .getStrutSelezionateList().getTable();
                    /*
                     * Codice aggiuntivo per il logging...
                     */
                    LogParam param = SpagoliteLogUtil.getLogParam(
                    ...
                    if (!getMessageBox().hasError()) {
                        getMessageBox().addInfo(
                                "Le strutture sono state aggiunte con successo al modello");
                        getMessageBox().setViewMode(ViewMode.plain);
                    ...
                    getMessageBox().addError(
                            "Errore inaspettato nell'aggiunta di strutture al modello: modello non presente");
                }
            } catch (ParerUserError ex) {
                getMessageBox().addError(ex.getDescription());
            }
    ...
    public void deleteStrutModelloList() throws EMFError {
        DecUsoModelloTipoSerieRowBean currentRow = (DecUsoModelloTipoSerieRowBean) getForm()
                .getStrutModelloList().getTable().getCurrentRow();
        ...
        if (!getMessageBox().hasError() && idUsoModelloTipoSerie != null) {
            try {
                ...
                getMessageBox()
                        .addError("L'associazione alla struttura non pu\u00F2 essere eliminata: "
                                + ex.getDescription());
            }
        }
        forwardToPublisher(getLastPublisher());
    ...
    public void triggerModelliTipiSerieDetailId_enteOnTriggerJs() throws EMFError {
        ...
        ActionUtils utile = new ActionUtils();
        utile.triggerEnteGenerico(getForm().getModelliTipiSerieDetail(), getUser().getIdUtente(),
                Boolean.FALSE);
        ...
        if ((idStrut = getForm().getModelliTipiSerieDetail().getId_strut().parse()) != null) {
            getForm().getModelliTipiSerieDetail().getId_tipo_unita_doc_dati_spec_combo()
                    .setDecodeMap(
                            DecodeMap.Factory.newInstance(
                                    tipoUnitaDocEjb.getTipiUnitaDocAbilitati(
            ...
            getForm().getModelliTipiSerieDetail().getId_tipo_doc_dati_spec_combo()
                    .setDecodeMap(
                            DecodeMap.Factory.newInstance(
                                    tipoDocumentoEjb.getTipiDocPrincipaliAbilitati(
                                            getUser().getIdUtente(), idStrut),
    ...
    public void populateIdTipoUnitaDocDatiSpecOnTriggerJs() throws EMFError {
        getForm().getModelliTipiSerieDetail().getId_tipo_unita_doc_dati_spec()
                .setValue(getRequest().getParameter(getForm().getModelliTipiSerieDetail()
                        .getId_tipo_unita_doc_dati_spec().getName()));
        getForm().getModelliTipiSerieDetail().getNm_tipo_unita_doc_dati_spec()
                .setValue(getRequest().getParameter(getForm().getModelliTipiSerieDetail()
                        .getNm_tipo_unita_doc_dati_spec().getName()));
        redirectToAjax(getForm().getModelliTipiSerieDetail().asJSON());
    }

    public void populateIdTipoDocDatiSpecOnTriggerJs() throws EMFError {
        getForm().getModelliTipiSerieDetail().getId_tipo_doc_dati_spec()
                .setValue(getRequest().getParameter(getForm().getModelliTipiSerieDetail()
                        .getId_tipo_doc_dati_spec().getName()));
        getForm().getModelliTipiSerieDetail().getNm_tipo_doc_dati_spec()
                .setValue(getRequest().getParameter(getForm().getModelliTipiSerieDetail()
                        .getNm_tipo_doc_dati_spec().getName()));
        redirectToAjax(getForm().getModelliTipiSerieDetail().asJSON());
    }
    ...
    public void cercaTipoUd() throws EMFError {
        ...
        if (getForm().getModelliTipiSerieDetail().getId_ambiente().parse() == null) {
            ...
            getForm().getModelliTipiSerieDetail().getNm_ambiente().setValue(
                    getForm().getModelliTipiSerieDetail().getId_ambiente().getDecodedValue());
    ...
    // <editor-fold defaultstate="collapsed" desc="Gestione trigger inserimento/modifica regole di
    // filtraggio">
    @Override
    ...
    public void triggerRegoleFiltraggioDetailId_enteOnTriggerJs() throws EMFError {
        ...
        ActionUtils utile = new ActionUtils();
        utile.triggerEnteGenerico(getForm().getRegoleFiltraggioDetail(), getUser().getIdUtente(),
                Boolean.FALSE);
    ...
    public void populateIdTipoDocDatiSpecFiltraggioOnTriggerJs() throws EMFError {
        String nmTipoDoc = getRequest().getParameter(
                getForm().getRegoleFiltraggioDetail().getNm_tipo_doc_dati_spec().getName());
        Set<String> values = getForm().getRegoleFiltraggioDetail().getNm_tipo_doc_dati_spec()
                .getValues();
        ...
        getForm().getRegoleFiltraggioDetail().getNm_tipo_doc_dati_spec()
                .setDecodeMap(DecodeMap.Factory.newInstance(tb, "nm_tipo_doc_dati_spec",
                        "nm_tipo_doc_dati_spec"));
        getForm().getRegoleFiltraggioDetail().getNm_tipo_doc_dati_spec()
    ...
    public void cercaStrutture() throws EMFError {
        if (getForm().getStrutModelloDetail().postAndValidate(getRequest(), getMessageBox())) {
            ...
            if (!getMessageBox().hasError()) {
                try {
                    OrgStrutTableBean table = struttureEjb.getOrgStrutTableBean(
                            getUser().getIdUtente(), nmStrut, idEnte, idAmbiente,
                            idModelloTipoSerie, Boolean.FALSE);
                    getForm().getStrutRicercateList().setTable(table);
                    getForm().getStrutRicercateList().getTable().addSortingRule("nm_ente",
                            SortingRule.ASC);
                    getForm().getStrutRicercateList().getTable().addSortingRule("nm_strut",
                            SortingRule.ASC);
                    getForm().getStrutRicercateList().getTable()
                            .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                    ...
                    getForm().getStrutSelezionateList().setTable(new OrgStrutTableBean());
                    getForm().getStrutSelezionateList().getTable().addSortingRule("nm_ente",
                            SortingRule.ASC);
                    getForm().getStrutSelezionateList().getTable().addSortingRule("nm_strut",
                            SortingRule.ASC);
                    getForm().getStrutSelezionateList().getTable()
                            .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
    ...
    public void logEventi() throws EMFError {
        ...
        form.getOggettoDetail().getNm_tipo_oggetto()
                .setValue(SacerLogConstants.TIPO_OGGETTO_MODELLO_TIPO_SERIE);
        DecModelloTipoSerieRowBean rb = (DecModelloTipoSerieRowBean) getForm()
                .getModelliTipiSerieList().getTable().getCurrentRow();
