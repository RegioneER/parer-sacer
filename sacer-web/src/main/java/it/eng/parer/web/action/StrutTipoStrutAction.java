...
public class StrutTipoStrutAction extends StrutTipoStrutAbstractAction {
    ...
    public void loadDettaglio() throws EMFError {
        ...
        if (lista != null && (action != null && !action.equals(NE_DETTAGLIO_INSERT))) {
            ...
            if (lista.equals(getForm().getTipoStrutDocList().getName())
                ...
                DecTipoStrutDocRowBean tipoStrutDocRowBean = tipoStrutDocEjb.getDecTipoStrutDocRowBean(idTipoStrutDoc,
                        null);
                ...
                if (StringUtils.isNotBlank(cessato) && "1".equals(cessato)) {
                    ...
                    getForm().getTipoDocAmmessoDaTipoStrutDocList().setUserOperations(true, false, false, false);
                }
            }
        ...
        if (lista.equals(getForm().getTipoDocAmmessoDaTipoStrutDocList().getName())) {
            ...
            getForm().getTipoDocAmmessoDaTipoStrutDoc().getId_tipo_doc_ammesso().setDecodeMap(mappaTipoStrutDoc);
            if (currentRow != null) {
        ...
        if (lista != null && (lista.equals(getForm().getTipoRapprCompAmmessoDaTipoCompList().getName()))) {
            BigDecimal idStrut = getForm().getIdList().getId_strut().parse();
            ...
            DecTipoRapprCompTableBean table = tipoStrutDocEjb.getDecTipoRapprCompTableBeanByIdStrut(idStrut,
                    new Date());
            DecodeMap mappaTipoStrutDoc = new DecodeMap();
            mappaTipoStrutDoc.populatedMap(table, "id_tipo_rappr_comp", "nm_tipo_rappr_comp");
            getForm().getTipoRapprCompAmmessoDaTipoComp().getId_tipo_rappr_comp().setDecodeMap(mappaTipoStrutDoc);
            if (currentRow != null) {
    ...
    public void undoDettaglio() throws EMFError {
        ...
        if (publisher.equals(Application.Publisher.TIPO_STRUT_DOC_DETAIL)
            ...
            goBack();
                ...
                && getForm().getTipoDocAmmessoDaTipoStrutDoc().getStatus().toString().equals("insert")) {
            goBack();
                ...
                && getForm().getTipoRapprCompAmmessoDaTipoComp().getStatus().toString().equals("insert")) {
            goBack();
        } else {
            loadDettaglio();
        }
    ...
    public void insertDettaglio() throws EMFError {
        ...
        if (lista.equals(getForm().getFormatoFileAmmessoList().getName())) {
            getForm().getSelectFormatoFileAmmessoList().getCd_estensione_file_busta().setHidden(true);
    ...
    public void dettaglioOnClick() throws EMFError {
        ...
        if (getForm().getTipoStrutDocList().getName().equals(lista)) {
            ...
            DecTipoCompDocRowBean riga = (DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable()
                    .getCurrentRow();
            boolean isNotContenuto = !riga.getTiUsoCompDoc().equals(CostantiDB.TipoUsoComponente.CONTENUTO);
            if (NE_DETTAGLIO_INSERT.equals(action) && isNotContenuto) {
                // Solo i Componenti di tipo "CONTENUTO" posso avere dei dati specifici
                getMessageBox()
                        .addWarning("Il tipo componente è diverso da CONTENUTO. \n Non è possibile associare un xsd.");
            } else {
                /*
                ...
                if (redirect) {
                    ...
                    StringBuilder string = new StringBuilder("?operation=listNavigationOnClick&navigationEvent="
                            + action + "&table=" + StrutDatiSpecForm.XsdDatiSpecList.NAME + "&riga=" + row.toString());
                    form.getXsdDatiSpecList().setTable(getForm().getXsdDatiSpecList().getTable());
                    /*
                     * Propago l'idStruttura che ho salvato in memoria, per passarlo con la nuova form che porterò nella
                     * nuova action
                     */
                    ...
                    if (getLastPublisher().equals(Application.Publisher.TIPO_COMP_DOC_DETAIL)) {
                        ...
                        form.getTipoCompDocRif().getNm_tipo_comp_doc().setValue(
                                ((DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable().getCurrentRow())
                                        .getNmTipoCompDoc());
                        form.getTipoStrutDocRif().getNm_tipo_strut_doc().setValue(
                                ((DecTipoStrutDocRowBean) getForm().getTipoStrutDocList().getTable().getCurrentRow())
                                        .getNmTipoStrutDoc());
                    }
                    ...
                    // fisso a false tutte le autorizzazioni a procedere con le altre fasi della listNavigationOnClick
                    // in questa action
    ...
    public void confermaDisattivazioneXsd() throws EMFError {
        ...
        if (getLastPublisher().equals(Application.Publisher.TIPO_COMP_DOC_DETAIL)) {
            form.getIdList().getId_tipo_comp_doc()
                    .setValue(((DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable().getCurrentRow())
                            .getIdTipoCompDoc().toString());
            getSession().setAttribute("lastPage", "tipoCompDoc");
            ...
            form.getTipoStrutDocRif().getNm_tipo_strut_doc()
                    .setValue(((DecTipoStrutDocRowBean) getForm().getTipoStrutDocList().getTable().getCurrentRow())
                            .getNmTipoStrutDoc());
        }
    ...
    public void reloadAfterGoBack(String publisherName) {
        ...
        if (publisherName.equals(Application.Publisher.TIPO_COMP_DOC_DETAIL)) {
            ...
            final BigDecimal idTipoStrutDoc = ((DecTipoStrutDocRowBean) getForm().getTipoStrutDocList().getTable()
                    .getCurrentRow()).getIdTipoStrutDoc();
            DecTipoCompDocTableBean tipoCompDocTableBean = tipoStrutDocEjb.getDecTipoCompDocTableBean(idTipoStrutDoc,
            ...
            DecTipoStrutDocRowBean tipoStrutDocRB = (DecTipoStrutDocRowBean) getForm().getTipoStrutDocList().getTable()
                    .getCurrentRow();
            /* Carico la lista dei "Tipi documenti ammessi" */
            // Lista tipo struttura documento ammessa
            DecTipoStrutDocAmmessoTableBean tipoStrutDocTableBean = tipoDocEjb
                    .getDecTipoStrutDocAmmessoTableBeanByIdTipoStrutDoc(tipoStrutDocRB.getIdTipoStrutDoc());
            getForm().getTipoDocAmmessoDaTipoStrutDocList().setTable(tipoStrutDocTableBean);
            getForm().getTipoDocAmmessoDaTipoStrutDocList().getTable().first();
            getForm().getTipoDocAmmessoDaTipoStrutDocList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        }
    }
    ...
    public void tabDecFormatoFileAmmessoOnClick() throws EMFError {
        getForm().getDecTipoCompDocTab().setCurrentTab(getForm().getDecTipoCompDocTab().getDecFormatoFileAmmesso());
    ...
    public void tabDecTipoCompDocXsdDatiSpecOnClick() throws EMFError {
        getForm().getDecTipoCompDocTab().setCurrentTab(getForm().getDecTipoCompDocTab().getDecTipoCompDocXsdDatiSpec());
        ...
        xsdDatiSpecRowBean.setIdTipoCompDoc(
                ((DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable().getCurrentRow()).getIdTipoCompDoc());
        ...
        if (indiciAssolutiFormatiAmmissibili != null && indiciAssolutiFormatiAmmissibili.length > 0) {
            ...
            for (String comp : indiciAssolutiFormatiAmmissibili) {
                if (StringUtils.isNotBlank(comp) && StringUtils.isNumeric(comp)) {
                    DecFormatoFileDocRowBean row = (DecFormatoFileDocRowBean) getForm().getFormatoFileDocList()
                            .getTable().getRow((Integer.parseInt(comp) - indice));
                    getForm().getFormatoFileDocList().getTable().remove(Integer.parseInt(comp) - indice);
            ...
            for (String comp : indiciAssolutiFormatiAmmessi) {
                if (StringUtils.isNotBlank(comp) && StringUtils.isNumeric(comp)) {
                    DecFormatoFileDocRowBean row = (DecFormatoFileDocRowBean) getForm()
                            .getSelectFormatoFileAmmessoList().getTable().getRow((Integer.parseInt(comp) - indice));
                    getForm().getSelectFormatoFileAmmessoList().getTable().remove(Integer.parseInt(comp) - indice);
    ...
    /**
     * Bottone che serve per aggiungere tutti i formati file da una lista all'altra, nelle pagine di inserimento e
     * modifica formati file doc
     *
     * @throws Throwable
     *             errore generico
     */
    ...
    /**
     * Bottone che serve per rimuovere tutti i formati file dalla lista, nelle pagine di inserimento e modifica formati
     * file doc
     *
     * @throws Throwable
     *             errore generico
    ...
    private void salvaTipoCompDoc() throws EMFError {
        ...
        if (tipoCompDoc.validate(getMessageBox())) {
            ...
            if (tipoCompDoc.getNm_tipo_comp_doc().parse() == null) {
                getMessageBox().addError("Errore di compilazione form: nome tipo componente non inserito</br>");
            }
            if (tipoCompDoc.getDs_tipo_comp_doc().parse() == null) {
                getMessageBox()
                        .addError("Errore di compilazione form: descrizione tipo componente file non inserito</br>");
            }
            ...
            if (tipoCompDoc.getDt_istituz().parse() == null) {
                getMessageBox().addError("Errore di compilazione form: data istituzione non inserito</br>");
            }
            ...
            if (tipoStrutDocEjb.getDecTipoCompDocRowBean(tipoCompDoc.getNm_tipo_comp_doc().parse(),
                    idTipoStrutDoc) != null && getForm().getTipoCompDoc().getStatus().equals(Status.insert)) {
                getMessageBox()
                        .addError("Errore di compilazione form: nome tipo comp doc già presente nel database </br>");
            }
            try {
    ...
    private void salvaTipoStrutDoc() throws EMFError {
        ...
        if (tipoStrutDoc.validate(getMessageBox())) {
            ...
            if (tipoStrutDoc.getDs_tipo_strut_doc().parse() == null) {
                getMessageBox().addError("Errore di compilazione form: descrizione tipo struttura non inserito</br>");
            }
            ...
            try {
                if (getMessageBox().isEmpty()) {
                    ...
                    if (getForm().getTipoStrutDoc().getStatus().equals(Status.insert)) {
                        ...
                        getForm().getTipoCompDocList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                        getMessageBox().addMessage(
                                new Message(MessageLevel.INF, "Nuova struttura documento salvata con successo"));
                        ...
                        idTipoStrutDoc = ((DecTipoStrutDocRowBean) getForm().getTipoStrutDocList().getTable()
                                .getCurrentRow()).getIdTipoStrutDoc();
                        tipoStrutDocEjb.updateDecTipoStrutDoc(param, idTipoStrutDoc, tipoStrutDocRowBean);
                        getForm().getTipoStrutDocList().getTable()
                                .setCurrentRowIndex(getForm().getTipoStrutDocList().getTable().getCurrentRowIndex());
                    }
                    getForm().getTipoStrutDoc().setViewMode();
                    getForm().getTipoStrutDoc().setStatus(Status.view);
                    getForm().getTipoStrutDocList().setStatus(Status.view);
    ...
    private void salvaFormatoFileAmmesso() throws EMFError {
        ...
        BigDecimal idTipoCompDoc = ((DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable().getCurrentRow())
                .getIdTipoCompDoc();
        for (DecFormatoFileDocRowBean row : (DecFormatoFileDocTableBean) getForm().getSelectFormatoFileAmmessoList()
                .getTable()) {
    ...
    public void deleteTipoCompDocList() throws EMFError {
        ...
        DecTipoCompDocRowBean tipoCompDocRowBean = (DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable()
                .getCurrentRow();
        try {
            /*
             * Codice aggiuntivo per il logging...
            ...
            if (Application.Publisher.TIPO_COMP_DOC_DETAIL.equals(lastPublisher)) {
                ...
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form, form.getTipoCompDocList()));
            }
            tipoStrutDocEjb.deleteDecTipoCompDoc(param, tipoCompDocRowBean);
            getMessageBox()
                    .addMessage(new Message(MessageLevel.INF, "Tipo Componente documento eliminato con successo"));
            if (Application.Publisher.TIPO_COMP_DOC_DETAIL.equals(lastPublisher)) {
                goBack();
            }
        } catch (Exception e) {
    ...
    public void deleteTipoStrutDocList() throws EMFError {
        ...
        try {
            ...
            if (Application.Publisher.CREA_STRUTTURA.equalsIgnoreCase(param.getNomePagina())) {
                ...
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form, form.getTipoStrutDocList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            ...
            getForm().getTipoStrutDocList().getTable().first();
            getForm().getTipoStrutDocList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
            if (Application.Publisher.TIPO_STRUT_DOC_DETAIL.equals(lastPublisher) || "".equals(lastPublisher)) {
                goBack();
            }
    ...
    private void loadTipoCompDoclists(boolean isFirst) {
        ...
        if (!isFirst) {
            ...
            indMap.put("tipoFormatoFileAmmesso", getForm().getFormatoFileAmmessoList().getTable().getCurrentRowIndex());
            indMap.put("xsdDatiSpec", getForm().getXsdDatiSpecList().getTable().getCurrentRowIndex());
            indMap.put("tipoRapprComp",
                    getForm().getTipoRapprCompAmmessoDaTipoCompList().getTable().getCurrentRowIndex());
        }
        ...
        DecTipoCompDocRowBean tipocompDocBean = (DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable()
                .getCurrentRow();
        ...
        getForm().getTipoRapprCompAmmessoDaTipoCompList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        ...
        if (isFirst) {
            ...
            getForm().getFormatoFileAmmessoList().getTable().setCurrentRowIndex(indMap.get("tipoFormatoFileAmmesso"));
        ...
        if ((StringUtils.isNotBlank(cessato) && "1".equals(cessato)) || getRequest().getAttribute("cessato") != null) {
            ...
            getForm().getTipoRapprCompAmmessoDaTipoCompList().setUserOperations(true, false, false, false);
        }
    }
    ...
    public void loadXsdTipoCompDoc() throws EMFError {
        ...
        string.append("&idTipoCompDoc=")
                .append(((DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable().getCurrentRow())
                        .getIdTipoCompDoc().intValue());
        form.getIdList().getId_tipo_comp_doc()
                .setValue(((DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable().getCurrentRow())
                        .getIdTipoCompDoc().toString());
        getSession().setAttribute("lastPage", "tipoCompDoc");
        form.getTipoCompDocRif().getNm_tipo_comp_doc().setValue(
                ((DecTipoCompDocRowBean) getForm().getTipoCompDocList().getTable().getCurrentRow()).getNmTipoCompDoc());
        form.getTipoStrutDocRif().getNm_tipo_strut_doc()
                .setValue(((DecTipoStrutDocRowBean) getForm().getTipoStrutDocList().getTable().getCurrentRow())
                        .getNmTipoStrutDoc());
    ...
    private void salvaTipoRapprComp() throws EMFError {
        ...
        if (getForm().getTipoRapprCompAmmessoDaTipoComp().getId_tipo_rappr_comp().parse() == null) {
            getMessageBox().addError("Errore di compilazione form: tipo rappresentazione componente non inserito<br/>");
        }
        try {
            if (getMessageBox().isEmpty()) {
                /*
                ...
                if (getForm().getTipoRapprCompAmmessoDaTipoComp().getStatus().equals(Status.insert)) {
                    ...
                    tipoStrutDocEjb.insertDecTipoRapprAmmesso(param,
                            ...
                            getForm().getTipoRapprCompAmmessoDaTipoComp().getId_tipo_rappr_comp().parse());
                    getMessageBox().addMessage(
                            new Message(MessageLevel.INF, "Tipo rappresentazione componente inserito con successo!"));
                ...
                } else if (getForm().getTipoRapprCompAmmessoDaTipoComp().getStatus().equals(Status.update)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                    ...
                    BigDecimal idTipoCompDocDB = ((DecTipoRapprAmmessoRowBean) getForm()
                            .getTipoRapprCompAmmessoDaTipoCompList().getTable().getCurrentRow()).getIdTipoCompDoc();
                    BigDecimal idTipoRapprInModifica = getForm().getTipoRapprCompAmmessoDaTipoComp()
                            .getId_tipo_rappr_comp().parse();
                    tipoStrutDocEjb.updateDecTipoRapprAmmesso(param, idTipoRapprAmmessoDB, idTipoCompDocDB,
                            idTipoRapprInModifica);
                    getMessageBox().addMessage(
                            new Message(MessageLevel.INF, "Tipo rappresentazione componente modificato con successo!"));
                    /*
                     ...
                     */
                    ((DecTipoRapprAmmessoRowBean) getForm().getTipoRapprCompAmmessoDaTipoCompList().getTable()
                            .getCurrentRow()).setIdTipoRapprComp(idTipoRapprInModifica);
                }
                getMessageBox().setViewMode(ViewMode.plain);
    ...
    public void updateTipoRapprCompAmmessoDaTipoCompList() throws EMFError {
        ...
        BigDecimal idTipoRapprAmmesso = getForm().getTipoRapprCompAmmessoDaTipoComp().getId_tipo_rappr_comp().parse();
        getForm().getTipoRapprCompAmmessoDaTipoComp().getId_tipo_rappr_comp().setValue(idTipoRapprAmmesso.toString());
    ...
    public void deleteTipoRapprCompAmmessoDaTipoCompList() {
        ...
        try {
            BigDecimal idTipoRapprAmmesso = ((DecTipoRapprAmmessoTableBean) getForm()
                    .getTipoRapprCompAmmessoDaTipoCompList().getTable()).getCurrentRow().getIdTipoRapprAmmesso();
            /*
             * Codice aggiuntivo per il logging...
             */
            LogParam param = SpagoliteLogUtil.getLogParam(
            ...
            if (Application.Publisher.TIPO_COMP_DOC_DETAIL.equalsIgnoreCase(param.getNomePagina())) {
                StrutTipoStrutForm form = (StrutTipoStrutForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(
                        SpagoliteLogUtil.getDetailActionNameDelete(form, form.getTipoRapprCompAmmessoDaTipoCompList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            BigDecimal idTipoStrutDoc = ((DecTipoStrutDocRowBean) getForm().getTipoStrutDocList().getTable()
            ...
            getMessageBox().addMessage(
                    new Message(MessageLevel.INF, "Tipo rappresentazione componente eliminato con successo"));
            BigDecimal idTipoCompDoc = getForm().getTipoCompDoc().getId_tipo_comp_doc().parse();
            DecTipoRapprAmmessoTableBean tipoRapprAmmessoTableBean = tipoStrutDocEjb
                    .getDecTipoRapprAmmessoTableBeanByIdTipoCompDoc(idTipoCompDoc);
            getForm().getTipoRapprCompAmmessoDaTipoCompList().setTable(tipoRapprAmmessoTableBean);
            ...
            if (Application.Publisher.ASSOCIAZIONE_TIPO_COMP_TIPO_RAPPR_COMP.equals(getLastPublisher())) {
                goBack();
            } else {
                forwardToPublisher(Application.Publisher.TIPO_COMP_DOC_DETAIL);
            ...
            if (getMessageBox().isEmpty()) {
                ...
                if (getForm().getTipoDocAmmessoDaTipoStrutDoc().getStatus().equals(Status.insert)) {
                    ...
                    tipoDocEjb.insertDecTipoStrutDocAmmesso(param,
                            getForm().getTipoDocAmmessoDaTipoStrutDoc().getId_tipo_doc_ammesso().parse(),
                            getForm().getTipoStrutDoc().getId_tipo_strut_doc().parse());
                    getMessageBox()
                            .addMessage(new Message(MessageLevel.INF, "Tipo documento ammesso inserito con successo!"));
                    /* Inserisco la riga in fondo alla tabella */
                ...
                } else if (getForm().getTipoDocAmmessoDaTipoStrutDoc().getStatus().equals(Status.update)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                    /* Modifico su DB */
                    ...
                    BigDecimal idTipoStrutDocDB = ((DecTipoStrutDocAmmessoRowBean) getForm()
                            .getTipoDocAmmessoDaTipoStrutDocList().getTable().getCurrentRow()).getIdTipoStrutDoc();
                    BigDecimal idTipoDocInModifica = getForm().getTipoDocAmmessoDaTipoStrutDoc()
                            .getId_tipo_doc_ammesso().parse();
                    tipoDocEjb.updateDecTipoStrutDocAmmessoFromTipoStrutDoc(param, idTipoStrutDocAmmessoDB,
                            idTipoDocInModifica, idTipoStrutDocDB);
                    getMessageBox().addMessage(
                            new Message(MessageLevel.INF, "Tipo documento ammesso modificato con successo!"));
                    /*
                     * Setto sulla lista (ancora da ricaricare) il nuovo valore di idTipoStrutDoc, in maniera tale che
                     * in caso di immediata ri-modifica prenda su, dalla loadDettaglio, il valore corretto
                     */
                    ((DecTipoStrutDocAmmessoRowBean) getForm().getTipoDocAmmessoDaTipoStrutDocList().getTable()
                            .getCurrentRow()).setIdTipoDoc(idTipoDocInModifica);
                }
                getMessageBox().setViewMode(ViewMode.plain);
    ...
    public void updateTipoDocAmmessoDaTipoStrutDocList() throws EMFError {
        /* Imposto il valore nella combo */
        BigDecimal idTipoDocAmmesso = getForm().getTipoDocAmmessoDaTipoStrutDoc().getId_tipo_doc_ammesso().parse();
        getForm().getTipoDocAmmessoDaTipoStrutDoc().getId_tipo_doc_ammesso().setValue(idTipoDocAmmesso.toString());
    ...
    public void deleteTipoDocAmmessoDaTipoStrutDocList() {
        ...
        try {
            ...
            if (Application.Publisher.TIPO_STRUT_DOC_DETAIL.equalsIgnoreCase(param.getNomePagina())) {
                StrutTipoStrutForm form = (StrutTipoStrutForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(
                        SpagoliteLogUtil.getDetailActionNameDelete(form, form.getTipoDocAmmessoDaTipoStrutDocList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            BigDecimal idTipoStrutDocAmmesso = ((DecTipoStrutDocAmmessoTableBean) getForm()
                    .getTipoDocAmmessoDaTipoStrutDocList().getTable()).getCurrentRow().getIdTipoStrutDocAmmesso();
            BigDecimal idTipoStrutDoc = getForm().getTipoStrutDoc().getId_tipo_strut_doc().parse();
            BigDecimal idTipoDoc = ((DecTipoStrutDocAmmessoTableBean) getForm().getTipoDocAmmessoDaTipoStrutDocList()
            ...
            if (Application.Publisher.ASSOCIAZIONE_TIPO_STRUT_DOC_TIPO_DOC.equals(getLastPublisher())) {
                goBack();
            } else {
                forwardToPublisher(Application.Publisher.TIPO_STRUT_DOC_DETAIL);
    ...
    public void loadDettaglioTipoDoc() throws EMFError {
        ...
        BigDecimal idTipoDoc = ((DecTipoStrutDocAmmessoTableBean) getForm().getTipoDocAmmessoDaTipoStrutDocList()
                .getTable()).getRow(numberRiga.intValue()).getIdTipoDoc();
    ...
    public void loadDettaglioTipoRapprComp() throws EMFError {
        ...
        BigDecimal idTipoRapprComp = ((DecTipoRapprAmmessoTableBean) getForm().getTipoRapprCompAmmessoDaTipoCompList()
                .getTable()).getRow(numberRiga.intValue()).getIdTipoRapprComp();
        DecTipoRapprCompRowBean tipoRapprCompRow = tipoRapprEjb.getDecTipoRapprCompRowBean(idTipoRapprComp, idStrut);
    ...
    private StruttureForm prepareRedirectToStrutture() throws EMFError {
        ...
        ArrayList<ExecutionHistory> executionHistory = SessionManager.getExecutionHistory(getSession());
