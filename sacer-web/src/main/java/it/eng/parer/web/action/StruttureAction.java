...
public class StruttureAction extends StruttureAbstractAction {
            ...
            if (getLastPublisher().equals(Application.Publisher.IMPORTA_PARAMETRI_WIZARD)) {
                ...
                try {
                    ...
                    if (a != null) {
                        ...
                        Method method = StruttureAction.class.getMethod(operationMethod, String[].class);
    ...
    public void loadDettaglio() throws EMFError {
        ...
        try {
            ...
            if (lista != null && (action != null && !action.equals(NE_DETTAGLIO_INSERT))) {
                ...
                if (lista.equals(categorieEntiListName) && (getForm().getCategorieEntiList().getTable() != null)
                    ...
                    BigDecimal idCategEnte = ((OrgCategEnteRowBean) getForm().getCategorieEntiList().getTable()
                            .getCurrentRow()).getIdCategEnte();

                    OrgCategEnteRowBean categEnteRowBean = ambienteEjb.getOrgCategEnteRowBean(idCategEnte);
                    ...
                    BigDecimal idTipoRapprComp = ((DecTipoRapprCompRowBean) getForm().getTipoRapprCompList().getTable()
                            .getCurrentRow()).getIdTipoRapprComp();
                    ...
                    getForm().getTipoRapprComp().getId_formato_output_rappr().setDecodeMap(mappaFormatoFile);
                    ...
                    BigDecimal idCategStrut = ((OrgCategStrutRowBean) getForm().getCategorieStruttureList().getTable()
                            .getCurrentRow()).getIdCategStrut();
                    OrgCategStrutRowBean categStrutRowBean = struttureEjb.getOrgCategStrutRowBean(idCategStrut);
                    ...
                    DecTipoStrutDocTableBean table = tipoDocEjb.getDecTipoStrutDocTableBeanByIdStrut(idStrut,
                            new Date());
                    ...
                    getForm().getTipoCompAmmessoDaTipoRapprComp().getId_tipo_strut_doc().setValue("" + idTipoStrutDoc);
                    ...
                    getForm().getTipoCompAmmessoDaTipoRapprComp().getId_tipo_comp_doc().setDecodeMap(mappaTipoCompDoc);
                    ...
                    BigDecimal idStrut = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                            .getBigDecimal("id_strut");
                    OrgUsoSistemaMigrazRowBean uso = (OrgUsoSistemaMigrazRowBean) getForm().getSistemiMigrazioneList()
                    ...
                    getForm().getGestioneXsdMigrazione().getNm_sistema_migraz().setDecodeMap(
                            DecodeMap.Factory.newInstance(orgUsoTableBean, "id_sistema_migraz", "nm_sistema_migraz"));
                    ...
                    DecXsdDatiSpecTableBean xsdDatiSpecTableBean = datiSpecEjb.getDecXsdDatiSpecTableBean(idStrut,
                            CostantiDB.TipiUsoDatiSpec.MIGRAZ.name(), CostantiDB.TipiEntitaSacer.UNI_DOC.name(),
                            nmSistemaMigraz);
    ...
    public void undoDettaglio() throws EMFError {
        ...
        if (publisher.equals(Application.Publisher.CREA_STRUTTURA)
            ...
            goBack();
                ...
                && getForm().getTipoCompAmmessoDaTipoRapprComp().getStatus().toString().equals("insert")) {
            goBack();
    ...
    private void salvaStruttura() throws EMFError {
        ...
        if (struttura.validate(getMessageBox())) {
            ...
            if (struttura.getNm_strut().parse() == null) {
                ...
                if (!m.matches()) {
                    getMessageBox()
                            .addError("Errore di compilazione form: Nome struttura contenente caratteri non permessi");
                }
            }
            ...
            if (struttura.getDt_ini_val_strut().parse().after(struttura.getDt_fine_val_strut().parse())) {
            ...
            if (struttura.getFl_archivio_restituito().parse() == null) {
                getMessageBox().addError("Errore di compilazione form: Archivio restituito non inserito</br>");
            }
            ...
            if ("1".equals(strutRowBean.getFlTemplate())
                    && (ente.getTipoDefTemplateEnte().equals(CostantiDB.TipoDefTemplateEnte.NO_TEMPLATE.name()))) {
                getMessageBox().addError(
    ...
    /**
     * Esegue il controllo sul campo "Numero massimo componenti" prima di consentire la prosecuzione della procedura di
     * salvataggio, switchando tra i vari tipo di salvataggio.
     *
     * @param struttura
     * @param strutRowBean
        ...
        try {
            if (getSession().getAttribute("salvataggioAttributes") != null) {
                ...
                case DUPLICA_STANDARD:
                    ...
                    azione = SpagoliteLogUtil.getButtonActionName(form, form.getCheckDuplicaStruttura(),
                            form.getCheckDuplicaStruttura().getConfermaSceltaDup().getName());
                    break;
                ...
                switchTipoSalvataggio(param, (InsStruttura) sa[0], (OrgStrutRowBean) sa[1], tipoSalvataggio,
                        (AplParamApplicTableBean) sa[2], (AplParamApplicTableBean) sa[3],
                        (AplParamApplicTableBean) sa[4]);
            }
            forwardToPublisher(Application.Publisher.CREA_STRUTTURA);
            postLoad();
        } catch (ParerUserError e) {
    ...
    private void switchTipoSalvataggio(LogParam param, InsStruttura struttura, OrgStrutRowBean strutRowBean,
        ...
        case STRUTTURA:
            ...
            break;
        case DUPLICA_NON_STANDARD:
            eseguiDuplicaNonStandard(param, struttura, strutRowBean, parametriAmministrazioneStruttura,
                    parametriConservazioneStruttura, parametriGestioneStruttura);
            break;
        case DUPLICA_STANDARD:
        case IMPORTA_STANDARD:
            ...
            break;
        case IMPORTA_NON_STANDARD:
            eseguiImportaNonStandard(param, struttura, strutRowBean, parametriAmministrazioneStruttura,
                    parametriConservazioneStruttura, parametriGestioneStruttura);
            break;
        }
    }

    private void eseguiSalvataggioStruttura(LogParam param, InsStruttura struttura, OrgStrutRowBean strutRowBean)
        ...
        if (struttura.getStatus().equals(Status.update)) {
            ...
            OrgEnteRowBean ente = struttureEjb.getOrgEnteRowBean(struttura.getId_ente_rif().parse());
            OrgAmbienteRowBean ambiente = struttureEjb.getOrgAmbienteRowBean(struttura.getId_ambiente_rif().parse());
            ...
            getMessageBox().addMessage(new Message(MessageLevel.INF, "Update della struttura effettuato con successo"));
        } else {
            ...
            loadlists(strutRowBean.getIdStrut(), true);
            getMessageBox().addMessage(new Message(MessageLevel.INF, "Inserimento struttura effettuato con successo"));
        }
    ...
    private void eseguiDuplicaNonStandard(LogParam param, InsStruttura struttura, OrgStrutRowBean strutRowBean,
        ...
        if (struttura.getStatus().equals(Status.insert)) {
            strutRowBean.setIdEnte(struttura.getId_ente_rif().parse());
            try {
                SalvaStrutturaDto salva = (SalvaStrutturaDto) getSession().getAttribute(SES_ATTRIB_VALORI_SALVATAGGIO);
                CopiaStruttureEjb.OrgStrutCopyResult result = struttureEjb.copyOrgStrutRowBean(param, strutRowBean,
                        ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                                .getBigDecimal("id_strut"),
    ...
    private void eseguiImportaNonStandard(LogParam param, InsStruttura struttura, OrgStrutRowBean strutRowBean,
        ...
        if (getForm().getInsStruttura().getStatus().equals(Status.insert)) {
            try {
                strutRowBean.setIdEnte(struttura.getId_ente_rif().parse());
                SalvaStrutturaDto salva = (SalvaStrutturaDto) getSession().getAttribute(SES_ATTRIB_VALORI_SALVATAGGIO);
                CopiaStruttureEjb.OrgStrutCopyResult result = struttureEjb.insertOrgStrutImp(param, strutRowBean,
                        UUID.fromString(getSession().getAttribute("uuid").toString()), salva,
                        parametriAmministrazioneStruttura, parametriConservazioneStruttura, parametriGestioneStruttura);
                gestisciMessaggiInfo(result.getMex());
            } catch (ParerUserError e) {
    ...
    private void reloadDettaglioPostDuplicaNonStandard(OrgStrutRowBean strutRowBean) throws EMFError {
        strutRowBean = struttureEjb.getOrgStrutRowBean(strutRowBean.getIdStrut(), strutRowBean.getIdEnte());
        OrgEnteRowBean enteTemp = struttureEjb.getOrgEnteRowBean(strutRowBean.getIdEnte());
        OrgAmbienteRowBean ambienteTemp = struttureEjb.getOrgAmbienteRowBean(enteTemp.getIdAmbiente());
        strutRowBean.setString("nm_ente", enteTemp.getNmEnte() + " - " + (ambienteTemp.getNmAmbiente()));
        OrgStrutTableBean orgStrutTableBean = new OrgStrutTableBean();
        orgStrutTableBean.add(strutRowBean);
        getForm().getStruttureList().setTable(orgStrutTableBean);
        getForm().getStruttureList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        ...
        if (getForm().getInsStruttura().getStatus().equals(Status.insert)) {
            try {
                ...
                if (isFromImporta) {
                    ...
                    StruttureForm form = (StruttureForm) SpagoliteLogUtil.getForm(this);
                    param.setNomeAzione(SpagoliteLogUtil.getButtonActionName(form, form.getInsStruttura(),
                            form.getInsStruttura().getConfermaImportaStruttura().getName()));
                    strutRowBean.setFlTemplate("0");
                    if (getForm().getInsStruttura().getStatus().equals(Status.insert)) {
                        strutRowBean.setIdEnte(struttura.getId_ente_rif().parse());
                        CopiaStruttureEjb.OrgStrutCopyResult result = struttureEjb.overwriteOrgStrutImp(param,
                                strutRowBean, UUID.fromString(getSession().getAttribute("uuid").toString()), salva,
                    ...
                    StruttureForm form = (StruttureForm) SpagoliteLogUtil.getForm(this);
                    param.setNomeAzione(SpagoliteLogUtil.getButtonActionName(form, form.getCheckDuplicaStruttura(),
                            form.getCheckDuplicaStruttura().getConfermaSceltaDup().getName()));
                    BigDecimal idStrut = (BigDecimal) getSession().getAttribute("idStrutToCopy");
                    CopiaStruttureEjb.OrgStrutCopyResult result = struttureEjb.overwriteStrut(param, idStrut,
                            strutRowBean, salva, parametriAmministrazioneStruttura, parametriConservazioneStruttura,
                            parametriGestioneStruttura);
                    gestisciMessaggiInfo(result.getMex());
                    getMessageBox().addMessage(new Message(MessageLevel.INF, "Nuova struttura salvata con successo"));
                }
    ...
    private void reloadDettaglioPostImportaNonStandard(InsStruttura struttura, OrgStrutRowBean strutRowBean)
            throws EMFError, ParerUserError {
    ...
    private void salvaStrutturaGestioneNonStandard(String publisherPerLogging, String buttonActionNamePerLogging,
            TipoSalvataggio tipoSalvataggio) throws EMFError {
        getMessageBox().clear();
        OrgStrutRowBean strutRowBean = new OrgStrutRowBean();
        InsStruttura struttura = getForm().getInsStruttura();
        struttura.post(getRequest());
        ...
        if (getMessageBox().isEmpty()) {
            ...
            try {
                ...
                checkNumCompAndSalvaStruttura(param, struttura, strutRowBean, tipoSalvataggio,
                        (AplParamApplicTableBean) getForm().getParametriAmministrazioneStrutturaList().getTable(),
                        (AplParamApplicTableBean) getForm().getParametriConservazioneStrutturaList().getTable(),
                        (AplParamApplicTableBean) getForm().getParametriGestioneStrutturaList().getTable());
                forwardToPublisher(Application.Publisher.CREA_STRUTTURA);
            } catch (ParerUserError e) {
                String[] errorParts = e.getDescription().split(";");
                customizeErrorMessage(errorParts);
    ...
    private void salvaTipoRapprComp() throws EMFError {
        ...
        if (tipoRapprComp.validate(getMessageBox())) {
            ...
            if (StringUtils.isBlank(tipoRapprComp.getNm_tipo_rappr_comp().parse())) {
                getMessageBox()
                        .addError("Errore di compilazione form: tipo rappresentazione componente non inserito</br>");
            }
            ...
            if (tipoRapprComp.getDt_istituz().parse() == null) {
                getMessageBox().addError("Errore di compilazione form: data di attivazione non inserita</br>");
            }
            if (tipoRapprComp.getId_formato_contenuto().parse() == null) {
                getMessageBox().addError("Errore di compilazione form: formato del file contenuto non inserito</br>");
            }
            if (StringUtils.isBlank(tipoRapprComp.getTi_algo_rappr().parse())) {
                getMessageBox()
                        .addError("Errore di compilazione form: algoritmo di rappresentazione non inserito</br>");
            }
            if (StringUtils.isBlank(tipoRapprComp.getTi_output_rappr().parse())) {
                getMessageBox().addError("Errore di compilazione form: tipo di output non inserito</br>");
            }
            if (tipoRapprComp.getId_formato_output_rappr().parse() == null) {
                getMessageBox().addError("Errore di compilazione form: formato di output non inserito</br>");
            }
            if (tipoRapprComp.getDt_soppres().parse() == null) {
                tipoRapprComp.getDt_soppres().setValue(getDefaultDate());
            }
            if (tipoRapprComp.getDt_istituz().parse() != null && tipoRapprComp.getDt_soppres().parse() != null
                    && tipoRapprComp.getDt_istituz().parse().after(tipoRapprComp.getDt_soppres().parse())) {
                getMessageBox().addError(
            ...
            try {
                if (getMessageBox().isEmpty()) {
                    ...
                    if (getForm().getTipoRapprComp().getStatus().equals(Status.insert)) {
                        ...
                        tipoRapprCompRowBean = tipoRapprEjb
                                .getDecTipoRapprCompRowBean(tipoRapprCompRowBean.getNmTipoRapprComp(), idStrut);
                        ...
                        getMessageBox().addMessage(
                                new Message(MessageLevel.INF, "Nuovo Tipo Rappresentazione salvata con successo"));
                    } else if (getForm().getTipoRapprComp().getStatus().equals(Status.update)) {
                        param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                        BigDecimal idTipoRapprComp = ((DecTipoRapprCompRowBean) getForm().getTipoRapprCompList()
                                .getTable().getCurrentRow()).getIdTipoRapprComp();
                        // VEDERE SE NON HO SBAGLIATO A TOGLIERE idTipoStrutDoc
                        tipoRapprEjb.updateDecTipoRapprComp(param, idTipoRapprComp, tipoRapprCompRowBean);
                        tipoRapprCompRowBean.setIdTipoRapprComp(idTipoRapprComp);
                        getForm().getTipoRapprCompList().getTable()
                                .setCurrentRowIndex(getForm().getTipoRapprCompList().getTable().getCurrentRowIndex());
                    }
                    getForm().getTipoRapprComp().setViewMode();
    ...
    private void salvaCategStrut() throws EMFError {
        ...
        if (getForm().getCategorieStrutture().validate(getMessageBox())) {
            ...
            if (getForm().getCategorieStrutture().getDs_categ_strut().parse() == null) {
                getMessageBox().addError("Errore di compilazione: inserire descrizione categoria </br>");
            }
            ...
            try {
                if (getMessageBox().isEmpty()) {
                    ...
                    if (getForm().getCategorieStrutture().getStatus().equals(Status.insert)) {
                        ...
                        getMessageBox().addMessage(
                                new Message(MessageLevel.INF, "Nuova categoria strutture salvata con successo"));

                    } else if (getForm().getCategorieStrutture().getStatus().equals(Status.update)) {

                        BigDecimal idCategStrut = ((OrgCategStrutRowBean) getForm().getCategorieStruttureList()
                                .getTable().getCurrentRow()).getIdCategStrut();
                        struttureEjb.updateOrgCategStrut(idCategStrut, categStrutRowBean);
                        getForm().getCategorieStruttureList().getTable().setCurrentRowIndex(
                                getForm().getCategorieStruttureList().getTable().getCurrentRowIndex());
    ...
    private void salvaUsoSistemaMigraz() throws EMFError {
        ...
        if (!getMessageBox().hasError()) {
            try {
                ...
                BigDecimal idSistemaVersante = getForm().getGestioneXsdMigrazione().getNm_sistema_migraz().parse();

                sysMigrazioneEjb.insertOrgUsoSistemaMigraz(idStrut, idSistemaVersante);
                getMessageBox().addInfo("Sistema di migrazione per la struttura salvato con successo");
                getMessageBox().setViewMode(ViewMode.plain);
    ...
    private void salvaParametriStruttura() throws EMFError {
        ...
        for (AplParamApplicRowBean row : (AplParamApplicTableBean) getForm().getParametriConservazioneStrutturaList()
                .getTable()) {
            if (row.getNmParamApplic().equals("FL_GEST_FASCICOLI")) {
        ...
        if (!getMessageBox().hasError()) {
            ...
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            struttureEjb.saveParametriStruttura(param, parametriAmministrazione, parametriConservazione,
                    parametriGestione, idStrut);
    ...
    public void dettaglioOnClick() throws EMFError {
        ...
        if (getForm().getStruttureList().getTable() != null && !getForm().getStruttureList().getTable().isEmpty()) {
        ...
        if (getForm().getRegistroUnitaDocList().getName().equals(lista)
        ...
        else if (getForm().getTipoDocList().getName().equals(lista) && action.equals(ListAction.NE_DETTAGLIO_VIEW)) {
            ...
            form.getStrutRif().getStruttura().setValue(getForm().getInsStruttura().getNm_strut().parse() + " ("
                    + getForm().getInsStruttura().getDs_strut().parse() + ")");
            form.getStrutRif().getNm_strut().setValue(getForm().getInsStruttura().getNm_strut().parse());

            this.setInsertAction(false);
            this.setEditAction(false);
            this.setDeleteAction(false);
            form.getTrasformTipoRapprList()
                    .setFilterValidRecords(getForm().getTrasformTipoRapprList().isFilterValidRecords());
            redirectToPage(Application.Actions.TRASFORMATORI, form, form.getTrasformTipoRapprList().getName(),
                    getForm().getTrasformTipoRapprList().getTable(), getNavigationEvent());
        } else if (lista.equals(getForm().getSubStrutList().getName()) && action.equals(ListAction.NE_DETTAGLIO_VIEW)) {
    ...
    /*
     * Questo metodo viene chiamato quaando nella form di dettaglio si punta ad un unico record presente nella lista
     * chiamante, quando ce ne sono più di uno viene chiamato il metodo deleteStruttureList()
     */
    @Override
        ...
        if (idStrut != null && !BigDecimal.ZERO.equals(idStrut)) {
            ...
            if (!getMessageBox().hasError()) {
                ...
                if (getForm().getVisStrutture().getId_ente().parse() != null) {
                    ...
                    ricStrut.setBigDecimal("id_ambiente", getForm().getVisStrutture().getId_ambiente().parse());
                }
    ...
    /**
     * Metodo richiamato dal tasto "Inserisci" all'interno della lista A seconda della lista chiamante, visualizza la
     * form di inserimento corrispondente
     *
     * @throws EMFError
     *             errore generico
     */
    ...
    public void insertDettaglio() throws EMFError {
        ...
        if (lista.equals(getForm().getStruttureList().getName())) {
            ...
            DecFormatoFileDocTableBean tmpTableBeanFormatoFileDoc = formatoFileDocEjb
                    .getDecFormatoFileDocNiOrdUsoTableBean(idStrut);
            DecodeMap mappaFormatoFile = new DecodeMap();
            mappaFormatoFile.populatedMap(tmpTableBeanFormatoFileDoc, "id_formato_file_doc", "nm_formato_file_doc");
            getForm().getTipoRapprComp().getId_formato_contenuto().setDecodeMap(mappaFormatoFile);
            getForm().getTipoRapprComp().getId_formato_convertit().setDecodeMap(mappaFormatoFile);
            DecFormatoFileStandardTableBean tmpTableBeanFfs = formatiStandardEjb
                    .getDecFormatoFileStandardTableBean(null);
            mappaFormatoFile = new DecodeMap();
            mappaFormatoFile.populatedMap(tmpTableBeanFfs, "id_formato_file_standard", "nm_formato_file_standard");
            getForm().getTipoRapprComp().getId_formato_output_rappr().setDecodeMap(mappaFormatoFile);
            getForm().getTipoRapprComp().getTi_algo_rappr().setDecodeMap(mappaAlgoritmoRappr);
            getForm().getTipoRapprComp().getTi_output_rappr().setDecodeMap(mappaTipoOutputRappr);
            ...
            /*
             * Se l'azione è update o insert, verifico nel caso di struttura template che esista solo la struttura di
             * default e impongo che non se ne possano creare altre
             */
            ...
            DecodeMap mappaTipoStrutDoc = new DecodeMap();
            mappaTipoStrutDoc.populatedMap(table, "id_tipo_strut_doc", "nm_tipo_strut_doc");
            getForm().getTipoCompAmmessoDaTipoRapprComp().getId_tipo_strut_doc().setDecodeMap(mappaTipoStrutDoc);
            /* Pulisco la bombo */
            ...
            getForm().getXsdMigrStrutTab().setCurrentTab(getForm().getXsdMigrStrutTab().getXsdMigrTipoUnitaDoc());
            getForm().getGestioneXsdMigrazione().reset();
            ...
            getForm().getGestioneXsdMigrazione().getNm_sistema_migraz().setDecodeMap(
                    DecodeMap.Factory.newInstance(aplSistemaMigrazTableBean, "id_sistema_migraz", "nm_sistema_migraz"));
            getForm().getGestioneXsdMigrazione().getId_strut().setValue(idStrut.toPlainString());
    ...
    /**
     * Metodo associato al link "Gestione Strutture" del menu Carica la form compilabile per la ricerca
     *
     * @throws EMFError
     *             errore generico
     */
    ...
    public void ricercaStruttura() throws EMFError {
        ...
        try {
            ...
            // Nascondo i bottoni di conferma/annulla creazione struttura template con javascript disattivato
    ...
    private void initRicercaStruttureCombo() throws ParerUserError {
        // Combo Ambiente
        DecodeMap mappaAmbienti = new DecodeMap();
        OrgAmbienteTableBean ambienteTableBean = ambienteEjb.getAmbientiAbilitati(getUser().getIdUtente());
        ambienteTableBean.addSortingRule("nm_ambiente", SortingRule.ASC);
        ambienteTableBean.sort();
        mappaAmbienti.populatedMap(ambienteTableBean, "id_ambiente", "nm_ambiente");
        ...
        String ambienteSelezionato = organizzazione.get(WebConstants.Organizzazione.AMBIENTE.name());
    ...
    /**
     * Metodo associato al bottone "VisStruttura" che raccoglie i dati dalla form di ricerca e li utilizza per
     * interrogare il DB
     *
     * @throws EMFError
     *             errore generico
    ...
    private void initStrutComboBox(BigDecimal idAmbienteEnteConvenz) {
        ...
        bt.add(br2);
        mappaTempoScadChiusFirme.populatedMap(bt, "ti_tempo_scad_chius_firme", "ti_tempo_scad_chius_firme");
        ...
        if (idAmbienteEnteConvenz != null) {
            BaseTable enteConvenzTableBean = ambienteEjb
                    .getSIOrgEnteConvenzAccordoValidoTableBean(getUser().getIdUtente(), idAmbienteEnteConvenz);
        ...
        getForm().getInsStruttura().getFl_archivio_restituito().setDecodeMap(ComboGetter.getMappaGenericFlagSiNo());
        getForm().getInsStruttura().getFl_archivio_restituito().setValue("0");
    }

    /**
     * Metodo che esegue la ricerca all'interno del Database di strutture corrispondenti ai parametri passati in
     * ingresso
     *
     * @param strutRowBean
     *
    ...
    private void reloadStrutList(OrgStrutRowBean strutRowBean) throws EMFError {
        ...
        BigDecimal idAmbitoTerrit = struttureEjb.getIdAmbitoTerritorialePerRicerca(
                strutRowBean.getBigDecimal("id_regione_stato"), strutRowBean.getBigDecimal("id_provincia"),
                strutRowBean.getBigDecimal("id_forma_associata"));

        OrgVRicStrutTableBean ricStrutTableBean = struttureEjb.getOrgVRicStrutTableBean(strutRowBean.getNmStrut(),
                strutRowBean.getIdEnte(), strutRowBean.getBigDecimal("id_ambiente"),
        ...
        if (getForm().getStruttureList().getStatus().equals(Status.update)) {
            getForm().getStruttureList().getTable()
                    .setCurrentRowIndex(getForm().getStruttureList().getTable().getCurrentRowIndex());
        ...
        getForm().getStruttureTemplate().getNum_strut_templ_part().setValue(
                struttureEjb.countOrgStrutTemplateWithCompletedPartitioningRaggruppati(getUser().getIdUtente()));
    ...
    public void updateStruttureList() throws EMFError {
        ...
        if (struttureEjb.hasAroUnitaDoc(((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                .getBigDecimal("id_strut"))) {
            getForm().getInsStruttura().getNm_strut().setViewMode();
        }
    ...
    public void updateTipoRapprCompList() throws EMFError {
        getForm().getTipoRapprComp().setEditMode();
        getForm().getTipoRapprComp().getLogEventiTipoRapprComp().setViewMode();
        DecTipoRapprCompRowBean decTipoRapprCompRowBean = (DecTipoRapprCompRowBean) getForm().getTipoRapprCompList()
                .getTable().getCurrentRow();
    ...
    public void deleteStruttureList() throws EMFError {
        ...
        try {
            ...
            if (Application.Publisher.STRUTTURA_RICERCA.equalsIgnoreCase(param.getNomePagina())) {
                StruttureForm form = (StruttureForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form, form.getStruttureList()));
            } else {
    ...
    public void deleteTipoRapprCompList() throws EMFError {
        ...
        DecTipoRapprCompRowBean tipoRapprCompRowBean = (DecTipoRapprCompRowBean) getForm().getTipoRapprCompList()
                .getTable().getCurrentRow();
        try {
            ...
            if (Application.Publisher.CREA_STRUTTURA.equalsIgnoreCase(param.getNomePagina())) {
                StruttureForm form = (StruttureForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form, form.getTipoRapprCompList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            tipoRapprEjb.deleteDecTipoRapprComp(param, tipoRapprCompRowBean.getIdTipoRapprComp().longValue());
            getMessageBox()
                    .addMessage(new Message(MessageLevel.INF, "Tipologia Rappresentazione eliminata con successo"));
            final BigDecimal idStrut = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                    .getBigDecimal("id_strut");

            DecTipoRapprCompTableBean tipoRapprCompTableBean = tipoRapprEjb.getDecTipoRapprCompTableBean(idStrut,
    ...
    public void deleteCategorieStruttureList() throws EMFError {
        ...
        OrgCategStrutRowBean orgCategStrutRowBean = (OrgCategStrutRowBean) getForm().getCategorieStruttureList()
                .getTable().getCurrentRow();
        ...
        if (getMessageBox().isEmpty()) {
            ...
            getForm().getCategorieStruttureList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
    ...
    public void deleteCategorieEntiList() throws EMFError {
        ...
        OrgCategEnteRowBean orgCategEnteRowBean = (OrgCategEnteRowBean) getForm().getCategorieEntiList().getTable()
                .getCurrentRow();
        ...
        if (getMessageBox().isEmpty()) {
            ...
            OrgCategEnteTableBean orgCategEnteTableBean = ambienteEjb.getOrgCategEnteTableBean(orgCategEnteRowBean);
    ...
    public void reloadAfterGoBack(String publisherName) {
        ...
        BigDecimal idStrut = null;
        if (getForm().getStruttureList().getTable() != null && getForm().getStruttureList().getTable().size() > 0) {
            idStrut = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                    .getBigDecimal("id_strut");
        }
        try {
            ...
            if (idStrut != null) {
                ...
                if (publisherName.equals(Application.Publisher.STRUTTURA_RICERCA)) {
                    ...
                    if (!getForm().getTipoRapprCompList().getTable().isEmpty()) {
                        idTipoRapprComp = ((DecTipoRapprCompRowBean) getForm().getTipoRapprCompList().getTable()
                                .getCurrentRow()).getIdTipoRapprComp();
                        reloadTipoRapprCompLists(idTipoRapprComp);
                    }
                } else if (publisherName.equals(Application.Publisher.CATEGORIE_STRUTTURE_RICERCA)) {
                    ...
                    if (getForm().getXsdMigrStrutTab().getCurrentTab()
                        ...
                        xsdDatiSpecTableBean = datiSpecEjb.getDecXsdDatiSpecTableBean(idStrut,
                            ...
                            .equals(getForm().getXsdMigrStrutTab().getXsdMigrTipoDoc())) {
                        xsdDatiSpecTableBean = datiSpecEjb.getDecXsdDatiSpecTableBean(idStrut,
                                CostantiDB.TipiUsoDatiSpec.MIGRAZ.name(), CostantiDB.TipiEntitaSacer.DOC.name(),
                                nmSistemaMigraz);
                    } else if (getForm().getXsdMigrStrutTab().getCurrentTab()
                            .equals(getForm().getXsdMigrStrutTab().getXsdMigrTipoCompDoc())) {
                        xsdDatiSpecTableBean = datiSpecEjb.getDecXsdDatiSpecTableBean(idStrut,
                                CostantiDB.TipiUsoDatiSpec.MIGRAZ.name(), CostantiDB.TipiEntitaSacer.COMP.name(),
                                nmSistemaMigraz);
                    }
    ...
    public void duplicaStrutturaOperation() {
        ...
        getSession().setAttribute("idStrutToCopy",
                ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow()).getBigDecimal("id_strut"));
        ...
        setCheckInEditMode();
        if (((OrgVRicStrutRowBean) getForm().getStruttureList().getTable().getCurrentRow()).getFlTemplate()
                .equals("1")) {
    ...
    public void duplicaFormatoOperation() throws EMFError {
        ...
        if (isCessata) {
            getMessageBox().addError("La struttura \u00E8 cessata, impossibile duplicare il formato");
            forwardToPublisher(getLastPublisher());
        } else {
            String riga = getRequest().getParameter("riga");
            Integer nr = Integer.parseInt(riga);
            ...
            // fisso a false tutte le autorizzazioni a procedere con le altre fasi della listNavigationOnClick in questa
            // action
            this.setInsertAction(false);
            this.setEditAction(false);
            this.setDeleteAction(false);
    ...
    public JSONObject triggerVisStruttureId_ambienteOnTrigger() throws EMFError {
        ...
        if (getForm().getVisStrutture().getId_ambiente().parse() != null) {
            ...
            // Combo
            OrgEnteTableBean orgEnteTableBean = ambienteEjb.getEntiAbilitati(getUser().getIdUtente(),
                    getForm().getVisStrutture().getId_ambiente().parse().longValue(), Boolean.FALSE);
            orgEnteTableBean.addSortingRule("nm_ente", SortingRule.ASC);
            orgEnteTableBean.sort();
            for (OrgEnteRowBean row : orgEnteTableBean) {
                row.setString("nmDs", row.getNmEnte() + ", " + row.getDsEnte());
    ...
    public void tabXsdMigrTipoDocOnClick() throws EMFError {
        ...
        getForm().getXsdMigrStrutTab().setCurrentTab(getForm().getXsdMigrStrutTab().getXsdMigrTipoDoc());
        String nmSistemaMigraz = getForm().getGestioneXsdMigrazione().getNm_sistema_migraz().getDecodedValue();

        final BigDecimal idStrut = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                .getBigDecimal("id_strut");
        DecXsdDatiSpecTableBean xsdDatiSpecTableBean = datiSpecEjb.getDecXsdDatiSpecTableBean(idStrut,
                CostantiDB.TipiUsoDatiSpec.MIGRAZ.name(), CostantiDB.TipiEntitaSacer.DOC.name(), nmSistemaMigraz);
    ...
    public void tabXsdMigrTipoUnitaDocOnClick() throws EMFError {
        ...
        final BigDecimal idStrut = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                .getBigDecimal("id_strut");
        DecXsdDatiSpecTableBean xsdDatiSpecTableBean = datiSpecEjb.getDecXsdDatiSpecTableBean(idStrut,
                CostantiDB.TipiUsoDatiSpec.MIGRAZ.name(), CostantiDB.TipiEntitaSacer.UNI_DOC.name(), nmSistemaMigraz);
    ...
    public void tabXsdMigrTipoCompDocOnClick() throws EMFError {
        getForm().getXsdMigrStrutTab().setCurrentTab(getForm().getXsdMigrStrutTab().getXsdMigrTipoCompDoc());
        String nmSistemaMigraz = getForm().getGestioneXsdMigrazione().getNm_sistema_migraz().getDecodedValue();

        final BigDecimal idStrut = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                .getBigDecimal("id_strut");
        DecXsdDatiSpecTableBean xsdDatiSpecTableBean = datiSpecEjb.getDecXsdDatiSpecTableBean(idStrut,
                CostantiDB.TipiUsoDatiSpec.MIGRAZ.name(), CostantiDB.TipiEntitaSacer.COMP.name(), nmSistemaMigraz);
    ...
    public void cessaStruttura() throws EMFError {
        ...
        if (!getMessageBox().hasError()) {
            ...
            getForm().getInsStruttura().copyFromBean(strutRowBean);
            getMessageBox()
                    .addMessage(new Message(MessageLevel.INF, "Cessazione della struttura effettuata con successo"));
            setDettaglioStrutturaViewMode();
        }
    }
    // end MEV#21353
    ...
    private SalvaStrutturaDto getSalvaStrutturaDto() throws EMFError {
        ...
        String checkIncludiElementiDisattivi = getForm().getInsStruttura().getCheck_includi_elementi_disattivi()
                .parse();
    ...
    private void importOrgStrutXml() throws EMFError, JAXBException {
        ...
        try {
            ...
            // Se ho selezionato il check di struttura STANDARD, controllo anche di avere strutture template disponibili
            int numOfCheck = 0;
            ...
            if (!getMessageBox().hasError()) {
                ...
                if (!mime.equals(VerFormatiEnums.XML_MIME) && !mime.equals(VerFormatiEnums.TEXT_PLAIN_MIME)) {
                    getMessageBox().addError("Il formato del file caricato non corrisponde al tipo testo/xml");
                }
        ...
        if (idStrut != null) {
            ...
            if (!isFirst) {
                ...
                if (getForm().getRegistroUnitaDocList().getTable() != null) {
                    indMap.put("registroUnitaDoc", getForm().getRegistroUnitaDocList().getTable().getCurrentRowIndex());
                    indMap.put("registroUnitaDocPS", getForm().getRegistroUnitaDocList().getTable().getPageSize());
                }
                if (getForm().getTipoUnitaDocList().getTable() != null) {
                    indMap.put("tipoUnitaDoc", getForm().getTipoUnitaDocList().getTable().getCurrentRowIndex());
                    indMap.put("tipoUnitaDocPS", getForm().getTipoUnitaDocList().getTable().getPageSize());
                }
                ...
                if (getForm().getTipoStrutDocList().getTable() != null) {
                    ...
                    indMap.put("tipoStrutDocPS", getForm().getTipoStrutDocList().getTable().getPageSize());
                }
                if (getForm().getTipoRapprCompList().getTable() != null) {
                    indMap.put("tipoRapprComp", getForm().getTipoRapprCompList().getTable().getCurrentRowIndex());
                    indMap.put("tipoRapprCompPS", getForm().getTipoRapprCompList().getTable().getPageSize());
                }
                if (getForm().getCriteriRaggruppamentoList().getTable() != null) {
                    indMap.put("criteriRaggr",
                            getForm().getCriteriRaggruppamentoList().getTable().getCurrentRowIndex());
                    indMap.put("criteriRaggrPS", getForm().getCriteriRaggruppamentoList().getTable().getPageSize());
                }
                ...
                if (getForm().getSubStrutList().getTable() != null) {
                    indMap.put("subStrut", getForm().getSubStrutList().getTable().getCurrentRowIndex());
                    indMap.put("subStrutPS", getForm().getSubStrutList().getTable().getPageSize());
                }
                if (getForm().getTipologieSerieList().getTable() != null) {
                    indMap.put("tipoSerie", getForm().getTipologieSerieList().getTable().getCurrentRowIndex());
                    indMap.put("tipoSeriePS", getForm().getTipologieSerieList().getTable().getPageSize());
                }
                if (getForm().getSistemiMigrazioneList().getTable() != null) {
                    indMap.put("sysMigr", getForm().getSistemiMigrazioneList().getTable().getCurrentRowIndex());
                    indMap.put("sysMigrPS", getForm().getSistemiMigrazioneList().getTable().getPageSize());
                }
            ...
            registroUnitaDocTableBean.addSortingRule(DecRegistroUnitaDocTableDescriptor.COL_CD_REGISTRO_UNITA_DOC,
                    SortingRule.ASC);
            ...
            tipoUnitaTableBean.addSortingRule(DecTipoUnitaDocTableDescriptor.COL_NM_TIPO_UNITA_DOC, SortingRule.ASC);
            ...
            tipoStrutDocTableBean.addSortingRule(DecTipoStrutDocTableDescriptor.COL_NM_TIPO_STRUT_DOC, SortingRule.ASC);
            ...
            getForm().getTipoRapprCompList().setTable(tipoRapprCompTableBean);
            tipoRapprCompTableBean.addSortingRule(DecTipoRapprCompTableDescriptor.COL_NM_TIPO_RAPPR_COMP,
                    SortingRule.ASC);
            ...
            // Lista titolari
            getForm().getTitolariList().setTable(
                    titolariEjb.getDecTitolTableBean(idStrut, getForm().getTitolariList().isFilterValidRecords()));
            ...
            getForm().getTipologieSerieList().getTable().addSortingRule("nm_tipo_serie", SortingRule.ASC);
            ...
            getForm().getSistemiMigrazioneList().setTable(sysMigrazioneEjb.getOrgUsoSistemaMigrazTableBean(idStrut));
            getForm().getSistemiMigrazioneList().getTable().addSortingRule("nm_sistema_migraz", SortingRule.ASC);
            getForm().getSistemiMigrazioneList().getTable().sort();
            // Lista enti convenzionati
            getForm().getEnteConvenzOrgList().setTable(ambienteEjb.getSIOrgEnteConvenzOrgTableBean(idStrut));
            ...
            if (!indMap.isEmpty()) {
                if (getForm().getRegistroUnitaDocList().getTable() != null && indMap.containsKey("registroUnitaDoc")) {
                    getForm().getRegistroUnitaDocList().getTable().setCurrentRowIndex(indMap.get("registroUnitaDoc"));
                    getForm().getRegistroUnitaDocList().getTable().setPageSize(indMap.get("registroUnitaDocPS"));
                }
                if (getForm().getTipoUnitaDocList().getTable() != null && indMap.containsKey("tipoUnitaDoc")) {
                    getForm().getTipoUnitaDocList().getTable().setCurrentRowIndex(indMap.get("tipoUnitaDoc"));
                    getForm().getTipoUnitaDocList().getTable().setPageSize(indMap.get("tipoUnitaDocPS"));
                }
                if (getForm().getTipoDocList().getTable() != null && indMap.containsKey("tipoDoc")) {
                ...
                if (getForm().getTipoStrutDocList().getTable() != null && indMap.containsKey("tipoStrutDoc")) {
                    ...
                    getForm().getTipoStrutDocList().getTable().setPageSize(indMap.get("tipoStrutDocPS"));
                }
                if (getForm().getTipoRapprCompList().getTable() != null && indMap.containsKey("tipoRapprComp")) {
                    getForm().getTipoRapprCompList().getTable().setCurrentRowIndex(indMap.get("tipoRapprComp"));
                    getForm().getTipoRapprCompList().getTable().setPageSize(indMap.get("tipoRapprCompPS"));
                }
                if (getForm().getCriteriRaggruppamentoList().getTable() != null && indMap.containsKey("criteriRaggr")) {
                    getForm().getCriteriRaggruppamentoList().getTable().setCurrentRowIndex(indMap.get("criteriRaggr"));
                    getForm().getCriteriRaggruppamentoList().getTable().setPageSize(indMap.get("criteriRaggrPS"));
                }
                ...
                if (getForm().getTipologieSerieList().getTable() != null && indMap.containsKey("tipoSerie")) {
                    getForm().getTipologieSerieList().getTable().setCurrentRowIndex(indMap.get("tipoSerie"));
                    getForm().getTipologieSerieList().getTable().setPageSize(indMap.get("tipoSeriePS"));
                }
                if (getForm().getSubStrutList().getTable() != null && indMap.containsKey("subStrut")) {
                    getForm().getSubStrutList().getTable().setCurrentRowIndex(indMap.get("subStrut"));
                    getForm().getSubStrutList().getTable().setPageSize(indMap.get("subStrutPS"));
                }
                if (getForm().getSistemiMigrazioneList().getTable() != null && indMap.containsKey("sysMigr")) {
                    getForm().getSistemiMigrazioneList().getTable().setCurrentRowIndex(indMap.get("sysMigr"));
                    getForm().getSistemiMigrazioneList().getTable().setPageSize(indMap.get("sysMigrPS"));
                }
                if (getForm().getEnteConvenzOrgList().getTable() != null && indMap.containsKey("enteConvenz")) {
    ...
    public void loadXsdTipoUd() throws EMFError {
        ...
        StringBuilder string = new StringBuilder("?operation=listNavigationOnClick&navigationEvent=dettaglioView&table="
    ...
    public void loadXsdTipoDoc() throws EMFError {
        ...
        DecXsdDatiSpecRowBean xsdRow = datiSpecEjb.getLastDecXsdDatiSpecRowBean(idStrut, null,
                ((DecTipoDocRowBean) getForm().getTipoDocList().getTable().getCurrentRow()).getIdTipoDoc(), null);
        DecXsdDatiSpecTableBean xsdTable = new DecXsdDatiSpecTableBean();
        xsdTable.add(xsdRow);
        xsdTable.setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        form.getXsdDatiSpecList().setTable(xsdTable);
        ...
        string.append("&idTipoDoc=").append(
                ((DecTipoDocRowBean) getForm().getTipoDocList().getTable().getCurrentRow()).getIdTipoDoc().intValue());
        string.append("&cessato=").append(getForm().getInsStruttura().getFl_cessato().parse());
        form.getIdList().getId_tipo_doc().setValue(
                ((DecTipoDocRowBean) getForm().getTipoDocList().getTable().getCurrentRow()).getIdTipoDoc().toString());

        getSession().setAttribute("lastPage", "tipoDoc");
        form.getTipoDocRif().getNm_tipo_doc()
                .setValue(((DecTipoDocRowBean) getForm().getTipoDocList().getTable().getCurrentRow()).getNmTipoDoc());
    ...
    public void confermaSceltaDup() throws EMFError {
        ...
        if (getMessageBox().isEmpty()) {
            ...
            if (getRequest().getParameter("Check_dup_strut") != null) {
                ...
                getSession().setAttribute(SES_ATTRIB_SALVATAGGIO, TipoSalvataggio.DUPLICA_NON_STANDARD);
            } else {
    ...
    public void populateComboStrut(BaseRowInterface strutRowBean) {
        ...
        mappaEnti.populatedMap(orgEnteTableBean, "id_ente", "nm_ente");
        getForm().getInsStruttura().getId_ente_rif().setDecodeMap(mappaEnti);
        getForm().getInsStruttura().getId_ente_rif().setValue(orgEnteRowBean.getIdEnte().toString());
        ...
        getForm().getInsStruttura().getId_ambiente_rif().setValue(orgEnteRowBean.getIdAmbiente().toString());
    ...
    public void updateNode() throws EMFError {
        ...
        if (publisher.equals(Application.Publisher.GESTIONE_CATEGORIE_TIPO_UD)) {
            ...
            if (getForm().getCategorieTipoUd().getId_to_update().parse() == null) {
                ...
                getSession().setAttribute("idToUpdate", getForm().getCategorieTipoUd().getId_to_update().parse());
            }
            ...
            try {
                if (getMessageBox().isEmpty()) {
                    ...
                    if (getForm().getCategorieTipoUd().getStatus().equals(Status.update)) {
                        ...
                        tipoUnitaDocEjb.updateDecCategTipoUnitaDoc(idToUpdate, categTipoUnitaDocRowBean);
                    }
                    getForm().getCategorieTipoUd().setViewMode();
                    getForm().getCategorieTipoUd().clear();
                    reloadCategTipoUdTreeCombo();
    ...
    public void reloadCategTipoUdTreeCombo() {
        DecCategTipoUnitaDocTableBean tableBean = tipoUnitaDocEjb.getDecCategTipoUnitaDocTableBean(false);
        getForm().getGestCatTiUdTree().setTable(tableBean);

        DecodeMap map = new DecodeMap();
        DecCategTipoUnitaDocTableBean tableCategFirstLevel = tipoUnitaDocEjb.getDecCategTipoUnitaDocTableBean(true);
        map.populatedMap(tableCategFirstLevel, "id_categ_tipo_unita_doc", "cd_categ_tipo_unita_doc");
    ...
    public void ricercaCategorieStrutButton() throws EMFError {
        ...
        OrgCategStrutTableBean orgCategStrutTableBean = struttureEjb.getOrgCategStrutTableBean(categStrutRowBean);
        getForm().getCategorieStruttureList().setTable(orgCategStrutTableBean);
        getForm().getCategorieStruttureList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        getForm().getCategorieStruttureList().getTable().first();
            ...
            try {
                if (possoSalvare) {
                    ...
                    if (getForm().getCategorieEnti().getStatus().equals(Status.insert)) {
                        ...
                        getMessageBox()
                                .addMessage(new Message(MessageLevel.INF, "Nuova categoria enti salvata con successo"));
                        ...
                        getForm().getCategorieEntiList().getTable()
                                .setCurrentRowIndex(getForm().getCategorieEntiList().getTable().getCurrentRowIndex());
                        getMessageBox().addMessage(
                                new Message(MessageLevel.INF, "Update della categoria enti effettuato con successo"));
    ...
    public void ricercaCategorieEnteButton() throws EMFError {
        ...
        OrgCategEnteTableBean orgCategEnteTableBean = ambienteEjb.getOrgCategEnteTableBean(categEnteRowBean);
        getForm().getCategorieEntiList().setTable(orgCategEnteTableBean);
        getForm().getCategorieEntiList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        getForm().getCategorieEntiList().getTable().first();
    ...
    public void importazioneTitolario() throws EMFError {
        ...
        form.getStrutRif().getStruttura().setValue(getForm().getInsStruttura().getNm_strut().parse() + " - "
                + getForm().getInsStruttura().getDs_strut().parse());
        form.getStrutRif().getId_ente().setValue(getForm().getInsStruttura().getId_ente().getDecodedValue());

        redirectToAction(Application.Actions.STRUT_TITOLARI, "?operation=loadImportaTitolario", form);
    }
    ...
    public void inserimentoManualeTitolario() throws EMFError {
        ...
        redirectToAction(Application.Actions.STRUT_TITOLARI, "?operation=loadWizard" + updateRiga, form);
    }
    ...
    private void reloadTipoRapprCompLists(BigDecimal idTipoRapprComp) throws EMFError {
        ...
        getForm().getTipoCompAmmessoDaTipoRapprCompList().getTable().setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        ...
        getForm().getTipoRapprComp().getLogEventiTipoRapprComp().setEditMode();
        if ("1".equals(getForm().getInsStruttura().getFl_cessato().parse())) {
            getForm().getTipoCompAmmessoDaTipoRapprCompList().setUserOperations(true, false, false, false);
            getForm().getTrasformTipoRapprList().setUserOperations(true, false, false, false);
        } else {
            getForm().getTipoCompAmmessoDaTipoRapprCompList().setUserOperations(true, true, true, true);
    ...
    private void redirectToSubStrutPage(String action) throws EMFError {
        ...
        form.getStrutRif().getStruttura().setValue(getForm().getInsStruttura().getNm_strut().parse() + " - "
                + getForm().getInsStruttura().getDs_strut().parse());
        form.getStrutRif().getId_ente().setValue(getForm().getInsStruttura().getId_ente().getDecodedValue());
        form.getStrutRif().getFl_template().setValue(getForm().getInsStruttura().getFl_template().getValue());
        form.getStrutRif().getId_strut()
                .setValue(((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
    ...
    private void redirectToTitolarioPage(String action) throws EMFError {
        ...
        form.getTitolariList().setTable(getForm().getTitolariList().getTable());
        form.getTitolariList().setFilterValidRecords(getForm().getTitolariList().isFilterValidRecords());
    ...
    private void redirectToTipologiaSeriaPage(String action) throws EMFError {
        ...
        try {
            ...
            utile.initGenericComboAmbienteEnteStruttura(form.getFiltriTipologieSerie(), getUser().getIdUtente(),
                    idStrut, Boolean.TRUE);
        } catch (ParerUserError ex) {
    ...
    private StrutTipiForm prepareRedirectToStrutTipi() {
        ...
        OrgEnteRowBean enteBean = struttureEjb.getOrgEnteRowBean(strutBean.getBigDecimal("id_ente"));
        OrgAmbienteRowBean ambienteBean = struttureEjb.getOrgAmbienteRowBean(enteBean.getIdAmbiente());
        form.getStrutRif().getId_ente().setValue(enteBean.getNmEnte());
        form.getStrutRif().getStruttura()
                .setValue(strutBean.getString("nm_strut") + " (" + strutBean.getString("ds_strut") + ")");
    ...
    private void redirectToRegistroPage() throws EMFError {
        ...
        redirectToPage(Application.Actions.STRUT_TIPI, form, form.getRegistroUnitaDocList().getName(),
    ...
    private void redirectToTipologiaUnitaDocPage() throws EMFError {
        StrutTipiForm form = prepareRedirectToStrutTipi();
        /*
         * Se non è un tentativo d'inserimento di un nuovo Tipo unita documentaria mantengo il valore dell'id in modo da
         * poterlo riusare nella gestione del dettaglio
         */
        if (!NE_DETTAGLIO_INSERT.equals(getNavigationEvent())) {
            form.getIdList().getId_tipo_unita_doc()
                    .setValue(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList().getTable().getCurrentRow())
                            .getIdTipoUnitaDoc().toPlainString());
        } else {
            form.getIdList().getId_tipo_unita_doc().setValue(null);
        }
        form.getTipoUnitaDocList().setFilterValidRecords(getForm().getTipoUnitaDocList().isFilterValidRecords());
    ...
    private void redirectToTipoDocPage() throws EMFError {
        ...
        form.getTipoDocList().setFilterValidRecords(getForm().getTipoDocList().isFilterValidRecords());
    ...
    private void redirectToTipoFascicoloPage() throws EMFError {
        ...
        form.getTipoFascicoloList().setFilterValidRecords(getForm().getTipoFascicoloList().isFilterValidRecords());
        redirectToPage(Application.Actions.STRUT_TIPI_FASCICOLO, form, form.getTipoFascicoloList().getName(),
                getForm().getTipoFascicoloList().getTable(), getNavigationEvent());
    }

    private void redirectToTipoStrutDocPage() throws EMFError {
        StrutTipoStrutForm form = prepareRedirectToStrutTipoStrut();
        form.getTipoStrutDocList().setFilterValidRecords(getForm().getTipoStrutDocList().isFilterValidRecords());
    ...
    private void redirectToFormatoFileDocPage() throws EMFError {
        ...
        redirectToPage(Application.Actions.STRUT_FORMATO_FILE, form, form.getFormatoFileDocList().getName(),
    ...
    private void redirectToPage(final String action, BaseForm form, String listToPopulate, BaseTableInterface<?> table,
        ...
        redirectToAction(action,
                "?operation=listNavigationOnClick&navigationEvent=" + event + "&table=" + listToPopulate + "&riga="
                        + table.getCurrentRowIndex() + "&cessato="
                        + getForm().getInsStruttura().getFl_cessato().parse(),
                form);
    }
     ...
     */
    public CriteriRaggruppamentoForm initComboAmbienteEnteStrutCreaCriteriRaggr(BigDecimal idStrut) {
    ...
    public void filterInactiveRecordsRegistroUnitaDocList() throws EMFError {
        ...
        // Lista registri
        DecRegistroUnitaDocTableBean registroUnitaDocTableBean = registroEjb.getDecRegistroUnitaDocTableBean(idStrut,
                getForm().getRegistroUnitaDocList().isFilterValidRecords());
    ...
    public void filterInactiveRecordsTipoFascicoloList() throws EMFError {
        ...
        tipoFascicoloTableBean = tipoFascicoloEjb.getTipiFascicoloAbilitati(getUser().getIdUtente(), idStrut,
                getForm().getTipoFascicoloList().isFilterValidRecords());

        getForm().getTipoFascicoloList().setTable(tipoFascicoloTableBean);
        tipoFascicoloTableBean.addSortingRule(DecTipoFascicoloTableDescriptor.COL_NM_TIPO_FASCICOLO, SortingRule.ASC);
        tipoFascicoloTableBean.sort();
    ...
    public void filterInactiveRecordsTipoRapprCompList() throws EMFError {
        ...
        getForm().getTipoRapprCompList().setTable(tipoRapprCompTableBean);
        tipoRapprCompTableBean.addSortingRule(DecTipoRapprCompTableDescriptor.COL_NM_TIPO_RAPPR_COMP, SortingRule.ASC);
        tipoRapprCompTableBean.sort();
    ...
    public void filterInactiveRecordsFormatoFileDocList() throws EMFError {
        ...
        DecFormatoFileDocTableBean formatoFileDocTableBean = formatoFileDocEjb.getDecFormatoFileDocTableBean(idStrut,
    ...
    public void deleteTipoCompAmmessoDaTipoRapprCompList() {
        ...
        try {
            ...
            if (param.getNomePagina().equalsIgnoreCase(Application.Publisher.ASSOCIAZIONE_TIPO_RAPPR_COMP_TIPO_COMP)) {
                ...
                param.setNomeAzione(
                        SpagoliteLogUtil.getDetailActionNameDelete(form, form.getTipoCompAmmessoDaTipoRapprCompList()));
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            BigDecimal idTipoRapprAmmesso = ((DecTipoRapprAmmessoTableBean) getForm()
                    .getTipoCompAmmessoDaTipoRapprCompList().getTable()).getCurrentRow().getIdTipoRapprAmmesso();
            tipoStrutDocEjb.deleteDecTipoRapprAmmesso(param, idTipoRapprAmmesso, idTipoRapprAmmesso);
            getMessageBox().addMessage(new Message(MessageLevel.INF, "Tipo componente ammesso eliminato con successo"));
            ...
            if (Application.Publisher.ASSOCIAZIONE_TIPO_RAPPR_COMP_TIPO_COMP.equals(getLastPublisher())) {
                goBack();
            } else {
                forwardToPublisher(Application.Publisher.TIPO_RAPPR_COMP_DETAIL);
            }
    ...
    private void salvaTipoCompAmmesso() throws EMFError {
        ...
        BigDecimal idTipoComp = getForm().getTipoCompAmmessoDaTipoRapprComp().getId_tipo_comp_doc().parse();
        if (idTipoComp == null) {
        ...
        try {
            if (getMessageBox().isEmpty()) {
                ...
                param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
                BigDecimal idTipoRapprComp = getForm().getTipoRapprComp().getId_tipo_rappr_comp().parse();
                if (getForm().getTipoCompAmmessoDaTipoRapprComp().getStatus().equals(Status.insert)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarInsert());
                    tipoStrutDocEjb.insertDecTipoRapprAmmesso(param, idTipoComp, idTipoRapprComp);
                    getMessageBox().addMessage(new Message(MessageLevel.INF, "Tipo componente inserito con successo!"));
                    /* Inserisco la riga in fondo alla tabella */
                    DecTipoRapprAmmessoRowBean row = tipoStrutDocEjb.getDecTipoRapprAmmessoRowBean(idTipoComp,
                            idTipoRapprComp);
                ...
                } else if (getForm().getTipoCompAmmessoDaTipoRapprComp().getStatus().equals(Status.update)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                    /* Ricavo il valore dell'idTipoStrutDoc già memorizzato su DB e di quello che sto modificando */
                    BigDecimal idTipoRapprAmmessoDB = ((DecTipoRapprAmmessoRowBean) getForm()
                            .getTipoCompAmmessoDaTipoRapprCompList().getTable().getCurrentRow())
                                    .getIdTipoRapprAmmesso();
                    tipoStrutDocEjb.updateDecTipoRapprAmmesso(param, idTipoRapprAmmessoDB, idTipoComp, idTipoRapprComp);
                    getMessageBox()
                            .addMessage(new Message(MessageLevel.INF, "Tipo componente modificato con successo!"));
                    /*
                     * Setto sulla lista (ancora da ricaricare) il nuovo valore di idTipoCompDoc, in maniera tale che in
                     * caso di immediata ri-modifica prenda su, dalla loadDettaglio, il valore corretto
                     */
                    ((DecTipoRapprAmmessoRowBean) getForm().getTipoCompAmmessoDaTipoRapprCompList().getTable()
                            .getCurrentRow()).setIdTipoCompDoc(idTipoComp);
                }
                getMessageBox().setViewMode(ViewMode.plain);
                getForm().getTipoCompAmmessoDaTipoRapprComp().setViewMode();
    ...
    @Override
    public JSONObject triggerTipoCompAmmessoDaTipoRapprCompId_tipo_strut_docOnTrigger() throws EMFError {

        BigDecimal idStrut = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                .getBigDecimal("id_strut");
        getForm().getTipoCompAmmessoDaTipoRapprComp().getId_tipo_strut_doc().post(getRequest());
        BigDecimal idTipoStrutDoc = getForm().getTipoCompAmmessoDaTipoRapprComp().getId_tipo_strut_doc().parse();

        DecTipoCompDocTableBean tipoCompDoc = tipoStrutDocEjb.getDecTipoCompDocTableBean(idStrut, new Date(),
                idTipoStrutDoc);
        DecodeMap mappaTipoCompDoc = new DecodeMap();
        mappaTipoCompDoc.populatedMap(tipoCompDoc, "id_tipo_comp_doc", "nm_tipo_comp_doc");
        getForm().getTipoCompAmmessoDaTipoRapprComp().getId_tipo_comp_doc().setDecodeMap(mappaTipoCompDoc);
    ...
    public void loadDettaglioTipoCompDoc() throws EMFError {
        ...
        DecTipoCompDocRowBean tipoCompDocRow = tipoStrutDocEjb.getDecTipoCompDocRowBean(idTipoCompDoc);
    ...
    private void redirectToTipoCompPage(DecTipoRapprAmmessoRowBean row) throws EMFError {
        ...
        redirectToPage(Application.Actions.STRUT_TIPO_STRUT, form, form.getTipoCompDocList().getName(),
                getForm().getTipoCompAmmessoDaTipoRapprCompList().getTable(), getNavigationEvent());
    }

    /**
     * Bottone per l'inserimento del file xml di configurazione: resetto l'oggetto wizard, imposto il campo multipart
     * editabile e forwordo alla pagina del wizard
     *
     * @throws EMFError
     *             errore generico
     */
    ...
    public void importaParametriDaRicercaButton() throws EMFError {
        ...
        if (struttureDaElaborare.size() > 0) {
            ...
            getMessageBox().addError("E’ necessario selezionare le strutture ove eseguire l’importazione");
            forwardToPublisher(Application.Publisher.STRUTTURA_RICERCA);
        }
    }
    ...
    /**
     * Chiusura primo step: - Verifica se è stato caricato il file XML, quindi carica il secondo step, altrimenti mostra
        ...
        if (getForm().getImportaParametri().validate(getMessageBox())) {
            try {
                if (getForm().getImportaParametri().getNm_tipo_unita_doc().parse() != null) {
                    ...
                    /*
                     * Se il flag “Includi registri collegati” è true viene verificato se almeno un registro da
                     * importare cui il tipo Ud è collegato presenta il flag “fl_tipo_serie_mult” a 1 ed in caso lancio
                    ...
                    if (importareRegistri.equals("1") && existRegistriDaImportareConFlTipoSerieMultAlzato) {
                        getRequest().setAttribute("customBoxImportaParametri", true);
                        getSession().setAttribute("existRegistriDaImportareConFlTipoSerieMultAlzato",
    ...
    public JSONObject triggerImportaParametriNm_tipo_unita_docOnTrigger() throws EMFError {
        ...
        List<String> nmTipoUnitaDocList = getForm().getImportaParametri().getNm_tipo_unita_doc().parse();
        UUID uuid = (UUID) getSession().getAttribute("uuid");
        if (nmTipoUnitaDocList.size() == 1) {
            ...
            getForm().getImportaParametri().getNm_tipo_strut_unita_doc().setDecodeMap(new DecodeMap());
        }
    ...
    private DecodeMap getTipiUdDaXmlDecodeMap(UUID uuid) {
        ...
        DecTipoUnitaDocTableBean decTipoUnitaDocTableBean = struttureEjb.getTipiUdDaXmlImportato(uuid);
        mappaTipiUd.populatedMap(decTipoUnitaDocTableBean, "nm_tipo_unita_doc", "nm_tipo_unita_doc");
        return mappaTipiUd;
    }
    ...
    public void confermaImportaParametri() throws EMFError {
        try {
            ...
            if (getSession().getAttribute("existRegistriDaImportareConFlTipoSerieMultAlzato") != null) {
    ...
    private void eseguiImportaParametri(boolean existRegistriDaImportareConFlTipoSerieMultAlzato)
            throws ParerUserError, EMFError {
        /*
         * N.B. non c'è bisogno di fare post perchè viene già fatto nel process() per quanto riguarda questo caso
         * particolare di wizard multipart...
         */
        List<String> tipoUdDaImportareList = getForm().getImportaParametri().getNm_tipo_unita_doc().parse();
        String tipoStrutUdDaImportare = getForm().getImportaParametri().getNm_tipo_strut_unita_doc().parse();
        String importareCriteri = getForm().getImportaParametri().getCheck_includi_criteri().parse();
        BigDecimal idStrutturaCorrente = ((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                .getBigDecimal("id_strut");
        ...
        try {
            ...
            for (String tipoUdDaImportare : tipoUdDaImportareList) {
                ...
                getMessageBox().addInfo(
                        "Esecuzione dell’importazione del tipo di unità documentaria " + tipoUdDaImportare + "<br>");
    ...
    private void loadStruttura(BigDecimal idStrut) throws EMFError, ParerUserError {
        ...
        OrgAmbienteRowBean orgAmbienteRowBean = ambienteEjb.getOrgAmbienteRowBean(orgEnteRowBean.getIdAmbiente());
        ...
        mappaAmbienti.populatedMap(ambienteTableBean, "id_ambiente", "nm_ambiente");
        getForm().getInsStruttura().getId_ambiente_rif().setDecodeMap(mappaAmbienti);
        getForm().getInsStruttura().getId_ambiente_rif().setValue("" + orgAmbienteRowBean.getIdAmbiente());
        ...
        if ("1".equals(getForm().getInsStruttura().getFl_cessato().parse())) {
            getForm().getParametriStrutturaButtonList().getParametriAmministrazioneStrutturaButton().setViewMode();
            getForm().getParametriStrutturaButtonList().getParametriConservazioneStrutturaButton().setViewMode();
            getForm().getParametriStrutturaButtonList().getParametriGestioneStrutturaButton().setViewMode();
        } else {
            getForm().getParametriStrutturaButtonList().getParametriAmministrazioneStrutturaButton().setEditMode();
            getForm().getParametriStrutturaButtonList().getParametriConservazioneStrutturaButton().setEditMode();
            getForm().getParametriStrutturaButtonList().getParametriGestioneStrutturaButton().setEditMode();
        }
    }
    ...
    /*
     * Carica le liste dei parametri a video dal Database oppure dall'entità orgStrut importata se diversa da null.
     */
    private void loadListeParametriStrutturaPerDupImp(OrgStrutRowBean orgStrutRowBean, boolean hideDeleteButtons,
            boolean editMode, OrgStrut orgStrutImportata) throws ParerUserError {
        Object[] parametriObj = null;
        if (orgStrutImportata == null) {
            parametriObj = amministrazioneEjb.getAplParamApplicRowBeansFromStruttura(orgStrutRowBean);
        } else {
            parametriObj = amministrazioneEjb.getAplParamApplicRowBeansFromStrutturaImportata(orgStrutImportata);
        }
        getForm().getParametriAmministrazioneSection().setLoadOpened(true);
        getForm().getParametriConservazioneSection().setLoadOpened(true);
        getForm().getParametriGestioneSection().setLoadOpened(true);
        getForm().getParametriAmministrazioneStrutturaList().setTable((AplParamApplicTableBean) parametriObj[0]);
        getForm().getParametriAmministrazioneStrutturaList().getTable().setPageSize(300);
        getForm().getParametriAmministrazioneStrutturaList().getTable().first();
        getForm().getParametriGestioneStrutturaList().setTable((AplParamApplicTableBean) parametriObj[1]);
        getForm().getParametriGestioneStrutturaList().getTable().setPageSize(300);
    ...
    /**
     * Al clic del bottone popolo una combo degli ambienti cui l'utente è abilitato, setto l'attributo che mi dice di
     * visualizzare la finestrella ed infine redireziono alla pagina stessa che deve essere ricaricata per recepire
     * codeste direttive
     *
     * @throws EMFError
     *             errore generico
    ...
    public void creaStruttureTemplate() throws EMFError {
        ...
        ambienteTableBean.sort();
        mappaAmbienti.populatedMap(ambienteTableBean, "id_ambiente", "nm_ambiente");
        getForm().getStruttureTemplateCreator().getId_ambiente_strutture_template().setDecodeMap(mappaAmbienti);
        /*
         * Ricarico la pagina in maniera tale che, col parametrozzo settato in request, a sto giro mi venga visualizzata
         * la finestrella
         */
    ...
    public void confermaCreazioneStruttureTemplate() throws EMFError {
        /*
         * Controllo la provenienza: via finestrella JavaScript o noJavaScript? N.B.: procedura migliorabile facendo in
         * modo di "settare" in request anche tramite finestrella JavaScript il valore delle combo selezionate senza
         * passarle come parametro come fatto di seguito...
         */
        ...
        if (Boolean.parseBoolean(isFromAjax)) {
            ...
            idAmbienteSelezionato = getForm().getStruttureTemplateCreator().getId_ambiente_strutture_template().parse();
            nmAmbienteSelezionato = getForm().getStruttureTemplateCreator().getId_ambiente_strutture_template()
                    .getDecodedValue();
            idEnteSelezionato = getForm().getStruttureTemplateCreator().getId_ente_strutture_template().parse();
            nmEnteSelezionato = getForm().getStruttureTemplateCreator().getId_ente_strutture_template()
                    .getDecodedValue();
        }
        ...
        if (idAmbienteSelezionato != null) {
            ...
            // Se ho selezionato SOLO L'AMBIENTE, devo prendere un ente a caso tra quelli template delle'ambiente
            // selezionato
            if (idEnteSelezionato == null) {
                OrgVRicEnteTableBean orgVRicEnteTemplateTableBean = ambienteEjb.getEntiAbilitatiTemplate(
                        getUser().getIdUtente(), idAmbienteSelezionato,
                        CostantiDB.TipoDefTemplateEnte.TEMPLATE_DEF_AMBIENTE.name());
                // Se NON esiste almeno un ente con tipo_def_template_ente = TEMPLATE_DEF_AMBIENTE per l'ambiente
                // selezionato
                if (orgVRicEnteTemplateTableBean.isEmpty()) {
                    ...
                    // Se invece ne esiste almeno uno, prendo il primo che trovo (come diceva quella pubblicità della
                    // FIAT del 2002, "adesso esco e vado col primo template che incontro!")
                    idEntePerCreazioneStruttureTemplate = orgVRicEnteTemplateTableBean.getRow(0).getIdEnte();
                    nmEntePerCreazioneStruttureTemplate = orgVRicEnteTemplateTableBean.getRow(0).getNmEnte();
                }
            }

            if (!getMessageBox().hasError()) {
                // Determino le strutture template disponibili già presenti per l'ambiente (ed eventualmente ente)
                // selezionato/i
                int numStruttureTemplateGiaPresenti = (int) struttureEjb.countOrgStrutTemplatePerAmbienteEnte(
                        idAmbienteSelezionato.longValue(),
                ...
                if (numStruttureTemplateDaCreare <= 0) {
                    getMessageBox()
                            .addError("Il numero di strutture template disponibili nell'ambiente/ente selezionato "
                    ...
                    int[] progressivi = struttureEjb
                            .getProgressiviPerCreazioneStruttureTemplate(numStruttureTemplateDaCreare);

                    idEntePerCreazioneStruttureTemplate = idEnteSelezionato != null ? idEnteSelezionato
                            : idEntePerCreazioneStruttureTemplate;
                    nmEntePerCreazioneStruttureTemplate = nmEnteSelezionato != null ? nmEnteSelezionato
                    ...
                    while (numStruttureTemplateDaCreare != 0) {
                        ...
                        try {
                            /*
                             * a questo metodo come LogParam viene passato null in quanto non serve perché non dovrà
                             * loggare applicativamente la struttura in caso di Template.
                             */
                            ...
                            getMessageBox()
                                    .addError("Errore durante la creazione massiva di una o più strutture template");
                        }
                    ...
                    if (!getMessageBox().hasError()) {
                        ...
                        getForm().getStruttureTemplate().getNum_strut_templ_disp()
                                .setValue(struttureEjb.countOrgStrutTemplateRaggruppati(getUser().getIdUtente()));
                        getForm().getStruttureTemplate().getNum_strut_templ_part().setValue(struttureEjb
                                .countOrgStrutTemplateWithCompletedPartitioningRaggruppati(getUser().getIdUtente()));
                        String messageInfo = "Create "
                                + (numMassimoStruttureTemplateCreabili - numStruttureTemplateGiaPresenti) + " "
                        ...
                        if (nmEntePerCreazioneStruttureTemplate != null
                            ...
                            messageInfo = messageInfo + " nell'ente " + nmEntePerCreazioneStruttureTemplate;
                        }
    ...
    public void eliminaTuttiFormatiFileDoc() {
        ...
        param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
        List<String> formatiNonEliminati = formatoFileDocEjb.deleteDecFormatoFileDocList(param, idStrut,
                formatiDaEliminare);
        if (!formatiNonEliminati.isEmpty()) {
            ...
            getMessageBox().addMessage(
                    new Message(Message.MessageLevel.INF, "Tutti i formati ammessi sono stati eliminati con successo"));
        }
        DecFormatoFileDocTableBean formatoFileDocTableBean = formatoFileDocEjb.getDecFormatoFileDocTableBean(idStrut,
                getForm().getFormatoFileDocList().isFilterValidRecords());
        getForm().getFormatoFileDocList().setTable(formatoFileDocTableBean);
    ...
    public void setComboEntiAbilitatiTemplate(BigDecimal idAmbiente) {
        OrgVRicEnteTableBean enteTableBean = ambienteEjb.getEntiAbilitatiTemplate(getUser().getIdUtente(), idAmbiente,
                CostantiDB.TipoDefTemplateEnte.TEMPLATE_DEF_ENTE.name());
        DecodeMap mappaEnti = new DecodeMap();
        mappaEnti.populatedMap(enteTableBean, "id_ente", "nm_ente");
        getForm().getStruttureTemplateCreator().getId_ente_strutture_template().setDecodeMap(mappaEnti);
    }

    @Override
    public void ricaricaAmbiente() throws EMFError {
        getForm().getStruttureTemplateCreator().post(getRequest());
        BigDecimal idAmbiente = getForm().getStruttureTemplateCreator().getId_ambiente_strutture_template().parse();
        if (idAmbiente != null) {
    ...
    public void duplicaRegistroOperation() throws EMFError {
        ...
        if (isCessata) {
            ...
            // Siccome me devo spostà nell'altra action (StrutTipiForm), la quale gestisce il dettaglio del registro, mi
            // preparo per il trasloco
            StrutTipiForm form = prepareRedirectToStrutTipi();
            form.getRegistroUnitaDocList()
                    .setFilterValidRecords(getForm().getRegistroUnitaDocList().isFilterValidRecords());
            // Inserisco la lista registri presente in StruttureAction nella lista registri di StrutTipiAction
            ((it.eng.spagoLite.form.list.List<SingleValueField<?>>) form
            ...
            redirectToAction(Application.Actions.STRUT_TIPI,
                    "?operation=duplicaRegistroOperation&table=RegistroUnitaDocList&riga=" + numeroRiga, form);
        }
    }
    ...
    public JSONObject triggerVisStruttureId_regione_statoOnTrigger() throws EMFError {
        ...
        OrgAmbitoTerritTableBean ambito2LivelloTableBean = ambienteEjb.getOrgAmbitoTerritChildTableBean(idRegioneStato);
    ...
    public JSONObject triggerVisStruttureId_provinciaOnTrigger() throws EMFError {
        ...
        OrgAmbitoTerritTableBean ambito3LivelloTableBean = ambienteEjb.getOrgAmbitoTerritChildTableBean(idProvincia);
    ...
    public JSONObject triggerVisStruttureId_ambiente_ente_convenzOnTrigger() throws EMFError {
        getForm().getVisStrutture().post(getRequest());
        BigDecimal idAmbienteEnteConvenz = getForm().getVisStrutture().getId_ambiente_ente_convenz().parse();
        // Ricavo il TableBean relativo agli enti convenzionati
        BaseTable enteConvenzTableBean = ambienteEjb.getSIOrgEnteConvenzTableBean(getUser().getIdUtente(),
    ...
    public JSONObject triggerInsStrutturaId_ambiente_ente_convenzOnTrigger() throws EMFError {
        getForm().getInsStruttura().post(getRequest());
        BigDecimal idAmbienteEnteConvenz = getForm().getInsStruttura().getId_ambiente_ente_convenz().parse();
        // Ricavo il TableBean relativo agli enti convenzionati
        BaseTable enteConvenzTableBean = ambienteEjb.getSIOrgEnteConvenzAccordoValidoTableBean(getUser().getIdUtente(),
                idAmbienteEnteConvenz);
        DecodeMap mappaEntiConvenz = new DecodeMap();
        mappaEntiConvenz.populatedMap(enteConvenzTableBean, "id_ente_siam", "nm_ente_siam");
        getForm().getInsStruttura().getId_ente_convenz().setDecodeMap(mappaEntiConvenz);
    ...
    public JSONObject triggerInsStrutturaId_ente_convenzOnTrigger() throws EMFError {
        ...
        try {
            ...
            if (dateEnteSiamStrut != null) {
                ...
                //
                getForm().getInsStruttura().getDt_ini_val().setValue(formato.format(Calendar.getInstance().getTime()));
                Calendar c = Calendar.getInstance();
                c.set(2444, Calendar.DECEMBER, 31, 0, 0, 0);
    ...
    private void redirectToEnteConvenzPage(String action) throws EMFError {
        ...
        form.getStrutRif().getStruttura().setValue(getForm().getInsStruttura().getNm_strut().parse() + " ( "
                + getForm().getInsStruttura().getDs_strut().parse() + ")");
        form.getStrutRif().getNm_ente().setValue(getForm().getInsStruttura().getId_ente().getDecodedValue());
        form.getStrutRif().getId_strut()
                .setValue(((BaseRowInterface) getForm().getStruttureList().getTable().getCurrentRow())
                        .getBigDecimal("id_strut").toPlainString());
    ...
    public void loadStrutDaMenu() {
        ...
        redirectToAction(Application.Actions.STRUTTURE, "?operation=listNavigationOnClick&navigationEvent="
                + NE_DETTAGLIO_VIEW + "&table=" + form.getStruttureList().getName() + "&riga=0", form);
    }
    ...
    public void deleteParametriAmministrazioneStrutturaList() throws EMFError {
        AplParamApplicRowBean row = (AplParamApplicRowBean) getForm().getParametriAmministrazioneStrutturaList()
                .getTable().getCurrentRow();
    ...
    public void deleteParametriConservazioneStrutturaList() throws EMFError {
        AplParamApplicRowBean row = (AplParamApplicRowBean) getForm().getParametriConservazioneStrutturaList()
                .getTable().getCurrentRow();
        BigDecimal idValoreParamApplic = row.getBigDecimal("id_valore_param_applic");
        /*
         * Codice aggiuntivo per il logging...
    ...
    public void deleteParametriGestioneStrutturaList() throws EMFError {
        AplParamApplicRowBean row = (AplParamApplicRowBean) getForm().getParametriGestioneStrutturaList().getTable()
                .getCurrentRow();
        BigDecimal idValoreParamApplic = row.getBigDecimal("id_valore_param_applic");
        /*
         * Codice aggiuntivo per il logging...
        ...
        param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
        param.setNomeAzione(
                SpagoliteLogUtil.getDetailActionNameDelete(getForm(), getForm().getParametriGestioneStrutturaList()));
        if (idValoreParamApplic != null) {
            if (amministrazioneEjb.deleteParametroStruttura(param, idValoreParamApplic)) {
        ...
        while (rowIt.hasNext()) {
            ...
            if (rowBean.getTiValoreParamApplic().equals(Constants.ComboValueParamentersType.PASSWORD.name())) {
                ...
                if (rowBean.getString("ds_valore_param_applic_strut_amm") != null) {
                    rowBean.setString("ds_valore_param_applic_strut_amm", Constants.OBFUSCATED_STRING);
                }

                if (rowBean.getString("ds_valore_param_applic_strut_gest") != null) {
                    rowBean.setString("ds_valore_param_applic_strut_gest", Constants.OBFUSCATED_STRING);
                }

                if (rowBean.getString("ds_valore_param_applic_strut_cons") != null) {
                    rowBean.setString("ds_valore_param_applic_strut_cons", Constants.OBFUSCATED_STRING);
                }
            }
        }
