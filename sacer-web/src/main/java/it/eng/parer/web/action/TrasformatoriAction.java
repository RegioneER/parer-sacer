...
public class TrasformatoriAction extends TrasformatoriAbstractAction {
    ...
    private static Logger log = LoggerFactory.getLogger(TrasformatoriAction.class.getName());
    ...
    public void loadDettaglio() throws EMFError {
        ...
        if (!action.equals(NE_DETTAGLIO_INSERT)) {
            ...
            if (lista.equals(getForm().getTrasformTipoRapprList().getName())
                ...
                BigDecimal idTrasformTipoRappr = ((DecTrasformTipoRapprRowBean) getForm()
                        .getTrasformTipoRapprList().getTable().getCurrentRow())
                        .getIdTrasformTipoRappr();
                ...
                if (StringUtils.isNotBlank(cessato) && "1".equals(cessato)) {
                    getForm().getTrasformTipoRapprList().setUserOperations(true, false, false,
                            false);
                }
                if (!action.equals(NE_DETTAGLIO_INSERT)) {
                    // TODO: VERIFICARE
                    ...
                    getForm().getTrasformTipoRappr().getScaricaTrasformatore()
                            .setDisableHourGlass(true);
                    String stato = trasformTipoRapprRowBean.getTiStatoFileTrasform();
                    // TODO: VERIFICARE
                    if (StringUtils.isNotBlank(cessato) && "1".equals(cessato)) {
                        getForm().getTrasformTipoRappr().getSbloccaFileTrasformatore()
                                .setHidden(true);
                        getForm().getTrasformTipoRappr().getSbloccaFileTrasformatore()
                                .setViewMode();
                ...
                BigDecimal idImageTrasform = ((DecImageTrasformRowBean) getForm()
                        .getImageTrasformList().getTable().getCurrentRow()).getIdImageTrasform();
                ...
                if (!action.equals(NE_DETTAGLIO_INSERT)) {
                    ...
                    getForm().getImageTrasform().getScaricaFileImgTrasformatore()
                            .setDisableHourGlass(true);
                    // TODO: VERIFICARE
                    if (StringUtils.isNotBlank(cessato) && "1".equals(cessato)) {
    ...
    public void deleteImageTrasformList() throws EMFError {
        ...
        DecImageTrasformRowBean row = ((DecImageTrasformRowBean) getForm().getImageTrasformList()
        ...
        if (row.getDtLastScaricoImageTrasform() != null) {
            ...
            if (param.getNomePagina()
                    .equalsIgnoreCase(Application.Publisher.TRASFORM_TIPO_RAPPR_DETAIL)) {
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getImageTrasformList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            DecTrasformTipoRapprRowBean bean = (DecTrasformTipoRapprRowBean) form
                    .getTrasformTipoRapprList().getTable().getCurrentRow();
    ...
    public void reloadAfterGoBack(String publisher) {
        if (Application.Publisher.TRASFORM_TIPO_RAPPR_DETAIL.equals(publisher)) {
            try {
                ...
                log.error("Errore nel reloadAfterGoBack di TrasformatoriAction per il publisher :"
                        + publisher, ex);
            }
    ...
    private void reloadImagesList() {
        BigDecimal idTrasformTipoRappr = ((DecTrasformTipoRapprRowBean) getForm()
                .getTrasformTipoRapprList().getTable().getCurrentRow()).getIdTrasformTipoRappr();
        DecImageTrasformTableBean tableImgs = tipoRapprEjb
                .getDecImageTrasformTableBean(idTrasformTipoRappr);
    ...
    public void testTrasformatore() throws EMFError {
        ...
        try {
            ...
            AvanzamentoWs avanzamento = AvanzamentoWs.nuovoAvanzamentoWS("prova",
            ...
            /*
             * myRecuperoExt.getParametriRecupero().setTipoEntitaSacer(CostantiDB.TipiEntitaRecupero
             * .COMP_DIP); myRecuperoExt.getParametriRecupero().setUtente(getUser());
             * myRecuperoExt.getParametriRecupero().setIdUnitaDoc(componenteRB.getIdUnitaDoc().
             * longValue());
            ...
            if (recuperoDip == null) {
                recuperoDip = (RecuperoDip) new InitialContext()
                        .lookup("java:app/Parer-ejb/RecuperoDip");
            }
            ...
            if (!getMessageBox().isEmpty()) {
                getMessageBox().addWarning(
                        "Il test del trasformatore ha ritornato il seguente messaggio : "
    ...
    public void process() throws EMFError {
        ...
        if (isMultipart && (getLastPublisher()
                .equals(Application.Publisher.IMPORTA_FILE_TRASFORMATORE)
        ...
        try {
                ...
                if (!item.isFormField()) {
                    ...
                    if (item.getFieldName().equals(trasform.getNm_trasform().getName())) {
                        trasform.getNm_trasform().setValue(item.getString());
                            ...
                            .equals(trasform.getCd_versione_trasform().getName())) {
                        trasform.getCd_versione_trasform().setValue(item.getString());
                    } else if (item.getFieldName()
                            .equals(imageTransform.getNm_image_trasform().getName())) {
                    ...
                    // nell'eventualità che si voglia permettere di modificare un'altro dei campi
                    // rimasti, scommentare
                    // il relativo else if.
                    // else if
            ...
            if (isFromCaricaImmagine && imageTransform.getNm_image_trasform().parse() == null) {
                ...
                if (isFromCaricaImmagine
                        && Status.insert.equals(getForm().getImageTrasform().getStatus())) {
                    BigDecimal idTrasform = ((DecTrasformTipoRapprRowBean) getForm()
                            .getTrasformTipoRapprList().getTable().getCurrentRow())
                            .getIdTrasformTipoRappr();
    ...
    private void aggiornaIstanza(DiskFileItem tmpFileItem, boolean isFromCaricaImmagine,
            boolean isImageInsert) throws EMFError {
        FileBinario fileBin;
        ...
        if (isFromCaricaImmagine) {
            ...
            BigDecimal idTrasformatore = ((DecTrasformTipoRapprRowBean) getForm()
                    .getTrasformTipoRapprList().getTable().getCurrentRow())
                    .getIdTrasformTipoRappr();
            ...
            getForm().getTrasformTipoRappr().getScaricaTrasformatore().setEditMode();
            getForm().getTrasformTipoRappr().getScaricaTrasformatore()
                    .setDisableHourGlass(isImageInsert);
    ...
    public void updateTrasformTipoRapprList() throws EMFError {
        BigDecimal idTrasformTipoRappr = ((DecTrasformTipoRapprRowBean) getForm()
                .getTrasformTipoRapprList().getTable().getCurrentRow()).getIdTrasformTipoRappr();
        DecTrasformTipoRapprRowBean riga = tipoRapprEjb
                .getDecTrasformTipoRapprRowBean(idTrasformTipoRappr);
        ...
        if (CostantiDB.StatoFileTrasform.ERRATO.name().equals(stato)) {
            ...
            getMessageBox().addWarning(
                    "Un trasformatore pu\u00f2 essere modificato solo se il suo stato \u00e8 : ERRATO");

        }
    }

    private void modificaTrasformatore(BigDecimal idTrasformatore,
            FileBinario fileDelTrasformatore) {

        DecTrasformTipoRapprRowBean row = (DecTrasformTipoRapprRowBean) getForm()
                .getTrasformTipoRapprList().getTable().getCurrentRow();
        byte[] blob = null;
        ...
        // BigDecimal idTipoRapprComp=bean.getIdTipoRapprComp();
        if (param.getNomePagina()
                .equalsIgnoreCase(Application.Publisher.IMPORTA_FILE_TRASFORMATORE)) {
            param.setNomeAzione(
    ...
    private void salvaTrasformatore() {
        ...
        decTrasformTipoRapprRowBean.setIdTipoRapprComp(((DecTrasformTipoRapprRowBean) getForm()
                .getTrasformTipoRapprList().getTable().getCurrentRow()).getIdTipoRapprComp());
        ...
        if (form.validate(msgBox)) {
            ...
            try {
                ...
                log.error("Eccezione nell'aggiornamento del trasformatore", ex);
        ...
        if (form.validate(msgBox)) {
            ...
            try {
                ...
                if (msgBox.isEmpty()) {
                    ...
                    param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
                    TrasformatoriForm form2 = (TrasformatoriForm) SpagoliteLogUtil.getForm(this);
                    DecTrasformTipoRapprRowBean bean = (DecTrasformTipoRapprRowBean) form2
                            .getTrasformTipoRapprList().getTable().getCurrentRow();
                    BigDecimal idTipoRapprComp = bean.getIdTipoRapprComp();

                    if (isModifica) {
                        BigDecimal idImageTrasform = ((DecImageTrasformRowBean) getForm()
                                .getImageTrasformList().getTable().getCurrentRow())
                                .getIdImageTrasform();
                        decImageTrasformRowBean.setIdImageTrasform(idImageTrasform);
                        param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                        tipoRapprEjb.updateImageTrasform(param, decImageTrasformRowBean,
                                idTipoRapprComp);
                        ...
                        // DA FINIRE !!!!!!!!
                        tipoRapprEjb.insertImageTrasform(param, decImageTrasformRowBean,
                                idTipoRapprComp);
                        reloadImagesList();

                    }
                    decImageTrasformRowBean = tipoRapprEjb.getDecImageTrasformRowBean(
                            decImageTrasformRowBean.getIdImageTrasform());
                    ...
                    msgBox.addInfo(
                            "Aggiornamento dell'immagine trasformatore effettuato con successo");

                }
            } catch (EMFError ex) {
                log.error("Eccezione nell'aggiornamento dell'immagine del trasformatore", ex);
                getMessageBox().addError(
                        "Eccezione nell'aggiornamento dell'immagine del trasformatore", ex);
            }
    ...
    private void checkCampiObbligatori(TrasformatoriForm.TrasformTipoRappr form, MessageBox msgBox)
            throws EMFError {

        if (form.getNm_trasform().parse() == null) {
            msgBox.addError(
                    "Errore di compilazione : il nome del trasformatore \u00e8 obbligatorio <br/>");
        }
        if (form.getCd_versione_trasform().parse() == null) {
            msgBox.addError(
                    "Errore di compilazione : la versione del trasformatore \u00e8 obbligatoria <br/>");
        }
    ...
    public void scaricaTrasformatore() throws EMFError {
        ...
        try {
            ...
            getMessageBox().addMessage(new Message(Message.MessageLevel.ERR,
                    "Errore nel recupero dei file del trasformatore"));
    ...
    public void scaricaFileImgTrasformatore() throws EMFError {
        ...
        DecImageTrasformRowBean decImageTrasform = tipoRapprEjb
                .getDecImageTrasformRowBean(idImageTrasform);
        ServletOutputStream out = getServletOutputStream();
        try {
            byte[] data = new byte[1000];
            ...
            getMessageBox().addMessage(
                    new Message(Message.MessageLevel.ERR, "Errore nel recupero dei file immagine"));
            log.error(e.getMessage(), e);
        }
    }
    ...
    private void modificaImmagine(BigDecimal idImageTrasform, FileBinario fileBin) {
        ...
        if (blob != null) {
            ...
            BigDecimal idTipoRapprComp = bean.getIdTipoRapprComp();
            if (param.getNomePagina()
                    .equalsIgnoreCase(Application.Publisher.IMPORTA_FILE_IMMAGINE)) {
                param.setNomeAzione(SpagoliteLogUtil.getButtonActionName(form2,
                        form2.getImageTrasform(),
    ...
    public void sbloccaFileTrasformatore() throws EMFError {
        try {
            ...
            getMessageBox().addInfo(
                    "Stato del trasformatore reimpostato per effettuare la modifica del file ");
            getForm().getTrasformTipoRappr().setViewMode();
            getForm().getTrasformTipoRappr().setStatus(Status.view);
            getForm().getTrasformTipoRapprList().setStatus(Status.view);
            ...
            log.error("Errore nella procedura sbloccaFileTrasformatore()", e);
    ...
    private void insertImmagine(String nomeImmagine, FileBinario fileBin) throws EMFError {
        try {
            ...
            if (blob != null) {
                ...
                getForm().getImageTrasformList().setTable(tableImgs);
                getForm().getImageTrasformList().getTable().first();
                getForm().getImageTrasformList().getTable()
            ...
            throw new EMFError(EMFError.BLOCKING,
                    "Errore nel salvataggio dell'immagine del trasformatore ", e);
        }
