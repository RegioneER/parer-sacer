...
public class MonitoraggioValidator extends TypeValidator {
	...
	if (periodo != null && data != null) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Filtri periodo e data versamento entrambi valorizzati!"));
	...
	if (periodo != null
	    ...
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Campi periodo e data versamento entrambi valorizzati!"));
	...
	if (dataRifDa.after(dataRifA)) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento Da maggiore di Data riferimento A"));
	}
	if (dataRifDa.before(dataInizio.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento Da inferiore al 1 gennaio 2000"));
	}
	if (dataRifDa.after(ieri.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento Da maggiore di data odierna - 1 gg"));
	}
	if (dataRifA.before(dataInizio.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento A inferiore al 1 gennaio 2000"));
	}
	if (dataRifA.after(ieri.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento A maggiore di data odierna - 1 gg"));
	}
    }
	...
	if (dataRifDa.before(dataInizio.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento Da inferiore al 1 dicembre 2011"));
	}
	if (dataRifDa.after(ieri.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento Da maggiore di data odierna - 1 gg"));
	...
	if (dataRifA.before(dataInizio.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento A inferiore al 1 dicembre 2011"));
	}
	if (dataRifA.after(ieri.getTime())) {
	    getMessageBox().addMessage(new Message(MessageLevel.ERR,
		    "Data riferimento A maggiore di data odierna - 1 gg"));
