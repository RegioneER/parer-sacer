...
public class GestioneJobAction extends GestioneJobAbstractAction {
	...
	StatoJob creazioneElenchi = new StatoJob(JobConstants.JobEnum.CREAZIONE_ELENCHI_VERS.name(),
		...
		getForm().getCreazioneElenchi().getAttivo(),
		getForm().getCreazioneElenchi().getDt_reg_log_job_ini(), dataAttivazioneJob);
	...
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CREAZIONE_INDICI_ELENCHI_VERS.name());
	StatoJob creazioneIndici = new StatoJob(
		JobConstants.JobEnum.CREAZIONE_INDICI_ELENCHI_VERS.name(),
		...
		getForm().getCreazioneIndici().getDt_prossima_attivazione(),
		getForm().getCreazioneIndici().getAttivo(),
	...
	StatoJob verificaFirme = new StatoJob(
		JobConstants.JobEnum.VERIFICA_FIRME_A_DATA_VERS.name(),
		...
		getForm().getVerificaFirme().getDt_prossima_attivazione(),
		getForm().getVerificaFirme().getAttivo(),
		getForm().getVerificaFirme().getDt_reg_log_job_ini(), dataAttivazioneJob);

	gestisciStatoJob(verificaFirme);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Coda indici aip da
	// elaborare">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.PRODUCER_CODA_INDICI_AIP_DA_ELAB.name());
	StatoJob codaIndiciAipDaElab = new StatoJob(
		JobConstants.JobEnum.PRODUCER_CODA_INDICI_AIP_DA_ELAB.name(),
		...
		getForm().getVerificaFirme().getAttivo(),
		getForm().getCodaIndiciAipDaElab().getDt_reg_log_job_ini(), dataAttivazioneJob);
	...
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CALCOLO_CONTENUTO_SACER.name());
	StatoJob calcoloContenuto = new StatoJob(
		JobConstants.JobEnum.CALCOLO_CONTENUTO_SACER.name(),
	...
	// organizzazioni">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.ALLINEAMENTO_ORGANIZZAZIONI.name());
	StatoJob allineamentoOrganizzazioni = new StatoJob(
		JobConstants.JobEnum.ALLINEAMENTO_ORGANIZZAZIONI.name(),
	...
	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Aggiorna stato
	// archiviazione">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.AGGIORNA_STATO_ARCHIVIAZIONE.name());
	StatoJob aggiornaStatoArk = new StatoJob(
		JobConstants.JobEnum.AGGIORNA_STATO_ARCHIVIAZIONE.name(),
	...
	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Elabora sessioni recupero
	// archiviazione">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.ELABORA_SESSIONI_RECUPERO.name());
	StatoJob elaboraSessioniRecupero = new StatoJob(
		JobConstants.JobEnum.ELABORA_SESSIONI_RECUPERO.name(),
	...
	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Registra schedulazione
	// TPI">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.REGISTRA_SCHEDULAZIONI_JOB_TPI.name());
	StatoJob registraSchedTpi = new StatoJob(
		JobConstants.JobEnum.REGISTRA_SCHEDULAZIONI_JOB_TPI.name(),
		...
		getForm().getRegistraSchedTpi().getAttivo(),
		getForm().getRegistraSchedTpi().getDt_reg_log_job_ini(), dataAttivazioneJob);
	...
	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Verifica massiva
	// versamenti falliti">
	dataAttivazioneJob = getActivationDateJob(
	...
	StatoJob verficaMassivaVersamentiFalliti = new StatoJob(
		...
		getForm().getVerificaMassivaVersamentiFalliti()
			.getStartVerificaMassivaVersamentiFalliti(),
		getForm().getVerificaMassivaVersamentiFalliti()
			.getStartOnceVerificaMassivaVersamentiFalliti(),
		getForm().getVerificaMassivaVersamentiFalliti()
			.getStopVerificaMassivaVersamentiFalliti(),
		...
		getForm().getVerificaMassivaVersamentiFalliti().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(verficaMassivaVersamentiFalliti);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Verifica periodo
	// registro">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.VERIFICA_COMPATIBILITA_REGISTRO.name());
	StatoJob verificaPeriodoRegistro = new StatoJob(
		JobConstants.JobEnum.VERIFICA_COMPATIBILITA_REGISTRO.name(),
	...
	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Creazione automatica
	// serie">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CREAZIONE_AUTOMATICA_SERIE.name());
	StatoJob creazioneAutomaticaSerie = new StatoJob(
		JobConstants.JobEnum.CREAZIONE_AUTOMATICA_SERIE.name(),
		...
		getForm().getCreazioneAutomaticaSerie().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	// serie UD">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CREAZIONE_INDICE_AIP_SERIE_UD.name());
	StatoJob creazioneIndiciAipSerieUd = new StatoJob(
		JobConstants.JobEnum.CREAZIONE_INDICE_AIP_SERIE_UD.name(),
		...
		getForm().getCreazioneIndiciAipSerieUd().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(creazioneIndiciAipSerieUd);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Generazione automatica
	// contenuto effettivo
	// serie">
	dataAttivazioneJob = getActivationDateJob(
	...
	StatoJob generazioneAutomaticaEffettivoSerie = new StatoJob(
		...
		getForm().getGenerazioneAutomaticaEffettivoSerie()
			.getStartGenerazioneAutomaticaEffettivo(),
		getForm().getGenerazioneAutomaticaEffettivoSerie()
			.getStartOnceGenerazioneAutomaticaEffettivo(),
		getForm().getGenerazioneAutomaticaEffettivoSerie()
			.getStopGenerazioneAutomaticaEffettivo(),
		...
		getForm().getGenerazioneAutomaticaEffettivoSerie().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(generazioneAutomaticaEffettivoSerie);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Evasione richieste
	...
	StatoJob evasioneRichiesteAnnullamentoVersamenti = new StatoJob(
		...
		getForm().getEvasioneRichiesteAnnullamentoVersamenti()
			.getStartEvasioneRichiesteAnnulVers(),
		getForm().getEvasioneRichiesteAnnullamentoVersamenti()
			.getStartOnceEvasioneRichiesteAnnulVers(),
		getForm().getEvasioneRichiesteAnnullamentoVersamenti()
		...
		getForm().getEvasioneRichiesteAnnullamentoVersamenti().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	// LOG">
	String nomeApplicazione = configHelper
	...
	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Controllo automatico
	// contenuto effettivo
	// serie">
	dataAttivazioneJob = getActivationDateJob(
	...
	StatoJob controlloAutomaticoEffettivoSerie = new StatoJob(
		...
		getForm().getControlloAutomaticoEffettivoSerie()
			.getStartControlloAutomaticoEffettivo(),
		getForm().getControlloAutomaticoEffettivoSerie()
			.getStartOnceControlloAutomaticoEffettivo(),
		getForm().getControlloAutomaticoEffettivoSerie()
			.getStopControlloAutomaticoEffettivo(),
		...
		getForm().getControlloAutomaticoEffettivoSerie().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CALCOLA_STRUTTURA_JOB.name());
	StatoJob calcoloStruttura = new StatoJob(JobConstants.JobEnum.CALCOLA_STRUTTURA_JOB.name(),
		...
		getForm().getCalcoloStruttura().getAttivo(),
		getForm().getCalcoloStruttura().getDt_reg_log_job_ini(), dataAttivazioneJob);

	gestisciStatoJob(calcoloStruttura);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per evasione richieste di
	// restituzione archivio">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.EVASIONE_RICH_REST_ARCH.name());
	StatoJob evasioneRichiesteRestArch = new StatoJob(
		JobConstants.JobEnum.EVASIONE_RICH_REST_ARCH.name(),
		getForm().getEvasioneRichiesteRestituzioneArchivio().getFl_data_accurata(),
		getForm().getEvasioneRichiesteRestituzioneArchivio()
			.getStartEvasioneRichiesteRestArch(),
		getForm().getEvasioneRichiesteRestituzioneArchivio()
			.getStartOnceEvasioneRichiesteRestArch(),
		getForm().getEvasioneRichiesteRestituzioneArchivio()
			.getStopEvasioneRichiesteRestArch(),
		...
		getForm().getEvasioneRichiesteRestituzioneArchivio().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(evasioneRichiesteRestArch);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Creazione Elenchi indici
	// AIP">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_UD.name());
	StatoJob creazioneElenchiIndiciAipUd = new StatoJob(
		JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_UD.name(),
		...
		getForm().getCreazioneElenchiIndiciAip().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(creazioneElenchiIndiciAipUd);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Allineamento enti
	// convenzionati">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.ALLINEA_ENTI_CONVENZIONATI.name());
	StatoJob allineaEntiConvenzionati = new StatoJob(
		JobConstants.JobEnum.ALLINEA_ENTI_CONVENZIONATI.name(),
		...
		getForm().getAllineaEntiConvenzionati().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(allineaEntiConvenzionati);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Calcolo contenuto
	// fascicoli">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CALCOLO_CONTENUTO_FASCICOLI.name());
	StatoJob calcoloContenutoFascicoli = new StatoJob(
		JobConstants.JobEnum.CALCOLO_CONTENUTO_FASCICOLI.name(),
		...
		getForm().getCalcoloContenutoFascicoli().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	gestisciStatoJob(calcoloContenutoFascicoli);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Verifica Periodo tipo
	// fascicolo">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.VERIFICA_COMPATIBILITA_TIPO_FASC.name());
	StatoJob verificaPeriodoTipoFasc = new StatoJob(
		JobConstants.JobEnum.VERIFICA_COMPATIBILITA_TIPO_FASC.name(),
		...
		getForm().getVerificaPeriodoTipoFascicolo().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	StatoJob creazioneElenchiVersFascicoli = new StatoJob(
		...
		getForm().getCreazioneElenchiVersFascicoli()
			.getStartCreazioneElenchiVersFascicoli(),
		getForm().getCreazioneElenchiVersFascicoli()
			.getStartOnceCreazioneElenchiVersFascicoli(),
		...
		getForm().getCreazioneElenchiVersFascicoli().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	StatoJob creazioneIndiciVersFascicoli = new StatoJob(
		...
		getForm().getCreazioneIndiciVersFascicoli()
			.getStartOnceCreazioneIndiciVersFascicoli(),
		...
		getForm().getCreazioneIndiciVersFascicoli().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.VALIDAZIONE_FASCICOLI.name());
	StatoJob validazioneFascicoli = new StatoJob(
		JobConstants.JobEnum.VALIDAZIONE_FASCICOLI.name(),
	...
	// fascicoli">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.CREAZIONE_INDICE_AIP_FASC.name());
	StatoJob creazioneIndiciAipFasc = new StatoJob(
		JobConstants.JobEnum.CREAZIONE_INDICE_AIP_FASC.name(),
		...
		getForm().getCreazioneIndiciAipFascicoli().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	StatoJob creazioneElenchiIndiciAipFasc = new StatoJob(
		...
		getForm().getCreazioneElenchiIndiciAipFascicoli()
			.getStartCreazioneElenchiIndiciAipFasc(),
		getForm().getCreazioneElenchiIndiciAipFascicoli()
			.getStartOnceCreazioneElenchiIndiciAipFasc(),
		getForm().getCreazioneElenchiIndiciAipFascicoli()
			.getStopCreazioneElenchiIndiciAipFasc(),
		...
		getForm().getCreazioneElenchiIndiciAipFascicoli().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(creazioneElenchiIndiciAipFasc);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per Preparazione partizione
	// da migrare 1">
	dataAttivazioneJob = getActivationDateJob(
	...
	StatoJob preparazionePartizioneDaMigrare1 = new StatoJob(
		...
		getForm().getPreparazionePartizioneDaMigrare1()
			.getStopPreparazionePartizioneDaMigrare1(),
		...
		getForm().getPreparazionePartizioneDaMigrare1().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	StatoJob preparazionePartizioneDaMigrare2 = new StatoJob(
		...
		getForm().getPreparazionePartizioneDaMigrare2()
			.getStartOncePreparazionePartizioneDaMigrare2(),
		getForm().getPreparazionePartizioneDaMigrare2()
			.getStopPreparazionePartizioneDaMigrare2(),
		...
		getForm().getPreparazionePartizioneDaMigrare2().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	StatoJob preparazionePartizioneDaMigrare3 = new StatoJob(
		...
		getForm().getPreparazionePartizioneDaMigrare3()
			.getStartPreparazionePartizioneDaMigrare3(),
		getForm().getPreparazionePartizioneDaMigrare3()
			.getStartOncePreparazionePartizioneDaMigrare3(),
		getForm().getPreparazionePartizioneDaMigrare3()
			.getStopPreparazionePartizioneDaMigrare3(),
		...
		getForm().getPreparazionePartizioneDaMigrare3().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	StatoJob preparazionePartizioneDaMigrare4 = new StatoJob(
		...
		getForm().getPreparazionePartizioneDaMigrare4()
			.getStartPreparazionePartizioneDaMigrare4(),
		getForm().getPreparazionePartizioneDaMigrare4()
			.getStartOncePreparazionePartizioneDaMigrare4(),
		getForm().getPreparazionePartizioneDaMigrare4()
		...
		getForm().getPreparazionePartizioneDaMigrare4().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	gestisciStatoJob(preparazionePartizioneDaMigrare4);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per produzione coda da
	// migrare 1">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_1.name());
	StatoJob producerCodaDaMigrare1 = new StatoJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_1.name(),
	...
	// migrare 2">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_2.name());
	StatoJob producerCodaDaMigrare2 = new StatoJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_2.name(),
	...
	// migrare 3">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_3.name());
	StatoJob producerCodaDaMigrare3 = new StatoJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_3.name(),
	...
	// migrare 4">
	dataAttivazioneJob = getActivationDateJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_4.name());
	StatoJob producerCodaDaMigrare4 = new StatoJob(
		JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_4.name(),
	...
	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per verifica migrazione
	// subpartizione">
	dataAttivazioneJob = getActivationDateJob(
	...
	StatoJob verificaMigrazioneSubpartizione = new StatoJob(
		...
		getForm().getVerificaMigrazioneSubpartizione()
			.getStartVerificaMigrazioneSubpartizione(),
		getForm().getVerificaMigrazioneSubpartizione()
			.getStartOnceVerificaMigrazioneSubpartizione(),
		getForm().getVerificaMigrazioneSubpartizione()
			.getStopVerificaMigrazioneSubpartizione(),
		...
		getForm().getVerificaMigrazioneSubpartizione().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
	...
	StatoJob calcoloContenutoAggMeta = new StatoJob(
		...
		getForm().getCalcoloContenutoAggiornamentiMetadati()
			.getStartOnceCalcoloContenutoAgg(),
		...
		getForm().getCalcoloContenutoAggiornamentiMetadati().getDt_reg_log_job_ini(),
		dataAttivazioneJob);

	gestisciStatoJob(calcoloContenutoAggMeta);
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="UI Gestione job per controlla migrazione
	// subpartizione">
	dataAttivazioneJob = getActivationDateJob(
	...
	StatoJob controlloMigrazioneSubpartizione = new StatoJob(
		...
		getForm().getControllaMigrazioneSubpartizione()
			.getStartControllaMigrazioneSubpartizione(),
		getForm().getControllaMigrazioneSubpartizione()
			.getStartOnceControllaMigrazioneSubpartizione(),
		getForm().getControllaMigrazioneSubpartizione()
			.getStopControllaMigrazioneSubpartizione(),
		...
		getForm().getControllaMigrazioneSubpartizione().getDt_reg_log_job_ini(),
		dataAttivazioneJob);
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage CodaIndiciAipDaElab
    // schedulation">
    @Override
    public void startCodaIndiciAipDaElab() throws EMFError {
	esegui(JobConstants.JobEnum.PRODUCER_CODA_INDICI_AIP_DA_ELAB.name(),
		"Coda indici aip da elaborare", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceCodaIndiciAipDaElab() throws EMFError {
	esegui(JobConstants.JobEnum.PRODUCER_CODA_INDICI_AIP_DA_ELAB.name(),
		"Coda indici aip da elaborare", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopCodaIndiciAipDaElab() throws EMFError {
	esegui(JobConstants.JobEnum.PRODUCER_CODA_INDICI_AIP_DA_ELAB.name(),
		"Coda indici aip da elaborare", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage CalcolaContenutoSacer
    // schedulation">
    @Override
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage AllineamentoOrganizzazioni
    // schedulation">
    @Override
    public void startAllineamentoOrganizzazioni() throws EMFError {
	esegui(JobConstants.JobEnum.ALLINEAMENTO_ORGANIZZAZIONI.name(),
		"Allineamento organizzazioni", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceAllineamentoOrganizzazioni() throws EMFError {
	esegui(JobConstants.JobEnum.ALLINEAMENTO_ORGANIZZAZIONI.name(),
		"Allineamento organizzazioni", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopAllineamentoOrganizzazioni() throws EMFError {
	esegui(JobConstants.JobEnum.ALLINEAMENTO_ORGANIZZAZIONI.name(),
		"Allineamento organizzazioni", null, OPERAZIONE.STOP);
    }
    // </editor-fold>
	...
	esegui(JobConstants.JobEnum.AGGIORNA_STATO_ARCHIVIAZIONE.name(),
		"Aggiorna stato archiviazione", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceAggiornamentoStatoArk() throws EMFError {
	esegui(JobConstants.JobEnum.AGGIORNA_STATO_ARCHIVIAZIONE.name(),
		"Aggiorna stato archiviazione", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopAggiornamentoStatoArk() throws EMFError {
	esegui(JobConstants.JobEnum.AGGIORNA_STATO_ARCHIVIAZIONE.name(),
		"Aggiorna stato archiviazione", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage ElaboraSessioniRecupero
    // schedulation">
    @Override
    public void startElaboraSessioniRecupero() throws EMFError {
	esegui(JobConstants.JobEnum.ELABORA_SESSIONI_RECUPERO.name(),
		"Elabora sessioni recupero archiviazione", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceElaboraSessioniRecupero() throws EMFError {
	esegui(JobConstants.JobEnum.ELABORA_SESSIONI_RECUPERO.name(),
		"Elabora sessioni recupero archiviazione", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopElaboraSessioniRecupero() throws EMFError {
	esegui(JobConstants.JobEnum.ELABORA_SESSIONI_RECUPERO.name(),
		"Elabora sessioni recupero archiviazione", null, OPERAZIONE.STOP);
    }
    // </editor-fold>
	...
	esegui(JobConstants.JobEnum.REGISTRA_SCHEDULAZIONI_JOB_TPI.name(),
		"Registra schedulazioni job TPI", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceRegistraSchedTpi() throws EMFError {
	esegui(JobConstants.JobEnum.REGISTRA_SCHEDULAZIONI_JOB_TPI.name(),
		"Registra schedulazioni job TPI", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopRegistraSchedTpi() throws EMFError {
	esegui(JobConstants.JobEnum.REGISTRA_SCHEDULAZIONI_JOB_TPI.name(),
		"Registra schedulazioni job TPI", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage CreazioneIndiciAIP
    // schedulation">
    @Override
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage ProducerCodaDaMigrare1
    // schedulation">
    @Override
    public void startProducerCodaDaMigrare1() throws EMFError {
	esegui(JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_1.name(), "Producer coda da migrare 1",
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage ProducerCodaDaMigrare2
    // schedulation">
    @Override
    public void startProducerCodaDaMigrare2() throws EMFError {
	esegui(JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_2.name(), "Producer coda da migrare 2",
		null, OPERAZIONE.START);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage ProducerCodaDaMigrare3
    // schedulation">
    @Override
    public void startProducerCodaDaMigrare3() throws EMFError {
	esegui(JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_3.name(), "Producer coda da migrare 3",
		null, OPERAZIONE.START);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage ProducerCodaDaMigrare4
    // schedulation">
    @Override
    public void startProducerCodaDaMigrare4() throws EMFError {
	esegui(JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_4.name(), "Producer coda da migrare 4",
		null, OPERAZIONE.START);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // PreparazionePartizioneDaMigrare1 schedulation">
    @Override
    public void startPreparazionePartizioneDaMigrare1() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_1.name(),
		"Preparazione Partizione da migrare 1", null, OPERAZIONE.START);
    }

    @Override
    public void startOncePreparazionePartizioneDaMigrare1() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_1.name(),
		"Preparazione Partizione da migrare 1", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopPreparazionePartizioneDaMigrare1() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_1.name(),
		"Preparazione Partizione da migrare 1", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // PreparazionePartizioneDaMigrare2 schedulation">
    @Override
    public void startPreparazionePartizioneDaMigrare2() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_2.name(),
		"Preparazione Partizione da migrare 2", null, OPERAZIONE.START);
    }

    @Override
    public void startOncePreparazionePartizioneDaMigrare2() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_2.name(),
		"Preparazione Partizione da migrare 2", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopPreparazionePartizioneDaMigrare2() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_2.name(),
		"Preparazione Partizione da migrare 2", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // PreparazionePartizioneDaMigrare3 schedulation">
    @Override
    public void startPreparazionePartizioneDaMigrare3() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_3.name(),
		"Preparazione Partizione da migrare 3", null, OPERAZIONE.START);
    }

    @Override
    public void startOncePreparazionePartizioneDaMigrare3() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_3.name(),
		"Preparazione Partizione da migrare 3", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopPreparazionePartizioneDaMigrare3() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_3.name(),
		"Preparazione Partizione da migrare 3", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // PreparazionePartizioneDaMigrare4 schedulation">
    @Override
    public void startPreparazionePartizioneDaMigrare4() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_4.name(),
		"Preparazione Partizione da migrare 4", null, OPERAZIONE.START);
    }

    @Override
    public void startOncePreparazionePartizioneDaMigrare4() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_4.name(),
		"Preparazione Partizione da migrare 4", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopPreparazionePartizioneDaMigrare4() throws EMFError {
	esegui(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_4.name(),
		"Preparazione Partizione da migrare 4", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage VerificaMigrazioneSubpartizione
    // schedulation">
    @Override
    public void startVerificaMigrazioneSubpartizione() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_MIGRAZIONE_SUBPARTIZIONE.name(),
		"Verifica migrazione subpartizione", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceVerificaMigrazioneSubpartizione() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_MIGRAZIONE_SUBPARTIZIONE.name(),
		"Verifica migrazione subpartizione", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopVerificaMigrazioneSubpartizione() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_MIGRAZIONE_SUBPARTIZIONE.name(),
		"Verifica migrazione subpartizione", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // ControllaMigrazioneSubpartizione schedulation">
    @Override
    public void startControllaMigrazioneSubpartizione() throws EMFError {
	esegui(JobConstants.JobEnum.CONTROLLA_MIGRAZIONE_SUBPARTIZIONE.name(),
		"Controlla migrazione subpartizione", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceControllaMigrazioneSubpartizione() throws EMFError {
	esegui(JobConstants.JobEnum.CONTROLLA_MIGRAZIONE_SUBPARTIZIONE.name(),
		"Controlla migrazione subpartizione", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopControllaMigrazioneSubpartizione() throws EMFError {
	esegui(JobConstants.JobEnum.CONTROLLA_MIGRAZIONE_SUBPARTIZIONE.name(),
		"Controlla migrazione subpartizione", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // VerificaMassivaVersamentiFalliti schedulation">
    @Override
    public void startVerificaMassivaVersamentiFalliti() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_MASSIVA_VERS_FALLITI.name(),
		"Verifica massiva versamenti falliti", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceVerificaMassivaVersamentiFalliti() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_MASSIVA_VERS_FALLITI.name(),
		"Verifica massiva versamenti falliti", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopVerificaMassivaVersamentiFalliti() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_MASSIVA_VERS_FALLITI.name(),
		"Verifica massiva versamenti falliti", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage VerificaPeriodoRegistro
    // schedulation">
    @Override
    public void startVerificaPeriodoRegistro() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_COMPATIBILITA_REGISTRO.name(),
		"Verifica periodo registro", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceVerificaPeriodoRegistro() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_COMPATIBILITA_REGISTRO.name(),
		"Verifica periodo registro", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopVerificaPeriodoRegistro() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_COMPATIBILITA_REGISTRO.name(),
		"Verifica periodo registro", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage CreazioneAutomaticaSerie
    // schedulation">
    @Override
    public void startCreazioneAutomaticaSerie() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_AUTOMATICA_SERIE.name(), "Creazione automatica serie",
		null, OPERAZIONE.START);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage CreazioneIndiciAIPSerieUD
    // schedulation">
    @Override
    public void startCreazioneIndiciAipSerieUd() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICE_AIP_SERIE_UD.name(),
		"Creazione indice AIP serie ud", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceCreazioneIndiciAipSerieUd() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICE_AIP_SERIE_UD.name(),
		"Creazione indice AIP serie ud", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopCreazioneIndiciAipSerieUd() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICE_AIP_SERIE_UD.name(),
		"Creazione indice AIP serie ud", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage GenerazioneAutomaticaEffettivo
    // schedulation">
    @Override
	...
	esegui(JobConstants.JobEnum.GENERAZIONE_AUTOMATICA_CONTENUTO_EFFETTIVO.name(),
		"Generazione automatica contenuto effettivo serie", null,
		OPERAZIONE.ESECUZIONE_SINGOLA);
    }
    ...
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Methods to manage ControlloAutomaticoEffettivo
    // schedulation">
    @Override
	...
	esegui(JobConstants.JobEnum.CONTROLLO_AUTOMATICO_CONTENUTO_EFFETTIVO.name(),
		"Controllo automatico contenuto effettivo serie", null,
		OPERAZIONE.ESECUZIONE_SINGOLA);
    }
    ...
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // EvasioneRichiesteAnnullamentoVersamenti
    // schedulation">
    @Override
    public void startEvasioneRichiesteAnnulVers() throws EMFError {
	esegui(JobConstants.JobEnum.EVASIONE_RICH_ANNUL_VERS.name(),
		"Evasione richieste di annullamento versamenti", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceEvasioneRichiesteAnnulVers() throws EMFError {
	esegui(JobConstants.JobEnum.EVASIONE_RICH_ANNUL_VERS.name(),
		"Evasione richieste di annullamento versamenti", null,
		OPERAZIONE.ESECUZIONE_SINGOLA);
    }
	...
	esegui(JobConstants.JobEnum.EVASIONE_RICH_ANNUL_VERS.name(),
		"Evasione richieste di annullamento versamenti", null, OPERAZIONE.STOP);
    }
    // </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage CalcoloEstrazione
    // schedulation">
    @Override
    public void startEvasioneRichiesteRestArch() throws EMFError {
	esegui(JobConstants.JobEnum.EVASIONE_RICH_REST_ARCH.name(),
		"Evasione richieste di restituzione archivio", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceEvasioneRichiesteRestArch() throws EMFError {
	esegui(JobConstants.JobEnum.EVASIONE_RICH_REST_ARCH.name(),
		"Evasione richieste di restituzione archivio", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopEvasioneRichiesteRestArch() throws EMFError {
	esegui(JobConstants.JobEnum.EVASIONE_RICH_REST_ARCH.name(),
		"Evasione richieste di restituzione archivio", null, OPERAZIONE.STOP);
    }
    // </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage CreazioneElenchiIndiciAIPUd
    // schedulation">
    @Override
    public void startCreazioneElenchiIndiciAip() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_UD.name(),
		"Creazione elenchi indici AIP", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceCreazioneElenchiIndiciAip() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_UD.name(),
		"Creazione elenchi indici AIP", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopCreazioneElenchiIndiciAip() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_UD.name(),
		"Creazione elenchi indici AIP", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage CalcolaContenutoFascicoli
    // schedulation">
    @Override
    public void startCalcoloContenutoFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CALCOLO_CONTENUTO_FASCICOLI.name(),
		"Calcolo contenuto fascicoli", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceCalcoloContenutoFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CALCOLO_CONTENUTO_FASCICOLI.name(),
		"Calcolo contenuto fascicoli", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopCalcoloContenutoFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CALCOLO_CONTENUTO_FASCICOLI.name(),
		"Calcolo contenuto fascicoli", null, OPERAZIONE.STOP);
    }

    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Methods to manage AllineaEntiConvenzionati
    // schedulation">
    @Override
    public void startAllineaEntiConvenzionati() throws EMFError {
	esegui(JobConstants.JobEnum.ALLINEA_ENTI_CONVENZIONATI.name(), "Allinea enti convenzionati",
		null, OPERAZIONE.START);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage VerificaPeriodoTipoFascicolo
    // schedulation">
    @Override
    public void startVerificaPeriodoTipoFasc() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_COMPATIBILITA_TIPO_FASC.name(),
		"Verifica periodo tipo fascicolo", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceVerificaPeriodoTipoFasc() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_COMPATIBILITA_TIPO_FASC.name(),
		"Verifica periodo tipo fascicolo", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopVerificaPeriodoTipoFasc() throws EMFError {
	esegui(JobConstants.JobEnum.VERIFICA_COMPATIBILITA_TIPO_FASC.name(),
		"Verifica periodo tipo fascicolo", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage CreazioneElencoVersFascicoli
    // schedulation">
    @Override
    public void startCreazioneElenchiVersFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_VERS_FASCICOLI.name(),
		"Creazione elenchi versamento fascicoli", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceCreazioneElenchiVersFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_VERS_FASCICOLI.name(),
		"Creazione elenchi versamento fascicoli", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopCreazioneElenchiVersFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_VERS_FASCICOLI.name(),
		"Creazione elenchi versamento fascicoli", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage CreazioneIndiciVersFascicoli
    // schedulation">
    @Override
    public void startCreazioneIndiciVersFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICI_ELENCHI_VERS_FASC.name(),
		"Creazione indici versamento fascicoli", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceCreazioneIndiciVersFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICI_ELENCHI_VERS_FASC.name(),
		"Creazione indici versamento fascicoli", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopCreazioneIndiciVersFascicoli() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICI_ELENCHI_VERS_FASC.name(),
		"Creazione indici versamento fascicoli", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage ValidazioneFascicoli
    // schedulation">
    @Override
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage CreazioneIndiciAIPFascicoli
    // schedulation">
    @Override
    public void startCreazioneIndiciAipFasc() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICE_AIP_FASC.name(),
		"Creazione indici AIP fascicoli", null, OPERAZIONE.START);
    }

    @Override
    public void stopCreazioneIndiciAipFasc() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICE_AIP_FASC.name(),
		"Creazione indici AIP fascicoli", null, OPERAZIONE.STOP);
    }

    @Override
    public void startOnceCreazioneIndiciAipFasc() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_INDICE_AIP_FASC.name(),
		"Creazione indici AIP fascicoli", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // CalcoloContenutoAggiornamentiMetadati
    // schedulation">
    @Override
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage CalcoloConsistenza
    // schedulation">
    @Override
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods to manage
    // CreazioneElenchiIndiciAIPFascicoli schedulation">
    @Override
    public void startCreazioneElenchiIndiciAipFasc() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_FASC.name(),
		"Creazione elenchi indici AIP fascicoli", null, OPERAZIONE.START);
    }

    @Override
    public void stopCreazioneElenchiIndiciAipFasc() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_FASC.name(),
		"Creazione elenchi indici AIP fascicoli", null, OPERAZIONE.STOP);
    }

    @Override
    public void startOnceCreazioneElenchiIndiciAipFasc() throws EMFError {
	esegui(JobConstants.JobEnum.CREAZIONE_ELENCHI_INDICI_AIP_FASC.name(),
		"Creazione elenchi indici AIP fascicoli", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }
    // </editor-fold>
