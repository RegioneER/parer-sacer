...
public class StrutTipiAction extends StrutTipiAbstractAction {
    ...
    private static Logger log = LoggerFactory.getLogger(StrutTipiAction.class.getName());
        ...
        try {
            ...
            if (lista != null && (action != null && !action.equals(NE_DETTAGLIO_INSERT))) {
                ...
                if (lista.equals(getForm().getTipoUnitaDocList().getName())
                    ...
                    BigDecimal idTipoUnita = ((DecTipoUnitaDocRowBean) getForm()
                            .getTipoUnitaDocList().getTable().getCurrentRow()).getIdTipoUnitaDoc();
                    ...
                    BigDecimal idTipoDoc = ((DecTipoDocRowBean) getForm().getTipoDocList()
                            .getTable().getCurrentRow()).getIdTipoDoc();
                    ...
                    DecTipoDocRowBean tipoDocRowBean = tipoDocEjb.getDecTipoDocRowBean(idTipoDoc,
                            null);
                    ...
                    if (getForm().getTipoDocList().getTable().size() > 0) {
                        ...
                        xsdDatiSpecRowBean.setIdTipoDoc(((DecTipoDocRowBean) getForm()
                                .getTipoDocList().getTable().getCurrentRow()).getIdTipoDoc());
                        ...
                        xsdDatiSpecTableBean = datiSpecEjb
                        ...
                        if (tipoDocRowBean.getFlTipoDocPrincipale() != null
                            ...
                            OrgRegolaValSubStrutTableBean regoleTableBean = subStrutEjb
                                    .getOrgRegolaValSubStrutTableBean(idTipoDoc,
                        ...
                        getForm().getTipoStrutDocAmmessoDaTipoDocList()
                                .setTable(tipoStrutDocTableBean);
                    ...
                    if (StringUtils.isNotBlank(cessato) && "1".equals(cessato)) {
                        ...
                        getForm().getRegoleSubStrutList().setUserOperations(true, false, false,
                                false);
                        getForm().getTipoStrutDocAmmessoDaTipoDocList().setUserOperations(true,
                                false, false, false);
                        getForm().getXsdDatiSpecList().setUserOperations(true, false, false, false);
                        getForm().getCriteriRaggruppamentoList().setUserOperations(true, false,
                                false, false);
                    }
                    ...
                    getForm().getRegistroUnitaDoc().getId_modello_tipo_serie()
                            .setDecodeMap(DecodeMap.Factory.newInstance(listaModelli,
                                    "id_modello_tipo_serie", "nm_modello_tipo_serie"));

                    BigDecimal idRegistroUnitaDoc = ((DecRegistroUnitaDocRowBean) getForm()
                    ...
                    String maxLenNumero = registroEjb
                            .calcolaMaxLenNumeroChiave(registroUnitaDocRowBean);
                    ...
                    if ((getForm().getRegistroUnitaDocList().getTable().size() > 0)) {
                        ...
                        BigDecimal idRegistro = ((DecRegistroUnitaDocRowBean) getForm()
                                .getRegistroUnitaDocList().getTable().getCurrentRow())
                                .getIdRegistroUnitaDoc();
                        ...
                        getForm().getRegistroTipoUnitaDocAmmessoList()
                                .setTable(tipoUnitaDocAmmessoTableBean);
                        ...
                        if (aaRegistroUnitaDocTableBean != null) {
                            getForm().getAaRegistroUnitaDocList()
                                    .setTable(aaRegistroUnitaDocTableBean);
                        ...
                        // Lista criteri di raggruppamento
                        DecVRicCriterioRaggrTableBean criteri = critRaggrEjb
                                .getCriteriRaggrDaRegistro(registroUnitaDocRowBean.getIdStrut(),
                                        registroUnitaDocRowBean.getIdRegistroUnitaDoc());
                        criteri.addSortingRule("nm_criterio_raggr", SortingRule.ASC);
                        criteri.sort();
                        getForm().getCriteriRaggruppamentoList().setTable(criteri);
                        getForm().getCriteriRaggruppamentoList().getTable()
                    ...
                    if (registroUnitaDocRowBean.getNiAnniConserv() != null) {
                        if (registroUnitaDocRowBean.getNiAnniConserv()
                                .equals(new BigDecimal(9999))) {
                    ...
                    if ((StringUtils.isNotBlank(cessato) && "1".equals(cessato))
                            || getRequest().getAttribute("cessato") != null) {
                        getForm().getRegistroUnitaDocList().setUserOperations(true, false, false,
                                false);
                        getForm().getRegistroTipoUnitaDocAmmessoList().setUserOperations(true,
                                false, false, false);
                        getForm().getAaRegistroUnitaDocList().setUserOperations(true, false, false,
                                false);
                        getForm().getCriteriRaggruppamentoList().setUserOperations(true, false,
                                false, false);
                    }
                    ...
                    BigDecimal idTipoUnitaDoc = getForm().getTipoUnitaDoc().getId_tipo_unita_doc()
                            .parse();
                    ...
                    getForm().getTipoStrutUnitaDoc().getRegistro_tipo_strut_unita_doc()
                            .setDecodeMap(DecodeMap.Factory.newInstance(
                                    tipoUnitaDocEjb.getRegistriByTipoUnitaDoc(idTipoUnitaDoc),
                                    "id_registro_unita_doc", "cd_registro_unita_doc"));
                    getForm().getTipoStrutUnitaDoc().getSis_vers_tipo_strut_unita_doc()
                            .setDecodeMap(DecodeMap.Factory.newInstance(
                                    tipoUnitaDocEjb.getAplSistemaVersanteTableBean(),
                                    "id_sistema_versante", "nm_sistema_versante"));
                    getForm().getTipoStrutUnitaDoc().getMetadati_specifici()
                            .setDecodeMap(DecodeMap.Factory.newInstance(
                                    tipoUnitaDocEjb.getDecXsdDatiSpecTableBean(idTipoUnitaDoc),
                                    "id_xsd_dati_spec", "descrizione"));

                    BigDecimal idTipoStrutUnitaDoc = ((DecTipoStrutUnitaDocRowBean) getForm()
                    ...
                    if (getForm().getTipoStrutUnitaDocList().getTable().size() > 0) {
                        ...
                        DecTipoDocAmmessoTableBean tipoDocAmmessoTableBean = tipoUnitaDocEjb
                                .getDecTipoDocAmmessoTableBean(
                                        ((DecTipoStrutUnitaDocRowBean) getForm()
                                                .getTipoStrutUnitaDocList().getTable()
                        ...
                        getForm().getTipoDocAmmessoList().getTable()
                                .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                    ...
                    String[] arrReg = idRegistroUnitaDocList
                            .toArray(new String[idRegistroUnitaDocList.size()]);
                    getForm().getTipoStrutUnitaDoc().getRegistro_tipo_strut_unita_doc()
                            .setValues(arrReg);

                    List<String> idSistemaVersanteList = tipoUnitaDocEjb
                            .getIdSistemaVersanteListByTipoStrutUnitaDoc(idTipoStrutUnitaDoc);
                    String[] arrSis = idSistemaVersanteList
                            .toArray(new String[idSistemaVersanteList.size()]);
                    getForm().getTipoStrutUnitaDoc().getSis_vers_tipo_strut_unita_doc()
                            .setValues(arrSis);

                    List<String> idXsdDatiSpecList = tipoUnitaDocEjb
                            .getIdXsdDatiSpecListByTipoStrutUnitaDoc(idTipoStrutUnitaDoc);
                    String[] arrXsd = idXsdDatiSpecList
                            .toArray(new String[idXsdDatiSpecList.size()]);
                    getForm().getTipoStrutUnitaDoc().getMetadati_specifici().setValues(arrXsd);

                    if ((StringUtils.isNotBlank(cessato) && "1".equals(cessato))
                            || getRequest().getAttribute("cessato") != null) {
                        getForm().getTipoDocAmmessoList().setUserOperations(true, false, false,
                                false);
                    }
                    ...
                    if ((getForm().getTipoDocAmmessoList().getTable().size() > 0)) {
                        ...
                        BigDecimal idTipoDocAmmesso = ((DecTipoDocAmmessoRowBean) getForm()
                                .getTipoDocAmmessoList().getTable().getCurrentRow())
                                .getIdTipoDocAmmesso();

                        DecTipoDocAmmessoRowBean tipoDocAmmessoRowBean = tipoUnitaDocEjb
                                .getDecTipoDocAmmessoRowBean(idTipoDocAmmesso, BigDecimal.ZERO,
                                        BigDecimal.ZERO);
                        getForm().getTipoDocAmmesso().copyFromBean(tipoDocAmmessoRowBean);
                        String nmTipoDoc = StringUtils.isNotBlank(
                                getForm().getTipoDocAmmesso().getId_tipo_doc().getDecodedValue())
                                        ? getForm().getTipoDocAmmesso().getId_tipo_doc()
                                                .getDecodedValue()
                                        : getForm().getTipoDocAmmessoList().getTable()
                                                .getCurrentRow().getString("nm_tipo_doc");
                    ...
                    // una lista
                    getForm().getDecParteNumRegistroList().getTi_parte().setDecodeMap(
                            ComboGetter.getMappaTiParte(ConfigRegAnno.TiParte.values()));
                    ...
                    getForm().getDecParteNumRegistroList()
                            .setTable(decParteNumeroRegistroTableBean);
                    getForm().getDecParteNumRegistroList().getTable().first();
                    getForm().getDecParteNumRegistroList().getTable()
                            .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                    ...
                    getForm().getErroriSuRegistroList().getTable()
                            .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                    ...
                    BigDecimal idStrut;
                    OrgRegolaValSubStrutRowBean row = (OrgRegolaValSubStrutRowBean) getForm()
                            .getRegoleSubStrutList().getTable().getCurrentRow();
                    getForm().getRegolaSubStrut().copyFromBean(row);

                    if (getLastPublisher().equals(Application.Publisher.TIPO_UNITA_DOC_DETAIL)) {
                        idStrut = ((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                                .getTable().getCurrentRow()).getIdStrut();
                        getForm().getRegolaSubStrut().getId_tipo_doc()
                                .setDecodeMap(DecodeMap.Factory.newInstance(
                                        tipoDocEjb.getDocumentiPrincipali(idStrut), "id_tipo_doc",
                                        "nm_tipo_doc"));
                        getForm().getRegolaSubStrut().getId_tipo_doc()
                                .setValue("" + row.getIdTipoDoc());
                        ...
                        idStrut = ((DecTipoDocRowBean) getForm().getTipoDocList().getTable()
                                .getCurrentRow()).getIdStrut();
                        getForm().getRegolaSubStrut().getId_tipo_unita_doc()
                                .setDecodeMap(DecodeMap.Factory.newInstance(
                                        tipoUnitaDocEjb.getDecTipoUnitaDocTableBean(idStrut),
                                        "id_tipo_unita_doc", "nm_tipo_unita_doc"));
                        getForm().getRegolaSubStrut().getId_tipo_unita_doc()
                                .setValue("" + row.getIdTipoUnitaDoc());
                    ...
                    getForm().getCampiSubStrutList().setTable(subStrutEjb
                            .getOrgCampoValSubStrutTableBean(row.getIdRegolaValSubStrut()));
                    getForm().getCampiSubStrutList().getTable()
                            .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                    getForm().getCampiSubStrutList().getTable().first();

                    if (getRequest().getAttribute("cessato") != null) {
                        getForm().getCampiSubStrutList().setUserOperations(true, false, false,
                                false);
                    }
                    ...
                    getForm().getCampoSubStrut().getTi_campo()
                            .setDecodeMap(ComboGetter.getMappaTiCampo());
                    OrgCampoValSubStrutRowBean row = (OrgCampoValSubStrutRowBean) getForm()
                            .getCampiSubStrutList().getTable().getCurrentRow();
                    ...
                    DecUsoModelloXsdUniDocRowBean row = (DecUsoModelloXsdUniDocRowBean) getForm()
                            .getXsdModelliUdList().getTable().getCurrentRow();
                    // init combos
                    DecodeMap mpTiModelloXsd = modelliXsdUdEjb.getTiModelloXsdInUsoByIdAmbTiUso(
                            row.getIdAmbiente(), row.getTiUsoModelloXsd(), "ti_modello_xsd");
                    getForm().getXsdModelliUdDetail().getTi_modello_xsd()
                            .setDecodeMap(mpTiModelloXsd);
                    DecodeMap mpCdXsd = modelliXsdUdEjb.getCdXsdInUsoByIdAmbTiModUso(
                            row.getIdAmbiente(), row.getTiModelloXsd(), row.getTiUsoModelloXsd(),
                            "cd_xsd");
                    ...
                    DecUsoModelloXsdUniDocRowBean usoModelloXsdUniDocRowBean = modelliXsdUdEjb
                            .getDecModelloXsdUdInUsoOnUniDoc(
                                    getForm().getIdList().getId_tipo_unita_doc().parse(),
                                    row.getIdModelloXsdUd(), row.getTiUsoModelloXsd(),
                                    row.getCdXsd());
                    //
                    ...
                    getForm().getXsdModelliUdDetail().getScaricaXsdModelliUdButton()
            ...
            if (lista != null
                    && (lista.equals(getForm().getRegistroTipoUnitaDocAmmessoList().getName())
                ...
                if (lista.equals(getForm().getRegistroTipoUnitaDocAmmessoList().getName())) {
                    ...
                    idStrut = ((DecRegistroUnitaDocRowBean) getForm().getRegistroUnitaDocList()
                            .getTable().getCurrentRow()).getIdStrut();
                    ...
                    if (currentRow != null) {
                        ...
                        try {
                            if (tipoSerieEjb.checkTipoSerieStandardDaRegistroOTipoUd(
                                    currentRow.getIdRegistroUnitaDoc(),
                                    currentRow.getIdTipoUnitaDoc()) == null) {
                                getForm().getTipoUnitaDocAmmesso().getCreaTipoSerieStandard()
                                        .setHidden(true);
                            }
                    ...
                    if (mappa != null && Application.Publisher.TIPO_UNITA_DOC_DETAIL
                            .equalsIgnoreCase(mappa.getAction())) {
            ...
            if (lista != null
                    && (lista.equals(getForm().getTipoStrutDocAmmessoDaTipoDocList().getName()))) {
                BigDecimal idStrut = ((DecTipoDocRowBean) getForm().getTipoDocList().getTable()
                        .getCurrentRow()).getIdStrut();
                ...
                /*
                 * Se il record corrente è presente (non sono in insert), setto ilvalore del tipo
                 * struttura documento
                 */
                if (currentRow != null) {
                    getForm().getTipoStrutDocAmmessoDaTipoDoc().getId_tipo_strut_doc_ammesso()
    ...
    public void undoDettaglio() throws EMFError {
        ...
        if (publisher.equals(Application.Publisher.REGISTRO_UNITA_DOC_DETAIL)
            ...
            getSession().removeAttribute(
                    "salvataggioAttributesCreazioneCriteriDaControlliModificaRegistro");
            goBack();
            ...
            goBack();
                ...
                && getForm().getTipoDoc().getStatus() != null
            ...
            if (getForm().getCampiSubStrutList().getStatus().equals(Status.insert)) {
                ...
                getForm().getCampoSubStrut()
                        .copyFromBean(getForm().getCampiSubStrutList().getTable().getCurrentRow());
                ...
                && getForm().getTipoStrutDocAmmessoDaTipoDoc().getStatus().toString()
                        .equals("insert")) {
            goBack();
    ...
    public void insertDettaglio() throws EMFError {
        ...
        if (lista.equals(getForm().getRegistroUnitaDocList().getName())) {
            ...
            getForm().getRegistroCreazioneCriterio().getCreaCriterioRaggrStandardRegistroButton()
                    .setHidden(true);
            ...
            getForm().getTipoUnitaDocCreazioneCriterio().getCreaCriterioRaggrStandardTipoUdButton()
                    .setHidden(true);
            getForm().getTempoConservazioneUnitaDocSection().setHidden(false);
            ...
            DecModelloTipoSerieTableBean listaModelli = modelliSerieEjb
                    .getDecModelloTipoSerieAllAbilitatiTableBean(idStrut, true);
            getForm().getTipoUnitaDoc().getId_modello_tipo_serie().setDecodeMap(DecodeMap.Factory
            ...
            OrgTipoServizioTableBean listaTipiServizioConserv = tipoUnitaDocEjb
                    .getOrgTipoServizioTableBean(
                            CostantiDB.TiClasseTipoServizio.CONSERVAZIONE.name());
            getForm().getTipoUnitaDoc().getId_tipo_servizio().setDecodeMap(DecodeMap.Factory
                    .newInstance(listaTipiServizioConserv, "id_tipo_servizio", "cd_tipo_servizio"));
            OrgTipoServizioTableBean listaTipiServizioAttiv = tipoUnitaDocEjb
                    .getOrgTipoServizioTableBean(
                            CostantiDB.TiClasseTipoServizio.ATTIVAZIONE_SISTEMA_VERSANTE.name());
            getForm().getTipoUnitaDoc().getId_tipo_servizio_attiv().setDecodeMap(DecodeMap.Factory
                    .newInstance(listaTipiServizioAttiv, "id_tipo_servizio", "cd_tipo_servizio"));
            ...
            getForm().getTipoUnitaDoc().getId_tipo_serv_conserv_tipo_ud()
                    .setDecodeMap(DecodeMap.Factory.newInstance(listaTipiServConservTipoUd,
                            "id_tipo_servizio", "cd_tipo_servizio"));
            OrgTipoServizioTableBean listaTipiServAttivTipoUd = tipoUnitaDocEjb
                    .getOrgTipoServizioTableBean(
                            CostantiDB.TiClasseTipoServizio.ATTIVAZIONE_TIPO_UD.name());
            getForm().getTipoUnitaDoc().getId_tipo_serv_attiv_tipo_ud()
                    .setDecodeMap(DecodeMap.Factory.newInstance(listaTipiServAttivTipoUd,
                            "id_tipo_servizio", "cd_tipo_servizio"));
            ...
            // tempo di conservazione
            getForm().getTipoUnitaDoc().getFl_conserv_uniforme()
                    .setDecodeMap(ComboGetter.getMappaGenericFlagSiNo());

            getForm().getTipoUnitaDoc().getFl_conserv_uniforme()
                    .setValue(JobConstants.ComboFlag.NO.getValue());

            getForm().getTipoUnitaDoc().getFl_conserv_illimitata()
                    .setDecodeMap(ComboGetter.getMappaGenericFlagSiNo());
            ...
            getForm().getTipoDocCreazioneCriterio().getCreaCriterioRaggrStandardTipoDocButton()
                    .setHidden(true);
            ...
            DecTipoUnitaDocRowBean tipoUnitaDocRow = (DecTipoUnitaDocRowBean) getForm()
                    .getTipoUnitaDocList().getTable().getCurrentRow();
            ...
            getForm().getTipoStrutUnitaDoc().getSis_vers_tipo_strut_unita_doc()
                    .setDecodeMap(DecodeMap.Factory.newInstance(
                            tipoUnitaDocEjb.getAplSistemaVersanteTableBean(), "id_sistema_versante",
                            "nm_sistema_versante"));
            ...
            if (getSession().getAttribute("provenienzaRegola")
                ...
                idStrut = ((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList().getTable()
                        .getCurrentRow()).getIdStrut();
                getForm().getRegolaSubStrut().getId_tipo_doc()
                        .setDecodeMap(DecodeMap.Factory.newInstance(
                                tipoDocEjb.getDocumentiPrincipali(idStrut), "id_tipo_doc",
            ...
            getForm().getRegolaSubStrut().getDt_soppres()
                    .setValue(formato.format(calendar.getTime()));
            ...
            if (getForm().getIdList().getId_strut().parse() != null) {
                ...
                OrgEnteRowBean enteRowBean = struttureEjb
            ...
            DecodeMap mpTiModelloXsd = modelliXsdUdEjb.getTiModelloXsdInUsoByIdAmbTiUso(idAmbiente,
                    tiUsoModelloXsd, "ti_modello_xsd");
            ...
            getForm().getXsdModelliUdDetail().getDt_uso_istituz()
                    .setValue(df.format(Calendar.getInstance().getTime()));
            getForm().getXsdModelliUdDetail().getDt_uso_soppres()
    ...
    public void dettaglioOnClick() throws EMFError {
        ...
        if (getForm().getXsdDatiSpecList().getName().equals(lista)
                && !action.equals(ListAction.NE_DETTAGLIO_DELETE)) {
            /*
             *
             * Ricordarsi di togliere gli append inutili nella stringa se non serve passare i
             * parametri in quella maniera
             */
            ...
            if (getLastPublisher().equals(Application.Publisher.TIPO_DOC_DETAIL)) {
                string.append("&idTipoDoc=").append(
                ...
                string.append("&idTipoUnitaDoc=")
                        .append(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList().getTable()
                                .getCurrentRow()).getIdTipoUnitaDoc().intValue());
                form.getIdList().getId_tipo_unita_doc()
                        .setValue(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                                .getTable().getCurrentRow()).getIdTipoUnitaDoc().toString());
                getSession().setAttribute("lastPage", "tipoUnitaDoc");
                form.getTipoUdRif().getNm_tipo_unita_doc()
                        .setValue(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                                .getTable().getCurrentRow()).getNmTipoUnitaDoc());
                form.getTipoUdRif().getDs_tipo_unita_doc()
                        .setValue(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                                .getTable().getCurrentRow()).getDsTipoUnitaDoc());
            }
            ...
            getSession().setAttribute("provenienzaRegola",
                    Application.Publisher.TIPO_UNITA_DOC_DETAIL);
            ...
            forwardToPublisher(Application.Publisher.REGISTRO_UNITA_DOC_DETAIL);
                ...
                && !action.equals(NE_DETTAGLIO_DELETE)) {
            ...
            if (getLastPublisher().equals(Application.Publisher.TIPO_UNITA_DOC_DETAIL)) {
                ...
                getSession().setAttribute("provenienzaRegola",
                        Application.Publisher.TIPO_DOC_DETAIL);
            }
    ...
    public void confermaDisattivazioneXsd() throws EMFError {
        /*
         *
         * Ricordarsi di togliere gli append inutili nella stringa se non serve passare i parametri
         * in quella maniera
         */
        StrutDatiSpecForm form = new StrutDatiSpecForm();
        Integer row = getForm().getXsdDatiSpecList().getTable().getCurrentRowIndex();
        ...
        if (getLastPublisher().equals(Application.Publisher.TIPO_DOC_DETAIL)) {
            ...
            form.getIdList().getId_tipo_unita_doc()
                    .setValue(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList().getTable()
                            .getCurrentRow()).getIdTipoUnitaDoc().toString());
            getSession().setAttribute("lastPage", "tipoUnitaDoc");
            ...
            form.getTipoUdRif().getDs_tipo_unita_doc().setValue(((DecTipoUnitaDocRowBean) getForm()
                    .getTipoUnitaDocList().getTable().getCurrentRow()).getDsTipoUnitaDoc());
        }
    ...
    public void elencoOnClick() throws EMFError {
        ArrayList<ExecutionHistory> executionHistoryList = SessionManager
    ...
    public void reloadAfterGoBack(String publisherName) {
        ...
        try {
            ...
            getMessageBox().addError(
                    "Errore inaspettato durante il recupero dell'identificativo della struttura");
        } finally {
        ...
        if (publisherName.equals(Application.Publisher.TIPO_DOC_DETAIL)
            ...
            if (publisherName.equals(Application.Publisher.TIPO_DOC_DETAIL)) {
                ...
                DecTipoDocRowBean tipoDocRB = (DecTipoDocRowBean) getForm().getTipoDocList()
                ...
                // Lista criteri di raggruppamento
                DecVRicCriterioRaggrTableBean criteri = critRaggrEjb
                        .getCriteriRaggrDaTipoDoc(tipoDocRB.getIdStrut(), tipoDocRB.getIdTipoDoc());
                criteri.addSortingRule("nm_criterio_raggr", SortingRule.ASC);
                criteri.sort();
                getForm().getCriteriRaggruppamentoList().setTable(criteri);
                getForm().getCriteriRaggruppamentoList().getTable()
                ...
                DecRegistroUnitaDocRowBean registroRB = (DecRegistroUnitaDocRowBean) getForm()
                        .getRegistroUnitaDocList().getTable().getCurrentRow();
                DecRegistroUnitaDocRowBean registroUdRB = registroEjb.getDecRegistroUnitaDocRowBean(
                        registroRB.getIdRegistroUnitaDoc(), registroRB.getIdStrut());
                DecVRicCriterioRaggrTableBean criteri = critRaggrEjb.getCriteriRaggrDaRegistro(
                        registroUdRB.getIdStrut(), registroUdRB.getIdRegistroUnitaDoc());
                criteri.addSortingRule("nm_criterio_raggr", SortingRule.ASC);
                criteri.sort();
                getForm().getCriteriRaggruppamentoList().setTable(criteri);
                getForm().getCriteriRaggruppamentoList().getTable()
        ...
        if (getLastPublisher().equals(Application.Publisher.TIPO_UNITA_DOC_AMMESSO_DETAIL)) {
            ...
            if (getForm().getTipoUnitaDocList().getTable() != null) {
                VTipoUnitaDocAmmessoRowBean.setIdTipoUnitaDoc(((DecTipoUnitaDocRowBean) getForm()
                        .getTipoUnitaDocList().getTable().getCurrentRow()).getIdTipoUnitaDoc());
                try {
                    loadTipoUnitaDoclists(false);
                } catch (EMFError | ParerUserError ex) {
                    ...
                    getMessageBox().addError(
                            "Errore inaspettato al caricamento della lista tipo unit\u00E0 dcoumentaria");
                }
            } else if (getForm().getRegistroUnitaDocList() != null) {
                VTipoUnitaDocAmmessoRowBean.setIdRegistroUnitaDoc(
                        ((DecRegistroUnitaDocRowBean) getForm().getRegistroUnitaDocList().getTable()
                ...
                getForm().getTipoUnitaDocAmmessoList().getTable()
                        .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                getForm().getTipoUnitaDocAmmessoList().setStatus(Status.view);
            }
        ...
        if (getLastPublisher().equals(Application.Publisher.TIPO_STRUT_UNITA_DOC_DETAIL)) {
            ...
            DecTipoDocAmmessoTableBean tipoDocAmmessoTableBean = tipoUnitaDocEjb
                    .getDecTipoDocAmmessoTableBean(
                            ((DecTipoStrutUnitaDocRowBean) getForm().getTipoStrutUnitaDocList()
            ...
            OrgRegolaValSubStrutRowBean row = (OrgRegolaValSubStrutRowBean) getForm()
                    .getRegoleSubStrutList().getTable().getCurrentRow();
            getForm().getCampiSubStrutList().setTable(
                    subStrutEjb.getOrgCampoValSubStrutTableBean(row.getIdRegolaValSubStrut()));
            ...
            if (getSession().getAttribute("provenienzaRegola")
                    .equals(Application.Publisher.TIPO_UNITA_DOC_DETAIL)) {
                DecTipoUnitaDocRowBean row = (DecTipoUnitaDocRowBean) getForm()
                        .getTipoUnitaDocList().getTable().getCurrentRow();
                getForm().getRegoleSubStrutList()
                        .setTable(subStrutEjb.getOrgRegolaValSubStrutTableBean(
                                row.getIdTipoUnitaDoc(), Constants.TipoDato.TIPO_UNITA_DOC,
                                getForm().getRegoleSubStrutList().isFilterValidRecords()));
            } else if (getSession().getAttribute("provenienzaRegola")
                    .equals(Application.Publisher.TIPO_DOC_DETAIL)) {
                DecTipoDocRowBean row = (DecTipoDocRowBean) getForm().getTipoDocList().getTable()
                        .getCurrentRow();
                getForm().getRegoleSubStrutList()
            ...
            getForm().getRegoleSubStrutList().getTable()
                    .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
            getForm().getRegoleSubStrutList().getTable().first();
        }
    ...
    public void tabDecTipoStrutUnitaDocOnClick() throws EMFError {
        ...
        getForm().getDecTipoUnitaDocTab()
                .setCurrentTab(getForm().getDecTipoUnitaDocTab().getDecTipoStrutUnitaDoc());
        final BigDecimal idTipoUnitaDoc = ((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                .getTable().getCurrentRow()).getIdTipoUnitaDoc();
        DecTipoStrutUnitaDocTableBean tipoStrutUnitaDocTableBean = tipoStrutDocEjb
                .getDecTipoStrutUnitaDocTableBean(idTipoUnitaDoc,
                        getForm().getTipoStrutUnitaDocList().isFilterValidRecords());
    ...
    public void tabDecTipoUnitaDocAmmessoOnClick() throws EMFError {
        getForm().getDecTipoUnitaDocTab()
                .setCurrentTab(getForm().getDecTipoUnitaDocTab().getDecTipoUnitaDocAmmesso());

        DecVLisTiUniDocAmsRowBean tipoUnitaDocAmmessoRowBean = new DecVLisTiUniDocAmsRowBean();
        DecVLisTiUniDocAmsTableBean tipoUnitaDocAmmessoTableBean = new DecVLisTiUniDocAmsTableBean();

        tipoUnitaDocAmmessoRowBean.setIdTipoUnitaDoc(((DecTipoUnitaDocRowBean) getForm()
                .getTipoUnitaDocList().getTable().getCurrentRow()).getIdTipoUnitaDoc());
        tipoUnitaDocAmmessoTableBean = tipoUnitaDocEjb
                .getDecVLisTiUniDocAmsTableBean(tipoUnitaDocAmmessoRowBean);
    ...
    public void tabDecTipoDocXsdDatiSpecOnClick() throws EMFError {
        ...
        getForm().getDecTipoDocTab()
                .setCurrentTab(getForm().getDecTipoDocTab().getDecTipoDocXsdDatiSpec());
    ...
    public void tabDecTipoUnitaDocXsdDatiSpecOnClick() throws EMFError {
        ...
        DecXsdDatiSpecTableBean xsdDatiSpecTableBean = new DecXsdDatiSpecTableBean();
        DecXsdDatiSpecRowBean xsdDatiSpecRowBean = new DecXsdDatiSpecRowBean();
        xsdDatiSpecRowBean.setIdTipoUnitaDoc(((DecTipoUnitaDocRowBean) getForm()
                .getTipoUnitaDocList().getTable().getCurrentRow()).getIdTipoUnitaDoc());
        xsdDatiSpecRowBean.setIdStrut(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                .getTable().getCurrentRow()).getIdStrut());
        xsdDatiSpecRowBean.setTiUsoXsd(CostantiDB.TipiUsoDatiSpec.VERS.name());
    ...
    /**
     * Metodo per popolare la combobox relativa alla form corrispondente alla tabella
     * DecTipoDocAmmesso
     */
    private void setTipoDocAmmessoComboBox(Long id) throws EMFError {
        getForm().getTipoDocAmmesso().getTi_doc().setDecodeMap(
                ComboGetter.getMappaSortedGenericEnum("ti_doc", VolumeEnums.DocTypeEnum.values()));
    ...
    /**
     * Metodo per popolare a seconda della struttura di riferimento, la ComboBox relativa alla
     * tabella TipoUnitaDocAmmesso
     *
     * @param idStrut
     *
     * @throws EMFError errore generico
    ...
    private void setTipoUnitaDocAmmessoComboBox(BigDecimal idStrut) throws EMFError {
        ...
        mappaRegistroUnitaDoc.populatedMap(registroUnitaTableBean, "id_registro_unita_doc",
                "cd_registro_unita_doc");
        getForm().getTipoUnitaDocAmmesso().getId_registro_unita_doc()
                .setDecodeMap(mappaRegistroUnitaDoc);
        DecTipoUnitaDocTableBean tipoUnitaTableBean = tipoUnitaDocEjb
                .getDecTipoUnitaDocTableBean(idStrut, true);
        // Ordino per registroUnitaDoc.cdRegistroUnitaDoc
        ...
        mappaTipoUnitaDoc.populatedMap(tipoUnitaTableBean, "id_tipo_unita_doc",
                "nm_tipo_unita_doc");
    ...
    public void updateRegistroUnitaDocList() throws EMFError {
        ...
        DecRegistroUnitaDocRowBean registroCurrent = (DecRegistroUnitaDocRowBean) getForm()
                .getRegistroUnitaDocList().getTable().getCurrentRow();
        if (!struttureEjb.existAroUnitaDocByIdRegistroUnitaDoc(
                registroCurrent.getIdRegistroUnitaDoc(), registroCurrent.getIdStrut())) {
            getForm().getRegistroUnitaDoc().setEditMode();
        }
        ...
        // creazione del criterio
        if (!critRaggrEjb.existsCriterioStandardPerTipoDato(
                registroCurrent.getIdRegistroUnitaDoc().longValue(), TipoDato.REGISTRO)) {
            getForm().getRegistroCreazioneCriterio().getCreaCriterioRaggrStandardRegistroButton()
                    .setHidden(false);
        } else {
            getForm().getRegistroCreazioneCriterio().getCreaCriterioRaggrStandardRegistroButton()
    ...
    public void updateTipoUnitaDocList() throws EMFError {
        ...
        DecTipoUnitaDocRowBean tipoUnitaDocCurrent = (DecTipoUnitaDocRowBean) getForm()
                .getTipoUnitaDocList().getTable().getCurrentRow();
        ...
        if (!critRaggrEjb.existsCriterioStandardPerTipoDato(
                tipoUnitaDocCurrent.getIdTipoUnitaDoc().longValue(), TipoDato.TIPO_UNITA_DOC)) {
            getForm().getTipoUnitaDocCreazioneCriterio().getCreaCriterioRaggrStandardTipoUdButton()
                    .setHidden(false);
        } else {
            getForm().getTipoUnitaDocCreazioneCriterio().getCreaCriterioRaggrStandardTipoUdButton()
    ...
    public void updateTipoStrutDocAmmessoDaTipoDocList() throws EMFError {
        ...
        BigDecimal idTipoStrutDoc = getForm().getTipoStrutDocAmmessoDaTipoDoc()
                .getId_tipo_strut_doc_ammesso().parse();
        getForm().getTipoStrutDocAmmessoDaTipoDoc().getId_tipo_strut_doc_ammesso()
                .setValue(idTipoStrutDoc.toString());
    ...
    private void setTipoUnitaComboBox(boolean isUpdate) throws EMFError {
        getForm().getTipoUnitaDoc().getTi_save_file()
                .setDecodeMap(ComboGetter.getMappaSortedGenericEnum("ti_save_file",
                        CostantiDB.TipoSalvataggioFile.values()));
        if (!isUpdate) {
            getForm().getTipoUnitaDoc().getTi_save_file()
                    .setValue(CostantiDB.TipoSalvataggioFile.BLOB.name());
        }
    ...
    public void updateTipoDocList() throws EMFError {
        ...
        if (flTipoDocPrincipale != null && flTipoDocPrincipale.equals("1")
                && !critRaggrEjb.existsCriterioStandardPerTipoDato(
                        tipoDocCurrent.getIdTipoDoc().longValue(), TipoDato.TIPO_DOC)) {
            getForm().getTipoDocCreazioneCriterio().getCreaCriterioRaggrStandardTipoDocButton()
                    .setHidden(false);
        } else {
            getForm().getTipoDocCreazioneCriterio().getCreaCriterioRaggrStandardTipoDocButton()
    ...
    /**
     * Metodo che cancella l'entitÃ DecRegistroUnitaDoc corrispondente al record della lista
     * selezionato
     *
     * @throws EMFError errore generico
     */
    ...
    public void deleteRegistroUnitaDocList() throws EMFError {
        ...
        if (mappa != null && Application.Publisher.REGISTRO_UNITA_DOC_DETAIL
                .equalsIgnoreCase(mappa.getAction())) {
            BigDecimal id = (BigDecimal) mappa.getId();
            BigDecimal idStrut = (BigDecimal) mappa.getAppo();
            registroUnitaDocRowBean = registroEjb.getDecRegistroUnitaDocRowBean(id, idStrut);
        } else {
            registroUnitaDocRowBean = (DecRegistroUnitaDocRowBean) getForm()
                    .getRegistroUnitaDocList().getTable().getCurrentRow();
        }
        ...
        try {
            ...
            if (Application.Publisher.REGISTRO_UNITA_DOC_DETAIL
    ...
    public void deleteTipoDocList() throws EMFError {
        ...
        try {
            ...
            if (Application.Publisher.TIPO_DOC_DETAIL.equalsIgnoreCase(param.getNomePagina())) {
                ...
                StruttureForm form = (StruttureForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(
                        SpagoliteLogUtil.getDetailActionNameDelete(form, form.getTipoDocList()));
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
    ...
    public void deleteRegistroTipoUnitaDocAmmessoList() {
        ...
        try {
            ...
            if (Application.Publisher.REGISTRO_UNITA_DOC_DETAIL
                ...
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getRegistroTipoUnitaDocAmmessoList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            String azioneModCriterioPerDeleteAssociazione = SpagoliteLogUtil
                    .getButtonActionName(getForm(), getForm().getTipoUnitaDocAmmesso(),
                            getForm().getTipoUnitaDocAmmesso()
                                    .getUpdCriterioRaggrByTipoUnitaDocFromAssociazioneDelete()
                                    .getName());
            String nmPaginaPerCriteri = Application.Publisher.TIPO_UNITA_DOC_AMMESSO_DETAIL;
            tipoUnitaDocEjb.deleteDecTipoUnitaDocAmmesso(param,
                    azioneModCriterioPerDeleteAssociazione, nmPaginaPerCriteri,
                    VTipoUnitaDocAmmessoRowBean.getIdTipoUnitaDocAmmesso());
            getMessageBox().addMessage(new Message(MessageLevel.INF,
                    "Tipo Unita' Documentaria Ammessa eliminata con successo"));
            ...
            if (Application.Publisher.TIPO_UNITA_DOC_AMMESSO_DETAIL.equals(lastPublisher)) {
                ...
                getForm().getIdList().getId_registro_unita_doc().setValue(
                        VTipoUnitaDocAmmessoRowBean.getIdRegistroUnitaDoc().toPlainString());
                reloadRegistroLists();
            }
        } catch (Exception e) {
        ...
        try {
            ...
            LogParam param = SpagoliteLogUtil.getLogParam(
                    configurationHelper
                            .getValoreParamApplicByApplic(CostantiDB.ParametroAppl.NM_APPLIC),
                    getUser().getUsername(), SpagoliteLogUtil.getPageName(this));
            if (Application.Publisher.TIPO_UNITA_DOC_DETAIL
                    .equalsIgnoreCase(param.getNomePagina())) {
                StrutTipiForm form = (StrutTipiForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getTipoUnitaDocAmmessoList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
    ...
    public void deleteTipoStrutUnitaDocList() throws EMFError {
        ...
        try {
            ...
            if (Application.Publisher.TIPO_UNITA_DOC_DETAIL
                    .equalsIgnoreCase(param.getNomePagina())) {
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getTipoStrutUnitaDocList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            tipoUnitaDocEjb.deleteDecTipoStrutUnitaDoc(param, tipoStrutUnitaDocRowBean);
            final BigDecimal idTipoUnitaDoc = ((DecTipoUnitaDocRowBean) getForm()
                    .getTipoUnitaDocList().getTable().getCurrentRow()).getIdTipoUnitaDoc();
            DecTipoStrutUnitaDocTableBean tipoStrutUnitaDocTableBean = tipoStrutDocEjb
                    .getDecTipoStrutUnitaDocTableBean(idTipoUnitaDoc,
                            getForm().getTipoStrutUnitaDocList().isFilterValidRecords());
            getMessageBox().addMessage(
                    new Message(MessageLevel.INF, "Tipo Struttura eliminato con successo"));
            getForm().getTipoStrutUnitaDocList().setTable(tipoStrutUnitaDocTableBean);
            getForm().getTipoStrutUnitaDocList().getTable().first();
            getForm().getTipoStrutUnitaDocList().getTable()
                    .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
            if (Application.Publisher.TIPO_STRUT_UNITA_DOC_DETAIL.equals(lastPublisher)
                    || "".equals(lastPublisher)) {
                goBack();
            }
        } catch (ParerUserError ex) {
    ...
    public void deleteTipoDocAmmessoList() throws EMFError {
        ...
        DecTipoDocAmmessoRowBean tipoDocAmmessoRowBean = (DecTipoDocAmmessoRowBean) getForm()
                .getTipoDocAmmessoList().getTable().getCurrentRow();
        ...
        try {
            ...
            LogParam param = SpagoliteLogUtil.getLogParam(
                    configurationHelper
                            .getValoreParamApplicByApplic(CostantiDB.ParametroAppl.NM_APPLIC),
                    getUser().getUsername(), SpagoliteLogUtil.getPageName(this));
            if (Application.Publisher.TIPO_STRUT_UNITA_DOC_DETAIL
                    .equalsIgnoreCase(param.getNomePagina())) {
                StrutTipiForm form = (StrutTipiForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getTipoDocAmmessoList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
    ...
    public void deleteAaRegistroUnitaDocList() throws EMFError {
        ...
        BigDecimal idRegistroUnitaDoc = ((DecRegistroUnitaDocRowBean) getForm()
                .getRegistroUnitaDocList().getTable().getCurrentRow()).getIdRegistroUnitaDoc();
        ...
        try {
            ...
            if (Application.Publisher.REGISTRO_UNITA_DOC_DETAIL
                ...
                StrutTipiForm form = (StrutTipiForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getAaRegistroUnitaDocList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            ...
            loadDettaglio();
            getMessageBox().addMessage(new Message(MessageLevel.INF,
                    "Periodo di validità registro eliminato con successo"));
    ...
    private void salvaRegistroUnitaDoc() throws EMFError {
        ...
        if (registroUnitaDoc.validate(getMessageBox())) {
            ...
            if (registroUnitaDoc.getCd_registro_unita_doc().parse() == null) {
                getMessageBox()
                        .addError("Errore di compilazione form: codice registro non inserito<br/>");
            } else {
                ...
                if (!fsu.controllaSubPath(registroUnitaDoc.getCd_registro_normaliz().parse())) {
                    ...
                    /*
                     * Controllo che la lunghezza totale, tenendo presente anche ambiente, ente e
                     * struttura, sia minore o uguale a 100 caratteri (aggiungo 3 che è il numero di
                     * underscores di separazione)
                     */
                    int lunghezzaAmbEnteStrutReg = getForm().getStrutRif().getNm_ambiente().parse()
                            .length() + getForm().getStrutRif().getId_ente().parse().length()
                            + getForm().getStrutRif().getNm_strut().parse().length()
                            + getForm().getRegistroUnitaDoc().getCd_registro_unita_doc().parse()
                                    .length()
                            + 3;
            ...
            if (registroUnitaDoc.getDs_registro_unita_doc().parse() == null) {
                getMessageBox().addError(
                        "Errore di compilazione form: descrizione registro non inserito<br/>");
            }
            ...
            if (StringUtils.isBlank(registroFiscale)) {
                getMessageBox().addError(
                        "Errore di compilazione form:  selezionare un valore per la voce \"Fiscale\"<br/>");
            }
            if (registroUnitaDoc.getDt_istituz().parse() != null
                    && registroUnitaDoc.getDt_soppres().parse() != null
                    && registroUnitaDoc.getDt_istituz().parse()
                            .after(registroUnitaDoc.getDt_soppres().parse())) {
                getMessageBox().addError(
            ...
            // getMessageBox()
            // .addError("Errore di compilazione form: inserire tempo conservazione tipo
            // unit\u00E0<br/>");
            // }

            try {
                BigDecimal idStrut = (BigDecimal) getSession()
                        .getAttribute("id_struttura_lavorato");
                if (idStrut == null) {
                    idStrut = getForm().getIdList().getId_strut().parse();
                }
                ...
                boolean creaTipoSerieStandard = registroUnitaDoc.getFl_crea_tipo_serie_standard()
                        .parse() != null
                                ? registroUnitaDoc.getFl_crea_tipo_serie_standard().parse()
                                        .equals("1")
                                : false;
                ...
                if (!getMessageBox().hasError() && creaTipoSerieStandard) {
                    ...
                    if (idModelloTipoSerie != null) {
                        modelliSerieEjb.checkModelloTipoUdRegistroPerSerie(idStrut,
                                idModelloTipoSerie, tipoSerie, descrizioneTipoSerie, codiceSerie,
                                descrizioneSerie, idRegistroUnitaDoc, null);
                    } else {
                        getMessageBox().addError(
                ...
                if (!getMessageBox().hasError()) {
                    ...
                    if ((registroUnitaDoc.getFl_conserv_uniforme().parse() != null
                            ...
                            && (StringUtils
                                    .isNotEmpty(registroUnitaDoc.getFl_conserv_illimitata().parse())
                                    || registroUnitaDoc.getNi_aa_conserv().parse() != null))
                            // conserv uniforme uguale a 1 e ho messo illimitata a 1 ma numero anni
                            // diverso da 9999
                            || (registroUnitaDoc.getFl_conserv_uniforme().parse() != null
                                    ...
                                    && registroUnitaDoc.getFl_conserv_illimitata().parse()
                                            .equals("1")
                                    && registroUnitaDoc.getNi_aa_conserv().parse() != null
                                    && registroUnitaDoc.getNi_aa_conserv().parse()
                                            .compareTo(new BigDecimal("9999")) != 0)
                            // conserv uniforme uguale a 1, illimitata a 0 ma non ho messo qualcosa
                            // in numero anni
                            || (registroUnitaDoc.getFl_conserv_uniforme().parse() != null
                                    && registroUnitaDoc.getFl_conserv_uniforme().parse().equals("1")
                                    && registroUnitaDoc.getFl_conserv_illimitata().parse() != null
                ...
                if (!getMessageBox().hasError()) {
                    ...
                    // MEV 25985 - Se il valore di FlCreaSerie è spuntato, allora non devo
                    // considerare i valori su
                    // registro
                    if (getForm().getRegistroUnitaDoc().getFl_crea_serie() != null && getForm()
                            .getRegistroUnitaDoc().getFl_crea_serie().parse().equals("1")) {
                    ...
                    if (getForm().getRegistroUnitaDoc().getStatus().equals(Status.insert)) {
                        ...
                        registroUnitaDocRowBean = registroEjb.getDecRegistroUnitaDocRowBean(
                                ...
                                registroUnitaDocRowBean.getIdStrut());
                        getForm().getIdList().getId_registro_unita_doc().setValue(
                                registroUnitaDocRowBean.getIdRegistroUnitaDoc().toPlainString());
                        ...
                        getMessageBox().addMessage(new Message(MessageLevel.INF,
                                "Nuovo registro salvato con successo"));

                        if (popup) {
                            getMessageBox().setViewMode(ViewMode.alert);
                            getMessageBox().addMessage(
                                    new Message(MessageLevel.INF, "<br>" + msgTempiConservazione));
                        } else {
                        ...
                        eseguiStepControlloTipiSerieSalvataggioModificaRegistro(param, null,
                                idStrut, idRegistroUnitaDoc, cdRegistroUnitaDoc,
                                registroUnitaDocRowBean, creazioneCriterio, popup,
                                msgTempiConservazione);
                    }
                }
            } catch (ParerUserError e) {
                setActionToSession(null, true);
    ...
    private void eseguiStepControlloTipiSerieSalvataggioModificaRegistro(LogParam param,
            String nmAzionePerCriteri, BigDecimal idStrut, BigDecimal idRegistroUnitaDoc,
            String cdRegistroUnitaDoc, DecRegistroUnitaDocRowBean registroUnitaDocRowBean,
            RegistroCreazioneCriterio creazioneCriterio, boolean popup,
            String msgTempiConservazione) throws EMFError {
        try {
            // Devo mostrare un popup. Purtroppo il punto più "decente" è questo. Fa schifo
            // e lo sappiamo entrambi.
            if (cdRegistroUnitaDoc != null && !cdRegistroUnitaDoc
                    .equals(registroUnitaDocRowBean.getCdRegistroUnitaDoc())) {
                String message = registroEjb.checkEditRegistroForTipiSerie(idStrut,
                        idRegistroUnitaDoc, registroUnitaDocRowBean.getCdRegistroUnitaDoc());
            ...
            String azioneInsCriterio = SpagoliteLogUtil.getButtonActionName(getForm(),
                    getForm().getRegistroUnitaDoc(), getForm().getRegistroUnitaDoc()
                            .getInsCriterioRaggrByTipoUnitaDocFromReg().getName());
            String azioneModCriterio = SpagoliteLogUtil.getButtonActionName(getForm(),
                    getForm().getRegistroUnitaDoc(), getForm().getRegistroUnitaDoc()
                            .getUpdCriterioRaggrByTipoUnitaDocFromReg().getName());
            registroEjb.updateDecRegistroUnitaDoc(param, azioneInsCriterio, azioneModCriterio,
                    idRegistroUnitaDoc, registroUnitaDocRowBean,
                    creazioneCriterio.getCriterio_autom_registro().parse());
            getMessageBox()
                    .addMessage(new Message(MessageLevel.INF, "Registro modificato con successo"));
            if (popup) {
                getMessageBox().setViewMode(ViewMode.alert);
                getMessageBox()
                        .addMessage(new Message(MessageLevel.INF, "<br>" + msgTempiConservazione));
            } else {
                getMessageBox().setViewMode(ViewMode.plain);
            }
            // Ricarico tutto il registro e i suoi figli
    ...
    private void salvaTipoUnitaDoc() throws EMFError {
        ...
        TipoUnitaDocCreazioneCriterio creazioneCriterio = getForm()
                .getTipoUnitaDocCreazioneCriterio();
        ...
        if (tipoUnitaDoc.validate(getMessageBox())) {
            ...
            if (tipoUnitaDoc.getTi_save_file().parse() == null) {
                getMessageBox().addError(
                        "Errore di compilazione form: tipo salvataggio file non inserito<br/>");
            }
            ...
            if (tipoUnitaDoc.getDt_istituz().parse() != null
                    && tipoUnitaDoc.getDt_istituz().parse() != null && tipoUnitaDoc.getDt_istituz()
                            .parse().after(tipoUnitaDoc.getDt_soppres().parse())) {
                getMessageBox().addError(
                        "Errore di compilazione form: data soppressione precedente a data istituzione<br/>");
            }
            if (tipoUnitaDoc.getNm_categ_strut().parse() == null) {
                getMessageBox().addError(
                        "Errore di compilazione form: inserire categoria tipo unit\u00E0<br/>");
            }
            ...
            try {
                ...
                if (getForm().getTipoUnitaDoc().getStatus().equals(Status.update)) {
                    idTipoUnitaDoc = ((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                            .getTable().getCurrentRow()).getIdTipoUnitaDoc();
                }
                // Controlli sulla configurazione serie
                boolean creaTipoSerieStandard = tipoUnitaDoc.getFl_crea_tipo_serie_standard()
                        .parse() != null
                                ? tipoUnitaDoc.getFl_crea_tipo_serie_standard().parse().equals("1")
                                : false;
                if (!getMessageBox().hasError() && creaTipoSerieStandard) {
                    ...
                    if (idModelloTipoSerie != null) {
                        ...
                        String descrizioneTipoSerie = tipoUnitaDoc.getDs_tipo_serie_da_creare()
                                .parse();
                        String descrizioneSerie = tipoUnitaDoc.getDs_serie_da_creare().parse();
                        modelliSerieEjb.checkModelloTipoUdRegistroPerSerie(idStrut,
                                idModelloTipoSerie, tipoSerie, descrizioneTipoSerie, codiceSerie,
                                descrizioneSerie, null, idTipoUnitaDoc);
                    } else {
                        getMessageBox().addError(
                ...
                // i campi "Conservazione" e "Tipo servizio di attivazione su tipo ud" siano stati
                // compilati
                ...
                if (!getMessageBox().hasError()) {
                    ...
                    if ((tipoUnitaDoc.getFl_conserv_uniforme().parse() != null
                            ...
                            && (StringUtils
                                    .isNotEmpty(tipoUnitaDoc.getFl_conserv_illimitata().parse())
                            ...
                            || (tipoUnitaDoc.getFl_conserv_uniforme().parse() != null
                                    ...
                                    && tipoUnitaDoc.getNi_aa_conserv().parse() != null
                                    && tipoUnitaDoc.getNi_aa_conserv().parse()
                                            .compareTo(new BigDecimal("9999")) != 0)
                            // conserv uniforme uguale a 1, illimitata a 0 ma non ho messo qualcosa
                            // in numero anni
                            || (tipoUnitaDoc.getFl_conserv_uniforme().parse() != null
                ...
                if (getMessageBox().isEmpty()) {
                    ...
                    tipoUnitaDocRowBean
                            .setIdCategTipoUnitaDoc(tipoUnitaDoc.getNm_categ_strut().parse());
                    ...
                    LogParam param = SpagoliteLogUtil.getLogParam(
                            ...
                            SpagoliteLogUtil.getToolbarSave(
                                    getForm().getTipoUnitaDoc().getStatus().equals(Status.update)));
                    param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
                    if (getForm().getTipoUnitaDoc().getStatus().equals(Status.insert)) {
                        ...
                        tipoUnitaDocEjb.updateDecTipoUnitaDoc(param, idTipoUnitaDoc,
                                tipoUnitaDocRowBean,
                                creazioneCriterio.getCriterio_autom_tipo_ud().parse());
                        getMessageBox().addMessage(new Message(MessageLevel.INF,
                                "Tipologia unit\u00E0 documentaria modificata con successo"));
                        getForm().getIdList().getId_tipo_unita_doc()
                                .setValue(idTipoUnitaDoc.toPlainString());
                        loadTipoUnitaDoclists(true);
                    }
    ...
    private void salvaTipoDocAmmesso() throws EMFError {
        ...
        BigDecimal idTipoStrutUnitaDoc = ((DecTipoStrutUnitaDocRowBean) getForm()
                .getTipoStrutUnitaDocList().getTable().getCurrentRow()).getIdTipoStrutUnitaDoc();
        ...
        if (getForm().getTipoDocAmmesso().getStatus().equals(Status.insert) && tipoUnitaDocEjb
                .existsDecTipoDocAmmesso(null, tipoDocAmmesso.getId_tipo_doc().parse(),
        ...
        DecTipoDocAmmessoTableBean tb = (DecTipoDocAmmessoTableBean) getForm()
                .getTipoDocAmmessoList().getTable();
            ...
            if (getMessageBox().isEmpty()) {
                ...
                if (getForm().getTipoDocAmmesso().getStatus().equals(Status.insert)) {
                    ...
                    tipoDocAmmessoRowBean = tipoUnitaDocEjb.getDecTipoDocAmmessoRowBean(null,
                            tipoDocAmmessoRowBean.getIdTipoDoc(),
                            tipoDocAmmessoRowBean.getIdTipoStrutUnitaDoc(),
                            tipoDocAmmessoRowBean.getTiDoc());
                    tipoDocAmmesso.getNm_tipo_doc()
                            .setValue(tipoDocAmmesso.getId_tipo_doc().getHtmlDecodedValue());
                    ...
                    String tiDocInziale = ((DecTipoDocAmmessoRowBean) getForm()
                            .getTipoDocAmmessoList().getTable().getCurrentRow()).getTiDoc();
                    BigDecimal idTipoDocAmmesso = ((DecTipoDocAmmessoRowBean) getForm()
                            .getTipoDocAmmessoList().getTable().getCurrentRow())
                            .getIdTipoDocAmmesso();
                    tipoUnitaDocEjb.updateDecTipoDocAmmesso(param, idTipoDocAmmesso,
                            tipoDocAmmessoRowBean, tiDocInziale);
                    getMessageBox().addMessage(new Message(MessageLevel.INF,
                     ...
                     */
                    ((DecTipoDocAmmessoRowBean) getForm().getTipoDocAmmessoList().getTable()
                            .getCurrentRow()).setIdTipoDocAmmesso(idTipoDocAmmesso);
                }
                getForm().getTipoDocAmmesso().setViewMode();
                getForm().getTipoDocAmmesso().setStatus(Status.view);
                getForm().getTipoDocAmmessoList().setStatus(Status.view);
    ...
    private void salvaTipoStrutUnitaDoc() throws EMFError {
        ...
        if (tipoStrutUnitaDoc.validate(getMessageBox())) {
            ...
            if (tipoStrutUnitaDoc.getAa_min_tipo_strut_unita_doc().parse() != null
                    ...
                    && tipoStrutUnitaDoc.getAa_min_tipo_strut_unita_doc().parse().compareTo(
                            tipoStrutUnitaDoc.getAa_max_tipo_strut_unita_doc().parse()) > 0) {
                getMessageBox().addError(
                        "Errore di compilazione form: anno inizio validità maggiore di anno fine validità<br/>");
            }
            if (tipoStrutUnitaDoc.getDt_istituz().parse()
                    .after(tipoStrutUnitaDoc.getDt_soppres().parse())) {
                getMessageBox().addError(
            ...
            try {
                if (getMessageBox().isEmpty()) {
                    ...
                    List<BigDecimal> idXsdDatiSpecList = getForm().getTipoStrutUnitaDoc()
                            .getMetadati_specifici().parse();
                    ...
                    if (getForm().getTipoStrutUnitaDoc().getStatus().equals(Status.insert)) {
                        ...
                        getForm().getIdList().getId_tipo_strut_doc().setValue(
                                tipoStrutUnitaDocRowBean.getIdTipoStrutUnitaDoc().toPlainString());
                        ...
                        idTipoStrutUnitaDoc = ((DecTipoStrutUnitaDocRowBean) getForm()
                                .getTipoStrutUnitaDocList().getTable().getCurrentRow())
                                .getIdTipoStrutUnitaDoc();
                        tipoUnitaDocEjb.updateDecTipoStrutUnitaDoc(param, idTipoStrutUnitaDoc,
                                tipoStrutUnitaDocRowBean, idSistemaVersanteList,
                                idRegistroUnitaDocList, idXsdDatiSpecList);
                        getMessageBox().addMessage(
                                new Message(MessageLevel.INF, "Modifica effettuata con successo"));
                    }
                    getForm().getTipoStrutUnitaDoc().setViewMode();
                    getForm().getTipoStrutUnitaDoc().setStatus(Status.view);
                    getForm().getTipoStrutUnitaDocList().setStatus(Status.view);
    ...
    private void salvaTipoUnitaDocAmmesso() throws EMFError {
        ...
        if (tipoUnitaDocAmmesso.getId_registro_unita_doc().parse() == null) {
            getMessageBox().addError(
                    "Errore di compilazione form: registro unit\u00E0 documentaria non inserito<br/>");
        }
        if (tipoUnitaDocAmmesso.getId_tipo_unita_doc().parse() == null) {
            getMessageBox().addError(
                    "Errore di compilazione form: tipo unit\u00E0 documentaria non inserito<br/>");
        }

        if (getMessageBox().isEmpty()) {
            BigDecimal idRegistroUnitaDoc = getForm().getTipoUnitaDocAmmesso()
                    .getId_registro_unita_doc().parse();
            BigDecimal idTipoUnitaDoc = getForm().getTipoUnitaDocAmmesso().getId_tipo_unita_doc()
                    .parse();
            /*
             * Codice aggiuntivo per il logging...
             */
                ...
                if (getForm().getTipoUnitaDocAmmesso().getStatus().equals(Status.insert)) {
                    ...
                    if (tipoUnitaDocEjb.getDecTipoUnitaDocAmmessoByParentId(idRegistroUnitaDoc,
                        ...
                        throw new ParerUserError(
                                "Associazione gi\u00e0 esistente all'interno della struttura</br>");
                    }
                    // Se tutto OK, proseguo
                    eseguiSalvataggioAssociazione(param, null, null, idRegistroUnitaDoc,
                            idTipoUnitaDoc);
                    ...
                    if (getForm().getTipoUnitaDocAmmessoList().getStatus().equals(Status.update)) {
                        VTipoUnitaDocAmmessoRowBean = (DecVLisTiUniDocAmsRowBean) getForm()
                                .getTipoUnitaDocAmmessoList().getTable().getCurrentRow();
                    } else if (getForm().getRegistroTipoUnitaDocAmmessoList().getStatus()
                    ...
                    tipoUnitaDocEjb.updateDecTipoUnitaDocAmmesso(param,
                            tipoUnitaDocAmmessoRowBean.getIdTipoUnitaDocAmmesso(),
                            idRegistroUnitaDoc, idTipoUnitaDoc);
                    getMessageBox().setViewMode(ViewMode.plain);
                    setAssociazioneAfterSave(tipoUnitaDocAmmessoRowBean.getIdTipoUnitaDocAmmesso(),
                            idRegistroUnitaDoc, idTipoUnitaDoc);
                }
            } catch (ParerUserError e) {
                getMessageBox().addError(e.getDescription());
    ...
    public void eseguiSalvataggioAssociazione(LogParam param, String nmAzionePerCriteri,
            String tipoAzione, BigDecimal idRegistroUnitaDoc, BigDecimal idTipoUnitaDoc)
            throws ParerUserError {
        param.setNomeAzione(SpagoliteLogUtil.getToolbarInsert());
        String azioneInsCriterio = SpagoliteLogUtil.getButtonActionName(getForm(),
                getForm().getTipoUnitaDocAmmesso(), getForm().getTipoUnitaDocAmmesso()
                        .getInsCriterioRaggrByTipoUnitaDocFromAssociazione().getName());
        String azioneModCriterio = SpagoliteLogUtil.getButtonActionName(getForm(),
                getForm().getTipoUnitaDocAmmesso(), getForm().getTipoUnitaDocAmmesso()
                        .getUpdCriterioRaggrByTipoUnitaDocFromAssociazione().getName());
        try {
            tipoUnitaDocEjb.insertDecTipoUnitaDocAmmesso(param, azioneInsCriterio,
                    azioneModCriterio, idRegistroUnitaDoc, idTipoUnitaDoc);
            ...
            getMessageBox().addInfo(
                    "Nuovo tipo registro associato con successo al tipo di unit\u00E0 documentaria");
            setAssociazioneAfterSave(tipoUnitaDocAmmessoRowBean.getIdTipoUnitaDocAmmesso(),
                    idRegistroUnitaDoc, idTipoUnitaDoc);
        } catch (ParerWarningException ex) {
            DecTipoUnitaDocAmmessoRowBean tipoUnitaDocAmmessoRowBean = tipoUnitaDocEjb
    ...
    public void setAssociazioneAfterSave(BigDecimal idTipoUnitaDocAmmesso,
        ...
        getForm().getIdList().getId_tipo_unita_doc_ammesso()
                .setValue(idTipoUnitaDocAmmesso.toPlainString());
        getForm().getTipoUnitaDocAmmesso().getCreaTipoSerieStandard().setEditMode();
        getForm().getTipoUnitaDocAmmesso().getCreaTipoSerieStandard().setHidden(false);

        try {
            if (tipoSerieEjb.checkTipoSerieStandardDaRegistroOTipoUd(idRegistroUnitaDoc,
                    idTipoUnitaDoc) == null) {
                getForm().getTipoUnitaDocAmmesso().getCreaTipoSerieStandard().setHidden(true);
            }
        } catch (ParerUserError ex) {
    ...
    private void salvaTipoDoc() throws EMFError {
        ...
        String flTipoDocPrincipaleBeforeChange = getForm().getTipoDoc().getFl_tipo_doc_principale()
                .parse();
        ...
        if (tipoDoc.validate(getMessageBox())) {
            ...
            if (tipoDoc.getNm_tipo_doc().parse() == null) {
                getMessageBox()
                        .addError("Errore di compilazione form: nome tipo non inserito<br/>");
            }
            if (tipoDoc.getDs_tipo_doc().parse() == null) {
                getMessageBox().addError(
                        "Errore di compilazione form: descrizione tipo non inserito<br/>");
            }
            ...
            try {
                ...
                if (getMessageBox().isEmpty()) {
                    ...
                    if (getForm().getTipoDoc().getStatus().equals(Status.insert)) {
                        ...
                        getMessageBox().addMessage(
                                new Message(MessageLevel.INF, "Nuovo Tipo salvato con successo"));

                    } else if (getForm().getTipoDoc().getStatus().equals(Status.update)) {
                        param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                        BigDecimal idTipo = null;

                        idTipo = ((DecTipoDocRowBean) getForm().getTipoDocList().getTable()
                        ...
                        getMessageBox().addMessage(new Message(MessageLevel.INF,
                                "Tipo documento modificato con successo"));

                    }

                    // Lista criteri di raggruppamento
                    DecVRicCriterioRaggrTableBean criteri = critRaggrEjb.getCriteriRaggrDaTipoDoc(
                            tipoDocRowBean.getIdStrut(), tipoDocRowBean.getIdTipoDoc());
                    criteri.addSortingRule("nm_criterio_raggr", SortingRule.ASC);
                    criteri.sort();
                    getForm().getCriteriRaggruppamentoList().setTable(criteri);
                    getForm().getCriteriRaggruppamentoList().getTable()
                ...
                if (tipoDocRowBean.getIdTipoDoc() != null) {
                    getForm().getIdList().getId_tipo_doc()
                            .setValue(tipoDocRowBean.getIdTipoDoc().toPlainString());
                }
    ...
    private void salvaTipoStrutDocAmmesso() throws EMFError {
        ...
        if (getForm().getTipoStrutDocAmmessoDaTipoDoc().getId_tipo_strut_doc_ammesso()
                .parse() == null) {
            getMessageBox().addError(
            ...
            if (getMessageBox().isEmpty()) {
                ...
                if (getForm().getTipoStrutDocAmmessoDaTipoDoc().getStatus().equals(Status.insert)) {
                    ...
                    BigDecimal idTipoDocDB = ((DecTipoStrutDocAmmessoRowBean) getForm()
                            .getTipoStrutDocAmmessoDaTipoDocList().getTable().getCurrentRow())
                            .getIdTipoDoc();
                    BigDecimal idTipoStrutDocInModifica = getForm()
                            .getTipoStrutDocAmmessoDaTipoDoc().getId_tipo_strut_doc_ammesso()
                            .parse();
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarUpdate());
                    tipoDocEjb.updateDecTipoStrutDocAmmessoFromTipoDoc(param,
                            idTipoStrutDocAmmessoDB, idTipoDocDB, idTipoStrutDocInModifica);
                    getMessageBox().addMessage(new Message(MessageLevel.INF,
                            "Tipo struttura documento ammesso modificata con successo!"));
                    /*
                     * Setto sulla lista (ancora da ricaricare) il nuovo valore di idTipoStrutDoc,
                     * in maniera tale che in caso di immediata ri-modifica prenda su, dalla
                     * loadDettaglio, il valore corretto
                     */
                    ((DecTipoStrutDocAmmessoRowBean) getForm().getTipoStrutDocAmmessoDaTipoDocList()
                            .getTable().getCurrentRow())
                            .setIdTipoStrutDoc(idTipoStrutDocInModifica);
                }
                getMessageBox().setViewMode(ViewMode.plain);
    ...
    private void loadTipoUnitaDoc(BigDecimal idTipoUnitaDoc) throws EMFError, ParerUserError {
        ...
        OrgTipoServizioTableBean listaTipiServConservTipoUd = tipoUnitaDocEjb
                .getOrgTipoServizioTableBean(CostantiDB.TiClasseTipoServizio.CONSERVAZIONE.name());
        getForm().getTipoUnitaDoc().getId_tipo_serv_conserv_tipo_ud().setDecodeMap(DecodeMap.Factory
                .newInstance(listaTipiServConservTipoUd, "id_tipo_servizio", "cd_tipo_servizio"));
        OrgTipoServizioTableBean listaTipiServAttivTipoUd = tipoUnitaDocEjb
                .getOrgTipoServizioTableBean(
                        CostantiDB.TiClasseTipoServizio.ATTIVAZIONE_TIPO_UD.name());
        getForm().getTipoUnitaDoc().getId_tipo_serv_attiv_tipo_ud().setDecodeMap(DecodeMap.Factory
                .newInstance(listaTipiServAttivTipoUd, "id_tipo_servizio", "cd_tipo_servizio"));

        DecTipoUnitaDocRowBean tipoUnitaRowBean = tipoUnitaDocEjb
                .getDecTipoUnitaDocRowBean(idTipoUnitaDoc, null);
        setTipoUnitaComboBox();
        ...
        if (tipoUnitaRowBean.getIdCategTipoUnitaDoc() != null) {
            ...
            if (idCategStrutPadre != null) {
                ...
                mappaCateg.populatedMap(table, "id_categ_tipo_unita_doc",
                ...
                getForm().getTipoUnitaDoc().getTi_categ_strut()
                        .setValue(idCategStrutPadre.toString());
            } // Sono una categoria
            else {
                DecCategTipoUnitaDocTableBean table = tipoUnitaDocEjb
                        .getDecCategTipoUnitaDocChildTableBean(
                                tipoUnitaRowBean.getIdCategTipoUnitaDoc());
                DecodeMap mappaCateg = new DecodeMap();
                mappaCateg.populatedMap(table, "id_categ_tipo_unita_doc",
                        "cd_categ_tipo_unita_doc");
                getForm().getTipoUnitaDoc().getNm_categ_strut().setDecodeMap(mappaCateg);
        ...
        if ((StringUtils.isNotBlank(cessato) && "1".equals(cessato))
                || getRequest().getAttribute("cessato") != null) {
            getForm().getParametriTipoUdButtonList().getParametriAmministrazioneTipoUdButton()
                    .setViewMode();
            getForm().getParametriTipoUdButtonList().getParametriConservazioneTipoUdButton()
                    .setViewMode();
            getForm().getParametriTipoUdButtonList().getParametriGestioneTipoUdButton()
                    .setViewMode();
        } else {
            getForm().getParametriTipoUdButtonList().getParametriAmministrazioneTipoUdButton()
                    .setEditMode();
    ...
    private void loadTipoUnitaDoclists(boolean isFirst) throws EMFError, ParerUserError {
        ...
        if (!isFirst) {
            if (getForm().getTipoUnitaDocAmmessoList().getTable() != null) {
                ...
                indMap.put("tipoUnitaDocAmmessoPS",
                        getForm().getTipoUnitaDocAmmessoList().getTable().getPageSize());
            }
            if (getForm().getXsdDatiSpecList().getTable() != null) {
                indMap.put("xsdDatiSpec",
                        getForm().getXsdDatiSpecList().getTable().getCurrentRowIndex());
                indMap.put("xsdDatiSpecPS",
                        getForm().getXsdDatiSpecList().getTable().getPageSize());
            }
            if (getForm().getXsdModelliUdList().getTable() != null) {
                indMap.put("xsdModelli",
                        getForm().getXsdModelliUdList().getTable().getCurrentRowIndex());
                indMap.put("xsdModelliPS",
                        getForm().getXsdModelliUdList().getTable().getPageSize());
            }
            if (getForm().getTipoStrutUnitaDocList().getTable() != null) {
                indMap.put("tipoStrutUnitaDoc",
                        getForm().getTipoStrutUnitaDocList().getTable().getCurrentRowIndex());
                indMap.put("tipoStrutUnitaDocPS",
                        getForm().getTipoStrutUnitaDocList().getTable().getPageSize());
            }
            if (getForm().getRegoleSubStrutList().getTable() != null) {
                indMap.put("regoleSubStrut",
                        getForm().getRegoleSubStrutList().getTable().getCurrentRowIndex());
                indMap.put("regoleSubStrutPS",
                        getForm().getRegoleSubStrutList().getTable().getPageSize());
            }
            if (getForm().getSistemiVersantiList().getTable() != null) {
                indMap.put("sisVers",
                        getForm().getSistemiVersantiList().getTable().getCurrentRowIndex());
                indMap.put("sisVersPS",
                        getForm().getSistemiVersantiList().getTable().getPageSize());
            }
        ...
        DecUsoModelloXsdUniDocTableBean modelloXsdUdTableBean = modelliXsdUdEjb
                .getDecModelliXsdUdInUsoOnUniDoc(idTipoUnitaDoc,
        ...
        // Lista regole
        OrgRegolaValSubStrutTableBean regoleTableBean = subStrutEjb
                .getOrgRegolaValSubStrutTableBean(idTipoUnitaDoc, Constants.TipoDato.TIPO_UNITA_DOC,
                        getForm().getRegoleSubStrutList().isFilterValidRecords());
        regoleTableBean.setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
        getForm().getRegoleSubStrutList().setTable(regoleTableBean);
        ...
        if (getForm().getSistemiVersantiList().getTable().getRow(0) != null && getForm()
                .getSistemiVersantiList().getTable().getRow(0).getObject("dt_first_vers") != null) {
            SimpleDateFormat format = new SimpleDateFormat(WebConstants.DATE_FORMAT_DATE_TYPE);
            Date d = (Date) getForm().getSistemiVersantiList().getTable().getRow(0)
                    .getObject("dt_first_vers");
            getForm().getTipoUnitaDoc().getDt_first_vers().setValue("" + format.format(d));
            Date dLast = (Date) getForm().getSistemiVersantiList().getTable().getRow(0)
                    .getObject("dt_last_vers");
            getForm().getTipoUnitaDoc().getDt_last_vers().setValue("" + format.format(dLast));
        }

        // Lista criteri di raggruppamento
        DecVRicCriterioRaggrTableBean criteri = critRaggrEjb.getCriteriRaggrDaTipoUnitaDoc(idStrut,
                idTipoUnitaDoc);
        criteri.addSortingRule("nm_criterio_raggr", SortingRule.ASC);
        criteri.sort();
        getForm().getCriteriRaggruppamentoList().setTable(criteri);
        ...
        if (!indMap.isEmpty()) {
            if (getForm().getTipoUnitaDocAmmessoList().getTable() != null
                ...
                getForm().getTipoUnitaDocAmmessoList().getTable()
                        .setCurrentRowIndex(indMap.get("tipoUnitaDocAmmesso"));
                getForm().getTipoUnitaDocAmmessoList().getTable()
                        .setPageSize(indMap.get("tipoUnitaDocAmmessoPS"));
            }
            if (getForm().getXsdDatiSpecList().getTable() != null
                    && indMap.containsKey("xsdDatiSpec")) {
                getForm().getXsdDatiSpecList().getTable()
                        .setCurrentRowIndex(indMap.get("xsdDatiSpec"));
                getForm().getXsdDatiSpecList().getTable().setPageSize(indMap.get("xsdDatiSpecPS"));
            }
            if (getForm().getXsdModelliUdList().getTable() != null
                    && indMap.containsKey("xsdModelli")) {
                getForm().getXsdModelliUdList().getTable()
                        .setCurrentRowIndex(indMap.get("xsdModelli"));
                getForm().getXsdModelliUdList().getTable()
                        .setCurrentRowIndex(indMap.get("xsdModelliPS"));
            }
            if (getForm().getTipoStrutUnitaDocList().getTable() != null
                    && indMap.containsKey("tipoStrutUnitaDoc")) {
                getForm().getTipoStrutUnitaDocList().getTable()
                        .setCurrentRowIndex(indMap.get("tipoStrutUnitaDoc"));
                getForm().getTipoStrutUnitaDocList().getTable()
                        .setPageSize(indMap.get("tipoStrutUnitaDocPS"));
            }
            if (getForm().getRegoleSubStrutList().getTable() != null
                    && indMap.containsKey("regoleSubStrut")) {
                getForm().getRegoleSubStrutList().getTable()
                        .setCurrentRowIndex(indMap.get("regoleSubStrut"));
                getForm().getRegoleSubStrutList().getTable()
                        .setPageSize(indMap.get("regoleSubStrutPS"));
            }
            if (getForm().getRegoleSubStrutList().getTable() != null
                    && indMap.containsKey("sisVers")) {
                getForm().getRegoleSubStrutList().getTable()
                        .setCurrentRowIndex(indMap.get("sisVers"));
            ...
            if (getForm().getCriteriRaggruppamentoList().getTable() != null
                ...
                getForm().getCriteriRaggruppamentoList().getTable()
                        .setPageSize(indMap.get("criteriRaggruppamentoPS"));
            }
        }
    ...
    private void loadListeParametriTipoUd(BigDecimal idStrut, BigDecimal idTipoUnitaDoc,
            List<String> funzione, boolean hideDeleteButtons, boolean editModeAmministrazione,
            boolean editModeConservazione, boolean editModeGestione) throws ParerUserError {
        BigDecimal idAmbiente = null;
        if (idStrut != null) {
        ...
        Object[] parametriObj = amministrazioneEjb.getAplParamApplicTipoUd(idAmbiente, idStrut,
                idTipoUnitaDoc, funzione);
        ...
        getForm().getParametriGestioneTipoUdList()
                .setTable((AplParamApplicTableBean) parametriGestione);
        getForm().getParametriGestioneTipoUdList().getTable().setPageSize(300);
        getForm().getParametriGestioneTipoUdList().getTable().first();
        getForm().getParametriConservazioneTipoUdList()
                .setTable((AplParamApplicTableBean) parametriConservazione);
        ...
        if (editModeAmministrazione) {
            getForm().getParametriAmministrazioneTipoUdList()
                    .getDs_valore_param_applic_tipo_ud_amm().setEditMode();
            getForm().getParametriAmministrazioneTipoUdList().setStatus(Status.update);
        } else {
            getForm().getParametriAmministrazioneTipoUdList()
                    .getDs_valore_param_applic_tipo_ud_amm().setViewMode();
            getForm().getParametriAmministrazioneTipoUdList().setStatus(Status.view);
        }

        if (editModeConservazione) {
            getForm().getParametriConservazioneTipoUdList().getDs_valore_param_applic_tipo_ud_cons()
                    .setEditMode();
        ...
        if (editModeGestione) {
            getForm().getParametriGestioneTipoUdList().getDs_valore_param_applic_tipo_ud_gest()
                    .setEditMode();
    ...
    public JSONObject triggerTipoUnitaDocTi_categ_strutOnTrigger() throws EMFError {
        ...
        if (getForm().getTipoUnitaDoc().getTi_categ_strut().parse() != null) {
            DecCategTipoUnitaDocTableBean table = tipoUnitaDocEjb
                    .getDecCategTipoUnitaDocChildTableBean(
                            getForm().getTipoUnitaDoc().getTi_categ_strut().parse());
            DecodeMap mappaCateg = new DecodeMap();
        ...
        if (getForm().getTipoUnitaDoc().getNm_categ_strut().parse() != null) {
            ...
            if (rb != null) {
                if (rb.getIdTipoServizioConserv() != null) {
                    getForm().getTipoUnitaDoc().getId_tipo_servizio()
                            .setValue("" + rb.getIdTipoServizioConserv());
                }
                if (rb.getIdTipoServizioAttiv() != null) {
                    getForm().getTipoUnitaDoc().getId_tipo_servizio_attiv()
                            .setValue("" + rb.getIdTipoServizioAttiv());
                }
            }
            if (rb2 != null) {
    ...
    public void updateTipoUnitaDoc() throws EMFError {
        if (getSession().getAttribute("provenienzaParametri") == null) {
            ...
            // sono in update e quindi non imposto i valori di default per il tipo
            // salvataggio. Questo andrebbe infatti a sovrascrivere il valore effettivo del record
            // in modifica.
            setTipoUnitaComboBox(true);
    ...
    private void setEditModeParametriAmministrazione() {
        ...
        getForm().getParametriConservazioneTipoUdList().setStatus(Status.update);
        getForm().getParametriGestioneTipoUdList().setStatus(Status.update);
        getForm().getParametriAmministrazioneTipoUdList().getDs_valore_param_applic_tipo_ud_amm()
                .setEditMode();
        getForm().getParametriConservazioneTipoUdList().getDs_valore_param_applic_tipo_ud_cons()
                .setEditMode();
        getForm().getParametriGestioneTipoUdList().getDs_valore_param_applic_tipo_ud_gest()
    ...
    public void deleteRegistroUnitaDoc() throws EMFError {
        ...
        try {
            ...
            registroEjb.deleteDecRegistroUnitaDoc(param,
                    registroUnitaDocRowBean.getIdRegistroUnitaDoc().longValue());
            getMessageBox().addMessage(new Message(MessageLevel.INF,
                    "Registro unit\u00E0 documentaria eliminato con successo"));
            // Reload list
            DecRegistroUnitaDocTableBean registroUnitaDocTableBean = registroEjb
                    .getDecRegistroUnitaDocTableBean(getForm().getIdList().getId_strut().parse(),
                            getForm().getRegistroUnitaDocList().isFilterValidRecords());
    ...
    private void reloadRegistroLists() throws EMFError {
        ...
        aaRegistroUnitaDocTableBean = registroEjb
                .getDecAARegistroUnitaDocTableBean(idRegistroUnitaDoc);
        if (aaRegistroUnitaDocTableBean != null) {
    ...
    private void salvaRegola() throws EMFError {
        ...
        if (getSession().getAttribute("provenienzaRegola")
            ...
            nmTipoUnitaDoc = ((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList().getTable()
                    .getCurrentRow()).getNmTipoUnitaDoc();
            ...
            // gi\u00E0 impostato
            idTipoDoc = ((DecTipoDocRowBean) getForm().getTipoDocList().getTable().getCurrentRow())
                    .getIdTipoDoc();
            idTipoUnitaDoc = getForm().getRegolaSubStrut().getId_tipo_unita_doc().parse();
            nmTipoDoc = ((DecTipoDocRowBean) getForm().getTipoDocList().getTable().getCurrentRow())
                    .getNmTipoDoc();
            BaseTable bt = new BaseTable();
            BaseRow br = new BaseRow();
            DecodeMap mappaTipoDoc = new DecodeMap();
        ...
        if (getForm().getRegolaSubStrut().validate(getMessageBox())) {
            ...
            if (getForm().getRegolaSubStrut().getDt_soppres().parse() != null) {
                dtSoppres = new Date(
                        getForm().getRegolaSubStrut().getDt_soppres().parse().getTime());
            } else {
                Calendar calendar = Calendar.getInstance();
                calendar.set(2444, 11, 31, 0, 0, 0);
                calendar.set(Calendar.MILLISECOND, 0);
            ...
            Date dtIstituz = new Date(
                    getForm().getRegolaSubStrut().getDt_istituz().parse().getTime());

            if (getForm().getRegoleSubStrutList().getStatus().equals(Status.insert)) {
                if (!subStrutEjb.existOrgRegolaSubStrut(null, idTipoUnitaDoc, idTipoDoc, dtIstituz,
                        dtSoppres)) {
                    ...
                    try {
                        ...
                        param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
                        idRegolaValSubStrut = subStrutEjb.saveRegolaSubStrut(param, idTipoUnitaDoc,
                                idTipoDoc, dtIstituz, dtSoppres);
                    } catch (ParerUserError ex) {
                    ...
                    if (!getMessageBox().hasError()) {
                        ...
                        getForm().getCampiSubStrutList()
                                .setTable(new OrgCampoValSubStrutTableBean());
                        getForm().getCampiSubStrutList().getTable()
                                .setPageSize(WebConstants.DEFAULT_PAGE_SIZE);
                        getForm().getCampiSubStrutList().getTable().first();
                    }
                ...
                if (idRegolaSubStrut == null) {
                    getMessageBox().addError(
                            "Errore inaspettato. Ritentare il caricamento e la modifica della regola");
                } else if (!subStrutEjb.existOrgRegolaSubStrut(idRegolaSubStrut, idTipoUnitaDoc,
                        idTipoDoc, dtIstituz, dtSoppres)) {
                    try {
                        LogParam param = SpagoliteLogUtil.getLogParam(
                                configurationHelper.getValoreParamApplicByApplic(
                        ...
                        if (getSession().getAttribute("provenienzaRegola")
                            ...
                            subStrutEjb.saveRegolaSubStrut(param, idRegolaSubStrut, dtIstituz,
                                    dtSoppres, idTipoDoc);
                        } else if (getSession().getAttribute("provenienzaRegola")
                                .equals(Application.Publisher.TIPO_DOC_DETAIL)) {
                            param.setIdOggetto(idTipoUnitaDoc);
                            subStrutEjb.saveRegolaSubStrutFromTipoDoc(param, idRegolaSubStrut,
                                    dtIstituz, dtSoppres, idTipoUnitaDoc);
                        }
                    } catch (ParerUserError ex) {
                        getMessageBox().addError(ex.getMessage());
                    }
    ...
    public void deleteRegoleSubStrutList() throws EMFError {
        ...
        OrgRegolaValSubStrutRowBean rowBean = (OrgRegolaValSubStrutRowBean) getForm()
                .getRegoleSubStrutList().getTable().getCurrentRow();
            ...
            try {
                ...
                if (param.getNomePagina().equalsIgnoreCase(Application.Publisher.REGOLA_DETAIL)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
                        ...
                        .equalsIgnoreCase(Application.Publisher.TIPO_DOC_DETAIL)) {
                    param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(getForm(),
                            getForm().getRegoleSubStrutList()));
                } else if (param.getNomePagina()
                        .equalsIgnoreCase(Application.Publisher.TIPO_UNITA_DOC_DETAIL)) {
                    param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(getForm(),
                            getForm().getRegoleSubStrutList()));
                }
                 ...
                 * getForm().getRegoleSubStrutList().getTable().getCurrentRow()).
                 * getIdTipoUnitaDoc()); param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete()); }
                 * else { param.setNomeAzione( SpagoliteLogUtil.getDetailActionNameDelete(getForm(),
                 * getForm().getRegoleSubStrutList()) ); }
                 * param.setIdOggetto(((OrgRegolaValSubStrutRowBean)
                 * getForm().getRegoleSubStrutList().getTable().getCurrentRow()).
                 * getIdTipoUnitaDoc());
    ...
    public void deleteCampiSubStrutList() throws EMFError {
        getMessageBox().clear();
        String lastPublisher = getLastPublisher();
        boolean isFromDetailOrIsEmpty = Application.Publisher.CAMPO_REGOLA_DETAIL
                .equals(lastPublisher) || "".equals(lastPublisher);
        int index = getForm().getCampiSubStrutList().getTable().getCurrentRowIndex();
        BigDecimal idCampoValSubStrut = ((OrgCampoValSubStrutRowBean) getForm()
                .getCampiSubStrutList().getTable().getCurrentRow()).getIdCampoValSubStrut();
        if (idCampoValSubStrut == null) {
            getMessageBox().addError(
                    "Errore inaspettato. Ritentare il caricamento e la modifica del campo");
        } else {
            try {
                /*
                 * Codice aggiuntivo per il logging...
                 */
                BigDecimal idTipoUnitaDoc = ((OrgRegolaValSubStrutRowBean) getForm()
                        .getRegoleSubStrutList().getTable().getCurrentRow()).getIdTipoUnitaDoc();
                LogParam param = SpagoliteLogUtil.getLogParam(
                        configurationHelper
                                .getValoreParamApplicByApplic(CostantiDB.ParametroAppl.NM_APPLIC),
                        getUser().getUsername(), SpagoliteLogUtil.getPageName(this));
                ...
                if (param.getNomePagina()
                        .equalsIgnoreCase(Application.Publisher.CAMPO_REGOLA_DETAIL)) {
                    param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
                } else {
                    param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(getForm(),
                            getForm().getCampiSubStrutList()));
    ...
    private void salvaCampoTipoUd() throws EMFError {
        if (getForm().getCampoSubStrut().postAndValidate(getRequest(), getMessageBox())) {
            BigDecimal idRegolaSubStrut = ((OrgRegolaValSubStrutRowBean) getForm()
                    .getRegoleSubStrutList().getTable().getCurrentRow()).getIdRegolaValSubStrut();
            ...
            case DATO_PROFILO:
                if (StringUtils.isBlank(nmCampo)) {
                    getMessageBox().addError(
                            "\u00C8 necessario indicare il dato di profilo di riferimento");
                }
                break;
            case DATO_SPEC_DOC_PRINC:
                ...
                if (idRecord == null) {
                    getMessageBox().addError(
                            "\u00C8 necessario indicare il dato specifico di riferimento");
                } else {
                    nmCampo = getForm().getCampoSubStrut().getId_attrib_dati_spec()
                            .getDecodedValue();
                }
                break;
            ...
            case SUB_STRUT:
                if (StringUtils.isBlank(nmCampo)) {
                    ...
                    getForm().getCampoSubStrut().getNm_campo()
                            .setValue(CostantiDB.NomeCampo.SUB_STRUTTURA.name());
                }
            ...
            if (!getMessageBox().hasError()) {
                ...
                param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
                if (getForm().getCampiSubStrutList().getStatus().equals(Status.insert)) {
                    if (!subStrutEjb.existOrgCampoSubStrut(null, idRegolaSubStrut, tiCampo, nmCampo,
                            idRecord)) {
                        Long idCampoValSubStrut = null;
                        try {
                            param.setIdOggetto(idTipoUnitaDoc);
                            idCampoValSubStrut = subStrutEjb.saveCampoSubStrut(param,
                                    idRegolaSubStrut, tiCampo, nmCampo, idRecord);
                        } catch (ParerUserError ex) {
                            getMessageBox().addError(ex.getMessage());
                        }
                        if (!getMessageBox().hasError()) {
                        ...
                        getMessageBox().addError(
                                "Per la regola esiste gi\u00E0 un campo contenente i dati inseriti");
                    }
                    ...
                    if (idCampoValSubStrut == null) {
                        getMessageBox().addError(
                                "Errore inaspettato. Ritentare il caricamento e la modifica del campo");
                    } else if (!subStrutEjb.existOrgCampoSubStrut(idCampoValSubStrut,
                            idRegolaSubStrut, tiCampo, nmCampo, idRecord)) {
                        try {
                            subStrutEjb.saveCampoSubStrut(param, tiCampo, nmCampo, idRecord,
                                    idCampoValSubStrut);
                        } catch (ParerUserError ex) {
                            getMessageBox().addError(ex.getMessage());
                        }
    ...
    public void populateNmCampo(String tiCampo) {
        if (StringUtils.isNotBlank(tiCampo)) {
            ...
            BigDecimal idTipoUnitaDoc = ((OrgRegolaValSubStrutRowBean) getForm()
                    .getRegoleSubStrutList().getTable().getCurrentRow()).getIdTipoUnitaDoc();
            BigDecimal idTipoDoc = ((OrgRegolaValSubStrutRowBean) getForm().getRegoleSubStrutList()
                    .getTable().getCurrentRow()).getIdTipoDoc();
            CostantiDB.TipoCampo campo = CostantiDB.TipoCampo.valueOf(tiCampo);
            switch (campo) {
            case DATO_PROFILO:
                getForm().getCampoSubStrut().getNm_campo()
                        .setDecodeMap(ComboGetter.getMappaNmCampoDatoProfilo());
                getForm().getCampoSubStrut().getId_sub_strut().setDecodeMap(new DecodeMap());
                getForm().getCampoSubStrut().getId_attrib_dati_spec().setDecodeMap(new DecodeMap());
                break;
            case DATO_SPEC_DOC_PRINC:
            ...
            case SUB_STRUT:
                getForm().getCampoSubStrut().getNm_campo()
                        .setDecodeMap(ComboGetter.getMappaNmCampoSubStruttura());
                getForm().getCampoSubStrut().getNm_campo()
                        .setValue(CostantiDB.NomeCampo.SUB_STRUTTURA.name());
                getForm().getCampoSubStrut().getId_sub_strut()
                        .setDecodeMap(DecodeMap.Factory.newInstance(
                                subStrutEjb.getOrgSubStrutTableBean(idStrut), "id_sub_strut",
                                "nm_sub_strut"));
                getForm().getCampoSubStrut().getId_attrib_dati_spec().setDecodeMap(new DecodeMap());
                break;
            }
    ...
    private void redirectToCreaCriterioRaggrPage() throws EMFError {
        ...
        if (getLastPublisher().equals(Application.Publisher.REGISTRO_UNITA_DOC_DETAIL)) {
            form.getIdFields().getId_registro_unita_doc()
                    .setValue("" + ((DecRegistroUnitaDocRowBean) getForm().getRegistroUnitaDocList()
        ...
        redirectToAction(Application.Actions.CRITERI_RAGGRUPPAMENTO,
                "?operation=listNavigationOnClick&navigationEvent=" + getNavigationEvent()
                        ...
                        + getForm().getCriteriRaggruppamentoList().getTable().getCurrentRowIndex()
                        + "&cessato=" + struttura.getFlCessato(),
                form);
    }
     ...
     *
     * @param criteriForm criteri
     * @param idStrut     id struttura
     */
    public void initComboAmbienteEnteStrutCreaCriteriRaggr(CriteriRaggruppamentoForm criteriForm,
            BigDecimal idStrut) {
    ...
    public void deleteCriteriRaggruppamentoList() throws EMFError {
        try {
            ...
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            if (param.getNomePagina()
                    .equalsIgnoreCase(Application.Publisher.REGISTRO_UNITA_DOC_DETAIL)) {
                StrutTipiForm form = (StrutTipiForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getCriteriRaggruppamentoList()));
            } else if (param.getNomePagina()
                    .equalsIgnoreCase(Application.Publisher.TIPO_DOC_DETAIL)) {
                StrutTipiForm form = (StrutTipiForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                ...
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                    ...
                    .equalsIgnoreCase(Application.Publisher.CREA_STRUTTURA)) {
                StruttureForm form = (StruttureForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getCriteriRaggruppamentoList()));
            } else if (param.getNomePagina()
                    .equalsIgnoreCase(Application.Publisher.LISTA_CRITERI_RAGGR)) {
                // Correzione bug in cui mancava la gestione della cancellazione da lista criteri
                // reggr
                CriteriRaggruppamentoForm form = (CriteriRaggruppamentoForm) SpagoliteLogUtil
                        .getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getCriterioRaggrList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
    ...
    public void loadDettaglioRegistro() throws EMFError {
        ...
        String registroAmmesso = ((DecVLisTiUniDocAmsTableBean) getForm()
                .getTipoUnitaDocAmmessoList().getTable()).getRow(numberRiga.intValue())
                .getCdRegistroUnitaDoc();
        DecRegistroUnitaDocRowBean registroRow = registroEjb
                .getDecRegistroUnitaDocRowBean(registroAmmesso, idStrut);
    ...
    public void loadDettaglioTipoUd() throws EMFError {
        ...
        // Recupero il tipo ud
        String tipoUd = ((DecVLisTiUniDocAmsTableBean) getForm()
                .getRegistroTipoUnitaDocAmmessoList().getTable()).getRow(numberRiga.intValue())
                .getNmTipoUnitaDoc();
        DecTipoUnitaDocRowBean tipoUdRow = tipoUnitaDocEjb.getDecTipoUnitaDocRowBean(tipoUd,
                idStrut);
        // Setto la tabella dei registri aggiungendo solo quello recuperato
    ...
    public void loadDettaglioTipoStrutDoc() throws EMFError {
        ...
        BigDecimal idTipoStrutDoc = ((DecTipoStrutDocAmmessoTableBean) getForm()
                .getTipoStrutDocAmmessoDaTipoDocList().getTable()).getRow(numberRiga.intValue())
                .getIdTipoStrutDoc();
        DecTipoStrutDocRowBean tipoStrutDocRow = tipoStrutDocEjb
                .getDecTipoStrutDocRowBean(idTipoStrutDoc, idStrut);
    ...
    public boolean inserimentoWizardOnSave() throws EMFError {
        DecParteNumeroRegistroTableBean tb = (DecParteNumeroRegistroTableBean) getForm()
                .getPartiList().getTable();
        tb.clearSortingRule();
        ...
        String cdFormatoNumero = getForm().getDatiDescFormatoNumero().getCd_formato_numero()
                .parse();
        String dsFormatoNumero = getForm().getDatiDescFormatoNumero().getDs_formato_numero()
                .parse();
        try {
            /*
             * Codice aggiuntivo per il logging...
            ...
            LogParam param = SpagoliteLogUtil.getLogParam(
                    configurationHelper.getValoreParamApplicByApplic(
                            CostantiDB.ParametroAppl.NM_APPLIC),
                    getUser().getUsername(), SpagoliteLogUtil.getPageName(this),
                    SpagoliteLogUtil.getToolbarSave(getForm().getAaRegistroUnitaDocList()
                            .getStatus().equals(Status.update)));
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            if (getForm().getAaRegistroUnitaDocList().getStatus().equals(Status.update)) {
                ...
                registroEjb.saveDecAaRegistroUnitaDoc(param, row.getIdAaRegistroUnitaDoc(), min,
                        max, tb, idPartiEliminate, cdFormatoNumero, dsFormatoNumero);
                registroEjb.checkUdNelPeriodoValidita(row.getIdAaRegistroUnitaDoc());
            } else {
                BigDecimal idRegistroUnitaDoc = getForm().getRegistroUnitaDoc()
                        .getId_registro_unita_doc().parse();
                BigDecimal idAaRegistroUnitaDoc = registroEjb.saveDecAaRegistroUnitaDoc(param,
                        idRegistroUnitaDoc, min, max, tb, cdFormatoNumero, dsFormatoNumero);
            ...
            long maxSizeNum = 0;
            List<Object> maxSizes = tb
                    .toList(DecParteNumeroRegistroTableDescriptor.COL_NI_MAX_CHAR_PARTE);
            for (int i = 0; i < maxSizes.size(); i++) {
                Object tmpobj = maxSizes.get(i);
                if (tmpobj != null) {
                    maxSizeNum += ((BigDecimal) tmpobj).longValue();
                } else {
                    BigDecimal niMinCharParte = ((DecParteNumeroRegistroRowBean) tb.getRow(i))
                            .getNiMinCharParte();
                    String tipoPadding = ((DecParteNumeroRegistroRowBean) tb.getRow(i))
                            .getTiPadSxParte();
                    String tipoDato = ((DecParteNumeroRegistroRowBean) tb.getRow(i))
                            .getTiCharParte();
                    if ((StringUtils.isNotEmpty(tipoPadding) && tipoPadding
                            .equals(ConfigRegAnno.TipiPadding.RIEMPI_0_A_SX_LESS12.name()))
                            || tipoDato.equals(KeyOrdUtility.TipiCalcolo.NUMERICO.name())
                            || tipoDato
                                    .equals(KeyOrdUtility.TipiCalcolo.NUMERICO_GENERICO.name())) {
                        maxSizeNum += 12L;
                    } else {
            ...
            if (maxSizeNum > maxLenPossibile) {
                getMessageBox().addWarning(
                        "Periodo di validit\u00E0 salvato con successo, ma la dimensione "
                                + "minima normalizzata del numero (" + maxSizeNum + ") supera "
                                + maxLenPossibile + " caratteri. "
            ...
            getMessageBox()
                    .addError("Il periodo non pu\u00F2 essere salvato: " + ex.getDescription());
        } catch (Exception ex) {
            log.error("Eccezione generica nel salvataggio del periodo di validit\u00E0", ex);
            getMessageBox().addError(
                    "Si \u00E8 verificata un'eccezione nel salvataggio del periodo di validit\u00E0");
        }
        ...
        if (getForm().getDatiAnniParte().postAndValidate(getRequest(), getMessageBox())) {
            ...
            if (StringUtils.isBlank(annoValidoMinimo) || !StringUtils.isNumeric(annoValidoMinimo)) {
                ...
                if (StringUtils.isBlank(
                        ...
                        || Integer.parseInt(getForm().getDatiAnniParte()
                                .getAa_min_registro_unita_doc().getValue()) < dbAnnoMinimo) {
                    getMessageBox().addError(
                            "Errore di compilazione: anno di inizio validit\u00E0 inferiore a "
                                    + annoValidoMinimo);
                } else if (StringUtils.isNotBlank(
                        getForm().getDatiAnniParte().getAa_max_registro_unita_doc().getValue())
                        && Integer.parseInt(getForm().getDatiAnniParte()
                                .getAa_max_registro_unita_doc().getValue()) < Integer
                                        .parseInt(getForm().getDatiAnniParte()
                                                .getAa_min_registro_unita_doc().getValue())) {
                    getMessageBox().addError("Attenzione intervallo non valido");
                }

                if (!getMessageBox().hasError()) {
                    BigDecimal max = getForm().getDatiAnniParte().getAa_max_registro_unita_doc()
                            .parse();
                    BigDecimal min = getForm().getDatiAnniParte().getAa_min_registro_unita_doc()
                            .parse();
                    if (max == null) {
                    ...
                    try {
                        ...
                        if (getForm().getAaRegistroUnitaDocList().getStatus()
                                .equals(Status.update)) {
                            DecAaRegistroUnitaDocRowBean row = (DecAaRegistroUnitaDocRowBean) getForm()
                                    .getAaRegistroUnitaDocList().getTable().getCurrentRow();
                            ...
                            idRegistroUnitaDoc = getForm().getRegistroUnitaDoc()
                                    .getId_registro_unita_doc().parse();
                        }
                        registroEjb.checkDecAaRegistroUnitaDoc(idAaRegistroUnitaDoc,
                                idRegistroUnitaDoc, min, max);
                    } catch (ParerUserError e) {
                        getMessageBox().addError(e.getDescription());
                    }
                }
    ...
    public boolean inserimentoWizardPartiOnExit() throws EMFError {
        ...
        if (!getMessageBox().hasError()) {
            List<Object> tipiCarattere = tb
                    .toList(DecParteNumeroRegistroTableDescriptor.COL_TI_CHAR_PARTE);
            if (tipiCarattere.size() > 1
                    && tipiCarattere.contains(KeyOrdUtility.TipiCalcolo.GENERICO.name())) {
                getMessageBox().addError(
        ...
        if (!getMessageBox().hasError()) {
            BigDecimal tmpMinCharParte = tb
                    .sum(DecParteNumeroRegistroTableDescriptor.COL_NI_MIN_CHAR_PARTE);
            if (tmpMinCharParte != null) {
                ...
                List<Object> tiCharSeps = tb
                        .toList(DecParteNumeroRegistroTableDescriptor.COL_TI_CHAR_SEP);
                ...
                if (sumNiMinCharParte > maxLenPossibile) {
                    getMessageBox().addError(
                            "La somma delle dimensioni minime delle parti deve essere minore o uguale a "
                                    + maxLenPossibile
                                    + " caratteri (la somma calcolata risulta essere "
                                    + sumNiMinCharParte + " caratteri).");
                }
            }
        }
        if (!getMessageBox().hasError()) {
            List<Object> progressivi = tb
                    .toList(DecParteNumeroRegistroTableDescriptor.COL_NI_PARTE_NUMERO_REGISTRO);
            Set<Object> set = new HashSet<>(progressivi);
            if (set.size() < progressivi.size()) {
                getMessageBox().addError(
                        "Almeno un numero d'ordine \u00E8 definito su pi\u00F9 di una parte");
            }
        }
        if (!getMessageBox().hasError()) {
            List<Object> niMaxCharParti = tb.toList(
                    DecParteNumeroRegistroTableDescriptor.COL_NI_MAX_CHAR_PARTE, new SortingRule[] {
        ...
        if (!getMessageBox().hasError()) {
            List<Object> tiParteList = tb
                    .toList(DecParteNumeroRegistroTableDescriptor.COL_TI_PARTE);
            int contaTiParte = 0;
        ...
        if (!getMessageBox().hasError()) {
            ...
            for (int i = 0; i < tiCharSeps.size(); i++) {
                ...
                if (i != (tiCharSeps.size() - 1)) {
                    BigDecimal niMinCharParte = ((DecParteNumeroRegistroRowBean) tb.getRow(i))
                            .getNiMinCharParte();
                    BigDecimal niMaxCharParte = ((DecParteNumeroRegistroRowBean) tb.getRow(i))
                            .getNiMaxCharParte();
                    if (StringUtils.isEmpty(tiCharSep)
                            && niMinCharParte.compareTo(niMaxCharParte) != 0) {
    ...
    public void inserimentoWizardDescFormatoNumeroOnEnter() throws EMFError {
        ...
        if (getForm().getAaRegistroUnitaDocList().getStatus().equals(Status.insert)) {
            if (getForm().getPartiList().getTable().size() == 1
                ...
                getForm().getDatiDescFormatoNumero().getCd_formato_numero().setValue(getForm()
                        .getPartiList().getTable().getRow(0).getString("nm_parte_numero_registro"));
                getForm().getDatiDescFormatoNumero().getDs_formato_numero().setValue(getForm()
                        .getPartiList().getTable().getRow(0).getString("ds_parte_numero_registro"));
            } else {
    ...
    public void addParte() throws EMFError {
        if (getForm().getPartiInserimento().postAndValidate(getRequest(), getMessageBox())) {
            ...
            if (getForm().getPartiList().getStatus().equals(Status.update)) {
                row = (DecParteNumeroRegistroRowBean) getForm().getPartiList().getTable()
                        .getCurrentRow();
            ...
            if (!getMessageBox().hasError()) {
                String nomeParte = getForm().getPartiInserimento().getNm_parte_numero_registro()
                        .parse();
                List<Object> nomi = ((DecParteNumeroRegistroTableBean) getForm().getPartiList()
                        .getTable())
                ...
                if (getForm().getPartiList().getStatus().equals(Status.insert)) {
                    if (nomi.contains(nomeParte)) {
                        getMessageBox().addError(
                                "Esiste gi\u00E0 nella lista una parte con nome " + nomeParte);
                    }
                } else {
                    ...
                    if (max != null) {
                        getMessageBox().addError(
                            ...
                            || (!tiCharParte.equals(KeyOrdUtility.TipiCalcolo.ALFABETICO.name())
                                    && !tiCharParte.equals(
                                            KeyOrdUtility.TipiCalcolo.ALFANUMERICO.name()))) {
                        getMessageBox().addError(
                                "Tipo di riempimento non pu\u00F2 essere valorizzato nel caso in cui 'Numero massimo di caratteri' sia valorizzato o 'Caratteri ammessi' sia diverso da ALFANUMERICO o ALFABETICO");
                    }
                }
            ...
            if (!getMessageBox().hasError()) {
                ...
                tb.clearSortingRule();
                tb.addSortingRule(
                        DecParteNumeroRegistroTableDescriptor.COL_NI_PARTE_NUMERO_REGISTRO);
    ...
    public void deletePartiList() throws EMFError {
        DecParteNumeroRegistroTableBean partiTableBean = (DecParteNumeroRegistroTableBean) getForm()
                .getPartiList().getTable();
        int index = partiTableBean.getCurrentRowIndex();
        DecParteNumeroRegistroRowBean currentRow = (DecParteNumeroRegistroRowBean) partiTableBean
                .getCurrentRow();
        if (currentRow.getIdParteNumeroRegistro() != null) {
            Set<BigDecimal> idParti = (Set<BigDecimal>) getSession()
                    .getAttribute(PARAMETER_ID_PARTI_ELIMINATE);
            if (idParti == null) {
                idParti = new HashSet<>();
            }
        ...
        partiTableBean
                .addSortingRule(DecParteNumeroRegistroTableDescriptor.COL_NI_PARTE_NUMERO_REGISTRO);
        partiTableBean.sort();
        for (DecParteNumeroRegistroRowBean row : partiTableBean) {
            row.setNiParteNumeroRegistro(new BigDecimal(index++));
        }
        getForm().getPartiInserimento().getNi_parte_numero_registro()
    ...
    public void updatePartiList() throws EMFError {
        ...
        DecParteNumeroRegistroRowBean row = (DecParteNumeroRegistroRowBean) getForm().getPartiList()
                .getTable().getCurrentRow();
        ...
        if (StringUtils.isNotBlank(tiCharParte)) {
            getForm().getPartiInserimento().getTi_parte()
                    .setDecodeMap(ComboGetter.getCustomMappaTiParte(tiCharParte));
        }
    ...
    private void setDecodeMaps() {
        getForm().getPartiInserimento().getTi_char_parte().setDecodeMap(ComboGetter
                .getMappaSortedGenericEnum("ti_char_parte", KeyOrdUtility.TipiCalcolo.values()));
        getForm().getPartiInserimento().getTi_char_sep()
                .setDecodeMap(ComboGetter.getMappaSeparatori("ti_char_sep"));
        getForm().getPartiInserimento().getTi_pad_sx_parte()
                .setDecodeMap(ComboGetter.getMappaSortedGenericEnum("ti_pad_sx_parte",
                        ConfigRegAnno.TipiPadding.RIEMPI_0_A_SX_LESS12,
                        ConfigRegAnno.TipiPadding.STANDARD));
        getForm().getPartiInserimento().getTi_parte().setDecodeMap(new DecodeMap());
    }
    ...
    private void increaseNiNumeroRegistro() {
        ...
        if (sizeParti > 0) {
            lastPgParte = getForm().getPartiList().getTable().getRow(sizeParti - 1).getBigDecimal(
                    DecParteNumeroRegistroRowBean.TABLE_DESCRIPTOR.COL_NI_PARTE_NUMERO_REGISTRO);
        }
    ...
    public void deleteTipoStrutDocAmmessoDaTipoDocList() {
        ...
        try {
            ...
            if (Application.Publisher.TIPO_DOC_DETAIL.equalsIgnoreCase(param.getNomePagina())) {
                StrutTipiForm form = (StrutTipiForm) SpagoliteLogUtil.getForm(this);
                param.setNomeAzione(SpagoliteLogUtil.getDetailActionNameDelete(form,
                        form.getTipoStrutDocAmmessoDaTipoDocList()));
            } else {
                param.setNomeAzione(SpagoliteLogUtil.getToolbarDelete());
            }
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            ...
            getMessageBox().addMessage(new Message(MessageLevel.INF,
                    "Tipo struttura documento ammesso eliminata con successo"));
            ...
            if (Application.Publisher.ASSOCIAZIONE_TIPO_DOC_TIPO_STRUT_DOC
                    .equals(getLastPublisher())) {
                goBack();
            } else {
                forwardToPublisher(Application.Publisher.TIPO_DOC_DETAIL);
    ...
    private void redirectToTipoStrutDocPage() throws EMFError {
        ...
        redirectToPage(Application.Actions.STRUT_TIPO_STRUT, form,
                form.getTipoStrutDocList().getName(),
    ...
    public JSONObject triggerPartiInserimentoTi_pad_sx_parteOnTrigger() throws EMFError {
        ...
        if (StringUtils.isNotBlank(tipo)) {
            if (tipo.equals(ConfigRegAnno.TipiPadding.STANDARD.name())) {
                getForm().getPartiInserimento().getDesc_pad_sx_parte()
                        .setValue("Non viene eseguito il riempimento");
    ...
    public void filterInactiveRecordsRegoleSubStrutList() throws EMFError {
        ...
        if (getSession().getAttribute("provenienzaRegola")
                .equals(Application.Publisher.TIPO_UNITA_DOC_DETAIL)) {
            DecTipoUnitaDocRowBean row = (DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                    .getTable().getCurrentRow();
            getForm().getRegoleSubStrutList()
    ...
    public void duplicaRegistroOperation() throws EMFError {
        ...
        getForm().getRegistroUnitaDoc().getDt_istituz()
                .setValue(formattatore.format(oggi.getTime()));
        ...
        getForm().getRegistroCreazioneCriterio().getCriterio_autom_registro().setChecked(
                critRaggrEjb.existsCriterioStandardPerTipoDato(idRegistroUnitaDoc.longValue(),
                        TipoDato.REGISTRO));
    ...
    private void salvaDuplicaRegistroUnitaDoc() throws EMFError {
        ...
        String criterioAutomRegistro = getForm().getRegistroCreazioneCriterio()
                .getCriterio_autom_registro().parse();
        ...
        if (getForm().getRegistroUnitaDoc().getCd_registro_unita_doc().parse() == null) {
            ...
            // Controllo che il nome struttura rispetti
            FileServUtils fsu = new FileServUtils();
            if (!fsu.controllaSubPath(
                    getForm().getRegistroUnitaDoc().getCd_registro_normaliz().parse())) {
                getMessageBox().addError(
                        "Errore di compilazione form: Tipo registro contenente caratteri non permessi <br/>");
            } else {
                /*
                ...
                int lunghezzaAmbEnteStrutReg = getForm().getStrutRif().getNm_ambiente().parse()
                        ...
                        + getForm().getStrutRif().getNm_strut().parse().length() + getForm()
                                .getRegistroUnitaDoc().getCd_registro_unita_doc().parse().length()
                        + 3;
        ...
        if (!getMessageBox().hasError()) {
            if (getForm().getRegistroUnitaDoc().validate(getMessageBox())) {
                try {
                    /*
                     * Codice aggiuntivo per il logging... Stessa operazione dell'Inserimento di un
                     * registro anche se si tratta di una duplicazione
                     */
                    LogParam param = SpagoliteLogUtil.getLogParam(
                            configurationHelper.getValoreParamApplicByApplic(
                                    CostantiDB.ParametroAppl.NM_APPLIC),
                    ...
                    param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
                    registroEjb.duplicaRegistroUnitaDoc(param, registroRowBean,
                            criterioAutomRegistro);
                    ...
                    getForm().getRegistroUnitaDocList().setStatus(Status.view);
                    getMessageBox().addMessage(new Message(MessageLevel.INF,
                            "Nuovo registro duplicato con successo!"));
                    getMessageBox().setViewMode(ViewMode.plain);
                    getSession().removeAttribute("fromDuplicaRegistro");
                    getForm().getTipoUnitaDoc().getLogEventiTipoUD().setEditMode();
                    getForm().getRegistroUnitaDoc().getLogEventi().setEditMode();
    ...
    public void creaTipoSerieStandard() throws EMFError {
        BigDecimal idRegistro = getForm().getTipoUnitaDocAmmesso().getId_registro_unita_doc()
                .parse();
        ...
        try {
            ...
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            int tipiSerieCreati = tipoSerieEjb.createTipoSerieStandardDaRegistroOTipoUd(param,
                    idRegistro, idTipoUd);
            if (tipiSerieCreati > 0) {
                ...
                if (tipiSerieCreati == 1) {
                    ...
                    messaggio.append("creati ").append(tipiSerieCreati)
                            .append(" tipi di serie standard");
                }
                getMessageBox().addInfo(messaggio.toString());

            } else {
                getMessageBox().addWarning(
                        "Il tipo di serie non può essere creato perchè già presente nel sistema");
            }
            getMessageBox().setViewMode(ViewMode.plain);
        } catch (ParerUserError ex) {
            getMessageBox().addError(ex.getDescription());
    ...
    public void logEventiTipoUD() throws EMFError {
        DecTipoUnitaDocRowBean riga = (DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                .getTable().getCurrentRow();
        logEventiCommon(SacerLogConstants.TIPO_OGGETTO_TIPO_UNITA_DOCUMENTARIA,
                riga.getIdTipoUnitaDoc().toString());
    }

    @Override
    public void logEventiTipoDoc() throws EMFError {
        DecTipoDocRowBean riga = (DecTipoDocRowBean) getForm().getTipoDocList().getTable()
                .getCurrentRow();
        logEventiCommon(SacerLogConstants.TIPO_OGGETTO_TIPO_DOCUMENTO,
                riga.getIdTipoDoc().toString());
    }
    ...
    public void confermaSalvataggioRegistroUnitaDoc() throws EMFError {
        BigDecimal idRegistroUnitaDoc = getForm().getRegistroUnitaDoc().getId_registro_unita_doc()
                .parse();
        String criterioAutomRegistro = getForm().getRegistroCreazioneCriterio()
                .getCriterio_autom_registro().parse();
        BigDecimal idStrut = (BigDecimal) getSession().getAttribute("id_struttura_lavorato");
        ...
        try {
            ...
            String azioneModCriterio = SpagoliteLogUtil.getButtonActionName(getForm(),
                    getForm().getRegistroUnitaDoc(), getForm().getRegistroUnitaDoc()
                            .getUpdCriterioRaggrByTipoUnitaDocFromReg().getName());
            registroEjb.updateDecRegistroUnitaDoc(param, azioneInsCriterio, azioneModCriterio,
                    idRegistroUnitaDoc, registroUnitaDocRowBean, criterioAutomRegistro);
            getMessageBox()
                    .addMessage(new Message(MessageLevel.INF, "Registro modificato con successo"));
            getMessageBox().setViewMode(ViewMode.plain);
            // Ricarico tutto il registro e i suoi figli
    ...
    public void creaCriterioRaggrStandardRegistroButton() throws EMFError {
        ...
        LogParam param = SpagoliteLogUtil.getLogParam(
                configurationHelper
                        .getValoreParamApplicByApplic(CostantiDB.ParametroAppl.NM_APPLIC),
                getUser().getUsername(), SpagoliteLogUtil.getPageName(this),
                SpagoliteLogUtil.getButtonActionName(getForm(),
                        getForm().getRegistroCreazioneCriterio(),
                        getForm().getRegistroCreazioneCriterio()
                                .getCreaCriterioRaggrStandardRegistroButton().getName()));
        param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
        try {
    ...
    public void creaCriterioRaggrStandardTipoUdButton() throws EMFError {
        ...
        LogParam param = SpagoliteLogUtil.getLogParam(
                ...
                getUser().getUsername(), SpagoliteLogUtil.getPageName(this),
                SpagoliteLogUtil.getButtonActionName(getForm(),
                        getForm().getTipoUnitaDocCreazioneCriterio(),
                        getForm().getTipoUnitaDocCreazioneCriterio()
                                .getCreaCriterioRaggrStandardTipoUdButton().getName()));
        param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
        try {
    ...
    public void creaCriterioRaggrStandardTipoDocButton() throws EMFError {
        ...
        LogParam param = SpagoliteLogUtil.getLogParam(
                ...
                getUser().getUsername(), SpagoliteLogUtil.getPageName(this),
                SpagoliteLogUtil.getButtonActionName(getForm(),
                        getForm().getTipoDocCreazioneCriterio(),
                        getForm().getTipoDocCreazioneCriterio()
                                .getCreaCriterioRaggrStandardTipoDocButton().getName()));
        param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
        try {
    ...
    public JSONObject triggerTipoDocFl_tipo_doc_principaleOnTrigger() throws EMFError {
        ...
        try {
            ...
            String flTipoDocPrincipale = getForm().getTipoDoc().getFl_tipo_doc_principale().parse();
            DecTipoDocRowBean tipoDocCurrent = (DecTipoDocRowBean) getForm().getTipoDocList()
                    .getTable().getCurrentRow();
    ...
    public JSONObject triggerRegistroUnitaDocCd_registro_unita_docOnTrigger() throws EMFError {
        getForm().getRegistroUnitaDoc().post(getRequest());
        String cdRegistroUnitaDoc = getForm().getRegistroUnitaDoc().getCd_registro_unita_doc()
                .parse();
    ...
    public void deleteParametriAmministrazioneTipoUdList() throws EMFError {
        AplParamApplicRowBean row = (AplParamApplicRowBean) getForm()
                .getParametriAmministrazioneTipoUdList().getTable().getCurrentRow();
        // int deletedRowIndex =
        ...
        if (idValoreParamApplic != null) {
            ...
            getMessageBox().addWarning(
                    "Valore sul tipo unità documentaria non presente: nessuna cancellazione effettuata");
        }
        try {
            loadTipoUnitaDoc(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList().getTable()
                    .getCurrentRow()).getIdTipoUnitaDoc());
        } catch (ParerUserError ex) {
            getMessageBox().addError(ex.getDescription());
        }
    ...
    public void deleteParametriConservazioneTipoUdList() throws EMFError {
        AplParamApplicRowBean row = (AplParamApplicRowBean) getForm()
                .getParametriConservazioneTipoUdList().getTable().getCurrentRow();
        // int deletedRowIndex =
        ...
        if (idValoreParamApplic != null) {
            ...
            getMessageBox().addWarning(
                    "Valore sul tipo unità docuementaria non presente: nessuna cancellazione effettuata");
        }
        try {
            loadTipoUnitaDoc(((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList().getTable()
                    .getCurrentRow()).getIdTipoUnitaDoc());
    ...
    public void deleteParametriGestioneTipoUdList() throws EMFError {
        AplParamApplicRowBean row = (AplParamApplicRowBean) getForm()
                .getParametriGestioneTipoUdList().getTable().getCurrentRow();
        // int deletedRowIndex =
    ...
    public void parametriAmministrazioneTipoUdButton() throws Throwable {
        BigDecimal idStrut = getForm().getIdList().getId_strut().parse();
        BigDecimal idTipoUnitaDoc = ((BaseRowInterface) getForm().getTipoUnitaDocList().getTable()
                .getCurrentRow()).getBigDecimal("id_tipo_unita_doc");
    ...
    private void salvaParametriTipoUd() throws EMFError {
        ...
        AplParamApplicTableBean parametriGestione = (AplParamApplicTableBean) getForm()
                .getParametriGestioneTipoUdList().getTable();
        ...
        if (!getMessageBox().hasError()) {
            ...
            LogParam param = SpagoliteLogUtil.getLogParam(
                    ...
                    SpagoliteLogUtil.getToolbarSave(
                            getForm().getTipoUnitaDoc().getStatus().equals(Status.update)));
            param.setTransactionLogContext(sacerLogEjb.getNewTransactionLogContext());
            tipoUnitaDocEjb.saveParametriTipoUd(param, parametriAmministrazione,
                    parametriConservazione, parametriGestione, idTipoUnitaDoc);
            ...
            setViewModeListeParametri();
            try {
                // loadListeParametriTipoUd(idStrut, idTipoUnitaDoc, null, false, false, false,
                // false);
                loadListaParametriAmministrazioneTipoUd(idStrut, idTipoUnitaDoc, funzione, false,
                        false,
                        getForm().getParametriAmministrazioneTipoUdList().isFilterValidRecords());
                loadListaParametriConservazioneTipoUd(idStrut, idTipoUnitaDoc, funzione, false,
                        false,
                        getForm().getParametriConservazioneTipoUdList().isFilterValidRecords());
        ...
        try {
            if (getSession().getAttribute("provenienzaParametri") != null) {
                ...
                if (provenzienzaParametri.equals("amministrazione")) {
                    // loadListeParametriTipoUd(idStrut, idTipoUnitaDoc, funzione, false, true,
                    // true, true);
                    loadListaParametriAmministrazioneTipoUd(idStrut, idTipoUnitaDoc, funzione,
                            false, true, getForm().getParametriAmministrazioneTipoUdList()
                                    .isFilterValidRecords());
                    loadListaParametriConservazioneTipoUd(idStrut, idTipoUnitaDoc, funzione, false,
                            true,
                            getForm().getParametriConservazioneTipoUdList().isFilterValidRecords());
                    ...
                    // loadListeParametriTipoUd(idStrut, idTipoUnitaDoc, funzione, false, false,
                    // true, true);
                    loadListaParametriAmministrazioneTipoUd(idStrut, idTipoUnitaDoc, funzione,
                            false, false, getForm().getParametriAmministrazioneTipoUdList()
                                    .isFilterValidRecords());
                    loadListaParametriConservazioneTipoUd(idStrut, idTipoUnitaDoc, funzione, false,
                            true,
                            getForm().getParametriConservazioneTipoUdList().isFilterValidRecords());
            ...
            getMessageBox().addError(
                    "Errore durante il caricamento dei parametri tipo unità documentaria");
        }
        forwardToPublisher(Application.Publisher.PARAMETRI_TIPO_UD);
    }
    ...
    public void scaricaXsdModelliUdButton() throws EMFError {
        ...
        if (getForm().getIdList().getId_tipo_doc().parse() != null) {
            nomeTipo = tipoDocEjb
                    .getDecTipoDocRowBean(getForm().getIdList().getId_tipo_doc().parse(), null)
                    .getNmTipoDoc();
        } else if (getForm().getIdList().getId_tipo_unita_doc().parse() != null) {
            nomeTipo = tipoUnitaDocEjb.getDecTipoUnitaDocRowBean(
                    getForm().getIdList().getId_tipo_unita_doc().parse(), null).getNmTipoUnitaDoc();
        }
    ...
    private void zipXsdTipoDoc(ZipOutputStream out, String blXsd, String filename)
            throws IOException {
    ...
    public JSONObject triggerXsdModelliUdDetailTi_modello_xsdOnTrigger() throws EMFError {
        ...
        if (StringUtils.isNotBlank(tiModelloXsd)) {
            String tiUsoModello = getForm().getIdList().getNm_sys_migraz().parse() != null
                    ? TiUsoModelloXsd.MIGRAZ.name()
                    : TiUsoModelloXsd.VERS.name();
            DecodeMap mpCdXsd = modelliXsdUdEjb.getCdXsdInUsoByIdAmbTiModUso(
                    getForm().getXsdModelliUdDetail().getId_ambiente().parse(), tiModelloXsd,
                    tiUsoModello, "cd_xsd");
            getForm().getXsdModelliUdDetail().getCd_xsd().setDecodeMap(mpCdXsd);
            // pre-select element (default)
            Optional<DecModelloXsdUdRowBean> modelloXsdStandard = modelliXsdUdEjb
                    .getDefaultDecModelloXsdUd(
                            getForm().getXsdModelliUdDetail().getId_ambiente().parse(),
                            tiModelloXsd, tiUsoModello);
            if (modelloXsdStandard.isPresent()) {
                // set values
                getForm().getXsdModelliUdDetail().getCd_xsd()
                        .setValue(modelloXsdStandard.get().getCdXsd());
                getForm().getXsdModelliUdDetail().getDs_xsd()
                        .setValue(modelloXsdStandard.get().getDsXsd());
                ...
                getForm().getXsdModelliUdDetail().getBl_xsd()
                        .setValue(modelloXsdStandard.get().getBlXsd());
    ...
    public JSONObject triggerXsdModelliUdDetailCd_xsdOnTrigger() throws EMFError {
        ...
        if (StringUtils.isNotBlank(cdXsd)) {
            ...
            modelloXsdUd = modelliXsdUdEjb.getDecModelloXsdUd(modelloXsdUd.getIdAmbiente(),
                    modelloXsdUd.getTiModelloXsd(), modelloXsdUd.getTiUsoModelloXsd(),
                    modelloXsdUd.getCdXsd(), false);
            // set values
            ...
            try {
                ...
                if (getForm().getXsdModelliUdDetail().getStatus().equals(Status.insert)) {
                    if (!dtUsoIstituz.equals(today) && dtUsoIstituz.before(today)) {
                        getMessageBox().addError(
                                "La data di attivazione deve essere successiva o uguale alla data odierna");
                    }
                    ...
                    if (isUniDoc) {
                        inUso = modelliXsdUdEjb.existDecUsoModelloXsdUdOnUniDoc(
                                getForm().getIdList().getId_tipo_unita_doc().parse(),
                                modelloXsdUdRowBean.getTiUsoModelloXsd(),
                                modelloXsdUdRowBean.getCdXsd());
                    } else if (isDoc) {
                    ...
                    if (inUso) {
                        getMessageBox().addError(
                                "Esiste gi\u00E0 una relazione associata al modello e versione selezionato");
                    }
                }
                // check date
                if (dtUsoSoppres.before(dtUsoIstituz)) {
                    getMessageBox().addError(
                            "La data di fine validit\u00E0 deve essere successiva alla data di attivazione");
                }
                if (dtUsoSoppres.after(dtSoppres)) {
                    getMessageBox().addError(
                            "La data di fine validit\u00E0 deve essere precedente o uguale alla data di fine validit\u00E0 del modello XSD ("
                                    + new SimpleDateFormat(Constants.DATE_FORMAT_DATE_TYPE)
                                            .format(dtSoppres)
                                    + ")");
                }
                // check standard
                if (modelloXsdUdRowBean.getFlStandard().equals(CostantiDB.Flag.TRUE)) {
                    ...
                    if (finded) {
                        getMessageBox().addError(
                                "Esiste gi\u00E0 una relazione standard per il tipo modello xsd selezionato");
                    }
                }
                // no errors
                if (!getMessageBox().hasError() && (isUniDoc || isDoc)) {
                    ...
                    if (getForm().getXsdModelliUdDetail().getStatus().equals(Status.insert)) {
                        if (getForm().getIdList().getId_tipo_unita_doc().parse() != null) {
                            ...
                            // Aggiungo in fondo alla lista il modello xsd ud associato (tipo uni
                            // doc)
                    ...
                    } else if (getForm().getXsdModelliUdDetail().getStatus()
                            .equals(Status.update)) {
                        if (getForm().getIdList().getId_tipo_unita_doc().parse() != null) {
                            modelliXsdUdEjb.updateDecModelloXsdUdInUsoUniDoc(param,
                                    modelloXsdUdRowBean);
                        } else if (getForm().getIdList().getId_tipo_doc().parse() != null) {
                            modelliXsdUdEjb.updateDecModelloXsdUdInUsoDoc(param,
                                    modelloXsdUdRowBean);
                        }
                    }
                    //
    ...
    public void deleteXsdModelliUdList() throws EMFError {
        ...
        if (isUniDoc) {
            ...
            DecUsoModelloXsdDocRowBean row = (DecUsoModelloXsdDocRowBean) getForm()
                    .getXsdModelliUdList().getTable().getCurrentRow();
            modelloXsdUdRowBean.copyFromBaseRow(row);
        }
        ...
        if (dtSoppres.compareTo(today) < 0) {
            getMessageBox()
                    .addError("Versione modello XSD ammesso gi\u00E0 disattivato in precedenza");
            if (StringUtils.isNotBlank(getLastPublisher())) {
                forwardToPublisher(getLastPublisher());
            } else {
                goBack();
            ...
            if (!getMessageBox().hasError()) {
                try {
                    ...
                    if (isUniDoc) {
                        ...
                        isInUse = modelliXsdUdEjb.isUsoModelloXsdUdDocInUse(
                                getForm().getIdList().getId_strut().parse(),
                    ...
                    if (isUniDoc || isDoc) {
                        ...
                        if (isInUse) {
                            if (StringUtils.isNotBlank(getLastPublisher())) {
                                deleted = false;
                                // Mostra messaggio di disattivazione
                                getRequest().setAttribute("confermaDisattivazioneXsdUdAmmesso",
                                        true);
                                forwardToPublisher(getLastPublisher());
                            } else {
                                deleteXsdModelloAmmesso(param, modelloXsdUdRowBean, isUniDoc,
                                        isDoc);
                            }
                        } else {
                    ...
                    deleted = false;
                    getMessageBox()
                            .addError("Versione modello xsd ammesso non pu\u00F2 essere eliminato: "
                                    + ex.getDescription());
                }
            ...
            if (!getMessageBox().hasError() && getLastPublisher()
                    .equals(Application.Publisher.MODELLO_XSD_UD_AMMESSO_DETAIL)) {
                goBack();
            } else {
                forwardToPublisher(getLastPublisher());
            }
    ...
    private void deleteXsdModelloAmmesso(LogParam param, DecModelloXsdUdRowBean modelloXsdUdRowBean,
            boolean isUniDoc, boolean isDoc) throws EMFError, ParerUserError {
        if (isUniDoc) {
            modelliXsdUdEjb.deleteDecUsoModelloXsdUniDoc(param,
                    getForm().getIdList().getId_strut().parse(),
                    modelloXsdUdRowBean.getIdTipoUniDoc(),
                    modelloXsdUdRowBean.getIdUsoModelloXsdUniDoc());
        } else if (isDoc) {
            modelliXsdUdEjb.deleteDecUsoModelloXsdDoc(param,
                    getForm().getIdList().getId_strut().parse(), modelloXsdUdRowBean.getIdTipoDoc(),
                    modelloXsdUdRowBean.getIdUsoModelloXsdDoc());
        }
    }
    ...
    public void confermaDisattivazioneXsdUdAmmesso() throws EMFError {
        ...
        try {
            if (isUniDoc) {
                usoModelloXsdUniDocTableBean = modelliXsdUdEjb
                        .deactivateDecModelloXsdUdInUsoUniDoc(param, modelloXsdUdRowBean);
            } else if (isDoc) {
        ...
        while (rowIt.hasNext()) {
            ...
            if (rowBean.getTiValoreParamApplic()
                ...
                if (rowBean.getString("ds_valore_param_applic_tipo_ud_amm") != null) {
                    rowBean.setString("ds_valore_param_applic_tipo_ud_amm",
                            Constants.OBFUSCATED_STRING);
                }

                if (rowBean.getString("ds_valore_param_applic_tipo_ud_gest") != null) {
                    rowBean.setString("ds_valore_param_applic_tipo_ud_gest",
                            Constants.OBFUSCATED_STRING);
                }

                if (rowBean.getString("ds_valore_param_applic_tipo_ud_cons") != null) {
                    rowBean.setString("ds_valore_param_applic_tipo_ud_cons",
                            Constants.OBFUSCATED_STRING);
                }
    ...
    public void filterInactiveRecordsParametriAmministrazioneTipoUdList() throws EMFError {
        ...
        BigDecimal idTipoUnitaDoc = ((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                .getTable().getCurrentRow()).getIdTipoUnitaDoc();
        boolean filterValid = getForm().getParametriAmministrazioneTipoUdList()
                .isFilterValidRecords();
        try {
            ...
            getMessageBox().addError(
                    "Errore durante il recupero dei parametri di amministrazione del tipo ud");
        }
        forwardToPublisher(getLastPublisher());
    }
    ...
    public void filterInactiveRecordsParametriConservazioneTipoUdList() throws EMFError {
        ...
        BigDecimal idTipoUnitaDoc = ((DecTipoUnitaDocRowBean) getForm().getTipoUnitaDocList()
                .getTable().getCurrentRow()).getIdTipoUnitaDoc();
        boolean filterValid = getForm().getParametriConservazioneTipoUdList()
                .isFilterValidRecords();
        try {
            if (getLastPublisher().equals(Application.Publisher.PARAMETRI_TIPO_UD)) {
                loadListaParametriConservazioneTipoUd(idStrut, idTipoUnitaDoc, null, false, true,
            ...
            getMessageBox().addError(
                    "Errore durante il recupero dei parametri di conservazione del tipo ud");
        }
        forwardToPublisher(getLastPublisher());
    }
    ...
    public void filterInactiveRecordsParametriGestioneTipoUdList() throws EMFError {
        ...
        try {
            ...
            getMessageBox()
                    .addError("Errore durante il recupero dei parametri di gestione del tipo ud");
        }
        forwardToPublisher(getLastPublisher());
    }

    private void loadListaParametriAmministrazioneTipoUd(BigDecimal idStrut,
            BigDecimal idTipoUnitaDoc, List<String> funzione, boolean hideDeleteButtons,
        ...
        AplParamApplicTableBean parametriAmministrazione = amministrazioneEjb
                .getAplParamApplicAmministrazioneTipoUd(idAmbiente, idStrut, idTipoUnitaDoc,
    ...
    private void loadListaParametriConservazioneTipoUd(BigDecimal idStrut,
            BigDecimal idTipoUnitaDoc, List<String> funzione, boolean hideDeleteButtons,
        ...
        AplParamApplicTableBean parametriConservazione = amministrazioneEjb
                .getAplParamApplicConservazioneTipoUd(idAmbiente, idStrut, idTipoUnitaDoc, funzione,
                        filterValid);
    ...
    private void loadListaParametriGestioneTipoUd(BigDecimal idStrut, BigDecimal idTipoUnitaDoc,
        ...
        AplParamApplicTableBean parametriGestione = amministrazioneEjb
                .getAplParamApplicGestioneTipoUd(idAmbiente, idStrut, idTipoUnitaDoc, funzione,
                        filterValid);
