...
@WebServlet(urlPatterns = {
        "/RecAIPFascicoloSync" }, asyncSupported = true)
public class RecAIPFascicoloSrvlt extends KeycloakAuthorizationServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        tmpAvanzamento = AvanzamentoWs.nuovoAvanzamentoWS(instanceName,
                AvanzamentoWs.Funzioni.RecuperoFasc);
            ...
            if (isMultipart) {
                ...
                try {
                    ...
                    if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
                        ...
                        // logAvanzamento();
                        //
                        recuperoFascSync.recuperaOggettoFasc(rispostaWsFasc, myRecuperoFascExt,
                                uploadDir);
                    }
                    ...
                    rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666,
                            "Eccezione generica nella servlet recupero AIP sync del fascicolo "
                                    + e1.getMessage());
                    ...
                    rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666,
                            "Eccezione generica nella servlet recupero AIP sync del fascicolo "
                                    + e1.getMessage());
                    log.error("Eccezione generica nella servlet recupero AIP sync del fascicolo ",
                            e1);
                } finally {
                    if (fileItems != null) {
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            ...
            try (ServletOutputStream out = response.getOutputStream();
                ...
                response.setHeader("Content-Length", String
                        .valueOf(rispostaWsFasc.getRifFileBinario().getFileSuDisco().length()));
            ...
            try (ServletOutputStream out = response.getOutputStream();
                ...
                Marshaller marshaller = xmlContextCache
                        .getVersRespStatoFascCtx_StatoConservazioneFasc().createMarshaller();
        ...
        if (rispostaWsFasc.getRifFileBinario() != null
                && rispostaWsFasc.getRifFileBinario().getFileSuDisco() != null) {
