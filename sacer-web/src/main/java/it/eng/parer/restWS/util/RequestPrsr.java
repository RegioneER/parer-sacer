...
public class RequestPrsr extends AbsRequestPrsr {
    ...
    /*
     * Metodo che chiama il parse passando il parametro aggiuntivo true. In questo modo si dice al
     * parsing di verificare il contenuto del CommonName dell'header e di bypassare il controllo su
     * LOGINNAME e PASSWORD.
     */
    // public List<FileItem> parseWithCommonName(IRispostaWS rispostaWs, ReqPrsrConfig
    // configurazione)
    ...
    /**
     * Nota bene: E' fondamentale che questo metodo ritorni la collection di FileItem, e che il
     ...
     * handler che non punta a nulla; il fenomeno Ã¨ difficile da replicare ma estremamente
     ...
     * exception)
     *
     * @param rispostaWs     interfaccia IRispostaWS
     * @param configurazione bean ReqPrsrConfig
     *
    ...
    public List<FileItem> parse(IRispostaWS rispostaWs, ReqPrsrConfig configurazione,
        ...
        // nella riga sotto arrivano i dati e vengono scritti su disco, la sua esecuzione puÃ²
        // richiedere parecchio
        // tempo
        ...
        /*
         * verifica della struttura della chiamata al WS: non Ã¨ un WS SOAP perciÃ² la signature del
