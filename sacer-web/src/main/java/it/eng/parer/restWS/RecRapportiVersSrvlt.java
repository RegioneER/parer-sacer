...
import it.eng.parer.ws.recupero.dto.WSDescRecProveCons;
import it.eng.parer.ws.recupero.dto.WSDescRecRapportiVers;
 ...
 * @author Fioravanti_F
 */
public class RecRapportiVersSrvlt extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(RecRapportiVersSrvlt.class);
    private String uploadDir;
    private String instanceName;

    public RecRapportiVersSrvlt() throws IOException {
        super();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        Response405.fancy405(resp, Response405.NomeWebServiceRest.REC_RAPP_VERS_SYNC);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        myRecuperoExt.setDescrizione(new WSDescRecRapportiVers());
            ...
            if (isMultipart) {
                ...
                try {
                    ...
                    if (rispostaWs.getSeverity() == SeverityEnum.OK) {
                        ...
                        // logAvanzamento();
                        //
                        recuperoSync.recuperaRapportiVers(rispostaWs, myRecuperoExt, uploadDir);
                    }
