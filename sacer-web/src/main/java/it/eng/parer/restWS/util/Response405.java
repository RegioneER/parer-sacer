...
public class Response405 {
    ...
    public enum NomeWebServiceRest {
        ...
        REC_UNITA_DOC_SYNC("RecDIPUnitaDocumentariaSync"), REC_PROVE_CONSERV_SYNC("RecDIPProveConservSync"), /**/
        REC_RAPP_VERS_SYNC("RecDIPRapportiVersSync"), REC_AIP_UNITA_DOC_SYNC("RecAIPUnitaDocumentariaSync"), /**/
        ...
        //
        REC_AIP_FASCICOLO_SYNC("RecAIPFascicoloSync"),
        //
    ...
    private final static String messaggio = "<html><body><h1>[SACER] - {0}</h1>\n"
