...
@WebServlet(urlPatterns = {
        "/RecDIPProveConservSync" }, asyncSupported = true)
public class RecProveConservSrvlt extends KeycloakAuthorizationServlet {

    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(RecProveConservSrvlt.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Response405.fancy405(resp, Response405.NomeWebServiceRest.REC_PROVE_CONSERV_SYNC);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        myRecuperoExt.setDescrizione(new WSDescRecProveCons());
        ...
        if (rispostaWs.getSeverity() == SeverityEnum.OK) {
            ...
            if (isMultipart) {
                ...
                rispostaWs.setEsitoWsErrBundle(MessaggiWSBundle.WS_CHECK,
                        "La chiamata non ̬ multipart/formdata ");
                log.error(
                        "Errore nella servlet recupero sync: la chiamata non ̬ multipart/formdata ");
            }
        }
