...
public class InvioRichiestaAnnullamentoVersamentiSrvlt extends Oauth2Srvlt {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Response405.fancy405(resp,
                Response405.NomeWebServiceRest.INVIO_RICHIESTA_ANNULLAMENTO_VERSAMENTI);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        tmpAvanzamento = AvanzamentoWs.nuovoAvanzamentoWS(instanceName,
                AvanzamentoWs.Funzioni.Annullamento);
            ...
            if (isMultipart) {
                ...
                try {
                    ...
                    if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
                        ...
                        invioRichiestaAnnullamentoVersamentiEjb.verificaVersione(
                                sessioneFinta.getVersioneWS(), rispostaWs, ravExt);
                    }

                    /* CONTROLLI COERENZA CON XML SCHEMA E CONTROLLI SUCCESSIVI */
                    if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
                        tmpAvanzamento.setFase("verifica xml").logAvanzamento();
                        invioRichiestaAnnullamentoVersamentiEjb
                                .parseXML(sessioneFinta.getDatiIndiceSipXml(), rispostaWs, ravExt);
                    }
                    ...
                    if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
                        ...
                        invioRichiestaAnnullamentoVersamentiEjb
                                .esaminaRichiesteAnnullamentoVersamento(rispostaWs, ravExt);
                    }
