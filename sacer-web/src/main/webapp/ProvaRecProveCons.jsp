...
<html>
    ...
    <body>
        <h1>Recupero Sincrono prove di conservazione</h1>
        <h2>Viene chiamata la servlet/ws <b>RecDIPProveConservSync</b></h2>
        <form action="RecDIPProveConservSync" method="post"  enctype="multipart/form-data" >
            <div class="box">
                <label>
                    <span>VERSIONE</span>
