...
<sl:html>
    ...
    <sl:body>
        ...
        <sl:content>
            ...
            <c:if test="${(sessionScope['###_FORM_CONTAINER']['tipoSerieRegistriList'].status eq 'view') }">
                <div class="livello1"><b><font color="#d3101c">Regole di filtraggio sul tipo documento principale</font></b></div>
                        ...
                        <sl:newLine skipLine="true"/>
                <div class="livello1"><b><font color="#d3101c">Filtri su dati specifici</font></b></div>
                        ...
                        <sl:newLine skipLine="true"/>
                <div class="livello1"><b><font color="#d3101c"><%= StrutSerieForm.RegoleDiRappresentazioneList.DESCRIPTION%></font></b></div>
