...
<sl:html>
    <sl:head  title="Monitoraggio - Lista unità documentarie derivanti da aggiornamenti metadati falliti" >
    </sl:head>
    <sl:body>
        ...
        <sl:content>
            ...
            <sl:contentTitle title="LISTA UNITÀ DOCUMENTARIE DERIVANTI DA AGGIORNAMENTI METADATI FALLITI"/>
            ...
            <sl:pulsantiera>
                <!-- piazzo il bottone -->
                <slf:lblField name="<%=MonitoraggioAggMetaForm.FiltriAggMeta.RICERCA_UNITA_DOC_AGG_META_FALLITI_BUTTON%>" width="w25" />
            </sl:pulsantiera>
            <sl:newLine skipLine="true"/>

            <!--  piazzo la lista con i risultati -->
            <slf:listNavBar name="<%= MonitoraggioAggMetaForm.UnitaDocAggMetaFallitiList.NAME%>" pageSizeRelated="true"/>
            <slf:list name="<%= MonitoraggioAggMetaForm.UnitaDocAggMetaFallitiList.NAME%>" />
            <slf:listNavBar  name="<%= MonitoraggioAggMetaForm.UnitaDocAggMetaFallitiList.NAME%>" />
            <sl:newLine skipLine="true" />
