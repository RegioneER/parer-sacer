...
<sl:html>
    <sl:head  title="Monitoraggio - Lista aggiornamenti metadati" >
    </sl:head>
    <sl:body>
        ...
        <sl:content>
            ...
            <sl:contentTitle title="LISTA AGGIORNAMENTI METADATI"/>
            ...
            <slf:fieldSet  borderHidden="false">
                ...
                <sl:newLine />
                <slf:lblField name="<%=MonitoraggioAggMetaForm.FiltriAggMeta.TI_STATO_UPD_ELENCO_VERS%>" colSpan="2" />
                <sl:newLine />
                <slf:lblField name="<%=MonitoraggioAggMetaForm.FiltriAggMeta.FL_SES_UPD_KO_RISOLTI%>" colSpan="2" />
                <sl:newLine />
            ...
            <sl:pulsantiera>
                <!-- piazzo il bottone -->
                <slf:lblField name="<%=MonitoraggioAggMetaForm.FiltriAggMeta.RICERCA_AGG_META_BUTTON%>" width="w25" />
            </sl:pulsantiera>
            <sl:newLine skipLine="true"/>

            <!--  piazzo la lista con i risultati -->
            <slf:listNavBar name="<%= MonitoraggioAggMetaForm.AggMetaList.NAME%>" pageSizeRelated="true"/>
            <slf:list name="<%= MonitoraggioAggMetaForm.AggMetaList.NAME%>" />
            <slf:listNavBar  name="<%= MonitoraggioAggMetaForm.AggMetaList.NAME%>" />
