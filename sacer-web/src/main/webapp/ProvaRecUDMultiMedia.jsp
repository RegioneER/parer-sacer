...
<html>
    ...
    <body>
        <h1>Recupero Unità Documentaria Multimedia</h1>
        <h2>Viene chiamata la servlet/ws <b>RecUniDocMultiMedia</b></h2>
        <form action="RecUniDocMultiMedia" method="post"  enctype="multipart/form-data" >
            <div class="box">
                <label>
                    <span>VERSIONE</span>
