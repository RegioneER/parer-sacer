...
<html>
    ...
    <body>
        <h1>Recupero Sincrono AIP unità documentaria</h1>
        <h2>Viene chiamata la servlet/ws <b>RecAIPUnitaDocumentariaSync</b></h2>
        <form action="RecAIPUnitaDocumentariaSync" method="post"  enctype="multipart/form-data" >
            <div class="box">
                <label>
                    <span>VERSIONE</span>
