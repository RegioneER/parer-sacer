...
<html>
    ...
    <body>
        <h1>Recupero Sincrono DIP per esibizione</h1>
        <h2>Viene chiamata la servlet/ws <b>RecDIPEsibizioneSync</b></h2>
        <form action="RecDIPEsibizioneSync" method="post"  enctype="multipart/form-data" >
            <div class="box">
                <label>
                    <span>VERSIONE</span>
