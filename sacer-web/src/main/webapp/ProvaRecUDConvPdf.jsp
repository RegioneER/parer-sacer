...
<html>
    <head>
        ...
        <title>Recupero Sincrono unità documentaria</title>
        <style>
            h1 {
    ...
    <body>
        <h1>Recupero Sincrono unità documentaria con conversione PDF</h1>
        <h2>Viene chiamata la servlet/ws <b>RecDIPComponenteTrasformatoSync</b></h2>
        <form action="RecDIPComponenteTrasformatoSync" method="post"  enctype="multipart/form-data" >
            <div class="box">
                <label>
                    <span>VERSIONE</span>
