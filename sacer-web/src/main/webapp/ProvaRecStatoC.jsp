...
<html>
    ...
    <body>
        <h1>Recupero Sincrono stato conservazione</h1>
        <h2>Viene chiamata la servlet/ws <b>RecDIPStatoConservazioneSync</b></h2>
        <form action="RecDIPStatoConservazioneSync" method="post"  enctype="multipart/form-data" >
            <div class="box">
                <label>
                    <span>VERSIONE</span>
