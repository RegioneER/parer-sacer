...
<html>
    ...
    <body>
        <h1>Recupero Prove di Conservazione Unità Documentaria Multimedia</h1>
        <h2>Viene chiamata la servlet/ws <b>RecPCUniDocMultiMedia</b></h2>
        <form action="RecPCUniDocMultiMedia" method="post"  enctype="multipart/form-data" >
            <div class="box">
                <label>
                    <span>VERSIONE</span>
                    <input type="text" size="10" name="VERSIONE" class="input-text" value="1.2"></input>
                </label>
                ...
                <label>
                    <span>XMLINDICE</span>
                    <TEXTAREA NAME="XMLINDICE" ROWS=10, COLS=100 class="input-text"></TEXTAREA>
                </label>
                <label>
                    <span>XMLSIP</span>
