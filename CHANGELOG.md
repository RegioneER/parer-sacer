...
- [#40851](https://parermine.regione.emilia-romagna.it/issues/40851) Correzione del conteggio dei versamenti UD annullati

### Novità: 13
- [#41050](https://parermine.regione.emilia-romagna.it/issues/41050) Ottimizzazione processo di recupero oggetti ZIP vs UNZIP 
- [#41005](https://parermine.regione.emilia-romagna.it/issues/41005) Introduzione dell'autenticazione con token nel servizio di recupero stato conservazione fascicolo
- [#40943](https://parermine.regione.emilia-romagna.it/issues/40943) Sviluppo fascicoli - Possibilità di ricercare per soggetto
- [#40910](https://parermine.regione.emilia-romagna.it/issues/40910) ottimizzazione performnce per annullamento UD con collegamenti
- [#40874](https://parermine.regione.emilia-romagna.it/issues/40874) Gestione degli URN degli Indici AIP delle UD annullate
- [#40777](https://parermine.regione.emilia-romagna.it/issues/40777) Ottimizzazione gestione recupero oggetti S3 di grandi dimensioni
- [#40674](https://parermine.regione.emilia-romagna.it/issues/40674) Ottimizzazione job restituzione archivio 
- [#40654](https://parermine.regione.emilia-romagna.it/issues/40654) Importa parametri: introduzione selezione tipi documento da importare
- [#40380](https://parermine.regione.emilia-romagna.it/issues/40380) Miglioramenti alla cancellazione a seguito di restituzione archivio
- [#37227](https://parermine.regione.emilia-romagna.it/issues/37227) Adeguamento job di «calcolo contenuto SACER» a seguito di cancellazione UD
- [#32370](https://parermine.regione.emilia-romagna.it/issues/32370) Eliminazione della cartella root FTP al termine del processo di restituzione
- [#31348](https://parermine.regione.emilia-romagna.it/issues/31348) Centralizzazione della gestione dei messaggi di errore applicativi
- [#31347](https://parermine.regione.emilia-romagna.it/issues/31347) Introduzione pagina gestione errori

## 10.20.1 (01-07-2026)

### Bugfix: 2
- [#40934](https://parermine.regione.emilia-romagna.it/issues/40934) Correzione apertura pagine ricerca dati specifici
- [#40927](https://parermine.regione.emilia-romagna.it/issues/40927) Modifica ai controlli al recupero di file da Sacer

## 10.20.0 (26-06-2026)

### Bugfix: 5
- [#40707](https://parermine.regione.emilia-romagna.it/issues/40707) Correzione in visualizzazione dettaglio parametri per i valori di tipo PASSWORD
- [#40695](https://parermine.regione.emilia-romagna.it/issues/40695) Correzione query recupero corrispondenze a Ping da dettaglio struttura
- [#40425](https://parermine.regione.emilia-romagna.it/issues/40425) Ottimizzazione job VERIFICA_COMPATIBILITA_TIPO_FASC
- [#40183](https://parermine.regione.emilia-romagna.it/issues/40183) Correzione verifica esistenza oggetto su O.S. per gli Indici AIP. 
- [#40174](https://parermine.regione.emilia-romagna.it/issues/40174) SACER: timeout e errore critico in cancellazione struttura appena creata

### Novità: 8
- [#40864](https://parermine.regione.emilia-romagna.it/issues/40864) Lista stati in Dettaglio richiesta annullamento versamento UD: aggiungere l'orario 
- [#40795](https://parermine.regione.emilia-romagna.it/issues/40795) Modifica generatore query di ricerca dati specifici lato java
- [#40705](https://parermine.regione.emilia-romagna.it/issues/40705) Introdurre il nuovo framework con la modifica per l'accesso tramite CIE/SPID
- [#40400](https://parermine.regione.emilia-romagna.it/issues/40400) Gestione dell'autorizzazione della proposta di scarto
- [#40385](https://parermine.regione.emilia-romagna.it/issues/40385) Disciplinare tecnico: modifica sezione automa e tabella referenti
- [#40195](https://parermine.regione.emilia-romagna.it/issues/40195) Gestione degli URN delle UD annullate
- [#40173](https://parermine.regione.emilia-romagna.it/issues/40173) Ottimizzazione tempi di esecuzione del job Sigillo e della firma Elenco indici AIP
- [#39225](https://parermine.regione.emilia-romagna.it/issues/39225) Introduzione di controlli al recupero di file da Sacer
...
### Bugfix: 2
- [#40781](https://parermine.regione.emilia-romagna.it/issues/40781) Correzione date di inizio e fine sessione di recupero nel monitoraggio
- [#40780](https://parermine.regione.emilia-romagna.it/issues/40780) Risoluzione errore nei servizi di recupero dei file unzippati

## 10.18.0 (14-05-2026)

### Bugfix: 4
- [#40546](https://parermine.regione.emilia-romagna.it/issues/40546) Correzione filtri data aperture e data chiusura fascicoli in "Ricerca unità documentaria avanzata"
- [#40372](https://parermine.regione.emilia-romagna.it/issues/40372) Ottimizzazione job VERIFICA COMPATIBILITA REGISTRO
- [#40065](https://parermine.regione.emilia-romagna.it/issues/40065) Collegamenti: verifica dell'esistenza dell'UD collegata considerando l'ultima versata non annullata
- [#39355](https://parermine.regione.emilia-romagna.it/issues/39355) Correzione del problema del filtro per data annullamento nella pagina VERSAMENTI ANNULLATI FASCICOLI

### Novità: 7
- [#40613](https://parermine.regione.emilia-romagna.it/issues/40613) Ottimizzazione tempi di esecuzione funzione di "Riepilogo versamenti sintetico"
- [#40211](https://parermine.regione.emilia-romagna.it/issues/40211) Creazione della proposta di scarto delle unità documentarie non contenute in aggregazioni
- [#40208](https://parermine.regione.emilia-romagna.it/issues/40208) Miglioramento usabilità della pagina Gestione parametri 
- [#38690](https://parermine.regione.emilia-romagna.it/issues/38690) Modifiche alla pagina Ricerca avanzata unità documentarie
- [#38179](https://parermine.regione.emilia-romagna.it/issues/38179) Eliminazione pulsante di creazione del criterio di raggruppamento in Ricerca UD
- [#38176](https://parermine.regione.emilia-romagna.it/issues/38176) Rimozione dello stato di conservazione IN CUSTODIA
- [#37230](https://parermine.regione.emilia-romagna.it/issues/37230) Aggiunta filtri di ricerca ud già inserite in una proposta di scarto

## 10.17.0 (15-04-2026)

### Bugfix: 3
- [#40331](https://parermine.regione.emilia-romagna.it/issues/40331) Correzione visualizzazione in "edit mode" dei filtri di ricerca in monitoragio struttura
- [#40176](https://parermine.regione.emilia-romagna.it/issues/40176) Correzione dell'errore nell'accedere al dettaglio di un elenco di versamento di una struttura con più substrutture
- [#40163](https://parermine.regione.emilia-romagna.it/issues/40163) Struttura tipologia documentaria: la tendina dei Registri presenta per la selezione, registri anche non appartenenti alla struttura

### Novità: 6
- [#40280](https://parermine.regione.emilia-romagna.it/issues/40280) Adeguamento procedura di eliminazione dei log dei job più vecchi di 3 anni.
- [#40127](https://parermine.regione.emilia-romagna.it/issues/40127) Nuova versione 1.3 per i servizi di recupero con alcuni parametri spostati dalla chiave ad un nuovo elemento opzionale XML
- [#40093](https://parermine.regione.emilia-romagna.it/issues/40093) Utilizzo del parametro  limitato al recupero del componente
- [#39883](https://parermine.regione.emilia-romagna.it/issues/39883) Gestione validazione XML multi-namespace con XSD modulari (xs:import/xs:include)
- [#37228](https://parermine.regione.emilia-romagna.it/issues/37228) Adeguamento monitoraggio ‘’Esame contenuto SACER’’
- [#30416](https://parermine.regione.emilia-romagna.it/issues/30416) Cancellazione delle sessioni fallite nella procedura di restituzione archivio

## 10.16.0 (03-03-2026)

### Bugfix: 5
- [#40107](https://parermine.regione.emilia-romagna.it/issues/40107) Inibizione dell'accesso al dettaglio delle UD annullate dal monitoraggio sintetico
- [#40105](https://parermine.regione.emilia-romagna.it/issues/40105) Correzione dell'errore critico quando si ordina per durata la ricerca schedulazioni job
- [#38538](https://parermine.regione.emilia-romagna.it/issues/38538) Correzione dello stato di conservazione assunto da una UD a seguito di annullamento della serie in cui è contenuta
- [#38537](https://parermine.regione.emilia-romagna.it/issues/38537) Correzione dello stato di conservazione assunto da una UD a seguito di annullamento del fascicolo in cui è contenuta
- [#34009](https://parermine.regione.emilia-romagna.it/issues/34009) Correzione della visualizzazione caratteri accentati non corretta

### Novità: 6
- [#40139](https://parermine.regione.emilia-romagna.it/issues/40139) Correzione di un errore nell'export di una struttura
- [#40119](https://parermine.regione.emilia-romagna.it/issues/40119) Introduzione log di utilizzo dei dati specifici nella ricerca unità documentarie
- [#39992](https://parermine.regione.emilia-romagna.it/issues/39992) Patch di sicurezza per interventi legati a CVE
- [#38028](https://parermine.regione.emilia-romagna.it/issues/38028) Dimissione della funzionalità di conservazione fiscale delle serie di UD
- [#37692](https://parermine.regione.emilia-romagna.it/issues/37692) Sostituzione partizionamenti manuali e by reference per blocco tabelle sessioni di versamento andate a buon fine
- [#37429](https://parermine.regione.emilia-romagna.it/issues/37429) Modifica foto struttura Sacer 

## 10.15.0 (06-02-2026)

### Novità: 1
- [#38892](https://parermine.regione.emilia-romagna.it/issues/38892) Aggiunta informazione ID_STRUT ai fini del partizionamento automatico delle tabelle delle sessioni di versamento andate a buon fine

## 10.14.0 (03-02-2026)

### Bugfix: 5
- [#39789](https://parermine.regione.emilia-romagna.it/issues/39789) Risoluzione del problema che impedisce l'annullamento dei fascicoli da PING
- [#39492](https://parermine.regione.emilia-romagna.it/issues/39492) Correzione dello stato di conservazione assunto da una UD a seguito di firma dell'Elenco indice AIP del fascicolo in cui è contenuta
- [#39491](https://parermine.regione.emilia-romagna.it/issues/39491) Correzione dello stato di conservazione assunto da una UD a seguito di firma dell'Indice AIP della serie in cui è contenuta
- [#39446](https://parermine.regione.emilia-romagna.it/issues/39446) Correzione errata denominazione di alcuni file negli AIP delle unità documentarie
- [#39145](https://parermine.regione.emilia-romagna.it/issues/39145) Correzione messaggio associato all'errore UD-001-016 a causa di inversione fra registro e tipologia UD

### Novità: 7
- [#39896](https://parermine.regione.emilia-romagna.it/issues/39896) Adeguamento gestione cancellazione per integrazione con cancellazione logica su restituzione archivio
- [#39581](https://parermine.regione.emilia-romagna.it/issues/39581) Revisione disciplinare tecnico
- [#39521](https://parermine.regione.emilia-romagna.it/issues/39521) Introduzione scope type "request" gestione controller web Spring
- [#39453](https://parermine.regione.emilia-romagna.it/issues/39453) Realizzazione nuovo servizio di recupero stato conservazione del fascicolo
- [#38426](https://parermine.regione.emilia-romagna.it/issues/38426) Modifica alla pagina gestione parametri
- [#37229](https://parermine.regione.emilia-romagna.it/issues/37229) Gestione scarto: creazione richiesta
- [#33130](https://parermine.regione.emilia-romagna.it/issues/33130) Rimozione del Job Verifica Firma a Data Versamento
...
### Bugfix: 2
- [#39023](https://parermine.regione.emilia-romagna.it/issues/39023) Correzione vista paramentrica MON_VP_LIS_UD_NON_VERS_IAM
- [#38913](https://parermine.regione.emilia-romagna.it/issues/38913) Firma elenchi – pop-up credenziali non sempre visibile

### Novità: 13
- [#39187](https://parermine.regione.emilia-romagna.it/issues/39187) Adeguamento consultazione dettaglio richiesta di annullamento a seguito della cancellazione UD.
- [#39147](https://parermine.regione.emilia-romagna.it/issues/39147) Modifica delle modalità di calcolo dell'estensione nel recupero di file sbustati
- [#38666](https://parermine.regione.emilia-romagna.it/issues/38666) Pagina di monitoraggio semplificata (Monitoraggio struttura)
- [#38652](https://parermine.regione.emilia-romagna.it/issues/38652) Software improvements
- [#38651](https://parermine.regione.emilia-romagna.it/issues/38651) Software improvements
- [#38418](https://parermine.regione.emilia-romagna.it/issues/38418) Software improvements
- [#38412](https://parermine.regione.emilia-romagna.it/issues/38412) Eliminazione del controllo case sensitive nell'importazione dei parametri unità documentaria
- [#38379](https://parermine.regione.emilia-romagna.it/issues/38379) Rimozione funzionalità Gestione job legacy
- [#38354](https://parermine.regione.emilia-romagna.it/issues/38354) Software improvements
- [#37210](https://parermine.regione.emilia-romagna.it/issues/37210) Consultazione data-mart
- [#37207](https://parermine.regione.emilia-romagna.it/issues/37207) Progettazione e definizione data-mart
- [#34882](https://parermine.regione.emilia-romagna.it/issues/34882) Riduzione tempi di apertura della pagina di dettaglio della richiesta di estrazione in produzione
- [#30725](https://parermine.regione.emilia-romagna.it/issues/30725) Adeguamento servizio di  annullamento UD per Cancellazione UD
