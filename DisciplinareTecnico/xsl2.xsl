<xsl:stylesheet version="1.0"
        ...
        <fo:root font-family="DejaVu Sans">
            <fo:layout-master-set>    
                <fo:simple-page-master master-name="PaginaA4"  
                                       page-width="29.7cm" page-height="21cm" margin-top="0.5cm"
                                       margin-bottom="0.5cm" margin-left="1.0cm" margin-right="1.0cm" >
            ...
            <fo:page-sequence master-reference="PaginaA4" initial-page-number="1">
                ...
                <fo:flow flow-name="xsl-region-body" >
                    <fo:wrapper font-size="10pt" text-align="justify">
                        ...
                        <xsl:apply-templates select="capitolo[@tipo='parametriStruttura']" /> 
                        <xsl:apply-templates select="capitolo[@tipo='parametriTipoUd']" />
                        <xsl:apply-templates select="capitolo[@tipo='formatiAmmessi']" />  
    ...
    <xsl:template match="capitolo[@tipo='testata']">
        <fo:block id="{generate-id(.)}">
            <fo:block text-align="center" font-size="23pt" font-weight="bold">
                DISCIPLINARE TECNICO
            </fo:block>  
            <xsl:call-template name="aCapo" />
            <fo:block text-align="center" font-size="22pt" font-weight="normal" >
            ...
            <xsl:call-template name="aCapo" />
            <xsl:call-template name="aCapo" />
            <fo:block text-align="center" font-size="15pt" font-weight="normal" >
            ...
            <xsl:call-template name="aCapo" />
            <xsl:call-template name="aCapo" />
            <fo:block text-align="center" font-size="13pt" font-weight="normal" >
    ...
    <xsl:template match="capitolo[@tipo='utentiSistema']" >
        <fo:block id="{generate-id(.)}">
            ...
            <xsl:call-template name="aCapo" />
            <fo:block>In questo capitolo sono definiti i nominativi, i recapiti, il ruolo delle diverse persone dell’Ente abilitate all’accesso al Sistema. Oltre agli utenti dell’Ente sono riportati
gli utenti dell’ente amministratore IBACN – ParER e di eventuali organi di vigilanza.</fo:block> 
    ...
    <xsl:template match="capitolo[@tipo='profiliAccesso']" >
        <fo:block id="{generate-id(.)}">
            ...
            <fo:block>Tra i Ruoli gestiti dal Sistema e assegnabili agli utenti:</fo:block>
            <xsl:call-template name="aCapo" />
            <fo:list-block xsl:use-attribute-sets="bloccoElencoPuntato">
                ...
                <fo:list-item>
                    ...
                    <fo:list-item-body start-indent="body-start()">
                        <fo:block border-width="0mm" border-style="hidden">Conservatore: è assegnato ai Responsabili (e loro incaricati) degli enti Conservatori. Consente di accedere alle funzioni necessarie a gestire il processo di conservazione;</fo:block>
                        <xsl:call-template name="aCapo" />
                    </fo:list-item-body>
                </fo:list-item>
                <fo:list-item>
                    ...
                    <fo:list-item-body start-indent="body-start()">
                        <fo:block border-width="0mm" border-style="hidden">Gestore: è assegnato agli utenti degli enti Gestori e consente l’accesso alle funzionalità di gestione degli utenti e delle organizzazioni degli enti produttori gestiti e ad assicurare loro il supporto per l’esercizio dei servizi di conservazione.</fo:block>
                    </fo:list-item-body>
                </fo:list-item>
            </fo:list-block>
            <xsl:call-template name="aCapo" />
    ...
    <xsl:template match="capitolo[@tipo='parametriStruttura']" >
        <fo:block id="{generate-id(.)}" page-break-before="always">
            <xsl:call-template name="stampaCapitolo">
                <xsl:with-param name="cap" select="."/>
            </xsl:call-template>
            ...
            <xsl:if test="tabella[@tipo='parametriStruttura']/riga">
                <fo:table>
                    ...
                    <fo:table-body>
                        <xsl:for-each select="tabella[@tipo='parametriStruttura']/riga" >
                            <fo:table-row>
                                <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                    <fo:block>
                                        <xsl:value-of select="funzione"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                    <fo:block>
                                ...
                                <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                        <fo:block>
                                            <xsl:if test="not(valoreStandard='null')">
                                                <xsl:value-of select="valoreStandard"/>
                                            </xsl:if>
                                        </fo:block>
                                </fo:table-cell>                        
                                <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                    <fo:block>
                                        <xsl:if test="not(valoreEffettivo='null')">
                                            <xsl:value-of select="valoreEffettivo"/>
                                        </xsl:if>
                                        <xsl:if test="valoreEffettivo='null' and not(valoreStandard='null')">
                                            <xsl:value-of select="valoreStandard"/>
                                        </xsl:if>
                                    </fo:block>
                                </fo:table-cell>                        
    ...
    <xsl:template match="capitolo[@tipo='formatiAmmessi']" >
        <xsl:call-template name="aCapo" />
        <fo:block id="{generate-id(.)}">
            <xsl:call-template name="stampaCapitolo">
                <xsl:with-param name="cap" select="."/>
            ...
            <xsl:if test="$righe">
                <fo:table>
                    <fo:table-header font-weight="bold">
                        ...
                        <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                            <fo:block>Descrizione trasformazione</fo:block>
                        </fo:table-cell>                        
                    </fo:table-header>
                    <fo:table-body>
                        <xsl:for-each select="$righe">
                            <fo:table-row>
                                ...
                                <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                    <fo:block>
                                        <xsl:value-of select="descrizionetrasf"/>
                                    </fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </xsl:for-each>
                ...
                <xsl:if test="$capStrutturaUD">
                    <xsl:for-each select="$capStrutturaUD">                    
                        <fo:block id="{generate-id(.)}" font-weight="bold">
                            ...
                            <xsl:if test="./tabella[@tipo='strutturaUD']/riga">
                                <fo:table>
                                    ...
                                    <fo:table-body>
                                        <xsl:for-each select="./tabella[@tipo='strutturaUD']/riga[not(tipoDocumento=preceding-sibling::riga/tipoDocumento)]">
												<fo:table-row>
													<fo:table-cell xsl:use-attribute-sets="table.cell.attr">
														<fo:block font-weight="normal">
                                ...
                                <fo:block font-weight="bold">Tabella - <xsl:value-of select="@nome"/><xsl:text>_Descrizione tipi documento</xsl:text></fo:block>
                                <xsl:call-template name="aCapo" />
                                <xsl:call-template name="aCapo" />
                            </xsl:if>

                            <xsl:variable name="esistonoNote" select="./tabella[@tipo='strutturaUD']/riga/note" />
                            <xsl:variable name="esistonoPeriodicita" select="./tabella[@tipo='strutturaUD']/riga/periodicitaVersamento" />
                            <!-- TABELLA DESCRITTIVA -->
                            <xsl:if test="./tabella[@tipo='strutturaUD']/riga">
                                <fo:table>
                                    <fo:table-column column-width="20%"/>                        
                                    ...
                                    <fo:table-header font-weight="bold">
                                        ...
                                        <xsl:if test="not($esistonoPeriodicita='')">
                                            <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                                <fo:block>Periodicità di versamento</fo:block>
                                            </fo:table-cell>
                                        </xsl:if>
                                        <xsl:if test="not($esistonoNote='')">
                                            <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                                <fo:block>Note</fo:block>
                                            </fo:table-cell>
                                        </xsl:if>
                                        ...
                                        <xsl:for-each select="./tabella[@tipo='strutturaUD']/riga">
                                            <fo:table-row>
                                                ...
                                                <xsl:if test="not($esistonoPeriodicita='')">
                                                    <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                                        <fo:block font-weight="normal">
                                                            <xsl:call-template name="scriviSeNonNullo"><xsl:with-param name="campo" select="periodicitaVersamento"/></xsl:call-template>
                                                        </fo:block>
                                                    </fo:table-cell>
                                                </xsl:if>
                                                <xsl:if test="not($esistonoNote='')">
                                ...
                                <fo:block font-weight="bold">Tabella - <xsl:value-of select="@nome"/><xsl:text>_Dettaglio tipi documento</xsl:text></fo:block>
                                <xsl:call-template name="aCapo" />
                                <xsl:call-template name="aCapo" />
                            </xsl:if>
                        ...
                        <xsl:if test="$tabRegistriStrutturaUD/riga">
                            ...
                            <!-- TABELLA DI DETTAGLIO DEI REGISTRI-->                                                        
                            <fo:table width="100%">
                                <fo:table-column column-width="20%"/>
                                <fo:table-column column-width="20%"/>
                                <fo:table-column column-width="15%"/>
                        ...
                        <xsl:call-template name="aCapo" />
                        <xsl:call-template name="aCapo" />
						<xsl:if test="not(collegamenti='null')">
							<fo:block>
								<fo:inline font-weight="bold">
									<xsl:text>Collegamenti tra unità documentarie</xsl:text>
								</fo:inline>
								<fo:inline font-weight="normal">
									<xsl:text>: </xsl:text>
									<xsl:call-template name="scriviSeNonNullo"><xsl:with-param name="campo" select="collegamenti"/></xsl:call-template>
								</fo:inline>
							</fo:block>  
							<xsl:call-template name="aCapo" />
						</xsl:if>
						<xsl:if test="not(periodicitaVersamento='null')">
							<fo:block>
								<fo:inline font-weight="bold">
									<xsl:text>Periodicità di versamento</xsl:text>
								</fo:inline>
								<fo:inline font-weight="normal">
									<xsl:text>: </xsl:text>
									<xsl:call-template name="scriviSeNonNullo"><xsl:with-param name="campo" select="periodicitaVersamento"/></xsl:call-template>                                
						...
						<xsl:if test="not(firme='null')">
							<fo:block>
								<fo:inline font-weight="bold">
									<xsl:text>Firme</xsl:text>
								</fo:inline>
								<fo:inline font-weight="normal">
									<xsl:text>: </xsl:text>
									<xsl:call-template name="scriviSeNonNullo"><xsl:with-param name="campo" select="firme"/></xsl:call-template>  
								</fo:inline>
							</fo:block>  
							<xsl:call-template name="aCapo" />
						</xsl:if>
    ...
    <xsl:template match="capitolo[@tipo='parametriTipoUd']" >
        <fo:block id="{generate-id(.)}" page-break-before="always">
            <xsl:call-template name="stampaCapitolo">
                <xsl:with-param name="cap" select="."/>
            </xsl:call-template>
            <xsl:call-template name="aCapo" />
            <xsl:variable name="capParametriTipoUd" select="." />
            <xsl:if test="not($capParametriTipoUd//capitolo[@tipo='unitaDocumentaria']/tabella[@tipo='parametriTipoUd']/riga)">
                <fo:block id="{generate-id($capParametriTipoUd/param)}" font-weight="bold">
                    <fo:block>
                        <fo:inline font-weight="normal">
                            <xsl:text>Non sono definiti parametri sul tipo unità documentaria.</xsl:text>
                        </fo:inline>
                    </fo:block>  
                    <xsl:call-template name="aCapo" />
                </fo:block>
            </xsl:if>
            <xsl:if test="$capParametriTipoUd//capitolo[@tipo='unitaDocumentaria']/tabella[@tipo='parametriTipoUd']/riga">
                <fo:block id="{generate-id($capParametriTipoUd/param)}" font-weight="bold">
                    <fo:block>
                        <fo:inline font-weight="normal">
                            <xsl:text>In questo paragrafo sono indicati (se presenti) i valori dei parametri utilizzati per le verifiche al versamento definiti in modo specifico per la tipologia di unità documentaria.</xsl:text>
                        </fo:inline>
                    </fo:block>  
                    <xsl:call-template name="aCapo" />
                </fo:block>
                <xsl:for-each select="$capParametriTipoUd//capitolo[@tipo='unitaDocumentaria']" >
                    <fo:block>
                        <fo:inline font-weight="bold">
                            <xsl:value-of select="@nome" />
                        </fo:inline>
                    ...
                    <xsl:call-template name="aCapo" />
                    <xsl:if test="tabella[@tipo='parametriTipoUd']/riga">
                        <fo:table>
                            <fo:table-column column-width="10%"/>
                            <fo:table-column column-width="25%"/>
                            <fo:table-column column-width="35%"/>                        
                            ...
                            <fo:table-header font-weight="bold">
                                ...
                                <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                    <fo:block>Valore sulla struttura</fo:block>
                                </fo:table-cell>                        
                                <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                    <fo:block>Valore effettivo (Richiesto dall'Ente)</fo:block>
                                </fo:table-cell>                        
                            ...
                            <fo:table-body>
                                <xsl:for-each select="tabella[@tipo='parametriTipoUd']/riga" >
                                    <!-- La riga viene stampata solo se il valore effettivo sulla UD è valorizzato -->
                                    <xsl:if test="not(valoreEffettivo='null')">
                                        <fo:table-row>
                                            <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                                <fo:block>
                                            ...
                                            <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
                                                    <fo:block>
                                                        <xsl:if test="not(valoreStruttura='null')">
                                                            <xsl:value-of select="valoreStruttura"/>
                                                        </xsl:if>
                                                    </fo:block>
                                            </fo:table-cell>                        
                                            <fo:table-cell xsl:use-attribute-sets="table.cell.attr">
