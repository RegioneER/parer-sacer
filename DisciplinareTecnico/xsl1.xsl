...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="/fotoOggetto">
        <disciplinare>
            ...
            <xsl:call-template name="formatiAmmessi" />
            <xsl:call-template name="parametriStruttura" />
            ...
            <xsl:call-template name="parametriTipoUd" />
        </disciplinare>
    </xsl:template>
                ...
                <xsl:element name="tabella">
                    ...
                    <xsl:for-each select="$utentiAbilitati">
                        <riga>
                            ...
                            <abilitazioniTipiUd>
                                <xsl:value-of select="datoRecord[colonnaDato='lista_tipo_ud_abil']/valoreDato"/>
                            </abilitazioniTipiUd>
                            <abilitazioniTipiDoc>
                                <xsl:value-of select="datoRecord[colonnaDato='lista_tipo_doc_abil']/valoreDato"/>
                            </abilitazioniTipiDoc>
                            <abilitazioniRegistri>
                                <xsl:value-of select="datoRecord[colonnaDato='lista_reg_abil']/valoreDato"/>
                            </abilitazioniRegistri>
                        </riga>
                    </xsl:for-each>
                </xsl:element>
    ...
    <xsl:template name="formatiAmmessi">
        <capitolo livello="1" numerato="si" nome="Formati ammessi" tipo="formatiAmmessi">
            <tabella nome="Formati ammessi" tipo="formatiAmmessi" livello="1" numerato="no">
    ...
    <!-- PARAMETRI STRUTTURA -->
    <xsl:template name="parametriStruttura">
        <capitolo nome="Parametri di Struttura per le verifiche al versamento" tipo="parametriStruttura" livello="1" numerato="si">
                <tabella nome="Parametri struttura" tipo="parametriStruttura" livello="2" numerato="no">
                    <xsl:for-each select="/fotoOggetto/recordChild[tipoRecord='Struttura']/child/recordChild[tipoRecord='Parametri struttura']/child">
                        <xsl:element name="riga">
                            <funzione>
                                <xsl:value-of select="datoRecord[colonnaDato='ti_param_applic']/valoreDato" />
                            </funzione>
                            <parametro>
                                <xsl:value-of select="keyRecord/datoKey[colonnaKey='nm_param_applic']/valoreKey" />
                            </parametro>
                            <descrizione>
                                <xsl:value-of select="datoRecord[colonnaDato='ds_param_applic']/valoreDato" />
                            </descrizione>
                            <valoreStandard>
                                <xsl:variable name="valoreStandard" select="datoRecord[colonnaDato='ds_valore_param_applic_su_ambiente']/valoreDato" />
                                <xsl:choose>
                                    <xsl:when test="$valoreStandard='true'">
                                        <xsl:text>SI</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$valoreStandard='false'">
                            ...
                            <valoreEffettivo>
                                <xsl:variable name="valoreEffettivo" select="datoRecord[colonnaDato='ds_valore_param_applic']/valoreDato" />
                                <xsl:choose>
                                    <xsl:when test="$valoreEffettivo='true'">
                                        <xsl:text>SI</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="$valoreEffettivo='false'">
                                        <xsl:text>NO</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
            ...
            <xsl:element name="tabella">
                ...
                <xsl:for-each select="/fotoOggetto/recordChild[tipoRecord='Struttura']/child/recordChild[tipoRecord='Tipi oggetto da trasformare']/child">
                    <riga>
                        ...
                        <trasformazione>
                            <xsl:value-of select="datoRecord[colonnaDato='cd_trasf']/valoreDato"/>
                        </trasformazione>
                        <descrizionetrasf>
        ...
        <capitolo nome="Tipologie di unità documentarie" tipo="tipologieUD" livello="1" numerato="no">
            <xsl:for-each select="/fotoOggetto/recordChild[tipoRecord='Struttura']/child/recordChild[tipoRecord='Tipo unità documentaria']/child">
                ...
                <xsl:element name="capitolo">
                    <xsl:attribute name="nome">Tipologia di unità documentaria <xsl:value-of select="keyRecord/datoKey[colonnaKey='nm_tipo_unita_doc']/valoreKey" />
                    </xsl:attribute>
                        ...
                        <xsl:element name="capitolo">                            <!-- Capitolo tipi struttura -->
                            ...
                            <xsl:element name="tabella">
                                ...
                                <xsl:for-each select="recordChild[tipoRecord='Tipi struttura unità documentaria']/child">
                                    <riga>
                                        ...
                                        <annoInizioValidita>
                                            <xsl:value-of select="datoRecord[colonnaDato='aa_min_tipo_strut_unita_doc']/valoreDato"/>
                                        </annoInizioValidita>
                                        <annoFineValidita>
                                            <xsl:value-of select="datoRecord[colonnaDato='aa_max_tipo_strut_unita_doc']/valoreDato"/>
                                        </annoFineValidita>
                                        <sistemiVersanti>
                                            <xsl:for-each select="recordChild[tipoRecord='Sistemi verasanti tipo struttura ud']/child">
                                                <sistema>
                                                    <xsl:value-of select="keyRecord/datoKey[colonnaKey='nm_sistema_versante']/valoreKey"/>
                                                </sistema>
                                            </xsl:for-each>
                                        </sistemiVersanti>
                                    </riga>
                            ...
                            <xsl:for-each select="recordChild[tipoRecord='Tipi struttura unità documentaria']/child">
                                <xsl:element name="capitolo">                                    <!-- Capitolo singolo tipo struttura -->
                                    <xsl:attribute name="nome">Tipo struttura <xsl:value-of select="keyRecord/datoKey[colonnaKey='nm_tipo_strut_unita_doc']/valoreKey" />
                                    </xsl:attribute>
                                    ...
                                    <xsl:attribute name="capitoloInterno">si</xsl:attribute>
                                    <collegamenti>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_collegamenti_ud']/valoreDato"/>
                                    </collegamenti>
                                    <periodicitaVersamento>                                        
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_periodicita_vers']/valoreDato"/>
                                    </periodicitaVersamento>
                                    <firme>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_firma']/valoreDato"/>
                                    </firme>
                                    <xsl:element name="tabella">
                                        <xsl:attribute name="tipo">strutturaUD</xsl:attribute>
                                        <xsl:attribute name="numerato">no</xsl:attribute>
                                        <xsl:attribute name="nome">Tipo struttura unità documentaria <xsl:value-of select="keyRecord/datoKey[colonnaKey='nm_tipo_strut_unita_doc']/valoreKey" />
                                        </xsl:attribute>

                                        <xsl:for-each select="recordChild[tipoRecord='Tipi documenti ammessi']/child">
											<xsl:sort select="keyRecord/datoKey[colonnaKey='nm_tipo_doc']/valoreKey" />
                                            ...
                                            <riga>
                                                ...
                                                <note>
                                                    <xsl:value-of select="datoRecord[colonnaDato='dl_note_tipo_doc']/valoreDato"/>
                                                </note>
                                            </riga>
                                        </xsl:for-each>
                                    </xsl:element>
                                    <xsl:element name="tabella"><xsl:attribute name="tipo">registriStrutturaUD</xsl:attribute>
                                        <xsl:attribute name="numerato">no</xsl:attribute>
                                                ...
                                                <periodiValidita>
                                                    <xsl:for-each select="recordChild[tipoRecord='Periodi di validità']/child">
                                                        <periodo>
                                                            ...
                                                            <al>
                                                                <xsl:value-of select="datoRecord[colonnaDato='aa_max_registro_unita_doc']/valoreDato" />
                                                            </al>
                                                            <descFormatoNumero>
                                                                <xsl:value-of select="datoRecord[colonnaDato='ds_formato_numero']/valoreDato" />
                                                            </descFormatoNumero>
                                                        </periodo>
                                                    </xsl:for-each>
                                                </periodiValidita>
                                    ...
                                    <anno>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_anno_tipo_strut_unita_doc']/valoreDato"/>
                                    </anno>
                                    <numero>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_numero_tipo_strut_unita_doc']/valoreDato"/>
                                    </numero>
                                    <data>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_data_tipo_strut_unita_doc']/valoreDato"/>
                                    </data>
                                    <oggetto>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_ogg_tipo_strut_unita_doc']/valoreDato"/>
                                    </oggetto>
                                    <riferimentoTemporale>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_rif_temp_tipo_strut_ud']/valoreDato"/>
                                    </riferimentoTemporale>
<!--									
                                    <collegamenti>
                                        <xsl:value-of select="datoRecord[colonnaDato='ds_collegamenti_ud']/valoreDato"/>
...
-->									
                            ...
                            <xsl:for-each select="recordChild[tipoRecord='XSD dati specifici tipo unità documentaria']/child">
                                <xsl:if test="recordChild[tipoRecord='Dati specifici tipo unità documentaria']/child">
                                    <xsl:element name="tabella">
                                        <xsl:attribute name="tipo">metadatiSpecificiUD</xsl:attribute>
                                        <xsl:attribute name="numerato">no</xsl:attribute>
                                        <xsl:attribute name="nome">Metadati specifici associati al tipo unità documentaria <xsl:value-of select="$nomeTipoUD" />
                                        </xsl:attribute>
                                        <versione>
                    ...
                    <xsl:if test="$docAmmessiUD">
                        <xsl:for-each select="$docAmmessiUD">
                            ...
                            <xsl:element name="capitolo">
                                <xsl:attribute name="nome">Tipo documento: <xsl:value-of select="$nomeDoc" />
                                </xsl:attribute>
                                ...
                                <xsl:if test="$childDatiSpecTipoDoc">
                                    <xsl:element name="capitolo">
                                        <xsl:attribute name="nome">Metadati specifici tipo documento <xsl:value-of select="$nomeDoc" />
                                        </xsl:attribute>
    ...
    <xsl:template name="parametriTipoUd">
        <capitolo nome="Parametri sul tipo unità documentaria per le verifiche al versamento" tipo="parametriTipoUd" livello="1" numerato="no">
            <xsl:for-each select="/fotoOggetto/recordChild[tipoRecord='Struttura']/child/recordChild[tipoRecord='Tipo unità documentaria']/child">
                <xsl:variable name="nomeTipoUD" select="keyRecord/datoKey[colonnaKey='nm_tipo_unita_doc']/valoreKey" />
                <xsl:element name="capitolo">
                    <xsl:attribute name="nome">Tipologia di unità documentaria <xsl:value-of select="keyRecord/datoKey[colonnaKey='nm_tipo_unita_doc']/valoreKey" />
                    ...
                    <tabella nome="Parametri tipo ud" tipo="parametriTipoUd" livello="2" numerato="no">
                        <xsl:for-each select="recordChild[tipoRecord='Parametri tipo unità documentaria']/child">
                            <xsl:element name="riga">
                                <funzione>
                                    <xsl:value-of select="datoRecord[colonnaDato='ti_param_applic']/valoreDato" />
                                </funzione>
                                ...
                                <valoreStruttura>
                                    <xsl:variable name="valoreStruttura" select="datoRecord[colonnaDato='ds_valore_param_applic_su_struttura']/valoreDato" />
                                    <xsl:choose>
                                        <xsl:when test="$valoreStruttura='true'">
                                            <xsl:text>SI</xsl:text>
                                        </xsl:when>
                                        <xsl:when test="$valoreStruttura='false'">
                                            <xsl:text>NO</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
