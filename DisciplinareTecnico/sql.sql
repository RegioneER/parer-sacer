SELECT  XMLELEMENT("fotoOggetto",
          ...
          STRUTTURA,
                ...
                (
                    SELECT XMLELEMENT("fotoOggetto", 
                                    ...
                                    XMLELEMENT
                                            ("recordMaster", 
                                                    ...
                                                    XMLELEMENT("idRecord",ente.id_ente_siam), 
                                                    ...
                                                    XMLELEMENT
                                                            ("keyRecord", 
                                                                    XMLELEMENT
                                                                            ("datoKey", 
                                                                                    XMLELEMENT("colonnaKey",'nm_ente_siam'),
                                                                                    XMLELEMENT("labelKey",'Denominazione'),
                                                                                    XMLELEMENT("valoreKey",ente.nm_ente_siam) 
                                                                            ) 
                                                            ), 
                                                    -- fine keyRecord
                                                    ...
                                                    XMLELEMENT
                                                            ("datoRecord", 
                                                                    XMLELEMENT("colonnaDato",'nm_ente_siam_nuovo'), 
                                                                    XMLELEMENT("labelDato",'Denominazione nuovo ente'), 
                                                                    XMLELEMENT("valoreDato", nvl(ente_new.nm_ente_siam, 'null') ) 
                                                            ),
                                                    XMLELEMENT
                                                            ("datoRecord", 
                              ...
                              WHERE ente_sto.id_ente_convenz = ente.id_ente_siam
                                                    )
                                            ), 
                                            -- Fine Anagrafiche
                                            ...
                                            ("recordChild", 
                                                    ...
                                                    (SELECT XMLAGG
                                                      ...
                                                      WHERE org_ente.id_ente_convenz = ente.id_ente_siam
                                                    )
                                            ), 
                                            ...
                                            ("recordChild", 
                                                    ...
                                                    (SELECT XMLAGG
                                                      ...
                                                      WHERE ark.id_ente_convenz = ente.id_ente_siam
                                                    )
                                            ),
                                            -- Fine Archivista
                                                    ...
                                                    (SELECT XMLAGG
                                                                    (XMLELEMENT
                                                                            ("child", 
                                                                                    ...
                                                                                    XMLELEMENT
                                                                                            ("datoRecord", 
                                                                                                    XMLELEMENT("colonnaDato",'dt_dec_accordo'), 
                                                                                                    XMLELEMENT("labelDato",'Data decorrenza'), 
                                                                                                    XMLELEMENT("valoreDato", nvl(to_char(acc.dt_dec_accordo, 'dd/mm/yyyy'), 'null') ) 
                                                                                            ),
                                                                                    XMLELEMENT
                                                                                            ("datoRecord", 
                                                                                    ...
                                                                                    XMLELEMENT
                                                                                            ("datoRecord", 
                                                                                                    XMLELEMENT("colonnaDato",'fl_valido'), 
                                                                                                    XMLELEMENT("labelDato",'flag accordo valido'), 
                                                                                                    XMLELEMENT("valoreDato", CASE 
                                                                                                                                --Accordo valido (data corrente compresa tra data decorrenza e data fine validità e < data scadenza) 
																																WHEN SYSDATE between acc.dt_dec_Accordo AND acc.dt_scad_accordo and acc.dt_fine_valid_accordo >= sysdate THEN '1'
																																-- Accordo valido in corso di rinnovo (data corrente > data scadenza e < data fine validità)
																																when SYSDATE between acc.dt_fine_valid_accordo AND acc.dt_scad_accordo  THEN '1'
                                                                                                                                ELSE '0' 
                                                                                                                            END 
                                                                                                    ) 
                                                                                            ),
                                                                    ...
                                                                    ORDER BY acc.dt_scad_accordo DESC NULLS FIRST
                                                                    )
                                                      ...
                                                      WHERE acc.id_ente_convenz = ente.id_ente_siam
                                                      AND   SYSDATE > acc.dt_dec_accordo
                                      ...
                                      WHERE user_rif.id_ente_convenz = ente.id_ente_siam
                                                    )
                                            )
                                            -- Fine referenti
                      ) AS FOTO
                      -- Fine FotoOggetto
                    FROM SACER_IAM.ORG_ENTE_SIAM ente
                    ...
                    left join SACER_IAM.ORG_ENTE_SIAM ente_new
                     on (ente_new.id_ente_siam = ente.id_ente_convenz_nuovo)
                    ...
                    join SACER_IAM.ORG_ENTE_CONVENZ_ORG org_ente_org
                     on (org_ente_org.ID_ENTE_CONVENZ = ente.ID_ENTE_SIAM)
                                ...
                                SELECT    XMLELEMENT("fotoOggetto", 
                                            ...
                                            XMLELEMENT
                                                                ("recordMaster",
                                                                        ...
                                                                        XMLELEMENT ("datoRecord",
                                                                                        XMLELEMENT("colonnaDato",'nm_ente_siam'),
                                                                                        XMLELEMENT("labelDato",'Ente convenzionato'),
                                                                                        XMLELEMENT("valoreDato",nvl(ente_convenz.nm_ente_siam, 'null') )
                                                                                ),
                                                                        XMLELEMENT ("datoRecord",
                                                                                        XMLELEMENT("colonnaDato",'dt_ini_val'),
                                                                                        XMLELEMENT("labelDato",'Data inizio validità'),
                                                        ...
                                                        -- inizio record child Valore parametro (sulla struttura)
                                                        XMLELEMENT
                                                        ("recordChild", 
                                                                XMLELEMENT("tipoRecord", 'Parametri struttura'),
                                                                
                                                                (SELECT XMLAGG
                                                                        (XMLELEMENT
                                                                        ("child", 
                                                                                XMLELEMENT("idRecord", apl_param.ID_PARAM_APPLIC), 
                                                                                XMLELEMENT
                                                                                ("keyRecord",                                                                     
                                                                                        XMLELEMENT
                                                                                        ("datoKey", 
                                                                                        XMLELEMENT("colonnaKey",'nm_param_applic'), 
                                                                                        XMLELEMENT("labelKey",'Nome parametro'),
                                                                                        XMLELEMENT("valoreKey", apl_param.nm_param_applic)
                                                                                        )
                                                                                ), 
                                                                                XMLELEMENT
                                                                                        ("datoRecord", 
                                                                                        XMLELEMENT("colonnaDato",'ds_param_applic'), 
                                                                                        XMLELEMENT("labelDato",'Descrizione parametro'), 
                                                                                        XMLELEMENT("valoreDato", nvl(apl_param.ds_param_applic,'null')) 
                                                                                        ), 
                                                                                XMLELEMENT
                                                                                        ("datoRecord", 
                                                                                        XMLELEMENT("colonnaDato",'ds_valore_param_applic_struttura'), 
                                                                                        XMLELEMENT("labelDato",'Valore parametro struttura'), 
                                                                                        XMLELEMENT("valoreDato", nvl((SELECT DISTINCT val.DS_VALORE_PARAM_APPLIC 
																																				 FROM APL_VALORE_PARAM_APPLIC val 
																																				 WHERE val.id_param_applic=apl_param.id_param_applic 
																																				 AND val.id_strut=strut.id_strut
																																				 AND val.TI_APPART='STRUT'),'null')) 
                                                                                        ), 
                                                                                XMLELEMENT
                                                                                        ("datoRecord", 
                                                                                        XMLELEMENT("colonnaDato",'ds_valore_param_applic_su_ambiente'), 
                                                                                        XMLELEMENT("labelDato",'Valore parametro su ambiente'), 
                                                                                        XMLELEMENT("valoreDato", nvl((SELECT DISTINCT val.DS_VALORE_PARAM_APPLIC 
																																				 FROM APL_VALORE_PARAM_APPLIC val 
																																				 WHERE val.id_param_applic=apl_param.id_param_applic 
																																				 AND val.id_ambiente=amb.id_ambiente 
--																																				 AND val.id_ambiente=:id_ambiente 
																																				 AND val.TI_APPART='AMBIENTE'),'null')) 
                                                                                        ), 
                                                                                XMLELEMENT
                                                                                        ("datoRecord", 
                                                                                        XMLELEMENT("colonnaDato",'ti_param_applic'), 
                                                                                        XMLELEMENT("labelDato",'Funzione'), 
                                                                                        XMLELEMENT("valoreDato", apl_param.ti_param_applic) 
                                                                                        )
                                                                        )
                                                                        ORDER BY apl_param.TI_PARAM_APPLIC, apl_param.NM_PARAM_APPLIC
                                                                                                )
                                                                FROM 	SACER.APL_PARAM_APPLIC  apl_param
                                                                WHERE 	apl_param.ti_gestione_param = 'gestione'
                                                                AND 	apl_param.FL_APPART_STRUT='1'
                                                                )),
                                                        -- FINE record child Valore parametro (sulla struttura)
                                                                        ...
                                                                        (SELECT XMLAGG
                                                                                        (XMLELEMENT
                                                                                                ("child",
                                                                                                        ...
                                                                                                        XMLELEMENT
                                                                                                                ("datoRecord",
                                                                                                                        XMLELEMENT("colonnaDato",'lista_tipo_ud_abil'),
                                                                                                                        XMLELEMENT("labelDato",'Lista tipi ud abilitate'),
                                                                                                                        XMLELEMENT("valoreDato",nvl(to_char(abil.lista_tipo_ud_abil), 'null'))
                                                                                                                ),
                                                                                                        XMLELEMENT
                                                                                                                ("datoRecord",
                                                                                                                        XMLELEMENT("colonnaDato",'lista_reg_abil'),
                                                                                                                        XMLELEMENT("labelDato",'Lista registri abilitati'),
                                                                                                                        XMLELEMENT("valoreDato",nvl(to_char(abil.lista_reg_abil), 'null'))
                                                                                                                ),
                                                                                                        XMLELEMENT
                                                                                                                ("datoRecord",
                                                                                                                        XMLELEMENT("colonnaDato",'lista_tipo_doc_abil'),
                                                                                                                        XMLELEMENT("labelDato",'Lista tipi doc abilitati'),
                                                                                                                        XMLELEMENT("valoreDato",nvl(to_char(abil.lista_tipo_doc_abil), 'null'))
                                                                                                                )	
                                                                                                )
                                                                                                ...
                                                                                                ("child",
                                                                                                        ...
                                                                                                        XMLELEMENT
                                                                                                                ("datoRecord",
                                                                                                                        XMLELEMENT("colonnaDato",'dl_note'),
                                                                                                                        XMLELEMENT("labelDato",'Note'),
                                                                                                                        XMLELEMENT("valoreDato",abil.dl_note)
                                                                                                                )	
                                                                                                )
                                                                                        ORDER BY abil.NM_COGNOME_USER, abil.NM_NOME_USER
                                                                                        )
                                                                            ...
                                                                            (SELECT XMLAGG
                                                                                            (XMLELEMENT
                                                                                                    ("child",
                                                                                                            ...
                                                                                                            XMLELEMENT
                                                                                                                    ("datoRecord",
                                                                                                                            XMLELEMENT("colonnaDato",'cd_trasf'),
                                                                                                                            XMLELEMENT("labelDato",'Nome trasformazione'),
                                                                                                                            XMLELEMENT("valoreDato",nvl(to_char(trasf.cd_trasf),'null'))
                                                                                                                    ),
                                                                                                            XMLELEMENT
                                                                                                                    ("datoRecord",
                                                            ...
                                                            (SELECT XMLAGG(
                                                                    XMLELEMENT
                                                                        ("child",
                                                                            ...
                                                                            XMLELEMENT
                                                                                ("datoRecord",
                                                                                    XMLELEMENT("colonnaDato",'dl_note_tipo_ud'),
                                                                                    XMLELEMENT("labelDato",'Note tipo ud'),
                                                                                    XMLELEMENT("valoreDato", nvl(tipo_ud.dl_note_tipo_ud, 'null') )
                                                                                ),
                                                                            ...
                                                                            XMLELEMENT
                                                                                ...
                                                                                -- inizio record child Valore parametro (sulla UD)
                                                                                 XMLELEMENT
                                                                                 ("recordChild", 
                                                                                         XMLELEMENT("tipoRecord", 'Parametri tipo unità documentaria'),
                                                                                         ...
                                                                                         (SELECT XMLAGG
                                                                                                 ...
                                                                                                 ("child", 
                                                                                                         ...
                                                                                                         XMLELEMENT
                                                                                                                 ("datoRecord", 
                                                                                                                 XMLELEMENT("colonnaDato",'ds_valore_param_ud'), 
                                                                                                                 XMLELEMENT("labelDato",'Valore parametro ud'), 
                                                                                                                 XMLELEMENT("valoreDato", nvl( (SELECT DISTINCT val.DS_VALORE_PARAM_APPLIC 
																																				 FROM APL_VALORE_PARAM_APPLIC val 
																																				 WHERE val.id_param_applic=apl_param.id_param_applic 
																																				 AND val.id_tipo_unita_doc=tipo_ud.ID_TIPO_UNITA_DOC
																																				 AND val.TI_APPART='TIPO_UNITA_DOC') ,'null')) 
                                                                                                                 ), 
                                                                                                         XMLELEMENT
                                                                                                                 ("datoRecord", 
                                                                                                                 XMLELEMENT("colonnaDato",'ds_valore_param_applic_su_ambiente'), 
                                                                                                         ...
                                                                                                         XMLELEMENT
                                                                                                                 ("datoRecord", 
                                                                                                                 XMLELEMENT("colonnaDato",'ds_valore_param_applic_su_struttura'), 
                                                                                                                 XMLELEMENT("labelDato",'Valore parametro su struttura'), 
                                                                                                                 XMLELEMENT("valoreDato", nvl( (SELECT DISTINCT val.DS_VALORE_PARAM_APPLIC 
																																				 FROM APL_VALORE_PARAM_APPLIC val 
																																				 WHERE val.id_param_applic=apl_param.id_param_applic 
																																				 AND val.id_Strut=strut.id_strut 
																							...
																							FROM 	SACER.APL_PARAM_APPLIC  apl_param
																							WHERE 	apl_param.ti_gestione_param = 'gestione'
																							AND 	apl_param.FL_APPART_TIPO_UNITA_DOC='1'
                                                                                         )),
                                                                                -- FINE record child Valore parametro (sulla UD)
                                                                                                ...
                                                                                                ("child",
                                                                                                    ...
                                                                                                    XMLELEMENT
                                                                                                        ("datoRecord",
                                                                                                            ...
                                                                                                            XMLELEMENT("valoreDato",nvl(strud.ds_tipo_strut_unita_doc,'null'))
                                                                                                        ),
                                                                                                    XMLELEMENT
                                                                                                        ("datoRecord",
                                                                                                            XMLELEMENT("colonnaDato",'dt_istituz'),
                                                                                                    ...
                                                                                                    XMLELEMENT
                                                                                                    ("datoRecord",
                                                                                                            XMLELEMENT("colonnaDato",'ds_collegamenti_ud'),
                                                                                                            XMLELEMENT("labelDato",'Collegamenti ud'),
                                                                                                            XMLELEMENT("valoreDato", nvl(strud.ds_collegamenti_ud, 'null') )
                                                                                                    ),
                                                                                                    XMLELEMENT
                                                                                                    ("datoRecord",
                                                                                                            XMLELEMENT("colonnaDato",'ds_periodicita_vers'),
                                                                                                            XMLELEMENT("labelDato",'Periodicità versamento'),
                                                                                                            XMLELEMENT("valoreDato", nvl(strud.ds_periodicita_vers, 'null') )
                                                                                                    ),
                                                                                                    XMLELEMENT
                                                                                                    ("datoRecord",
                                                                                                            XMLELEMENT("colonnaDato",'ds_firma'),
                                                                                                            XMLELEMENT("labelDato",'Firma'),
                                                                                                            XMLELEMENT("valoreDato", nvl(strud.ds_firma, 'null') )
                                                                                                    ),
                            ...
                            --                                                                                                                                    XMLELEMENT("valoreDato", nvl(periodi.aa_max_registro_unita_doc, 'null') )
                                                                                                    ...
                                                                                                    -- inizio record child DEC_TIPO_STRUT_UD_SIS_VERS (sistemi versanti struttura UD)
                                                                                                    XMLELEMENT
                                                                                                        ("recordChild",
                                                                                                            XMLELEMENT("tipoRecord",'Sistemi verasanti tipo struttura ud'),
                                                                                                            (SELECT XMLAGG
                                                                                                                    (XMLELEMENT
                                                                                                                        ("child",
                                                                                                                            XMLELEMENT("idRecord",strutSisVers.id_tipo_strut_ud_sis_vers),
                                                                                                                            XMLELEMENT
                                                                                                                                ("keyRecord",
                                                                                                                                    XMLELEMENT
                                                                                                                                        ("datoKey",
                                                                                                                                            XMLELEMENT("colonnaKey",'nm_sistema_versante'),
                                                                                                                                            XMLELEMENT("labelKey",'Nome sistema versante'),
                                                                                                                                            XMLELEMENT("valoreKey",sistVers.nm_sistema_versante)
                                                                                                                                    )
                                                                                                                                ),
                                                                                                                            XMLELEMENT
                                                                                                                                ("datoRecord",
                                                                                                                                    XMLELEMENT("colonnaDato",'ds_registro_unita_doc'),
                                                                                                                                    XMLELEMENT("labelDato",'Descrizione sistema versante'),
                                                                                                                                    XMLELEMENT("valoreDato", nvl(sistVers.ds_sistema_versante, 'null') )
                                                                                                                                )
                                                                                                                        )
                                                                                                                    ORDER BY sistVers.nm_sistema_versante
                                                                                                                    )
                                                                                                            FROM  SACER.DEC_TIPO_STRUT_UD_SIS_VERS strutSisVers, SACER_IAM.APL_SISTEMA_VERSANTE sistVers
                                                                                                            WHERE strutSisVers.id_tipo_strut_unita_doc = strud.id_tipo_strut_unita_doc
                                                                                                            AND   sistVers.id_sistema_versante = strutSisVers.id_sistema_versante 
                                                                                                            )
                                                                                                        ), -- fine record child DEC_TIPO_STRUT_UD_SIS_VERS (sistemi versanti struttura UD)                    
                                                                                                                    ...
                                                                                                                    (XMLELEMENT
                                                                                                                        ("child",
                                                                                                                            ...
                                                                                                                            XMLELEMENT
                                                                                                                                ("datoRecord",
                                                                                                                                    XMLELEMENT("colonnaDato",'ds_periodicita_vers'),
                                                                                                                                    XMLELEMENT("labelDato",'Periodicita di versamento'),
                                                                                                                                    XMLELEMENT("valoreDato", trim(nvl(tipodoc.ds_periodicita_vers, 'null')) )
                                                                                                                                ),
                                                                                                                            XMLELEMENT
                                                                                                                                ("datoRecord",
                                                                                                                                    XMLELEMENT("colonnaDato",'dl_note_tipo_doc'),
                                                                                                                                    XMLELEMENT("labelDato",'Note tipo documento'),
                                                                                                                                    XMLELEMENT("valoreDato", trim(nvl(tipodoc.dl_note_tipo_doc, 'null')) )
                                                                                                                                ),
...
--                                                            ORDER BY    tipo_ud.nm_tipo_unita_doc
                                ...
                                left join sacer_iam.ORG_ENTE_SIAM ente_convenz
                                 on (ente_convenz.id_ente_siam = strut.id_ente_convenz)
