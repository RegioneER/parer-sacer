...
public class VrsXmlSesFascicoloErr implements Serializable {
    ...
    private List<VrsXmlSesFascErrObjectStorage> vrsXmlSesFascErrObjectStorages = new ArrayList<>();
    ...
    public List<VrsXmlSesFascErrObjectStorage> getVrsXmlSesFascErrObjectStorages() {
        return vrsXmlSesFascErrObjectStorages;
    }

    public void setVrsXmlSesFascErrObjectStorages(List<VrsXmlSesFascErrObjectStorage> vrsXmlSesFascErrObjectStorages) {
        this.vrsXmlSesFascErrObjectStorages = vrsXmlSesFascErrObjectStorages;
    }
}
