...
/**
 * The primary key class for the MON_V_CNT_UPD_UD_ENTE database table.
 */
@Embeddable
public class MonVCntUpdUdEnteId implements Serializable {
    ...
    public MonVCntUpdUdEnteId() {/* Hibernate */
    }

    public MonVCntUpdUdEnteId(BigDecimal idUserIam, BigDecimal idEnte, String tiStatoUpdUd,
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MonVCntUpdUdEnteId)) {
            return false;
        }
        MonVCntUpdUdEnteId castOther = (MonVCntUpdUdEnteId) other;
