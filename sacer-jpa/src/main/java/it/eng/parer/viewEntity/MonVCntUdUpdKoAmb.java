...
/**
 * The persistent class for the MON_V_CNT_UD_UPD_KO_AMB database table.
 */
@Entity
@Table(name = "MON_V_CNT_UD_UPD_KO_AMB")
public class MonVCntUdUpdKoAmb implements Serializable {

    private static final long serialVersionUID = 1L;

    private BigDecimal niUpdUdKo;

    public MonVCntUdUpdKoAmb() {/* Hibernate */
    }
