...
public class VolVListaCompVol implements Serializable {
    ...
    public VolVListaCompVol(BigDecimal idVolumeConserv, String dsUrnCompCalc,
	    ...
	    String flCompFirmato, String tiEsitoVerifFirmeVers, String tiEsitoVerifFirmeChius,
	    BigDecimal idUnitaDoc, BigDecimal idDoc) {
    ...
    public VolVListaCompVol(BigDecimal idVolumeConserv, BigDecimal idCompDoc, String dsUrnCompCalc,
	    ...
	    String nmFormatoFileDocVers, Date dtCreazioneDoc, BigDecimal niFileSizeCalc,
	    String flCompFirmato, String tiEsitoVerifFirmeVers, String tiEsitoVerifFirmeChius,
	    BigDecimal idUnitaDoc, BigDecimal idDoc, String cdRegistroKeyUnitaDoc,
