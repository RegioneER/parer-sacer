...
public class ElvVRicElencoVersByUd implements Serializable {
    ...
    public ElvVRicElencoVersByUd(BigDecimal idElencoVers, String nmElenco, String dsElenco,
	    String tiStatoElenco, String tiGestElenco, BigDecimal niCompAggElenco,
	    BigDecimal niCompVersElenco, BigDecimal niSizeVersElenco, BigDecimal niSizeAggElenco,
	    Date dtCreazioneElenco, Date dtChius, Date dtFirmaIndice, BigDecimal idCriterioRaggr,
	    String nmCriterioRaggr, String nmAmbiente, String nmEnte, String nmStrut,
	    String flElencoFisc, String flElencoStandard, String flElencoFirmato,
	    BigDecimal niIndiciAip, Date dtCreazioneElencoIxAip, Date dtFirmaElencoIxAip,
	    Date tsStatoElencoInCodaJms) {
