...
/**
 * The persistent class for the LOG_VP_LIS_INI_SCHED_JOB database table/view/macro.
 *
 */
@Entity
...
// ===================================================================================
@SqlResultSetMapping(name = "LogVpLisIniSchedJobDTOMapping", classes = @ConstructorResult(targetClass = LogVpLisIniSchedJobDTO.class, columns = {
        @ColumnResult(name = "ID_LOG_JOB", type = BigDecimal.class),
...
public class LogVpLisIniSchedJob implements Serializable {
