                ...
                if (response != null) {
                    ...
                    if (resEntity != null) {
                        ...
                        case STATO_ARK_CARTELLA:
                            ...
                            StatoArchiviazioneCartellaRisposta statoArk = XmlUtils.unmarshallResponse(um, responseIS,
                        ...
                        case ELIMINA_CARTELLA_ARK:
                            ...
                            EliminaCartellaArchiviataRisposta elimArk = XmlUtils.unmarshallResponse(um, responseIS,
                        ...
                        case RETRIEVE_FILE_UNITA_DOC:
                            ...
                            RetrieveFileUnitaDocRisposta retFileUniDoc = XmlUtils.unmarshallResponse(um, responseIS,
                        ...
                        esitoConnessione.setXmlResponse(new String(entityBA, Charset.forName("UTF-8")));
                        esitoConnessione.setErroreConnessione(false);
                    }
                }
            }
