...
public class ElencoSignatureSessionEjb implements SignatureSessionEjb {
    ...
    private static Logger logger = LoggerFactory
            .getLogger(ElencoSignatureSessionEjb.class.getName());
    ...
    public boolean isFileEquals(long idFile, byte[] fileSbustato) {
        ...
        if (fileSbustato != null) {
            ...
            ElvElencoVer elenco = genericHelper.findById(ElvElencoVer.class, idFile);
            // EVO#16486
            ...
            if (elencoIndice.get(0).getCdEncodingHashFile() != null
                    && elencoIndice.get(0).getCdEncodingHashFile()
                            .equals(TipiEncBinari.BASE64.descrivi())
                    && elencoIndice.get(0).getDsAlgoHashFile() != null && elencoIndice.get(0)
                            .getDsAlgoHashFile().equals(TipiHash.SHA_256.descrivi())) {
