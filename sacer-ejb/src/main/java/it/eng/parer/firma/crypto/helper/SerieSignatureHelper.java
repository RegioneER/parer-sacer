...
public class SerieSignatureHelper extends SigningHelper {
    ...
    public List<HsmSessioneFirma> getBlockedSessionsByUser(long userId) {
        ...
        Query query = getEntityManager().createQuery(
                "SELECT e.hsmSessioneFirma.idSessioneFirma, MAX(e.tsEsito) AS TsLastOperation "
                        ...
                        + "AND se.tiSessioneFirma = :type "
                        + "GROUP BY e.hsmSessioneFirma.idSessioneFirma");
    ...
    /**
     * Returns the {@link HsmVerSerieSessioneFirma} of {@code session} whose <code>Elenco</code> id
     * is {@code idElenco}
     *
    ...
    public HsmVerSerieSessioneFirma findSerieSessione(long sessionId, long idElenco) {
        ...
        Query query = getEntityManager()
                .createQuery("SELECT e " + "FROM HsmVerSerieSessioneFirma e "
