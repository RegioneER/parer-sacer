...
public interface SignatureSessionEjb {
    ...
    /**
     * Returns {@literal true} if {@code fileSbustato} is the same as the original one, otherwise
     * {@literal false}
     *
     * @param idFile       id file
     * @param fileSbustato file sbustato in byte
     *
     * @return true/false
     */
     ...
     *
     * @param sessionId   id of the current signature session
     * @param idFile      id file
     * @param signedFile  file firmato in byte
     * @param signingDate data firma
     ...
     * Stores the signature file
     *
     * @param session     current signature session
     * @param idFile      id file
     * @param signedFile  firmato in byte
     * @param signingDate data firma
     * @param tipoFirma   tipo firma (XADES o CADES)
     *
     * @throws Exception errore generico
     ...
     * @param codError if {@literal null} it will be set with
    ...
    /**
     * Returns {@literal true} if the user has any active sessionsReturns, otherwise
     * {@literal false}
     *
    ...
    /**
     * Returns {@literal true} if the user has any blocked sessionsReturns, otherwise
     * {@literal false}
     *
     * @param user entity IamUser
     *
