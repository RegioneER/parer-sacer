...
public class GestSessRecupero {
    ...
    public GestSessRecupero(RispostaWSRecupero risp) {
        ...
        if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
            try {
                ...
                rispostaWs.setSeverity(IRispostaWS.SeverityEnum.ERROR);
                rispostaWs.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666,
                        "GestSessRecupero Errore nel recupero dell'EJB dei controlli TPI  " + ex.getMessage());
        ...
        if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
            try {
                controlliRecTpi = (ControlliRecTpi) new InitialContext().lookup("java:module/ControlliRecTpi");
            } catch (NamingException ex) {
                rispostaWs.setSeverity(IRispostaWS.SeverityEnum.ERROR);
                rispostaWs.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666,
                        "GestSessRecupero Errore nel recupero dell'EJB dei controlli recupero TPI  " + ex.getMessage());
        ...
        if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
            try {
                ...
                rispostaWs.setSeverity(IRispostaWS.SeverityEnum.ERROR);
                rispostaWs.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666,
                        "GestSessRecupero Errore nel recupero dell'EJB ControlliRecupero  " + ex.getMessage());
    ...
    public void caricaParametri(RecuperoExt recupero) {
        ...
        rispostaControlli = controlliSemantici.caricaDefaultDaDBParametriApplic(CostantiDB.TipoParametroAppl.TPI);
        ...
        if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
            ...
            String dataFine = tpiDefaults.get(CostantiDB.ParametroAppl.TPI_DATA_FINE_USO_BLOB);
            try {
                ...
                setRispostaWsError();
                rispostaWs.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666,
                        "GestSessRecupero.caricaParametri - TPI_DATA_FINE_USO_BLOB: " + e.getMessage());
        ...
        if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK
            ...
            if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
                ...
                if (rispostaControlli.isrBoolean()) {
                    ...
                    recupero.setSubPathUnitaDocArk(MessaggiWSFormat.formattaSubPathUnitaDocArk(tmpChiave));
                    recupero.getParametriRecupero().setDescUnitaDoc(recupero.getSubPathUnitaDocArk());
                } else {
                    setRispostaWsError();
                    rispostaWs.setEsitoWsError(rispostaControlli.getCodErr(), rispostaControlli.getDsErr());
                }
            ...
            if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
                ...
                if (rispostaControlli.isrBoolean()) {
                    ...
                    recupero.setSubPathVersatoreArk(MessaggiWSFormat.formattaSubPathVersatoreArk(tmpVersatore));
                } else {
                    setRispostaWsError();
                    rispostaWs.setEsitoWsError(rispostaControlli.getCodErr(), rispostaControlli.getDsErr());
                }
            ...
            if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
                recupero.setFileLogRetrieve(MessaggiWSFormat.formattaFileLogRetrieve(tmpVersatore, tmpChiave));
            }
        }
    }
    ...
    public void verificaDate(RecuperoExt recupero) {
        ...
        if (rispostaControlli.isrBoolean()) {
            recupero.getDatiSessioneRecupero().setDateDocumenti((Collection<Date>) rispostaControlli.getrObject());
        } else if (rispostaControlli.getCodErr() != null) {
            setRispostaWsError();
            rispostaWs.setEsitoWsError(rispostaControlli.getCodErr(), rispostaControlli.getDsErr());
        }
    ...
    public void verificaPrenotaRecAsync(RecuperoExt recupero) {
        ...
        /*
         * se rende OK -> recupera da filesystem se rende WARNING -> prenotazione effettuata o recupero in corso, non
         * recupera nulla se rende ERROR -> recupero e prenotazione impossibili
         */

        if (rispostaControlli.isrBoolean()) {
            if (rispostaControlli.getCodErr() != null) {
                setRispostaWsWarning();
                rispostaWs.setEsitoWsWarning(rispostaControlli.getCodErr(), rispostaControlli.getDsErr());
            }
        } else if (rispostaControlli.getCodErr() != null) {
            setRispostaWsError();
            rispostaWs.setEsitoWsError(rispostaControlli.getCodErr(), rispostaControlli.getDsErr());
