...
public class RecuperoFascSync {
    ...
    public void initRispostaWs(RispostaWSRecuperoFasc rispostaWsFasc, AvanzamentoWs avanzamento,
        ...
        recFasc.getParametriRecuperoFasc().setTipoRichiedente(JobConstants.TipoSessioniRecupEnum.SERVIZIO);
    ...
    public void verificaVersione(String versione, RispostaWSRecuperoFasc rispostaWsFasc, RecuperoFascExt recFasc) {
        ...
        tmpRispostaControlli = myControlliWs.checkVersione(versione, recFasc.getDescrizione().getNomeWs(),
                recFasc.getWsVersions(), TipiWSPerControlli.VERSAMENTO_RECUPERO_FASC);
        if (!tmpRispostaControlli.isrBoolean()) {
            rispostaWsFasc.setSeverity(SeverityEnum.ERROR);
            rispostaWsFasc.setEsitoWsError(tmpRispostaControlli.getCodErr(), tmpRispostaControlli.getDsErr());
    ...
    public void parseXML(String datiXml, RispostaWSRecuperoFasc rispostaWsFasc, RecuperoFascExt recFasc) {
        StatoConservazioneFasc myEsito = rispostaWsFasc.getIstanzaEsito();
        AvanzamentoWs tmpAvanzamentoWs = rispostaWsFasc.getAvanzamento();

        if (recFasc.getParametriRecuperoFasc().getUtente() == null) {
            rispostaWsFasc.setSeverity(SeverityEnum.ERROR);
            rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666, "Errore: l'utente non è autenticato.");
            return;
        }
    ...
    public void recuperaStatoConservazioneFASC(RispostaWSRecuperoFasc rispostaWsFasc, RecuperoFascExt recFasc) {
        StatoConservazioneFasc myEsito = rispostaWsFasc.getIstanzaEsito();
        AvanzamentoWs tmpAvanzamentoWs = rispostaWsFasc.getAvanzamento();
    ...
    public void recuperaOggettoFasc(RispostaWSRecuperoFasc rispostaWsFasc, RecuperoFascExt recuperoFasc, String path) {
        StatoConservazioneFasc myEsito = rispostaWsFasc.getIstanzaEsito();
        AvanzamentoWs tmpAvanzamentoWs = rispostaWsFasc.getAvanzamento();
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            if (recuperoFasc.getParametriRecuperoFasc()
                ...
                RispostaControlli rc = controlliRecuperoFasc
                        .contaXMLIndiceAIPFasc(recuperoFasc.getParametriRecuperoFasc().getIdFascicolo());
                if (rc.getrLong() == 0) {
