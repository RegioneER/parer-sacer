...
/**
 *
 * @author Fioravanti_F Nota bene: la cache dei cointesti XML usata dai servizi relativi ai
 *         Fascicoli è implementata dal file XmlFascCache
 */
@Singleton
@LocalBean
@Startup
public class XmlContextCache {
	...
	try {
	    ...
	    tpiStatoArkCartellaCtx = JAXBContext
		    .newInstance(StatoArchiviazioneCartellaRisposta.class);
	    tpiEliminaCartellaArkCtx = JAXBContext
		    .newInstance(EliminaCartellaArchiviataRisposta.class);
	    tpiRegistraCartellaRiArkCtx = JAXBContext
		    .newInstance(RegistraCartellaRiArkRisposta.class);
	    tpiRetrieveFileUnitaDocCtx = JAXBContext
		    .newInstance(RetrieveFileUnitaDocRisposta.class);
	...
	try {
	    ...
	    versRespStatoCtx_IndiceProveCons = JAXBContext
		    .newInstance(IndiceProveConservazione.class);
	    ...
	    creazioneElencoVersamentoCtx_Elencoversamento = JAXBContext
		    .newInstance(Elencoversamento.class);
	    creazioneIndiceVolumeSerieCtx_IndiceVolumeSerie = JAXBContext
		    .newInstance(IndiceVolumeSerie.class);
	    ...
	    selfDescMoreInfoCtx = JAXBContext.newInstance(
		    MetadatiIntegratiSelfDescriptionType.class,
		    it.eng.parer.aipFascicoli.xml.usselfdescResp.ObjectFactory.class);
	    creaIndiceAipFascicoloCtx = JAXBContext.newInstance(
		    it.eng.parer.aipFascicoli.xml.usmainResp.IdCType.class,
	    ...
	    selfDescMoreInfoCtxV2 = JAXBContext.newInstance(
		    MetadatiIntegratiSelfDescriptionType.class,
	    ...
	    versRespStatoFascCtx_StatoConservazioneFasc = JAXBContext
		    .newInstance(StatoConservazioneFasc.class);
	    // end EVO#13993
	    ...
	    // EVO#13993
	    versReqStatoFascSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.VERS_REQ_STATO_FASC_XSD));
	    // end EVO#13993
	    versReqStatoMMSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.VERS_REQ_STATO_MM_XSD));
	    ...
	    versRespUniSincroSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.UNISINCRO_2_XSD));
	    // EVO#20972
	    versRespUniSincroSchemaV2 = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.UNISINCRO_2_XSD_V2));
	    // end EVO#20972

	    aipFascProfSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.AIP_FASC_PROF_XSD));
	    aipFascSelfDescSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.AIP_FASC_SELF_DESC_XSD));
	    aipFascUniSincroSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.AIP_FASC_UNISINCRO_2_XSD));

	    // MEV#26576
	    aipFascProfSchemaV2 = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.AIP_FASC_PROF_XSD_V2));
