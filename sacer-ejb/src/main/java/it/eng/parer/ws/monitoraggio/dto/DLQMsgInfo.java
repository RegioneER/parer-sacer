...
public class DLQMsgInfo {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(deliveryCount, fromApplication, messageID, payloadType, sentTimestamp,
                state);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return deliveryCount == other.deliveryCount
                && Objects.equals(fromApplication, other.fromApplication)
                && Objects.equals(messageID, other.messageID)
                && Objects.equals(payloadType, other.payloadType)
                && Objects.equals(sentTimestamp, other.sentTimestamp)
