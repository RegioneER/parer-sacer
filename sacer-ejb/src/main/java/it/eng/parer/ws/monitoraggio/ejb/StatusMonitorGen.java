...
public class StatusMonitorGen {
    ...
    public void calcolaStatus(RispostaWSStatusMonitor rispostaWs, StatusMonExt mon) {
        ...
        if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
            ...
            // presenza di almeno una data di versamento con stato = ARCHIVIATA e con il numero di file definito
            ...
            // presenza di almeno una data antecedente a quella corrente, con stato = REGISTRATA o DA_ARCHIVIARE
