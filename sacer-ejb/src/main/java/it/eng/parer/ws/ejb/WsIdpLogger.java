...
public class WsIdpLogger {
    ...
    public void scriviLog(LogDto logDto) {
        ...
        if (iamDefaults.get(CostantiDB.ParametroAppl.IDP_QRY_REGISTRA_EVENTO_UTENTE) != null
                && !iamDefaults.get(CostantiDB.ParametroAppl.IDP_QRY_REGISTRA_EVENTO_UTENTE).isEmpty()
                && iamDefaults.get(CostantiDB.ParametroAppl.IDP_QRY_VERIFICA_DISATTIVAZIONE_UTENTE) != null
                && !iamDefaults.get(CostantiDB.ParametroAppl.IDP_QRY_VERIFICA_DISATTIVAZIONE_UTENTE).isEmpty()
