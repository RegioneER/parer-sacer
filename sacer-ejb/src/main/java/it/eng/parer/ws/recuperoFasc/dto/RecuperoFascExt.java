 ...
 * @author DiLorenzo_F
 */
public class RecuperoFascExt implements IRecuperoFascExt {

    private static final long serialVersionUID = 5261426459498072293L;
    private String datiXml;
    private RecuperoFascicolo strutturaRecuperoFasc;
    private ParametriRecuperoFasc parametriRecuperoFasc;
    private ParametriFascParser parametriFascParser;
