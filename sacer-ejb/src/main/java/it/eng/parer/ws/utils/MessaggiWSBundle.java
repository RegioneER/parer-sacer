 ...
 */
// Last update: 2017-12-05 18:35:10.148111
...
public class MessaggiWSBundle {
    ...
    private static MessaggiWSCache lookupCacheRef() {
        try {
            return (MessaggiWSCache) new InitialContext().lookup("java:app/Parer-ejb/MessaggiWSCache");
    ...
    /**
     * L''ambiente {0} non è valorizzato o è valorizzato con un valore non definito
     */
    ...
    /**
     * L''utente {0} non è autorizzato alla funzione {0}
     */
    ...
    /**
     * Fascicolo {0}: il tipo {0} non è presente entro la struttura versante o è disattivo
     */
    public static final String FASC_002_001 = "FASC-002-001";

    /**
     * Fascicolo {0}:il numero di unità documentarie indicato nel contenuto sintetico {0} non coincide con il numero di
    ...
    /**
     * Fascicolo {0}:almeno una unità documentaria indicata nel contenuto analitico non è presente in Sacer.
     */
    ...
    /**
     * Nel SIP di Versamento del Fascicolo non è stato indicato l''indice di classificazione
     */
    ...
    /**
     * Fascicolo {0}:il codice indicato non rispetta i requisiti di formato: {0}
     */
    ...
    /**
     * Fascicolo {0}: il tipo fascicolo {0} non ha associato un xsd di profilo archivistico standard nel periodo di
     * validità vigente nell''anno del fascicolo.
     */
    public static final String FAS_PF_ARCH_001_001 = "FAS_PF_ARCH-001-001";

    /**
     * La versione {0} dell''xsd di profilo archivistico del fascicolo non è presente o è disattiva
     */
    public static final String FAS_PF_ARCH_001_002 = "FAS_PF_ARCH-001-002";

    /**
     * Fascicolo {0}: il tipo fascicolo {0} non ha associato un xsd di profilo archivistico nel periodo di validità
     * vigente nell''anno del fascicolo.
     */
    public static final String FAS_PF_ARCH_001_003 = "FAS_PF_ARCH-001-003";

    /**
     * Fascicolo {0}: il tipo fascicolo {0} ha associato un xsd di profilo archivistico e non è stato dichiarato
     * nell''XML di Versamento
     */
    public static final String FAS_PF_ARCH_001_004 = "FAS_PF_ARCH-001-004";

    /**
     * Fascicolo {0}: Errore nella verifica dei dati di profilo archivistico del fascicolo. {0}
     */
    ...
    /**
     * Fascicolo {0}: il tipo fascicolo {0} non ha associato un xsd di profilo fascicolo standard nel periodo di
     * validità vigente nell''anno del fascicolo.
     */
    public static final String FAS_PF_GEN_001_001 = "FAS_PF_GEN-001-001";

    /**
     * La versione {0} dell''xsd di profilo generale del fascicolo non è presente o è disattiva
     */
    public static final String FAS_PF_GEN_001_002 = "FAS_PF_GEN-001-002";

    /**
     * Fascicolo {0}: Errore nella verifica dei dati di profilo generale del fascicolo. {0}
     */
    public static final String FAS_PF_GEN_002_001 = "FAS_PF_GEN-002-001";

    /**
     * Fascicolo {0}: Errore nella verifica dei dati di profilo generale del fascicolo. Il valore indicato nel tag {0}
     * supera la lunghezza massima prevista
     */
    public static final String FAS_PF_GEN_002_002 = "FAS_PF_GEN-002-002";
    ...
    /**
     * Fascicolo {0}: l''unità documentaria {0} indicata come PrimoDocumentoNelFascicolo non è presente nel contenuto
     * analitico del fascicolo
     */
    public static final String FAS_PF_GEN_003_003 = "FAS_PF_GEN-003-003";

    /**
     * Fascicolo {0}: l''unità documentaria {0} indicata come UltimoDocumentoNelFascicolo non è presente nel contenuto
     * analitico del fascicolo
     */
    ...
    /**
     * La Struttura {0} è stata cessata
     */
    public static final String UD_001_020 = "UD-001-020";
    ...
    /**
     * Il tipo documento {0} non è presente nell''Unità Documentaria {1}
     */
    public static final String DOC_001_004 = "DOC-001-004";
    ...
    /**
     * Se si valorizza il tipo documento non \u00e8 possibile valorizzare ID documento
     */
    public static final String DOC_011_001 = "DOC-011-001";
    ...
    /**
     * Componente {0}: Report Verifica Firma non presente per il componente selezionato
     */
    public static final String COMP_006_003 = "COMP-006-003";
    ...
    /**
     * Componente {0}: l''algoritmo usato per indicare l''hash non è supportato (sono gestiti MD5, SHA-1 e SHA256,
    ...
    /**
     * I versamenti da annullare specificati nella richiesta devono avere stesso Tipo Versamento
     */
    public static final String RICH_ANN_VERS_017 = "RICH-ANN-VERS-017";
     ...
     */
    public static final String RICH_ANN_VERS_020 = "RICH-ANN-VERS-020";

    /**
     * Per almeno una unità documentaria definita nella richiesta è necessario specificare il Tipo Registro
     */
    public static final String RICH_ANN_VERS_021 = "RICH-ANN-VERS-021";

    /**
     * Nessun fascicolo definito nella richiesta è annullabile
     */
    public static final String RICH_ANN_VERS_022 = "RICH-ANN-VERS-022";

    /**
     * Alcuni fascicoli definiti nella richiesta non sono annullabili
     */
