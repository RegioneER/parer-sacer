...
public class MessaggiWSBundle {
    ...
    /**
     * Fascicolo {0}:il numero di unità documentarie indicato nel contenuto sintetico {0} non
    ...
    /**
     * Fascicolo {0}:almeno una unità documentaria indicata nel contenuto analitico non è presente
     * in Sacer.
     */
    ...
    /**
     * Si è verificata un''eccezione nel salvataggio del modello XSD del tipo fascicolo. Il testo
     * inserito nel campo Descrizione xsd supera il limite di 254 caratteri.
     */
    public static final String FASC_008_001 = "FASC-008-001";

    /**
     * Fascicolo {0}: il tipo fascicolo {0} non ha associato un xsd di profilo archivistico standard
    ...
    /**
     * Fascicolo {0}: il tipo fascicolo {0} non ha associato un xsd di profilo archivistico nel
     * periodo di validità vigente nell''anno del fascicolo.
     */
    public static final String FAS_PF_ARCH_001_003 = "FAS_PF_ARCH-001-003";

    /**
     * Fascicolo {0}: il tipo fascicolo {0} ha associato un xsd di profilo archivistico e non è
    ...
    /**
     * Fascicolo {0}: il tipo fascicolo {0} non ha associato un xsd di profilo fascicolo standard
     * nel periodo di validità vigente nell''anno del fascicolo.
     */
    ...
    /**
     * Fascicolo {0}: Errore nella verifica dei dati di profilo generale del fascicolo. Il valore
     * indicato nel tag {0} supera la lunghezza massima prevista
     */
    ...
    /**
     * Fascicolo {0}: l''unità documentaria {0} indicata come PrimoDocumentoNelFascicolo non è
     * presente nel contenuto analitico del fascicolo
     */
    public static final String FAS_PF_GEN_003_003 = "FAS_PF_GEN-003-003";

    /**
     * Fascicolo {0}: l''unità documentaria {0} indicata come UltimoDocumentoNelFascicolo non è
     * presente nel contenuto analitico del fascicolo
     */
     ...
     * SHA-1 e SHA256, codificati in Hex e Base64)
     */
