...
public class ControlliTpi {
	...
	try {
	    rispostaControlli.setrString(configurationHelper
		    .getValoreParamApplicByApplic(CostantiDB.ParametroAppl.TPI_ROOT_SACER));
	...
	boolean isTpiEnable = Boolean.parseBoolean(configurationHelper
		.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.TPI_ENABLE));
