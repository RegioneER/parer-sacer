...
public class CancellaUtenteHelper {
    ...
    public void deleteIamUser(CancellaUtenteExt cuExt, RispostaWSCancellaUtente rispostaWs) throws ParerInternalError {
        try {
            /*
             * Verifica se l'utente è referenziato nelle sessioni o nelle unità documentarie o nei volumi o nei log
             * delle operazioni sui volumi
             */
    ...
    public boolean isReferenced(Integer idUserIam) {
        String queryStr = "SELECT u FROM IamUser u " + "WHERE u.idUserIam = :idUserIam "
                ...
                + "           WHERE elog.iamUser.idUserIam = :idUserIam ) " + "OR EXISTS (SELECT l FROM LogOper l "
