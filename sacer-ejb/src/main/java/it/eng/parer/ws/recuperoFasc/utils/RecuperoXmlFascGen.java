...
public class RecuperoXmlFascGen {
    ...
    public void generaStatoConservazioneFasc(RecuperoFascExt recuperoFasc) {
        ...
        if (rispostaWsFasc.getSeverity() == IRispostaWS.SeverityEnum.OK) {
            rispostaControlli = controlliRecuperoFasc
                    .leggiVersatoreFascicolo(recuperoFasc.getParametriRecuperoFasc().getIdFascicolo());
            if (rispostaControlli.isrBoolean()) {
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            ...
            //
            if (parsedFasc.getVersatore().getUtente() != null && !parsedFasc.getVersatore().getUtente().isEmpty()) {
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            String tmpUrnFasc = MessaggiWSFormat.formattaUrnDocUniDoc(
            ...
            if (rispostaControlli.isrBoolean() == false) {
                ...
                myEsito.getFascicolo().setStatoConservazioneFASC(StatoConservazioneFascType
                        .valueOf((((FasFascicolo) rispostaControlli.getrObject()).getTiStatoConservazione().name())));
            }
        }
    }
