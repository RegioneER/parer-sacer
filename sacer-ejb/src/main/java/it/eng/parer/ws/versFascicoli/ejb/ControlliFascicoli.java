...
public class ControlliFascicoli {
    ...
    public RispostaControlli getDecLvlVoceTitolWithNiLivello(long niLivello, long idStrutt, Date dtApertura) {
        ...
        if (rispostaControlli.getrLong() != -1) {
            ...
            return getDecLvlVoceTitolWithNiLivello(niLivello, idStrutt, dtApertura, decTitol.getIdTitol());
        } else {
    ...
    public RispostaControlli checkCdVoceDecVoceTitol(String cdVoceTitol, String cdCompositoVoceTitol, long idStrutt,
            Date dtApertura) {
        ...
        try {
            ...
            if (rispostaControlli.getrLong() != -1) {
                ...
                query.setParameter("cdVoceTitol", StringEscapeUtils.escapeJava(cdVoceTitol.toUpperCase().trim()));// ripulisco
                                                                                                                  // dagli
                                                                                                                  // spazi
