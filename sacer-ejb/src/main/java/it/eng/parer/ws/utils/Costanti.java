...
public class Costanti {
    ...
    //
    public static final String[] WS_REC_PROVE_CON_IDX_UD_COMP = {
            "1.0" }; // non esiste più
    public static final String[] WS_INSERIMENTO_UTENTE_COMP = {
            "1.0" }; // inutile, da togliere
    ...
    public static final String WS_REC_PROVE_CON_IDX_UD_NOME = "RecProveConservIdxUdSync"; // non
    // esiste
    // più
    ...
    // end EVO#13993
    //
    public static final String WS_INSERIMENTO_UTENTE_NOME = "InserimentoUtente"; // inutile, da
    // togliere
    ...
    //
    // NOTA: i servizi Multimedia hanno nome diverso, ma versioni identiche agli omologhi servizi
    // sincroni
    ...
    public class UrnFormatter {
        ...
        public static final String URN_UPD_FMT_STRING = "{0}:{1}:{2}"; // VERS_FMT_STRING +
        // UD_FMT_STRING
        public static final String URN_UPD_FMT_STRING_V2 = "{0}:{1}:UPD{2}"; // VERS_FMT_STRING +
        // UD_FMT_STRING
        public static final String URN_UPD_FMT_STRING_V3 = "{0}:{1}:AGG_MD{2}"; // VERS_FMT_STRING +
        // UD_FMT_STRING
        ...
        // urn:<sistemaconservazione>:<ente>:<struttura>:ElencoVers-UD-<dataCreazione>-<id
        // elenco>:Indice
        ...
        // urn:<sistemaconservazione>:<ente>:<struttura>:ElencoIndiciAIP-UD-<dataCreazione>-<id
        // elenco>
        ...
        // urn:<sistemaconservazione>:<ente>:<struttura>:<registro>-<anno>-<numero>:UPD<progressivo
        // aggiornamento>
        public static final String URN_UPD_UD_FMT_STRING_V2 = "urn:{0}:{1}:{2}:{3}-{4}-{5}:UPD{6}";
        // urn:<sistemaconservazione>:<ente>:<struttura>:<registro>-<anno>-<numero>:AGG_MD<progressivo
        // aggiornamento>
        ...
        public static final String URN_FASC_FMT_STRING = "{0}:{1}"; // VERS_FMT_STRING +
        // FASC_FMT_STRING
        ...
        // urn:<sistemaconservazione>:<ente>:<struttura>:ElencoVers-FA-<data creazione>-<id
        // elenco>:Indice
        ...
        // urn:<sistemaconservazione>:<ente>:<struttura>:ElencoIndiciAIP-FA-<dataCreazione>-<id
        // elenco>:Indice
        public static final String URN_ELENCO_AIP_FASC_FIRMATI_FMT_STRING_V2 = "urn:{0}:ElencoIndiciAIP-FA-{1}-{2}:Indice";

        // urn:<sistemaconservazione>:<ente>:<struttura>:ElencoIndiciAIP-FA-<id
        // elenco>:IndiceNonFirmato
        ...
        // MAC#25915
        public static final String SPATH_AGG_MD_REGEXP = "(" + URN_UPD_PREFIX
                + "([0-9]){5}[:[A-Za-z]+]*)$";
        // end MAC#25915
    ...
    public enum ModificatoriWS {
        ...
        //
        TAG_REC_USR_DOC_COMP, // tag di recupero, abilita i tag opzionali di Utente, IdDocumento,
        // NumOrdComponente e
        // TipoDocumento
        //
