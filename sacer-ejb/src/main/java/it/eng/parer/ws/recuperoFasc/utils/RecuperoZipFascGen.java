...
public class RecuperoZipFascGen {
    ...
    public void generaZipOggettoFasc(String outputPath, RecuperoFascExt recuperoFasc)
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            ...
            try (FileOutputStream tmpOutputStream = new FileOutputStream(
                    zipDaScaricare.getFileSuDisco());
                ...
                if (zipDaScaricare.getFileSuDisco() != null) {
    ...
    private void aggiungiFileXmlSchemaFasc(ZipArchiveOutputStream zipOutputStream, long idFascicolo)
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            if (lstXmlVersFascicolo != null && !lstXmlVersFascicolo.isEmpty()) {
                ...
                // MEV#29726
                String codiceVersioneXmlVersamento = xmlVersFascicolo.getCdVersioneXml();

                FileXSD xsdPIndexFileSource = ("2.0".equals(codiceVersioneXmlVersamento)
                        || "3.0".equals(codiceVersioneXmlVersamento))
                                ? FileXSD.AIP_FASC_UNISINCRO_2_XSD_V2
                                : FileXSD.AIP_FASC_UNISINCRO_2_XSD;
                FileXSD xsdMoreInfoSelfDescSource = ("2.0".equals(codiceVersioneXmlVersamento)
                        || "3.0".equals(codiceVersioneXmlVersamento))
                                ? FileXSD.AIP_FASC_SELF_DESC_XSD_V2
                                : FileXSD.AIP_FASC_SELF_DESC_XSD;
                // end MEV#29726

                FileXSD xsdMoreInfoPVolumeSource = ("2.0".equals(codiceVersioneXmlVersamento)
                        || "3.0".equals(codiceVersioneXmlVersamento)) ? FileXSD.AIP_FASC_PROF_XSD_V2
                                : FileXSD.AIP_FASC_PROF_XSD;
                ...
                if ("2.0".equals(codiceVersioneXmlVersamento)
                        || "3.0".equals(codiceVersioneXmlVersamento)) {
