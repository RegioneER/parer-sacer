...
public class ControlliRecuperoFasc {
    ...
    public RispostaControlli leggiContVerAipUdInFASCAIPV2(long idFascicolo) {
        ...
        try {
            ...
            log.error("Eccezione nella lettura della tabella delle versioni indici aip in FASC ", e);
        }
        return rispostaControlli;
    }
    ...
    private String generaNomeFileAIPFasc(FasFascicolo ff) {
        ...
        String tmpUrn = MessaggiWSFormat.formattaUrnAipFascicolo(MessaggiWSFormat.formattaBaseUrnFascicolo(
                MessaggiWSFormat.formattaUrnPartVersatore(versatore, true, Costanti.UrnFormatter.VERS_FMT_STRING),
                MessaggiWSFormat.formattaUrnPartFasc(chiave, true, Costanti.UrnFormatter.FASC_FMT_STRING)));
    ...
    public RispostaControlli leggiVersatoreFascicolo(long idFascicolo) {
        ...
        try {
            ...
            versatore.setAmbiente(tmpFasc.getOrgStrut().getOrgEnte().getOrgAmbiente().getNmAmbiente());
    ...
    public RispostaControlli leggiXMLSessioneversFasc(long idFascicolo) {
        ...
        try {
            String queryStr = "select xml from FasXmlVersFascicolo xml "
                    + "where xml.fasFascicolo.idFascicolo  = :idFascicolo " + "order by xml.dtVersFascicolo ";
    ...
    public RispostaControlli leggiXMLProfiloFascList(long idFascicolo) {
        ...
        try {
            String queryStr = "select xml from FasXmlFascicolo xml " + "join fetch xml.decModelloXsdFascicolo fasc "
                    + "where xml.fasFascicolo.idFascicolo  = :idFascicolo " + "order by xml.dtVersFascicolo ";
    ...
    public RispostaControlli contaXMLIndiceAIPFasc(long idFascicolo) {
        ...
        try {
            ...
            log.error("Eccezione nella lettura della tabella dei file di versione indice AIP fascicolo ", e);
        }
        return rispostaControlli;
    }
    ...
    public RispostaControlli leggiXMLIndiceAIPFasc(long idFascicolo) {
        ...
        try {
            String queryStr = "SELECT fas FROM FasFileMetaVerAipFasc fas "
                    + "JOIN FETCH fas.fasMetaVerAipFascicolo meta " + "JOIN FETCH meta.fasVerAipFascicolo ver "
                    + "WHERE ver.fasFascicolo.idFascicolo = :idFascicolo " + "AND meta.tiFormatoMeta = 'UNISYNCRO' "
                    + "AND meta.tiMeta = 'INDICE' " + "ORDER BY ver.pgVerAipFascicolo DESC";
    ...
    public RispostaControlli leggiElvFileElencoVersFasc(long idFascicolo, String tiFileElencoVersFasc,
            String tiFileElencoVersFasc2) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        try {
            ...
            if (!listaFileElencoVersFasc.isEmpty()) {
                ...
                if (tiFileElencoVersFasc.equals(ElencoEnums.OpTypeEnum.FIRMA_ELENCO_INDICI_AIP.name())) {
            ...
            log.error("Eccezione nella lettura della tabella dei file elenco indici AIP fascicoli ", e);
        }
        return rispostaControlli;
    }
    ...
    public void loadElvElencoVersFasc(ElvFileElencoVersFasc fileElencoVersFasc) {
        ...
        TypedQuery<ElvElencoVersFasc> query = entityManager.createQuery(
                "SELECT f FROM ElvElencoVersFasc f JOIN FETCH f.orgStrut s "
                        + "JOIN FETCH s.orgEnte e JOIN FETCH e.orgAmbiente a WHERE f.idElencoVersFasc = :" + idParam,
                ElvElencoVersFasc.class);
        query.setParameter(idParam, fileElencoVersFasc.getElvElencoVersFasc().getIdElencoVersFasc());
        fileElencoVersFasc.setElvElencoVersFasc(query.getSingleResult());
    }

    // da RecuperoFascPrsr
    public RispostaControlli checkTipoFascicoloperStrut(long idStrut, String nmTipoFasc, String descChiaveFasc) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        try {
            ...
            if (lstTipoFascs.size() == 1) {
                ...
                rispostaControlli
                        .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.DOC_001_001, descChiaveFasc, nmTipoFasc)
            ...
            rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666,
                    "Eccezione ControlliRecuperoFasc.checkTipoFascicoloperStrut " + e.getMessage()));
    ...
    // da RecuperoFascPrsr
    public RispostaControlli checkTipoFascicoloinFASC(long idFascicolo, String nmTipoFasc, String descChiaveFasc) {
        RispostaControlli rispostaControlli;
        rispostaControlli = new RispostaControlli();
        rispostaControlli.setrBoolean(false);
        ...
        try {
            String queryStr = "select t from FasFascicolo t " + "where t.idFascicolo = :idFascicoloIn "
            ...
            if (!lstFasFascicolos.isEmpty()) {
                rispostaControlli.setrLong(lstFasFascicolos.get(0).getDecTipoFascicolo().getIdTipoFascicolo());
                rispostaControlli.setrBoolean(true);
            } else {
                rispostaControlli.setCodErr(MessaggiWSBundle.DOC_001_004);
                rispostaControlli
                        .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.DOC_001_004, nmTipoFasc, descChiaveFasc));
            }
        } catch (Exception e) {
            rispostaControlli.setrBoolean(false);
            rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
    ...
    public RispostaControlli leggiXMLMetadatiFasc(long idFascicolo) {
        ...
        try {
            String queryStr = "SELECT fas FROM FasFileMetaVerAipFasc fas "
                    + "JOIN FETCH fas.fasMetaVerAipFascicolo meta " + "JOIN FETCH meta.fasVerAipFascicolo ver "
                    + "WHERE ver.fasFascicolo.idFascicolo = :idFascicolo " + "AND meta.tiMeta = 'FASCICOLO' "
            ...
            log.error("Eccezione nella lettura della tabella dei file di versione metadati fascicolo ", e);
        }
        return rispostaControlli;
    }
