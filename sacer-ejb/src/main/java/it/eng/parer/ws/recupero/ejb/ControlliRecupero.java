...
public class ControlliRecupero {
    ...
    public RispostaControlli leggiCompFileInUD(long idUnitaDoc, boolean estraiFileIndiceAip) {
        ...
        try {
            ...
            for (AroCompDoc tmpCmp : lstComponenti) {
                ...
                // file sbustati
                determinaFormatoComponenteSbustato(tmpCRec, tmpCmp);
    ...
    private void determinaFormatoComponenteSbustato(ComponenteRec tmpCRec, AroCompDoc tmpCmp) {
        // MEV#39147 - Modifica delle modalità di calcolo dell'estensione nel recupero di
        // file sbustati
        ...
        // Determina se il componente è un file firmato oppure no
        boolean componenteFirmato = tmpCmp.getFlCompFirmato() != null
                && tmpCmp.getFlCompFirmato().equals("1");
        ...
        String nmFormatoCalcolato = formatoCalcolato != null
                ...
                : null;
        String nmFormatoVersato = formatoVersato != null ? formatoVersato.getNmFormatoFileDoc()
                : null;
