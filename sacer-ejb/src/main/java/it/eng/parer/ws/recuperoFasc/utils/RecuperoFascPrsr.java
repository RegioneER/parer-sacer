    ...
    public void parseXML(String datiXml, RecuperoFascExt recuperoFasc) {
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            ...
            try {
                ...
                Unmarshaller unmarshaller = xmlContextCache.getVersReqStatoFascCtx_RecuperoFasc().createUnmarshaller();
                ...
                rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.XSD_001_001, event.getMessage());
            } catch (Exception e) {
                ValidationEvent event = validationHandler.getFirstErrorValidationEvent();
                rispostaWsFasc.setSeverity(SeverityEnum.ERROR);
                rispostaWsFasc.setErrorCode("-1");
                ...
                rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.XSD_001_002, event.getMessage());
            }
        }
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            if (!parsedFasc.getVersione().equals(recuperoFasc.getVersioneWsChiamata())) {
                rispostaWsFasc.setSeverity(SeverityEnum.ERROR);
                rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.UD_001_013, parsedFasc.getVersione());
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            if (!parsedFasc.getVersatore().getUserID().equals(recuperoFasc.getLoginName())) {
                rispostaWsFasc.setSeverity(SeverityEnum.ERROR);
                rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.UD_001_005, parsedFasc.getVersatore().getUserID());
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            try {
                ...
                rispostaWsFasc.setSeverity(SeverityEnum.ERROR);
                rispostaWsFasc.setEsitoWsErrBundle(MessaggiWSBundle.ERR_666,
                        "Errore nel recupero dell'EJB dei Controlli Recupero Fasc " + ex.getMessage());
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK
                ...
                && parsedFasc.getVersatore().getUtente() != null && !parsedFasc.getVersatore().getUtente().isEmpty()) {
            ...
            if (rispostaControlli.isrBoolean()) {
                ...
                recuperoFasc.getParametriRecuperoFasc().setUtente((User) rispostaControlli.getrObject());
            } else {
                rispostaWsFasc.setSeverity(SeverityEnum.ERROR);
                rispostaWsFasc.setEsitoWsError(rispostaControlli.getCodErr(), rispostaControlli.getDsErr());
                myEsito.getEsitoChiamataWS().setCredenzialiOperatore(ECEsitoPosNegType.NEGATIVO);
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            ...
            rispostaControlli.reset();
            rispostaControlli = controlliEjb.checkAuthWS(recuperoFasc.getParametriRecuperoFasc().getUtente(),
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK) {
            ...
            if (recuperoFasc.getParametriFascParser().isLeggiAncheFascAnnullati()) {
                rispostaControlli = controlliSemantici.checkChiaveFasc(tmpCSChiaveFasc, recuperoFasc.getIdStruttura(),
            ...
            if (rispostaControlli.isrBoolean() || rispostaControlli.getrLong() == -1) {
                ...
                recuperoFasc.getParametriRecuperoFasc().setIdFascicolo(rispostaControlli.getrLong());
                // normalized cd_key_fasc
                recuperoFasc.getParametriRecuperoFasc().setNumeroFascNormalized((String) rispostaControlli.getrMap()
        ...
        if (rispostaWsFasc.getSeverity() == SeverityEnum.OK
            ...
            if (recuperoFasc.getParametriRecuperoFasc().getIdFascicolo() == null) {
                ...
                rispostaControlli = controlliRecuperoFasc.checkTipoFascicoloperStrut(recuperoFasc.getIdStruttura(),
                ...
                if (rispostaControlli.isrBoolean()) {
                    ...
                    if (rispostaControlli.isrBoolean()) {
                        ...
                        recuperoFasc.getParametriRecuperoFasc().setIdTipoFascicolo(rispostaControlli.getrLong());
                    } else {
                        setRispostaWsError();
                        myEsito.getEsitoChiamataWS().setIdentificazioneChiave(ECEsitoPosNegType.NEGATIVO);
                        rispostaWsFasc.setEsitoWsError(rispostaControlli.getCodErr(), rispostaControlli.getDsErr());
