 ...
 * tipo CLOB impiegata da un eventuale altro DBMS.
 *
...
public class RecClbOracle {
     ...
     *                             recuperare il clob
     * @param outputStream         stream su cui scrivere (può essere uno ZipOutputStream o un
     *                             semplice FileOutputStream
     * @param tabellaClobDaLeggere una delle tabelle di Sacer da cui leggere il clob
     *
