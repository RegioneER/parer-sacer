...
public class CostantiDB {
    ...
    public class ParametroAppl {
        ...
        // automa per recupero AIP durante restituzione archivio
    ...
    public enum TiPartition {
        ...
        AIP_UD, BLOB, FILE, FILE_ELENCHI_VERS, FILE_ELENCO_VERS_FASC, FILE_SER, FILE_SES,
        FILE_VOL_SER, SES, UNI_DOC, XML_SES
    }
    ...
    public enum TipoErrRichAnnulVers {
        ...
        ITEM_GIA_PRESENTE, ITEM_IN_CORSO_DI_ANNUL, ITEM_GIA_ANNULLATO, ITEM_NON_ESISTE,
        ITEM_RIFERITO, ITEM_VERSATA_IN_DATA_RICH, STATO_CONSERV_NON_AMMESSO, REGISTRO_NON_ABILITATO,
        TIPO_DOC_PRINC_NON_ABILITATO, TIPO_UNITA_DOC_NON_ABILITATO, TIPO_FASCICOLO_NON_ABILITATO,
