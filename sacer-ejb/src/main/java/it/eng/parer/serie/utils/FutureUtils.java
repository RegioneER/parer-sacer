...
public class FutureUtils {
     ...
     * @param sessionId   l'id della sessione in gestione
     * @param key         la stringa chiave per l'oggetto Future
    ...
    /**
     * Mantiene una mappa in applicationContext contenente per ogni sessionId, una mappa degli
     * oggetti Future per le serie in creazione in corso
     *
     * @param httpSession sessione Http
     * @param sessionId   l'id della sessione in gestione
    ...
    /**
     * Metodo che gestisce la costruzione della stringa chiave per l'oggetto Future che sta per
     * essere creato dal metodo asincrono chiamato, sulla base dei parametri in input
     *
     * @param serieBean  Bean contenente i parametri della chiamata asincrona
     * @param idStrut    id della struttura della serie
     * @param idVerSerie id della versione della serie su cui è stato chiamato il metodo asincrono
     *
    ...
    /**
     * Metodo che gestisce la costruzione della stringa chiave per l'oggetto Future che sta per
     * essere creato dal metodo asincrono chiamato (tiCreazione), sulla base dei parametri in input
     *
     * @param tiCreazione tipo di chiamata asincrona eseguita
     * @param cdSerie     codice della serie
     * @param aaSerie     anno della serie
     * @param idStrut     id della struttura della serie
     * @param idVerSerie  id della versione della serie su cui è stato chiamato il metodo asincrono
     *
     * @return la stringa univoca per la gestione dell'oggetto Future che verra' chiamato
    ...
    /**
     * Metodo che gestisce la decostruzione della stringa chiave per l'oggetto Future che sta per
     * essere creato dal metodo asincrono chiamato (tiCreazione), sulla base dei parametri in input
     *
     * @param key la stringa univoca per la gestione dell'oggetto Future che verra' chiamato
     *
