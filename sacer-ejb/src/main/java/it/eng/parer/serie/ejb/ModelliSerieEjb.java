...
public class ModelliSerieEjb {
    ...
    /**
     * Ritorna il tableBean la lista di modelli abilitati per l'ambiente + tutti i modelli in uso
     * per la struttura in input
     *
     ...
     */
    public DecModelloTipoSerieTableBean getDecModelloTipoSerieAllAbilitatiTableBean(
        ...
        List<DecModelloTipoSerie> allModelli = helper.retrieveDecModelloTipoSerie(
                strut.getOrgEnte().getOrgAmbiente().getIdAmbiente(), idStrut.longValue(),
                filterValid);
        List<DecModelloTipoSerie> usoModelli = helper
                .retrieveDecModelloTipoSerieFromDecUsoModello(idStrut, filterValid);
        if (!allModelli.isEmpty() || !usoModelli.isEmpty()) {
            try {
                ...
                for (DecModelloTipoSerie modello : modelli) {
                    DecModelloTipoSerieRowBean row = (DecModelloTipoSerieRowBean) Transform
                            .entity2RowBean(modello);
                    row.setString("nm_ambiente", modello.getOrgAmbiente().getNmAmbiente());
                    row.setString("nm_tipo_doc_dati_spec",
                            modello.getDecTipoDoc() != null ? modello.getDecTipoDoc().getNmTipoDoc()
                                    : null);
                    row.setString("nm_tipo_unita_doc_dati_spec",
                            modello.getDecTipoUnitaDoc() != null
                                    ? modello.getDecTipoUnitaDoc().getNmTipoUnitaDoc()
                                    : null);
                    table.add(row);
                }
                ...
                logger.error(
                        "Errore durante il recupero della lista di modelli abilitati per la struttura "
     ...
     */
    public DecModelloTipoSerieTableBean getDecModelloTipoSerieAbilitatiAmbienteTableBean(
            BigDecimal idAmbiente, boolean filterValid) {
        DecModelloTipoSerieTableBean table = new DecModelloTipoSerieTableBean();
        List<DecModelloTipoSerie> allModelli = helper
                .retrieveDecModelloTipoSerie(idAmbiente.longValue(), null, filterValid);
        if (!allModelli.isEmpty()) {
            try {
                ...
                table.sort();
                    ...
                    | InvocationTargetException ex) {
                logger.error(
                        "Errore durante il recupero della lista di modelli abilitati per l'ambiente "
                                + ExceptionUtils.getRootCauseMessage(ex),
                        ex);
            }
        }
     ...
     *
     * @param idStrut              la struttura relativa al salvataggio
     * @param idModelloTipoSerie   il modello selezionato dall'utente
     * @param tipoSerie            tipo serie scelto dall'utente
     * @param descrizioneTipoSerie descrizione tipo serie scelto dall'utente
     * @param codiceSerie          codice serie scelto dall'utente
     * @param descrizioneSerie     descrizione serie scelto dall'utente
     * @param idRegistroUnitaDoc   id registro in modifica
     * @param idTipoUnitaDoc       id tipo ud in modifica
     *
     * @throws ParerUserError errore generico
     */
    public void checkModelloTipoUdRegistroPerSerie(BigDecimal idStrut,
            BigDecimal idModelloTipoSerie, String tipoSerie, String descrizioneTipoSerie,
            String codiceSerie, String descrizioneSerie, BigDecimal idRegistroUnitaDoc,
            BigDecimal idTipoUnitaDoc) throws ParerUserError {
        DecModelloTipoSerie modello = helper.findById(DecModelloTipoSerie.class,
                idModelloTipoSerie);
        if (modello.getTiRglNmTipoSerie()
            ...
            DecTipoSerie decTipoSerie = tipoSerieHelper.getDecTipoSerieByName(tipoSerie,
                    idStrut.longValue());
            ...
            if (checkTipoUdRegNmTipoSerieDaCreare(tipoSerie, idStrut, idRegistroUnitaDoc,
                    idTipoUnitaDoc)) {
                throw new ParerUserError(
        ...
        if (modello.getTiRglCdSerie()
            ...
            if (checkTipoUdRegCdSerieDaCreare(codiceSerie, idStrut, idRegistroUnitaDoc,
                    idTipoUnitaDoc)) {
                throw new ParerUserError(
        ...
        if (modello.getTiRglDsTipoSerie()
                .equals(CostantiDB.TipoRegolaModelloTipoSerie.EREDITA_DA_TIPO_UD_REG.name())) {
    ...
    /**
     * Verifica che il nome <code>nmTipoSerieDaCreare</code> indicato non sia già stato indicato
     * come "nm_tipo_serie_da_creare" su un'altra tipologia di ud o su un registro nella struttura
     * data in input, escludendo il registro o il tipo unità documentaria in modifica
     *
     * @param nmTipoSerieDaCreare nome tipo serie da creare
     * @param idStrut             id struttura
     * @param idRegistroUnitaDoc  id registro unita doc
     * @param idTipoUnitaDoc      tipo unita doc
     *
    ...
    public boolean checkTipoUdRegNmTipoSerieDaCreare(String nmTipoSerieDaCreare, BigDecimal idStrut,
        ...
        boolean regs = registroHelper.checkRegistroUnitaDocByCampoStringa("nmTipoSerieDaCreare",
                nmTipoSerieDaCreare, idStrut, idRegistroUnitaDoc);
        boolean tipiUd = tipoUdHelper.checkTipoUnitaDocByCampoStringa("nmTipoSerieDaCreare",
                nmTipoSerieDaCreare, idStrut, idTipoUnitaDoc);
        return (regs || tipiUd);
    }

    /**
     * Verifica che il nome <code>cdSerieDaCreare</code> indicato non sia già stato indicato come
     * "cd_serie_da_creare" su un'altra tipologia di ud o su un registro nella struttura data in
     * input, escludendo il registro o il tipo unità documentaria in modifica
     *
     * @param cdSerieDaCreare    serie da creare
     * @param idStrut            id struttura
     * @param idRegistroUnitaDoc id registro unita doc
    ...
    public boolean checkTipoUdRegCdSerieDaCreare(String cdSerieDaCreare, BigDecimal idStrut,
            BigDecimal idRegistroUnitaDoc, BigDecimal idTipoUnitaDoc) {
        boolean regs = registroHelper.checkRegistroUnitaDocByCampoStringa("cdSerieDaCreare",
                cdSerieDaCreare, idStrut, idRegistroUnitaDoc);
        boolean tipiUd = tipoUdHelper.checkTipoUnitaDocByCampoStringa("cdSerieDaCreare",
                cdSerieDaCreare, idStrut, idTipoUnitaDoc);
        return (regs || tipiUd);
    }
     ...
     * @throws ParerUserError errore generico
     */
    public DecNotaModelloTipoSerieTableBean getDecNotaModelloTipoSerieTableBean(
            BigDecimal idModelloTipoSerie) throws ParerUserError {
        DecNotaModelloTipoSerieTableBean table = new DecNotaModelloTipoSerieTableBean();
        List<DecNotaModelloTipoSerie> list = helper
                .retrieveDecNotaModelloTipoSerie(idModelloTipoSerie);
        if (list != null && !list.isEmpty()) {
            try {
                for (DecNotaModelloTipoSerie nota : list) {
                    ...
                    row.setString("cd_tipo_nota_serie",
                            nota.getDecTipoNotaSerie().getCdTipoNotaSerie());
                    table.add(row);
                }
            } catch (ClassNotFoundException | NoSuchMethodException | InstantiationException
                    | IllegalAccessException | IllegalArgumentException
     ...
     * @param idTipoNotaSerie    nota serie
     *
     * @return il massimo progressivo
     */
    public BigDecimal getMaxPgNotaModelloTipoSerie(BigDecimal idModelloTipoSerie,
     ...
     * @param idModelloTipoSerie id modello tipo serie
     * @param idTipoNotaSerie    nota serie
     * @param pgNota             progressivo nota
     * @param dsNota             descrizione nota
     * @param dtNota             data nota
     *
    ...
    public BigDecimal saveNotaModelloTipoSerie(LogParam param, long idUtente,
            BigDecimal idModelloTipoSerie, BigDecimal idTipoNotaSerie, BigDecimal pgNota,
        ...
        try {
            ...
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                    ...
                    SacerLogConstants.TIPO_OGGETTO_MODELLO_TIPO_SERIE,
                    new BigDecimal(nota.getDecModelloTipoSerie().getIdModelloTipoSerie()),
                    param.getNomePagina());
        } catch (Exception e) {
     ...
     * @param idNotaModelloTipoSerie id nota tipo serie
     * @param dsNota                 descrizione nota
     * @param idUtente               id utente
     * @param dtNota                 data nota
     *
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveNotaModelloTipoSerie(LogParam param, BigDecimal idNotaModelloTipoSerie,
            String dsNota, long idUtente, Date dtNota) throws ParerUserError {
        logger.debug("Eseguo il salvataggio dell'elemento di descrizione");
        try {
            DecNotaModelloTipoSerie nota = helper.findById(DecNotaModelloTipoSerie.class,
                    idNotaModelloTipoSerie);
            nota.setDsNotaTipoSerie(dsNota);
            nota.setIamUser(helper.findById(IamUser.class, idUtente));
            nota.setDtNotaTipoSerie(dtNota);
     ...
     * @param idNotaModelloTipoSerie id nota modello serie
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteNotaModelloTipoSerie(LogParam param, BigDecimal idNotaModelloTipoSerie)
     ...
     * @throws ParerUserError errore generico
     */
    public DecModelloCampoInpUdTableBean getDecModelloCampoInpUdTableBean(
            BigDecimal idModelloTipoSerie) throws ParerUserError {
    ...
    /**
     * Ritorna il tableBean contenente la lista di regole di acquisizione modificabili del modello
     * dato in input e tipo campo
     *
     * @param idModelloTipoSerie id modello
     ...
     */
    public DecModelloCampoInpUdTableBean getDecModelloCampoInpUdTableBean(
            BigDecimal idModelloTipoSerie, String tiCampo) throws ParerUserError {
        List<DecModelloCampoInpUd> list = helper.retrieveDecModelloCampoInpUd(idModelloTipoSerie,
                tiCampo);
     ...
     */
    public BigDecimal getIdModelloCampoInpUd(BigDecimal idModelloTipoSerie, String tiCampo,
            String nmCampo) {
        DecModelloCampoInpUd decModelloCampoInpUd = helper
                .getDecModelloCampoInpUd(idModelloTipoSerie, tiCampo, nmCampo);
        BigDecimal idModelloCampoInpUd = decModelloCampoInpUd != null
                ? new BigDecimal(decModelloCampoInpUd.getIdModelloCampoInpUd())
                : null;
     ...
     *
     * @param param               parametri per il logging
     * @param idModelloCampoInpUd id modello campo in unita doc
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecModelloCampoInpUd(LogParam param, BigDecimal idModelloCampoInpUd)
            throws ParerUserError {
        logger.debug("Eseguo l'eliminazione delle regole di acquisizione");
        try {
            DecModelloCampoInpUd regola = helper.findById(DecModelloCampoInpUd.class,
                    idModelloCampoInpUd);
            ...
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                    param.getNomeUtente(), param.getNomeAzione(),
                    SacerLogConstants.TIPO_OGGETTO_MODELLO_TIPO_SERIE,
                    new BigDecimal(regola.getDecModelloTipoSerie().getIdModelloTipoSerie()),
                    param.getNomePagina());
        } catch (Exception e) {
    ...
    public void saveDecModelloCampoInpUd(LogParam param, BigDecimal idModelloTipoSerie,
        ...
        try {
            ...
            DecModelloTipoSerie decModelloTipoSerie = helper.findById(DecModelloTipoSerie.class,
                    idModelloTipoSerie);
            List<DecModelloCampoInpUd> campiPreModifiche = decModelloTipoSerie
                    .getDecModelloCampoInpUds();
            ...
            for (DecModelloCampoInpUd campoPreModifica : campiPreModifiche) {
                ...
                for (DecModelloCampoInpUdRowBean datoCompilato : datiCompilati) {
                    if (datoCompilato.getIdModelloCampoInpUd() != null
                            && campoPreModifica.getIdModelloCampoInpUd() == datoCompilato
                                    .getIdModelloCampoInpUd().longValue()) {
            ...
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                    param.getNomeUtente(), param.getNomeAzione(),
                    SacerLogConstants.TIPO_OGGETTO_MODELLO_TIPO_SERIE, idModelloTipoSerie,
                    param.getNomePagina());
        } catch (Exception e) {
     ...
     * modificabili del modello dato in input e tipo campo, aggiungendo a ogni riga le versioni del
     * dato specifico
     *
     * @param idModelloTipoSerie id modello
     ...
     * @throws ParerUserError errore generico
     */
    public DecModelloCampoInpUdTableBean getDecModelloCampoInpUdDatiSpecTableBean(
            BigDecimal idModelloTipoSerie, BigDecimal idTipoEntita, String tiCampo)
            throws ParerUserError {
        List<DecModelloCampoInpUd> list = helper.retrieveDecModelloCampoInpUd(idModelloTipoSerie,
                tiCampo);
        DecModelloCampoInpUdTableBean table = transformDecModelloCampoInpUd(list);
        ...
        for (DecAttribDatiSpec attrib : decAttribDatiSpecs) {
            ...
            if (!toList.contains(attrib.getNmAttribDatiSpec())) {
                ...
                DecModelloCampoInpUdRowBean row = table
    ...
    private DecModelloCampoInpUdTableBean transformDecModelloCampoInpUd(
            List<DecModelloCampoInpUd> list) throws ParerUserError {
    ...
    /**
     * Ritorna il tableBean contenente la lista di regole di rappresentazione del modello dato in
     * input, ordinati come segue: 1) KEY_UD_SERIE 2) DT_UD_SERIE 3) INFO_UD_SERIE 4)
     * DS_KEY_ORD_UD_SERIE 5) PG_UD _SERIE
     *
     * @param idModelloTipoSerie id modello
     *
     * @return il tableBean della lista
    ...
    public DecModelloOutSelUdTableBean getDecModelloOutSelUdTableBean(BigDecimal idModelloTipoSerie)
        ...
        // FIXME: Controllare l'ordinamento (vedi voce Ordinamenti di liste con "delegate" sulla
        // wiki)
        ...
        if (list != null && !list.isEmpty()) {
            try {
                ...
                for (DecModelloOutSelUd out : list) {
                    DecModelloOutSelUdRowBean row = (DecModelloOutSelUdRowBean) Transform
                            .entity2RowBean(out);
    ...
    /**
     * Ritorna il tableBean contenente la lista di campi regola di rappresentazione modificabili del
     * modello dato in input e tipo campo
     *
     * @param idModelloOutSelUd id regola di rappresentazione, se null crea la lista completa di
     *                          campi
     * @param tiCampo           tipo campo delle regole
     *
     * @return il tableBean della lista
     ...
     * @throws ParerUserError errore generico
     */
    public DecModelloCampoOutSelUdTableBean getDecModelloCampoOutSelUdTableBean(
            BigDecimal idModelloOutSelUd, String tiCampo) throws ParerUserError {
    ...
    /**
     * Ritorna il tableBean contenente la lista di campi regola di rappresentazione sui dati
     * specifici modificabili del modello dato in input e tipo campo, aggiungendo a ogni riga le
     * versioni del dato specifico
     *
     * @param idModelloOutSelUd id regola di rappresentazione, se null crea la lista completa di
     *                          campi
     * @param idTipoEntita      idTipoUnitaDoc o idTipoDoc in base a tiCampo
     * @param tiCampo           tipo campo delle regole
     *
     * @return il tableBean della lista
     *
     ...
     */
    public DecModelloCampoOutSelUdTableBean getDecModelloCampoOutSelUdTableBean(
            BigDecimal idModelloOutSelUd, BigDecimal idTipoEntita, String tiCampo)
            throws ParerUserError {
        List<DecModelloCampoOutSelUd> list = (idModelloOutSelUd != null
                ? helper.retrieveDecModelloCampoOutSelUd(idModelloOutSelUd, tiCampo)
                : new ArrayList<DecModelloCampoOutSelUd>());
    ...
    private DecModelloCampoOutSelUdTableBean transformDecModelloCampoOutSelUd(
            List<DecModelloCampoOutSelUd> list) throws ParerUserError {
     ...
     *
     * @param param              parametri per il logging
     * @param tiOut              tipo output
     * @param dlFormatoOut       formato
     * @param datiCompilati      compilazione
     * @param idModelloTipoSerie id modello serie
     *
     * @throws ParerUserError errore generico
     */
    ...
    public void saveDecModelloOutSelUd(LogParam param, String tiOut, String dlFormatoOut,
            DecModelloCampoOutSelUdTableBean datiCompilati, BigDecimal idModelloTipoSerie)
            throws ParerUserError {
        try {
            DecModelloTipoSerie decModelloTipoSerie = helper.findById(DecModelloTipoSerie.class,
                    idModelloTipoSerie);
            ...
            if (decModelloOutSelUd.getDecModelloCampoOutSelUds() == null) {
                decModelloOutSelUd
                        .setDecModelloCampoOutSelUds(new ArrayList<DecModelloCampoOutSelUd>());
            }
     ...
     *
     * @param param             parametri per il logging
     * @param idModelloOutSelUd record da modificare
     * @param tiOut             tipo output
     * @param dlFormatoOut      formato
     * @param datiCompilati     compilazione
     *
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveDecModelloOutSelUd(LogParam param, BigDecimal idModelloOutSelUd, String tiOut,
            String dlFormatoOut, DecModelloCampoOutSelUdTableBean datiCompilati)
            throws ParerUserError {
        try {
            DecModelloOutSelUd decModelloOutSelUd = helper.findById(DecModelloOutSelUd.class,
                    idModelloOutSelUd);
            decModelloOutSelUd.setTiOut(tiOut);
            decModelloOutSelUd.setDlFormatoOut(dlFormatoOut);

            // Recupero i campi da DB prima delle modifiche
            List<DecModelloCampoOutSelUd> campiPreModifiche = helper
                    .retrieveDecModelloCampoOutSelUd(idModelloOutSelUd, null);
            // List<DecModelloCampoOutSelUd> campiPreModifiche =
            // decModelloOutSelUd.getDecModelloCampoOutSelUds();
            ...
            for (DecModelloCampoOutSelUd campoPreModifica : campiPreModifiche) {
                ...
                for (DecModelloCampoOutSelUdRowBean datoCompilato : datiCompilati) {
                    if (datoCompilato.getIdModelloCampoOutSelUd() != null
                            && campoPreModifica.getIdModelloCampoOutSelUd() == datoCompilato
                                    .getIdModelloCampoOutSelUd().longValue()) {
                        isPresente = true;
                        break;
                    }
                }
            ...
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                    ...
                    SacerLogConstants.TIPO_OGGETTO_MODELLO_TIPO_SERIE,
                    new BigDecimal(
                            decModelloOutSelUd.getDecModelloTipoSerie().getIdModelloTipoSerie()),
                    param.getNomePagina());
        } catch (Exception e) {
            String messaggio = "Eccezione imprevista nel salvataggio delle regole di rappresentazione ";
            messaggio += ExceptionUtils.getRootCauseMessage(e);
     ...
     *
     * @param param             parametri per il logging
     * @param idModelloOutSelUd id modello output
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecModelloOutSelUd(LogParam param, BigDecimal idModelloOutSelUd)
            throws ParerUserError {
        logger.debug("Eseguo l'eliminazione delle regole di rappresentazione");
        try {
            DecModelloOutSelUd regola = helper.findById(DecModelloOutSelUd.class,
                    idModelloOutSelUd);
            helper.removeEntity(regola, true);
            // Inserito per loggare la foto del Modello tipo serie
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
    ...
    /**
     * Ritorna il tableBean contenente per il modello dato in input un unico rowBean che contiene la
     * lista di regole di filtraggio per i tipi documento principale
     *
     * @param idModelloTipoSerie id modello
     *
     * @return il tableBean della lista
     ...
     * @throws ParerUserError errore generico
     */
    public DecModelloFiltroTiDocTableBean getDecModelloFiltroTiDocSingleRowTableBean(
            BigDecimal idModelloTipoSerie) throws ParerUserError {
    ...
    /**
     * Ritorna il tableBean contenente per il modello dato in input la lista di regole di filtraggio
     * per i tipi documento principale
     *
     * @param idModelloTipoSerie id modello
     *
     * @return il tableBean della lista
     ...
     * @throws ParerUserError errore generico
     */
    public DecModelloFiltroTiDocTableBean getDecModelloFiltroTiDocTableBean(
            BigDecimal idModelloTipoSerie) throws ParerUserError {
        DecModelloFiltroTiDocTableBean table = new DecModelloFiltroTiDocTableBean();
        List<DecModelloFiltroTiDoc> list = helper.retrieveDecModelloFiltroTiDoc(idModelloTipoSerie);
        if (list != null && !list.isEmpty()) {
    ...
    /**
     * Ritorna il tableBean contenente la lista di filtri su dati specifici del modello dato in
     * input
     *
     * @param idModelloTipoSerie id modello
     *
     ...
     * @throws ParerUserError errore generico
     */
    public DecModelloFiltroSelUdattbTableBean getDecModelloFiltroSelUdattbTableBean(
            BigDecimal idModelloTipoSerie) throws ParerUserError {
        DecModelloFiltroSelUdattbTableBean table = new DecModelloFiltroSelUdattbTableBean();
        List<DecModelloFiltroSelUdattb> list = helper
                .retrieveDecModelloFiltroSelUdattb(idModelloTipoSerie);
        if (list != null && !list.isEmpty()) {
            try {
    ...
    /**
     * Ritorna il tableBean contenente la lista di filtri sui dati specifici modificabili del
     ...
     */
    public DecModelloFiltroSelUdattbTableBean getDecModelloFiltroSelUdattbTableBean(
            BigDecimal idModelloTipoSerie, BigDecimal idTipoUnitaDoc, BigDecimal idTipoDoc)
            throws ParerUserError {
        List<DecModelloFiltroSelUdattb> list = helper
                .retrieveDecModelloFiltroSelUdattb(idModelloTipoSerie);
        ...
        if (idTipoDoc != null) {
            ...
            decAttribDatiSpecsDoc = tipoSerieHelper.getDecAttribDatiSpec(idTipoDoc,
                    Constants.TipoEntitaSacer.DOC);
        }
        ...
        if (decAttribDatiSpecsUnitaDoc != null) {
            ...
            for (DecAttribDatiSpec attrib : decAttribDatiSpecsUnitaDoc) {
                ...
                String versioniXsd = tipoSerieHelper.getVersioniXsd(
                        new BigDecimal(attrib.getIdAttribDatiSpec()), idTipoUnitaDoc,
                        Constants.TipoEntitaSacer.UNI_DOC);
                String tmp = vers;
                if (StringUtils.isNotBlank(versioniXsd)) {
                    tmp += " " + versioniXsd;
        ...
        if (decAttribDatiSpecsDoc != null) {
            // Potrei avere attributi già popolati da db o aggiunti dai tipi ud, devo discernere la
            // casistica mentre
            // scorro la lista
            ...
            for (DecAttribDatiSpec attrib : decAttribDatiSpecsDoc) {
                BaseRow versioneXsd = new BaseRow();
                String versioniXsd = tipoSerieHelper.getVersioniXsd(
                        new BigDecimal(attrib.getIdAttribDatiSpec()), idTipoDoc,
                        Constants.TipoEntitaSacer.DOC);
                String tmp = vers;
                if (StringUtils.isNotBlank(versioniXsd)) {
                    tmp += " " + versioniXsd;
                ...
                if (!toList.contains(attrib.getNmAttribDatiSpec())
                    ...
                    // Presi da tipi ud, sicuramente l'indice sarà la somma di quelli da db +
                    // l'indice degli attributi
                    // aggiunti dai tipi ud
                    int indexRow = (toList.size()
                            + udAttributeNames.indexOf(attrib.getNmAttribDatiSpec())) - 1;
    ...
    private DecModelloFiltroSelUdattbTableBean transformDecModelloFiltroSelUdattb(
            List<DecModelloFiltroSelUdattb> list) throws ParerUserError {
        DecModelloFiltroSelUdattbTableBean table = new DecModelloFiltroSelUdattbTableBean();
        if (list != null && !list.isEmpty()) {
            try {
                table = (DecModelloFiltroSelUdattbTableBean) Transform.entities2TableBean(list);
    ...
    public void saveDecModelloFiltroSelUdattb(LogParam param, BigDecimal idModelloTipoSerie,
        ...
        try {
            ...
            List<DecModelloFiltroSelUdattb> campiPreModifiche = decModelloTipoSerie
            ...
            for (DecModelloFiltroSelUdattb campoPreModifica : campiPreModifiche) {
                ...
                for (DecModelloFiltroSelUdattbRowBean datoCompilato : datiCompilati) {
                    if (datoCompilato.getIdModelloFiltroSelUdattb() != null
                            && campoPreModifica.getIdModelloFiltroSelUdattb() == datoCompilato
                                    .getIdModelloFiltroSelUdattb().longValue()) {
     ...
     *
     * @param param                    parametri per il logging
     * @param idModelloFiltroSelUdattb id modello filtro
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecModelloFiltroSelUdattb(LogParam param, BigDecimal idModelloFiltroSelUdattb)
        ...
        try {
            ...
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                    param.getNomeUtente(), param.getNomeAzione(),
                    SacerLogConstants.TIPO_OGGETTO_MODELLO_TIPO_SERIE,
                    new BigDecimal(filtro.getDecModelloTipoSerie().getIdModelloTipoSerie()),
                    param.getNomePagina());
        } catch (Exception e) {
     ...
     * @throws ParerUserError errore generico
     */
    public DecUsoModelloTipoSerieTableBean getDecUsoModelloTipoSerieTableBean(
            BigDecimal idModelloTipoSerie) throws ParerUserError {
        DecUsoModelloTipoSerieTableBean table = new DecUsoModelloTipoSerieTableBean();
        List<DecUsoModelloTipoSerie> list = helper
                .retrieveDecUsoModelloTipoSerie(idModelloTipoSerie);
        if (list != null && !list.isEmpty()) {
            try {
                for (DecUsoModelloTipoSerie uso : list) {
                    ...
                    DecUsoModelloTipoSerieRowBean row = (DecUsoModelloTipoSerieRowBean) Transform
                            .entity2RowBean(uso);
     ...
     *
     * @param nmModelloTipoSerie nome modello
     * @param idAmbiente         id ambiente
     *
     * @return il rowBean contenente i dati del modello
     *
     * @throws ParerUserError errore generico
     */
    public DecModelloTipoSerieRowBean getDecModelloTipoSerieRowBean(String nmModelloTipoSerie,
            BigDecimal idAmbiente) throws ParerUserError {
     ...
     * @param param              parametri per il logging
     * @param idModelloTipoSerie id modello
     * @param creazioneBean      bean CreazioneModelloSerieBean
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveModelloTipoSerie(LogParam param, BigDecimal idModelloTipoSerie,
        ...
        try {
            DecModelloTipoSerie modelloTipoSerie = helper.findById(DecModelloTipoSerie.class,
                    idModelloTipoSerie);
            ...
            logger.error(
                    "Errore imprevisto durante il salvataggio del modello di tipologia serie : "
                            + ExceptionUtils.getRootCauseMessage(ex),
                    ex);
            throw new ParerUserError(
                    "Eccezione imprevista durante il salvataggio del modello di tipologia serie");
        }
    }
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public Long saveModelloTipoSerie(LogParam param, CreazioneModelloSerieBean creazioneBean)
            throws ParerUserError {
        logger.info("Eseguo il salvataggio del modello di tipo serie");
        Long idModelloTipoSerie = null;
        try {
            OrgAmbiente ambiente = helper.findById(OrgAmbiente.class,
                    creazioneBean.getId_ambiente());
    ...
    private void setDatiModello(DecModelloTipoSerie modelloTipoSerie,
            CreazioneModelloSerieBean creazioneBean) {
        DecTipoUnitaDoc tipoUd = creazioneBean.getId_tipo_unita_doc_dati_spec() != null ? helper
                .findById(DecTipoUnitaDoc.class, creazioneBean.getId_tipo_unita_doc_dati_spec())
                : null;
        DecTipoDoc tipoDoc = creazioneBean.getId_tipo_doc_dati_spec() != null
                ? helper.findById(DecTipoDoc.class, creazioneBean.getId_tipo_doc_dati_spec())
                : null;
        ...
        modelloTipoSerie
                .setFlControlloConsistObblig(creazioneBean.getFl_controllo_consist_obblig());
        ...
        modelloTipoSerie
                .setTiRglRangeAnniCreaAutom(creazioneBean.getTi_rgl_range_anni_crea_autom());
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecModelloTipoSerie(LogParam param, BigDecimal idModelloTipoSerie)
            throws ParerUserError {
     ...
     * @param param              parametri per il loggin
     * @param idModelloTipoSerie id modello
     * @param nmTipiDocs         tipi documento da inserire
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveDecModelloFiltroTiDoc(LogParam param, BigDecimal idModelloTipoSerie,
            List<String> nmTipiDocs) throws ParerUserError {
        try {
            DecModelloTipoSerie decModelloTipoSerie = helper.findById(DecModelloTipoSerie.class,
                    idModelloTipoSerie);
            List<DecModelloFiltroTiDoc> campiPreModifiche = helper
                    .getDecModelloFiltroTiDoc(idModelloTipoSerie);
            ...
            for (String nmTipoDoc : nmTipiDocs) {
                if ((tipoSerieHelper.getDecModelloFiltroTiDoc(idModelloTipoSerie, nmTipoDoc))
                        .size() == 0) {
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecModelloFiltroTiDoc(LogParam param, BigDecimal idModelloTipoSerie)
            throws ParerUserError {
     ...
     * @param param              parametri per il logging
     * @param idModelloTipoSerie id modello
     * @param strutTable         entity OrgStrutTableBean
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveDecUsoModelloTipoSerie(LogParam param, BigDecimal idModelloTipoSerie,
            OrgStrutTableBean strutTable) throws ParerUserError {
        try {
            DecModelloTipoSerie modello = helper.findById(DecModelloTipoSerie.class,
                    idModelloTipoSerie);
            for (OrgStrutRowBean row : strutTable) {
                if (helper.existDecUsoModelloTipoSerie(idModelloTipoSerie, row.getIdStrut())) {
                    throw new ParerUserError("La struttura " + row.getNmStrut()
                            + " \u00E8 gi\u00E0 associata al modello");
                }
     ...
     *
     * @param param                 parametri per il logging
     * @param idUsoModelloTipoSerie id modello
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecUsoModelloTipoSerie(LogParam param, BigDecimal idUsoModelloTipoSerie)
            throws ParerUserError {
        logger.debug("Eseguo l'eliminazione della associazione della struttura al modello");
        try {
            DecUsoModelloTipoSerie uso = helper.findById(DecUsoModelloTipoSerie.class,
                    idUsoModelloTipoSerie);
            helper.removeEntity(uso, true);
            // Inserito per loggare la foto del Modello tipo serie
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                    param.getNomeUtente(), param.getNomeAzione(),
                    SacerLogConstants.TIPO_OGGETTO_MODELLO_TIPO_SERIE,
                    new BigDecimal(uso.getDecModelloTipoSerie().getIdModelloTipoSerie()),
                    param.getNomePagina());
        } catch (Exception e) {
