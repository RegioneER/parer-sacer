...
public final class CreazioneSerieBean {
    ...
    public CreazioneSerieBean(String ti_creazione, BigDecimal nm_tipo_serie, BigDecimal ni_anni_conserv,
            String cd_serie, String ds_serie, BigDecimal aa_serie, Date dt_inizio_serie, Date dt_fine_serie,
            String ds_azione, String ds_nota_azione, String ti_periodo_sel_serie, BigDecimal ni_periodo_sel_serie) {
    ...
    public CreazioneSerieBean(SerieUDForm.CreazioneSerie formFields) throws EMFError, ParerUserError {
        ...
        if (anni == null) {
            if (unlimited != null && unlimited.equals("1")) {
                ...
                throw new ParerUserError("Eccezione nella collezione dei parametri per la creazione della serie");
            }
        } else {
    ...
    public String getCdCompositoSerie() {
        ...
        String codiceSerie = StringUtils.isNotBlank(codiceSeriePadre) ? codiceSeriePadre + "/" + this.getCd_serie()
                : this.getCd_serie();
        return codiceSerie;
    }
