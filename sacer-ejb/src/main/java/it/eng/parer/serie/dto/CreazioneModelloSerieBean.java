...
public class CreazioneModelloSerieBean {
     ...
     *
     * @param detail form di dettaglio
     *
     * @throws it.eng.spagoCore.error.EMFError Errore di parsing
     */
    public CreazioneModelloSerieBean(ModelliSerieForm.ModelliTipiSerieDetail detail)
            throws EMFError {
        ...
        if (StringUtils.isNotBlank(niMmCreaAutomTranscode)) {
            if (niMmCreaAutomTranscode
                ...
                this.ni_mm_crea_autom = CostantiDB.IntervalliMeseCreazioneSerie.DECADE
                        .getNumSerie();
            } else if (niMmCreaAutomTranscode
                    .equals(CostantiDB.IntervalliMeseCreazioneSerie.QUINDICINA.name())) {
                this.ni_mm_crea_autom = CostantiDB.IntervalliMeseCreazioneSerie.QUINDICINA
                        .getNumSerie();
            } else if (niMmCreaAutomTranscode
                ...
                this.ni_mm_crea_autom = CostantiDB.IntervalliMeseCreazioneSerie.BIMESTRE
                        .getNumSerie();
            } else if (niMmCreaAutomTranscode
                    .equals(CostantiDB.IntervalliMeseCreazioneSerie.TRIMESTRE.name())) {
                this.ni_mm_crea_autom = CostantiDB.IntervalliMeseCreazioneSerie.TRIMESTRE
                        .getNumSerie();
            } else if (niMmCreaAutomTranscode
                    .equals(CostantiDB.IntervalliMeseCreazioneSerie.QUADRIMESTRE.name())) {
                this.ni_mm_crea_autom = CostantiDB.IntervalliMeseCreazioneSerie.QUADRIMESTRE
                        .getNumSerie();
            } else if (niMmCreaAutomTranscode
                    .equals(CostantiDB.IntervalliMeseCreazioneSerie.SEMESTRE.name())) {
                this.ni_mm_crea_autom = CostantiDB.IntervalliMeseCreazioneSerie.SEMESTRE
                        .getNumSerie();
            }
        } else {
