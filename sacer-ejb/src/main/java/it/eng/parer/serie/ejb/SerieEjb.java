...
public class SerieEjb {
    ...
    public SerSerieRowBean getSerSerieRowBean(BigDecimal idTipoSerie, BigDecimal idStrut, BigDecimal aaSerie) {
        ...
        if (serie != null) {
            try {
                ...
                logger.error("Errore durante il recupero delle serie " + ExceptionUtils.getRootCauseMessage(ex), ex);
    ...
    public boolean isSerieExisting(BigDecimal idStrut, BigDecimal idTipoSerie, BigDecimal aaSerie, Date dataInizio,
            Date dataFine) {
    ...
    public boolean isSerieExisting(BigDecimal idStrut, BigDecimal idTipoSerie, BigDecimal aaSerie, Date dataInizio,
            Date dataFine, String cdSerie) {
        Long count = helper.countSerie(idStrut, idTipoSerie, aaSerie, dataInizio, dataFine, cdSerie);
        return count > 0L;
    }

    public boolean isSerieExisting(BigDecimal idStrut, BigDecimal idTipoSerie, BigDecimal aaSerie, String cdSerie) {
    ...
    /**
     * Esegue il salvataggio in transazione del nuovo record serie, che verr\u00E0 poi utilizzato dal metodo asincrono
     * per eseguire il calcolo
     *
     * @param idUser
     *            l'utente che ha richiamato la funzione di creazione
     * @param idStrut
    ...
    public Long saveSerie(long idUser, BigDecimal idStrut, CreazioneSerieBean serieBean, byte[] file)
            throws ParerUserError {
        ...
        logger.info(SerieEjb.class.getSimpleName() + " SALVATAGGIO SERIE - Salvataggio nuova serie");
        ...
        logger.info(SerieEjb.class.getSimpleName() + " SALVATAGGIO SERIE - Salvataggio stato versione");
        ...
        context.getBusinessObject(SerieEjb.class).createSerContenutoVerSerie(verSerie, tipoContenuto, now.getTime());
        ...
        if (acquisizione) {
            context.getBusinessObject(SerieEjb.class).createSerFileInputVerSerie(file,
                    serieBean.getCd_doc_file_input_ver_serie(), serieBean.getDs_doc_file_input_ver_serie(),
                    serieBean.getFl_fornito_ente(), CostantiDB.ScopoFileInputVerSerie.ACQUISIRE_CONTENUTO.name(), user,
                    verSerie);
        }
        ...
        if (StringUtils.isNotBlank(serieBean.getCd_serie_padre_da_creare())) {
            if (tipoSerie.getDecTipoSeriePadre() == null) {
                ...
                logger.info(SerieEjb.class.getSimpleName() + " SALVATAGGIO SERIE - Salvataggio padre da creare");
                ...
                statoVerSeriePadre.setTiStatoVerSerie(CostantiDB.StatoVersioneSerie.APERTURA_IN_CORSO.name());
                statoVerSeriePadre.setDsNotaAzione("Serie 'padre' creata contestualmente alla creazione della serie "
                ...
                verSeriePadre.setIdStatoVerSerieCor(new BigDecimal(statoVerSeriePadre.getIdStatoVerSerie()));
            }
        } else if (StringUtils.isNotBlank(serieBean.getCd_serie_padre()) && serieBean.getId_serie_padre() != null) {
            logger.info(SerieEjb.class.getSimpleName()
            ...
            SerVerSerie lastVerSeriePadre = helper.getLastSerVerSerie(serieBean.getId_serie_padre());
    ...
    public SerFileInputVerSerie createSerFileInputVerSerie(byte[] file, String cdDocFileInputVerSerie,
            String dsDocFileInputVerSerie, String flFornitoEnte, String tiScopoFileInputVerSerie, IamUser user,
    ...
    public void createSerContenutoVerSerie(SerVerSerie verSerie, String tipoContenuto, Date now) {
        ...
        contenutoSerie.setTiStatoContenutoVerSerie(CostantiDB.StatoContenutoVerSerie.CREAZIONE_IN_CORSO.name());
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public Future<String> callCreazioneSerieAsync(long idUser, Long idVerSerie, boolean acquisizione) {
        ...
        try {
            ...
            future = context.getBusinessObject(SerieEjb.class).creazioneSerieAsync(idUser, tipoCreazione, idVerSerie);
        } catch (Exception e) {
    ...
    @Asynchronous
    public Future<String> creazioneSerieAsync(long idUser, JobConstants.JobEnum tipoCreazione, long idVerSerie)
        ...
        try {
            ...
            case CALCOLO_SERIE:
                ...
                if (contenuto != null) {
                    ...
                    context.getBusinessObject(SerieEjb.class).calcoloSerie(idUser, contenuto, false);
                }
                break;
            case INPUT_SERIE:
                contenuto = helper.getLockSerContenutoVerSerie(idVerSerie,
            ...
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(tipoCreazione.name(), JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(),
                        null, contenuto.getIdContenutoVerSerie(), contenuto.getClass().getSimpleName());
            }
            logger.info(SerieEjb.class.getSimpleName() + " --- FINE chiamata asincrona per creazione serie");
        } catch (Exception e) {
            ...
            error = true;
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(tipoCreazione.name(), JobConstants.OpTypeEnum.ERRORE.name(), messaggio,
                        contenuto.getIdContenutoVerSerie(), contenuto.getClass().getSimpleName());
            }
        }
    ...
    public String calcoloContenutoSerieSingleTx(BigDecimal idVerSerieEntry, long idUser) {
        ...
        boolean error = false;
        try {
            logger.debug(SerieEjb.class.getSimpleName() + " --- Richiesta LOCK su contenuto CALCOLATO con id_ver_serie "
            ...
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.CALCOLO_SERIE.name(),
                        JobConstants.OpTypeEnum.INIZIO_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
                context.getBusinessObject(SerieEjb.class).calcoloSerie(idUser, contenuto, true);
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.CALCOLO_SERIE.name(),
                        JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
            }
            logger.debug(SerieEjb.class.getSimpleName() + " --- FINE chiamata asincrona per creazione serie");
        } catch (Exception e) {
            error = true;
            String messaggio = "Eccezione imprevista durante la fase di creazione serie:";
            messaggio += ExceptionUtils.getRootCauseMessage(e);
            ...
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.CALCOLO_SERIE.name(),
                        JobConstants.OpTypeEnum.ERRORE.name(), messaggio, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
            }
        }
        String result;
    ...
    public void calcoloSerie(long idUser, SerContenutoVerSerie contenuto, boolean calcoloAutomatico) {
        ...
        logger.debug(SerieEjb.class.getSimpleName() + " CALCOLO ASYNC SERIE --- Ottenuti i tipi di serie da calcolare");
        ...
        for (DecTipoSerieUd tipoSerieUd : tipiSerieUd) {
            ...
            String query = this.wrapQuery(JobConstants.JobEnum.CALCOLO_SERIE, tipoSerieUd, annoSerie, verSerie);

            List<ResultVCalcoloSerieUd> tmpUds = context.getBusinessObject(SerieEjb.class).saveQueryAndExecute(query,
            ...
            logger.debug(SerieEjb.class.getSimpleName() + " CALCOLO ASYNC SERIE --- Query eseguita - ottenute "
                    + tmpUds.size() + " unit\u00E0 documentarie");
            if (!tmpUds.isEmpty()) {
                for (ResultVCalcoloSerieUd ud : tmpUds) {
                    context.getBusinessObject(SerieEjb.class)
                            .handleAroUnitaDocWithTransaction(contenuto.getIdContenutoVerSerie(), ud);
                }
                counterUd += tmpUds.size();
            }
            context.getBusinessObject(SerieEjb.class).handleAroUdAppartVerSerie(idUser, contenuto, counterUd,
                    "Calcolo serie", calcoloAutomatico, (rounds == tipiSerieUd.size()));
        }
    }

    private String wrapQuery(JobConstants.JobEnum tipoCreazione, DecTipoSerieUd tipoSerieUd, BigDecimal annoSerie,
            SerVerSerie verSerie) throws IllegalStateException {
        String query = context.getBusinessObject(SerieEjb.class).buildQuery(tipoCreazione, tipoSerieUd, annoSerie,
                verSerie);
        ...
        wrapQuery.append(" WHERE ").append("tmp.key_ud_serie IS NOT NULL").append(" AND ")
                .append("tmp.dt_ud_serie IS NOT NULL").append(" AND ").append("tmp.info_ud_serie IS NOT NULL")
                .append(" AND ").append("tmp.ds_key_ord_ud_serie IS NOT NULL");
        if (dtUdSeriePresente && verSerie.getDtInizioSelSerie() != null && verSerie.getDtFineSelSerie() != null) {
            wrapQuery.append(" AND ").append("tmp.dt_ud_serie >= ").append("to_date('")
                    .append(df.format(verSerie.getDtInizioSelSerie())).append("', 'dd/mm/yyyy')").append(" AND ")
                    .append("tmp.dt_ud_serie <= ").append("to_date('").append(df.format(verSerie.getDtFineSelSerie()))
                    .append("', 'dd/mm/yyyy')");
        }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void handleAroUnitaDocWithTransaction(Long idContenutoVerSerie, ResultVCalcoloSerieUd result) {
        logger.debug(SerieEjb.class.getSimpleName()
    ...
    public void handleAroUnitaDoc(Long idContenutoVerSerie, ResultVCalcoloSerieUd result) {
        ...
        SerContenutoVerSerie contenuto = helper.findById(SerContenutoVerSerie.class, idContenutoVerSerie);
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void handleAroUdAppartVerSerie(long idUser, SerContenutoVerSerie contenuto, int counterUd, String azione,
            boolean calcoloAutomatico, boolean lastRound) {
        ...
        contenuto.setIdFirstUdAppartVerSerie(firstUd != null ? new BigDecimal(firstUd) : BigDecimal.ZERO);
        contenuto.setIdLastUdAppartVerSerie(lastUd != null ? new BigDecimal(lastUd) : BigDecimal.ZERO);
        ...
        if (statoCorrente != null) {
            if (!statoCorrente.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.APERTA.name())) {
                logger.debug(SerieEjb.class.getSimpleName() + azione + " --- Aggiorna lo stato della versione");
                SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                        ...
                        CostantiDB.StatoVersioneSerie.APERTA.name(), azione, null, idUser, now,
                        verSerie.getIdVerSerie());

                logger.debug(
                        SerieEjb.class.getSimpleName() + azione + " --- Eseguo la persist del nuovo stato versione");
                helper.insertEntity(statoVerSerie, false);
                verSerie.setIdStatoVerSerieCor(new BigDecimal(statoVerSerie.getIdStatoVerSerie()));
            }
            ...
            if (calcoloAutomatico && tipoSerie.getTiStatoVerSerieAutom() == null) {
                throw new IllegalStateException(
                    ...
                    && (tipoSerie.getTiStatoVerSerieAutom().equals(CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name())
                ...
                verSerieDaElab.setIdStrut(new BigDecimal(verSerie.getSerSerie().getOrgStrut().getIdStrut()));
                verSerieDaElab.setTiStatoVerSerie(CostantiDB.StatoVersioneSerieDaElab.APERTA.name());
                verSerieDaElab.setSerVerSerie(verSerie);
                logger.debug(SerieEjb.class.getSimpleName() + " --- Eseguo la persist del nuovo verSerie da elab");
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public SerStatoVerSerie createSerStatoVerSerie(BigDecimal pgStatoVerSerie, String tiStatoVerSerie, String azione,
            String nota, long idUser, Date now, Long idVerSerie) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public SerStatoSerie createSerStatoSerie(BigDecimal pgStatoSerie, String tiStatoSerie, String azione, String nota,
            long idUser, Date now, Long idSerie) {
    ...
    public String buildQuery(JobConstants.JobEnum tipoCreazione, DecTipoSerieUd tipoSerieUd, BigDecimal annoSerie,
            SerVerSerie verSerie) {
        ...
        String select = context.getBusinessObject(SerieEjb.class).buildSelectQuery(output, counterRicDatiSpec,
                annoSerie, verSerie.getSerSerie().getCdCompositoSerie());
        ...
        case CALCOLO_SERIE:
            ...
            List<DecFiltroSelUdDato> filtriUd = helper.getDecFiltroSelUdDato(tipoSerieUd.getIdTipoSerieUd(),
                    tipoSerieUd.getDecTipoUnitaDoc().getNmTipoUnitaDoc());
            where = context.getBusinessObject(SerieEjb.class).buildWhereCalcoloSerieQuery(whereBuilder, selTables,
                    filtri, filtriUd, tipoSerieUd, annoSerie, counterRicDatiSpec, verSerie);
            break;
        case INPUT_SERIE:
            ...
            where = context.getBusinessObject(SerieEjb.class).buildWhereInputSerieQuery(whereBuilder, selTables,
                    filtriDatoProfilo, filtriDatiSpecUd, tipoSerieUd, annoSerie, counterRicDatiSpec);
            break;
        default:
            throw new IllegalArgumentException("Tipo creazione serie non valido");
        }
    ...
    public List<ResultVCalcoloSerieUd> saveQueryAndExecute(String query, Long idRegistroUnitaDoc, Long idTipoUnitaDoc,
            SerContenutoVerSerie contenuto, List<Long> selTables) {
        context.getBusinessObject(SerieEjb.class).saveQuery(query, idRegistroUnitaDoc, idTipoUnitaDoc,
                contenuto.getIdContenutoVerSerie());
        return helper.executeQueryList(query);
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveQuery(String query, Long idRegistroUnitaDoc, Long idTipoUnitaDoc, Long idContenutoVerSerie) {
    ...
    public String buildSelectQuery(List<DecOutSelUd> output, BigDecimal counterRicDatiSpec, BigDecimal annoSerie,
            String cdSerie) {
        ...
        for (DecOutSelUd out : output) {
            ...
            for (DecCampoOutSelUd campo : campi) {
                ...
                case DATO_PROFILO:
                    ...
                    case ANNO:
                        ...
                        break;
                    case NUMERO:
                        if (out.getTiOut().equals(CostantiDB.TipoDiRappresentazione.PG_UD_SERIE.name())) {
                            campiItemSelect.put(nomeCampo.name(), "ud.pg_unita_doc");
                        } else if (out.getTiOut()
                                .equals(CostantiDB.TipoDiRappresentazione.DS_KEY_ORD_UD_SERIE.name())) {
                        ...
                        break;
                    case DATA_REG:
                        if (out.getTiOut().equals(CostantiDB.TipoDiRappresentazione.DS_KEY_ORD_UD_SERIE.name())) {
                            campiItemSelect.put(nomeCampo.name(), "to_char(ud.dt_Reg_Unita_Doc, 'yyyy/mm/dd')");
                        } else {
                            campiItemSelect.put(nomeCampo.name(), "to_char(ud.dt_Reg_Unita_Doc, 'dd/mm/yyyy')");
                        }
                        break;
                    case DATA_VERS:
                        if (out.getTiOut().equals(CostantiDB.TipoDiRappresentazione.DS_KEY_ORD_UD_SERIE.name())) {
                            campiItemSelect.put(nomeCampo.name(), "to_char(ud.dt_Creazione, 'yyyy/mm/dd')");
                        } else {
                            campiItemSelect.put(nomeCampo.name(), "to_char(ud.dt_Creazione, 'dd/mm/yyyy')");
                        }
                        break;
                    case TIPO_DOC_PRINC:
                ...
                case DATO_SPEC_DOC_PRINC:
                    ...
                    if (StringUtils.isNotBlank(campo.getTiTrasformCampo())) {
                        if (campo.getTiTrasformCampo()
                                .equals(CostantiDB.TipoTrasformatore.OUT_NO_SEP_CHAR.getTransformString())) {
                            valoreAttributo = "CASE WHEN ricDatiSpec" + tableSuffix
                                ...
                                .equals(CostantiDB.TipoTrasformatore.OUT_ANY_SEP_CHAR.getTransformString())) {
                            valoreAttributo = "CASE WHEN ricDatiSpec" + tableSuffix
                                    + ".dl_valore IS NOT NULL THEN SUBSTR(ricDatiSpec" + tableSuffix
                                ...
                                .equals(CostantiDB.TipoTrasformatore.OUT_PAD_CHAR.getTransformString())) {
                            valoreAttributo = "CASE WHEN ricDatiSpec" + tableSuffix
                                    + ".dl_valore IS NOT NULL THEN lpad(ricDatiSpec" + tableSuffix
                                    + ".dl_Valore, 12, '0') ELSE NULL END";
                        } else if (campo.getTiTrasformCampo()
                                .equals(CostantiDB.TipoTrasformatore.OUT_NO_SEP_TO_YEAR.getTransformString())
                                || campo.getTiTrasformCampo().equals(
                                        CostantiDB.TipoTrasformatore.OUT_ANY_SEP_TO_YEAR.getTransformString())) {
                            valoreAttributo = "CASE WHEN ricDatiSpec" + tableSuffix
                                    + ".dl_valore IS NOT NULL THEN SUBSTR(ricDatiSpec" + tableSuffix
                                    + ".dl_Valore,1,4) ELSE NULL END";
                        }
                    ...
                    subQuery = "(SELECT " + valoreAttributo + " FROM Aro_V_Ric_Dati_Spec ricDatiSpec" + tableSuffix
                            + " WHERE ricDatiSpec" + tableSuffix + ".id_Doc = docPrinc.id_Doc " + "AND ricDatiSpec"
                            + tableSuffix + ".ti_Entita_Sacer = 'DOC' " + "AND ricDatiSpec" + tableSuffix
                ...
                case DATO_SPEC_UNI_DOC:
                    ...
                    subQuery = "(SELECT " + valoreAttributo + " FROM Aro_V_Ric_Dati_Spec ricDatiSpec" + tableSuffix
                            ...
                            + "AND ricDatiSpec" + tableSuffix + ".ti_Entita_Sacer = 'UNI_DOC' " + "AND ricDatiSpec"
                            + tableSuffix + ".id_Attrib_Dati_Spec = " + String.valueOf(idAttrib) + ")";
                    campiItemSelect.put(campo.getNmCampo(), subQuery);
                    counterRicDatiSpec = counterRicDatiSpec.add(BigDecimal.ONE);
                    break;
                }
            ...
            if (StringUtils.isNotBlank(dlFormatoOut)) {
                ...
                /*
                 * Mi costruisco tre liste: una contenente i tagname, una gli indici di inizio e una gli indici di fine
                 * del tagname. Costruendoli insieme, per lo stesso indice di lista mi riferisco sempre allo stesso
                 * tagname
                 */
                ...
                for (int index = 0; index < tagNames.size(); index++) {
                    ...
                    if (start == currentLength) {
                        ...
                        tmp.append("'").append(dlFormatoOut.substring(currentLength, start)).append("'||");
                        tmp.append(substitute).append("||");
                    }
                    currentLength = end;
                }
                ...
                throw new IllegalStateException("Errore imprevisto : l'output con id pari a " + out.getIdOutSelUd()
                        + " non prevede formattazione dei campi");
            }

            CostantiDB.TipoDiRappresentazione tipoRappr = CostantiDB.TipoDiRappresentazione.valueOf(out.getTiOut());
            switch (tipoRappr) {
            case DS_KEY_ORD_UD_SERIE:
                select.append(itemSelect).append(" DS_KEY_ORD_UD_SERIE, ");
                break;
            case DT_UD_SERIE:
                select.append("to_date( ").append(itemSelect).append(" , 'dd/mm/yyyy') DT_UD_SERIE, ");
                break;
            case INFO_UD_SERIE:
            ...
            case KEY_UD_SERIE:
                ...
                break;
            case PG_UD_SERIE:
                select.append("to_number( ").append(itemSelect).append(")").append(" PG_UD_SERIE, ");
                break;
            default:
    ...
    private StringBuilder buildGenericWhere(DecTipoSerieUd tipoSerieUd, BigDecimal annoSerie, SerVerSerie verSerie) {
        ...
        where.append("ud.id_Registro_Unita_Doc = ").append(tipoSerieUd.getDecRegistroUnitaDoc().getIdRegistroUnitaDoc())
        ...
        if (tipoSerieUd.getDecTipoSerie().getTiSelUd().equals(CostantiDB.TipoSelUdTipiSerie.ANNO_KEY.name())) {
            where.append(andClause).append("ud.aa_Key_Unita_Doc = ").append(annoSerie.toPlainString());
        } else if (tipoSerieUd.getDecTipoSerie().getTiSelUd().equals(CostantiDB.TipoSelUdTipiSerie.DT_UD_SERIE.name())
                && StringUtils.isNotBlank(verSerie.getDsListaAnniSelSerie())) {
            where.append(andClause).append("ud.aa_Key_Unita_Doc IN (").append(verSerie.getDsListaAnniSelSerie())
                    .append(")");
        }
    ...
    public String buildWhereCalcoloSerieQuery(StringBuilder where, List<Long> selTables, List<DecFiltroSelUd> filtri,
            List<DecFiltroSelUdDato> filtriUd, DecTipoSerieUd tipoSerieUd, BigDecimal annoSerie,
            BigDecimal counterRicDatiSpec, SerVerSerie verSerie) {
        String andClause = " AND ";
        SimpleDateFormat df = new SimpleDateFormat(Constants.DATE_FORMAT_TIMESTAMP_TYPE);

        if (verSerie.getDtCreazioneUnitaDocDa() != null && verSerie.getDtCreazioneUnitaDocA() != null) {
            where.append(andClause).append("ud.dt_Creazione >= ").append("to_date('")
                    .append(df.format(verSerie.getDtCreazioneUnitaDocDa())).append("', 'dd/mm/yyyy hh24:mi:ss')")
                    .append(andClause).append("ud.dt_Creazione <= ").append("to_date('")
                    .append(df.format(verSerie.getDtCreazioneUnitaDocA())).append("', 'dd/mm/yyyy hh24:mi:ss')");
        }
        if (verSerie.getDtRegUnitaDocDa() != null && verSerie.getDtRegUnitaDocA() != null) {
            where.append(andClause).append("ud.dt_Reg_Unita_Doc >= ").append("to_date('")
                    .append(df.format(verSerie.getDtRegUnitaDocDa())).append("', 'dd/mm/yyyy hh24:mi:ss')")
                    .append(andClause).append("ud.dt_Reg_Unita_Doc <= ").append("to_date('")
                    .append(df.format(verSerie.getDtRegUnitaDocA())).append("', 'dd/mm/yyyy hh24:mi:ss')");
        }

        where.append(context.getBusinessObject(SerieEjb.class).buildDatiSpecCalcoloQuery(filtriUd, "UNI_DOC",
                counterRicDatiSpec));
            ...
            for (Long idTipoDoc : selTables) {
                ...
                if (!filtriDatiSpecDoc.isEmpty()) {
                    ...
                    appendFiltri.append(context.getBusinessObject(SerieEjb.class)
                            .buildDatiSpecCalcoloQuery(filtriDatiSpecDoc, "DOC", counterRicDatiSpec));
                    appendFiltri.append(") ");
                    counterFiltri++;
                }
            }
    ...
    public String buildWhereInputSerieQuery(StringBuilder where, List<Long> selTables,
            List<DecCampoInpUd> filtriDatoProfilo, List<DecCampoInpUd> filtriDatiSpec, DecTipoSerieUd tipoSerieUd,
            BigDecimal annoSerie, BigDecimal counterRicDatiSpec) {
        String andClause = " AND ";
        for (DecCampoInpUd campo : filtriDatoProfilo) {
            CostantiDB.NomeCampo nomeCampo = CostantiDB.NomeCampo.valueOf(campo.getNmCampo());
            switch (nomeCampo) {
            case TIPO_UNITA_DOC:
                where.append(andClause).append("tipoUd.nm_Tipo_Unita_Doc = '<").append(campo.getNmCampo()).append(">'");
                break;
            case REGISTRO:
                where.append(andClause).append("ud.cd_Registro_Key_Unita_Doc = '<").append(campo.getNmCampo())
                        .append(">'");
                break;
            case ANNO:
                where.append(andClause).append("ud.aa_Key_Unita_Doc = <").append(campo.getNmCampo()).append(">");
                break;
            case NUMERO:
                where.append(andClause).append("ud.cd_Key_Unita_Doc = '<").append(campo.getNmCampo()).append(">'");
                break;
            case DATA_REG:
                where.append(andClause).append("ud.dt_Reg_Unita_Doc = to_date('<").append(campo.getNmCampo())
                        .append(">', 'dd/mm/yyyy')");
                break;
            case DATA_VERS:
                where.append(andClause).append("ud.dt_Creazione = to_date('<").append(campo.getNmCampo())
                        .append(">', 'dd/mm/yyyy')");
                break;
            case TIPO_DOC_PRINC:
                where.append(andClause).append("tipoDocPrinc.nm_Tipo_Doc = '<").append(campo.getNmCampo()).append(">'");
                break;
            case OGGETTO:
                where.append(andClause).append("ud.dl_Oggetto_Unita_Doc = '<").append(campo.getNmCampo()).append(">'");
                break;
            default:
                throw new AssertionError(nomeCampo.name());
            }
        ...
        where.append(context.getBusinessObject(SerieEjb.class).buildDatiSpecInputQuery(filtriDatiSpec, "UNI_DOC",
                counterRicDatiSpec));
        ...
        if (!selTables.isEmpty()) {
            for (Long idTipoDoc : selTables) {
                List<DecCampoInpUd> filtriDatiSpecDoc = helper
                        .getDecCampoInpUdDatiSpec(tipoSerieUd.getDecTipoSerie().getIdTipoSerie(), null, idTipoDoc);
                if (!filtriDatiSpecDoc.isEmpty()) {
                    if (counterFiltri == 0) {
                        appendFiltri.append(andClause).append("((");
                        andClause = " OR ";
    ...
    public String buildDatiSpecCalcoloQuery(List<DecFiltroSelUdDato> filtriUd, String tiEntitaSacer,
        ...
        for (DecFiltroSelUdDato filtroUd : filtriUd) {
            ...
            CostantiDB.TipoOperatoreDatiSpec tiOper = CostantiDB.TipoOperatoreDatiSpec.valueOf(tiOperString);
            String descValore = filtroUd.getDecFiltroSelUdAttb().getDlValore() != null
                    ? filtroUd.getDecFiltroSelUdAttb().getDlValore().toUpperCase() : null;
            Long idAttrib = filtroUd.getDecAttribDatiSpec() != null
                    ? filtroUd.getDecAttribDatiSpec().getIdAttribDatiSpec() : null;
            this.buildDatoSpecSubQuery(tiOper, descValore, idAttrib, counterRicDatiSpec, tiEntitaSacer, datiSpec);
            counterRicDatiSpec = counterRicDatiSpec.add(BigDecimal.ONE);
        }
    ...
    public String buildDatiSpecInputQuery(List<DecCampoInpUd> filtriCampi, String tiEntitaSacer,
        ...
        for (DecCampoInpUd campo : filtriCampi) {
            ...
            Long idAttrib = campo.getDecAttribDatiSpec() != null ? campo.getDecAttribDatiSpec().getIdAttribDatiSpec()
                    : null;
            this.buildDatoSpecSubQuery(tiOper, descValore, idAttrib, counterRicDatiSpec, tiEntitaSacer, datiSpec);
            counterRicDatiSpec = counterRicDatiSpec.add(BigDecimal.ONE);
        }
    ...
    private void buildDatoSpecSubQuery(CostantiDB.TipoOperatoreDatiSpec tiOper, String descValore, Long idAttrib,
            BigDecimal counterRicDatiSpec, String tiEntitaSacer, StringBuilder datiSpec) throws AssertionError {
        String operatore;
        String filtro = "";
        switch (tiOper) {
        case CONTIENE:
        ...
        if (tiEntitaSacer.equals("UNI_DOC")) {
            datiSpec.append(" AND EXISTS (SELECT ricDatiSpec" + tableSuffix + ".* from Aro_V_Ric_Dati_Spec ricDatiSpec"
                    + tableSuffix + " " + "WHERE ricDatiSpec" + tableSuffix + ".id_Unita_Doc = ud.id_Unita_Doc "
                    + "AND ricDatiSpec" + tableSuffix + ".ti_Entita_Sacer = 'UNI_DOC' " + "AND ricDatiSpec"
                    + tableSuffix + ".id_Attrib_Dati_Spec = " + idAttrib + " " + "AND UPPER(ricDatiSpec" + tableSuffix
                    + ".dl_Valore)" + operatore + filtro + ")");
        } else if (tiEntitaSacer.equals("DOC")) {
            if (counterRicDatiSpec.intValue() > 1) {
                datiSpec.append(" AND ");
            }
            datiSpec.append("EXISTS (SELECT ricDatiSpec" + tableSuffix + ".* from Aro_V_Ric_Dati_Spec ricDatiSpec"
                    + tableSuffix + " " + "WHERE ricDatiSpec" + tableSuffix + ".id_Doc = docPrinc.id_Doc "
                    + "AND ricDatiSpec" + tableSuffix + ".ti_Entita_Sacer = 'DOC' " + "AND ricDatiSpec" + tableSuffix
                    + ".id_Attrib_Dati_Spec = " + idAttrib + " " + "AND UPPER(ricDatiSpec" + tableSuffix + ".dl_Valore)"
                    + operatore + filtro + ")");
        }
    }
    // </editor-fold>
    ...
    public void inputSerie(long idUser, SerContenutoVerSerie contenuto) throws IOException {
        logger.debug(SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Ricerco i tipi di serie da calcolare");
        SerVerSerie verSerie = contenuto.getSerVerSerie();
        SerSerie serSerie = verSerie.getSerSerie();
        BigDecimal annoSerie = serSerie.getAaSerie();
        DecTipoSerie tipoSerie = serSerie.getDecTipoSerie();
        ...
        List<DecTipoSerieUd> tipiSerieUd = helper.getDecTipoSerieUd(tipoSerie.getIdTipoSerie());
        logger.debug(SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Ottenuti i tipi di serie da calcolare");
        ...
        for (DecTipoSerieUd tipoSerieUd : tipiSerieUd) {
            ...
            logger.debug(SerieEjb.class.getSimpleName()
                    ...
                    + tipoSerieUd.getDecTipoUnitaDoc().getNmTipoUnitaDoc());
            String query = this.wrapQuery(JobConstants.JobEnum.INPUT_SERIE, tipoSerieUd, annoSerie, verSerie);
            logger.debug(SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Query compilata ");
            context.getBusinessObject(SerieEjb.class).saveQuery(query,
                    tipoSerieUd.getDecRegistroUnitaDoc().getIdRegistroUnitaDoc(),
                    tipoSerieUd.getDecTipoUnitaDoc().getIdTipoUnitaDoc(), contenuto.getIdContenutoVerSerie());
        ...
        CsvReader csvReader = new CsvReader(new ByteArrayInputStream(fileInput.getBlFileInputVerSerie().getBytes()),
                Charset.forName("UTF-8"));
        csvReader.setSkipEmptyRecords(true);
        int counterUd = 0;
        try {
            if (csvReader.readHeaders()) {
                logger.debug(SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Eseguo il parsing del file csv");
                int index = 0;
                while (csvReader.readRecord()) {
                    ...
                    for (DecCampoInpUd campo : campi) {
                        ...
                        if (campo.getTiTrasformCampo() != null && campo.getTiTrasformCampo()
                                .equals(CostantiDB.TipoTrasformatore.IN_NO_SEP_CHAR.getTransformString())) {
                            final Pattern p = Pattern.compile("([0-9]{1,2})[\\W]([0-9]{1,2})[\\W]([0-9]{4})");
                    ...
                    for (Map.Entry<Long, String> entry : queryMap.entrySet()) {
                        ...
                        while (m.find()) {
                            ...
                            if (substitute != null) {
                                ...
                                if (substitute.getTipoCampo().equals(CostantiDB.TipoCampo.DATO_SPEC_UNI_DOC)
                                        || substitute.getTipoCampo().equals(CostantiDB.TipoCampo.DATO_SPEC_DOC_PRINC)) {
                                ...
                                this.createSerErrFileInput(
                                        CostantiDB.TipoErroreFileInputSerie.CAMPI_NON_VALORIZZATI.name(),
                                        new BigDecimal(index), csvReader.getRawRecord(), erroriList);
                        ...
                        if (!campiNonValorizzatiError) {
                            ...
                            if (resultQueryList != null) {
                                ...
                                this.createSerErrFileInput(CostantiDB.TipoErroreFileInputSerie.SQL_ERRATA.name(),
                                        new BigDecimal(index), csvReader.getRawRecord(), erroriList);
                                logger.error(SerieEjb.class.getSimpleName()
                    ...
                    counterUd += context.getBusinessObject(SerieEjb.class).handleQueryResult(
                            contenuto.getIdContenutoVerSerie(), fileInput.getIdFileInputVerSerie(), result, erroriList);
                    index++;
                }
            } else {
                throw new IllegalStateException(
        ...
        context.getBusinessObject(SerieEjb.class).handleAroUdAppartVerSerie(idUser, contenuto, counterUd,
                "Acquisizione serie", false, true);
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public int handleQueryResult(Long idContenutoVerSerie, long idFileInputVerSerie, ResultInputSerieBean result,
            List<SerErrFileInput> erroriList) {
        SerFileInputVerSerie fileInputVerSerie = helper.findById(SerFileInputVerSerie.class, idFileInputVerSerie);
        SerContenutoVerSerie contenuto = helper.findById(SerContenutoVerSerie.class, idContenutoVerSerie);
        int counter = 0;
        if (result.getResultQueryList() != null) {
            if (result.getResultQueryList().isEmpty()) {
                logger.info(SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Errore, nessuna UD");
                this.createSerErrFileInput(CostantiDB.TipoErroreFileInputSerie.NO_UD.name(), result.getIndexRecord(),
                        result.getRecord(), erroriList);
            } else if (result.getResultQueryList().size() > 1) {
                logger.info(SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Errore, troppe UD");
                SerErrFileInput errFileInput = this.createSerErrFileInput(
                        CostantiDB.TipoErroreFileInputSerie.TROPPE_UD.name(), result.getIndexRecord(),
                        result.getRecord(), erroriList);
                ...
                if (!helper.existUdInSerie(contenuto.getIdContenutoVerSerie(), resultRecord.getIdUnitaDoc())) {
                    counter++;
                    logger.info(SerieEjb.class.getSimpleName()
                            + " INPUT ASYNC SERIE --- Registra l'appartenenza dell'ud al contenuto");
                    context.getBusinessObject(SerieEjb.class).handleAroUnitaDoc(idContenutoVerSerie, resultRecord);
                } else {
                    logger.info(SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Errore, UD doppia");
                    SerErrFileInput errFileInput = this.createSerErrFileInput(
                            CostantiDB.TipoErroreFileInputSerie.UD_DOPPIA.name(), result.getIndexRecord(),
                            result.getRecord(), erroriList);
                    this.createSerUdErrFileInput(errFileInput, result.getResultQueryList());
                }
            }
        ...
        logger.debug(
                SerieEjb.class.getSimpleName() + " INPUT ASYNC SERIE --- Eseguo la persist di ogni errore riscontrato");
    ...
    private SerErrFileInput createSerErrFileInput(String tiErrRec, BigDecimal indexRecord, String recordString,
            List<SerErrFileInput> erroriList) {
    ...
    private void createSerUdErrFileInput(SerErrFileInput errFileInput, List<ResultVCalcoloSerieUd> udList) {
     ...
     * *** RICERCA ONLINE ***
     */
    public SerVRicSerieUdTableBean getSerVRicSerieUdTableBean(long idUserIam, RicercaSerieBean filtri) {
        ...
        if (list != null && !list.isEmpty()) {
            try {
                for (SerVRicSerieUd record : list) {
                    SerVRicSerieUdRowBean row = (SerVRicSerieUdRowBean) Transform.entity2RowBean(record);
                    row.setString("amb_ente_strut",
                            record.getNmAmbiente() + " - " + record.getNmEnte() + " - " + record.getNmStrut());
                    row.setString("ti_crea_nm_modello",
                            (StringUtils.isNotBlank(record.getTiCreaStandard()) ? record.getTiCreaStandard() : "")
    ...
    public SerVRicSerieUdUsrTableBean getSerVRicSerieUdUsrTableBean(long idUserIam, RicercaSerieBean filtri) {
        ...
        if (list != null && !list.isEmpty()) {
            try {
                for (SerVRicSerieUdUsr record : list) {
                    SerVRicSerieUdUsrRowBean row = (SerVRicSerieUdUsrRowBean) Transform.entity2RowBean(record);
                    row.setString("amb_ente_strut",
                            record.getNmAmbiente() + " - " + record.getNmEnte() + " - " + record.getNmStrut());
                    table.add(row);
                }
    ...
    public SerVRicSerieUdTableBean getSerVRicSerieUdTableBean(List<BigDecimal> verSeries, BigDecimal idStrut) {
        SerVRicSerieUdTableBean table = new SerVRicSerieUdTableBean();
    ...
    public SerVVisSerieUdRowBean getSerVVisSerieUdRowBean(BigDecimal idVerSerie) {
        ...
        if (serie != null) {
            try {
                ...
                List<SerUrnFileVerSerie> urnFileVerSerieList = helper.getUrnFileVerSerieByTipiUrn(idVerSerie,
                        Arrays.asList(TiUrnFileVerSerie.ORIGINALE, TiUrnFileVerSerie.NORMALIZZATO));
                // filtro la lista in base al tipo file ('MARCA_IX_AIP_UNISINCRO', 'IX_AIP_UNISINCRO_FIRMATO',
                // 'IX_AIP_UNISINCRO')
                List<SerUrnFileVerSerie> urnFileVerSerieFilteredList = (List<SerUrnFileVerSerie>) CollectionUtils
                        .select(urnFileVerSerieList, new Predicate() {
                            ...
                            public boolean evaluate(final Object object) {
                                return "MARCA_IX_AIP_UNISINCRO"
                                        .equals(((SerUrnFileVerSerie) object).getSerFileVerSerie().getTiFileVerSerie());
                            }
                        });
                if (urnFileVerSerieFilteredList.isEmpty()) {
                    urnFileVerSerieFilteredList = (List<SerUrnFileVerSerie>) CollectionUtils.select(urnFileVerSerieList,
                            new Predicate() {
                                @Override
                                public boolean evaluate(final Object object) {
                                    return "IX_AIP_UNISINCRO_FIRMATO".equals(
                                            ((SerUrnFileVerSerie) object).getSerFileVerSerie().getTiFileVerSerie());
                                }
                            });
                }
                if (urnFileVerSerieFilteredList.isEmpty()) {
                    urnFileVerSerieFilteredList = (List<SerUrnFileVerSerie>) CollectionUtils.select(urnFileVerSerieList,
                            new Predicate() {
                                @Override
                                public boolean evaluate(final Object object) {
                                    return "IX_AIP_UNISINCRO".equals(
                                            ((SerUrnFileVerSerie) object).getSerFileVerSerie().getTiFileVerSerie());
                                }
                            });
                }
                ...
                // end EVO#16486
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della serie " + ExceptionUtils.getRootCauseMessage(ex), ex);
    ...
    public String[] getFlContenutoBloccato(String nmJob, BigDecimal idContenutoVerSerie) {
        SerVJobContenutoBloccato view = helper.getSerVJobContenutoBloccato(nmJob, idContenutoVerSerie);
        String[] result = null;
        if (view != null) {
            result = new String[] { view.getFlJobBloccato(), view.getDlMsgJobBloccato() };
        }
        return result;
    }
    ...
    public boolean checkCsvHeaders(byte[] fileByteArray, BigDecimal idTipoSerie) throws IOException, ParerUserError {
        boolean result = true;
        if (idTipoSerie == null) {
        ...
        if (list.isEmpty()) {
            throw new ParerUserError("Per il tipo serie non sono definite le regole di acquisizione file");
        }
        /* Recupero il CSVReader */
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (SerVLisNotaSerieTableBean) Transform.entities2TableBean(list);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della lista note della serie di unit\u00e0 documentarie "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
            }
        }
        return table;
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (SerVLisStatoSerieTableBean) Transform.entities2TableBean(list);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della lista stati della serie di unit\u00e0 documentarie "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
            }
        }
        return table;
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (SerVLisVerSeriePrecTableBean) Transform.entities2TableBean(list);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della lista versioni della serie di unit\u00e0 documentarie "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
            }
        }
        return table;
    ...
    public boolean checkStatoConservazioneUdInContenEff(BigDecimal idVerSerie) {
        SerVChkConservazioneUd check = helper.findViewById(SerVChkConservazioneUd.class, idVerSerie);
        return (check.getFlOkStatoConservazione().equals("1"));
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void updateSerie(BigDecimal idSerie, BigDecimal idVerSerie, String cdComposito, String descSerie,
            BigDecimal anniConserv, Date dtInizioSelSerie, Date dtFineSelSerie, String dsListaAnniSelSerie,
            String tiPeriodoSelSerie, BigDecimal niPeriodoSelSerie) throws ParerUserError {
        ...
        if (serie != null) {
            context.getBusinessObject(SerieEjb.class).checkStatoSerie(idVerSerie,
                    CostantiDB.StatoVersioneSerie.APERTA.name(), CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name());
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteSerVerSerie(long idUser, BigDecimal idSerie, BigDecimal idVerSerie) throws ParerUserError {
        SerSerie serie = helper.findByIdWithLock(SerSerie.class, idSerie);
        if (serie != null) {
            ...
            if (view != null) {
                ...
                if (!view.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.APERTURA_IN_CORSO.name())
                        && !view.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.APERTA.name())
                        && !view.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name())) {
                    throw new ParerUserError(
                            "La serie non \u00E8 eliminabile perch\u00E9 lo stato \u00E8 diverso da APERTURA_IN_CORSO, APERTA e DA_CONTROLLARE");
                } else if (view.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.APERTA.name())
                        || view.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.APERTURA_IN_CORSO.name())) {
                    if (!context.getBusinessObject(SerieEjb.class).checkContenuto(idVerSerie, true, true, false,
                        ...
                        if (vistaSerie.getTiStatoContenutoCalc() != null) {
                            if (vistaSerie.getTiStatoContenutoCalc()
                                    .equals(CostantiDB.StatoContenutoVerSerie.CREAZIONE_IN_CORSO.name())) {
                                String[] blocco = context.getBusinessObject(SerieEjb.class).getFlContenutoBloccato(
                                        JobConstants.JobEnum.CALCOLO_SERIE.name(), vistaSerie.getIdContenutoCalc());
                                if (blocco != null) {
                                    if (blocco[0].equals("1")) {
                                        throwErr = false;
                                    }
                                }
                            } else if (vistaSerie.getTiStatoContenutoCalc()
                                    .equals(CostantiDB.StatoContenutoVerSerie.CONTROLLO_CONSIST_IN_CORSO.name())) {
                                String[] blocco = context.getBusinessObject(SerieEjb.class).getFlContenutoBloccato(
                        ...
                        if (vistaSerie.getTiStatoContenutoAcq() != null) {
                            if (vistaSerie.getTiStatoContenutoAcq()
                                    .equals(CostantiDB.StatoContenutoVerSerie.CREAZIONE_IN_CORSO.name())) {
                                String[] blocco = context.getBusinessObject(SerieEjb.class).getFlContenutoBloccato(
                                        JobConstants.JobEnum.INPUT_SERIE.name(), vistaSerie.getIdContenutoAcq());
                                if (blocco != null) {
                                    if (blocco[0].equals("1")) {
                                        throwErr = false;
                                    }
                                }
                            } else if (vistaSerie.getTiStatoContenutoAcq()
                                    .equals(CostantiDB.StatoContenutoVerSerie.CONTROLLO_CONSIST_IN_CORSO.name())) {
                                String[] blocco = context.getBusinessObject(SerieEjb.class).getFlContenutoBloccato(
                                        JobConstants.JobEnum.CONTROLLA_CONTENUTO_SERIE_UD.name(),
                ...
                } else if (view.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name())) {
                    if (!context.getBusinessObject(SerieEjb.class).checkContenuto(idVerSerie, false, false, true,
                            CostantiDB.StatoContenutoVerSerie.CREATO.name(),
                            CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name())) {
                        boolean throwErr = true;
                        if (vistaSerie.getTiStatoContenutoEff() != null) {
                            if (vistaSerie.getTiStatoContenutoEff()
                                    .equals(CostantiDB.StatoContenutoVerSerie.CREAZIONE_IN_CORSO.name())) {
                                String[] blocco = context.getBusinessObject(SerieEjb.class).getFlContenutoBloccato(
                            ...
                            } else if (vistaSerie.getTiStatoContenutoEff()
                                    .equals(CostantiDB.StatoContenutoVerSerie.CONTROLLO_CONSIST_IN_CORSO.name())) {
                                String[] blocco = context.getBusinessObject(SerieEjb.class).getFlContenutoBloccato(
                                        JobConstants.JobEnum.CONTROLLA_CONTENUTO_SERIE_UD.name(),
                                        vistaSerie.getIdContenutoEff());
            ...
            try {
                ...
                if (deleteSerie) {
                    ...
                    BigDecimal pg = lastStatoSerie != null ? lastStatoSerie.getPgStatoSerie().add(BigDecimal.ONE)
                            : BigDecimal.ONE;
                    statoSerie = context.getBusinessObject(SerieEjb.class).createSerStatoSerie(pg,
                            ...
                            "Eliminazione la versione corrente della serie", idUser, now, serie.getIdSerie());
                    logger.debug(SerieEjb.class.getSimpleName() + " --- Eseguo la persist del nuovo stato serie");
    ...
    public SerVVisVolVerSerieUdRowBean getSerVVisVolSerieUdRowBean(BigDecimal idVolVerSerie) {
        ...
        if (volume != null) {
            try {
                ...
                List<SerUrnIxVolVerSerie> urnIxVolVerSerieList = helper.getUrnIxVolVerSerieByTipiUrn(idVolVerSerie,
                        Arrays.asList(TiUrnIxVolVerSerie.ORIGINALE, TiUrnIxVolVerSerie.NORMALIZZATO));
                ...
                // end EVO#16486
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero del volume serie " + ExceptionUtils.getRootCauseMessage(ex),
                        ex);
    ...
    public void cleanContenutoSerie(BigDecimal idSerie, BigDecimal idVerSerie, String tipoContenuto)
            throws ParerUserError {
        cleanContenutoSerie(idSerie, idVerSerie, tipoContenuto, false, null, null, null, null, null);
    }

    public void cleanContenutoSerie(BigDecimal idSerie, BigDecimal idVerSerie, String cdDocFileInputVerSerie,
            String dsDocFileInputVerSerie, String flFornitoEnte, byte[] file, long idUser) throws ParerUserError {
        cleanContenutoSerie(idSerie, idVerSerie, CostantiDB.TipoContenutoVerSerie.ACQUISITO.name(), true,
                cdDocFileInputVerSerie, dsDocFileInputVerSerie, flFornitoEnte, file, idUser);
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void cleanContenutoSerie(BigDecimal idSerie, BigDecimal idVerSerie, String tipoContenuto,
            boolean ricreaFileInput, String cdDocFileInputVerSerie, String dsDocFileInputVerSerie, String flFornitoEnte,
            byte[] file, Long idUser) throws ParerUserError {
        SerSerie serie = helper.findByIdWithLock(SerSerie.class, idSerie);
        if (serie != null) {
            try {
                SerVerSerie verSerie = helper.findById(SerVerSerie.class, idVerSerie);
                if (tipoContenuto.equals(CostantiDB.TipoContenutoVerSerie.ACQUISITO.name()) && ricreaFileInput) {
                    ...
                    IamUser user = helper.findById(IamUser.class, idUser);
                    context.getBusinessObject(SerieEjb.class).createSerFileInputVerSerie(file, cdDocFileInputVerSerie,
                            dsDocFileInputVerSerie, flFornitoEnte,
                ...
                context.getBusinessObject(SerieEjb.class).createSerContenutoVerSerie(verSerie, tipoContenuto, now);
            } catch (Exception e) {
    ...
    public void checkStatoContenutoSerie(BigDecimal idVerSerie, boolean checkContenutoCalc, boolean checkContenutoAcq,
            boolean checkContenutoEff, String... statoContenuto) throws ParerUserError {
        ...
        for (String stato : statiContenuto) {
            errorMsg.append(stato).append(",");
            if (checkContenutoCalc
                    && ((serie.getTiStatoContenutoCalc() == null) || (serie.getTiStatoContenutoCalc().equals(stato)))) {
                errorCalc = false;
            }
            if (checkContenutoAcq
                    && ((serie.getTiStatoContenutoAcq() == null) || (serie.getTiStatoContenutoAcq().equals(stato)))) {
                errorAcq = false;
            }
            if (checkContenutoEff
                    && ((serie.getTiStatoContenutoEff() == null) || (serie.getTiStatoContenutoEff().equals(stato)))) {
                errorEff = false;
            }
        }
    ...
    /* DETTAGLIO CONTENUTO */
    public SerVVisContenutoSerieUdRowBean getSerVVisContenutoSerieUdRowBean(BigDecimal idContenutoVerSerie,
            String tipoContenuto) {
        SerVVisContenutoSerieUd contenuto = helper.findViewById(SerVVisContenutoSerieUd.class, idContenutoVerSerie);
        ...
        if (contenuto != null) {
            try {
                row = (SerVVisContenutoSerieUdRowBean) Transform.entity2RowBean(contenuto);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero del contenuto serie " + ExceptionUtils.getRootCauseMessage(ex),
                        ex);
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (SerVLisUdAppartSerieTableBean) Transform.entities2TableBean(list);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della lista unit\u00e0 documentarie appartenenti alla serie "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
            }
        }
        return table;
    ...
    public SerVLisErrContenSerieUdTableBean getSerVLisErrContenSerieUdTableBean(BigDecimal idContenutoVerSerie) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void initControlloContenuto(BigDecimal idSerie, BigDecimal idVerSerie, String tipoContenuto)
            throws ParerUserError {
        SerSerie serie = helper.findByIdWithLock(SerSerie.class, idSerie);
        if (serie != null) {
            ...
            SerContenutoVerSerie contenuto = helper.getSerContenutoVerSerie(idVerSerie.longValue(), tipoContenuto);
            contenuto.setTiStatoContenutoVerSerie(CostantiDB.StatoContenutoVerSerie.CONTROLLO_CONSIST_IN_CORSO.name());
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void riavvioControlloContenuto(BigDecimal idSerie, BigDecimal idVerSerie, BigDecimal idContenuto,
            String tipoContenuto) throws ParerUserError {
        SerSerie serie = helper.findByIdWithLock(SerSerie.class, idSerie);
        if (serie != null) {
            SerContenutoVerSerie contenuto = helper.getLockSerContenutoVerSerie(idVerSerie.longValue(), tipoContenuto);
            if (contenuto != null) {
                if (idContenuto.longValue() != contenuto.getIdContenutoVerSerie()) {
                    throw new ParerUserError("Errore inaspettato nel riavvio del controllo contenuto");
                }
                String[] blocco = getFlContenutoBloccato(JobConstants.JobEnum.CONTROLLA_CONTENUTO_SERIE_UD.name(),
                        idContenuto);
                if (blocco != null) {
                    if (blocco[0].equals("1")) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteAroUdAppartVerSerie(long idUser, BigDecimal idSerie, BigDecimal idUdAppartVerSerie)
            throws ParerUserError {
        SerSerie serie = helper.findByIdWithLock(SerSerie.class, idSerie);
        if (serie != null) {
            try {
                AroUdAppartVerSerie ud = helper.findById(AroUdAppartVerSerie.class, idUdAppartVerSerie);
                ...
                BigDecimal niUd = serContenutoVerSerie.getNiUdContenutoVerSerie().subtract(BigDecimal.ONE);
                serContenutoVerSerie.setNiUdContenutoVerSerie(niUd);
                if (serContenutoVerSerie.getIdFirstUdAppartVerSerie().longValue() == idUdAppartVerSerie.longValue()) {
                    Long firstUd = helper.getUdAppartVerSerie(serContenutoVerSerie.getIdContenutoVerSerie(), true);
                    serContenutoVerSerie
                            .setIdFirstUdAppartVerSerie(firstUd != null ? new BigDecimal(firstUd) : BigDecimal.ZERO);
                }
                if (serContenutoVerSerie.getIdLastUdAppartVerSerie().longValue() == idUdAppartVerSerie.longValue()) {
                    Long lastUd = helper.getUdAppartVerSerie(serContenutoVerSerie.getIdContenutoVerSerie(), false);
                    serContenutoVerSerie
                            .setIdLastUdAppartVerSerie(lastUd != null ? new BigDecimal(lastUd) : BigDecimal.ZERO);
                }
                ...
                if (statoCorrente != null && tipoContenuto.equals(CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name())
                        && statoCorrente.getTiStatoVerSerie()
                                .equals(CostantiDB.StatoVersioneSerie.CONTROLLATA.name())) {
                    SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                            statoCorrente.getPgStatoVerSerie().add(BigDecimal.ONE),
                            CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name(),
                            "Eliminazione di unit\u00E0 documentarie da serie", null, idUser, now,
                            verSerie.getIdVerSerie());
                    helper.insertEntity(statoVerSerie, false);
                    verSerie.setIdStatoVerSerieCor(new BigDecimal(statoVerSerie.getIdStatoVerSerie()));
                ...
                if (statoContenuto.equals(CostantiDB.StatoContenutoVerSerie.CREATO.name())
                        || statoContenuto.equals(CostantiDB.StatoContenutoVerSerie.CONTROLLATA_CONSIST.name())) {
    ...
    public void createZipSerQueryContenutoVerSerie(BigDecimal idContenuto, ZipOutputStream out, String prefixFile,
            String suffixFile) throws IOException {
        List<SerQueryContenutoVerSerie> serQueryContenutoVerSeries = helper.getSerQueryContenutoVerSerie(idContenuto);
        int counter = 1;
    ...
    public SerVVisConsistSerieUdRowBean getSerVVisConsistSerieUdRowBean(BigDecimal idConsist) {
        SerVVisConsistSerieUd contenuto = helper.findViewById(SerVVisConsistSerieUd.class, idConsist);
        ...
        if (contenuto != null) {
            try {
                ...
                logger.error("Errore durante il recupero della consistenza attesa serie "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
                throw new IllegalStateException("Errore durante il recupero della consistenza attesa");
            }
        }
        return row;
    }

    public SerLacunaConsistVerSerieTableBean getSerLacunaConsistVerSerieTableBean(BigDecimal idConsist) {
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (SerLacunaConsistVerSerieTableBean) Transform.entities2TableBean(list);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della lista lacune " + ExceptionUtils.getRootCauseMessage(ex),
                        ex);
            }
        }
        return table;
    ...
    /**
     * Verifica che le chiavi fornite nella consistenza attesa rispettino il formato registro-anno-numero corrispondenti
     * al tipo serie selezionato
     *
     * @param cdFirstUdAttesa
     *            codice prima unita doc in attesa
     * @param cdLastUdAttesa
     *            codice ultima unita doc in attesa
     * @param idTipoSerie
     *            id tipo serie
     * @param aaSerie
     *            anno serie
    ...
    public boolean checkChiaveUdConsistenzaAttesa(String cdFirstUdAttesa, String cdLastUdAttesa, BigDecimal idTipoSerie,
        ...
        if (StringUtils.isNotBlank(cdFirstUdAttesa) && StringUtils.isNotBlank(cdLastUdAttesa)) {
            for (DecTipoSerieUd tipoSerieUd : tipoSerie.getDecTipoSerieUds()) {
                String cdRegistroUnitaDoc = tipoSerieUd.getDecRegistroUnitaDoc().getCdRegistroUnitaDoc();
                if (cdFirstUdAttesa.startsWith(cdRegistroUnitaDoc + "-")) {
                    String annoNumero = StringUtils.substringAfter(cdFirstUdAttesa, cdRegistroUnitaDoc + "-");
                    if (StringUtils.isNotBlank(annoNumero) && annoNumero.startsWith(aaSerie.toPlainString() + "-")) {
                        firstUdAttesaCorretta = true;
                    }
                }

                if (cdLastUdAttesa.startsWith(cdRegistroUnitaDoc + "-")) {
                    String annoNumero = StringUtils.substringAfter(cdLastUdAttesa, cdRegistroUnitaDoc + "-");
                    if (StringUtils.isNotBlank(annoNumero) && annoNumero.startsWith(aaSerie.toPlainString() + "-")) {
     ...
     * @param cdRegistroFirst
     *            codice registro
     * @param aaUnitaDocFirst
     *            anno unita doc
     * @param cdUnitaDocFirst
     *            code anno unita doc
     * @param cdRegistroLast
     *            registro
     * @param aaUnitaDocLast
     *            anno unita doc
     ...
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public BigDecimal saveConsistenzaAttesa(long idUser, BigDecimal idConsistVerSerie, BigDecimal idSerie,
            BigDecimal idVerSerie, BigDecimal niUdAttese, String cdDocConsist, String dsDocConsist,
            Date dtComunicConsistVerSerie, String cdRegistroFirst, BigDecimal aaUnitaDocFirst, String cdUnitaDocFirst,
            String cdRegistroLast, BigDecimal aaUnitaDocLast, String cdUnitaDocLast) throws ParerUserError {
        return saveConsistenzaAttesa(idUser, idConsistVerSerie, idSerie, idVerSerie, niUdAttese,
                CostantiDB.ModalitaDefPrimaUltimaUd.CHIAVE_UD.name(), null, null, cdDocConsist, dsDocConsist,
                dtComunicConsistVerSerie, cdRegistroFirst, aaUnitaDocFirst, cdUnitaDocFirst, cdRegistroLast,
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public BigDecimal saveConsistenzaAttesa(long idUser, BigDecimal idConsistVerSerie, BigDecimal idSerie,
            BigDecimal idVerSerie, BigDecimal niUdAttese, String tiMod, String cdFirstUdAttesa, String cdLastUdAttesa,
            String cdDocConsist, String dsDocConsist, Date dtComunicConsistVerSerie) throws ParerUserError {
        return saveConsistenzaAttesa(idUser, idConsistVerSerie, idSerie, idVerSerie, niUdAttese, tiMod, cdFirstUdAttesa,
                cdLastUdAttesa, cdDocConsist, dsDocConsist, dtComunicConsistVerSerie, null, null, null, null, null,
                null);
    }

    private BigDecimal saveConsistenzaAttesa(long idUser, BigDecimal idConsistVerSerie, BigDecimal idSerie,
            BigDecimal idVerSerie, BigDecimal niUdAttese, String tiMod, String cdFirstUdAttesa, String cdLastUdAttesa,
            String cdDocConsist, String dsDocConsist, Date dtComunicConsistVerSerie, String cdRegistroFirst,
            BigDecimal aaUnitaDocFirst, String cdUnitaDocFirst, String cdRegistroLast, BigDecimal aaUnitaDocLast,
        ...
        if (serie != null) {
            ...
            if (checkVersione(idVerSerie, CostantiDB.StatoVersioneSerie.APERTA.name(),
                ...
                if (checkContenuto(idVerSerie, (view.getTiStatoContenutoCalc() != null),
                        (view.getTiStatoContenutoAcq() != null), (view.getTiStatoContenutoEff() != null),
                        CostantiDB.StatoContenutoVerSerie.CREATO.name(),
                        CostantiDB.StatoContenutoVerSerie.CONTROLLATA_CONSIST.name(),
                        CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name())) {
                    ...
                    if (tiMod != null && tiMod.equals(CostantiDB.ModalitaDefPrimaUltimaUd.PROGRESSIVO.name())) {
                    ...
                    if (idConsistVerSerie != null
                            && (tiMod == null || tiMod.equals(CostantiDB.ModalitaDefPrimaUltimaUd.CODICE.name()))) {
                        logger.debug("Controllo in modifica sulle lacune");
                        List<SerLacunaConsistVerSerie> serLacunaConsistVerSerie = helper.getSerLacunaConsistVerSerie(
                                idConsistVerSerie, CostantiDB.TipoModLacuna.RANGE_PROGRESSIVI.name(), null, null);
                    ...
                    if (idConsistVerSerie != null) {
                        ...
                        consist.setSerLacunaConsistVerSeries(new ArrayList<SerLacunaConsistVerSerie>());
                    ...
                    if (tiMod != null) {
                        if (tiMod.equals(CostantiDB.ModalitaDefPrimaUltimaUd.PROGRESSIVO.name())) {
                            setConsistValuesForTiModProgressivo(consist, new BigDecimal(cdFirstUdAttesa),
                                    new BigDecimal(cdLastUdAttesa));
                        } else if (tiMod.equals(CostantiDB.ModalitaDefPrimaUltimaUd.CODICE.name())) {
                            setConsistValuesForTiModCodice(consist, cdFirstUdAttesa, cdLastUdAttesa);
                        } else if (tiMod.equals(CostantiDB.ModalitaDefPrimaUltimaUd.CHIAVE_UD.name())) {
                            setConsistValuesForTiModChiaveUd(consist, cdRegistroFirst, aaUnitaDocFirst, cdUnitaDocFirst,
    ...
    private void setConsistValuesForTiModProgressivo(SerConsistVerSerie consist, BigDecimal niFirstUnitaDocAttesa,
            BigDecimal niLastUnitaDocAttesa) {
        setConsistValuesForTiMod(consist, niFirstUnitaDocAttesa, niLastUnitaDocAttesa, null, null, null, null, null,
                null, null, null);
    }

    private void setConsistValuesForTiModCodice(SerConsistVerSerie consist, String cdFirstUdAttesa,
            String cdLastUdAttesa) {
        setConsistValuesForTiMod(consist, null, null, cdFirstUdAttesa, cdLastUdAttesa, null, null, null, null, null,
                null);
    }

    private void setConsistValuesForTiModChiaveUd(SerConsistVerSerie consist, String cdRegistroFirst,
            BigDecimal aaUnitaDocFirst, String cdUnitaDocFirst, String cdRegistroLast, BigDecimal aaUnitaDocLast,
            String cdUnitaDocLast) {
        setConsistValuesForTiMod(consist, null, null, null, null, cdRegistroFirst, aaUnitaDocFirst, cdUnitaDocFirst,
                cdRegistroLast, aaUnitaDocLast, cdUnitaDocLast);
    }

    private void setConsistValuesForTiModEmpty(SerConsistVerSerie consist) {
        setConsistValuesForTiMod(consist, null, null, null, null, null, null, null, null, null, null);
    }

    private void setConsistValuesForTiMod(SerConsistVerSerie consist, BigDecimal niFirstUnitaDocAttesa,
            BigDecimal niLastUnitaDocAttesa, String cdFirstUdAttesa, String cdLastUdAttesa, String cdRegistroFirst,
            BigDecimal aaUnitaDocFirst, String cdUnitaDocFirst, String cdRegistroLast, BigDecimal aaUnitaDocLast,
            String cdUnitaDocLast) {
    ...
    private void handleStatoSerieDaConsistenzaAttesa(SerVerSerie verSerie, String azione, long idUser)
            throws ParerUserError, IllegalStateException {
        SerStatoVerSerie statoCorrente = helper.findById(SerStatoVerSerie.class, verSerie.getIdStatoVerSerieCor());
        if (statoCorrente != null) {
            if (statoCorrente.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.CONTROLLATA.name())
                    || statoCorrente.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.DA_VALIDARE.name())) {
                ...
                SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                        ...
                        Calendar.getInstance().getTime(), verSerie.getIdVerSerie());
                logger.debug(SerieEjb.class.getSimpleName() + " --- Eseguo la persist del nuovo stato versione");
                helper.insertEntity(statoVerSerie, false);
                verSerie.setIdStatoVerSerieCor(new BigDecimal(statoVerSerie.getIdStatoVerSerie()));
            }
        } else {
        ...
        if (contenCalc != null && contenCalc.getTiStatoContenutoVerSerie()
            ...
            contenCalc.setTiStatoContenutoVerSerie(CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name());
        }
        if (contenAcq != null && contenAcq.getTiStatoContenutoVerSerie()
                .equals(CostantiDB.StatoContenutoVerSerie.CONTROLLATA_CONSIST.name())) {
            contenAcq.setTiStatoContenutoVerSerie(CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name());
        }
        if (contenEff != null && contenEff.getTiStatoContenutoVerSerie()
                .equals(CostantiDB.StatoContenutoVerSerie.CONTROLLATA_CONSIST.name())) {
            contenEff.setTiStatoContenutoVerSerie(CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name());
            helper.deleteSerVerSerieDaElab(new BigDecimal(verSerie.getIdVerSerie()));
        }
    }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public Future<String> callGenerazioneEffettivoAsync(long idUser, long idVerSerie, boolean fromCalc,
            boolean fromAcq) {
        logger.info(SerieEjb.class.getSimpleName() + " --- Inizio chiamata asincrona...");
        Future<String> future = null;
        try {
            future = context.getBusinessObject(SerieEjb.class).generazioneEffettivoAsync(idUser, idVerSerie, fromCalc,
                    fromAcq);
        } catch (Exception e) {
            // INUTILI in quanto intercettati
        }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public Future<Map<String, ?>> callGenerazioneEffettivoAsync(Map<String, BigDecimal> idVerSeries) {
        logger.info(SerieEjb.class.getSimpleName() + " --- Inizio chiamata asincrona...");
        Future<Map<String, ?>> futures = null;
        try {
            futures = context.getBusinessObject(SerieEjb.class).generazioneEffettivoAsync(idVerSeries);
        } catch (Exception e) {
            // INUTILI in quanto intercettati
        }
        logger.info(SerieEjb.class.getSimpleName() + " --- Fine chiamata asincrona...");
    ...
    @Asynchronous
    public Future<String> generazioneEffettivoAsync(long idUser, long idVerSerie, boolean fromCalc, boolean fromAcq)
            throws ParerInternalError {
        SerContenutoVerSerie contenuto = null;
        boolean error = false;
        try {
            logger.info(SerieEjb.class.getSimpleName() + " --- Richiesta LOCK su contenuto di tipo EFFETTIVO");
            contenuto = helper.getLockSerContenutoVerSerie(idVerSerie,
                    CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name());
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.GENERAZIONE_CONTENUTO_EFFETTIVO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.INIZIO_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
                context.getBusinessObject(SerieEjb.class).generazioneEffettivo(idUser, contenuto, fromCalc, fromAcq,
                        false);
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.GENERAZIONE_CONTENUTO_EFFETTIVO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
    ...
    public String generazioneContenutoEffettivoSingleTx(BigDecimal idVerSerieEntry, long idUser) {
        ...
        boolean error = false;
        try {
            logger.debug(SerieEjb.class.getSimpleName() + " --- Richiesta LOCK su contenuto EFFETTIVO con id_ver_serie "
                    + idVerSerieEntry.toPlainString());
            contenuto = helper.getLockSerContenutoVerSerie(idVerSerieEntry.longValue(),
                    CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name());
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.GENERAZIONE_CONTENUTO_EFFETTIVO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.INIZIO_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
                context.getBusinessObject(SerieEjb.class).generazioneEffettivo(idUser, contenuto, true, false, true);
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.GENERAZIONE_CONTENUTO_EFFETTIVO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
            }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void generazioneEffettivo(long idUser, SerContenutoVerSerie contenuto, boolean fromCalc, boolean fromAcq,
        ...
        if (fromCalc && fromAcq) {
            ...
            udDaCreare = helper.getAroUdAppartVerSerie(idVerSerie, CostantiDB.TipoContenutoVerSerie.CALCOLATO.name(),
            ...
            udDaCreare = helper.getAroUdAppartVerSerie(idVerSerie, CostantiDB.TipoContenutoVerSerie.ACQUISITO.name(),
                    null, false);
            azione = azione.concat("il contenuto di tipo ACQUISITO");
        }
        logger.info("Il nuovo contenuto conterr\u00E0 " + udDaCreare.size() + " unit\u00E0 documentarie");
        int counterUd = 0;
        for (ResultVCalcoloSerieUd ud : udDaCreare) {
            context.getBusinessObject(SerieEjb.class).handleAroUnitaDoc(contenuto.getIdContenutoVerSerie(), ud);
        }
        ...
        SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                statoCorrente.getPgStatoVerSerie().add(BigDecimal.ONE),
                CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name(), azione, null, idUser, now,
                verSerie.getIdVerSerie());
        ...
        if (calcoloAutomatico && tipoSerie.getTiStatoVerSerieAutom() == null) {
            throw new IllegalStateException(
                ...
                && (tipoSerie.getTiStatoVerSerieAutom().equals(CostantiDB.StatoVersioneSerie.CONTROLLATA.name())
                        || tipoSerie.getTiStatoVerSerieAutom()
                                .equals(CostantiDB.StatoVersioneSerie.DA_VALIDARE.name()))) {
            SerVerSerieDaElab verSerieDaElab = helper.getSerVerSerieDaElabByIdVerSerie(verSerie.getIdVerSerie());
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public Future<String> callControlloContenutoAsync(long idUser, long idVerSerie, String tipoContenuto) {
        logger.info(SerieEjb.class.getSimpleName() + " --- Inizio chiamata asincrona...");
        Future<String> future = null;
        try {
            future = context.getBusinessObject(SerieEjb.class).controlloContenutoAsync(idUser, idVerSerie,
                    tipoContenuto);
        } catch (Exception e) {
            // INUTILI in quanto intercettati
        }
    ...
    public Future<Map<String, ?>> callControlloContenutoAsync(Map<String, BigDecimal> idVerSeries) {
        ...
        Future<Map<String, ?>> futures = null;
        try {
            futures = context.getBusinessObject(SerieEjb.class).controlloContenutoAsync(idVerSeries);
        } catch (Exception e) {
            // INUTILI in quanto intercettati
        }
        logger.info(SerieEjb.class.getSimpleName() + " --- Fine chiamata asincrona...");
    ...
    @Asynchronous
    public Future<String> controlloContenutoAsync(long idUser, long idVerSerie, String tipoContenuto) {
        SerContenutoVerSerie contenuto = null;
        boolean error = false;
        try {
            logger.info(SerieEjb.class.getSimpleName() + " --- Richiesta LOCK su contenuto di tipo " + tipoContenuto);
            contenuto = helper.getLockSerContenutoVerSerie(idVerSerie, tipoContenuto);
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.CONTROLLA_CONTENUTO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.INIZIO_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
                context.getBusinessObject(SerieEjb.class).controlloContenuto(idUser, contenuto, false);
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.CONTROLLA_CONTENUTO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
            }
            logger.info(SerieEjb.class.getSimpleName() + " --- FINE chiamata asincrona per controllo contenuto serie");
        } catch (Exception e) {
            error = true;
        ...
        try {
            ...
            if (contenuto != null) {
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.CONTROLLA_CONTENUTO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.INIZIO_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
                context.getBusinessObject(SerieEjb.class).controlloContenuto(idUser, contenuto, true);
                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.CONTROLLA_CONTENUTO_SERIE_UD.name(),
                        JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(), null, contenuto.getIdContenutoVerSerie(),
                        contenuto.getClass().getSimpleName());
            }
            logger.debug(SerieEjb.class.getSimpleName() + " --- FINE chiamata asincrona per controllo contenuto serie");
        } catch (Exception e) {
            error = true;
            String messaggio = "Eccezione imprevista durante la fase di controllo contenuto serie:";
            messaggio += ExceptionUtils.getRootCauseMessage(e);
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void controlloContenuto(long idUser, SerContenutoVerSerie contenuto, boolean calcoloAutomatico) {
        logger.info(SerieEjb.class.getSimpleName()
        ...
        logger.info(
                SerieEjb.class.getSimpleName() + "--- CONTROLLA_CONTENUTO_SERIE_UD --- START - Ricerca chiavi doppie");
        List<String> codiciDuplicati = helper.getAroUdAppartChiaveDoppia(contenuto.getIdContenutoVerSerie());
        if (!codiciDuplicati.isEmpty()) {
            for (String codice : codiciDuplicati) {
                ...
                context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(
                        contenuto.getIdContenutoVerSerie(), pg++, CostantiDB.TipoErroreContenuto.CHIAVE_DOPPIA.name(),
                        dlErr, CostantiDB.TipoGravitaErrore.ERRORE.name(), origineErrore);
            }
        }
        logger.info(
                SerieEjb.class.getSimpleName() + "--- CONTROLLA_CONTENUTO_SERIE_UD --- END - Ricerca chiavi doppie");
        SerVerSerie verSerie = contenuto.getSerVerSerie();
        ...
        if (serConsistVerSeries.isEmpty()) {
            ...
            context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(contenuto.getIdContenutoVerSerie(),
                    pg++, CostantiDB.TipoErroreContenuto.CONSISTENZA_NON_DEFINITA.name(), dlErr, tipoGravita,
                    origineErrore);
        } else {
            logger.info(SerieEjb.class.getSimpleName()
            ...
            if ((consistUdAttese = consistenza.getNiUnitaDocAttese()) != null) {
                ...
                if (!consistUdAttese.equals(contenUd)) {
                    String dlErr = "La consistenza attesa prevede " + consistUdAttese.toPlainString()
                            + " unit\u00E0 documentarie," + " mentre il contenuto ha " + contenUd.toPlainString()
                            + " unit\u00E0 documentarie";
                    context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(
            ...
            List<ResultVCalcoloSerieUd> aroUdAppartVerSerie = helper.getAroUdAppartVerSerie(idVerSerie.longValue(),
                    contenuto.getTiContenutoVerSerie(), null, false);
            if (!aroUdAppartVerSerie.isEmpty()) {
                String cdFirstAroUdAppartVerSerie = aroUdAppartVerSerie.get(0).getKeyUdSerie();
                String cdLastAroUdAppartVerSerie = aroUdAppartVerSerie.get(aroUdAppartVerSerie.size() - 1)
                        .getKeyUdSerie();
                BigDecimal firstIdUnitaDoc = aroUdAppartVerSerie.get(0).getIdUnitaDoc();
                BigDecimal lastIdUnitaDoc = aroUdAppartVerSerie.get(aroUdAppartVerSerie.size() - 1).getIdUnitaDoc();
                if (consistenza.getTiModConsistFirstLast() != null) {
                    ...
                    if (consistenza.getTiModConsistFirstLast()
                        ...
                        String firstChiave = firstUd.getCdRegistroKeyUnitaDoc() + "-"
                                + firstUd.getAaKeyUnitaDoc().toPlainString() + "-" + firstUd.getCdKeyUnitaDoc();
                        AroUnitaDoc lastUd = helper.findById(AroUnitaDoc.class, lastIdUnitaDoc);
                        String lastChiave = lastUd.getCdRegistroKeyUnitaDoc() + "-"
                                + lastUd.getAaKeyUnitaDoc().toPlainString() + "-" + lastUd.getCdKeyUnitaDoc();

                        String cdFirstUdAttesa = (consistenza.getCdRegistroFirst() != null
                                && consistenza.getAaUnitaDocFirst() != null && consistenza.getCdUnitaDocFirst() != null)
                        ...
                        String cdLastUdAttesa = (consistenza.getCdRegistroLast() != null
                                && consistenza.getAaUnitaDocLast() != null && consistenza.getCdUnitaDocLast() != null)
                        ...
                        List<ResultVCalcoloSerieUd> aroUdAppartVerSeriePgNull = helper.getAroUdAppartVerSerie(
                                idVerSerie.longValue(), contenuto.getTiContenutoVerSerie(), null, true);
                        ...
                        BigDecimal niFirstAroUdAppartVerSerie = aroUdAppartVerSerie.get(0).getPgUdSerie();
                        BigDecimal niLastAroUdAppartVerSerie = aroUdAppartVerSerie.get(aroUdAppartVerSerie.size() - 1)
                                .getPgUdSerie();
                            ...
                            if (niFirstAroUdAppartVerSerie != null) {
                                if (!niFirstUdAttesa.equals(niFirstAroUdAppartVerSerie)) {
                                    if ((niFirstUdAttesa.compareTo(niFirstAroUdAppartVerSerie) < 0
                                            && !existLacuna(new BigDecimal(consistenza.getIdConsistVerSerie()), null,
                                                    niFirstUdAttesa, niFirstUdAttesa))
                                            || niFirstUdAttesa.compareTo(niFirstAroUdAppartVerSerie) > 0) {
                            ...
                            if (niLastAroUdAppartVerSerie != null) {
                                if (!niLastUdAttesa.equals(niLastAroUdAppartVerSerie)) {
                                    if ((niLastUdAttesa.compareTo(niLastAroUdAppartVerSerie) > 0
                                            && !existLacuna(new BigDecimal(consistenza.getIdConsistVerSerie()), null,
                                                    niLastUdAttesa, niLastUdAttesa))
                                            || niLastUdAttesa.compareTo(niLastAroUdAppartVerSerie) < 0) {
                        ...
                        for (SerVBucoNumerazioneUd buco : listaBuchiNum) {
                            ...
                            List<SerLacunaConsistVerSerie> lacuneList = helper.getSerLacunaConsistVerSerie(
                                    ...
                                    CostantiDB.TipoModLacuna.RANGE_PROGRESSIVI.name(), pgUdSerIniBuco, pgUdSerFinBuco);
                            if (lacuneList.isEmpty()) {
                                ...
                                if (existLacuna(new BigDecimal(consistenza.getIdConsistVerSerie()), null,
                                        pgUdSerIniBuco, pgUdSerFinBuco)) {
                                    /*
                                     * Controlla se esiste almeno una lacuna (comunicata con modalita =
                                     * RANGE_PROGRESSIVI) della consistenza attesa, il cui intervallo si sovrappone o e?
                                     * incluso con quello del buco di numerazione
                                     */
                                    dlErr += "\u00E8 solo parzialmente giustificata da una (o pi\u00F9) lacune della consistenza attesa";
                                    serErrContenutoVerSerie = context.getBusinessObject(SerieEjb.class)
                                            .createSerErrContenutoVerSerie(contenuto.getIdContenutoVerSerie(), pg++,
                                ...
                                /*
                                 * se il tipo di serie della serie del contenuto in input prevede la possibilit\u00E0 di
                                 * selezionare le unit\u00E0 doc non versate a fronte di un buco di numerazione (vedi
                                 * vista SER_V_CHK_DEF_UD_NOVERS_BUCO (cio\u00E8 che il campo in output di tipo
                                 * KEY_UD_SERIE sia definito solo con i campi REGISTRO, ANNO e PROGRESSIVO di tipo
                                 * DATO_PROFILO e che il registro abbia formato standard (cio\u00E8 preveda solo
                                 * numeri))
                                 */
                                SerVChkDefUdNoversBuco checkBuchi = helper.findViewById(SerVChkDefUdNoversBuco.class,
                                        idVerSerie);
                                if (checkBuchi != null && checkBuchi.getFlDefUdNonVers().equals("1")) {
                                     ...
                                     */
                                    List<SerVSelUdNoversBuco> udNonVersate = helper.getSerVSelUdNoversBuco(idVerSerie,
                                            pgUdSerIniBuco, pgUdSerFinBuco);
                        ...
                        List<SerLacunaConsistVerSerie> lacuneList = helper.getSerLacunaConsistVerSerie(
                                new BigDecimal(consistenza.getIdConsistVerSerie()),
                                CostantiDB.TipoModLacuna.RANGE_PROGRESSIVI.name(), null, null);
                        for (SerLacunaConsistVerSerie lacuna : lacuneList) {
                            Long count = helper.countAroUdAppartVerSerieInPgInterval(contenuto.getIdContenutoVerSerie(),
                                    lacuna.getNiIniLacuna(), lacuna.getNiFinLacuna());
                            if (count > 0L) {
                                ...
                                context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(
                                        contenuto.getIdContenutoVerSerie(), pg++,
                                        CostantiDB.TipoErroreContenuto.LACUNA_ERRATA.name(), dlErr,
                                        CostantiDB.TipoGravitaErrore.ERRORE.name(), origineErrore);
                            }
                        }
                    }
        ...
        if (contenuto.getTiContenutoVerSerie().equals(CostantiDB.TipoContenutoVerSerie.CALCOLATO.name())) {
            List<SerQueryContenutoVerSerie> queries = helper
                    .getSerQueryContenutoVerSerie(new BigDecimal(contenuto.getIdContenutoVerSerie()));
            pg = context.getBusinessObject(SerieEjb.class).controllaUdNonSelezionateInContenutoCalcolato(queries,
                    contenuto, pg, dataRiferimento, origineErrore);
            SerStatoVerSerie statoVerSerie = helper.getLastSerStatoVerSerieWithStatus(idVerSerie.longValue(),
            ...
            if (statoVerSerie != null) {
                ...
                pg = context.getBusinessObject(SerieEjb.class).controllaUdVersateDopoCalcolo(queries,
                        contenuto.getIdContenutoVerSerie(), contenuto, pg, dtRif, origineErrore);
                logger.info(SerieEjb.class.getSimpleName()
                        + "--- CONTROLLA_CONTENUTO_SERIE_UD --- END - Controllo unit\u00E0 documentarie versate dopo calcolo");
            }
        } else if (contenuto.getTiContenutoVerSerie().equals(CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name())) {
            SerContenutoVerSerie contenutoCalcolato = helper.getSerContenutoVerSerie(verSerie.getIdVerSerie(),
                    CostantiDB.TipoContenutoVerSerie.CALCOLATO.name());
            if (contenutoCalcolato != null) {
                List<SerQueryContenutoVerSerie> queries = helper
                        .getSerQueryContenutoVerSerie(new BigDecimal(contenutoCalcolato.getIdContenutoVerSerie()));
                pg = context.getBusinessObject(SerieEjb.class).controllaUdNonSelezionateInContenutoCalcolato(queries,
                        contenuto, pg, dataRiferimento, origineErrore);
                SerStatoVerSerie statoVerSerie = helper.getLastSerStatoVerSerieWithStatus(idVerSerie.longValue(),
                        CostantiDB.StatoVersioneSerie.APERTA.name());
                if (statoVerSerie != null) {
                    ...
                    logger.info(SerieEjb.class.getSimpleName()
                            + "--- CONTROLLA_CONTENUTO_SERIE_UD --- START - Controllo unit\u00E0 documentarie versate dopo calcolo");
                    pg = context.getBusinessObject(SerieEjb.class).controllaUdVersateDopoCalcolo(queries,
                            contenuto.getIdContenutoVerSerie(), contenutoCalcolato, pg, dtRif, origineErrore);
                    logger.info(SerieEjb.class.getSimpleName()
                            + "--- CONTROLLA_CONTENUTO_SERIE_UD --- END - Controllo unit\u00E0 documentarie versate dopo calcolo");
                }
            }
        ...
        pg = context.getBusinessObject(SerieEjb.class).controllaUdAnnullate(
                verSerie.getSerSerie().getDecTipoSerie().getIdTipoSerie(), contenuto, dataRiferimento, pg,
                origineErrore);
        logger.info(SerieEjb.class.getSimpleName()
        ...
        if (StringUtils.isNotBlank(verSerie.getDsListaAnniSelSerie())
            ...
            // se per la versione serie e' definita la lista degli anni di selezione delle unita doc e se tale lista
            ...
            String dsListaAnniSelSerie = verSerie.getDsListaAnniSelSerie()
                    .replace(verSerie.getSerSerie().getAaSerie().toPlainString(), "").replace(",,", ",");
            ...
            for (String anno : anni) {
                ...
                if (count > 0L) {
                    String dlErr = "Sono presenti unit\u00E0 documentarie non versate, relative all'anno " + anno
                            + ", diverso da quello della serie, che potrebbero appartenere alla serie";
                    context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(
                            contenuto.getIdContenutoVerSerie(), pg++, CostantiDB.TipoErroreContenuto.UD_NON_VERS.name(),
                            dlErr, CostantiDB.TipoGravitaErrore.WARNING.name(), origineErrore);
                }
            }
            logger.info(SerieEjb.class.getSimpleName()
        ...
        AroUdAppartVerSerie first = helper.findById(AroUdAppartVerSerie.class, contenuto.getIdFirstUdAppartVerSerie());
        AroUdAppartVerSerie last = helper.findById(AroUdAppartVerSerie.class, contenuto.getIdLastUdAppartVerSerie());
        ...
        if (first != null && last != null) {
            SimpleDateFormat df = new SimpleDateFormat(Constants.DATE_FORMAT_DATE_TYPE);
            logger.debug(SerieEjb.class.getSimpleName() + "--- Controllo date ud: DATA MINIMA delle ud - "
                    + df.format(min) + ". DATA PRIMA UD - " + df.format(first.getDtUdSerie()));
            if (first.getDtUdSerie().getTime() != min.getTime()) {
                String dlErr = "La prima unit\u00E0 documentaria ha data (" + df.format(first.getDtUdSerie())
            ...
            logger.debug(SerieEjb.class.getSimpleName() + "--- Controllo date ud: DATA MASSIMA delle ud - "
                    + df.format(max) + ". DATA ULTIMA UD - " + df.format(last.getDtUdSerie()));
            if (last.getDtUdSerie().getTime() != max.getTime()) {
                String dlErr = "L'ultima unit\u00E0 documentaria ha data (" + df.format(last.getDtUdSerie())
        ...
        if (helper.countSerieWithoutPgSerieUd(tipoSerie.getIdTipoSerie()) == 0L && (serConsistVerSeries.isEmpty()
                || serConsistVerSeries.get(0).getTiModConsistFirstLast() == null || serConsistVerSeries.get(0)
                        .getTiModConsistFirstLast().equals(CostantiDB.ModalitaDefPrimaUltimaUd.CODICE.name()))) {
            logger.debug(SerieEjb.class.getSimpleName()
            ...
            for (SerVBucoNumerazioneUd buco : listaBuchiNum) {
                ...
                SerErrContenutoVerSerie serErrContenutoVerSerie = context.getBusinessObject(SerieEjb.class)
                        .createSerErrContenutoVerSerie(contenuto.getIdContenutoVerSerie(), pg++,
                                CostantiDB.TipoErroreContenuto.BUCO_NUMERAZIONE.name(), dlErr,
                                CostantiDB.TipoGravitaErrore.ERRORE.name(), origineErrore);
                /*
                 * se il tipo di serie della serie del contenuto in input prevede la possibilit\u00E0 di selezionare le
                 * unit\u00E0 doc non versate a fronte di un buco di numerazione (vedi vista
                 * SER_V_CHK_DEF_UD_NOVERS_BUCO (cioe per tutte le coppie registro ? tipo unita doc sia definito
                 * PG_UD_SERIE mediante il solo NUMERO di tipo DATO_PROFILO e che ogni registro preveda, per ogni
                 * intervallo di anni, una sola parte che definisce il progressivo))
                 */
                logger.info(SerieEjb.class.getSimpleName()
                        + "--- CONTROLLA_CONTENUTO_SERIE_UD --- START - Controllo unit\u00E0 documentarie non versate per buco di numerazione");
                SerVChkDefUdNoversBuco checkBuchi = helper.findViewById(SerVChkDefUdNoversBuco.class, idVerSerie);
                if (checkBuchi != null && checkBuchi.getFlDefUdNonVers().equals("1")) {
                    /*
                     * unit\u00E0 doc non versate relative ai registri previsti dal tipo serie ed all'anno della serie,
                     * il cui numero e' compreso nel buco di numerazione
                     */
                    List<SerVSelUdNoversBuco> udNonVersate = helper.getSerVSelUdNoversBuco(idVerSerie, pgUdSerIniBuco,
                            pgUdSerFinBuco);
                    for (SerVSelUdNoversBuco ud : udNonVersate) {
        ...
        Date now = Calendar.getInstance().getTime();
        contenuto.setTiStatoContenutoVerSerie(CostantiDB.StatoContenutoVerSerie.CONTROLLATA_CONSIST.name());
        contenuto.setDtStatoContenutoVerSerie(now);

        if (contenuto.getTiContenutoVerSerie().equals(CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name())) {
            SerStatoVerSerie statoCorrente = helper.findById(SerStatoVerSerie.class, verSerie.getIdStatoVerSerieCor());
            logger.info(SerieEjb.class.getSimpleName()
            ...
            SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                    statoCorrente.getPgStatoVerSerie().add(BigDecimal.ONE),
                    CostantiDB.StatoVersioneSerie.CONTROLLATA.name(),
                    "Controllo contenuto serie di tipo " + contenuto.getTiContenutoVerSerie(), null, idUser, now,
                    verSerie.getIdVerSerie());
            ...
            if (calcoloAutomatico) {
                if (helper.countAroUdAppartVerSerie(contenuto.getIdContenutoVerSerie()) == 0) {
                    ...
                    SerStatoVerSerie statoVerSerieAutom = context.getBusinessObject(SerieEjb.class)
                            .createSerStatoVerSerie(statoVerSerie.getPgStatoVerSerie().add(BigDecimal.ONE),
                                    CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name(),
                    ...
                    verSerie.setIdStatoVerSerieCor(new BigDecimal(statoVerSerieAutom.getIdStatoVerSerie()));
                    ...
                    contenuto.setDtStatoContenutoVerSerie(now);
                        ...
                        || (helper.countSerErrContenutoVerSerie(new BigDecimal(contenuto.getIdContenutoVerSerie()),
                                CostantiDB.TipoGravitaErrore.ERRORE.name(),
                                CostantiDB.TipoErroreContenuto.CONSISTENZA_NON_DEFINITA.name(), null) > 0L)) {
                    logger.info(SerieEjb.class.getSimpleName()
                            + " --- CONTROLLA_CONTENUTO_SERIE_UD --- Aggiorna lo stato della versione per presenza errori nella generazione automatica");
                    SerStatoVerSerie statoVerSerieAutom = context.getBusinessObject(SerieEjb.class)
                            .createSerStatoVerSerie(statoVerSerie.getPgStatoVerSerie().add(BigDecimal.ONE),
                                    CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name(),
                                    "Il controllo contenuto serie di tipo " + contenuto.getTiContenutoVerSerie()
                    ...
                    SerStatoVerSerie statoVerSerieAutom = context.getBusinessObject(SerieEjb.class)
                            .createSerStatoVerSerie(statoVerSerie.getPgStatoVerSerie().add(BigDecimal.ONE),
                                    CostantiDB.StatoVersioneSerie.DA_VALIDARE.name(), "La serie deve essere validata",
                                    null, idUser, now, verSerie.getIdVerSerie());
    ...
    public int controllaUdAnnullate(Long idTipoSerie, SerContenutoVerSerie contenuto, Date dataRiferimento, int pg,
            final String origineErrore) throws IllegalStateException {
        List<DecTipoSerieUd> tipiSerieUd = helper.getDecTipoSerieUdNoSelUnitaDocAnnul(idTipoSerie);
        for (DecTipoSerieUd tipoSerieUd : tipiSerieUd) {
            SimpleDateFormat df = new SimpleDateFormat(Constants.DATE_FORMAT_TIMESTAMP_TYPE);
            List<AroUdAppartVerSerie> aroUnitaDocs = helper.getAroUnitaDocAnnullateInContenutoWithTipoSerieUd(
                    contenuto.getIdContenutoVerSerie(), tipoSerieUd.getDecRegistroUnitaDoc().getIdRegistroUnitaDoc(),
            ...
            for (AroUdAppartVerSerie udAppart : aroUnitaDocs) {
                ...
                String dlErr = "L'unit\u00E0 documentaria " + udAppart.getCdUdSerie() + " ( "
                        + ud.getCdRegistroKeyUnitaDoc() + "-" + ud.getAaKeyUnitaDoc().toPlainString() + "-"
                        + ud.getCdKeyUnitaDoc() + " ) \u00E8 stata annullata successivamente all'istante "
                        + df.format(dataRiferimento) + " e la coppia registro "
                        + tipoSerieUd.getDecRegistroUnitaDoc().getCdRegistroUnitaDoc()
                        + " - tipo di unit\u00E0 documentaria " + tipoSerieUd.getDecTipoUnitaDoc().getNmTipoUnitaDoc()
                        + ", previsti dal tipo di serie, "
                        + "non consente di selezionare unit\u00E0 documentarie annullate";
                context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(
                        contenuto.getIdContenutoVerSerie(), pg++, CostantiDB.TipoErroreContenuto.UD_ANNULLATA.name(),
                        dlErr, CostantiDB.TipoGravitaErrore.ERRORE.name(), origineErrore);
            }
        }
        return pg;
    ...
    public int controllaContenutoEffettivoNonVuoto(SerContenutoVerSerie contenuto, int pg, final String origineErrore) {
        if (helper.countAroUdAppartVerSerie(contenuto.getIdContenutoVerSerie()) == 0) {
            logger.info(SerieEjb.class.getSimpleName()
                    + " --- CONTROLLA_CONTENUTO_SERIE_UD --- Contenuto effettivo 'vuoto'");
            context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(contenuto.getIdContenutoVerSerie(),
                    pg++, CostantiDB.TipoErroreContenuto.CONTENUTO_EFFETTIVO_VUOTO.name(),
    ...
    public int controllaUdNonSelezionateInContenutoCalcolato(List<SerQueryContenutoVerSerie> queries,
            SerContenutoVerSerie contenuto, int pg, Date dataRiferimento, String origineErrore)
        ...
        for (SerQueryContenutoVerSerie queryRecord : queries) {
            ...
            if (indexCrop != -1) {
                ...
                SerVerSerie verSerie = contenuto.getSerVerSerie();
                if (verSerie.getDtInizioSelSerie() != null && verSerie.getDtFineSelSerie() != null) {
                    ...
                    tmpBuilder.append(" AND ").append("tmp.dt_ud_serie >= ").append("to_date('")
                            .append(queryDf.format(verSerie.getDtInizioSelSerie())).append("', 'dd/mm/yyyy')")
                            .append(" AND ").append("tmp.dt_ud_serie <= ").append("to_date('")
                            .append(queryDf.format(verSerie.getDtFineSelSerie())).append("', 'dd/mm/yyyy')");
                ...
                for (ResultVCalcoloSerieUd result : resultList) {
                    ...
                    if (ud.getDtCreazione().after(dataRiferimento)) {
                        String dlErr = "L'unit\u00E0 documentaria " + ud.getCdRegistroKeyUnitaDoc() + "-"
                                ...
                                + ", versata successivamente all'istante " + df.format(dataRiferimento)
    ...
    public int controllaUdVersateDopoCalcolo(List<SerQueryContenutoVerSerie> queries, Long idContenutoVerSerie,
            SerContenutoVerSerie contenutoCalcolato, int pg, Date dataRiferimento, final String origineErrore)
            throws IllegalStateException {
        SimpleDateFormat df = new SimpleDateFormat(Constants.DATE_FORMAT_TIMESTAMP_TYPE);
        SimpleDateFormat queryDf = new SimpleDateFormat(Constants.DATE_FORMAT_DATE_TYPE);
        for (SerQueryContenutoVerSerie queryRecord : queries) {
            ...
            if (StringUtils.containsIgnoreCase(query, "ORDER BY")) {
                ...
                query = choppedQuery + " and tmp.dt_creazione > to_date('" + queryDf.format(dataRiferimento)
                        + "', 'dd/mm/yyyy') ORDER BY" + orderBy;
            } else {
                query += " and tmp.dt_creazione > to_date('" + queryDf.format(dataRiferimento) + "', 'dd/mm/yyyy') ";
            }
            ...
            for (ResultVCalcoloSerieUd result : resultList) {
                BigDecimal idUnitaDoc = result.getIdUnitaDoc();
                AroUnitaDoc ud = helper.findById(AroUnitaDoc.class, idUnitaDoc);
                if (!helper.existUdInSerie(contenutoCalcolato.getIdContenutoVerSerie(), idUnitaDoc)) {
                    String dlErr = "L'unit\u00E0 documentaria " + ud.getCdRegistroKeyUnitaDoc() + "-"
                            + ud.getAaKeyUnitaDoc().toPlainString() + "-" + ud.getCdKeyUnitaDoc()
                            + " non \u00E8 presente nel contenuto perch\u00E9 versata successivamente all'istante "
                            + df.format(dataRiferimento);
                    context.getBusinessObject(SerieEjb.class).createSerErrContenutoVerSerie(idContenutoVerSerie, pg++,
    ...
    public SerErrContenutoVerSerie createSerErrContenutoVerSerie(long idContenutoVerSerie, int pgErr, String tiErr,
            String dlErr, String tiGravitaErr, String tiOrigineErr) {
        SerContenutoVerSerie contenuto = helper.findById(SerContenutoVerSerie.class, idContenutoVerSerie);
    ...
    public void createSerUdNonVersErr(SerErrContenutoVerSerie serErrContenuto, BigDecimal idUnitaDocNonVers) {
    ...
    public boolean existLacuna(BigDecimal idConsistVerSerie, BigDecimal idLacuna, BigDecimal niIniLacuna,
            BigDecimal niFinLacuna) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public BigDecimal saveLacuna(long idUser, BigDecimal idConsistVerSerie, BigDecimal pg, String tiLacuna,
            String tiModLacuna, BigDecimal niIniLacuna, BigDecimal niFinLacuna, String dlLacuna, String dlNotaLacuna)
            throws ParerUserError {
        logger.debug("Eseguo il salvataggio della lacuna");
        BigDecimal id = null;
        try {
            SerConsistVerSerie consistVerSerie = helper.findById(SerConsistVerSerie.class, idConsistVerSerie);
            if (consistVerSerie.getSerLacunaConsistVerSeries() == null) {
                consistVerSerie.setSerLacunaConsistVerSeries(new ArrayList<SerLacunaConsistVerSerie>());
            }
            SerLacunaConsistVerSerie lacuna = context.getBusinessObject(SerieEjb.class).createSerLacunaConsistVerSerie(
                    pg, tiLacuna, tiModLacuna, niIniLacuna, niFinLacuna, dlLacuna, dlNotaLacuna, consistVerSerie);
            helper.insertEntity(lacuna, false);
            id = new BigDecimal(lacuna.getIdLacunaConsistVerSerie());

            handleStatoSerieDaConsistenzaAttesa(consistVerSerie.getSerVerSerie(), "Modifica consistenza attesa",
                    idUser);
        } catch (Exception e) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public SerLacunaConsistVerSerie createSerLacunaConsistVerSerie(BigDecimal pg, String tiLacuna, String tiModLacuna,
            BigDecimal niIniLacuna, BigDecimal niFinLacuna, String dlLacuna, String dlNotaLacuna,
            SerConsistVerSerie consistVerSerie) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveLacuna(long idUser, BigDecimal idLacunaConsistVerSerie, String tiLacuna, BigDecimal niIniLacuna,
            BigDecimal niFinLacuna, String dlLacuna, String dlNotaLacuna) throws ParerUserError {
        logger.debug("Eseguo il salvataggio della lacuna");
        try {
            SerLacunaConsistVerSerie lacuna = helper.findById(SerLacunaConsistVerSerie.class, idLacunaConsistVerSerie);
            lacuna.setTiLacuna(tiLacuna);
            lacuna.setNiIniLacuna(niIniLacuna);
            lacuna.setNiFinLacuna(niFinLacuna);
            lacuna.setDlLacuna(dlLacuna);
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteLacuna(long idUser, BigDecimal idLacunaConsistVerSerie) throws ParerUserError {
    ...
    public boolean checkErroriContenutoEffettivo(BigDecimal idContenutoVerSerie, String tiGravitaErr) {
        Long count = helper.countSerErrContenutoVerSerie(idContenutoVerSerie, tiGravitaErr);
        return count > 0L;
    }

    public boolean checkErroriContenutoEffettivo(BigDecimal idContenutoVerSerie, String tiGravitaErr, String tiErr,
            String tiOrigineErr) {
        Long count = helper.countSerErrContenutoVerSerie(idContenutoVerSerie, tiGravitaErr, tiErr, tiOrigineErr);
        return count > 0L;
    }
            ...
            try {
                if (checkVersione(idVerSerie, statoSerieCorrente)) {
                    ...
                    if (contenutoEff != null) {
                        ...
                        if (idVerSerie != null
                                && contenutoEff.getSerVerSerie().getIdVerSerie() != idVerSerie.longValue()) {
                        ...
                        if (contenutoEff.getTiStatoContenutoVerSerie()
                                .equals(CostantiDB.StatoContenutoVerSerie.CONTROLLO_CONSIST_IN_CORSO.name())) {
                            throw new ParerUserError("Il controllo del contenuto effettivo \u00E8 in corso");
                        }
                        ...
                        SerStatoVerSerie statoCorrente = helper.findById(SerStatoVerSerie.class,
                                verSerie.getIdStatoVerSerieCor());
                        Date now = Calendar.getInstance().getTime();
                        logger.info(SerieEjb.class.getSimpleName() + " --- Aggiorna lo stato della versione");
                        SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class)
                                .createSerStatoVerSerie(statoCorrente.getPgStatoVerSerie().add(BigDecimal.ONE), stato,
                                        azione, nota, idUser, now, verSerie.getIdVerSerie());

                        logger.info(SerieEjb.class.getSimpleName() + " --- Eseguo la persist del nuovo stato versione");
                        helper.insertEntity(statoVerSerie, false);
                        verSerie.setIdStatoVerSerieCor(new BigDecimal(statoVerSerie.getIdStatoVerSerie()));
                        ...
                        if (stato.equals(CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name()) && udInSerie != null) {
                            contenutoEff.setTiStatoContenutoVerSerie(
                                    CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name());
                            contenutoEff.setDtStatoContenutoVerSerie(Calendar.getInstance().getTime());
                        ...
                        if (stato.equals(CostantiDB.StatoVersioneSerie.DA_VALIDARE.name())) {
                            ...
                            if (serVerSerieDaElab != null) {
                                if (!serVerSerieDaElab.getTiStatoVerSerie()
                                        .equals(CostantiDB.StatoVersioneSerieDaElab.DA_VALIDARE.name())) {
                                    throw new IllegalArgumentException(
                        ...
                        if (stato.equals(CostantiDB.StatoVersioneSerie.ANNULLATA.name())) {
                            ...
                            case AZIONE_SERIE_ANNULLATA:
                                nuovoStatoSerie = CostantiDB.StatoConservazioneSerie.ANNULLATA.name();
                                break;
                            case AZIONE_SERIE_AGGIORNA:
                                nuovoStatoSerie = CostantiDB.StatoConservazioneSerie.AIP_DA_AGGIORNARE.name();
                                break;
                            default:
                            ...
                            BigDecimal pg = lastStatoSerie != null
                                    ? lastStatoSerie.getPgStatoSerie().add(BigDecimal.ONE) : BigDecimal.ONE;
                            statoSerie = context.getBusinessObject(SerieEjb.class).createSerStatoSerie(pg,
                                    nuovoStatoSerie, azione, nota, idUser, now, serie.getIdSerie());
                            logger.debug(
                            ...
                            case AZIONE_SERIE_AGGIORNA:
                                ...
                                logger.debug(SerieEjb.class.getSimpleName() + " --- Salvataggio nuova versione");
                                ...
                                intVerSerie++;
                                String cdVerSerie = cdVerSeriePartial[0] + "." + String.format("%02d", intVerSerie);

                                SerVerSerie verSerieNew = context.getBusinessObject(SerieEjb.class).createSerVerSerie(
                                        cdVerSerie, verSerie.getDsListaAnniSelSerie(),
                                        verSerie.getDtCreazioneUnitaDocA(), verSerie.getDtCreazioneUnitaDocDa(),
                                        verSerie.getDtFineSelSerie(), verSerie.getDtInizioSelSerie(),
                                        verSerie.getDtRegUnitaDocA(), verSerie.getDtRegUnitaDocDa(),
                                        verSerie.getNiPeriodoSelSerie(), verSerie.getPgVerSerie().add(BigDecimal.ONE),
                                        verSerie.getTiPeriodoSelSerie(), serie);
                                logger.debug(SerieEjb.class.getSimpleName() + " --- Copia delle note della versione");
                                ...
                                for (SerConsistVerSerie oldConsist : verSerie.getSerConsistVerSeries()) {
                                    SerConsistVerSerie consistNew = new SerConsistVerSerie();
                                    consistNew.setSerLacunaConsistVerSeries(new ArrayList<SerLacunaConsistVerSerie>());
                                    if (verSerieNew.getSerConsistVerSeries() == null) {
                                        verSerieNew.setSerConsistVerSeries(new ArrayList<SerConsistVerSerie>());
                                    }
                                    verSerieNew.addSerConsistVerSery(consistNew);
                                    consistNew.setIamUser(oldConsist.getIamUser());
                                    consistNew.setNiUnitaDocAttese(oldConsist.getNiUnitaDocAttese());
                                    consistNew.setTiModConsistFirstLast(oldConsist.getTiModConsistFirstLast());
                                    consistNew.setNiFirstUnitaDocAttesa(oldConsist.getNiFirstUnitaDocAttesa());
                                    consistNew.setNiLastUnitaDocAttesa(oldConsist.getNiLastUnitaDocAttesa());
                                    consistNew.setCdFirstUnitaDocAttesa(oldConsist.getCdFirstUnitaDocAttesa());
                                    consistNew.setCdLastUnitaDocAttesa(oldConsist.getCdLastUnitaDocAttesa());
                                    consistNew.setCdDocConsistVerSerie(oldConsist.getCdDocConsistVerSerie());
                                    consistNew.setDsDocConsistVerSerie(oldConsist.getDsDocConsistVerSerie());
                                    consistNew.setDtComunicConsistVerSerie(oldConsist.getDtComunicConsistVerSerie());
                                    logger.debug(SerieEjb.class.getSimpleName()
                                    ...
                                    for (SerLacunaConsistVerSerie oldLacuna : oldConsist
                                        ...
                                        context.getBusinessObject(SerieEjb.class).createSerLacunaConsistVerSerie(
                                                oldLacuna.getPgLacuna(), oldLacuna.getTiLacuna(),
                                                oldLacuna.getTiModLacuna(), oldLacuna.getNiIniLacuna(),
                                                oldLacuna.getNiFinLacuna(), oldLacuna.getDlLacuna(),
                                ...
                                for (SerFileInputVerSerie oldFileInput : verSerie.getSerFileInputVerSeries()) {
                                    SerFileInputVerSerie fileInput = context.getBusinessObject(SerieEjb.class)
                                            .createSerFileInputVerSerie(
                                                    oldFileInput.getBlFileInputVerSerie().getBytes("UTF-8"),
                                    ...
                                    if (fileInput.getSerErrFileInputs() == null) {
                                        fileInput.setSerErrFileInputs(new ArrayList<SerErrFileInput>());
                                    }
                                    logger.debug(
                                            SerieEjb.class.getSimpleName() + " --- Copia degli errori dei file input");
                                    for (SerErrFileInput oldErrFileInput : oldFileInput.getSerErrFileInputs()) {
                                        SerErrFileInput errFileInput = new SerErrFileInput();
                                        ...
                                        for (SerUdErrFileInput oldUdErrFileInput : oldErrFileInput
                                            ...
                                            SerUdErrFileInput udErrFileInput = new SerUdErrFileInput();
                                            udErrFileInput.setAroUnitaDoc(oldUdErrFileInput.getAroUnitaDoc());
                                            udErrFileInput.setCdUdSerie(oldUdErrFileInput.getCdUdSerie());
                                            udErrFileInput.setDsKeyOrdUdSerie(oldUdErrFileInput.getDsKeyOrdUdSerie());
                                            udErrFileInput.setDtUdSerie(oldUdErrFileInput.getDtUdSerie());
                                            udErrFileInput.setInfoUdSerie(oldUdErrFileInput.getInfoUdSerie());
                                            udErrFileInput.setPgUdSerie(oldUdErrFileInput.getPgUdSerie());
                                ...
                                for (SerContenutoVerSerie oldContenuto : verSerie.getSerContenutoVerSeries()) {
                                    SerContenutoVerSerie contenutoSerie = context.getBusinessObject(SerieEjb.class)
                                ...
                                SerStatoVerSerie statoVerSerieNew = context.getBusinessObject(SerieEjb.class)
                                        .createSerStatoVerSerie(BigDecimal.ONE,
                                                CostantiDB.StatoVersioneSerie.DA_VALIDARE.name(),
                                                "Annullamento versione precedente", null, idUser, now,
                                                verSerieNew.getIdVerSerie());
                                logger.debug(SerieEjb.class.getSimpleName() + azione
                                        + " --- Eseguo la persist del nuovo stato versione");
                                helper.insertEntity(statoVerSerieNew, false);
                                verSerieNew
                                        .setIdStatoVerSerieCor(new BigDecimal(statoVerSerieNew.getIdStatoVerSerie()));
                                verSerieToUpdate = verSerieNew;

                                SerVerSerieDaElab verSerieDaElab = new SerVerSerieDaElab();
                                verSerieDaElab.setDtRegStatoVerSerie(now);
                                verSerieDaElab.setIdStrut(
                                        new BigDecimal(verSerieNew.getSerSerie().getOrgStrut().getIdStrut()));
                                verSerieDaElab
                                        .setTiStatoVerSerie(CostantiDB.StatoVersioneSerieDaElab.DA_VALIDARE.name());
                ...
                logger.error("CAMBIO STATO SERIE --- Impossibile acquisire il lock sul contenuto", lte);
                throw new ParerUserError(
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public SerContenutoVerSerie copySerContenutoVerSerie(SerContenutoVerSerie oldContenuto, Date now) {
        SerContenutoVerSerie contenutoSerie = new SerContenutoVerSerie();
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public SerVerSerie createSerVerSerie(String cdVerSerie, String dsListaAnniSelSerie, Date dtCreazioneUnitaDocA,
            Date dtCreazioneUnitaDocDa, Date dtFineSelSerie, Date dtInizioSelSerie, Date dtRegUnitaDocA,
            Date dtRegUnitaDocDa, BigDecimal niPeriodoSelSerie, BigDecimal pgVerSerie, String tiPeriodoSelSerie,
            SerSerie serie) {
        SerVerSerie verSerie = new SerVerSerie();
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public BigDecimal saveNota(long idUtente, BigDecimal idVerSerie, BigDecimal idTipoNotaSerie, BigDecimal pgNota,
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void saveStato(BigDecimal idStato, String dsAzione, String dsNota) throws ParerUserError {
        logger.debug("Eseguo il salvataggio dell'elemento di descrizione");
        try {
    ...
    public SerVVisErrFileSerieUdRowBean getSerVVisErrFileSerieUdRowBean(BigDecimal idErrFileInput) {
        SerVVisErrFileSerieUd erroreFileInput = helper.findViewById(SerVVisErrFileSerieUd.class, idErrFileInput);
        ...
        if (erroreFileInput != null) {
            try {
                ...
                logger.error("Errore durante il recupero dell'errore file in input "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
                throw new IllegalStateException("Errore durante il recupero dell'errore file in input");
            }
        }
        return row;
    }

    public SerVLisUdErrFileInputTableBean getSerVLisUdErrFileInputTableBean(BigDecimal idErrFileInput) {
    ...
    public SerVVisErrContenSerieUdRowBean getSerVVisErrContenSerieUdRowBean(BigDecimal idErrContenutoVerSerie) {
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (SerVLisUdNoversTableBean) Transform.entities2TableBean(list);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della lista di unit\u00e0 documentarie di errore contenuto "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
            }
        }
        return table;
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (SerVLisUdAppartVolSerieTableBean) Transform.entities2TableBean(list);
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error("Errore durante il recupero della lista di unit\u00e0 documentarie di volume serie "
                        + ExceptionUtils.getRootCauseMessage(ex), ex);
            }
        }
        return table;
    ...
    public SerieAutomBean generateIntervalliSerieAutom(BigDecimal niMesiCreazioneSerie, String cdSerieDefault,
            String dsSerieDefault, int anno, String tiSelUd) throws ParerUserError {
        SerieAutomBean bean = new SerieAutomBean(niMesiCreazioneSerie);
        Calendar cal = Calendar.getInstance();
        Date dtInizioSerie = null;
        Date dtFineSerie = null;
        if (niMesiCreazioneSerie == null && tiSelUd.equals(CostantiDB.TipoSelUdTipiSerie.DT_UD_SERIE.name())) {
            ...
            if (niMesiCreazioneSerie.doubleValue() == CostantiDB.IntervalliMeseCreazioneSerie.DECADE.getNumSerie()
                ...
                throw new ParerUserError("Errore nella determinazione del numero mesi per cui creare la serie");
            }
        }
        ...
        for (int i = 0; i < bean.getNumeroSerieDaCreare(); i++) {
            ...
            if (niMesiCreazioneSerie != null) {
                ...
                if (niMesiCreazioneSerie.compareTo(BigDecimal.ONE) < 0) {
                    ...
                    int giornoAttuale = cal.get(Calendar.DATE) + bean.getNiGiorniCalcolo().intValue();

                    if (giornoAttuale > giornoMassimo) {
                        // Se arrivare a fine mese ci sono meno giorni di quelli per il calcolo, arrivo a fine mese
                        cal.roll(Calendar.DATE, (giornoMassimo - cal.get(Calendar.DATE)));
                    } else if ((giornoMassimo - giornoAttuale) < Math.round(bean.getNiGiorniCalcolo().intValue() / 2)) {
                        // Caso di scarto a fine mese (Es. sono al 20, devo arrivare al 31). Se lo scarto per il calcolo
                        // successivo e' minore di 5, allora arrivo a fine mese
                        int calc = bean.getNiGiorniCalcolo().intValue() + (giornoMassimo - giornoAttuale);
                ...
                appendDsSerie = " da " + df.format(dtInizioSerie) + " a " + df.format(dtFineSerie) + "(" + (i + 1) + " "
                        + bean.getTipoIntervallo() + ")";
            } else {
                appendCdSerie = "-" + anno;
            }
            String cdSerie = cdSerieDefault + appendCdSerie;
            String dsSerie = dsSerieDefault + appendDsSerie;
            IntervalliSerieAutomBean intervalBean = new IntervalliSerieAutomBean(dtInizioSerie, dtFineSerie, cdSerie,
                    dsSerie);
    ...
    public Future<String> validazioneSerieAsync(BigDecimal idVerSerie) {
        ...
        try {
            ...
            logger.error(messaggio, e);
            if (idVerSerie != null) {
                // Per non finire in uno stato inconsistente, la versione viene riportata a un nuovo stato DA_VALIDARE
                // mettendo FINE_SCHEDULAZIONE anziché ERRORE
                String azione = StringUtils.substringAfter(ExceptionUtils.getRootCauseMessage(e), ":");
                context.getBusinessObject(SerieEjb.class).createStatoErroreValidazione(azione, idVerSerie.longValue());

                jobHelper.writeAtomicLogJob(JobConstants.JobEnum.SET_SERIE_UD_VALIDATA.name(),
                        JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(), messaggio, idVerSerie.longValue(),
    ...
    public Future<Map<String, ?>> validazioneSerieAsync(Map<String, BigDecimal> idVerSeries) {
        ...
        for (Entry<String, BigDecimal> idVerSerieEntry : idVerSeries.entrySet()) {
            ...
            boolean lock = false;
            try {
                lock = context.getBusinessObject(SerieEjb.class).executeValidazioneSerie(idVerSerieEntry.getValue());
            } catch (Exception e) {
                error = true;
                String messaggio = "Eccezione imprevista durante la fase di validazione serie:";
                messaggio += ExceptionUtils.getRootCauseMessage(e);
                ...
                if (idVerSerieEntry.getValue() != null) {
                    // Per non finire in uno stato inconsistente, la versione viene riportata a un nuovo stato
                    ...
                    jobHelper.writeAtomicLogJob(JobConstants.JobEnum.SET_SERIE_UD_VALIDATA.name(),
                            ...
                            idVerSerieEntry.getValue().longValue(), SerVerSerie.class.getSimpleName());
                }
            }
            String result;
            if (lock && !error) {
    ...
    public boolean executeValidazioneSerie(BigDecimal idVerSerie) throws Exception {
        boolean lock = false;
        logger.info(
                SerieEjb.class.getSimpleName() + " --- Richiesta LOCK su versione id " + idVerSerie.toPlainString());
        SerVerSerie verSerie = helper.findByIdWithLock(SerVerSerie.class, idVerSerie);
        if (verSerie != null) {
            lock = true;
            jobHelper.writeAtomicLogJob(JobConstants.JobEnum.SET_SERIE_UD_VALIDATA.name(),
                    JobConstants.OpTypeEnum.INIZIO_SCHEDULAZIONE.name(), null, verSerie.getIdVerSerie(),
                    verSerie.getClass().getSimpleName());
            // se per il contenuto di tipo EFFETTIVO non sono presenti errori rilevati con origine = VALIDAZIONE ->
            // Controlla validazione
            SerContenutoVerSerie contenutoEff = helper.getSerContenutoVerSerie(idVerSerie.longValue(),
                    CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name());
            boolean erroreControlli = false;
            if (helper.countSerErrContenutoVerSerie(new BigDecimal(contenutoEff.getIdContenutoVerSerie()), null, null,
                    CostantiDB.TipoOrigineErroreContenuto.VALIDAZIONE.name()) == 0L) {
                erroreControlli = context.getBusinessObject(SerieEjb.class).controllaValidazione(verSerie);
            }
            if (!erroreControlli) {
            ...
            jobHelper.writeAtomicLogJob(JobConstants.JobEnum.SET_SERIE_UD_VALIDATA.name(),
                    JobConstants.OpTypeEnum.FINE_SCHEDULAZIONE.name(), null, verSerie.getIdVerSerie(),
                    verSerie.getClass().getSimpleName());
        }
        logger.info(SerieEjb.class.getSimpleName() + " --- FINE chiamata asincrona per validazione serie");
        return lock;
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public boolean controllaValidazione(SerVerSerie verSerie) {
        SerContenutoVerSerie contenutoEff = helper.getLockSerContenutoVerSerie(verSerie.getIdVerSerie(),
                CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name());
        SerContenutoVerSerie contenutoCalc = helper.getSerContenutoVerSerie(verSerie.getIdVerSerie(),
                CostantiDB.TipoContenutoVerSerie.CALCOLATO.name());
        int pg = helper
                .countSerErrContenutoVerSerie(new BigDecimal(contenutoEff.getIdContenutoVerSerie()), null, null, null)
                .intValue() + 1;
        int pgIniziale = pg;
        ...
        pg = context.getBusinessObject(SerieEjb.class).controllaContenutoEffettivoNonVuoto(contenutoEff, pg,
                origineErrore);
        logger.info(SerieEjb.class.getSimpleName()
        ...
        pg = context.getBusinessObject(SerieEjb.class).controllaUdAnnullate(
                verSerie.getSerSerie().getDecTipoSerie().getIdTipoSerie(), contenutoEff, dataRiferimento, pg,
                origineErrore);
        logger.info(SerieEjb.class.getSimpleName()
                + "--- CONTROLLA_VALIDAZIONE --- END - Verifica presenza di UD annullate");
        if (contenutoCalc != null) {
            List<SerQueryContenutoVerSerie> queries = helper
                    .getSerQueryContenutoVerSerie(new BigDecimal(contenutoCalc.getIdContenutoVerSerie()));
            logger.info(SerieEjb.class.getSimpleName()
                    + "--- CONTROLLA_VALIDAZIONE --- START - Verifica presenza di UD non selezionate nel contenuto CALCOLATO");
            pg = context.getBusinessObject(SerieEjb.class).controllaUdNonSelezionateInContenutoCalcolato(queries,
                    contenutoEff, pg, dataRiferimento, origineErrore);
            logger.info(SerieEjb.class.getSimpleName()
            ...
            pg = context.getBusinessObject(SerieEjb.class).controllaUdVersateDopoCalcolo(queries,
                    contenutoEff.getIdContenutoVerSerie(), contenutoCalc, pg, dataRiferimento, origineErrore);
            logger.info(SerieEjb.class.getSimpleName()
        ...
        if (erroreValidazione) {
            ...
            SerStatoVerSerie statoValidazioneInCorso = helper.getLastSerStatoVerSerieWithStatus(
                    verSerie.getIdVerSerie(), CostantiDB.StatoVersioneSerie.VALIDAZIONE_IN_CORSO.name());
            Date now = Calendar.getInstance().getTime();
            logger.info(
                    SerieEjb.class.getSimpleName() + " --- CONTROLLA_VALIDAZIONE --- Aggiorna lo stato della versione");
            SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                    statoCorrente.getPgStatoVerSerie().add(BigDecimal.ONE),
                    CostantiDB.StatoVersioneSerie.DA_VALIDARE.name(),
                    "La serie non pu\u00F2 essere validata perch\u00E9 "
                            + "\u00E8 stato rilevato almeno un errore nel corso della validazione",
                    null, statoValidazioneInCorso.getIamUser().getIdUserIam(), now, verSerie.getIdVerSerie());
    ...
    public void createStatoErroreValidazione(String azione, Long idVerSerie) {
        ...
        if (!statoCorrente.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.VALIDAZIONE_IN_CORSO.name())) {
            statoValidazioneInCorso = helper.getLastSerStatoVerSerieWithStatus(verSerie.getIdVerSerie(),
        ...
        SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                ...
                statoValidazioneInCorso.getIamUser().getIdUserIam(), now, verSerie.getIdVerSerie());
        logger.debug(SerieEjb.class.getSimpleName() + " --- Eseguo la persist del nuovo stato versione");
        helper.insertEntity(statoVerSerie, false);
    ...
    public void validazioneSerie(SerVerSerie verSerie) throws ParerInternalError, NamingException, ValidationException,
        ...
        List<AroUdAppartVerSerie> aroUnitaDocInContenEff = helper.getAroUdAppartVerSerieInContenEff(
                verSerie.getIdVerSerie(), CostantiDB.StatoConservazioneUnitaDoc.AIP_DA_GENERARE.name());
        ...
        for (AroUdAppartVerSerie udVerSerie : aroUnitaDocInContenEff) {
            ...
            context.getBusinessObject(SerieEjb.class).creaPrimoIndiceAipUniSincro(idSerie, idUnitaDoc);
        }
        context.getBusinessObject(SerieEjb.class).updateSerieValidata(verSerie);
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void creaPrimoIndiceAipUniSincro(Long idSerie, Long idUnitaDoc) throws ParerInternalError, NamingException,
            ValidationException, NoSuchAlgorithmException, IOException, MarshalException, JAXBException {
        logger.debug(SerieEjb.class.getSimpleName()
    ...
    public void updateSerieValidata(SerVerSerie verSerie) {
        ...
        // QUERY NATIVA PER L'UPDATE delle UD per le quali non sia valorizzato l'id dell'ultima versione indice AIP
        helper.updateAroUdAppartVerSerieNoAip(contenEff.getIdContenutoVerSerie());
        // UPDATE: modifica tutte le unità doc appartenenti al contenuto di tipo EFFETTIVO della versione serie,
        ...
        logger.debug(SerieEjb.class.getSimpleName() + " --- Aggiorna lo stato della versione");
        SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                statoCorrente.getPgStatoVerSerie().add(BigDecimal.ONE), CostantiDB.StatoVersioneSerie.VALIDATA.name(),
        ...
        SerStatoSerie lastStatoSerie = helper.getLastSerStatoSerie(serie.getIdSerie());
        BigDecimal pg = lastStatoSerie != null ? lastStatoSerie.getPgStatoSerie().add(BigDecimal.ONE) : BigDecimal.ONE;
        if (serie.getIdStatoSerieCor() == null) {
            statoSerie = context.getBusinessObject(SerieEjb.class).createSerStatoSerie(pg,
                    CostantiDB.StatoConservazioneSerie.PRESA_IN_CARICO.name(), "Validazione serie",
                    statoValidazioneInCorso.getDsNotaAzione(), statoValidazioneInCorso.getIamUser().getIdUserIam(), now,
                    serie.getIdSerie());
        } else {
            statoSerie = context.getBusinessObject(SerieEjb.class).createSerStatoSerie(pg,
                    CostantiDB.StatoConservazioneSerie.AIP_IN_AGGIORNAMENTO.name(), "Validazione serie",
                    statoValidazioneInCorso.getDsNotaAzione(), statoValidazioneInCorso.getIamUser().getIdUserIam(), now,
                    serie.getIdSerie());
        }
        logger.debug(SerieEjb.class.getSimpleName() + " --- Eseguo la persist del nuovo stato serie");
        ...
        logger.debug(
                SerieEjb.class.getSimpleName() + " --- Aggiorno il record in verSerieDaElab relativo alla versione");
        SerVerSerieDaElab verSerieDaElab = helper.getSerVerSerieDaElabByIdVerSerie(verSerie.getIdVerSerie());
    ...
    public BaseTable getSerieDaFirmareBeanList(BigDecimal idAmbiente, BigDecimal idEnte, BigDecimal idStrut,
            CostantiDB.StatoVersioneSerie statoVersioneSerie) {
        List<Object[]> objList = helper.getSerVerSerieDaElabList(idAmbiente, idEnte, idStrut, statoVersioneSerie);
    ...
    /**
     * Data una struttura in input, mi restituisce l'informazione se esistano o meno delle versione serie di tipo
     * FIRMATA_NO_MARCA
     *
     * @param idStrut
     *            id struttura
    ...
    private void storeFirmaNoTransaction(Long idVerSerie, byte[] fileFirmato, long idUtente) throws Exception {
        ...
        SerVerSerie verSerie = helper.findByIdWithLock(SerVerSerie.class, idVerSerie);
        SerSerie serie = helper.findByIdWithLock(SerSerie.class, verSerie.getSerSerie().getIdSerie());
        ...
        if (verSerie.getSerSerie().getDecTipoSerie().getTiConservazioneSerie()
            ...
            SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                    ...
                    CostantiDB.StatoVersioneSerie.FIRMATA.name(), "Firma indice AIP serie", null, idUtente, new Date(),
                    idVerSerie);
            ...
            SerStatoSerie statoSerie = context.getBusinessObject(SerieEjb.class).createSerStatoSerie(
                    ...
                    CostantiDB.StatoConservazioneSerie.IN_ARCHIVIO.name(), "Firma indice AIP serie", null, idUtente,
                    new Date(), idSerie);
        ...
        /*
         * Se il tipo di serie prevede tipo conservazione = FISCALE, aggiorna la versione serie da elaborare assegnando
         * stato = FIRMATA_NO_MARCA
         */
        if (verSerie.getSerSerie().getDecTipoSerie().getTiConservazioneSerie()
            ...
            SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                    ...
                    "Firma indice AIP serie senza apposizione marca", null, idUtente, new Date(), idVerSerie);
            /* Aggiorna l'identificatore dello stato corrente della versione della serie */
            helper.insertEntity(statoVerSerie, false);
            verSerieDaElab.getSerVerSerie().setIdStatoVerSerieCor(new BigDecimal(statoVerSerie.getIdStatoVerSerie()));

            /* Aggiorna la versione serie da elaborare in FIRMATA_no_marca */
            verSerieDaElab.setTiStatoVerSerie(CostantiDB.StatoVersioneSerieDaElab.FIRMATA_NO_MARCA.name());
        }
    }
    ...
    public void riavvioValidazioneSerie(BigDecimal idSerie, BigDecimal idVerSerie) throws ParerUserError {
        ...
        if (serie != null) {
            SerVerSerie verSerie = helper.findByIdWithLock(SerVerSerie.class, idVerSerie);
            if (verSerie != null) {
                String[] blocco = getFlVersioneBloccata(JobConstants.JobEnum.SET_SERIE_UD_VALIDATA.name(), idVerSerie);
                if (blocco != null) {
                    if (!blocco[0].equals("1")) {
                ...
                throw new ParerUserError("La versione della serie \u00E8 in uso da parte di un altro utente");
            }
        } else {
            throw new ParerUserError("La serie \u00E8 in uso da parte di un altro utente");
        }
    ...
    public String[] getNameAndFileIndiceVolume(long idVolVerSerie) throws ParerUserError {
        ...
        try {
            ...
            file[0] = fileIndiceVolume.getSerUrnIxVolVerSeries().get(0).getDsUrn().substring(4).replaceAll(" ", "_");
            // end TODO
    ...
    public void createZipPacchettoArk(BigDecimal idVerSerie, ZipOutputStream out, String ixAIPFileName,
            String ixVolPrefix) throws IOException, ParerUserError {
    ...
    public boolean checkSerieDaRigenerare(BigDecimal idVerSerie) {
        SerVChkSerieUdDaRigenera check = helper.findViewById(SerVChkSerieUdDaRigenera.class, idVerSerie);
    ...
    public void setFlagContenutoVerSerieDaAggiornare(BigDecimal idTipoSerie) {
        List<SerVerSerie> verSeries = helper.getVersioniSerieCorrentiByTipoSerieAndStato(idTipoSerie,
                CostantiDB.StatoVersioneSerie.APERTA.name(), CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name(),
                CostantiDB.StatoVersioneSerie.CONTROLLATA.name(), CostantiDB.StatoVersioneSerie.DA_VALIDARE.name());
    ...
    public SerVLisSerDaValidareTableBean getSerVLisSerDaValidareTableBean(Long idUserIam, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStrut) throws ParerUserError {
        List<SerVLisSerDaValidare> list = helper.getSerVLisSerDaValidare(idUserIam, idAmbiente, idEnte, idStrut);
        SerVLisSerDaValidareTableBean table = new SerVLisSerDaValidareTableBean();
        if (!list.isEmpty()) {
            try {
                for (SerVLisSerDaValidare record : list) {
                    SerVLisSerDaValidareRowBean row = (SerVLisSerDaValidareRowBean) Transform.entity2RowBean(record);
                    row.setString("amb_ente_strut",
                            record.getNmAmbiente() + " - " + record.getNmEnte() + " - " + record.getNmStrut());
                    table.add(row);
                }
                    ...
                    | IllegalArgumentException | InvocationTargetException ex) {
                logger.error(
                        "Errore durante il recupero delle serie da validare " + ExceptionUtils.getRootCauseMessage(ex),
                        ex);
    ...
    public boolean existQueryContenutoVerSerie(BigDecimal idContenutoVerSerie, BigDecimal idRegistroUnitaDoc,
            BigDecimal idTipoUnitaDoc) {
        Long result = helper.countSerQueryContenutoVerSerie(idContenutoVerSerie, idRegistroUnitaDoc, idTipoUnitaDoc);
        return result > 0L;
    }
    ...
    public int aggiungiUnitaDocAlContenuto(long idUser, BigDecimal idContenutoVerSerie,
        ...
        SerContenutoVerSerie contenuto = helper.findByIdWithLock(SerContenutoVerSerie.class, idContenutoVerSerie);
        int countUd = 0;
        if (contenuto != null) {
            logger.debug(
                    SerieEjb.class.getSimpleName() + " --- Scorro la mappa di dati per ottenere le query necessarie");
            for (Map.Entry<RegistroTipoUnitaDoc, List<BigDecimal>> entry : map.entrySet()) {
                ...
                SerQueryContenutoVerSerie query = helper.getSerQueryContenutoVerSerie(
                        contenuto.getIdContenutoVerSerie(), registroTipoUnitaDoc.getIdRegistroUnitaDoc(),
                ...
                if (redecoratedQuery != null) {
                    List<ResultVCalcoloSerieUd> resultSet = helper.executeQueryList(redecoratedQuery);
                    countUd += resultSet.size();
                    for (ResultVCalcoloSerieUd result : resultSet) {
                        context.getBusinessObject(SerieEjb.class).handleAroUnitaDoc(contenuto.getIdContenutoVerSerie(),
                                result);
                    }
                }
            }
            ...
            contenuto.setNiUdContenutoVerSerie(
                    new BigDecimal(helper.countAroUdAppartVerSerie(idContenutoVerSerie.longValue())));
            contenuto.setIdFirstUdAppartVerSerie(firstUd != null ? new BigDecimal(firstUd) : BigDecimal.ZERO);
            contenuto.setIdLastUdAppartVerSerie(lastUd != null ? new BigDecimal(lastUd) : BigDecimal.ZERO);
            ...
            if (contenuto.getTiContenutoVerSerie().equals(CostantiDB.TipoContenutoVerSerie.EFFETTIVO.name())) {
                ...
                SerStatoVerSerie statoCorrente = helper.findById(SerStatoVerSerie.class, idStatoVerSerie);
                if (statoCorrente.getTiStatoVerSerie().equals(CostantiDB.StatoVersioneSerie.CONTROLLATA.name())) {
                    SerStatoVerSerie statoVerSerie = context.getBusinessObject(SerieEjb.class).createSerStatoVerSerie(
                            statoCorrente.getPgStatoVerSerie().add(BigDecimal.ONE),
                            CostantiDB.StatoVersioneSerie.DA_CONTROLLARE.name(),
                            "Aggiunte unit\u00E0 documentarie alla serie", null, idUser, now, verSerie.getIdVerSerie());
                    helper.insertEntity(statoVerSerie, false);
                    verSerie.setIdStatoVerSerieCor(new BigDecimal(statoVerSerie.getIdStatoVerSerie()));
            ...
            if (contenuto.getTiStatoContenutoVerSerie().equals(CostantiDB.StatoContenutoVerSerie.CREATO.name())
                    || contenuto.getTiStatoContenutoVerSerie()
                            .equals(CostantiDB.StatoContenutoVerSerie.CONTROLLATA_CONSIST.name())) {
                contenuto.setTiStatoContenutoVerSerie(CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name());
                contenuto.setDtStatoContenutoVerSerie(now);
            }
        } else {
    ...
    private String redecorateQuery(String blQuery, List<BigDecimal> idUnitaDocs, Date dtInizioSelSerie,
            Date dtFineSelSerie) throws ParerUserError {
        ...
        if (!idUnitaDocs.isEmpty()) {
            ...
            if (indexCropTmp != -1) {
                ...
                if (indexSubstWhere != -1) {
                    ...
                    StringBuilder builder = new StringBuilder(blQuery.substring(0, indexSubstWhere));
                    ...
                    builder.append(") tmp WHERE ").append("tmp.key_ud_serie IS NOT NULL").append(" AND ")
                    ...
                    if (dtInizioSelSerie != null && dtFineSelSerie != null) {
                        ...
                        builder.append(" AND ").append("tmp.dt_ud_serie >= ").append("to_date('")
                                .append(df.format(dtInizioSelSerie)).append("', 'dd/mm/yyyy')").append(" AND ")
                                .append("tmp.dt_ud_serie <= ").append("to_date('").append(df.format(dtFineSelSerie))
                                .append("', 'dd/mm/yyyy')");
                    }
    ...
    public DecTipoSerieUdTableBean getDecTipoSerieUdTableBean(BigDecimal idTipoSerie) throws ParerUserError {
        ...
        if (list != null && !list.isEmpty()) {
            try {
                for (SerVRicConsistSerieUd record : list) {
                    SerVRicConsistSerieUdRowBean row = (SerVRicConsistSerieUdRowBean) Transform.entity2RowBean(record);
                    ...
                    row.setString("fl_presenza_lacune", ((lacuneMancanti > 0 || lacuneNonProdotte > 0) ? "1" : "0"));
                    table.add(row);
                }
            } catch (ClassNotFoundException | NoSuchMethodException | InstantiationException | IllegalAccessException
                    | IllegalArgumentException | InvocationTargetException ex) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteSerConsistVerSerie(long idUser, BigDecimal idConsistVerSerie, BigDecimal idVerSerie,
            BigDecimal idSerie) throws ParerUserError {
        SerSerie serie = helper.findByIdWithLock(SerSerie.class, idSerie);
        if (serie != null) {
            if (context.getBusinessObject(SerieEjb.class).checkVersione(idVerSerie,
                    ...
                    CostantiDB.StatoVersioneSerie.CONTROLLATA.name(),
                    CostantiDB.StatoVersioneSerie.DA_VALIDARE.name())) {
                if (context.getBusinessObject(SerieEjb.class).checkContenuto(idVerSerie, true, true, true,
                        CostantiDB.StatoContenutoVerSerie.CREATO.name(),
                        CostantiDB.StatoContenutoVerSerie.CONTROLLATA_CONSIST.name(),
                        CostantiDB.StatoContenutoVerSerie.DA_CONTROLLARE_CONSIST.name())) {
                    try {
                        SerVerSerie verSerie = helper.findById(SerVerSerie.class, idVerSerie);
                        SerConsistVerSerie consist = helper.findById(SerConsistVerSerie.class, idConsistVerSerie);
                        helper.removeEntity(consist, true);

                        // Se versione serie ha stato corrente = CONTROLLATA o DA_VALIDARE, la versione serie assume
    ...
    public boolean existsCdSerieNormalized(BigDecimal idStrut, BigDecimal aaSerie, String cdSerieNormaliz) {
