...
/**
 * Cache per i client AWS. Siccome la creazione di un client ï¿½ un'attivitï¿½ computazionalmente
...
public class AwsClient {
	...
	final String longParameterString = configurationHelper
		.getValoreParamApplicByApplic(ParametroAppl.S3_CLIENT_MAX_CONNECTIONS);
	...
	final String longParameterString = configurationHelper
		.getValoreParamApplicByApplic(ParametroAppl.S3_CLIENT_CONNECTION_TIMEOUT);
	...
	final String longParameterString = configurationHelper
		.getValoreParamApplicByApplic(ParametroAppl.S3_CLIENT_SOCKET_TIMEOUT);
	return Duration.ofMinutes(
