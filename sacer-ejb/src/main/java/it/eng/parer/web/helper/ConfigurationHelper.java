...
public class ConfigurationHelper {
    ...
    /**
     * Ritorna la mappa dei valori di una lista parametri passata in ingresso in base al tipo di
     * entità
     *
     * @param nmParamApplicList lista parametri
     ...
     * @param getVal            entity tipo TipoAplVGetValAppart
     *
     * @return mappa chiave/valore di tipo String
     */
    public Map<String, String> getParamApplicMapValue(List<String> nmParamApplicList,
            BigDecimal idAmbiente, BigDecimal idStrut, BigDecimal idTipoUnitaDoc,
            BigDecimal idAaTipoFascicolo, CostantiDB.TipoAplVGetValAppart getVal) {
        ...
        if (!nmParamApplicList.isEmpty()) {
            ...
            for (AplParamApplic paramApplic : paramApplicList) {
                mappaAgenti.put(paramApplic.getNmParamApplic(),
                        getValoreParamApplic(paramApplic.getNmParamApplic(), idAmbiente, idStrut,
    ...
    public String getAplValoreParamApplic(String nmParamApplic, String tiAppart,
            BigDecimal idAmbiente, BigDecimal idStrut, BigDecimal idTipoUnitaDoc,
    ...
    public String getValoreParamApplicByAmb(String nmParamApplic, BigDecimal idAmbiente) {
        return getValoreParamApplic(nmParamApplic, idAmbiente,
                BigDecimal.valueOf(Integer.MIN_VALUE), BigDecimal.valueOf(Integer.MIN_VALUE),
                BigDecimal.valueOf(Integer.MIN_VALUE), TipoAplVGetValAppart.AMBIENTE);
    }
     ...
     */
    public String getValoreParamApplicByStrut(String nmParamApplic, BigDecimal idAmbiente,
            BigDecimal idStrut) {
        return getValoreParamApplic(nmParamApplic, idAmbiente, idStrut,
                BigDecimal.valueOf(Integer.MIN_VALUE), BigDecimal.valueOf(Integer.MIN_VALUE),
     ...
     */
    public String getValoreParamApplicByTipoUd(String nmParamApplic, BigDecimal idAmbiente,
     ...
     */
    public String getValoreParamApplicByAaTipoFasc(String nmParamApplic, BigDecimal idAmbiente,
            BigDecimal idStrut, BigDecimal idAaTipoFascicolo) {
        return getValoreParamApplic(nmParamApplic, idAmbiente, idStrut,
                BigDecimal.valueOf(Integer.MIN_VALUE), idAaTipoFascicolo,
     ...
     * @param idTipoUnitaDoc       id tipo unita doc
     * @param idAaTipoFascicolo    id anno tipo fascicolo
     * @param tipoAplVGetValAppart entity TipoAplVGetValAppart
     *
     * @return valore parametro
     */
    private String getValoreParamApplic(String nmParamApplic, BigDecimal idAmbiente,
        ...
        String queryStrTempl = "SELECT NEW it.eng.parer.web.helper.dto.AplVGetValParamDto (${"
        ...
        try {
            ...
            final String msg = "Errore nella lettura del parametro " + nmParamApplic
                    + " e tipologia " + tipoAplVGetValAppart.name();
            log.error(msg);
        ...
        if (result != null && !result.isEmpty()) {
             ...
             */
            return getValoreParamApplic(nmParamApplic, idAmbiente, idStrut, idTipoUnitaDoc,
                    idAaTipoFascicolo, CostantiDB.TipoAplVGetValAppart.next(tipoAplVGetValAppart));
        } else {
            // thorws Exception
            final String msg = "Parametro " + nmParamApplic + " con tipologia "
                    + tipoAplVGetValAppart.name() + " non definito o non valorizzato";
            log.error(msg);
            throw new ParamApplicNotFoundException(msg, nmParamApplic);
        }
    }
     ...
     * @return valore del parametro filtrato per tipologia <em>AATIPOFASCICOLO</em> .
     */
    public String getValoreParamApplicByTipoFasc(String nmParamApplic, BigDecimal idAmbiente,
            BigDecimal idStrut, BigDecimal idAaTipoFascicolo) {
        return getValoreParamApplic(nmParamApplic, idAmbiente, idStrut,
                BigDecimal.valueOf(Integer.MIN_VALUE), idAaTipoFascicolo,
                TipoAplVGetValAppart.AATIPOFASCICOLO);
