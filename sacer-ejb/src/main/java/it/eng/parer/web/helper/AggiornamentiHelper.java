...
public class AggiornamentiHelper extends GenericHelper {
    ...
    public it.eng.parer.slite.gen.viewbean.ElvVLisUpdUdTableBean getElvVLisUpdUdViewBean(BigDecimal idElencoVers,
            ElenchiVersamentoForm.ComponentiFiltri filtri) throws it.eng.spagoCore.error.EMFError {
    ...
    @SuppressWarnings("unchecked")
    public ElvVLisUpdUdTableBean getElvVLisUpdUdViewBean(BigDecimal idElencoVers, final String registro,
            final BigDecimal anno, final String codice, final BigDecimal annpRangeDa, final BigDecimal annoRangeA,
            String codiceRangeDa, String codiceRangeA) throws EMFError {
        ...
        // Ordino per pgUpdUnitaDoc che non potevo mettere nella query visto che non è tra i campi della distinct
