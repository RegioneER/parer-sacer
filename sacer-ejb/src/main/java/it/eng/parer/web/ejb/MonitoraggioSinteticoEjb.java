...
public class MonitoraggioSinteticoEjb {
	...
	UNITA_DOC_VERSATE, DOC_AGGIUNTI, VERS_FALLITI, AGGIUNTE_DOC_FALLITE, UNITA_DOC_VERSATE_B30,
	DOC_AGGIUNTI_B30, VERS_FALLITI_B30, AGGIUNTE_DOC_FALLITE_B30, UNITA_DOC_VERS_FALLITI,
	DOC_AGGIUNTI_VERS_FALLITI, UNITA_DOC_ANNUL
    }
    ...
    public LinkedHashMap<String, BaseRowInterface> calcolaRiepilogoSintetico(long idUtente,
	    BigDecimal idAmbiente, BigDecimal idEnte, BigDecimal idStrut, BigDecimal idTipoUnitaDoc,
	    Set<String> fieldsWithCnt) {
	...
	if (fieldsWithCnt.contains(fieldSetToPopulate.UNITA_DOC_VERSATE.name())
	    ...
	    rowBeanUd = (MonVChkCntUdRowBean) calcolaTot(idUtente, idAmbiente, idEnte, idStrut,
		    idTipoUnitaDoc, fieldSetToPopulate.UNITA_DOC_VERSATE,
		    fieldsWithCnt.contains(fieldSetToPopulate.UNITA_DOC_VERSATE.name()),
		    fieldsWithCnt.contains(fieldSetToPopulate.UNITA_DOC_VERSATE_B30.name()));
	} else {
	    rowBeanUd = new MonVChkCntUdRowBean();
	    rowBeanUd.entityToRowBean(buildQueryChk(idUtente, idAmbiente, idEnte, idStrut,
		    idTipoUnitaDoc, fieldSetToPopulate.UNITA_DOC_VERSATE));
	}
	...
	if (fieldsWithCnt.contains(fieldSetToPopulate.DOC_AGGIUNTI.name())
	    ...
	    rowBeanDoc = (MonVChkCntDocRowBean) calcolaTot(idUtente, idAmbiente, idEnte, idStrut,
		    idTipoUnitaDoc, fieldSetToPopulate.DOC_AGGIUNTI,
		    fieldsWithCnt.contains(fieldSetToPopulate.DOC_AGGIUNTI.name()),
		    fieldsWithCnt.contains(fieldSetToPopulate.DOC_AGGIUNTI_B30.name()));
	} else {
	    rowBeanDoc = new MonVChkCntDocRowBean();
	    rowBeanDoc.entityToRowBean(buildQueryChk(idUtente, idAmbiente, idEnte, idStrut,
		    idTipoUnitaDoc, fieldSetToPopulate.DOC_AGGIUNTI));
	}
	...
	if (idTipoUnitaDoc == null) {
		...
		rowBeanVers = (MonVChkCntVersRowBean) calcolaTot(idUtente, idAmbiente, idEnte,
			idStrut, idTipoUnitaDoc, fieldSetToPopulate.VERS_FALLITI,
			fieldsWithCnt.contains(fieldSetToPopulate.VERS_FALLITI.name()),
			fieldsWithCnt.contains(fieldSetToPopulate.VERS_FALLITI_B30.name()));
	    } else {
		rowBeanVers.entityToRowBean(buildQueryChk(idUtente, idAmbiente, idEnte, idStrut,
			idTipoUnitaDoc, fieldSetToPopulate.VERS_FALLITI));
	    }
		...
		rowBeanAgg = (MonVChkCntAggRowBean) calcolaTot(idUtente, idAmbiente, idEnte,
			idStrut, idTipoUnitaDoc, fieldSetToPopulate.AGGIUNTE_DOC_FALLITE,
			fieldsWithCnt.contains(fieldSetToPopulate.AGGIUNTE_DOC_FALLITE.name()),
			fieldsWithCnt.contains(fieldSetToPopulate.AGGIUNTE_DOC_FALLITE_B30.name()));
	    } else {
		rowBeanAgg.entityToRowBean(buildQueryChk(idUtente, idAmbiente, idEnte, idStrut,
			idTipoUnitaDoc, fieldSetToPopulate.AGGIUNTE_DOC_FALLITE));
	    }

	    log.debug("Fine calcolo aggiunte doc fallite");

	    if (fieldsWithCnt.contains(fieldSetToPopulate.UNITA_DOC_VERS_FALLITI.name())) {
		rowBeanUdNonVers = (MonVChkCntUdNonversRowBean) calcolaTot(idUtente, idAmbiente,
			idEnte, idStrut, idTipoUnitaDoc, fieldSetToPopulate.UNITA_DOC_VERS_FALLITI,
			false);
	    } else {
		rowBeanUdNonVers.entityToRowBean(buildQueryChk(idUtente, idAmbiente, idEnte,
			idStrut, idTipoUnitaDoc, fieldSetToPopulate.UNITA_DOC_VERS_FALLITI));
	    }
		...
		rowBeanDocNonVers = (MonVChkCntDocNonversRowBean) calcolaTot(idUtente, idAmbiente,
			idEnte, idStrut, idTipoUnitaDoc,
			fieldSetToPopulate.DOC_AGGIUNTI_VERS_FALLITI, false);
	    } else {
		rowBeanDocNonVers.entityToRowBean(buildQueryChk(idUtente, idAmbiente, idEnte,
			idStrut, idTipoUnitaDoc, fieldSetToPopulate.DOC_AGGIUNTI_VERS_FALLITI));
	    }
	...
	if (fieldsWithCnt.contains(fieldSetToPopulate.UNITA_DOC_ANNUL.name())) {
	    rowBeanUdAnnul = (MonVChkCntUdAnnulRowBean) calcolaTot(idUtente, idAmbiente, idEnte,
		    idStrut, idTipoUnitaDoc, fieldSetToPopulate.UNITA_DOC_ANNUL, false);
	} else {
	    rowBeanUdAnnul = new MonVChkCntUdAnnulRowBean();
	    rowBeanUdAnnul.entityToRowBean(buildQueryChk(idUtente, idAmbiente, idEnte, idStrut,
		    idTipoUnitaDoc, fieldSetToPopulate.UNITA_DOC_ANNUL));
	}
    ...
    private Object buildQueryChk(long idUtente, BigDecimal idAmbiente, BigDecimal idEnte,
	    BigDecimal idStrut, BigDecimal idTipoUnitaDoc, fieldSetToPopulate fieldSetToBuild)
	...
	if (idTipoUnitaDoc != null) {
		...
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_UD_TIPO_UD));
		if (flUsoVp) {
	    ...
	    case DOC_AGGIUNTI:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_DOC_TIPO_UD));
		if (flUsoVp) {
		...
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_UD_ANNUL_TIPO_UD));
		if (flUsoVp) {
		...
		throw new IllegalArgumentException(
			"Errore inaspettato nei parametri di calcolo riepilogo sintetico");
	    }
	    ...
	    case UNITA_DOC_VERSATE:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_UD_STRUT));
		if (flUsoVp) {
	    ...
	    case DOC_AGGIUNTI:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_DOC_STRUT));
		if (flUsoVp) {
	    ...
	    case VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_VERS_STRUT));
		if (flUsoVp) {
	    ...
	    case AGGIUNTE_DOC_FALLITE:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_AGG_STRUT));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_UD_NONVERS_STRUT));
		if (flUsoVp) {
	    ...
	    case DOC_AGGIUNTI_VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_DOC_NONVERS_STRUT));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_ANNUL:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_UD_ANNUL_STRUT));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_VERSATE:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_UD_ENTE));
		if (flUsoVp) {
	    ...
	    case DOC_AGGIUNTI:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_DOC_ENTE));
		if (flUsoVp) {
	    ...
	    case VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_VERS_ENTE));
		if (flUsoVp) {
	    ...
	    case AGGIUNTE_DOC_FALLITE:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_AGG_ENTE));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_UD_NONVERS_ENTE));
		if (flUsoVp) {
	    ...
	    case DOC_AGGIUNTI_VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_DOC_NONVERS_ENTE));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_ANNUL:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_UD_ANNUL_ENTE));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_VERSATE:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_UD_AMB));
		if (flUsoVp) {
	    ...
	    case DOC_AGGIUNTI:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_DOC_AMB));
		if (flUsoVp) {
	    ...
	    case VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_VERS_AMB));
		if (flUsoVp) {
	    ...
	    case AGGIUNTE_DOC_FALLITE:
		flUsoVp = Boolean.parseBoolean(configurationHelper
			.getValoreParamApplicByApplic(CostantiDB.ParametroAppl.USO_VP_AGG_AMB));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_UD_NONVERS_AMB));
		if (flUsoVp) {
	    ...
	    case DOC_AGGIUNTI_VERS_FALLITI:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_DOC_NONVERS_AMB));
		if (flUsoVp) {
	    ...
	    case UNITA_DOC_ANNUL:
		flUsoVp = Boolean.parseBoolean(configurationHelper.getValoreParamApplicByApplic(
			CostantiDB.ParametroAppl.USO_VP_UD_ANNUL_AMB));
		if (flUsoVp) {
    ...
    public BaseRowInterface calcolaTot(long idUtente, BigDecimal idAmbiente, BigDecimal idEnte,
	    BigDecimal idStrut, BigDecimal idTipoUnitaDoc, fieldSetToPopulate type, boolean tot30gg,
	    boolean isBefore30) {
	BaseRowInterface rowBean = null;
	BaseRowInterface appo = null;
	if (isBefore30) {
	    appo = calcolaTot(idUtente, idAmbiente, idEnte, idStrut, idTipoUnitaDoc, type,
		    isBefore30);
	}
	if (tot30gg) {
	    rowBean = calcolaTot(idUtente, idAmbiente, idEnte, idStrut, idTipoUnitaDoc, type,
		    false);
	    if (isBefore30) {
		switch (type) {
		case UNITA_DOC_VERSATE:
		    ...
		    rowBean.setObject("ni_ud_attesa_mem_b30gg",
			    appo.getBigDecimal("ni_ud_attesa_mem_b30gg"));
		    rowBean.setObject("ni_ud_attesa_sched_b30gg",
			    appo.getBigDecimal("ni_ud_attesa_sched_b30gg"));
		    rowBean.setObject("ni_ud_nosel_sched_b30gg",
			    appo.getBigDecimal("ni_ud_nosel_sched_b30gg"));

		    break;
		case DOC_AGGIUNTI:
		    azzeraB30ConutersDoc(rowBean);
		    rowBean.setObject("ni_doc_b30gg", appo.getBigDecimal("ni_doc_b30gg"));
		    rowBean.setObject("ni_doc_attesa_mem_b30gg",
			    appo.getBigDecimal("ni_doc_attesa_mem_b30gg"));
		    rowBean.setObject("ni_doc_attesa_sched_b30gg",
			    appo.getBigDecimal("ni_doc_attesa_sched_b30gg"));
		    rowBean.setObject("ni_doc_nosel_sched_b30gg",
			    appo.getBigDecimal("ni_doc_nosel_sched_b30gg"));

		    break;
		case VERS_FALLITI:
		    azzeraB30ConutersVers(rowBean);
		    rowBean.setObject("ni_vers_b30gg", appo.getBigDecimal("ni_vers_b30gg"));
		    rowBean.setObject("ni_vers_risolti_b30gg",
			    appo.getBigDecimal("ni_vers_risolti_b30gg"));
		    rowBean.setObject("ni_vers_norisolub_b30gg",
			    appo.getBigDecimal("ni_vers_norisolub_b30gg"));
		    rowBean.setObject("ni_vers_verif_b30gg",
			    appo.getBigDecimal("ni_vers_verif_b30gg"));
		    rowBean.setObject("ni_vers_noverif_b30gg",
			    appo.getBigDecimal("ni_vers_noverif_b30gg"));

		    break;
		case AGGIUNTE_DOC_FALLITE:
		    azzeraB30ConutersAgg(rowBean);
		    rowBean.setObject("ni_agg_b30gg", appo.getBigDecimal("ni_agg_b30gg"));
		    rowBean.setObject("ni_agg_risolti_b30gg",
			    appo.getBigDecimal("ni_agg_risolti_b30gg"));
		    rowBean.setObject("ni_agg_norisolub_b30gg",
			    appo.getBigDecimal("ni_agg_norisolub_b30gg"));
		    rowBean.setObject("ni_agg_verif_b30gg",
			    appo.getBigDecimal("ni_agg_verif_b30gg"));
		    rowBean.setObject("ni_agg_noverif_b30gg",
			    appo.getBigDecimal("ni_agg_noverif_b30gg"));
		    break;
		}
    ...
    public BaseRowInterface calcolaTot(long idUtente, BigDecimal idAmbiente, BigDecimal idEnte,
	    BigDecimal idStrut, BigDecimal idTipoUnitaDoc, fieldSetToPopulate type,
	    boolean isBefore30) {
	...
	case UNITA_DOC_VERSATE:
	    ...
	    if (idTipoUnitaDoc != null) {
		view = isBefore30 ? MonVCntUdTipoUdB30.class.getSimpleName()
			: MonVCntUdTipoUd.class.getSimpleName();
	    } else if (idStrut != null) {
		view = isBefore30 ? MonVCntUdStrutB30.class.getSimpleName()
			: MonVCntUdStrut.class.getSimpleName();
	    } else if (idEnte != null) {
		view = isBefore30 ? MonVCntUdEnteB30.class.getSimpleName()
			: MonVCntUdEnte.class.getSimpleName();
	    } else if (idAmbiente != null) {
		view = isBefore30 ? MonVCntUdAmbB30.class.getSimpleName()
			: MonVCntUdAmb.class.getSimpleName();
	    } else {
		throw new IllegalArgumentException(
	...
	case DOC_AGGIUNTI:
	    ...
	    if (idTipoUnitaDoc != null) {
		view = isBefore30 ? MonVCntDocTipoUdB30.class.getSimpleName()
			: MonVCntDocTipoUd.class.getSimpleName();
	    } else if (idStrut != null) {
		view = isBefore30 ? MonVCntDocStrutB30.class.getSimpleName()
			: MonVCntDocStrut.class.getSimpleName();
	    } else if (idEnte != null) {
		view = isBefore30 ? MonVCntDocEnteB30.class.getSimpleName()
			: MonVCntDocEnte.class.getSimpleName();
	    } else if (idAmbiente != null) {
		view = isBefore30 ? MonVCntDocAmbB30.class.getSimpleName()
			: MonVCntDocAmb.class.getSimpleName();
	    } else {
		throw new IllegalArgumentException(
	...
	case VERS_FALLITI:
		...
		view = isBefore30 ? MonVCntVersStrutB30.class.getSimpleName()
			: MonVCntVersStrut.class.getSimpleName();
	    } else if (idEnte != null) {
		view = isBefore30 ? MonVCntVersEnteB30.class.getSimpleName()
			: MonVCntVersEnte.class.getSimpleName();
	    } else if (idAmbiente != null) {
		view = isBefore30 ? MonVCntVersAmbB30.class.getSimpleName()
			: MonVCntVersAmb.class.getSimpleName();
	    } else {
		throw new IllegalArgumentException(
			"Errore inaspettato nei parametri di calcolo totali versamenti falliti");
	    }
	...
	case AGGIUNTE_DOC_FALLITE:
		...
		view = isBefore30 ? MonVCntAggStrutB30.class.getSimpleName()
			: MonVCntAggStrut.class.getSimpleName();
	    } else if (idEnte != null) {
		view = isBefore30 ? MonVCntAggEnteB30.class.getSimpleName()
			: MonVCntAggEnte.class.getSimpleName();
	    } else if (idAmbiente != null) {
		view = isBefore30 ? MonVCntAggAmbB30.class.getSimpleName()
			: MonVCntAggAmb.class.getSimpleName();
	    } else {
		throw new IllegalArgumentException(
			"Errore inaspettato nei parametri di calcolo totali aggiunte fallite");
	    }
	...
	default:
	    throw new IllegalArgumentException(
		    "Errore inaspettato nei parametri di calcolo totali");
	}
	String paramString = null;
	BigDecimal param1 = null;
	Long param2 = null;
	if (idTipoUnitaDoc != null) {
		...
		break;
	    default:
		paramString = VIEW_ID_TIPO_UNITA_DOC + " = :param1 AND " + VIEW_ID_STRUT
			+ " = :param2";
		param1 = idTipoUnitaDoc;
	...
	for (Object row : resultList) {
	    switch (type) {
	    case UNITA_DOC_VERSATE:
		rowBean = handleUdVersateRowBean(row, rowBean);
		break;
	    case DOC_AGGIUNTI:
		rowBean = handleDocAggiuntiRowBean(row, rowBean);
		break;
	    case VERS_FALLITI:
		rowBean = handleVersFallitiRowBean(row, totOggi, rowBean, totTrentaGg, totB30Gg);
		break;
	    case AGGIUNTE_DOC_FALLITE:
		rowBean = handleAggFalliteRowBean(row, totOggi, rowBean, totTrentaGg, totB30Gg);
		break;
	    case UNITA_DOC_VERS_FALLITI:
		rowBean = handleUdNonVersRowBean(row, totOggi, rowBean);
		break;
	    case DOC_AGGIUNTI_VERS_FALLITI:
    ...
    private BaseRowInterface handleUdVersateRowBean(Object row, BaseRowInterface rowBean)
	    throws IllegalArgumentException {
	...
	// ((MonVChkCntUdRowBean) rowBean).setNiUdCorr(((MonVChkCntUdRowBean)
	// rowBean).getNiUdCorr().add(totOggi));
	// ((MonVChkCntUdRowBean) rowBean).setNiUd30gg(((MonVChkCntUdRowBean)
	// rowBean).getNiUd30gg().add(totTrentaGg));
	return rowBean;
    }

    private BaseRowInterface handleDocAggiuntiRowBean(Object row, BaseRowInterface rowBean)
	    throws IllegalArgumentException {
	String tiDtCreazione = null;
	String tiStato = null;
	BigDecimal ni = null;
	...
	// ((MonVChkCntDocRowBean) rowBean).setNiDocCorr(((MonVChkCntDocRowBean)
	// rowBean).getNiDocCorr().add(totOggi));
	// ((MonVChkCntDocRowBean) rowBean).setNiDoc30gg(((MonVChkCntDocRowBean)
	// rowBean).getNiDoc30gg().add(totTrentaGg));
	return rowBean;
    }

    private BaseRowInterface handleVersFallitiRowBean(Object row, BigDecimal totOggi,
	    BaseRowInterface rowBean, BigDecimal totTrentaGg, BigDecimal totB30Gg) {
	String tiDtCreazione = null;
	String tiStato = null;
	BigDecimal ni = null;
	...
	if (niVersB30gg != null) {
	    ...
	    ((MonVChkCntVersRowBean) rowBean).setNiVers30gg(
		    ((MonVChkCntVersRowBean) rowBean).getNiVers30gg().add(totTrentaGg));
	}
	return rowBean;
    }

    private BaseRowInterface handleAggFalliteRowBean(Object row, BigDecimal totOggi,
	    BaseRowInterface rowBean, BigDecimal totTrentaGg, BigDecimal totB30gg) {
	String tiDtCreazione = null;
	String tiStato = null;
	BigDecimal ni = null;
	...
	if (niAggB30gg != null) {
	    ...
	    ((MonVChkCntAggRowBean) rowBean)
		    .setNiAggCorr(((MonVChkCntAggRowBean) rowBean).getNiAggCorr().add(totOggi));
	    ((MonVChkCntAggRowBean) rowBean)
    ...
    private BaseRowInterface handleUdNonVersRowBean(Object row, BigDecimal totOggi,
	...
	((MonVChkCntUdNonversRowBean) rowBean).setNiUdNonvers(
		((MonVChkCntUdNonversRowBean) rowBean).getNiUdNonvers().add(totOggi));
	return rowBean;
    }

    private BaseRowInterface handleDocNonVersRowBean(Object row, BigDecimal totOggi,
	    BaseRowInterface rowBean) {
	String tiStato = null;
	BigDecimal ni = null;
	...
	((MonVChkCntDocNonversRowBean) rowBean).setNiDocNonvers(
		((MonVChkCntDocNonversRowBean) rowBean).getNiDocNonvers().add(totOggi));
	return rowBean;
    }

    private BaseRowInterface handleUdAnnulRowBean(Object row, BigDecimal totOggi,
	    BaseRowInterface rowBean) {
	String tiStato = null;
	BigDecimal ni = null;
	...
	((MonVChkCntUdAnnulRowBean) rowBean).setNiUdAnnulTot(
		((MonVChkCntUdAnnulRowBean) rowBean).getNiUdAnnulTot().add(totOggi));
	return rowBean;
    }
