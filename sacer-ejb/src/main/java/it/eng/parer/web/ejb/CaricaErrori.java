 ...
 * @author Gilioli_P
 *
 *         Cache utilizzata per caricare la lista dei codici di errore da file di properties nei
 *         filtri di Monitoraggio/Riepilogo Versamenti/Versamenti Falliti. La classe singlettona, da
 *         buon single e asociale, viene caricata all'avvio dell'applicazione
 */
@Singleton
@LocalBean
@Startup
