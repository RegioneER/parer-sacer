...
public class ComboGetter {
    ...
    /**
     * Metodo statico che crea una decodeMap sulla base dei valori di un enum, ordinato in base al name
     *
     * @param <T>
     *            oggetto generics che estendene Enum con mappa codificata
     * @param key
     *            chiave
     * @param enumerator
     *            tipo enumerator
    ...
    /**
     * Metodo statico che crea una decodeMap sulla base dei valori di un enum, ordinato in base all'array fornito come
     * parametro
     *
     * @param <T>
     *            oggetto generics che estendene Enum con mappa codificata
    ...
    public static DecodeMapIF getMappaNiMesiCreazioneSerie() {
        ...
        for (CostantiDB.IntervalliMeseCreazioneSerie niMesi : CostantiDB.IntervalliMeseCreazioneSerie.values()) {
