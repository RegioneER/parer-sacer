...
public class RecuperoFascWeb {
    ...
    public RispostaWSRecuperoFasc recuperaOggettoFasc() throws EMFError {
        ...
        tmpAvanzamento = AvanzamentoWs.nuovoAvanzamentoWS("prova", AvanzamentoWs.Funzioni.RecuperoFascWeb);
        ...
        if (rispostaWs.getSeverity() == IRispostaWS.SeverityEnum.OK) {
            ...
            ParametriRecuperoFasc tmpParametriRecuperoFasc = myRecuperoFascExt.getParametriRecuperoFasc();
            tmpParametriRecuperoFasc.setIdFascicolo(idFascicolo.longValue());
            tmpParametriRecuperoFasc.setUtente(user);
            tmpParametriRecuperoFasc.setTipoRichiedente(JobConstants.TipoSessioniRecupEnum.DOWNLOAD);
             ...
             * tmpParametriRecupero.setIdDocumento(idCompDoc.longValue()); break; case COMP: case COMP_DIP_ESIBIZIONE:
             * case SUB_COMP: tmpParametriRecupero.setIdComponente(idCompDoc.longValue()); break; default: break; }
             */
            ...
            // prepara risposta
            recuperoFascSync.recuperaOggettoFasc(rispostaWs, myRecuperoFascExt, System.getProperty("java.io.tmpdir"));
        }
