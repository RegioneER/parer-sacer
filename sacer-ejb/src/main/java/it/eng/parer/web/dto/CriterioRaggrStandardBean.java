...
public class CriterioRaggrStandardBean {
    ...
    public CriterioRaggrStandardBean(String nmCriterioRaggr, BigDecimal aaKeyUnitaDoc,
	    BigDecimal aaKeyUnitaDocDa, BigDecimal aaKeyUnitaDocA, BigDecimal niTempoScadChius,
	    String tiTempoScadChius, Set<String> reg, Set<String> tipiUd, Set<String> tipiDoc,
	    BigDecimal niMaxComp, String dlOggettoUnitaDoc, Date dtRegUnitaDocDa,
	    Date dtRegUnitaDocA, String dlDoc, String dsAutoreDoc, Date dtCreazioneDa,
	    Date dtCreazioneA, String tiConservazione, String flUnitaDocFirmato,
	    String flForzaAccettazione, String flForzaConservazione, List<String> tiEsitoVerifFirme,
	    List<String> nmSistemaMigraz) {
    ...
    /**
     * @param nmCriterioRaggr the nmCriterioRaggr to set
     */
    ...
    /**
     * @param aaKeyUnitaDocDa the aaKeyUnitaDocDa to set
     */
    ...
    /**
     * @param aaKeyUnitaDocA the aaKeyUnitaDocA to set
     */
    ...
    /**
     * @param niTempoScadChius the niTempoScadChius to set
     */
    ...
    /**
     * @param tiTempoScadChius the tiTempoScadChius to set
     */
    ...
    /**
     * @param tipiUd the tipiUd to set
     */
    ...
    /**
     * @param tipiDoc the tipiDoc to set
     */
    ...
    /**
     * @param niMaxComp the niMaxComp to set
     */
    ...
    /**
     * @param dlOggettoUnitaDoc the dlOggettoUnitaDoc to set
     */
    ...
    /**
     * @param dtRegUnitaDocDa the dtRegUnitaDocDa to set
     */
    ...
    /**
     * @param dtRegUnitaDocA the dtRegUnitaDocA to set
     */
    ...
    /**
     * @param dsAutoreDoc the dsAutoreDoc to set
     */
    ...
    /**
     * @param dtCreazioneDa the dtCreazioneDa to set
     */
    ...
    /**
     * @param dtCreazioneA the dtCreazioneA to set
     */
    ...
    /**
     * @param tiConservazione the tiConservazione to set
     */
    ...
    /**
     * @param flUnitaDocFirmato the flUnitaDocFirmato to set
     */
    ...
    /**
     * @param flForzaConservazione the flForzaConservazione to set
     */
    ...
    /**
     * @param nmSistemaMigraz the nmSistemaMigraz to set
     */
