...
public class ParamIamHelper {
    ...
    public Map<String, String> getParamApplicMapValue(List<String> nmParamApplicList, BigDecimal idAmbienteEnteConvenz,
            BigDecimal idEnteSiam, CostantiDB.TipoIamVGetValAppart getVal) {
    ...
    public String getValoreParamApplic(String nmParamApplic, BigDecimal idAmbienteEnteConvenz, BigDecimal idEnteSiam,
        ...
        String queryStrTempl = "SELECT NEW it.eng.parer.web.helper.dto.IamVGetValParamDto (${" + IAMVGETVALPARAMBYCOL
        ...
        case AMBIENTEENTECONVENZ:
            //
            id = idAmbienteEnteConvenz != null ? idAmbienteEnteConvenz.longValue() : Integer.MIN_VALUE;
            //
