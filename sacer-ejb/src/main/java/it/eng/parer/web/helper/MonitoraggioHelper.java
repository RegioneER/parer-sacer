...
public class MonitoraggioHelper implements Serializable {
    ...
    /**
     * Utilizzato per il calcolo dei totali nella pagina di Riepilogo Versamenti, conta i documenti
     * raggruppandoli per tipo, stato e data di creazione senza filtrare per tipo unità documentaria
     *
     ...
     */
    public AroVDocRangeDtTableBean contaDocNoUd(long idUtente, BigDecimal idAmbiente,
        ...
        StringBuilder queryStr = new StringBuilder(
                "select doc.id.tiDoc, doc.id.tiStatoDoc, doc.id.tiDtCreazione, count(doc) as ni_doc "
                        ...
                        + "and strut.idStrut = iao.idOrganizApplic "
                        + "and doc.id.idStrut = iao.idOrganizApplic ");
    ...
    /**
     * Utilizzato per il calcolo dei totali nella pagina di Riepilogo Versamenti, conta i documenti
     * raggruppandoli per tipo, stato e data di creazione filtrando anche per tipo unità
     * documentaria
     *
     * @param idUtente       l'id associato ai permessi di un utente
     * @param idAmbiente     id ambiente
     * @param idEnte         id ente
     * @param idStruttura    id struttura
     ...
     *
     */
    public AroVDocTiUdRangeDtTableBean contaDocUd(long idUtente, BigDecimal idTipoUnitaDoc,
    ...
    /**
     * Utilizzato per il calcolo dei totali nella pagina di Riepilogo Versamenti, conta i documenti
     * raggruppandoli per tipo, stato del volume e data di creazione senza filtrare per tipo unità
     * documentaria
     *
     * @param idUtente    id utente
     * @param idAmbiente  id ambiente
     ...
     */
    public AroVDocVolRangeDtTableBean contaDocStatoVolNoUd(long idUtente, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStruttura) {
        StringBuilder queryStr = new StringBuilder(
        ...
        queryStr.append(
                "group by doc.id.tiDoc, doc.id.tiStatoVolumeConserv, doc.id.tiDtCreazione ");
    ...
    /**
     * Utilizzato per il calcolo dei totali nella pagina di Riepilogo Versamenti, conta i documenti
     * raggruppandoli per tipo, stato del volume e data di creazione filtrando per tipo unità
     * documentaria
     *
     * @param idUtente       id utente
     * @param idAmbiente     id ambiente
     ...
     */
    public AroVDocVolTiUdRangeDtTableBean contaDocStatoVolUd(long idUtente,
            BigDecimal idTipoUnitaDoc, BigDecimal idAmbiente, BigDecimal idEnte,
            BigDecimal idStruttura) {
        StringBuilder queryStr = new StringBuilder(
                "select doc.id.tiDoc, doc.id.tiStatoVolumeConserv, doc.id.tiDtCreazione, count(doc) as ni_doc_chiuso "
                        + "from IamAbilOrganiz iao, "
                        + "AroVDocVolTiUdRangeDt doc, OrgStrut strut  "
                        + "where iao.iamUser.idUserIam = :idUa "
                        + "and doc.id.tiDoc in ('PRINCIPALE', 'ALLEGATO', 'ANNESSO', 'ANNOTAZIONE') "
                        + "and doc.id.tiStatoDoc = 'IN_VOLUME_CHIUSO' "
                        + "and doc.id.tiStatoVolumeConserv in ('CHIUSO', 'FIRMATO', 'FIRMATO_NO_MARCA', 'DA_VERIFICARE') "
    ...
    /**
     * Utilizzato per il calcolo dei totali nella pagina di Riepilogo Versamenti, conta le sessioni
     * di tipo VERSAMENTO con indicazione di risolta e verificata
     *
     * @param idUtente    id utente
     * @param idAmbiente  id ambiente
     * @param idEnte      id ente
     ...
     */
    public VrsVSessioneVersRisoltaTableBean contaSessioniVersRisVer(long idUtente,
            BigDecimal idAmbiente, BigDecimal idEnte, BigDecimal idStruttura) {
        StringBuilder queryStr = new StringBuilder(
                "select ses.id.flSesRisolta, ses.id.tiDtCreazione, count(ses) as ni_ses_vers, ses.id.flVerif, ses.id.flSesNonRisolub "
                        + "from IamAbilOrganiz iao, "
                        + "VrsVSessioneVersRisolta ses, OrgStrut strut "
                        + "where iao.iamUser.idUserIam = :idUa "
                        + "and ses.id.tiSessioneVers = 'VERSAMENTO' "
                        + "and strut.idStrut = iao.idOrganizApplic "
        ...
        queryStr.append(
                "group by ses.id.flSesRisolta, ses.id.tiDtCreazione, ses.id.flVerif, ses.id.flSesNonRisolub ");
    ...
    /**
     * Utilizzato per il calcolo dei totali nella pagina di Riepilogo Versamenti, conta le sessioni
     * di tipo AGGIUNGI_DOCUMENTO con indicazione di risolta e verificata
     *
     * @param idUtente    id utente
     * @param idAmbiente  id ambiente
     * @param idEnte      id ente
     ...
     */
    public VrsVSessioneAggRisoltaTableBean contaSessioniAggRisVer(long idUtente,
            BigDecimal idAmbiente, BigDecimal idEnte, BigDecimal idStruttura) {
        StringBuilder queryStr = new StringBuilder(
                "select ses.id.flSesRisolta, ses.id.tiDtCreazione, count(ses) as ni_ses_agg, ses.id.flVerif, ses.id.flSesNonRisolub "
                        + "from IamAbilOrganiz iao,  "
                        + "VrsVSessioneAggRisolta ses, OrgStrut strut "
                        + "where iao.iamUser.idUserIam = :idUa "
                        + "and ses.id.tiSessioneVers = 'AGGIUNGI_DOCUMENTO' "
                        + "and ses.id.tiStatoSessioneVers = 'CHIUSA_ERR' "
                        + "and strut.idStrut = iao.idOrganizApplic "
     ...
     *
     * @param idUtente   l'id associato ai permessi di un utente
     * @param maxResult  il numero di record da recuperare
     * @param idAmbiente id ambiente
     *
     * @return entity bean MonVRiepStrutTableBean
     *
     */
    public MonVRiepStrutIamTableBean getMonVRiepStrutIamViewBean(long idUtente, int maxResult,
            int idAmbiente) {
    ...
    private MonVRiepStrutIamTableBean getMonVRiepStrutIamTableBeanFrom(
            List<MonVRiepStrutIam> listaMon) {
     ...
     * @param maxResult risultato massimo
     *
     *
     *
     ...
     *
     */
    public MonVLisUdVersTableBean getMonVLisDocViewBean(final MonitoraggioFiltriListaDocBean filtri,
            int maxResult) {
        ...
        if (StringUtils.isNotBlank(filtri.getTipoDoc()) && filtri.getTipoDoc().equals("1")) {
            if (StringUtils.isBlank(filtri.getStatoDoc()) || (!filtri.getStatoDoc()
                    .equals(ElencoEnums.DocStatusEnum.IN_ATTESA_MEMORIZZAZIONE.name())
                    && !filtri.getStatoDoc()
                            .equals(ElencoEnums.DocStatusEnum.IN_ATTESA_SCHED.name())
                    && !filtri.getStatoDoc()
                            .equals(ElencoEnums.DocStatusEnum.NON_SELEZ_SCHED.name()))) {
        ...
        } else if (StringUtils.isBlank(filtri.getStatoDoc()) || (!filtri.getStatoDoc()
                .equals(ElencoEnums.DocStatusEnum.IN_ATTESA_MEMORIZZAZIONE.name())
        ...
        } else if (filtri.getTipoCreazione()
        ...
        return lazyListHelper.getTableBean(query,
                list -> getMonVLisUdVersTableBeanFrom(filtri, list));
    }

    private MonVLisUdVersTableBean getMonVLisUdVersTableBeanFrom(
            MonitoraggioFiltriListaDocBean filtri, List<?> listaDoc) {
        ...
        try {
            if (listaDoc != null && !listaDoc.isEmpty()) {
                for (int index = 0; index < listaDoc.size(); index++) {
                    ...
                    /*
                     * "Rielaboro" il campo Struttura per presentarlo a video eventualmente
                     * valorizzato anche con ambiente ed ente
                     */
                    ...
                    if (StringUtils.isNotBlank(tiDoc) && !tiDoc.equals("PRINCIPALE")) {
                        row.setString("ti_doc",
                                tiDoc + " " + row.getBigDecimal("pg_doc").toPlainString());
                    }
     ...
     *
     * @param filtriSes i filtri di ricerca riportati dalla pagina precedente
     * @param maxResult il massimo numero di elementi da visualizzare nella lista
     *
     * @return MonVLisVersErrTableBean entity bean MonVLisVersErr
     *
     */
    public MonVLisVersErrIamTableBean getMonVLisVersErrIamViewBean(
            MonitoraggioFiltriListaVersFallitiBean filtriSes, int maxResult) {
        String whereWord = "WHERE ";
        ...
        // Ricavo le date per eventuale inserimento nella query del filtro giorno
        // versamento
        Date dataOrarioDa = (filtriSes.getGiornoVersDaValidato() != null
                ? filtriSes.getGiornoVersDaValidato()
                : null);
        Date dataOrarioA = (filtriSes.getGiornoVersAValidato() != null
                ? filtriSes.getGiornoVersAValidato()
                : null);
        ...
        if (flSessioneErrNonRisolub != null) {
            queryStr.append(whereWord)
                    .append("u.flSessioneErrNonRisolub = :flSessioneErrNonRisolub ");
            whereWord = "AND ";
        }

        // Gestione filtri codice errore
        String classeErrore = filtriSes.getClasseErrore() != null
                ? filtriSes.getClasseErrore().replace("_", "-")
                : null;
        String sottoClasseErrore = filtriSes.getSottoClasseErrore() != null
                ? filtriSes.getSottoClasseErrore().replace("_", "-")
                : null;
        String codiceErrore = filtriSes.getCodiceErrore() != null
                ? filtriSes.getCodiceErrore().replace("_", "-")
                : null;
        ...
        if (numeroRangeDa != null && numeroRangeA != null) {
            numeroRangeDa = StringPadding.padString(numeroRangeDa, "0", 12,
                    StringPadding.PADDING_LEFT);
            numeroRangeA = StringPadding.padString(numeroRangeA, "0", 12,
                    StringPadding.PADDING_LEFT);
            queryStr.append(whereWord).append(
                    "LPAD( u.cdKeyUnitaDoc, 12, '0') BETWEEN :codicein_da AND :codicein_a ");
            whereWord = " AND ";
        ...
        try {
            if (listaVersErr != null && !listaVersErr.isEmpty()) {
                monTableBean = (MonVLisVersErrIamTableBean) Transform
                        .entities2TableBean(listaVersErr);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
     ...
     *
     * @param filtriOV     i filtri di ricerca
     * @param dateValidate filtro data e ora già validato
     * @param maxResult    numero di record da visualizzare alla volta
     *
     * @return entity bean MonVLisOperVolTableBean
     *
     * @throws EMFError errore generico
     */
    public MonVLisOperVolIamTableBean getMonVLisOperVolIamViewBean(FiltriOperazioniVolumi filtriOV,
            Date[] dateValidate, int maxResult) throws EMFError {
     ...
     * @param filtriOV  filtri per la ricerca di Operazioni Volumi
     *
    ...
    public MonVLisOperVolIamTableBean getMonVLisOperVolIamViewBeanPlainFilters(int maxResult,
        ...
        String endWW = "";
        if (flCreaVolume.equals("1") || flRecuperaVolumeAperto.equals("1")
                || flAggiungiDocVolume.equals("1") || flRecuperaVolumeScaduto.equals("1")
                || flSetVolumeDaChiudere.equals("1") || flSetVolumeAperto.equals("1")
                || flInizioCreaIndice.equals("1") || flRecuperaVolumeInErrore.equals("1")
                || flCreaIndiceVolume.equals("1") || flMarcaIndiceVolume.equals("1")
                || flSetVolumeInErrore.equals("1") || flInizioVerifFirme.equals("1")
                || flChiusuraVolume.equals("1") || flErrVerifFirme.equals("1")
                || flRimuoviDocVolume.equals("1") || flEliminaVolume.equals("1")
                || flModificaVolume.equals("1") || flFirmaNoMarcaVolume.equals("1")
        ...
        // ESEGUO LA QUERY E PIAZZO I RISULTATI IN UNA LISTA
        return lazyListHelper.getTableBean(query,
                list -> getMonVLisOperVolIamTableBeanFrom(idEnte, list));
    }
    ...
    private MonVLisOperVolIamTableBean getMonVLisOperVolIamTableBeanFrom(BigDecimal idEnte,
        ...
        try {
            if (listaOperVol != null && !listaOperVol.isEmpty()) {
                monTableBean = (MonVLisOperVolIamTableBean) Transform
                        .entities2TableBean(listaOperVol);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
        ...
        for (MonVLisOperVolIamRowBean row : monTableBean) {
            row.setString("firmatario",
                    row.getNmCognomeFirmatario() + " " + row.getNmNomeFirmatario());

            /*
             * "Rielaboro" il campo Struttura per presentarlo a video eventualmente valorizzato
             * anche con ambiente ed ente
             */
            if (idEnte == null) {
                row.setNmStrut((row.getNmEnte() != null ? row.getNmEnte() : "") + ", "
                        + (row.getNmStrut() != null ? row.getNmStrut() : ""));
    ...
    /**
     * Recupera il tablebean con i dati da visualizzare nella pagina Esame Operazioni Elenchi di
     * Versamento
     *
     * @param filtriOE     i filtri di ricerca
     * @param dateValidate filtro data e ora già validato
     *
     * @return entity bean MonVLisOperVolTableBean
     *
    ...
    public ElvVLisLogOperTableBean getElvVLisLogOperViewBean(
            MonitoraggioForm.FiltriOperazioniElenchiVersamento filtriOE, Date[] dateValidate)
            throws EMFError {
        final Date dataOrarioDa = dateValidate != null ? dateValidate[0] : null;
        final Date dataOrarioA = dateValidate != null ? dateValidate[1] : null;
     ...
     */
    public ElvVLisLogOperTableBean getElvVLisLogOperViewBean(
            FiltriOperazioniElenchiVersamentoPlain filtriOE) {
        String whereWord = "WHERE ";
        ...
        String endWW = "";
        if (flChiusuraElenco || flCreaElenco || flCreaIndiceElenco || flDefNoteElencoChiuso
                || flDefNoteIndiceElenco || flEliminaElenco || flFirmaElenco || flModElenco
                || flRecuperaElencoAperto || flRecuperaElencoScaduto || flRimuoviDocElenco
                || flRimuoviUdElenco || flSetElencoAperto || flSetElencoDaChiudere || flFirmaInCorso
                || flFirmaInCorsoFallita || flStartCreazioneElencoAip || flEndCreazioneElencoAip
                || flFirmaElencoAip || flFirmaElencoAipInCorso || flFirmaElencoAipFallita
                || flMarcaElencoAip || flMarcaElencoAipFallita) {
            whereWord = "AND (";
            endWW = ")";
        } else {
            // setto il valore '' per fare in modo che se non ho settato nessun flag
        ...
        try {
            if (listaOperElenchi != null && !listaOperElenchi.isEmpty()) {
                monTableBean = (ElvVLisLogOperTableBean) Transform
                        .entities2TableBean(listaOperElenchi);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    /**
     * Recupera una lista con i dati da visualizzare nella pagina Esame Operazioni Volumi per
     * l'output di tipo aggregato
     *
     * @param filtriOV     i filtri di ricerca
     * @param dateValidate filtro data e ora già validato
     *
     ...
     * @throws EMFError errore generico
     */
    public BaseTable getMonVLisOperVolOutputAggregato(FiltriOperazioniVolumi filtriOV,
            Date[] dateValidate) throws EMFError {
        final Date dataOrarioDa = (dateValidate != null ? dateValidate[0] : null);
        final Date dataOrarioA = (dateValidate != null ? dateValidate[1] : null);
        return getMonVLisOperVolOutputAggregato(
                new FiltriOperazioniVolumiPlain(filtriOV, dataOrarioDa, dataOrarioA));
    }

    public BaseTable getMonVLisOperVolOutputAggregato(FiltriOperazioniVolumiPlain filtriOV) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT u.tiOper, count(u) FROM MonVLisOperVolIam u ");
        String whereWord = "WHERE ";
     ...
     * @throws EMFError errore generico
     */
    public BaseTable getElvVLisLogOperOutputAggregato(
            MonitoraggioForm.FiltriOperazioniElenchiVersamento filtriOE, Date[] dateValidate)
            throws EMFError {
    ...
    public BaseTable getElvVLisLogOperOutputAggregato(
        ...
        String whereWord = "WHERE ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT u.tiOper, count(u) FROM ElvVLisLogOper u ");
    ...
    /**
     * Restituisce la lista contenente i dati totali del contenuto SACER della pagina Esame
     * Contenuto Sacer
     *
     * @param filtriCS           bean filtro FiltriContenutoSacer
     * @param idAmbitoTerritList lista id ambienti territoriali
     ...
     * @throws EMFError errore generico
     */
    public BaseTable getMonTotSacerTable(FiltriContenutoSacer filtriCS,
            List<BigDecimal> idAmbitoTerritList, long idUserIam) throws EMFError {
        return getMonTotSacerTable(idAmbitoTerritList, idUserIam,
                new FiltriContenutoSacerPlain(filtriCS));
    }
     ...
     * Contenuto Sacer
     *
     * @param idAmbitoTerritList lista degli id di ambito territoriale
     * @param idUserIam          id dello user
     * @param filtriCS           filtri del contenuto Sacer
     *
    ...
    public BaseTable getMonTotSacerTable(List<BigDecimal> idAmbitoTerritList, long idUserIam,
        ...
        if (!idAmbienteList.isEmpty()) {
            queryStr.append(whereWord)
                    .append("strut.orgEnte.orgAmbiente.idAmbiente IN :idAmbienteList ");
        }
        // Inserimento nella query del filtro id ente
     ...
     * @param idUserIam  id user Iam
     * @param idEnte     id ente
     * @param dtRifDa    data riferimento da
     * @param idStrut    id struttura
     * @param dtRifA     data riferimento a
     *
     * @return entity bean MonTotSacerRowBean
     *
     */
    public BaseTable getMonTotSacerForHomeTable(BigDecimal idAmbiente, BigDecimal idEnte,
            BigDecimal idStrut, Date dtRifDa, Date dtRifA, long idUserIam) {
        String whereWord = "AND ";
        ...
        if (idAmbiente != null) {
            queryStr.append(whereWord)
                    .append("strut.orgEnte.orgAmbiente.idAmbiente = :idAmbiente ");
        }
        if (idEnte != null) {
    ...
    public CounterResultBean getTotalMonTotSacer() throws EMFError {
        try {
            ...
            TypedQuery<CounterResultBean> query = entityManager.createQuery(sql,
                    CounterResultBean.class);
     ...
     * di Dettaglio Versamento Fallito o Sessione Errata
     *
     ...
     * @param nmAmbientePerCalcolo    nome ambiente
     * @param nmEntePerCalcolo        nome ente
     * @param nmStrutPerCalcolo       nome struttura
     * @param idStrutPerCalcolo       id struttura
     * @param registroUD              registro unita doc
     * @param annoUD                  anno unita doc
     * @param numUD                   numero unita doc
     * @param chiaveDoc               chiave documento
     */
    public void salvaDettaglio(BigDecimal idSessioneVers, String flSessioneErrVerif,
            String flSessioneErrNonRisolub, String nmAmbientePerCalcolo, String nmEntePerCalcolo,
            String nmStrutPerCalcolo, BigDecimal idStrutPerCalcolo, String registroUD,
            BigDecimal annoUD, String numUD, String chiaveDoc) {
    ...
    /**
     * Salva nella tabella relativa alle sessioni di versamento le modifiche apportate nella pagina
     * al flag "verificato" di Lista Versamenti Falliti o Sessioni Errate
     *
     * @param idSessioneVers     id sessione versamento
     * @param flSessioneErrVerif flag 1/0 (true/false)
     */
    ...
    public void saveFlVerificatiNonRisolubili(BigDecimal idSessioneVers, String flSessioneErrVerif,
        ...
        VrsSessioneVersKo rec = entityManager.getReference(VrsSessioneVersKo.class,
                idSessioneVers.longValue());
        if (flSessioneErrVerif != null) {
     ...
     *
     * @param idTipoUD id tipo unita doc
     *
     ...
     * @param maxResults   numero massimo risultati
     *
    ...
    public VrsSessioneVersKoTableBean getSessioniErrateListTB(String flVerificato, int maxResults) {
        ...
        return lazyListHelper.getTableBean(query,
                list -> getVrsSessioneVersTableBeanFrom(list, entityManager));
    }

    private VrsSessioneVersKoTableBean getVrsSessioneVersTableBeanFrom(
            List<Object[]> sessioniErrate, EntityManager em) {
        VrsSessioneVersKoTableBean sessioniErrateTableBean = new VrsSessioneVersKoTableBean();
        try {
            // trasformo la lista di entity (risultante della query) in un tablebean
            for (Object[] row : sessioniErrate) {
                int i = 0;
                VrsSessioneVersKo bean = em.find(VrsSessioneVersKo.class,
                        Long.class.cast(row[i++]));
                VrsSessioneVersKoRowBean rowBean = (VrsSessioneVersKoRowBean) Transform
                        .entity2RowBean(bean);
    ...
    public MonVVisVersErrIamRowBean getMonVVisVersErrIamRowBean(BigDecimal idSessioneVers) {
        ...
        try {
            ...
            log.error("Errore nel recupero del dettaglio del versamento fallito " + e.getMessage(),
                    e);
        }
        return versErr;
    }
     ...
     *
     * @param riga MonVVisVersErrIamRowBean
     */
    private void aggiungiXmlDaObjectStorage(MonVVisVersErrIamRowBean riga) {
        ...
        if (riga.getIdSessioneVers() != null && xmlVuoti) {
            Map<String, String> xmls = objectStorageService
                    .getObjectSipInStaging(riga.getIdSessioneVers().longValue());
     ...
     * Se si avvera il secondo caso li devo recuperare
     *
     * @param riga MonVVisSesErrIamRowBean
     */
    private void aggiungiXmlDaObjectStorage(MonVVisSesErrIamRowBean riga) {
        boolean xmlVuoti = riga.getBlXmlRich() == null && riga.getBlXmlRisp() == null;
        /*
         * il backend risulta essere Object storage quindi gli xml non sono nei rowbean già caricati
         * in memoria. Se gli xml non sono ancora stati migrati, però, sono ancora presenti sulle
         * tabelle
         */
        if (riga.getIdSessioneVers() != null && xmlVuoti) {
            Map<String, String> xmls = objectStorageService
    ...
    public MonVVisSesErrIamRowBean getMonVVisSesErrIamRowBean(BigDecimal idSessioneVers) {
        ...
        try {
            ...
            log.error("Errore nel recupero del dettaglio della sessione fallita " + e.getMessage(),
                    e);
        }

        // concateno alcuni campi per il front-end
        String ambiente = sesErr != null && sesErr.getNmAmbiente() != null ? sesErr.getNmAmbiente()
                : "";
        String ente = sesErr != null && sesErr.getNmEnte() != null ? ", " + sesErr.getNmEnte() : "";
        String strut = sesErr != null && sesErr.getNmStrut() != null ? ", " + sesErr.getNmStrut()
                : "";
        if (sesErr != null) {
    ...
    public VrsFileSessioneKoTableBean getFileListTableBean(BigDecimal idSessioneVers) {
        Query query = entityManager.createQuery(
                "select ses.idSessioneVersKo, fileSes.pgFileSessione, fileSes.nmFileSessione, "
                        + "CONCAT('vers_', ses.idSessioneVersKo, '_file_', fileSes.pgFileSessione, '_id_', fileSes.nmFileSessione) "
                        + "from VrsSessioneVersKo ses JOIN "
                        + "ses.vrsDatiSessioneVersKos datiSes JOIN "
                        + "datiSes.vrsFileSessioneKos fileSes "
                        + "where ses.idSessioneVersKo = :idSessioneVers "
                        + "order by fileSes.pgFileSessione ");
        query.setParameter("idSessioneVers", longFromBigDecimal(idSessioneVers));

        return lazyListHelper.getTableBean(query,
                list -> getVrsFileSessioneKoTableBeanFrom(idSessioneVers, list));
    }
    ...
    /**
     * Restituisce una lista di oggetti blob (id, nome, contenuto in byte[]) che rappresentano i
     * file fisici della lista file nella pagina Dettaglio Versamento Fallito
     *
     * @param idSessioneVersKo id sessione di versamento
     *
    ...
    public List<BlobObject> getBlobboByteList(BigDecimal idSessioneVersKo) {
        ...
        // ricavo i blobbi
        VrsSessioneVersKo sessione = entityManager.find(VrsSessioneVersKo.class,
                idSessioneVersKo.longValue());
        for (int i = 0; i < sessione.getVrsDatiSessioneVersKos().size(); i++) {
            ...
            for (int j = 0; j < datiSes.getVrsFileSessioneKos().size(); j++) {
                ...
                BlobObject bo = new BlobObject(fileSes.getIdFileSessioneKo(),
                        "vers_" + sessione.getIdSessioneVersKo() + "_file_"
                                + fileSes.getPgFileSessione() + "_id_"
                                + fileSes.getNmFileSessione(),
                        null);
     ...
     * in ingresso
     *
     * @param filtriJS     job schedulati FiltriJobSchedulati
     * @param dateValidate date da verificare
     *
     * @return entity bean LogVLisSchedTableBean
     *
     * @throws EMFError errore generico
     */
    public AbstractBaseTable<?> getLogVLisSchedViewBean(FiltriJobSchedulati filtriJS,
            Date[] dateValidate) throws EMFError {
        ...
        if ("0".equals(filtriJS.getStorico().parse())) {
            listReturn = getLogVLisSchedViewBeanPlainFilters(filtriJS.getNm_job().parse(),
                    dataOrarioDa, dataOrarioA);
        } else {
            listReturn = getLogVLisSchedHistViewBeanPlainFilters(filtriJS.getNm_job().parse(),
                    dataOrarioDa, dataOrarioA);
        }
        return listReturn;
    }
     ...
     * @param dataOrarioDa data e ora di inizio
     * @param dataOrarioA  data e ora di fine
     *
    ...
    /**
     * Metodo che restituisce un viewbean con lo storico dei record trovati in base ai filtri di
     * ricerca passati in ingresso
     *
     * @param nomeJob      nome del job
     * @param dataOrarioDa data e ora di inizio
     * @param dataOrarioA  data e ora di fine
    ...
    public AbstractBaseTable<?> getLogVLisSchedStrutViewBean(FiltriJobSchedulati filtriJS,
        ...
        if ("0".equals(filtriJS.getStorico().parse())) {
            listReturn = getLogVLisSchedStrutViewBean(filtriJS.getId_strut().parse(),
                    filtriJS.getNm_job().parse(), dataOrarioDa, dataOrarioA);
        } else {
            listReturn = getLogVLisSchedStrutHistViewBean(filtriJS.getId_strut().parse(),
                    filtriJS.getNm_job().parse(), dataOrarioDa, dataOrarioA);
        }
        return listReturn;
    }

    public LogVLisSchedStrutTableBean getLogVLisSchedStrutViewBean(BigDecimal idStrut,
            String nomeJob, Date dataOrarioDa, Date dataOrarioA) {
        String whereWord = "WHERE ";
        ...
        try {
            if (listaSched != null && !listaSched.isEmpty()) {
                schedTableBean = (LogVLisSchedStrutTableBean) Transform
                        .entities2TableBean(listaSched);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
    ...
    public LogVLisSchedStrutHistTableBean getLogVLisSchedStrutHistViewBean(BigDecimal idStrut,
            String nomeJob, Date dataOrarioDa, Date dataOrarioA) {
        String whereWord = "WHERE ";
        ...
        try {
            if (listaSchedHist != null && !listaSchedHist.isEmpty()) {
                schedHistTableBean = (LogVLisSchedStrutHistTableBean) Transform
                        .entities2TableBean(listaSchedHist);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public List<Object[]> contaVersFallitiDistintiUD(long idUtente, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStruttura) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT COUNT(u), u.id.idStrut, u.id.flVerif, u.id.flNonRisolub "
                        + "FROM IamAbilOrganiz iao, " + "VrsVUdNonVer u, OrgStrut strut "
                        + "WHERE u.id.idStrut = iao.idOrganizApplic "
                        + "AND strut.idStrut = iao.idOrganizApplic "
                        + "AND iao.iamUser.idUserIam = :idUa ");
    ...
    public List<Object[]> contaVersFallitiDistintiDoc(long idUtente, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStruttura) {
        StringBuilder queryStr = new StringBuilder(
     ...
     *
     */
    public MonVVisUdNonVersRowBean getMonVVisUdNonVersRowBean(BigDecimal idStrut,
            String cdRegistroKeyUnitaDoc, BigDecimal aaKeyUnitaDoc, String cdKeyUnitaDoc) {
        List<MonVVisUdNonVers> listaNonVers = getMonVVisUdNonVers(idStrut, cdRegistroKeyUnitaDoc,
                aaKeyUnitaDoc, cdKeyUnitaDoc);
        ...
        try {
            ...
            log.error("Errore nel recupero del dettaglio dell'unità documentaria non versata "
                    + e.getMessage(), e);
        }
    ...
    public List<MonVVisUdNonVers> getMonVVisUdNonVers(BigDecimal idStrut,
            String cdRegistroKeyUnitaDoc, BigDecimal aaKeyUnitaDoc, String cdKeyUnitaDoc) {
        String queryStr = "SELECT u FROM MonVVisUdNonVers u " + "WHERE u.id.idStrut = :idstrut "
                ...
                + "AND u.id.aaKeyUnitaDoc = :aakeyunitadoc "
                + "AND u.id.cdKeyUnitaDoc = :cdkeyunitadoc";
    ...
    public MonVVisDocNonVersRowBean getMonVVisDocNonVersRowBean(BigDecimal idStrut,
            String cdRegistroKeyUnitaDoc, BigDecimal aaKeyUnitaDoc, String cdKeyUnitaDoc,
            String cdKeyDocVers) {
        List<MonVVisDocNonVers> listaNonVers = getMonVVisDocNonVers(idStrut, cdRegistroKeyUnitaDoc,
                aaKeyUnitaDoc, cdKeyUnitaDoc, cdKeyDocVers);
    ...
    public List<MonVVisDocNonVers> getMonVVisDocNonVers(BigDecimal idStrut,
            String cdRegistroKeyUnitaDoc, BigDecimal aaKeyUnitaDoc, String cdKeyUnitaDoc,
            String cdKeyDocVers) {
    ...
    public MonVLisVersDocNonVersTableBean getMonVLisVersDocNonVersViewBean(BigDecimal idStrut,
        ...
        StringBuilder queryStr = new StringBuilder("SELECT u FROM MonVLisVersDocNonVers u "
                + "WHERE u.cdRegistroKeyUnitaDoc = :cdregistrokeyunitadoc "
        ...
        try {
            if (listaVersDocNonVers != null && !listaVersDocNonVers.isEmpty()) {
                monTableBean = (MonVLisVersDocNonVersTableBean) Transform
                        .entities2TableBean(listaVersDocNonVers);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public MonVLisVersUdNonVersTableBean getMonVLisVersUdNonVersViewBean(BigDecimal idStrut,
        ...
        Query query = entityManager.createQuery("SELECT u FROM MonVLisVersUdNonVers u "
                + "WHERE u.cdRegistroKeyUnitaDoc = :cdregistrokeyunitadoc "
                + "AND u.aaKeyUnitaDoc = :aakeyunitadoc " + "AND u.cdKeyUnitaDoc = :cdkeyunitadoc "
                + "AND u.idStrut = :idstrut ORDER BY u.dtChiusura DESC");
        ...
        try {
            if (listaVersUdNonVers != null && !listaVersUdNonVers.isEmpty()) {
                monTableBean = (MonVLisVersUdNonVersTableBean) Transform
                        .entities2TableBean(listaVersUdNonVers);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public BaseTable getRegistriFromTotaleMonVLisVersErr(BigDecimal idAmbiente, BigDecimal idEnte,
            BigDecimal idStrut, Long idUserIam) {
        String whereWord = "WHERE ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT DISTINCT u.cdRegistroKeyUnitaDoc FROM MonVLisVersErrIam u ");
    ...
    public BaseTable getRegistriFromTotaleMonVLisUdNonVers(BigDecimal idAmbiente, BigDecimal idEnte,
            BigDecimal idStrut, Long idUserIam) {
        String whereWord = "WHERE ";
        StringBuilder queryStr = new StringBuilder(
        ...
        // ordina per data chiusura descrescente
        queryStr.append(
                "AND u.id.cdRegistroKeyUnitaDoc IS NOT NULL ORDER BY u.id.cdRegistroKeyUnitaDoc");
    ...
    /**
     *
     * @param idSessioneVers id della sessione di versamento
     *
    ...
    public MonVLisSesRecupTableBean getSessioniRecupero(BigDecimal idAmbiente, BigDecimal idEnte,
            BigDecimal idStruttura, String nmUserid, Date[] dateAperture, Object[] chiavi,
            String tiStato, String tiSessione) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT sesRecup from MonVLisSesRecup sesRecup ");
        ...
        if (dateDa != null && dateA != null) {
            queryStr.append(whereCondition)
                    .append("sesRecup.dtApertura BETWEEN :dataDa AND :dataA ");
            whereCondition = "AND ";
        } else if (dateDa != null) {
        ...
        if (chiavi != null) {
            if (chiavi[0] != null) {
                ...
                if (registri != null && registri.size() > 1) {
                    queryStr.append(whereCondition)
                            .append("sesRecup.cdRegistroKeyUnitaDoc IN (:registri) ");
                    whereCondition = "AND ";
                } else if (registri != null && !registri.isEmpty()) {
                    queryStr.append(whereCondition)
                            .append("sesRecup.cdRegistroKeyUnitaDoc = :registri ");
                    whereCondition = "AND ";
                }
            }
            if (chiavi[1] != null) {
        ...
        try {
            if (sesRecup != null && !sesRecup.isEmpty()) {
                for (MonVLisSesRecup row : sesRecup) {
                    MonVLisSesRecupRowBean rowBean = (MonVLisSesRecupRowBean) Transform
                            .entity2RowBean(row);
                    // MAC#27666
                    // SimpleDateFormat df = new SimpleDateFormat(Constants.DATE_FORMAT_DATE_TYPE
                    DateTimeFormatter df = DateTimeFormatter
                            .ofPattern(Constants.DATE_FORMAT_DATE_TYPE);
                    // end MAC#27666
                    ...
                    boolean downloadable = rowBean.getTiSessione()
                            ...
                            && rowBean.getTiStato()
                                    .equals(JobConstants.StatoSessioniRecupEnum.CHIUSO_OK.name());
     ...
     *
     * @param filtri    i filtri di ricerca riportati dalla pagina precedente
     * @param maxResult numero massimo risultati
     *
    ...
    public IamVLisOrganizDaReplicTableBean getIamVLisOrganizDaReplicTableBean(
            FiltriReplicaOrg filtri, int maxResult) throws EMFError {
        return getIamVLisOrganizDaReplicTableBeanPlainFilters(maxResult,
                filtri.getId_ambiente().parse(), filtri.getId_ente().parse(),
                filtri.getId_strut().parse(), filtri.getTi_oper_replic().parse(),
     ...
     *
     * @param maxResult  numero massimo di risultati
     * @param idAmbiente id dell'ambiente
     * @param idEnte     id dell'ente
     * @param idStrut    id della struttura
     * @param tiOper     tipo operazione
     * @param tiStato    tipo stato
     *
     * @return IamVLisOrganizDaReplicTableBean il table Bean da usare nella UI
     */
    public IamVLisOrganizDaReplicTableBean getIamVLisOrganizDaReplicTableBeanPlainFilters(
            int maxResult, BigDecimal idAmbiente, BigDecimal idEnte, BigDecimal idStrut,
    ...
    /**
     * Recupera il tablebean con i dati da visualizzare nella pagina Lista versamenti documenti
     * annullati
     *
     * @param idUtente        id utente
     * @param filtri          i filtri di ricerca riportati dalla pagina precedente
     * @param maxResult       numero massimo risultati
     * @param toTableBeanFunc funzione che data una List di record restituisce una
     *                        {@link MonVLisUniDocDaAnnulTableBean}
     *
     *
     *
     * @return entity bean MonVLisDocTableBean
    ...
    public BaseRow getTotaliUdDocComp(FiltriContenutoSacer filtriCS,
            List<BigDecimal> idAmbitoTerritList, long idUserIam) throws EMFError {
        return getTotaliUdDocComp(idAmbitoTerritList, idUserIam,
                new FiltriContenutoSacerPlain(filtriCS));
    }
    ...
    public BaseRow getTotaliUdDocComp(List<BigDecimal> idAmbitoTerritList, long idUserIam,
        ...
        if (!idAmbitoTerritList.isEmpty()) {
            queryStr.append(whereWord)
                    .append("enteConvenz.idAmbitoTerrit IN (:idAmbitoTerritList) ");
        }
    ...
    public BaseRow getTotaliUdDocCompForHome(BigDecimal idAmbiente, BigDecimal idEnte,
            BigDecimal idStrut, Date dtRifDa, Date dtRifA, long idUserIam) {
        String whereWord = "AND ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT sum(mon.niUnitaDocVers) - sum(mon.niUnitaDocAnnul) AS num_ud, "
    ...
    public Object[] getListaTotaliConsistenzaComp(FiltriConsistenzaSacer filtri) throws EMFError {
        ...
        String parte2 = "(SELECT ambientesub.id_ambiente, ambientesub.nm_ambiente, entesub.id_ente, entesub.nm_ente, strut.id_Strut, strut.nm_strut, "
                ...
                + "and conta_stato.dt_rif_conta BETWEEN TO_DATE(?1, 'dd-mm-yyyy') "
                + "AND TO_DATE(?2, 'dd-mm-yyyy') ) " + "join sacer.org_ente entesub "
                + "on(entesub.id_ente = strut.id_ente) " + "join sacer.org_ambiente ambientesub "
                + "on(ambientesub.id_ambiente = entesub.id_ambiente) "
        ...
        if (filtri.getId_ente().parse() != null) {
            confrontoConteggiNativeQuery = confrontoConteggiNativeQuery + " AND entesub.id_ente = ?"
                    + i++;
        }
        if (filtri.getId_strut().parse() != null) {
            confrontoConteggiNativeQuery = confrontoConteggiNativeQuery + " AND strut.id_strut = ?"
                    + i++;
        }
        ...
        for (Object[] totali : listaTotSacer) {
            try {
                ...
                BigDecimal deltaParte2 = riga.getBigDecimal("ni_comp_presa_in_carico")
                        ...
                        .add(riga.getBigDecimal("ni_comp_aip_generato"))
                        .add(riga.getBigDecimal("ni_comp_in_volume"));
                ...
                tabella.add(riga);
                // Aggiungo i totali
                totaleNiCompAipGen = totaleNiCompAipGen
                        + riga.getBigDecimal("ni_comp_aip_generato").longValue();
                totaleNiCompNeiSip = totaleNiCompNeiSip
                        + riga.getBigDecimal("ni_comp_vers").longValue();
                totaleNiCompNeiSipAnnul = totaleNiCompNeiSipAnnul
                        + riga.getBigDecimal("ni_comp_annul").longValue();
                totaleNiCompAipInAggiorn = totaleNiCompAipInAggiorn
                        + riga.getBigDecimal("ni_comp_aip_in_aggiorn").longValue();
                totaleNiCompInVolume = totaleNiCompInVolume
                        + riga.getBigDecimal("ni_comp_in_volume").longValue();
                totaleNiCompPresaInCarico = totaleNiCompPresaInCarico
                        + riga.getBigDecimal("ni_comp_presa_in_carico").longValue();
                totaleNiCompDelta = totaleNiCompDelta
                        + riga.getBigDecimal("ni_comp_delta").longValue();
        ...
        rigaTotali.setBigDecimal("totale_ni_comp_aip_in_aggiorn",
                new BigDecimal(totaleNiCompAipInAggiorn));
        ...
        rigaTotali.setBigDecimal("totale_ni_comp_presa_in_carico",
                new BigDecimal(totaleNiCompPresaInCarico));
    ...
    public String getListaTotaliConsistenzaCompDiffDayByDay(FiltriConsistenzaSacer filtri,
            Calendar start) throws EMFError {
        /*
         * Query per confronto totali tra MON_CONTA_UD_DOC_COMP e MON_CONTA_BY_STATO_CONSERV_NEW
         */
        ...
        String parte2 = " (SELECT nvl(sum (ni_comp_vers + ni_comp_agg), 0) "
                ...
                + "      and conta_stato.id_strut = strut.id_strut "
                ...
                + "    from org_strut strut " + " join sacer.org_ente entesub "
                + "on(entesub.id_ente = strut.id_ente) "
                + "    join sacer.org_ambiente ambientesub "
                + "on(ambientesub.id_ambiente = entesub.id_ambiente) "
        ...
        if (filtri.getId_ente().parse() != null) {
            confrontoConteggiNativeQuery = confrontoConteggiNativeQuery
                    + " AND entesub.id_ente = ?4 ";
        }
        if (filtri.getId_strut().parse() != null) {
            confrontoConteggiNativeQuery = confrontoConteggiNativeQuery
                    + " AND strut.id_strut = ?5 ";
        }

        confrontoConteggiNativeQuery = confrontoConteggiNativeQuery + " ) tmp "
                + "join sacer.org_ente ente " + "    on (ente.id_ente = tmp.id_ente) "
                + "join sacer.org_ambiente amb " + "    on (amb.id_ambiente = ente.id_ambiente) "
    ...
    public BaseTable getListaDifferenzaConsistenzaComp(BigDecimal idStrut, Date dtRifContaDa,
            Date dtRifContaA) {
        ...
        String differenzaNativeQuery = "SELECT a.*, "
                ...
                + "             GROUP BY TRUNC (doc.dt_creazione), "
                + "                   aa_key_unita_doc, " + "                   ud.id_strut, "
                + "                   ud.id_tipo_unita_doc, "
                + "                   doc_princ.id_tipo_doc, "
                + "                   ud.ID_REGISTRO_UNITA_DOC) a " + "         JOIN "
                + "         (  SELECT /*+ parallel (12) */ id_strut, "
                ...
                + "            FROM mon_v_ric_conta_ud_doc_comp "
                + "            WHERE id_strut = ?1  "
                // + " AND id_sub_strut = ?2 "
                ...
                + "                   id_tipo_unita_doc, "
                + "                   id_tipo_doc_princ, "
                + "                   id_REGISTRO_UNITA_DOC) b "
                + "             ON     a.id_strut = b.id_strut "
        ...
        for (BaseRow rigaMod : tabella) {
            rigaMod.setString("nm_strut",
                    entityManager
                            .find(OrgStrut.class, rigaMod.getBigDecimal("id_strut").longValue())
                            .getNmStrut());
            rigaMod.setString("nm_sub_strut",
                    entityManager
                            .find(OrgSubStrut.class,
                                    rigaMod.getBigDecimal("id_sub_strut").longValue())
                            .getNmSubStrut());
            rigaMod.setString("nm_tipo_doc",
                    entityManager
                            .find(DecTipoDoc.class,
                                    rigaMod.getBigDecimal("id_tipo_doc").longValue())
                            .getNmTipoDoc());
            rigaMod.setString("nm_tipo_unita_doc",
                    entityManager
                            .find(DecTipoUnitaDoc.class,
                                    rigaMod.getBigDecimal("id_tipo_unita_doc").longValue())
                            .getNmTipoUnitaDoc());
            rigaMod.setString("cd_registro_unita_doc",
                    entityManager
                            .find(DecRegistroUnitaDoc.class,
                                    rigaMod.getBigDecimal("id_registro_unita_doc").longValue())
    ...
    public BaseTable getListaDifferenzaConsistenzaVsCalcoloSacer(BigDecimal idStrut,
            Date dtRifContaDa, Date dtRifContaA) {
        /* Query per evidenziare differenze conteggio consistenza */
        String differenzaNativeQuery = "SELECT" + "  a.*,"
                + "  a.TOT_COMP_VERSATI_IN_ARCHIVIO - b.TOT_COMP_VERSA_CONTATI AS differenza,"
                + "  b.id_strut as id_Strut_b," + "  b.dt_rif_conta as dt_rif_conta_b,"
                + "  b.tot_comp_versa_contati"
                + "    FROM (   SELECT /*+ parallel (12) */ id_strut,"
                + "                   dt_rif_conta,"
                ...
                + "                   aa_key_unita_doc," + "                   id_tipo_unita_doc,"
                + "                   id_tipo_doc_princ,"
                + "                   id_REGISTRO_UNITA_DOC," + "                   id_sub_strut   "
                + "              FROM mon_v_ric_conta_by_stato_conserv_new"
                + "             WHERE id_strut = ?1 "
                + "                   AND dt_rif_conta BETWEEN TO_DATE (?2, 'dd/mm/yyyy') AND TO_DATE (?3, 'dd/mm/yyyy') "
                + "          GROUP BY id_strut," + "                   dt_rif_conta,"
                + "                   aa_key_unita_doc," + "                   id_tipo_unita_doc,"
                + "                   id_tipo_doc_princ,"
                + "                   id_REGISTRO_UNITA_DOC," + "                   id_sub_strut) a"
    ...
    public BaseTable getListaDifferenzaConsistenzaVsCalcoloSacer2(BigDecimal idStrut,
            Date dtRifContaDa, Date dtRifContaA) {
        /* Query per evidenziare differenze conteggio consistenza */
        String differenzaNativeQuery = "SELECT" + "  a.*,"
                + "  a.TOT_COMP_VERSATI_IN_ARCHIVIO - b.TOT_COMP_VERSA_CONTATI AS differenza,"
    ...
    public Calendar getLastPositiveRunCalcoloContenutoSacer() {
        String queryStr = "SELECT logJob.dtRegLogJob FROM LogJob logJob "
                + "WHERE logJob.nmJob = 'CALCOLO_CONTENUTO_SACER' "
    ...
    public BaseTable getListaDifferenzaConsistenzaVsCalcoloSacerConTipoDoc(BigDecimal idStrut,
            Date dtRifContaDa, Date dtRifContaA) {
        /* Query per evidenziare differenze conteggio consistenza */
        String differenzaNativeQuery = "SELECT" + "  a.*,"
                + "  a.TOT_COMP_VERSATI_IN_ARCHIVIO - b.TOT_COMP_VERSA_CONTATI AS differenza,"
                + "  b.id_strut," + "  b.dt_rif_conta," + "  b.tot_comp_versa_contati"
                + "    FROM (   SELECT /*+ parallel (12) */ id_strut,"
                + "                   dt_rif_conta,"
                + "                   COUNT (1)                    AS tot_comp_versati_in_archivio, "
                + "                   aa_key_unita_doc,"
    ...
    public MonVLisUdNonVersIamTableBean getMonVLisUdNonVersIamViewBeanScaricaContenuto(
        ...
        Date dataFirstOrarioDa = (filtri.getGiornoFirstVersDaValidato() != null
                ? filtri.getGiornoFirstVersDaValidato()
                : null);
        Date dataFirstOrarioA = (filtri.getGiornoFirstVersAValidato() != null
                ? filtri.getGiornoFirstVersAValidato()
                : null);

        Date dataLastOrarioDa = (filtri.getGiornoLastVersDaValidato() != null
                ? filtri.getGiornoLastVersDaValidato()
                : null);
        Date dataLastOrarioA = (filtri.getGiornoLastVersAValidato() != null
                ? filtri.getGiornoLastVersAValidato()
                : null);

        // Inserimento nella query del filtro data già impostato con data e ora
        if ((dataFirstOrarioDa != null) && (dataFirstOrarioA != null)) {
            queryStr.append(whereWord)
                    .append("u.dtFirstSesErr between :datafirstda AND :datafirsta ");
            whereWord = "AND ";
        }
        ...
        // whereWord = "AND ";
        // }
        // Inserimento nella query del filtro CHIAVE UNITA DOC singola con registro in versione
        // multiselect
        Set<String> registroSet = filtri.getRegistro();
        if (registroSet != null && !registroSet.isEmpty()) {
            queryStr.append(whereWord)
                    .append("(u.monVLisUdNonVersIamId.cdRegistroKeyUnitaDoc IN :setregistro)");
            whereWord = " AND ";
        }
        ...
        if (annoRangeDa != null && annoRangeA != null) {
            queryStr.append(whereWord).append(
                    "(u.monVLisUdNonVersIamId.aaKeyUnitaDoc BETWEEN :annoin_da AND :annoin_a) ");
            whereWord = " AND ";
        }
        ...
        queryStr.append(whereWord).append("u.idUserIam = :idUserIam ");
        if (StringUtils.isNotBlank(filtri.getClasseErrore())
                || StringUtils.isNotBlank(filtri.getSottoClasseErrore())
                || StringUtils.isNotBlank(filtri.getCodiceErrore())) {
            queryStr.append(whereWord).append(" EXISTS (" + "SELECT err "
                    + "FROM VrsErrSessioneVersKo err " + "JOIN err.vrsDatiSessioneVersKo dati "
                    + "JOIN dati.vrsSessioneVersKo ses "
        ...
        try {
            for (MonVLisUdNonVersIam row : listaUdNonVers) {
                MonVLisUdNonVersIamRowBean rb = (MonVLisUdNonVersIamRowBean) Transform
                        .entity2RowBean(row);
                rb.setString("nm_strut",
    ...
    public MonVLisUdNonVersIamTableBean getMonVpLisUdNonVersIamViewBeanScaricaContenuto(
        ...
        if ((dataFirstOrarioDa != null) && (dataFirstOrarioA != null)) {
            queryStr.append(whereWord)
                    .append("u.dt_First_Ses_Err between :datafirstda AND :datafirsta ");
            whereWord = "AND ";
        }
        ...
        if ((dataLastOrarioDa != null) && (dataLastOrarioA != null)) {
            queryStr.append(whereWord)
                    .append("u.dt_Last_Ses_Err between :datalastda AND :datalasta ");
            whereWord = "AND ";
        }
        ...
        if (codiceRangeDa != null && codiceRangeA != null) {
            ...
            codiceRangeA = StringPadding.padString(codiceRangeA, "0", 12,
                    StringPadding.PADDING_LEFT);
            queryStr.append(whereWord).append(
                    "FUNCTION('lpad', u.cd_Key_Unita_Doc, 12, '0') BETWEEN :codicein_da AND :codicein_a ");
            whereWord = " AND ";
        }
        ...
        if (StringUtils.isNotBlank(filtri.getClasseErrore())
            ...
            queryStr.append(whereWord).append(" EXISTS ("
                    + "SELECT vrserrsess1_.id_err_sessione_vers_ko "
                    ...
                    + "WHERE vrssession3_.ti_Sessione_Vers = 'VERSAMENTO' "
                    + "AND vrssession3_.id_Strut = u.id_Strut "
                    ...
                    + "AND (vrserrsess1_.id_Strut = :idStrut or vrserrsess1_.id_strut is null) "
                    + "AND ");
            if (StringUtils.isNotBlank(filtri.getCodiceErrore())) {
        ...
        try {
            for (Object[] row : listaUdNonVers) {
                ...
                // Gestione speciale per Character -> String per evitare NullPointerException su
                // .toString()
                ...
                // rb.setString("nm_strut", row.getNmAmbiente() + ", " + row.getNmEnte() + ", " +
                // row.getNmStrut());
                if (rb.getFlVerif() != null) {
                    rb.setFlVerif(rb.getFlVerif().equals("1") ? "SI" : "NO");
                }
    ...
    public MonVLisDocNonVersIamTableBean getMonVLisDocNonVersIamViewBeanScaricaContenuto(
        ...
        String whereWord = "WHERE ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT DISTINCT u FROM MonVLisDocNonVersIam u ");
        ...
        if (registroSet != null && !registroSet.isEmpty()) {
            queryStr.append(whereWord)
                    .append("(u.monVLisDocNonVersIamId.cdRegistroKeyUnitaDoc IN :setregistro)");
            whereWord = " AND ";
        }
        ...
        if (codice != null) {
            queryStr.append(whereWord)
                    .append("u.monVLisDocNonVersIamId.cdKeyUnitaDoc = :codicein ");
            whereWord = " AND ";
        }
        ...
        if (annoRangeDa != null && annoRangeA != null) {
            queryStr.append(whereWord).append(
                    "(u.monVLisDocNonVersIamId.aaKeyUnitaDoc BETWEEN :annoin_da AND :annoin_a) ");
            whereWord = " AND ";
        }
        ...
        try {
            if (listaDocNonVers != null && !listaDocNonVers.isEmpty()) {
                monTableBean = (MonVLisDocNonVersIamTableBean) Transform
                        .entities2TableBean(listaDocNonVers);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
        ...
        /*
         * "Rielaboro" il campo Struttura per presentarlo a video come unico campo dall'unione di
         * ambiente, ente e struttura
         */
        for (MonVLisDocNonVersIamRowBean row : monTableBean) {
            row.setString("nm_strut",
                    row.getNmAmbiente() + ", " + row.getNmEnte() + ", " + row.getNmStrut());
    ...
    public VrsSessioneVersKoEliminateTableBean getVrsSessioneVersKoEliminateTableBean(
            MonitoraggioForm.FiltriSessioniErrateFalliteEliminate filtri, Integer maxResults)
            throws EMFError {
        String whereWord = "WHERE ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT DISTINCT u FROM VrsSessioneVersKoEliminate u ");
        ...
        if (idAmbiente != null) {
            queryStr.append(whereWord)
                    .append("u.orgStrut.orgEnte.orgAmbiente.idAmbiente = :idAmbiente ");
            whereWord = "AND ";
        }
        // Inserimento nella query del filtro id ente
        ...
        try {
            if (listaRes != null && !listaRes.isEmpty()) {
                sessTableBean = (VrsSessioneVersKoEliminateTableBean) Transform
                        .entities2TableBean(listaRes);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
        ...
        for (VrsSessioneVersKoEliminateRowBean row : sessTableBean) {
            if (row.getNmAmbiente() != null && row.getNmEnte() != null
                    && row.getNmStrut() != null) {
    ...
    static class FiltriOperazioniVolumiPlain {
        ...
        private FiltriOperazioniVolumiPlain(FiltriOperazioniVolumi filtriOV, Date dataOrarioDa,
                Date dataOrarioA) throws EMFError {
    ...
    static class FiltriOperazioniElenchiVersamentoPlain {
        ...
        /**
         * @param filtriOE,     i filtri di ricerca
         * @param dataOrarioDa, filtro data e ora inizio già validato
         * @param dataOrarioA,  filtro data e ora fine già validato
         */
        private FiltriOperazioniElenchiVersamentoPlain(
                MonitoraggioForm.FiltriOperazioniElenchiVersamento filtriOE, Date dataOrarioDa,
                Date dataOrarioA) throws EMFError {
            ...
            this.flRecuperaElencoScaduto = filtriOE.getFl_oper_recupera_elenco_scaduto()
                    .isChecked();
            ...
            this.flStartCreazioneElencoAip = filtriOE.getFl_oper_start_crea_elenco_indici_aip()
                    .isChecked();
            this.flEndCreazioneElencoAip = filtriOE.getFl_oper_end_crea_elenco_indici_aip()
                    .isChecked();
            this.flFirmaElencoAip = filtriOE.getFl_oper_firma_elenco_indici_aip().isChecked();
            this.flFirmaElencoAipInCorso = filtriOE.getFl_oper_firma_elenco_indici_aip_in_corso()
                    .isChecked();
            this.flFirmaElencoAipFallita = filtriOE.getFl_oper_firma_elenco_indici_aip_fallita()
                    .isChecked();
            this.flMarcaElencoAip = filtriOE.getFl_oper_marca_elenco_indici_aip().isChecked();
            this.flMarcaElencoAipFallita = filtriOE.getFl_oper_marca_elenco_indici_aip_fallita()
                    .isChecked();
