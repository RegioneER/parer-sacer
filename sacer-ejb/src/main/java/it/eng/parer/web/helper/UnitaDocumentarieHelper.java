 ...
 * unitaDocumentarieHelperLocal), per la gestione della persistenza su DB per le operarazioni CRUD
 * su oggetti di UnitaDocumentarieTableBean ed UnitaDocumentarieRowBean
 */
...
public class UnitaDocumentarieHelper extends GenericHelper {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(UnitaDocumentarieHelper.class.getName());
    ...
    private static final String RIC_UD_DATI_SPEC_NM_TIPO_DOC_PRINC = "(SELECT tipo_doc_princ.nm_tipo_doc "
            ...
            + "             WHERE     "
            + "                   doc_princ.id_unita_doc = ud.id_unita_doc "
    ...
    // ai parametri
    public AroVRicUnitaDocRowBean getAroVRicUnitaDocRowBean(BigDecimal idUnitaDoc,
            BigDecimal idStruttura, String statoDoc) {
    ...
    /**
     * Metodo che wrappa quello seguente in quanto bypassa l'intercettazione fatta nell'ejb-jar.xml
     * per il metodo getAroVRicUnitaDocRicSempliceViewBean() che viene limitato ad un numero massimo
     * di records.
     *
     * @param filtri                         filtri di ricerca
     * @param idTipoUnitaDocList             lista di id del tipo di unità documentaria
     * @param cdRegistroUnitaDocList         lista di codici del registro dell' unità documentaria
     * @param idTipoDocList                  lista di id del tipo documento
     * @param dateAcquisizioneValidate       array di date validate
     * @param dateUnitaDocValidate           array di date relative alle unità documentarie
     * @param idStruttura                    id della struttura
     * @param subStruttureAbilitateAllUtente sottostrutture abilitate all'utente
     * @param nuovaVersione                  flag che indica se è la nuova versione della ricerca
     *
     * @return {@link AroVRicUnitaDocTableBean} table bean da usare per la UI
     *
     * @throws EMFError errore generico
     */
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicSempliceViewBeanNoLimit(
            FiltriUnitaDocumentarieSemplice filtri, List<BigDecimal> idTipoUnitaDocList,
            List<String> cdRegistroUnitaDocList, List<BigDecimal> idTipoDocList,
            Date[] dateAcquisizioneValidate, Date[] dateUnitaDocValidate, BigDecimal idStruttura,
            List<BigDecimal> subStruttureAbilitateAllUtente, boolean nuovaVersione)
            throws EMFError {

        if (nuovaVersione) {

            return getAroVRicUnitaDocRicSempliceViewBeanNewPlainFilter(idTipoUnitaDocList,
                    cdRegistroUnitaDocList, idTipoDocList, dateAcquisizioneValidate,
                    dateUnitaDocValidate, idStruttura, new FiltriUnitaDocumentarieSemplicePlain(
                            filtri, subStruttureAbilitateAllUtente),
                    -1, false);
        } else {
            return getAroVRicUnitaDocRicSempliceViewBeanPlainFilter(idTipoUnitaDocList,
                    cdRegistroUnitaDocList, idTipoDocList, dateAcquisizioneValidate,
                    dateUnitaDocValidate, idStruttura, new FiltriUnitaDocumentarieSemplicePlain(
                            filtri, subStruttureAbilitateAllUtente),
                    -1, false);
    ...
    /**
     * @param filtri                         filtri di ricerca
     * @param idTipoUnitaDocList             lista di tipi di unità documentarie
     * @param cdRegistroUnitaDocList         lista di codici di registro delle unità documentarie
     * @param idTipoDocList                  lista dei tipi di documento
     * @param dateAcquisizioneValidate       array delle date di acquisizione
     * @param dateUnitaDocValidate           array delle date delle unità documentarie
     * @param idStruttura                    id della struttura
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicSempliceViewBean(
            FiltriUnitaDocumentarieSemplice filtri, List<BigDecimal> idTipoUnitaDocList,
            List<String> cdRegistroUnitaDocList, List<BigDecimal> idTipoDocList,
            Date[] dateAcquisizioneValidate, Date[] dateUnitaDocValidate, BigDecimal idStruttura,
            int maxResults, List<BigDecimal> subStruttureAbilitateAllUtente, boolean nuovaVersione)
            throws EMFError {
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicSempliceViewBeanPlainFilter(
            List<BigDecimal> idTipoUnitaDocList, List<String> cdRegistroUnitaDocList,
            List<BigDecimal> idTipoDocList, Date[] dateAcquisizioneValidate,
            Date[] dateUnitaDocValidate, BigDecimal idStruttura,
            FiltriUnitaDocumentarieSemplicePlain filtri, int maxResults, boolean lazy) {
        String whereWord = "WHERE ";

        StringBuilder queryStrBuilder = new StringBuilder(
                "SELECT DISTINCT new it.eng.parer.viewEntity.AroVRicUnitaDoc (u.idUnitaDoc, u.aaKeyUnitaDoc, u.cdKeyUnitaDoc, u.cdRegistroKeyUnitaDoc, u.dtCreazione, u.dtRegUnitaDoc, "
                        + "u.flUnitaDocFirmato, u.tiEsitoVerifFirme, u.dsMsgEsitoVerifFirme, u.nmTipoUnitaDoc, u.flForzaAccettazione, "
                        + "u.flForzaConservazione, u.dsKeyOrd, u.niAlleg, u.niAnnessi, u.niAnnot, u.nmTipoDocPrinc, u.dsListaStatiElencoVers, u.tiStatoConservazione) "
        ...
        if (!cdRegistroUnitaDocList.isEmpty()) {
            queryStrBuilder.append(whereWord)
                    .append(" u.cdRegistroKeyUnitaDoc IN (:registrokeyunitadocin) ");
            whereWord = "AND ";
        }
        ...
        if (codiceNumContiene != null) {
            ...
            queryStrBuilder.append(whereWord)
                    .append(" UPPER(u.cdKeyUnitaDoc) LIKE :codicein_contiene ").append(escape);
            whereWord = " AND ";
        ...
        if ((dataDa != null) && (dataA != null)) {
            queryStrBuilder.append(whereWord)
                    .append(" (u.dtCreazione >= :datada AND u.dtCreazione <= :dataa) ");
            whereWord = "AND ";
        }
        ...
        if ((dataMetaDa != null) && (dataMetaA != null)) {
            queryStrBuilder.append(whereWord)
                    .append(" (u.dtRegUnitaDoc between :datametada AND :datametaa) ");
            whereWord = "AND ";
        }
        ...
        if (oggettoMeta != null) {
            queryStrBuilder.append(whereWord)
                    .append(" UPPER(u.dlOggettoUnitaDoc) LIKE :dloggettounitadocin ");
            whereWord = "AND ";
        }
        ...
        if (lazy) {
            return lazyListHelper.getTableBean(query, this::resultListToAroVRicUnitaDocRowBeans,
                    "u.idUnitaDoc");
        } else {
    ...
    // Metodo che restituisce un viewbean con i record trovati in base
    // ai filtri di ricerca passati in ingresso
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicSempliceViewBeanNewPlainFilter(
            List<BigDecimal> idTipoUnitaDocList, List<String> cdRegistroUnitaDocList,
            List<BigDecimal> idTipoDocList, Date[] dateAcquisizioneValidate,
            Date[] dateUnitaDocValidate, BigDecimal idStruttura,
            FiltriUnitaDocumentarieSemplicePlain filtri, int maxResults, boolean lazy) {
        ...
        StringBuilder queryStrBuilder = new StringBuilder(
                // La SELECT elenca esplicitamente le colonne del database, non i campi Java.
                // Il DISTINCT si applica a queste colonne, garantendo il risultato corretto.
                "SELECT DISTINCT u.ID_UNITA_DOC, u.AA_KEY_UNITA_DOC, u.CD_KEY_UNITA_DOC, u.CD_REGISTRO_KEY_UNITA_DOC, u.DT_CREAZIONE, u.DT_REG_UNITA_DOC, "
                        + "u.FL_UNITA_DOC_FIRMATO, u.TI_ESITO_VERIF_FIRME, u.DS_MSG_ESITO_VERIF_FIRME, u.NM_TIPO_UNITA_DOC, u.FL_FORZA_ACCETTAZIONE, "
                        + "u.FL_FORZA_CONSERVAZIONE, u.DS_KEY_ORD, u.NI_ALLEG, u.NI_ANNESSI, u.NI_ANNOT, u.NM_TIPO_DOC_PRINC, u.DS_LISTA_STATI_ELENCO_VERS, u.TI_STATO_CONSERVAZIONE "
                        + "FROM ARO_V_RIC_UNITA_DOC_NEW u ");

        // Da qui in poi, la logica di costruzione è la stessa, ma usa i nomi delle colonne SQL.
        if (!idTipoUnitaDocList.isEmpty()) {
            queryStrBuilder.append(whereWord).append(" u.ID_TIPO_UNITA_DOC IN (:tipoudin) ");
            whereWord = "AND ";
        }

        String cdVersioneXsdUd = filtri.getCdVersioneXsdUd();
        if (cdVersioneXsdUd != null) {
            queryStrBuilder.append(whereWord).append(" u.CD_VERSIONE_XSD_UD = :cdVersioneXsdUd ");
            whereWord = "AND ";
        }

        if (!cdRegistroUnitaDocList.isEmpty()) {
            queryStrBuilder.append(whereWord)
                    .append(" u.CD_REGISTRO_KEY_UNITA_DOC IN (:registrokeyunitadocin) ");
            whereWord = "AND ";
        }

        if (!idTipoDocList.isEmpty()) {
            queryStrBuilder.append(whereWord).append(" u.ID_TIPO_DOC IN (:tipodocin) ");
            whereWord = "AND ";
        }

        String cdVersioneXsdDoc = filtri.getCdVersioneXsdDoc();
        if (cdVersioneXsdDoc != null) {
            queryStrBuilder.append(whereWord).append(" u.CD_VERSIONE_XSD_DOC = :cdVersioneXsdDoc ");
            whereWord = "AND ";
        }
        ...
        String codice = filtri.getCodice();
        if (anno != null) {
            queryStrBuilder.append(whereWord).append(" u.AA_KEY_UNITA_DOC = :annoin ");
            whereWord = "AND ";
        }
        if (codice != null) {
            queryStrBuilder.append(whereWord).append(" u.CD_KEY_UNITA_DOC = :codicein ");
            whereWord = "AND ";
        }
        ...
        if (cdKeyDocVers != null) {
            queryStrBuilder.append(whereWord)
                    .append(" UPPER(u.CD_KEY_DOC_VERS) LIKE :cdKeyDocVers ");
            whereWord = "AND ";
        }
        ...
        if (annoRangeDa != null && annoRangeA != null) {
            queryStrBuilder.append(whereWord)
                    .append(" u.AA_KEY_UNITA_DOC BETWEEN :annoin_da AND :annoin_a ");
            whereWord = "AND ";
        }
        ...
        if (codiceRangeDa != null && codiceRangeA != null) {
            ...
            codiceRangeA = StringPadding.padString(codiceRangeA, "0", 12,
                    StringPadding.PADDING_LEFT);
            queryStrBuilder.append(whereWord).append(
                    " LPAD( u.CD_KEY_UNITA_DOC, 12, '0') BETWEEN :codicein_da AND :codicein_a ");
            whereWord = "AND ";
        }
        ...
        if (codiceNumContiene != null) {
            ...
            queryStrBuilder.append(whereWord)
                    .append(" UPPER(u.CD_KEY_UNITA_DOC) LIKE :codicein_contiene ").append(escape);
            whereWord = " AND ";
            codiceNumContiene = codiceNumContiene.toUpperCase();
        }
        ...
        String presenza = filtri.getPresenza();
        if (presenza != null) {
            queryStrBuilder.append(whereWord).append(" u.FL_UNITA_DOC_FIRMATO = :presenzain ");
            whereWord = "AND ";
        }

        String esito = filtri.getEsito();
        if (esito != null) {
            queryStrBuilder.append(whereWord).append(" u.TI_ESITO_VERIF_FIRME = :esitoin ");
            whereWord = "AND ";
        }
        ...
        if ((dataDa != null) && (dataA != null)) {
            queryStrBuilder.append(whereWord)
                    .append(" (u.DT_CREAZIONE >= :datada AND u.DT_CREAZIONE <= :dataa) ");
            whereWord = "AND ";
        }
        ...
        if (profiloNorm != null) {
            queryStrBuilder.append(whereWord)
                    .append(" u.FL_ESISTE_PROFILO_NORMATIVO = :profiloNorm ");
            whereWord = "AND ";
        }

        String forzaAcc = filtri.getForzaAcc();
        if (forzaAcc != null) {
            queryStrBuilder.append(whereWord).append(" u.FL_FORZA_ACCETTAZIONE = :forzaaccin ");
            whereWord = "AND ";
        }
        ...
        if (forzaConserva != null) {
            queryStrBuilder.append(whereWord)
                    .append(" u.FL_FORZA_CONSERVAZIONE = :forzaconservain ");
            whereWord = "AND ";
        }

        String forzaColleg = filtri.getForzaColleg();
        if (forzaColleg != null) {
            queryStrBuilder.append(whereWord).append(" u.FL_FORZA_COLLEGAMENTO = :forzacollegin ");
            whereWord = "AND ";
        }

        String cdVersioneWs = filtri.getCdVersioneWs();
        if (cdVersioneWs != null) {
            queryStrBuilder.append(whereWord).append(" u.CD_VERSIONE_WS = :cdVersioneWs ");
            whereWord = "AND ";
        }

        String docAggiunti = filtri.getDocAggiunti();
        if (docAggiunti != null) {
            queryStrBuilder.append(whereWord).append(" u.FL_DOC_AGGIUNTI = :docAggiunti ");
            whereWord = "AND ";
        }

        String flAggMeta = filtri.getFlAggMeta();
        if (flAggMeta != null) {
            queryStrBuilder.append(whereWord).append(" u.FL_AGG_META = :flAggMeta ");
            whereWord = "AND ";
        }

        String flHashVers = filtri.getFlHashVers();
        if (flHashVers != null) {
            queryStrBuilder.append(whereWord).append(" u.FL_HASH_VERS = :flHashVers ");
            whereWord = "AND ";
        }
        ...
        if (statoConserva != null) {
            queryStrBuilder.append(whereWord)
                    .append(" u.TI_STATO_CONSERVAZIONE = :statoconservain ");
            whereWord = "AND ";
        }
        ...
        if (tiStatoUdElencoVers != null) {
            queryStrBuilder.append(whereWord).append(
                    " (u.TI_STATO_UD_ELENCO_VERS = :tiStatoUdElencoVers OR u.TI_STATO_DOC_ELENCO_VERS = :tiStatoUdElencoVers) ");
            whereWord = "AND ";
        }
        ...
        if ((dataMetaDa != null) && (dataMetaA != null)) {
            queryStrBuilder.append(whereWord)
                    .append(" (u.DT_REG_UNITA_DOC between :datametada AND :datametaa) ");
            whereWord = "AND ";
        }

        String tiDoc = filtri.getTiDoc();
        if (tiDoc != null) {
            queryStrBuilder.append(whereWord).append(" u.TI_DOC = :tiDoc ");
            whereWord = "AND ";
        }
        ...
        if (oggettoMeta != null) {
            queryStrBuilder.append(whereWord)
                    .append(" UPPER(u.DL_OGGETTO_UNITA_DOC) LIKE :dloggettounitadocin ");
            whereWord = "AND ";
        }

        String autoreDocMeta = filtri.getAutoreDocMeta();
        if (autoreDocMeta != null) {
            queryStrBuilder.append(whereWord).append(" UPPER(u.DS_AUTORE_DOC) LIKE :dldocmetain ");
            whereWord = "AND ";
        }

        String descrizioneDocMeta = filtri.getDescrizioneDocMeta();
        if (descrizioneDocMeta != null) {
            queryStrBuilder.append(whereWord).append(" UPPER(u.DL_DOC) LIKE :dsautoredocin ");
            whereWord = "AND ";
        }

        String tipoConservazione = filtri.getTipoConservazione();
        if (tipoConservazione != null) {
            queryStrBuilder.append(whereWord).append(" u.TI_CONSERVAZIONE = :ticonservazionein ");
            whereWord = "AND ";
        }

        // ===================================================================================
        // Invocazione diretta e performante della SQL Macro.
        // ===================================================================================
        String dsClassif = filtri.getDsClassif();
        String cdFascic = filtri.getCdFascic();
        String dsOggettoFascic = filtri.getDsOggettoFascic();
        String cdSottofascic = filtri.getCdSottofascic();
        String dsOggettoSottofascic = filtri.getDsOggettoSottofascic();
        if (dsClassif != null || cdFascic != null || dsOggettoFascic != null
                || cdSottofascic != null || dsOggettoSottofascic != null) {
            queryStrBuilder.append(whereWord).append(
                    " u.ID_UNITA_DOC IN (SELECT t.id_unita_doc FROM TABLE(Aro_Vp_Ric_Ud_Profilo(:idstrutin, :aaKeyUnitaDocDa, :aaKeyUnitaDocA, "
                            + ":dsClassif, :cdFascic, :cdSottofascic, :dsOggettoSottofascic, :dsOggettoFascic)) t) ");
            whereWord = "AND ";
        }

        queryStrBuilder.append(whereWord).append(" u.ID_STRUT_UNITA_DOC = :idstrutin ");
        whereWord = "AND ";

        List<BigDecimal> subStruts = filtri.getSubStruts();
        queryStrBuilder.append(whereWord).append(" u.ID_SUB_STRUT IN (:subStruts) ");
        queryStrBuilder.append(" ORDER BY u.DS_KEY_ORD");

        Query query = getEntityManager().createNativeQuery(queryStrBuilder.toString(),
        ...
        if (dsClassif != null || cdFascic != null || dsOggettoFascic != null
                || cdSottofascic != null || dsOggettoSottofascic != null) {
            BigDecimal aaKeyUnitaDocDa = null;
            BigDecimal aaKeyUnitaDocA = null;

            if (annoRangeDa != null && annoRangeA != null) {
                // Caso 1: il range è specificato, usiamo quello
                aaKeyUnitaDocDa = annoRangeDa;
                aaKeyUnitaDocA = annoRangeA;
            } else if (anno != null) {
                // Caso 2: il range non è specificato, usiamo il valore singolo 'anno' per entrambi
                // i limiti
                aaKeyUnitaDocDa = anno;
                aaKeyUnitaDocA = anno;
            }
            // Usa le variabili preparate in precedenza per gli anni
            // query.setParameter("idSubStrut", subStruts.get(0));
            query.setParameter("aaKeyUnitaDocDa", aaKeyUnitaDocDa);
            query.setParameter("aaKeyUnitaDocA", aaKeyUnitaDocA);
            // Usa l'operatore ternario per fornire '%' come default
            query.setParameter("dsClassif", dsClassif != null ? dsClassif + "%" : "%");
            query.setParameter("cdFascic", cdFascic != null ? cdFascic + "%" : "%");
            query.setParameter("cdSottofascic", cdSottofascic != null ? cdSottofascic + "%" : "%");
            query.setParameter("dsOggettoSottofascic",
                    dsOggettoSottofascic != null ? dsOggettoSottofascic + "%" : "%");
            query.setParameter("dsOggettoFascic",
                    dsOggettoFascic != null ? dsOggettoFascic + "%" : "%");
        ...
        if (lazy) {
            // MEV #39292 - Gestione paginazione per query native
            return lazyListHelper.getTableBeanForNativeQuery(query,
                    this::resultListDTOToAroVRicUnitaDocRowBeansNuovo, "u.ID_UNITA_DOC",
                    "AroVRicUnitaDocNewDTOMapping");
        } else {
            @SuppressWarnings("unchecked")
            List<AroVRicUnitaDocNewDTO> risultatiDTO = query.getResultList();
            return resultListDTOToAroVRicUnitaDocRowBeansNuovo(risultatiDTO);
        }
    }

    private AroVRicUnitaDocTableBean resultListToAroVRicUnitaDocRowBeans(
            List<AroVRicUnitaDoc> listaUD) {
    ...
    /*
     * Nuovo metodo aggiunto per sdoppiare la nuova ricerca semplice che prende la nuova vista
     * entity e la copia a mano nel solito tablebean che c'era
     */
    private AroVRicUnitaDocTableBean resultListDTOToAroVRicUnitaDocRowBeansNuovo(
            List<AroVRicUnitaDocNewDTO> listaUD) {
        AroVRicUnitaDocTableBean udTableBean = new AroVRicUnitaDocTableBean();

        try {
            if (listaUD != null && !listaUD.isEmpty()) {
                for (AroVRicUnitaDocNewDTO ud : listaUD) {
                    AroVRicUnitaDocRowBean rb = new AroVRicUnitaDocRowBean();
                    rb.setAaKeyUnitaDoc(ud.getAaKeyUnitaDoc());
                    rb.setCdKeyUnitaDoc(ud.getCdKeyUnitaDoc());
                    rb.setCdRegistroKeyUnitaDoc(ud.getCdRegistroKeyUnitaDoc());
                    rb.setDsKeyOrd(ud.getDsKeyOrd());
                    rb.setDsListaStatiElencoVers(ud.getDsListaStatiElencoVers());
                    rb.setDsMsgEsitoVerifFirme(ud.getDsMsgEsitoVerifFirme());
                    rb.setDtCreazione(ud.getDtCreazione() != null
                            ? new Timestamp(ud.getDtCreazione().getTime())
                            : null);

                    rb.setDtRegUnitaDoc(ud.getDtRegUnitaDoc() != null
                            ? new Timestamp(ud.getDtRegUnitaDoc().getTime())
                            : null);
                    rb.setFlForzaAccettazione(ud.getFlForzaAccettazione());
                    rb.setFlForzaConservazione(ud.getFlForzaConservazione());
                    rb.setFlUnitaDocFirmato(ud.getFlUnitaDocFirmato());
                    rb.setIdUnitaDoc(ud.getIdUnitaDoc());
                    rb.setNiAlleg(ud.getNiAlleg());
                    rb.setNiAnnessi(ud.getNiAnnessi());
                    rb.setNiAnnot(ud.getNiAnnot());
                    rb.setNmTipoDocPrinc(ud.getNmTipoDocPrinc());
                    rb.setNmTipoUnitaDoc(ud.getNmTipoUnitaDoc());
                    rb.setTiEsitoVerifFirme(ud.getTiEsitoVerifFirme());
                    rb.setTiStatoConservazione(ud.getTiStatoConservazione());
                    udTableBean.add(rb);
                }
            }
        } catch (Exception e) {
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicAvanzataViewBeanNoLimit(
            FiltriUnitaDocumentarieAvanzata filtri, List<BigDecimal> idTipoUnitaDocList,
            Set<String> cdRegistroUnitaDocSet, List<BigDecimal> idTipoDocList,
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicDatiSpecViewBeanNoLimit(
            FiltriUnitaDocumentarieDatiSpec filtri, List<BigDecimal> idTipoUnitaDocList,
            Set<String> cdRegistroUnitaDocSet, List<BigDecimal> idTipoDocList,
            List<DecCriterioDatiSpecBean> listaDatiSpecOnLine, BigDecimal idStruttura,
            boolean addButton, boolean almenoUnTipoUdSelPerRicercaDatiSpec,
    ...
    /**
     * @param filtri                    filtri di ricerca
     * @param idTipoUnitaDocList        tipi di unita documentarie
     * @param cdRegistroUnitaDocSet     codici registro
     * @param idTipoDocList             tipi di documenti
     * @param listaDatiSpecOnLine       dati spec online
     * @param filtriCollegamenti        filtri di ricerca collegamenti
     * @param filtriFirmatari           filtri di ricerca firmatatio
     * @param filtriComponenti          filtri di ricerca componenti
     * @param filtriFascicoli           filtri di ricerca fascicoli
    ...
    // Metodo che restituisce un viewbean con i record trovati in base
    // ai filtri di ricerca passati in ingresso
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicAvanzataViewBean(
            FiltriUnitaDocumentarieAvanzata filtri, List<BigDecimal> idTipoUnitaDocList,
            Set<String> cdRegistroUnitaDocSet, List<BigDecimal> idTipoDocList,
            List<DecCriterioDatiSpecBean> listaDatiSpecOnLine,
            UnitaDocumentarieForm.FiltriCollegamentiUnitaDocumentarie filtriCollegamenti,
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicAvanzataViewBeanPlainFilter(
            ...
            Date[] dateAcquisizioneValidate, Date[] dateCreazioneCompValidate, Long idUserIam,
        ...
        StringBuilder queryStr = new StringBuilder(
                "SELECT DISTINCT new it.eng.parer.viewEntity.AroVRicUnitaDoc "
        ...
        if (filtriComponenti.getNmTipoStrutDoc() != null) {
            whereCompClause
                    .append(" AND strutDoc.decTipoStrutDoc.idTipoStrutDoc = :tipoStrutDocIn ");
        }
        ...
        if (filtriComponenti.getNmFormatoFileVers() != null) {
            whereCompClause
                    .append(" AND comp.decFormatoFileDoc.idFormatoFileDoc = :formatoFileDocIn ");
        }
        ...
        if (fileSizeDa != null && fileSizeA != null) {
            whereCompClause
                    .append(" AND comp.niSizeFileCalc between :filesizedain AND :filesizeain ");
        }
        ...
        if (filtriComponenti.getDsFormatoRapprEstesoCalc() != null) {
            whereCompClause
                    .append(" AND comp.dsFormatoRapprEstesoCalc = :formatoRapprCalcEstesoIn ");
        }
        ...
        if ((dataValDa != null) && (dataValA != null)) {
            ...
            joinCertif = true;
            whereCompClause.append(
                    " AND certif.dtFinValCertifFirmatario between :datavalda AND :datavala ");
        }
        ...
        if (filtriComponenti.getTiEsitoVerifFirmeChiuse() != null) {
            whereCompClause
                    .append(" AND appartComp.tiEsitoVerifFirmeChius = :esitoVerifFirmeChiusIn ");
            joinAppart = true;
        }
        ...
        if ((dataCompDa != null) && (dataCompA != null)) {
            whereCompClause.append(
                    " AND strutDoc.aroDoc.dtCreazione between :dataCompDaIn AND :dataCompAIn ");
        }
        //
        ...
        if (filtriComponenti.getNmTipoRapprComp() != null) {
            whereCompClause
                    .append(" AND comp.decTipoRapprComp.idTipoRapprComp = :idTipoRapprCompIn ");
        }
        ...
        if (StringUtils.isNotBlank(filtriFirmatari.getNmCognomeFirmatario())) {
            whereCompClause
                    .append(" AND UPPER(firma.nmCognomeFirmatario) LIKE :nmCognomeFirmatario ");
            joinFirma = true;
        }
        ...
        if (codiceNumContiene != null) {
            ...
            queryStr.append(whereWord)
                    .append(" UPPER(u.cdKeyUnitaDoc) LIKE :codicein_contiene " + escape);
            whereWord = " AND ";
            codiceNumContiene = codiceNumContiene.toUpperCase();
        }
        ...
        if (filtriFascicoli.isFiltriImpostati()) {
            queryStr.append(whereWord).append(
                    " exists (select 1 from AroVLisFasc fasc_ud where fasc_ud.id.idUnitaDoc = u.idUnitaDoc ");
            ...
            if (valoreClassif != null) {
                queryStr.append(whereWord)
                        .append(" UPPER(fasc_ud.cdCompositoVoceTitol) LIKE :valoreclassif ");
                whereWord = " AND ";
            }
            ...
            if (aaFascRangeDa != null && aaFascRangeA != null) {
                queryStr.append(whereWord)
                        .append(" (fasc_ud.aaFascicolo BETWEEN :aafasc_da AND :aafasc_a) ");
                whereWord = " AND ";
            }
            ...
            if (cdFascRangeDa != null && cdFascRangeA != null) {
                cdFascRangeDa = StringPadding.padString(cdFascRangeDa, "0", 12,
                        StringPadding.PADDING_LEFT);
                cdFascRangeA = StringPadding.padString(cdFascRangeA, "0", 12,
                        StringPadding.PADDING_LEFT);
                queryStr.append(whereWord).append(
                        " LPAD( fasc_ud.cdKeyFascicolo, 12, '0') BETWEEN :cdfasc_da AND :cdfasc_a ");
                whereWord = " AND ";
            }
            ...
            if (dtApeFascRangeDa != null || dtApeFascRangeA != null) {
                if (dtApeFascRangeDa == null) {
                    // solo estremo "a" presente → "da" = 01/01/2011
                    Calendar cal = Calendar.getInstance();
                    cal.set(2011, Calendar.JANUARY, 1, 0, 0, 0);
                    cal.set(Calendar.MILLISECOND, 0);
                    dtApeFascRangeDa = cal.getTime();
                }
                if (dtApeFascRangeA == null) {
                    // solo estremo "da" presente → "a" = oggi
                    dtApeFascRangeA = new Date();
                }
                queryStr.append(whereWord).append(
                        " (fasc_ud.dtApeFascicolo BETWEEN :dtapefasc_da AND :dtapefasc_a) ");
                whereWord = " AND ";
            }
            ...
            if (dtChiuFascRangeDa != null || dtChiuFascRangeA != null) {
                if (dtChiuFascRangeDa == null) {
                    // solo estremo "a" presente → "da" = 01/01/2011
                    Calendar cal = Calendar.getInstance();
                    cal.set(2011, Calendar.JANUARY, 1, 0, 0, 0);
                    cal.set(Calendar.MILLISECOND, 0);
                    dtChiuFascRangeDa = cal.getTime();
                }
                if (dtChiuFascRangeA == null) {
                    // solo estremo "da" presente → "a" = oggi
                    dtChiuFascRangeA = new Date();
                }
                queryStr.append(whereWord).append(
                        " (fasc_ud.dtChiuFascicolo BETWEEN :dtchiufasc_da AND :dtchiufasc_a) ");
                whereWord = " AND ";
            }
            ...
            if (oggettoFasc != null) {
                queryStr.append(whereWord)
                        .append(" UPPER(fasc_ud.dsOggettoFascicolo) LIKE :dsoggfasc ");
                whereWord = " AND ";
            }
        ...
        if (filtriCollegamenti.getConCollegamento() != null
                && filtriCollegamenti.getConCollegamento().equals("1")) {
            queryStr.append(whereWord).append(
        ...
        if (filtriCollegamenti.getConCollegamento() != null
                && filtriCollegamenti.getConCollegamento().equals("0")) {
            queryStr.append(whereWord).append(
        ...
        if (filtriCollegamenti.getIsOggettoCollegamento() != null
            ...
            if (valoreColl2 != null) {
                queryStr.append(whereWord)
                        .append(" UPPER(link2.dsLinkUnitaDoc) LIKE :valorecoll2 ");
            }
            queryStr.append(") ");
        }
        // Se il filtro "Con collegamento" vale "No"
        ...
        if (filtri.getDsClassif() != null || filtri.getCdFascic() != null
                || filtri.getDsOggettoFascic() != null || filtri.getCdSottofascic() != null
                || filtri.getDsOggettoSottofascic() != null) {
            queryStr.append(whereWord).append(
                    " (exists (select 1 from AroUnitaDoc ud where ud.idUnitaDoc = u.idUnitaDoc ");
        ...
        for (int i = 0; i < mappone.size(); i++) {
            ...
            if (!dsqp.getTiOper().equals(CostantiDB.TipoOperatoreDatiSpec.E_UNO_FRA.name())) {
                ...
                String[] inParams = dsqp.getDlValore().toUpperCase().trim()
                        .replaceAll("\\s*,\\s*", ",").split(",");
                query.setParameter("valorein" + i, Arrays.asList(inParams));
            }
            for (int j = 0; j < dsqp.getIdAttribDatiSpec().size(); j++) {
                query.setParameter("idattribdatispecin" + contaIdAttrib,
                        dsqp.getIdAttribDatiSpec().get(j));
                if (dsqp.getNmSistemaMigraz().get(j) != null) {
                    query.setParameter("nmsistemamigrazin" + contaIdAttrib,
                            dsqp.getNmSistemaMigraz().get(j));
                }
                contaIdAttrib++;
            }
        }
        ...
        if (filtri.getDsOggettoSottofascic() != null) {
            query.setParameter("oggSottoFascic",
                    "%" + filtri.getDsOggettoSottofascic().toUpperCase() + "%");
        }
        ...
        if (filtriComponenti.getDsNomeCompVers() != null) {
            query.setParameter("nomeCompVersIn",
                    "%" + filtriComponenti.getDsNomeCompVers().toUpperCase() + "%");
        }
        if (filtriComponenti.getDlUrnCompVers() != null) {
            query.setParameter("urnCompVersIn",
                    "%" + filtriComponenti.getDlUrnCompVers().toUpperCase() + "%");
        }
        if (filtriComponenti.getDsHashFileVers() != null) {
            query.setParameter("hashFileVersIn", filtriComponenti.getDsHashFileVers());
        }
        if (filtriComponenti.getNmMimetypeFile() != null) {
            query.setParameter("mimeTypeIn",
                    "%" + filtriComponenti.getNmMimetypeFile().toUpperCase() + "%");
        }
        if (filtriComponenti.getNmFormatoFileVers() != null) {
            query.setParameter("formatoFileDocIn",
                    filtriComponenti.getNmFormatoFileVers().longValue());
        }
        if (fileSizeDa != null && fileSizeA != null) {
        ...
        if (filtriComponenti.getDsFormatoRapprEstesoCalc() != null) {
            query.setParameter("formatoRapprCalcEstesoIn",
                    filtriComponenti.getDsFormatoRapprEstesoCalc());
        }
        if (filtriComponenti.getFlCompFirmato() != null) {
        ...
        if (filtriComponenti.getDsRifTempVers() != null) {
            query.setParameter("dsRifTempVers",
                    "%" + filtriComponenti.getDsRifTempVers().toUpperCase() + "%");
        }
        ...
        if (filtriComponenti.getTiEsitoContrFormatoFile() != null) {
            query.setParameter("esitoContrFormatoFileIn",
                    filtriComponenti.getTiEsitoContrFormatoFile());
        }
        if (filtriComponenti.getTiEsitoVerifFirma() != null) {
            query.setParameter("esitoVerifFirmeIn", filtriComponenti.getTiEsitoVerifFirma());
        }
        if (filtriComponenti.getTiEsitoVerifFirmeChiuse() != null) {
            query.setParameter("esitoVerifFirmeChiusIn",
                    filtriComponenti.getTiEsitoVerifFirmeChiuse());
        }
        if (filtriComponenti.getDsHashFileCalc() != null) {
        ...
        if (filtriComponenti.getCdEncodingHashFileCalc() != null) {
            query.setParameter("encodingHashFileCalcIn",
                    filtriComponenti.getCdEncodingHashFileCalc());
        }
        if (filtriComponenti.getDsUrnCompCalc() != null) {
            query.setParameter("urnCompCalcIn",
                    "%" + filtriComponenti.getDsUrnCompCalc().toUpperCase() + "%");
        }
        ...
        if (filtriComponenti.getNmTipoRapprComp() != null) {
            query.setParameter("idTipoRapprCompIn",
                    filtriComponenti.getNmTipoRapprComp().longValue());
        }

        if (filtriComponenti.getDsIdCompVers() != null) {
            query.setParameter("idCompDocIn",
                    "%" + filtriComponenti.getDsIdCompVers().toUpperCase() + "%");
        }

        if (filtriFirmatari.getCdFirmatario() != null) {
            query.setParameter("cdFirmatario",
                    "%" + filtriFirmatari.getCdFirmatario().toUpperCase() + "%");
        }
        ...
        if (filtriFirmatari.getNmFirmatario() != null) {
            query.setParameter("nmFirmatario",
                    "%" + filtriFirmatari.getNmFirmatario().toUpperCase() + "%");
        }
    ...
    // Metodo che restituisce un viewbean con i record trovati in base
    // ai filtri di ricerca passati in ingresso
    public AroVRicUnitaDocTableBean getAroVRicAdvUnitaDocRicAvanzataViewBean(
            FiltriUnitaDocumentarieAvanzata filtri, List<BigDecimal> idTipoUnitaDocList,
            Set<String> cdRegistroUnitaDocSet, List<BigDecimal> idTipoDocList,
            List<DecCriterioDatiSpecBean> listaDatiSpecOnLine,
            UnitaDocumentarieForm.FiltriCollegamentiUnitaDocumentarie filtriCollegamenti,
        ...
        final Date dateMetaDa = getDateOrNull(dateUnitaDocValidate, 0);
        final Date dateMetaA = getDateOrNull(dateUnitaDocValidate, 1);
        return getAroVRicAdvUnitaDocRicAvanzataViewBeanPlainFilter(idTipoUnitaDocList,
                cdRegistroUnitaDocSet, idTipoDocList, listaDatiSpecOnLine, dateAcquisizioneValidate,
    ...
    // Metodo che restituisce un viewbean con i record trovati in base
    // ai filtri di ricerca passati in ingresso
    public AroVRicUnitaDocTableBean getAroVRicAdvUnitaDocRicAvanzataViewBeanPlainFilter(
            List<BigDecimal> idTipoUnitaDocList, Set<String> cdRegistroUnitaDocSet,
            List<BigDecimal> idTipoDocList, List<DecCriterioDatiSpecBean> listaDatiSpecOnLine,
        ...
        String whereWord = "WHERE ";
        /*
         * La SELECT elenca esplicitamente le colonne del database, non i campi Java. Il DISTINCT si
         * applica a queste colonne, garantendo il risultato corretto.
         */
        StringBuilder queryStr = new StringBuilder(
                "SELECT DISTINCT u.ID_UNITA_DOC, u.AA_KEY_UNITA_DOC, u.CD_KEY_UNITA_DOC, u.CD_REGISTRO_KEY_UNITA_DOC, u.DT_CREAZIONE, u.DT_REG_UNITA_DOC, "
                        + "u.FL_UNITA_DOC_FIRMATO, u.TI_ESITO_VERIF_FIRME, u.DS_MSG_ESITO_VERIF_FIRME, u.NM_TIPO_UNITA_DOC, u.FL_FORZA_ACCETTAZIONE, "
                        + "u.FL_FORZA_CONSERVAZIONE, u.DS_KEY_ORD, u.NI_ALLEG, u.NI_ANNESSI, u.NI_ANNOT, u.NM_TIPO_DOC_PRINC, u.DS_LISTA_STATI_ELENCO_VERS, u.TI_STATO_CONSERVAZIONE "
                        + "from ARO_VP_RIC_ADV_UNITA_DOC(:idstrutin, SYS.ODCINUMBERLIST(:subStruts), :annoin_da, :annoin_a,:parProfiloNormativo) u ");

        // Inserimento nella query del filtro Tipo Unità Doc versione multiselect
        if (!idTipoUnitaDocList.isEmpty()) {
            queryStr.append(whereWord).append(" u.id_tipo_unita_doc IN (:listtipoud) ");
            whereWord = " AND ";
        }
        ...
        // Inserimento nella query del filtro Tipo Documento
        if (!idTipoDocList.isEmpty()) {
            queryStr.append(whereWord).append(" u.id_tipo_doc IN (:listtipodoc) ");
            whereWord = "AND ";
        }
        BigDecimal anno = filtri.getAaKeyUnitaDoc();
        String codice = filtri.getCdKeyUnitaDoc();
        ...
        String cdKeyDocVers = filtri.getCdKeyDocVers();
        if (cdKeyDocVers != null) {
            queryStr.append(whereWord).append(" UPPER(u.cd_key_doc_vers) LIKE :cdKeyDocVers ");
            whereWord = "AND ";
        }
        ...
        if (codiceNumContiene != null) {
            ...
            queryStr.append(whereWord).append(" UPPER(u.cd_Key_Unita_Doc) LIKE :codicein_contiene ")
                    .append(escape);
            whereWord = " AND ";
            codiceNumContiene = codiceNumContiene.toUpperCase();
        }
        ...
        String presenza = filtri.getFlUnitaDocFirmato();
        if (presenza != null) {
            queryStr.append(whereWord).append(" u.fl_Unita_Doc_Firmato = :presenzain ");
            whereWord = " AND ";
        }
        ...
        if (!esitoveriffirmeList.isEmpty()) {
            queryStr.append(whereWord)
                    .append(" (u.ti_Esito_Verif_Firme IN (:listaesitoveriffirme)) ");
            whereWord = " AND ";
        }
        ...
        if ((dataDa != null) && (dataA != null)) {
            queryStr.append(whereWord).append(" (u.dt_Creazione between :datada AND :dataa) ");
            whereWord = " AND ";
        }
        // Inserimento nella query del filtro ESISTE PROFILO NORMATIVO
        String profiloNorm = filtri.getProfiloNorm();
        if (profiloNorm != null) {
            queryStr.append(whereWord).append(" u.fl_Esiste_Profilo_Normativo = :profiloNorm ");
            whereWord = "AND ";
        }
        // Inserimento nella query del filtro FORZA ACCETTAZIONE
        String forzaAcc = filtri.getFlForzaAccettazione();
        if (forzaAcc != null) {
            queryStr.append(whereWord).append(" u.fl_Forza_Accettazione = :forzaaccin ");
            whereWord = " AND ";
        }
        ...
        String forzaConserva = filtri.getFlForzaConservazione();
        if (forzaConserva != null) {
            queryStr.append(whereWord).append(" u.fl_Forza_Conservazione = :forzaconservain ");
            whereWord = " AND ";
        }
        // Inserimento nella query del filtro FORZA COLLEGAMENTO
        String forzaColleg = filtri.getFlForzaCollegamento();
        if (forzaColleg != null) {
            queryStr.append(whereWord).append(" u.fl_Forza_Collegamento = :forzacollegin ");
            whereWord = "AND ";
        }
        String cdVersioneWs = filtri.getCdVersioneWs();
        if (cdVersioneWs != null) {
            queryStr.append(whereWord).append(" u.CD_VERSIONE_WS = :cdVersioneWs ");
            whereWord = "AND ";
        }
        String unitaDocAnnul = filtri.getFlUnitaDocAnnul();
        if (unitaDocAnnul != null) {
            // queryStr.append(whereWord).append(" u.fl_Unita_Doc_Annul = :unitaDocAnnul ");
            // whereWord = "AND ";
        }
        String docAggiunti = filtri.getFlDocAggiunti();
        if (docAggiunti != null) {
            queryStr.append(whereWord).append(" u.fl_Doc_Aggiunti = :docAggiunti ");
            whereWord = "AND ";
        }
        // Inserimento nella query del filtro FL_AGG_META
        String flAggMeta = filtri.getFlAggMeta();
        if (flAggMeta != null) {
            queryStr.append(whereWord).append(" u.fl_Agg_Meta = :flAggMeta ");
            whereWord = "AND ";
        }
        // Inserimento nella query del filtro FL_HASH_VERS
        String flHashVers = filtri.getFlHashVers();
        if (flHashVers != null) {
            queryStr.append(whereWord).append(" u.fl_Hash_Vers = :flHashVers ");
            whereWord = "AND ";
        }
        // Inserimento nella query del filtro STATO CONSERVAZIONE
        String tiStatoConservazione = filtri.getTiStatoConservazione();
        if (tiStatoConservazione != null) {
            queryStr.append(whereWord).append(" u.ti_Stato_Conservazione = :tiStatoConservazione ");
            whereWord = "AND ";
        }
        // Inserimento nella query del filtro TI_STATO_UD_ELENCO_VERS
        String tiStatoUdElencoVers = filtri.getTiStatoUdElencoVers();
        ...
        List<String> sisMigrazList = filtri.getNmSistemaMigraz();
        if (!sisMigrazList.isEmpty()) {
            queryStr.append(whereWord).append(" (u.nm_Sistema_Migraz IN (:listasismigraz)) ");
            whereWord = " AND ";
        }
        if ((filtri.getDataMetaDa() != null) && (filtri.getDataMetaA() != null)) {
            queryStr.append(whereWord)
        ...
        String tiDoc = filtri.getTiDoc();
        if (tiDoc != null) {
            queryStr.append(whereWord).append(" u.ti_Doc = :tiDoc ");
            whereWord = "AND ";
        }
        // Inserimento nella query del filtro metadati Oggetto
        String oggettoMeta = filtri.getDlOggettoUnitaDoc();
        ...
        String autoreDocMeta = filtri.getDsAutoreDoc();
        if (autoreDocMeta != null) {
            queryStr.append(whereWord).append(" UPPER(u.ds_Autore_Doc) LIKE :dldocmetain ");
            whereWord = " AND ";
        }
        // Inserimento nella query del filtro metadati Descrizione documento
        String descrizioneDocMeta = filtri.getDlDoc();
        if (descrizioneDocMeta != null) {
            queryStr.append(whereWord).append(" UPPER(u.dl_Doc) LIKE :dsautoredocin ");
            whereWord = " AND ";
        }
        // Inserimento nella query del filtro Tipo Conservazione
        String tipoConservazione = filtri.getTiConservazione();
        if (tipoConservazione != null) {
            queryStr.append(whereWord).append(" u.ti_Conservazione = :ticonservazionein ");
            whereWord = " AND ";
        }
        ...
        if (filtriFascicoli.isFiltriImpostati()) {
            ...
            if (valoreClassif != null) {
                queryStr.append(whereWord)
                        .append(" UPPER(u.cd_Composito_Voce_Titol) LIKE :valoreclassif ");
                whereWord = " AND ";
            }
            aaFascicolo = filtriFascicoli.getAaFascicolo();
            if (aaFascicolo != null) {
                queryStr.append(whereWord).append(" u.aa_Fascicolo = :aafasc ");
                whereWord = " AND ";
            }
            cdKeyFascicolo = filtriFascicoli.getCdKeyFascicolo();
            if (cdKeyFascicolo != null) {
                queryStr.append(whereWord).append(" u.cd_Key_Fascicolo = :cdfasc ");
                whereWord = " AND ";
            }
            aaFascRangeDa = filtriFascicoli.getAaFascicoloDa();
            aaFascRangeA = filtriFascicoli.getAaFascicoloA();
            if (aaFascRangeDa != null && aaFascRangeA != null) {
                queryStr.append(whereWord)
                        .append(" (u.aa_Fascicolo BETWEEN :aafasc_da AND :aafasc_a) ");
                whereWord = " AND ";
            }
            cdFascRangeDa = filtriFascicoli.getCdKeyFascicoloDa();
            cdFascRangeA = filtriFascicoli.getCdKeyFascicoloA();
            if (cdFascRangeDa != null && cdFascRangeA != null) {
                ...
                cdFascRangeA = StringPadding.padString(cdFascRangeA, "0", 12,
                        StringPadding.PADDING_LEFT);
                queryStr.append(whereWord).append(
                        " LPAD( u.cd_Key_Fascicolo, 12, '0') BETWEEN :cdfasc_da AND :cdfasc_a ");
                whereWord = " AND ";
            }
            tipoFascIn = filtriFascicoli.getNmTipoFascicolo();
            if (tipoFascIn != null) {
                queryStr.append(whereWord).append(" u.id_Tipo_Fascicolo = :tipofascin ");
                whereWord = " AND ";
            }
            dtApeFascRangeDa = filtriFascicoli.getDtApeFascicoloDa();
            dtApeFascRangeA = filtriFascicoli.getDtApeFascicoloA();
            if (dtApeFascRangeDa != null || dtApeFascRangeA != null) {
                ...
                queryStr.append(whereWord)
                        .append(" (u.dt_Ape_Fascicolo BETWEEN :dtapefasc_da AND :dtapefasc_a) ");
                whereWord = " AND ";
            }
            ...
            if (dtChiuFascRangeDa != null || dtChiuFascRangeA != null) {
                ...
                queryStr.append(whereWord)
                        .append(" (u.dt_Chiu_Fascicolo BETWEEN :dtchiufasc_da AND :dtchiufasc_a) ");
                whereWord = " AND ";
            }
            oggettoFasc = filtriFascicoli.getDsOggettoFascicolo();
            if (oggettoFasc != null) {
                queryStr.append(whereWord).append(" UPPER(u.ds_Oggetto_Fascic) LIKE :dsoggfasc ");
                whereWord = " AND ";
            }
        }
        ...
        if (filtriCollegamenti.getConCollegamento() != null
                && filtriCollegamenti.getConCollegamento().equals("1")) {
            // queryStr.append(whereWord).append(
            // " exists (select 1 from AroLinkUnitaDoc link where link.aroUnitaDoc.idUnitaDoc =
            // u.idUnitaDoc ");
            queryStr.append(whereWord).append(
                    " exists (select 1 from Aro_Link_Unita_Doc link where link.id_Unita_Doc = u.id_Unita_Doc ");

            // Se il filtro "Collegamento risolto" vale "Sì"
            if (filtriCollegamenti.getCollegamentoRisolto() != null
                    && filtriCollegamenti.getCollegamentoRisolto().equals("1")) {
                queryStr.append(whereWord).append(" link.id_unita_doc_link is not null ");
            }
            // Se il filtro "Collegamento risolto" vale "No"
            if (filtriCollegamenti.getCollegamentoRisolto() != null
                    && filtriCollegamenti.getCollegamentoRisolto().equals("0")) {
                queryStr.append(whereWord).append(" link.id_unita_doc_link is null ");
            }
            // Se il filtro "Descr. collegamento" è valorizzato
            valoreColl = filtriCollegamenti.getDsLinkUnitaDoc();
            if (valoreColl != null) {
                queryStr.append(whereWord)
                        .append(" UPPER(link.ds_Link_Unita_Doc) LIKE :valorecoll ");
            }
            // Se il filtro "Registro" è valorizzato
            valorereg = filtriCollegamenti.getCdRegistroKeyUnitaDocLink();
            if (valorereg != null && !valorereg.equals("")) {
                queryStr.append(whereWord)
                        .append(" link.cd_Registro_Key_Unita_Doc_Link = :valorereg ");
            }
            // Se il filtro "Anno" è valorizzato
            valoreanno = filtriCollegamenti.getAaKeyUnitaDocLink();
            if (valoreanno != null) {
                queryStr.append(whereWord).append(" link.aa_Key_Unita_Doc_Link = :valoreanno ");
            }
            // Se il filtro "Numero" è valorizzato
            valorenumero = filtriCollegamenti.getCdKeyUnitaDocLink();
            if (valorenumero != null) {
                queryStr.append(whereWord).append(" link.cd_Key_Unita_Doc_Link = :valorenumero ");
            }
            queryStr.append(") ");
        }
        // Se il filtro "Con collegamento" vale "No"
        if (filtriCollegamenti.getConCollegamento() != null
                && filtriCollegamenti.getConCollegamento().equals("0")) {
            queryStr.append(whereWord).append(
                    " not exists (select 1 from Aro_Link_Unita_Doc link1 where link1.id_Unita_Doc = u.id_Unita_Doc ");
            queryStr.append(") ");
        }
        // Se il filtro "E' oggetto di collegamento" vale "Sì"
        if (filtriCollegamenti.getIsOggettoCollegamento() != null
                && filtriCollegamenti.getIsOggettoCollegamento().equals("1")) {
            queryStr.append(whereWord).append(
                    " exists (select 1 from Aro_Link_Unita_Doc link2 where link2.id_Unita_Doc_link = u.id_Unita_Doc ");

            // Se il filtro "Descr. collegamento oggetto" è valorizzato
            valoreColl2 = filtriCollegamenti.getDsLinkUnitaDocOggetto();
            if (valoreColl2 != null) {
                queryStr.append(whereWord)
                        .append(" UPPER(link2.ds_Link_Unita_Doc) LIKE :valorecoll2 ");
            }
            queryStr.append(") ");
        }
        // Se il filtro "Con collegamento" vale "No"
        if (filtriCollegamenti.getIsOggettoCollegamento() != null
                && filtriCollegamenti.getIsOggettoCollegamento().equals("0")) {
            queryStr.append(whereWord).append(
                    " not exists (select 1 from Aro_Link_Unita_Doc link3 where link3.id_Unita_Doc_link = u.id_Unita_Doc ");
            queryStr.append(") ");
        }
        if (filtri.getDsClassif() != null || filtri.getCdFascic() != null
                || filtri.getDsOggettoFascic() != null || filtri.getCdSottofascic() != null
            ...
            if (filtri.getDsClassif() != null) {
                queryStr.append(
                        " AND (UPPER(u.ds_Classif_Princ) like :classif OR UPPER(u.ds_Classif) like :classif) ");
            }
            if (filtri.getCdFascic() != null) {
                queryStr.append(
                        " and (UPPER(u.cd_Fascic_Princ) like :fascic OR UPPER(u.cd_Fascic) like :fascic)");
            }
            if (filtri.getDsOggettoFascic() != null) {
                queryStr.append(
                        " and (UPPER(u.ds_Oggetto_Fascic_Princ) like :oggFascic OR UPPER(u.ds_Oggetto_Fascic) like :oggFascic) ");
            }
            if (filtri.getCdSottofascic() != null) {
                queryStr.append(
                        " and (UPPER(u.cd_Sottofascic_Princ) like :sottoFascic OR UPPER(u.cd_Sottofascic) like :sottoFascic) ");
            }
            if (filtri.getDsOggettoSottofascic() != null) {
                queryStr.append(
                        " and (UPPER(u.ds_Oggetto_Sottofascic_Princ) like :oggSottoFascic OR UPPER(u.ds_Oggetto_Sottofascic) like :oggSottoFascic) ");
            }
            whereWord = " AND ";
        }
        ...
        if (filtri.getIdSistemaVersante() != null) {
            queryStr.append(
                    " and EXISTS (SELECT 1 from sacer_iam.USR_USER usr JOIN sacer_iam.APL_SISTEMA_VERSANTE sist_vers "
                            + "                 ON (sist_vers.id_sistema_versante = usr.id_sistema_versante) WHERE usr.id_user_iam = u.id_user_vers AND sist_vers.id_sistema_versante = :idSistemaVersante) ");
        }

        // ordina per dsKeyDoc crescente
        queryStr.append(" ORDER BY u.ds_Key_Ord");

        log.info("#SQL#:{}", queryStr.toString());
        ...
        // non avendo passato alla query i parametri di ricerca, devo passarli ora
        if (filtri.getIdSistemaVersante() != null) {
            query.setParameter("idSistemaVersante", filtri.getIdSistemaVersante());
        }
        if (!idTipoUnitaDocList.isEmpty()) {
            query.setParameter("listtipoud", idTipoUnitaDocList);
        }
        ...
        if (annoRangeDa == null || annoRangeA == null) {
            query.setParameter("annoin_da", anno);
            query.setParameter("annoin_a", anno);
        }
        if (annoRangeDa != null && annoRangeA != null) {
            query.setParameter("annoin_da", annoRangeDa);
            query.setParameter("annoin_a", annoRangeA);
        ...
        if (anno != null) {
            /*
             * se non è stato inserito il range allora l'anno immesso dall'utente viene forzato nel
             * range di anni
             */
            query.setParameter("annoin_da", anno);
            query.setParameter("annoin_a", anno);
        ...
        if (profiloNorm != null) {
            query.setParameter("parProfiloNormativo", 1); // Indica alla vista di considerare il
                                                          // prof norm per prestazioni migliori
            query.setParameter("profiloNorm", profiloNorm);
        } else {
            query.setParameter("parProfiloNormativo", 0);
        }
        if (forzaAcc != null) {
            query.setParameter("forzaaccin", forzaAcc);
        }
        ...
        if (!subStruts.isEmpty()) {
            BigDecimal sottoStrutturaUnica = subStruts.get(0);
            // query.setParameter("subStruts", subStruts);
            query.setParameter("subStruts", sottoStrutturaUnica);
        }

        if (lazy) {
            // return lazyListHelper.getTableBean(query,
            // getAroVRicAdvUnitaDocTableBeanFromResultListFunction(addButton),
            // "u.idUnitaDoc");
            return lazyListHelper.getTableBeanForNativeQuery(query,
                    this::resultListDTOToAroVRicUnitaDocRowBeansNuovo, "u.ID_UNITA_DOC",
                    "AroVRicUnitaDocNewDTOMapping");
    ...
    // private Function<List, AroVRicAdvUnitaDocTableBean>
    // getAroVRicAdvUnitaDocTableBeanFromResultListFunction(
    // boolean addButton) {
    // return list -> getAroVRicAdvUnitaDocTableBeanFromResultList(list, addButton);
    // }
    //
    // public AroVRicAdvUnitaDocTableBean getAroVRicAdvUnitaDocTableBeanFromResultList(
    // List<AroVRicAdvUnitaDoc> listaUD, boolean addButton) {
    // AroVRicAdvUnitaDocTableBean udTableBean = new AroVRicAdvUnitaDocTableBean();
    //
    // try {
    // if (listaUD != null && !listaUD.isEmpty()) {
    // for (AroVRicAdvUnitaDoc ud : listaUD) {
    // AroVRicAdvUnitaDocRowBean rowBean = (AroVRicAdvUnitaDocRowBean) Transform
    // .entity2RowBean(ud);
    ...
    public AroVRicUnitaDocTableBean getAroVRicAdvUnitaDocRicAvanzataViewBeanNoLimit(
            FiltriUnitaDocumentarieAvanzata filtri, List<BigDecimal> idTipoUnitaDocList,
            Set<String> cdRegistroUnitaDocSet, List<BigDecimal> idTipoDocList,
            List<DecCriterioDatiSpecBean> listaDatiSpecOnLine,
            UnitaDocumentarieForm.FiltriCollegamentiUnitaDocumentarie filtriCollegamenti,
    ...
    /*
     * ############################################################################### PARTE NUOVA
     * DELLA RICERCA AVANZATA - FINE
     * ###############################################################################
     */
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicDatiSpecViewBeanPlainFilter(
            List<BigDecimal> idTipoUnitaDocList, Set<String> cdRegistroUnitaDocSet,
            List<BigDecimal> idTipoDocList, List<DecCriterioDatiSpecBean> listaDatiSpecOnLine,
            BigDecimal idStruttura, boolean addButton, FiltriUnitaDocumentarieDatiSpecPlain filtri,
        ...
        if (!cdRegistroUnitaDocSet.isEmpty()) {
            ...
            queryWhereConditions.append(whereWord)
                    .append(" ud.cd_Registro_Key_Unita_Doc IN (:setregistro) ");
            whereWord = "AND ";
        }
        ...
        if (annoRangeDa != null && annoRangeA != null) {
            queryWhereConditions.append(whereWord)
                    .append(" (ud.aa_Key_Unita_Doc BETWEEN :annoin_da AND :annoin_a) ");
            whereWord = " AND ";
        }
        ...
        if (codiceRangeDa != null && codiceRangeA != null) {
            ...
            codiceRangeA = StringPadding.padString(codiceRangeA, "0", 12,
                    StringPadding.PADDING_LEFT);
            queryWhereConditions.append(whereWord).append(
                    " LPAD( ud.cd_Key_Unita_Doc, 12, '0') BETWEEN :codicein_da AND :codicein_a ");
            whereWord = " AND ";
        }
        ...
        // non avendo passato alla query i parametri di ricerca dei dati specifici, devo passarli
        // ora
        int contaIdAttrib = 0;
        for (int i = 0; i < mappone.size(); i++) {
            DatiSpecQueryParams dsqp = mappone.get(i);
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocTableBeanFromResultList(
            List<AroVRicUnitaDoc> listaUD, boolean addButton) {
        AroVRicUnitaDocTableBean udTableBean = new AroVRicUnitaDocTableBean();

        try {
            if (listaUD != null && !listaUD.isEmpty()) {
                for (AroVRicUnitaDoc ud : listaUD) {
                    AroVRicUnitaDocRowBean rowBean = (AroVRicUnitaDocRowBean) Transform
                            .entity2RowBean(ud);
                    // Se sto gestendo l'aggiunta di ud a una serie, aggiungo questo campo per
                    // inserire il bottone "+"
                    // sulla selectList
    ...
    private String appendJoin(boolean formato, boolean firma, boolean certif, boolean appart) {
        ...
        if (appart) {
            join.append(
                    " JOIN comp.volAppartCompVolumes appartComp JOIN appartComp.volAppartDocVolume appartDoc ");
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocsById(List<BigDecimal> ids) {
        String queryStr = "SELECT DISTINCT new it.eng.parer.viewEntity.AroVRicUnitaDoc (u.id.idUnitaDoc, u.aaKeyUnitaDoc, u.cdKeyUnitaDoc, u.cdRegistroKeyUnitaDoc, u.dtCreazione, u.dtRegUnitaDoc, u.flUnitaDocFirmato, u.tiEsitoVerifFirme, u.dsMsgEsitoVerifFirme, u.nmTipoUnitaDoc, u.flForzaAccettazione, u.flForzaConservazione, u.dsKeyOrd, u.niAlleg, u.niAnnessi, u.niAnnot, u.nmTipoDocPrinc, u.dsListaStatiElencoVers, u.tiStatoConservazione) "
                + "FROM AroVRicUnitaDoc u " + "WHERE u.id.idUnitaDoc IN (:ids) "
                + "ORDER BY u.dsKeyOrd";
    ...
    public ElvVLisUpdUdTableBean getElvVLisUpdUdTableBeanByIdUpd(Set<BigDecimal> idUpdUnitaDocSet) {
        String queryStr = "SELECT u FROM ElvVLisUpdUd u "
                + "WHERE u.idUpdUnitaDoc IN (:idUpdUnitaDocSet) ";
        Query query = getEntityManager().createQuery(queryStr);
        ...
        try {
            if (listaUpd != null && !listaUpd.isEmpty()) {
                for (ElvVLisUpdUd row : listaUpd) {
                    ElvVLisUpdUdRowBean rowBean = (ElvVLisUpdUdRowBean) Transform
                            .entity2RowBean(row);
                    updTB.add(rowBean);
                }
            }
    ...
    public AroVLisDocTableBean getAroVLisDocTableBean(BigDecimal idud, String tipoDoc) {
        ...
        return lazyListHelper.getTableBean(query, this::getAroVLisDocTableBeanFromResultList,
                "idDoc");
    }

    public AroVVisDocIamTableBean getAroVVisDocAggIamTableBean(BigDecimal idud,
            Date dataCreazioneUd) {
    ...
    /**
     * Nel caso in cui il backend di salvataggio degli XML di versamento sia l'object storage
     * (gestito dal parametro <strong>applicativo</strong>) si possono verificare 2 casi:
     * <ul>
     ...
     *
     * @param tabella AroVVisDocIamTableBean
     */
     ...
     * Se si avvera il secondo caso li devo recuperare
     *
     * @param riga AroVVisDocIamRowBean
     */
    public void addXmlDocFromOStoAroVVisDocIamRowBean(AroVVisDocIamRowBean riga) {
        ...
        if (xmlVuoti) {
            Map<String, String> xmls = objectStorageService
                    .getObjectSipDoc(riga.getIdDoc().longValue());
            /*
     ...
     * Se si avvera il secondo caso li devo recuperare
     *
     * @param riga AroVVisUnitaDocIamRowBean
     */
    private void addXmlUniDocFromOStoAroVVisUnitaDocIamRowBean(AroVVisUnitaDocIamRowBean riga) {
        ...
        if (xmlVuoti) {
            Map<String, String> xmls = objectStorageService
                    .getObjectSipUnitaDoc(riga.getIdUnitaDoc().longValue());
    ...
    public AroVLisLinkUnitaDocTableBean getAroVLisLinkUnitaDocTableBean(BigDecimal idud,
            int maxResults) {
        ...
        query.setMaxResults(maxResults);
        return lazyListHelper.getTableBean(query,
                this::getAroVLisLinkUnitaDocTableBeanFromResultList);
    }
    ...
    private AroVLisLinkUnitaDocTableBean getAroVLisLinkUnitaDocTableBeanFromResultList(
        ...
        try {
            if (listaLink != null && !listaLink.isEmpty()) {
                listaLinkTableBean = (AroVLisLinkUnitaDocTableBean) Transform
                        .entities2TableBean(listaLink);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public AroVLisArchivUnitaDocTableBean getAroVLisArchivUnitaDocTableBean(BigDecimal idud,
            int maxResults) {
    ...
    private AroVLisArchivUnitaDocTableBean resultListToAroVLisArchivUnitaDocTableBean(
        ...
        try {
            if (listaArchiv != null && !listaArchiv.isEmpty()) {
                listaArchivTableBean = (AroVLisArchivUnitaDocTableBean) Transform
                        .entities2TableBean(listaArchiv);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public AroVLisCompDocTableBean getAroVLisCompDocTableBean(BigDecimal iddoc, int maxResults) {
        ...
        try {
            if (listaCompDoc != null && !listaCompDoc.isEmpty()) {
                listaCompDocTableBean = (AroVLisCompDocTableBean) Transform
                        .entities2TableBean(listaCompDoc);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public AroVLisUpdDocUnitaDocTableBean getAroVLisUpdDocUnitaDocTableBean(BigDecimal idupd,
            int maxResults) {
    ...
    public AroVLisVolNoValDocTableBean getAroVLisVolNoValDocTableBean(BigDecimal iddoc,
            int maxResults) {
    ...
    public AroVLisUpdCompUnitaDocTableBean getAroVLisUpdCompUnitaDocTableBean(BigDecimal idupd,
            int maxResults) {
    ...
    public AroVLisUpdKoRisoltiTableBean getAroVLisUpdKoRisoltiTableBean(BigDecimal idupd,
            int maxResults) {
    ...
    public AroWarnUpdUnitaDocTableBean getAroWarnUpdUnitaDocTableBean(BigDecimal idupd,
            int maxResults) {
        ...
        try {
            if (listaUpdWarnUnitaDoc != null && !listaUpdWarnUnitaDoc.isEmpty()) {
                for (AroWarnUpdUnitaDoc updWarnUD : listaUpdWarnUnitaDoc) {
                    ...
                    listaUpdWarnUnitaDocRowBean.setString("cd_err",
                            updWarnUD.getDecErrSacer().getCdErr());
    ...
    public String getVersioniXsd(BigDecimal idAttribDatiSpec, BigDecimal id,
            TipoEntitaSacer tipoEntitaSacer) {
        ...
        String queryStr = String
                .format("SELECT DISTINCT dec.cdVersioneXsd FROM DecXsdAttribDatiSpec decXsd "
                        + " JOIN decXsd.decXsdDatiSpec dec "
                        + " JOIN decXsd.decAttribDatiSpec decAttrib "
                        + " WHERE decAttrib.idAttribDatiSpec = :idattribdatispec "
                        + " AND %s = :id", tmpTipoEntita);
    ...
    public String getVersioniXsdSisMigr(BigDecimal idAttribDatiSpec, String tipoEntitaSacer,
        ...
        String queryStr = "SELECT DISTINCT dec.cdVersioneXsd FROM DecXsdAttribDatiSpec decXsd JOIN decXsd.decXsdDatiSpec dec "
                + " JOIN decXsd.decAttribDatiSpec decAttrib "
                + " WHERE decAttrib.idAttribDatiSpec = :idattribdatispec"
                + " AND dec.nmSistemaMigraz = :nmsistemamigrazin"
                + " AND dec.tiEntitaSacer = :tipoentitasacerin";
    ...
    public DecAttribDatiSpecTableBean getDecAttribDatiSpecTableBean(BigDecimal id,
        ...
        try {
            if (listaDatiSpec != null && !listaDatiSpec.isEmpty()) {
                listaDatiSpecTableBean = (DecAttribDatiSpecTableBean) Transform
                        .entities2TableBean(listaDatiSpec);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public DecAttribDatiSpecTableBean getDecAttribDatiSpecSisMigrTableBean(
            String tipoSistemaMigrazione, BigDecimal idStrut) {

        String queryStr = "SELECT u FROM DecXsdAttribDatiSpec v JOIN v.decAttribDatiSpec u "
                + "WHERE u.nmSistemaMigraz = :nmsistemamigrazin "
                + "AND u.orgStrut.idStrut = :idstrutin " + "AND (u.tiEntitaSacer = :unidocin "
                + "OR u.tiEntitaSacer = :docin) " + "ORDER BY v.niOrdAttrib";
    ...
    private AroVLisDatiSpecTableBean getAroVLisDatiSpecTableBeanFromResultList(
            List<?> listaDatiSpec) {
        AroVLisDatiSpecTableBean listaTableBean = new AroVLisDatiSpecTableBean();
        try {
            if (listaDatiSpec != null && !listaDatiSpec.isEmpty()) {
                listaTableBean = (AroVLisDatiSpecTableBean) Transform
                        .entities2TableBean(listaDatiSpec);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
    ...
    public String getUrnCalc(long idud) {
        ...
        return "urn_" + aud.getOrgStrut().getOrgEnte().getOrgAmbiente().getNmAmbiente() + "_"
                + aud.getOrgStrut().getOrgEnte().getNmEnte() + "_" + aud.getOrgStrut().getNmStrut()
                + "_" + aud.getCdRegistroKeyUnitaDoc() + "-" + aud.getAaKeyUnitaDoc().toString()
    ...
    public DecTipoUnitaDocRowBean getDecTipoUnitaDocRowBean(BigDecimal idTipoUnitaDoc) {
        DecTipoUnitaDoc tipoUnitaDoc = getEntityManager().find(DecTipoUnitaDoc.class,
                idTipoUnitaDoc.longValue());
    ...
    public AroVerIndiceAipUdTableBean getAroVerIndiceAipUdTableBean(BigDecimal idUnitaDoc,
            int maxResults) {
        ...
        try {
            if (listaIndici != null && !listaIndici.isEmpty()) {
                listaIndiciTableBean = (AroVerIndiceAipUdTableBean) Transform
                        .entities2TableBean(listaIndici);
                for (AroVerIndiceAipUdRowBean indiceRowBean : listaIndiciTableBean) {
                    ...
                    String tiFormatoIndiceAip = (majorNumber > 0)
                            ? "UNI SInCRO 2.0 (UNI 11386:2020)"
                    ...
                    if (indiceRowBean.getBigDecimal("id_ver_indice_aip") != null) {
                        ...
                        if (indice.getAroUrnVerIndiceAipUds() != null
                                && !indice.getAroUrnVerIndiceAipUds().isEmpty()) {
                            // Recupero lo urn ORIGINALE
                            AroUrnVerIndiceAipUd urnVerIndiceAipUd = IterableUtils
                                    .find(indice.getAroUrnVerIndiceAipUds(), object -> (object)
                                            .getTiUrn().equals(TiUrnVerIxAipUd.ORIGINALE));
                            if (urnVerIndiceAipUd != null) {
                                indiceRowBean.setString("urn", urnVerIndiceAipUd.getDsUrn());
                            }
                            // Recupero lo urn NORMALIZZATO
                            urnVerIndiceAipUd = IterableUtils
                                    .find(indice.getAroUrnVerIndiceAipUds(), object -> (object)
                                            .getTiUrn().equals(TiUrnVerIxAipUd.NORMALIZZATO));
                            if (urnVerIndiceAipUd != null) {
                                indiceRowBean.setString("urn_normalizzato",
                                        urnVerIndiceAipUd.getDsUrn());
                            }
                            // Recupero lo urn INIZIALE
                            urnVerIndiceAipUd = IterableUtils.find(
                                    indice.getAroUrnVerIndiceAipUds(),
                                    object -> (object).getTiUrn().equals(TiUrnVerIxAipUd.INIZIALE));
                            if (urnVerIndiceAipUd != null) {
                                indiceRowBean.setString("urn_iniziale",
                                        urnVerIndiceAipUd.getDsUrn());
                            }
                        } else {
    ...
    // MEV#30395
    public AroVerIndiceAipUdRowBean getAroVerIndiceAipUdRowBean(BigDecimal idVerIndiceAip,
            int maxResults) {
        String queryStr = "SELECT u FROM AroVerIndiceAipUd u "
                + "WHERE u.idVerIndiceAip = :idVerIndiceAip ";
        Query query = getEntityManager().createQuery(queryStr);
        ...
        try {
            if (listaVerIndici != null && !listaVerIndici.isEmpty()) {
                ...
                if (indice.getAroUrnVerIndiceAipUds() != null
                    ...
                    if (urnVerIndiceAipUd != null) {
                        verIndiceRowBean.setString("urn_normalizzato",
                                urnVerIndiceAipUd.getDsUrn());
                    }
                    // Recupero lo urn INIZIALE
                    urnVerIndiceAipUd = IterableUtils.find(indice.getAroUrnVerIndiceAipUds(),
    ...
    public AroFileVerIndiceAipUdRowBean getAroFileVerIndiceAipUdRowBean(BigDecimal idVerIndiceAip,
            int maxResults) {
        ...
        try {
            if (listaFileIndici != null && !listaFileIndici.isEmpty()) {
                fileIndiceRowBean = (AroFileVerIndiceAipUdRowBean) Transform
                        .entity2RowBean(listaFileIndici.get(0));
                if (fileIndiceRowBean.getBigDecimal("id_ver_indice_aip") != null) {
                    ...
                    if (indice.getAroUrnVerIndiceAipUds() != null
                        ...
                        urnVerIndiceAipUd = IterableUtils.find(indice.getAroUrnVerIndiceAipUds(),
                                object -> (object).getTiUrn().equals(TiUrnVerIxAipUd.NORMALIZZATO));
                        if (urnVerIndiceAipUd != null) {
                            fileIndiceRowBean.setString("urn_normalizzato",
                                    urnVerIndiceAipUd.getDsUrn());
                        }
                        // Recupero lo urn INIZIALE
                        urnVerIndiceAipUd = IterableUtils.find(indice.getAroUrnVerIndiceAipUds(),
                                object -> (object).getTiUrn().equals(TiUrnVerIxAipUd.INIZIALE));
                        if (urnVerIndiceAipUd != null) {
                            fileIndiceRowBean.setString("urn_iniziale",
                                    urnVerIndiceAipUd.getDsUrn());
                        }
                    } else {
    ...
    public AroVLisVolCorTableBean getAroVLisVolCorViewBean(BigDecimal idUnitaDoc) {
        ...
        try {
            if (listaVolumi != null && !listaVolumi.isEmpty()) {
                volumiTableBean = (AroVLisVolCorTableBean) Transform
    ...
    public AroVLisElvVerTableBean getAroVLisElvVerViewBean(BigDecimal idUnitaDoc) {
        ...
        try {
            if (listaElenchi != null && !listaElenchi.isEmpty()) {
                elenchiTableBean = (AroVLisElvVerTableBean) Transform
                        .entities2TableBean(listaElenchi);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public Long getLastIdUnitaDocAnnullata(BigDecimal idStrut, String cdRegistroKeyUnitaDoc,
        ...
        String queryStr = "SELECT u.idUnitaDoc FROM AroUnitaDoc u "
                ...
                + "AND u.dtAnnul != :dtAnnul " + "ORDER BY u.dtAnnul DESC ";
    ...
    public Long getIdUnitaDocVersataNoAnnul(BigDecimal idStrut, String cdRegistroKeyUnitaDoc,
            BigDecimal aaKeyUnitaDoc, String cdKeyUnitaDoc) {
        String queryStr = "SELECT u.idUnitaDoc FROM AroUnitaDoc u "
                + "WHERE u.orgStrut.idStrut = :idStrut "
                + "AND u.cdRegistroKeyUnitaDoc = :cdRegistroKeyUnitaDoc "
    ...
    public AroVLisFascTableBean getFascicoliAppartenenzaViewBean(BigDecimal idUnitaDoc) {
        String queryStr = "SELECT DISTINCT new it.eng.parer.viewEntity.AroVLisFasc(a.id.idFascicolo, a.aaFascicolo, a.cdKeyFascicolo, a.nmTipoFascicolo, "
                ...
                + "a.tiEsito, a.tiStatoFascElencoVers, a.tiStatoConservazione) "
                + "FROM AroVLisFasc a " + "WHERE a.id.idUnitaDoc = :idUnitaDoc "
                + "ORDER BY a.aaFascicolo, a.cdKeyFascicolo ";
        ...
        try {
            if (listaFascAppartenenza != null && !listaFascAppartenenza.isEmpty()) {
                fascicoliTableBean = (AroVLisFascTableBean) Transform
                        .entities2TableBean(listaFascAppartenenza);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public AroUpdUnitaDocTableBean getAggiornamentiMetadatiTableBean(BigDecimal idUnitaDoc) {
        String queryStr = "SELECT u FROM AroUpdUnitaDoc u "
                + "WHERE u.aroUnitaDoc.idUnitaDoc = :idUnitaDoc " + "ORDER BY u.tsIniSes ";
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idUnitaDoc", longFromBigDecimal(idUnitaDoc));
    ...
    // MEV#24597
    public AroVLisNotaUnitaDocTableBean getListaNoteUnitaDocumentarieTableBean(
        ...
        try {
            if (listaNote != null && !listaNote.isEmpty()) {
                noteTableBean = (AroVLisNotaUnitaDocTableBean) Transform
                        .entities2TableBean(listaNote);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public DecTipoNotaUnitaDocTableBean getDecTipoNotaUnitaDocNotInUnitaDocTableBean(long idUtente,
        ...
        List<DecTipoNotaUnitaDoc> decTipoNotaUnitaDocList = this
                .getDecTipoNotaUnitaDocListByIdUserIam(idUtente);
        List<DecTipoNotaUnitaDoc> listNotInUnitaDoc = this
                .getDecTipoNotaUnitaDocNotInUnitaDocByIdUserIam(idUtente, idUnitaDoc);
        try {
            if (decTipoNotaUnitaDocList != null && !decTipoNotaUnitaDocList.isEmpty()) {
                for (DecTipoNotaUnitaDoc row : decTipoNotaUnitaDocList) {
                    DecTipoNotaUnitaDocRowBean rowBean = (DecTipoNotaUnitaDocRowBean) Transform
                            .entity2RowBean(row);
                    if (rowBean.getFlObblig().equals("1")) {
                        rowBean.setDsTipoNotaUnitaDoc(
                                rowBean.getDsTipoNotaUnitaDoc() + " (OBBLIGATORIO)");
                    }
                    table.add(rowBean);
                }
            }
            ...
            log.error(
                    "Errore durante il recupero della lista tipi di nota delle unit\u00e0 documentarie "
    ...
    public DecTipoNotaUnitaDocTableBean getDecTipoNotaUnitaDocNotInVerIndiceAipTableBean(
            BigDecimal idVerIndiceAip) {
        DecTipoNotaUnitaDocTableBean table = new DecTipoNotaUnitaDocTableBean();
        table.addSortingRule("ni_ord", SortingRule.ASC);
        List<DecTipoNotaUnitaDoc> decTipoNotaUnitaDocList = this.getDecTipoNotaUnitaDocList();
        List<DecTipoNotaUnitaDoc> listNotInVerIndiceAip = this
                .getDecTipoNotaUnitaDocNotInVerIndiceAip(idVerIndiceAip);
        try {
            if (decTipoNotaUnitaDocList != null && !decTipoNotaUnitaDocList.isEmpty()) {
                for (DecTipoNotaUnitaDoc row : decTipoNotaUnitaDocList) {
                    DecTipoNotaUnitaDocRowBean rowBean = (DecTipoNotaUnitaDocRowBean) Transform
    ...
    public List<DecTipoNotaUnitaDoc> getDecTipoNotaUnitaDocNotInVerIndiceAip(
            BigDecimal idVerIndiceAip) {
        Query query = getEntityManager().createQuery(
    ...
    public BigDecimal saveNota(long idUtente, BigDecimal idUnitaDoc, BigDecimal idTipoNotaUnitaDoc,
        ...
        try {
            ...
            nota.setDecTipoNotaUnitaDoc(
                    this.findById(DecTipoNotaUnitaDoc.class, idTipoNotaUnitaDoc));
        ...
        if (list != null && !list.isEmpty()) {
            try {
                table = (AroVLisNotaUnitaDocTableBean) Transform.entities2TableBean(list);
                    ...
                    | InvocationTargetException ex) {
                log.error(
                        "Errore durante il recupero della lista note delle unit\u00e0 documentarie "
                                + ExceptionUtils.getRootCauseMessage(ex),
                        ex);
            }
        }
    ...
    public DecTipoNotaUnitaDocTableBean getSingleDecTipoNotaUnitaDocTableBean(
            BigDecimal idTipoNotaUnitaDoc) {
        DecTipoNotaUnitaDocTableBean table = new DecTipoNotaUnitaDocTableBean();
    ...
    public AroVerIndiceAipUdRowBean retrieveVersioneIndiceAipUdById(long idVerIndiceAip) {
        ...
        try {
            if (verIndiceAipUd != null) {
                verIndiceAipUdRowBean = (AroVerIndiceAipUdRowBean) Transform
                        .entity2RowBean(verIndiceAipUd);
                ...
                if (verIndiceAipUdRowBean.getBigDecimal("id_elenco_vers") != null) {
                    ...
                    verIndiceAipUdRowBean.setString("ti_stato_elenco_vers",
                ...
                if (verIndiceAipUdRowBean.getBigDecimal("id_ver_indice_aip") != null) {
                    ...
                    if (indice.getAroUrnVerIndiceAipUds() != null
                        ...
                        urnVerIndiceAipUd = IterableUtils.find(indice.getAroUrnVerIndiceAipUds(),
                                object -> (object).getTiUrn().equals(TiUrnVerIxAipUd.NORMALIZZATO));
                        if (urnVerIndiceAipUd != null) {
                            verIndiceAipUdRowBean.setString("urn_normalizzato",
                                    urnVerIndiceAipUd.getDsUrn());
                        }
                        ...
                        urnVerIndiceAipUd = IterableUtils.find(indice.getAroUrnVerIndiceAipUds(),
                                object -> (object).getTiUrn().equals(TiUrnVerIxAipUd.INIZIALE));
                        if (urnVerIndiceAipUd != null) {
                            verIndiceAipUdRowBean.setString("urn_iniziale",
                                    urnVerIndiceAipUd.getDsUrn());
                        }
                    } else {
    ...
    public boolean isUserAppartAllOk(long idUtente) {
        ...
        if (TiEnteConvenz.AMMINISTRATORE.equals(tiEnteConvenz)
                || TiEnteConvenz.CONSERVATORE.equals(tiEnteConvenz)) {
            isOk = true;
        }
    ...
    public List<Object[]> progressivoEsistenteUnitaDocList(BigDecimal idStrut,
        ...
        String queryStr = "SELECT unitaDoc FROM AroUnitaDoc unitaDoc "
                ...
                + "AND unitaDoc.pgUnitaDoc = :nuovoProgressivo "
                + "AND unitaDoc.orgStrut.idStrut = :idStrut "
                + "AND unitaDoc.idUnitaDoc != :idUnitaDoc " + "AND unitaDoc.dtAnnul = :dtAnnul ";
        Query query = getEntityManager().createQuery(queryStr);
        ...
        if (!unitaDocList.isEmpty()) {
            for (AroUnitaDoc unitaDoc : unitaDocList) {
                regAnnoNumeroObjList.add(new Object[] {
                        unitaDoc.getCdRegistroKeyUnitaDoc(), unitaDoc.getAaKeyUnitaDoc(),
                        unitaDoc.getCdKeyUnitaDoc() });
            }
        }
    ...
    public boolean existAroUnitaDocsFromRegistro(BigDecimal idRegistroUnitaDoc,
            BigDecimal idStrut) {
        Query query = getEntityManager().createQuery(
    ...
    public boolean existsRelationsWithUnitaDoc(long idTipoDato, Constants.TipoDato tipoDato) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT COUNT(unitaDoc) FROM AroUnitaDoc unitaDoc ");
        switch (tipoDato) {
        case REGISTRO:
        ...
        case TIPO_DOC:
            queryStr = new StringBuilder(
                    "SELECT COUNT(unitaDoc) FROM AroDoc doc " + "JOIN doc.aroUnitaDoc unitaDoc "
    ...
    /*
     * Controlla se esieste un numeroNormalizzato nell'ambito della stessa struttura/anno/numero
     * registro.
     */
    public boolean existsUdWithSameNormalizedNumber(long idRegistroUnitaDoc,
            BigDecimal annoRegistro, String numeroNormalizzato, String numeroNonNormalizzato) {
        Query query = getEntityManager()
                .createQuery("SELECT  COUNT(aroUnitaDoc) FROM AroUnitaDoc aroUnitaDoc " + // "WHERE
    ...
    public AroCompUrnCalc findAroCompUrnCalcByType(AroCompDoc aroCompDoc, TiUrn tiUrn) {
        Query query = getEntityManager().createQuery(
                "SELECT  a FROM AroCompUrnCalc a WHERE   a.aroCompDoc = :aroCompDoc AND a.tiUrn = :tiUrn");
    ...
    private String calcAndcheckCdKeyNormalized(AroUnitaDoc aroUnitaDoc,
            String cdKeyUnitaDocNormaliz) {
        if (this.existsUdWithSameNormalizedNumber(aroUnitaDoc.getIdDecRegistroUnitaDoc(),
                aroUnitaDoc.getAaKeyUnitaDoc(), cdKeyUnitaDocNormaliz,
    ...
    public AroCompUrnCalc verifyAndCreateCompUrnCalc(AroCompDoc aroCompDoc, String nomeStruttura,
            String nomeStrutturaNorm, String nomeEnte, String nomeEnteNorm, String nomeSistema,
            TiUrn tiUrn) {
        ...
        if (aroCompUrnCalc == null) {
            ...
            switch (tiUrn) {
            case ORIGINALE:
                tmpUrn = String.format("urn:%s:%s:%s:%s-%s-%s:", nomeSistema, nomeEnte,
                        nomeStruttura, aroUnitaDoc.getCdRegistroKeyUnitaDoc(),
                        aroUnitaDoc.getAaKeyUnitaDoc().longValueExact(),
                        aroUnitaDoc.getCdKeyUnitaDoc());
                break;
            case NORMALIZZATO:
                tmpUrn = String.format("urn:%s:%s:%s:%s-%s-%s:", nomeSistema, nomeEnteNorm,
                        nomeStrutturaNorm,
            ...
            if (needCheckSottoComp) {
                if (aroCompDocPadre != null) {
                    ...
                    tmpUrn += String.format("%05d", aroDoc.getNiOrdDoc().longValueExact()) + ":"
                            + String.format("%05d",
                                    aroCompDocPadre.getNiOrdCompDoc().longValueExact())
                            + ":"
     ...
     *
     * @param idAroUnitaDoc    id unita doc
     * @param tiUrnToCalculate tipo urn da calcolare
     */
    public void normalizzaUDAndCalcUrnOrigNormalizComp(long idAroUnitaDoc,
            ...
            for (Iterator<AroStrutDoc> it = tmpAroDoc.getAroStrutDocs().iterator(); it.hasNext();) {
                ...
                for (AroCompDoc tmpAroCompDoc : tmpAroStrutDoc.getAroCompDocs()) {
                    ...
                    for (TiUrn tiUrn : tiUrnToCalculate) {
                        // calcolo URN
                        AroCompUrnCalc tmpAroCompUrnCalc = me.verifyAndCreateCompUrnCalc(
                                tmpAroCompDoc, tmpOrgStrut.getNmStrut(),
                                tmpOrgStrut.getCdStrutNormaliz(), tmpOrgEnte.getNmEnte(),
    ...
    /**
     * @param filtri                   filtri di ricerca
     * @param idTipoUnitaDocList       tipi di unità documentarie
     * @param cdRegistroUnitaDocSet    registri delle unità documentarie
     * @param idTipoDocList            tipi di documenti
     * @param dateAcquisizioneValidate date di acquisizione
     * @param dateUnitaDocValidate     date delle unità documentarie
     * @param dateAnnulValidate        date di annullamento
     *
     * @return AroVRicUnitaDocTableBean table bean per la UI
     *
     * @throws EMFError errore generico7
     */
    // Metodo che restituisce un viewbean con i record trovati in base
    // ai filtri di ricerca passati in ingresso
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicAnnullateTableBean(
            UnitaDocumentarieForm.FiltriUnitaDocumentarieAnnullate filtri,
            List<BigDecimal> idTipoUnitaDocList, Set<String> cdRegistroUnitaDocSet,
            List<BigDecimal> idTipoDocList, Date[] dateAcquisizioneValidate,
        ...
        return getAroVRicUnitaDocRicAnnullateTableBeanPlainFilter(idTipoUnitaDocList,
                cdRegistroUnitaDocSet, idTipoDocList,
                new FiltriUnitaDocumentarieAnnullatePlain(filtri, dataCreazioneDa, dataCreazioneA,
    ...
    public AroVRicUnitaDocTableBean getAroVRicUnitaDocRicAnnullateTableBeanPlainFilter(
            ...
            FiltriUnitaDocumentarieAnnullatePlain filtriUnitaDocumentarieAnnullatePlain,
            boolean lazy) {
        String whereWord = "WHERE ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT DISTINCT u FROM AroUnitaDoc u LEFT JOIN u.aroDocs doc ");
        ...
        if (!idTipoUnitaDocList.isEmpty()) {
            queryStr.append(whereWord)
                    .append("(u.decTipoUnitaDoc.idTipoUnitaDoc IN (:listtipoud))");
            whereWord = " AND ";
        }
        ...
        if (!cdRegistroUnitaDocSet.isEmpty()) {
            queryStr.append(whereWord)
                    .append("u.decRegistroUnitaDoc.cdRegistroUnitaDoc IN (:setregistro) ");
            whereWord = "AND ";
        }
        ...
        if ((filtriUnitaDocumentarieAnnullatePlain.getDataRegUnitaDocDa() != null)
            ...
            queryStr.append(whereWord)
                    .append("(u.dtRegUnitaDoc between :dataregudda AND :datareguda) ");
            whereWord = " AND ";
        }
        ...
        if (filtriUnitaDocumentarieAnnullatePlain.getDataRegUnitaDocDa() != null
                && filtriUnitaDocumentarieAnnullatePlain.getDataRegUnitaDocA() != null) {
            query.setParameter("dataregudda",
                    filtriUnitaDocumentarieAnnullatePlain.getDataRegUnitaDocDa(),
                    TemporalType.DATE);
            query.setParameter("datareguda",
                    filtriUnitaDocumentarieAnnullatePlain.getDataRegUnitaDocA(), TemporalType.DATE);
        }

        if ((filtriUnitaDocumentarieAnnullatePlain.getDataAnnulDa() != null)
                && (filtriUnitaDocumentarieAnnullatePlain.getDataAnnulA() != null)) {
            query.setParameter("dataannulda",
                    filtriUnitaDocumentarieAnnullatePlain.getDataAnnulDa());
            query.setParameter("dataannula", filtriUnitaDocumentarieAnnullatePlain.getDataAnnulA());
        }

        if (!StringUtils.isBlank(filtriUnitaDocumentarieAnnullatePlain.getTiAnnullamento())) {
            query.setParameter("tiAnnullamento",
        ...
        try {
            if (listaUD != null && !listaUD.isEmpty()) {
                for (AroUnitaDoc ud : listaUD) {
                    ...
                    AroUnitaDocRowBean udRowBean = (AroUnitaDocRowBean) Transform
                            .entity2RowBean(ud);
                    ...
                    for (AroDoc doc : getAroDocs(ud)) {
                        if (doc.getTiDoc().equals("PRINCIPALE")) {
                            rowBean.setString("nm_tipo_doc_princ",
                                    getNmTipoDoc(doc.getIdDecTipoDoc()));
                            break;
                        }
                    }
                    // Ricavo il campo ds lista stati elenco vers
                    rowBean.setString("ds_lista_stati_elenco_vers",
                            getDsListaStatiElencoVers(ud.getIdUnitaDoc()));
    ...
    private List<AroDoc> getAroDocs(AroUnitaDoc ud) {
        TypedQuery<AroDoc> query = getEntityManager().createQuery(
    ...
    public String getNmTipoDoc(Long idTipoDoc) {
        if (idTipoDoc != null) {
            TypedQuery<String> query = getEntityManager().createQuery(
                    "SELECT d.nmTipoDoc FROM DecTipoDoc d WHERE d.idTipoDoc=:idTipoDoc",
                    String.class);
    ...
    private String getDsListaStatiElencoVers(long idUnitaDoc) {
        Query query = getEntityManager().createNativeQuery("select "
                ...
                + " from " + " (select ud_elenco.ti_stato_ud_elenco_vers ti_stato_elenco_vers "
                + " from ARO_UNITA_DOC ud_elenco " + " where ud_elenco.id_unita_doc = ?1 " + " "
                + " UNION "
    ...
    public List<AroNotaUnitaDoc> findAroNotaUnitaDocByIdUnitaDoc(AroUnitaDoc aroUnitaDoc) {
        TypedQuery<AroNotaUnitaDoc> query = getEntityManager().createQuery(
                "SELECT n FROM AroNotaUnitaDoc n WHERE n.aroUnitaDoc = :aroUnitaDoc ",
                AroNotaUnitaDoc.class);
    ...
    public String findNmTipoUnitaDocById(Long idTipoUnitaDoc) {
        TypedQuery<String> query = getEntityManager().createQuery(
                "SELECT u.nmTipoUnitaDoc FROM DecTipoUnitaDoc u WHERE u.idTipoUnitaDoc=:idTipoUnitaDoc",
                String.class);
    ...
    static class FiltriUnitaDocumentarieSemplicePlain {
        ...
        private FiltriUnitaDocumentarieSemplicePlain(FiltriUnitaDocumentarieSemplice filtri,
                List<BigDecimal> subStruttureAbilitateAllUtente) throws EMFError {
            ...
            this.subStruts = subStruttureAbilitateAllUtente;
    ...
    static class FiltriUnitaDocumentarieAnnullatePlain {
        ...
        private FiltriUnitaDocumentarieAnnullatePlain(
                UnitaDocumentarieForm.FiltriUnitaDocumentarieAnnullate filtri, Date dataCreazioneDa,
                Date dataCreazioneA, Date dataRegUnitaDocDa, Date dataRegUnitaDocA,
    ...
    static class FiltriUnitaDocumentarieAvanzataPlain {
        ...
        FiltriUnitaDocumentarieAvanzataPlain(FiltriUnitaDocumentarieAvanzata filtri,
                Date dataMetaDa, Date dataMetaA) throws EMFError {
            ...
            this.idSistemaVersante = filtri.getId_sistema_versante().parse();
        }
    ...
    static class FiltriUnitaDocumentarieDatiSpecPlain {
        ...
        FiltriUnitaDocumentarieDatiSpecPlain(FiltriUnitaDocumentarieDatiSpec filtri)
                throws EMFError {
            this.cdVersioneXsdUd = filtri.getCd_versione_xsd_ud().parse();
            this.cdVersioneXsdDoc = filtri.getCd_versione_xsd_doc().parse();
            /// this.aaKeyUnitaDoc = filtri.getAa_key_unita_doc().parse();
    ...
    static class FiltriCollegamentiUnitaDocumentariePlain {
        ...
        private FiltriCollegamentiUnitaDocumentariePlain(
            ...
            cdRegistroKeyUnitaDocLink = filtriCollegamenti.getCd_registro_key_unita_doc_link()
                    .getDecodedValue();
    ...
    public String getProfiloNormativo(String tiUsoModelloXsd, TiModelloXsdUd tiModelloXsdUd,
            long idUnitaDoc) {
    ...
    public List<DecVersioneWs> getDecVersioneWsList(String tiWs) {
        Query query = getEntityManager()
                .createQuery("SELECT versioneWs FROM DecVersioneWs versioneWs "
    ...
    public AroLogStatoConservUdTableBean getAroLogStatoConservUdTableBean(BigDecimal idUnitaDoc) {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss.SSS"); // Formato
        // desiderato
        try {
