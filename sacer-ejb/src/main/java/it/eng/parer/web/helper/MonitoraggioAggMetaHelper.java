...
public class MonitoraggioAggMetaHelper extends GenericHelper {
    ...
    String MON_CHK_UPD_UD_COR_BY_AMB = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "		and trunc(upd_da_elab.dt_creazione) = abil_key_ud.dt_last_upd_ud) " + "	) " + "select "
            + " usr.id_user_iam id_user_iam_cor, " + " amb.id_ambiente, " + "case " + "	when exists (select *  "
            + "				from tmp_abil_key_ud abil_key_ud " + "				) " + "			then '1' "
            + "			else '0' " + "end fl_upd_cor, " + "case " + "	when exists (select *  "
            + "				from tmp_upd_ud_da_elab_elenco upd_da_elab "
            + "				where upd_da_elab.ti_stato_upd_elenco_vers = 'IN_ATTESA_SCHED' " + "				) "
            + "			then '1' " + "			else '0' " + "end fl_upd_attesa_sched_cor, " + "case "
    ...
    String MON_CHK_UPD_UD_COR_BY_ENTE = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "		and upd_da_elab.aa_key_unita_doc = abil_key_ud.aa_key_unita_doc "
            + "		and trunc(upd_da_elab.dt_creazione) = abil_key_ud.dt_last_upd_ud) " + "	) " + "select "
            + " usr.id_user_iam id_user_iam_cor, " + " ente.id_ente, " + "case " + "	when exists (select *  "
            + "				from tmp_abil_key_ud abil_key_ud " + "				) " + "			then '1' "
            + "			else '0' " + "end fl_upd_cor, " + "case " + "	when exists (select *  "
            + "				from tmp_upd_ud_da_elab_elenco upd_da_elab "
            + "				where upd_da_elab.ti_stato_upd_elenco_vers = 'IN_ATTESA_SCHED' " + "				) "
    ...
    String MON_CHK_UPD_UD_COR_BY_STRUT = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "		and upd_da_elab.aa_key_unita_doc = abil_key_ud.aa_key_unita_doc "
            + "		and trunc(upd_da_elab.dt_creazione) = abil_key_ud.dt_last_upd_ud) " + "	) " + "select "
            + " usr.id_user_iam id_user_iam_cor, " + " strut.id_strut, " + "case "
            + "	when exists (select * from tmp_abil_key_ud " + "				) " + "			then '1' "
            + "			else '0' " + "end fl_upd_cor, " + "case " + "	when exists (select *  "
            + "				from tmp_upd_ud_da_elab_elenco upd_da_elab "
            + "				where upd_da_elab.ti_stato_upd_elenco_vers = 'IN_ATTESA_SCHED' " + "				) "
            + "			then '1' " + "			else '0' " + "end fl_upd_attesa_sched_cor, " + "case "
    ...
    String MON_CNT_UPD_UD_NOCOR_BY_AMB = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "group by abil_key_ud.id_ambiente,  " + "		 conta_upd_ud.ti_stato_udp_ud, " + "		 case "
            + "			when conta_upd_ud.dt_rif_conta between trunc (sysdate - 30) and trunc(sysdate - 1)  "
            + "				then '30gg' " + " when conta_upd_ud.dt_rif_conta = trunc(sysdate) "
            + "         then 'oggi' " + "				else 'before30gg' " + "		 end ";
    ...
    String MON_CNT_UPD_UD_NOCOR_BY_ENTE = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "		else 'before30gg' " + " end ti_dt_creazione, " + " sum (conta_upd_ud.ni_ses_upd_ud) ni_upd_ud "
            + "from tmp_abil_key_ud abil_key_ud " + "join MON_CONTA_SES_UPD_UD conta_upd_ud "
            + "	on (conta_upd_ud.id_key_total_ud = abil_key_ud.id_key_total_ud) " + "group by abil_key_ud.id_ente,  "
    ...
    String MON_CNT_UPD_UD_NOCOR_BY_STRUT = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "		else 'before30gg' " + " end ti_dt_creazione, " + " sum (conta_upd_ud.ni_ses_upd_ud) ni_upd_ud "
            + "from tmp_abil_key_ud abil_key_ud " + "join MON_CONTA_SES_UPD_UD conta_upd_ud "
            + "	on (conta_upd_ud.id_key_total_ud = abil_key_ud.id_key_total_ud) " + "group by abil_key_ud.id_strut,  "
    ...
    String MON_CHK_UPD_UD_KO_COR_BY_STRUT = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + "		and ses_ko.aa_key_unita_doc = abil_key_ud_ko.aa_key_unita_doc "
            + "		and trunc(ses_ko.ts_ini_ses) = abil_key_ud_ko.dt_last_upd_ud_ko) " + "	) " + "select "
            + " usr.id_user_iam id_user_iam_cor, " + " strut.id_strut, " + "case " + "	when exists (select *  "
            + "				from tmp_ses_upd_unita_ko ses_ko "
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_RISOLUBILE' " + "				) "
            + "			then '1' " + "			else '0' " + "end fl_upd_ko_norisolub_cor, " + "case "
            + "	when exists (select *  " + "				from tmp_ses_upd_unita_ko ses_ko "
    ...
    String MON_CNT_UPD_UD_KO_NOCOR_BY_AMB = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + " sum (conta_upd_ud_ko.ni_ses_upd_ud_ko) ni_upd_ud_ko " + "from tmp_abil_key_ud_ko abil_key_ud_ko "
            ...
            + "group by abil_key_ud_ko.id_ambiente, conta_upd_ud_ko.ti_stato_udp_ud_ko, " + "		 case "
            + "			when conta_upd_ud_ko.dt_rif_conta between trunc (sysdate - 30) and trunc(sysdate - 1)  "
    ...
    String MON_CNT_UPD_UD_KO_NOCOR_BY_ENTE = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + "	on (conta_upd_ud_ko.id_key_total_ud_ko = abil_key_ud_ko.id_key_total_ud_ko "
            + "	and conta_upd_ud_ko.ti_stato_udp_ud_ko in ('NON_RISOLUBILE', 'NON_VERIFICATO', 'VERIFICATO')) "
            + "group by abil_key_ud_ko.id_ente, conta_upd_ud_ko.ti_stato_udp_ud_ko, " + "		 case "
            + "			when conta_upd_ud_ko.dt_rif_conta between trunc (sysdate - 30) and trunc(sysdate - 1)  "
            + "				then '30gg' " + " when conta_upd_ud_ko.dt_rif_conta = trunc(sysdate) "
            + "         then 'oggi' " + "				else 'before30gg' " + "		 end ";
    ...
    String MON_CNT_UPD_UD_COR_BY_AMB = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "where upd.TI_STATO_UPD_ELENCO_VERS is not null " + "group by abil_key_ud.id_ambiente, 'TOTALE' "
            + "UNION " + "select " + " abil_key_ud.id_ambiente, "
    ...
    String MON_CNT_UPD_UD_COR_BY_ENTE = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "	and upd.aa_key_unita_doc = abil_key_ud.aa_key_unita_doc "
            + "	and trunc(upd.ts_ini_ses) = abil_key_ud.dt_last_upd_ud) "
            + "where upd.TI_STATO_UPD_ELENCO_VERS is not null " + "group by abil_key_ud.id_ente, 'TOTALE' " + "UNION "
            + "select " + " abil_key_ud.id_ente, " + " upd_da_elab.ti_stato_upd_elenco_vers ti_stato_upd_ud, "
            + " count(*) ni_upd_ud " + "from tmp_abil_key_ud abil_key_ud "
            + "join ELV_UPD_UD_DA_ELAB_ELENCO upd_da_elab " + "	on (upd_da_elab.id_strut = abil_key_ud.id_strut "
            + "	and upd_da_elab.id_tipo_unita_doc = abil_key_ud.id_tipo_unita_doc "
            + "	and upd_da_elab.id_registro_unita_doc = abil_key_ud.id_registro_unita_doc "
            + "	and upd_da_elab.id_tipo_doc_princ = abil_key_ud.id_tipo_doc_princ "
            + "	and upd_da_elab.aa_key_unita_doc = abil_key_ud.aa_key_unita_doc "
    ...
    String MON_CNT_UPD_UD_COR_BY_STRUT = "with tmp_abil_key_ud as " + "	(select " + "	  id_key_total_ud, "
            ...
            + "		 abil_key_ud.aa_key_unita_doc,	" + "		 abil_key_ud.id_tipo_unita_doc,	"
            + "		 abil_key_ud.id_registro_unita_doc, " + "		 abil_key_ud.id_tipo_doc_princ,		"
            + "		'TOTALE' " + "UNION " + "select " + " abil_key_ud.id_strut, "
            + " abil_key_ud.aa_key_unita_doc,		" + " abil_key_ud.id_tipo_unita_doc,		"
            + " abil_key_ud.id_registro_unita_doc,	" + " abil_key_ud.id_tipo_doc_princ,		"
            + " upd_da_elab.ti_stato_upd_elenco_vers ti_stato_upd_ud, " + " count(*) ni_upd_ud "
            + "from tmp_abil_key_ud abil_key_ud " + "join ELV_UPD_UD_DA_ELAB_ELENCO upd_da_elab "
            ...
            + "	and upd_da_elab.id_tipo_doc_princ = abil_key_ud.id_tipo_doc_princ "
            + "	and upd_da_elab.aa_key_unita_doc = abil_key_ud.aa_key_unita_doc "
            + "	and trunc(upd_da_elab.dt_creazione) = abil_key_ud.dt_last_upd_ud) " + "group by abil_key_ud.id_strut,  "
            + "		 abil_key_ud.aa_key_unita_doc,	" + "		 abil_key_ud.id_tipo_unita_doc,	"
            + "		 abil_key_ud.id_registro_unita_doc, " + "		 abil_key_ud.id_tipo_doc_princ,		"
    ...
    String MON_CHK_UD_UPD_KO_BY_AMB = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + "	   on (upd_ud_ko.id_upd_unita_doc_ko = ses_ko.id_upd_unita_doc_ko) " + "    ) " + " " + "select "
            + " usr.id_user_iam id_user_iam_cor, " + " amb.id_ambiente, " + " " + " " + "case "
            + "	when exists (select *  " + "				from tmp_ses_upd_unita_ko ses_ko "
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_RISOLUBILE' " + "				) "
            + "			then '1' " + "			else '0' " + "end fl_ud_upd_ko_norisolub, " + " " + " " + "case "
            + "	when exists (select *  " + "				from tmp_ses_upd_unita_ko ses_ko "
            + "				where ses_ko.ti_stato_ses_upd_ko = 'VERIFICATO' " + "				) "
            + "			then '1' " + "			else '0' " + "end fl_ud_upd_ko_verif, " + " " + " " + "case "
            + "	when exists (select *  " + "				from tmp_ses_upd_unita_ko ses_ko "
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_VERIFICATO' " + "				) "
    ...
    String MON_CHK_UD_UPD_KO_BY_ENTE = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + "     join VRS_UPD_UNITA_DOC_KO upd_ud_ko "
            + "	   on (upd_ud_ko.id_upd_unita_doc_ko = ses_ko.id_upd_unita_doc_ko) " + "    ) " + "	 " + "select "
            + " usr.id_user_iam id_user_iam_cor, " + " ente.id_ente, " + " " + " " + "case "
            + "	when exists (select *  " + "				from tmp_ses_upd_unita_ko ses_ko "
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_RISOLUBILE' " + "				) "
            + "			then '1' " + "			else '0' " + "end fl_ud_upd_ko_norisolub, " + " " + " " + "case "
            + "	when exists (select *  " + "				from tmp_ses_upd_unita_ko ses_ko "
    ...
    String MON_CNT_UD_UPD_KO_BY_AMB = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + "select  " + " upd_ko.id_ambiente, " + " upd_ko.ti_stato_ses_upd_ko, " + " count(*) ni_upd_ud_ko " + "  "
            + "from  tmp_upd_unita_doc_ko upd_ko   " + " " + " group by upd_ko.id_ambiente, upd_ko.ti_stato_ses_upd_ko";
    ...
    String MON_CNT_UD_UPD_KO_BY_ENTE = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + "      from tmp_abil_key_ud_ko abil_key_ud_ko " + "      join VRS_SES_UPD_UNITA_DOC_KO ses_ko "
            ...
            + "      join VRS_UPD_UNITA_DOC_KO upd_ud_ko "
            + "        on (upd_ud_ko.id_upd_unita_doc_ko = ses_ko.id_upd_unita_doc_ko) " + "    ) " + " " + "select  "
            + " upd_ko.id_ente, " + " upd_ko.ti_stato_ses_upd_ko, " + " count(*) ni_upd_ud_ko " + "  "
            + "from  tmp_upd_unita_doc_ko upd_ko   " + " " + " group by upd_ko.id_ente, upd_ko.ti_stato_ses_upd_ko";
    ...
    String MON_CNT_UD_UPD_KO_BY_STRUT = "with tmp_abil_key_ud_ko as " + "	(select " + "	  id_key_total_ud_ko, "
            ...
            + " abil_key_ud_ko.id_strut, " + "   " + " abil_key_ud_ko.aa_key_unita_doc, "
            + " abil_key_ud_ko.id_tipo_unita_doc, " + " abil_key_ud_ko.id_registro_unita_doc, "
            + " abil_key_ud_ko.id_tipo_doc_princ, " + "  " + " abil_key_ud_ko.ti_stato_ses_upd_ko, "
            + " count(*) ni_upd_ud_ko " + "  " + "from tmp_upd_unita_doc_ko abil_key_ud_ko " + "	 "
            + "group by abil_key_ud_ko.id_strut,  " + " " + "		 abil_key_ud_ko.aa_key_unita_doc, "
            + "		 abil_key_ud_ko.id_tipo_unita_doc, " + "		 abil_key_ud_ko.id_registro_unita_doc, "
            + "		 abil_key_ud_ko.id_tipo_doc_princ, " + "		  " + "		 abil_key_ud_ko.ti_stato_ses_upd_ko";
    // end MEV#22438
    ...
    public Map<String, Object> getTotali(String tipoEntita, BigDecimal idUser, BigDecimal idAmbiente, BigDecimal idEnte,
        ...
        if (tipoEntita.equals("AMBIENTE")) {
            ...
            checkCorResult = getMonVStrut(MON_CHK_UPD_UD_COR_BY_STRUT, idUser, idStrut, anniList, idTipoUnitaDoc,
                    idRegistroUnitaDoc, idTipoDocPrinc);
            // totCorResult = getMonVStrut(MON_CNT_UPD_UD_COR_BY_STRUT, idUser, idStrut, anniList, idTipoUnitaDoc,
            // idRegistroUnitaDoc, idTipoDocPrinc);
            totNoCorResult = getMonVStrut(MON_CNT_UPD_UD_NOCOR_BY_STRUT, idUser, idStrut, anniList, idTipoUnitaDoc,
                    idRegistroUnitaDoc, idTipoDocPrinc);
            checkCorKoResult = getMonVStrutKo(MON_CHK_UPD_UD_KO_COR_BY_STRUT, idUser, idStrut, anniList, idTipoUnitaDoc,
                    idRegistroUnitaDoc, idTipoDocPrinc);
            totCorKoResult = getMonVStrutKo(MON_CNT_UPD_UD_KO_COR_BY_STRUT, idUser, idStrut, anniList, idTipoUnitaDoc,
                    idRegistroUnitaDoc, idTipoDocPrinc);
            totNoCorKoResult = getMonVStrutKo(MON_CNT_UPD_UD_KO_NOCOR_BY_STRUT, idUser, idStrut, anniList,
                    idTipoUnitaDoc, idRegistroUnitaDoc, idTipoDocPrinc);
            // MEV#22438
            checkUdUpdKoResult = getMonVStrutKo(MON_CHK_UD_UPD_KO_BY_STRUT, idUser, idStrut, anniList, idTipoUnitaDoc,
                    idRegistroUnitaDoc, idTipoDocPrinc);
            totUdUpdKoResult = getMonVStrutKo(MON_CNT_UD_UPD_KO_BY_STRUT, idUser, idStrut, anniList, idTipoUnitaDoc,
                    idRegistroUnitaDoc, idTipoDocPrinc);
            // end MEV#22438
        }
    ...
    public Map<String, Object> getTotaliDataCorrente(String tipoEntita, BigDecimal idUser, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStrut, BigDecimal aaKeyUnitaDoc, BigDecimal aaKeyUnitaDocDa,
            BigDecimal aaKeyUnitaDocA, BigDecimal idTipoUnitaDoc, BigDecimal idRegistroUnitaDoc,
            BigDecimal idTipoDocPrinc) {
        Map<String, Object> risultati = new HashMap<>();
        List<Object[]> totCorResult = null;
        if (tipoEntita.equals("AMBIENTE")) {
            totCorResult = getMonV(MON_CNT_UPD_UD_COR_BY_AMB, idUser, idAmbiente);
    ...
    public Map<String, Object> getTotaliFalliti(String tipoEntita, BigDecimal idUser, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStrut, BigDecimal aaKeyUnitaDoc, BigDecimal aaKeyUnitaDocDa,
            BigDecimal aaKeyUnitaDocA, BigDecimal idTipoUnitaDoc, BigDecimal idRegistroUnitaDoc,
            BigDecimal idTipoDocPrinc) {
        Map<String, Object> risultati = new HashMap<>();
    ...
    // MEV#22438
    public Map<String, Object> getTotaliUdUpdFalliti(String tipoEntita, BigDecimal idUser, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStrut, BigDecimal aaKeyUnitaDoc, BigDecimal aaKeyUnitaDocDa,
            BigDecimal aaKeyUnitaDocA, BigDecimal idTipoUnitaDoc, BigDecimal idRegistroUnitaDoc,
            BigDecimal idTipoDocPrinc) {
        Map<String, Object> risultati = new HashMap<>();
    ...
    public List<Object[]> getMonVStrut(String viewName, BigDecimal param1, BigDecimal param2, List<Integer> param3,
    ...
    // MEV#22438
    public List<Object[]> getMonVStrutKo(String viewName, BigDecimal param1, BigDecimal param2, List<Integer> param3,
            BigDecimal param4, BigDecimal param5, BigDecimal param6) {
        String queryStr = viewName;
        if (param3 == null) {
            queryStr = StringUtils.replace(queryStr, "and aa_key_unita_doc BETWEEN :sette AND :otto", " ");
    ...
    public List<MonVLisUpdUdInterface> retrieveVLisAggMeta(BigDecimal idUser, BigDecimal idAmbiente, BigDecimal idEnte,
        ...
        try {
            ...
            Root entity = null;
            if ((statoIndiceAip.size() == 1
                    && (statoIndiceAip.contains("IN_ATTESA_SCHED") || statoIndiceAip.contains("NON_SELEZ_SCHED")))
            ...
            if (rangeNumeroA != null && !rangeNumeroA.equals("")) {
                condizioni.add(cb.between(entity.get("cdKeyUnitaDoc"), rangeNumeroDa, rangeNumeroA));
    ...
    public List<MonVLisUpdUdKoInterface> retrieveVLisAggMetaFalliti(BigDecimal idUser, BigDecimal idAmbiente,
    ...
    public List<MonVLisUpdUdErr> retrieveVLisAggMetaErrati(Date[] dateValidate, Set<String> tiStatoSes,
    ...
    // MEV#22438
    public List<MonVLisUdUpdKoInterface> retrieveVLisUnitaDocAggMetaFalliti(BigDecimal idUser, BigDecimal idAmbiente,
            BigDecimal idEnte, BigDecimal idStrut, BigDecimal idTipoUnitaDoc, BigDecimal idRegistroUnitaDoc,
            BigDecimal idTipoDoc, Date[] dateValidate, BigDecimal rangeAnnoDa, BigDecimal rangeAnnoA,
            String rangeNumeroDa, String rangeNumeroA, Set<String> statoSessione, BigDecimal idClasseErr,
            BigDecimal idErr) {
        ...
        try {
            ...
            cq.multiselect(entity.get("idUserIamCor"), entity.get("idAmbiente"), entity.get("nmAmbiente"),
                    entity.get("idEnte"), entity.get("nmEnte"), entity.get("idStrut"), entity.get("nmStrut"),
                    entity.get("idTipoUnitaDocLast"), entity.get("nmTipoUnitaDocLast"),
                    entity.get("cdRegistroKeyUnitaDoc"), entity.get("idTipoDocPrincLast"),
                    entity.get("nmTipoDocPrincLast"), entity.get("aaKeyUnitaDoc"), entity.get("cdKeyUnitaDoc"),
                    entity.get("tiStatoUpdUdKo"), entity.get("tsIniLastSes"), entity.get("idSesUpdUdKoLast"),
                    entity.get("idUpdUnitaDocKo"), entity.get("dsTsIniLastSes"), entity.get("dsEnteStrut"),
                    entity.get("dsUnitaDoc"), entity.get("dsErrPrincLast"), entity.get("cdErrPrincLast"),
                    entity.get("cdControlloWsPrincLast"));
            cq.distinct(true);
            List<Predicate> condizioni = new ArrayList<Predicate>();
            condizioni.add(cb.equal(entity.get("idUserIamCor"), idUser));
            condizioni.add(cb.equal(entity.get("idAmbiente"), idAmbiente));
    ...
    public MonContaSesUpdUdKo retrieveMonContaSesUpdUdKo(Date dtRifConta, long idStrut, BigDecimal aaKeyUnitaDoc,
            long idRegistroUnitaDoc, long idTipoUnitaDoc, long idTipoDoc, String tiStatoUpdUdKo) {
    ...
    public List<Object[]> getAggMetaPerCalcoloContenuto3(long idStrut, Date data) {
        String queryStr = "select " + " key_tot.id_key_total_ud, " + " tmp.ti_stato_upd_ud, " + " tmp.dt_upd_ud, "
                + " tmp.ni_ses_upd_ud " + "from " + "(select " + "	 upd.id_strut, " + "	 ud.id_sub_strut, "
                + "	 upd.id_tipo_unita_doc, " + "	 upd.id_registro_unita_doc, " + "	 upd.id_tipo_doc_princ, "
    ...
    public List<Object[]> getSesAggMetaPerCalcoloContenuto3(long idStrut, Date data) {
        String queryStr = "select  " + " key_tot_ko.id_key_total_ud_ko, " + " tmp.ti_stato_udp_ud_ko, "
                + " tmp.dt_upd_ud_ko, " + " tmp.ni_ses_upd_ud_ko, " + " tmp.id_strut, " + " tmp.id_tipo_unita_doc, "
                + " tmp.id_registro_unita_doc, " + " tmp.id_tipo_doc_princ, " + " tmp.aa_key_unita_doc " + "from "
                + "	(select " + "	 upd_ko.id_strut, " + "	 upd_ko.id_tipo_unita_doc, "
