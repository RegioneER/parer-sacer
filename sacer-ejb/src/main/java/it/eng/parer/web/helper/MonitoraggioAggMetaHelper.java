...
public class MonitoraggioAggMetaHelper extends GenericHelper {
    ...
    String MON_CHK_UPD_UD_COR_BY_AMB = "with tmp_abil_key_ud as " + "	(select "
            ...
            + "	tmp_upd_ud_da_elab_elenco as " + "	(select upd_da_elab.ti_stato_upd_elenco_vers  "
            ...
            + "	when exists (select *  " + "				from tmp_abil_key_ud abil_key_ud "
            ...
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_attesa_sched_cor, " + "case " + "	when exists (select *  "
            + "				from tmp_upd_ud_da_elab_elenco upd_da_elab "
            + "				where upd_da_elab.ti_stato_upd_elenco_vers = 'NON_SELEZ_SCHED' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_nosel_sched_cor " + "from ORG_AMBIENTE amb " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + "where amb.id_ambiente = :due "
    ...
    String MON_CHK_UPD_UD_COR_BY_ENTE = "with tmp_abil_key_ud as " + "	(select "
            ...
            + "				where upd_da_elab.ti_stato_upd_elenco_vers = 'NON_SELEZ_SCHED' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_nosel_sched_cor " + "from ORG_ENTE ente " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + "where ente.id_ente = :due "
            + "and usr.id_user_iam = :uno ";
    ...
    String MON_CHK_UPD_UD_COR_BY_STRUT = "with tmp_abil_key_ud as " + "	(select "
            ...
            + "			then '1' " + "			else '0' " + "end fl_upd_cor, " + "case "
            + "	when exists (select *  "
            + "				from tmp_upd_ud_da_elab_elenco upd_da_elab "
            + "				where upd_da_elab.ti_stato_upd_elenco_vers = 'IN_ATTESA_SCHED' "
            + "				) " + "			then '1' " + "			else '0' "
            ...
            + "				where upd_da_elab.ti_stato_upd_elenco_vers = 'NON_SELEZ_SCHED' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_nosel_sched_cor " + "from ORG_STRUT strut " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + "where strut.id_strut = :due "
            + "and usr.id_user_iam = :uno ";
    ...
    String MON_CNT_UPD_UD_NOCOR_BY_AMB = "with tmp_abil_key_ud as " + "	(select "
            ...
            + "	 from MON_V_ABIL_KEY_TOTAL_UD " + "	 where id_ambiente = :due "
            + "	 and id_user_iam_cor = :uno " + "	) " + "select " + " abil_key_ud.id_ambiente, "
            ...
            + "         then 'oggi' " + "		else 'before30gg' " + " end ti_dt_creazione, "
            + " sum (conta_upd_ud.ni_ses_upd_ud) ni_upd_ud " + "from tmp_abil_key_ud abil_key_ud "
    ...
    String MON_CNT_UPD_UD_NOCOR_BY_STRUT = "with tmp_abil_key_ud as " + "	(select "
            ...
            + "		 abil_key_ud.id_tipo_doc_princ,	" + "		 conta_upd_ud.ti_stato_udp_ud, "
            + "		 case "
            + "			when conta_upd_ud.dt_rif_conta between trunc (sysdate - 30) and trunc(sysdate - 1)  "
            + "				then '30gg' " + " when conta_upd_ud.dt_rif_conta = trunc(sysdate) "
            + "         then 'oggi' " + "				else 'before30gg' " + "		 end ";
    ...
    String MON_CHK_UPD_UD_KO_COR_BY_AMB = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_ko_norisolub_cor, " + "case " + "	when exists (select *  "
            ...
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_ko_noverif_cor " + "from ORG_AMBIENTE amb " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + "where amb.id_ambiente = :due "
            + "and usr.id_user_iam = :uno ";
    ...
    String MON_CHK_UPD_UD_KO_COR_BY_ENTE = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_VERIFICATO' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_ko_noverif_cor " + "from ORG_ENTE ente " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + "where ente.id_ente = :due "
            + "and usr.id_user_iam = :uno ";
    ...
    String MON_CHK_UPD_UD_KO_COR_BY_STRUT = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_VERIFICATO' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_upd_ko_noverif_cor " + "from ORG_STRUT strut " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + "where strut.id_strut = :due "
            + "and usr.id_user_iam = :uno ";
    ...
    String MON_CNT_UPD_UD_KO_NOCOR_BY_AMB = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "         then 'oggi' " + "		else 'before30gg' " + " end ti_dt_creazione, "
            + " sum (conta_upd_ud_ko.ni_ses_upd_ud_ko) ni_upd_ud_ko "
            + "from tmp_abil_key_ud_ko abil_key_ud_ko "
    ...
    String MON_CNT_UPD_UD_KO_NOCOR_BY_ENTE = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "	 and id_user_iam_cor = :uno " + "	) " + "select " + " abil_key_ud_ko.id_ente, "
    ...
    String MON_CNT_UPD_UD_COR_BY_STRUT = "with tmp_abil_key_ud as " + "	(select "
            ...
            + "		 abil_key_ud.aa_key_unita_doc,	" + "		 abil_key_ud.id_tipo_unita_doc,	"
            + "		 abil_key_ud.id_registro_unita_doc, "
            + "		 abil_key_ud.id_tipo_doc_princ,		" + "		'TOTALE' " + "UNION "
            + "select " + " abil_key_ud.id_strut, " + " abil_key_ud.aa_key_unita_doc,		"
            + " abil_key_ud.id_tipo_unita_doc,		" + " abil_key_ud.id_registro_unita_doc,	"
    ...
    String MON_CNT_UPD_UD_KO_COR_BY_STRUT = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + " abil_key_ud_ko.aa_key_unita_doc, " + " abil_key_ud_ko.id_tipo_unita_doc, "
            + " abil_key_ud_ko.id_registro_unita_doc, " + " abil_key_ud_ko.id_tipo_doc_princ,	"
            + " ses_ko.ti_stato_ses_upd_ko, " + " count(*) ni_upd_ud_ko "
    ...
    String MON_CHK_UD_UPD_KO_BY_AMB = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_RISOLUBILE' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_ud_upd_ko_norisolub, " + " " + " " + "case " + "	when exists (select *  "
            + "				from tmp_ses_upd_unita_ko ses_ko "
            + "				where ses_ko.ti_stato_ses_upd_ko = 'VERIFICATO' " + "				) "
            + "			then '1' " + "			else '0' " + "end fl_ud_upd_ko_verif, " + " " + " "
            + "case " + "	when exists (select *  "
            + "				from tmp_ses_upd_unita_ko ses_ko "
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_VERIFICATO' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_ud_upd_ko_noverif " + " " + "from ORG_AMBIENTE amb " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + " " + "where amb.id_ambiente = :due "
            + "and usr.id_user_iam = :uno ";
    ...
    String MON_CHK_UD_UPD_KO_BY_ENTE = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_VERIFICATO' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_ud_upd_ko_noverif " + " " + "from ORG_ENTE ente " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + " " + "where ente.id_ente = :due "
            + "and usr.id_user_iam = :uno ";
    ...
    String MON_CHK_UD_UPD_KO_BY_STRUT = "with tmp_abil_key_ud_ko as " + "	(select "
            ...
            + "				where ses_ko.ti_stato_ses_upd_ko = 'NON_VERIFICATO' "
            + "				) " + "			then '1' " + "			else '0' "
            + "end fl_ud_upd_ko_noverif " + " " + "from ORG_STRUT strut " + "join IAM_USER usr "
            + "	on (usr.id_user_iam > 0) " + " " + "where strut.id_strut = :due "
            + "and usr.id_user_iam = :uno";
     ...
     * "	 ud.id_sub_strut, " + "	 upd.id_tipo_unita_doc, " + "	 upd.id_registro_unita_doc, " +
     * "	 upd.id_tipo_doc_princ, " + "	 upd.aa_key_unita_doc, " +
     ...
     * "	 ud.id_sub_strut, " + "	 upd.id_tipo_unita_doc, " + "	 upd.id_registro_unita_doc, " +
     * "	 upd.id_tipo_doc_princ, " + "	 upd.aa_key_unita_doc, " +
     * "	 'TOTALE' ti_stato_upd_ud, " + "	 trunc(upd.ts_ini_ses) dt_upd_ud, " +
     * "	 count(*) ni_ses_upd_ud " + "	from ARO_UPD_UNITA_DOC upd " +
    ...
    public List<Object[]> getAggMetaPerCalcoloContenuto3(long idStrut, Date data) {
        String queryStr = "select " + " key_tot.id_key_total_ud, " + " tmp.ti_stato_upd_ud, "
                ...
                + "	 upd.id_tipo_unita_doc, " + "	 upd.id_registro_unita_doc, "
                + "	 upd.id_tipo_doc_princ, " + "	 upd.aa_key_unita_doc, "
                + "	 'TOTALE' ti_stato_upd_ud, " + "	 trunc(upd.ts_ini_ses) dt_upd_ud, "
                + "	 count(*) ni_ses_upd_ud " + "	from ARO_UPD_UNITA_DOC upd "
                + "	join ARO_UNITA_DOC ud " + "		on (ud.id_unita_doc = upd.id_unita_doc "
