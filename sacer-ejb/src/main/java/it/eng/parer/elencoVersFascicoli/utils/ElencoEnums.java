...
public class ElencoEnums {
    ...
    public enum OpTypeEnum {
        ...
        AGGIUNGI_DOC_ELENCO, ELIMINA_ELENCO, RIMUOVI_UD_ELENCO, RIMUOVI_DOC_ELENCO, MOD_ELENCO,
        VALIDAZIONE_ELENCO, ERRORE, REVOCA_CA, CREAZIONE_INDICI_ELENCHI_VERS_FASC,
        CREA_INDICE_ELENCO, VERIFICA_FIRME_A_DATA_VERS, INIZIO_CREA_INDICE, INIZIO_VERIF_FIRME,
        ...
        DEF_NOTE_INDICE_ELENCO, DEF_NOTE_ELENCO_CHIUSO, START_CREA_ELENCO_INDICI_AIP_FASC,
        END_CREA_ELENCO_INDICI_AIP_FASC, ELENCO_INDICI_AIP, FIRMA_ELENCO_INDICI_AIP,
        FIRMA_ELENCO_INDICI_AIP_IN_CORSO, FIRMA_ELENCO_INDICI_AIP_FALLITA, FIRMA_IN_CORSO,
    ...
    public enum MotivazioneChiusura {
        ...
        // FASC_SURPLUS("L'aggiunta all'elenco di una ulteriore fascicolo supererebbe il numero
        // massimo di fascicoli"),
        ELENCO_EXPIRED("Elenco di versamento fascicoli scaduto"),
        MANUAL_CLOSING("Chiusura manuale");
