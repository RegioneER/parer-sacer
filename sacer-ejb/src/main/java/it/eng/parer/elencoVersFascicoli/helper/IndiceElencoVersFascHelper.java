...
public class IndiceElencoVersFascHelper {
    ...
    public ElvVCreaIxElencoFasc retrieveElvVCreaIxElencoFasc(ElvElencoVersFasc elenco) {
        String SELECT_CREA_IX_ELENCO_FASC_STM = "SELECT creaIxElencoFasc "
                + "FROM ElvVCreaIxElencoFasc creaIxElencoFasc "
                + "WHERE creaIxElencoFasc.idElencoVersFasc = :idElencoVersFasc";
        Query q = em.createQuery(SELECT_CREA_IX_ELENCO_FASC_STM);
        q.setParameter("idElencoVersFasc", elenco.getIdElencoVersFasc());
        ElvVCreaIxElencoFasc elvVCreaIxElencoFasc = (ElvVCreaIxElencoFasc) q.getSingleResult();
        return elvVCreaIxElencoFasc;
    }

    public ElvVCreaLisFascElenco retrieveElvVCreaLisFascElenco(FasFascicolo ff) {
        String SELECT_CREA_LIS_FASC_ELENCO_STM = "SELECT creaLisFascElenco "
                + "FROM ElvVCreaLisFascElenco creaLisFascElenco "
                + "WHERE creaLisFascElenco.idFascicolo = :idFascicolo " + "ORDER BY creaLisFascElenco.tsIniSes";
        Query q = em.createQuery(SELECT_CREA_LIS_FASC_ELENCO_STM);
        q.setParameter("idFascicolo", ff.getIdFascicolo());
        ElvVCreaLisFascElenco elvVCreaLisFascElenco = (ElvVCreaLisFascElenco) q.getSingleResult();
        return elvVCreaLisFascElenco;
    }
    ...
    public Map retrieveDateVersamento(ElvElencoVer elenco) {
        ...
        Map dateVersamento = new HashMap();
