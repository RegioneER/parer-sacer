...
public class IndiceElencoVersFascHelper {
    ...
    public List<VolVCntUdDocCompTipoUd> getContenutoSinteticoElenco(VolVolumeConserv volume) {
        String selectContenutoSinteticoElencoStm = "SELECT contSint " + "FROM VolVCntUdDocCompTipoUd contSint "
    ...
    public String getTipologieDocumentoPrincipaleElv(ElvElencoVer elenco) {
        String selectTipologieDocPrincElvStm = "SELECT distinct tipoDoc.nmTipoDoc " + "FROM ElvElencoVer elenco "
    ...
    public String getTipologieUnitaDocumentaria(ElvElencoVer elenco) {
        String selectTipologieUdStm = "SELECT distinct tipoUnitaDoc.nmTipoUnitaDoc " + "FROM ElvElencoVer elenco "
    ...
    public String getTipologieRegistro(ElvElencoVer elenco) {
        String selectTipologieRegistroStm = "SELECT distinct uds.cdRegistroKeyUnitaDoc " + "FROM ElvElencoVer elenco "
                + "JOIN elenco.aroUnitaDocs uds " + "WHERE elenco = :elenco";
    ...
    public ElvVCreaIxElencoFasc retrieveElvVCreaIxElencoFasc(ElvElencoVersFasc elenco) {
        String selectCreaIxElencoFascStm = "SELECT creaIxElencoFasc " + "FROM ElvVCreaIxElencoFasc creaIxElencoFasc "
    ...
    public ElvVCreaLisFascElenco retrieveElvVCreaLisFascElenco(FasFascicolo ff) {
        String selectCreaLisFascElencoStm = "SELECT creaLisFascElenco "
                ...
                + "WHERE creaLisFascElenco.id.idFascicolo = :idFascicolo " + "ORDER BY creaLisFascElenco.tsIniSes";
    ...
    public Object retrieveDateVersamentoUdVersate(ElvElencoVer elenco) {
        String selectStm = "SELECT MIN(ud.dtCreazione), MAX(ud.dtCreazione) " + "FROM AroUnitaDoc ud "
