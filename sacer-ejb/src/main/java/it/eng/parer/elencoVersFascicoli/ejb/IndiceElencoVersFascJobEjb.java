...
public class IndiceElencoVersFascJobEjb {
    ...
    // public void buildIndexFile(ElvElencoVersFasc elenco, String nomeStruttura, String
    // nomeStrutturaNorm,
    ...
    // // creo il file .xml
    // log.info(
    // "Indice Elenco Versamento Fascicoli - creazione indice per elenco id '{}' appartenente alla
    // struttura '{}'",
    ...
    // String hashXmlIndice = new HashCalculator().calculateHashSHAX(indexFile,
    // TipiHash.SHA_256).toHexBinary();
    ...
    // dell'elenco e
    // // l'urn dell’indice “urn:<sistemaconservazione>:<ente>:<struttura>:ElencoVers-FA-<id
    // elenco>:Indice”
    // elencoHelper.storeFileIntoElenco(elenco, indexFile,
    // ElencoEnums.FileTypeEnum.INDICE_ELENCO.name(), new Date(),
    // hashXmlIndice, TipiHash.SHA_256.descrivi(), TipiEncBinari.HEX_BINARY.descrivi(),
    // urnXmlIndice,
