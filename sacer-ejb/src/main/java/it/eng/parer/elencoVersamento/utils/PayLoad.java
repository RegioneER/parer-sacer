...
public class PayLoad implements Serializable {
    ...
    // Constructor UD, DOC
    public PayLoad(long id, BigDecimal idStrut, String tipoEntitaSacer, String stato, BigDecimal aaKeyUnitaDoc,
            Date dtCreazione) {
        this.id = id;
    ...
    // Constructor UPD
    public PayLoad(long id, long idStrut, String tipoEntitaSacer, ElvUpdUdDaElabTiStatoUpdElencoVers stato,
