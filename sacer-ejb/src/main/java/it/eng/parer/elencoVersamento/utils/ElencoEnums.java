...
public class ElencoEnums {
    ...
    public enum OpTypeEnum {
        ...
        AGGIUNGI_DOC_ELENCO, ELIMINA_ELENCO, RIMUOVI_UD_ELENCO, RIMUOVI_DOC_ELENCO, RIMUOVI_UPD_UD_ELENCO, MOD_ELENCO,
        VALIDAZIONE_ELENCO, ERRORE, REVOCA_CA, CREAZIONE_INDICI_ELENCHI_VERS, CREA_INDICE_ELENCO,
        VERIFICA_FIRME_A_DATA_VERS, PRODUCER_CODA_INDICI_AIP_DA_ELAB, INIZIO_CREA_INDICE, INIZIO_VERIF_FIRME,
        ERR_VERIF_FIRME, SET_ELENCO_DA_CHIUDERE, RECUPERA_ELENCO_APERTO, RECUPERA_ELENCO_SCADUTO,
        RECUPERA_ELENCO_IN_ERRORE, SET_ELENCO_IN_ERRORE, SET_ELENCO_APERTO, VERIFICA_VERS_FALLITI,
        DEF_NOTE_INDICE_ELENCO, DEF_NOTE_ELENCO_CHIUSO, START_CREA_ELENCO_INDICI_AIP, END_CREA_ELENCO_INDICI_AIP,
        FIRMA_ELENCO_INDICI_AIP, FIRMA_ELENCO_INDICI_AIP_IN_CORSO, FIRMA_ELENCO_INDICI_AIP_FALLITA, FIRMA_IN_CORSO,
        FIRMA_IN_CORSO_FALLITA, MARCA_ELENCO_INDICI_AIP_FALLITA, MARCA_ELENCO_INDICI_AIP
    }
    ...
    public enum ElencoStatusEnum {
        ...
        COMPLETATO, APERTO, CHIUSO, DA_CHIUDERE, VALIDATO, ELENCO_INDICI_AIP_CREATO, ELENCO_INDICI_AIP_ERR_MARCA,
        ELENCO_INDICI_AIP_FIRMA_IN_CORSO, ELENCO_INDICI_AIP_FIRMATO, FIRMA_IN_CORSO, FIRME_VERIFICATE_DT_VERS,
        INDICI_AIP_GENERATI, IN_CODA_INDICE_AIP, IN_CODA_JMS_VERIFICA_FIRME_DT_VERS, IN_CODA_JMS_GENERA_INDICE_AIP,
        // MAC#16424
        ...
        public static ElencoStatusEnum[] getComboMappaStatoElencoRicerca() {
            return getEnums(APERTO, DA_CHIUDERE, CHIUSO, VALIDATO, FIRMA_IN_CORSO, FIRME_VERIFICATE_DT_VERS,
                    IN_CODA_JMS_INDICE_AIP_DA_ELAB, IN_CODA_INDICE_AIP, INDICI_AIP_GENERATI, ELENCO_INDICI_AIP_CREATO,
                    ELENCO_INDICI_AIP_FIRMA_IN_CORSO, ELENCO_INDICI_AIP_FIRMATO, ELENCO_INDICI_AIP_ERR_MARCA,
    ...
    public enum DocStatusEnum {
        /*
         * ATTENZIONE: lo stato IN_ELENCO_IN_ERRORE non esiste nella lista dei vincoli sulla tabella select * from
         * all_constraints where owner = 'SACER' and constraint_type ='C' and table_name = 'ARO_DOC' and constraint_name
         * = 'TI_STATO_DOC_ELENCO_VERS';
         */
        IN_ELENCO_IN_ERRORE, IN_ATTESA_MEMORIZZAZIONE, IN_ATTESA_SCHED, IN_ELENCO_APERTO, IN_ELENCO_CHIUSO,
        IN_ELENCO_COMPLETATO, IN_ELENCO_CON_ELENCO_INDICI_AIP_CREATO, IN_ELENCO_CON_ELENCO_INDICI_AIP_ERR_MARCA,
        IN_ELENCO_CON_ELENCO_INDICI_AIP_FIRMATO, IN_ELENCO_CON_FIRME_VERIFICATE_DT_VERS,
        IN_ELENCO_CON_INDICI_AIP_GENERATI, IN_ELENCO_DA_CHIUDERE, IN_ELENCO_VALIDATO, IN_ELENCO_IN_CODA_INDICE_AIP,
        NON_SELEZ_SCHED, IN_CODA_JMS_VERIFICA_FIRME_DT_VERS, IN_CODA_JMS_INDICE_AIP_DA_ELAB;
        ...
        public static DocStatusEnum[] getFilterEnums() {
            return getEnums(IN_ELENCO_CHIUSO, IN_ELENCO_APERTO, IN_ATTESA_SCHED, IN_ELENCO_DA_CHIUDERE,
                    IN_ELENCO_VALIDATO, IN_ATTESA_MEMORIZZAZIONE, NON_SELEZ_SCHED,
                    IN_ELENCO_CON_FIRME_VERIFICATE_DT_VERS, IN_ELENCO_IN_CODA_INDICE_AIP);
        }
    }

    public enum UdDocStatusEnum {

        IN_ATTESA_MEMORIZZAZIONE, IN_ATTESA_SCHED, IN_ELENCO_APERTO, IN_ELENCO_VALIDATO, IN_ELENCO_CHIUSO,
        IN_ELENCO_COMPLETATO, IN_ELENCO_CON_ELENCO_INDICI_AIP_CREATO, IN_ELENCO_CON_ELENCO_INDICI_AIP_ERR_MARCA,
        IN_ELENCO_CON_ELENCO_INDICI_AIP_FIRMATO, IN_ELENCO_CON_FIRME_VERIFICATE_DT_VERS,
        IN_ELENCO_CON_INDICI_AIP_GENERATI, IN_ELENCO_DA_CHIUDERE, IN_ELENCO_IN_CODA_INDICE_AIP, NON_SELEZ_SCHED,
    ...
    public enum FileTypeEnum {
        INDICE(".xml"), FIRMA(".tsr.p7m"), INDICE_FIRMATO(".xml.p7m"), MARCA_INDICE(".tsr"), MARCA_FIRMA(".tsr"),
        ELENCO_INDICI_AIP(".xml"), FIRMA_ELENCO_INDICI_AIP(".xml.p7m"), MARCA_FIRMA_ELENCO_INDICI_AIP(".tsr");
        ...
        public static FileTypeEnum[] getElencoIndiciFileTypes() {
            return getEnums(ELENCO_INDICI_AIP, FIRMA_ELENCO_INDICI_AIP, MARCA_FIRMA_ELENCO_INDICI_AIP);
        }
    ...
    public enum MotivazioneChiusura {
        ...
        // UD_SURPLUS("L'aggiunta all'elenco di una ulteriore unità documentaria supererebbe il numero massimo di unità
        // documentarie"),
        // COMP_SURPLUS("L'aggiunta all'elenco di un ulteriore componente supererebbe il numero massimo di componenti"),
