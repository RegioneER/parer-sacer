...
public class VolumeEnums {
    ...
    public enum OpTypeEnum {
        ...
        INIZIO_SCHEDULAZIONE, FINE_SCHEDULAZIONE, CREAZIONE_VOLUMI, CHIUSURA_VOLUME,
        CHIUSURA_VOLUME_ERR, CREA_VOLUME, AGGIUNGI_DOC_VOLUME, ELIMINA_VOLUME, RIMUOVI_DOC_VOLUME,
        MODIFICA_VOLUME, FIRMA_NO_MARCA_VOLUME, FIRMA_VOLUME, ERRORE, SCARICO_CA, REVOCA_CA,
        SCARICO_CRL, CALCOLO_CONTENUTO_SACER, CREAZIONE_INDICI, CREA_INDICE_VOLUME,
        MARCA_INDICE_VOLUME, VERIFICA_FIRME, INIZIO_CREA_INDICE, INIZIO_VERIF_FIRME,
        ERR_VERIF_FIRME, SET_VOLUME_DA_CHIUDERE, RECUPERA_VOLUME_APERTO, RECUPERA_VOLUME_SCADUTO,
        RECUPERA_VOLUME_IN_ERRORE, SET_VOLUME_IN_ERRORE, SET_VOLUME_APERTO,
        ALLINEAMENTO_ORGANIZZAZIONI, CREAZIONE_INDICE_AIP, VERIFICA_MASSIVA_VERS_FALLITI,
        VERIFICA_VERS_FALLITI
    }

    public enum VolStatusEnum {

        IN_ERRORE, CHIUSO, APERTO, NON_SELEZ_SCHED, IN_ATTESA_SCHED, FIRMATO_NO_MARCA, FIRMATO,
        DA_CHIUDERE, DA_VERIFICARE;
        ...
        public static VolStatusEnum[] getComboMappaStatoVolRicerca() {
            return getEnums(APERTO, CHIUSO, IN_ERRORE, FIRMATO, FIRMATO_NO_MARCA, DA_VERIFICARE,
                    DA_CHIUDERE);
        }
    }
    ...
    public enum DocStatusEnum {
        ...
        IN_VOLUME_CHIUSO, IN_VOLUME_APERTO, IN_VOLUME_IN_ERRORE, IN_ATTESA_SCHED,
        IN_VOLUME_DA_CHIUDERE, IN_ATTESA_MEMORIZZAZIONE, NON_SELEZ_SCHED;
    ...
    public enum MotivazioneChiusura {
        ...
        COMP_SURPLUS(
                "L'aggiunta al volume di un ulteriore componente supererebbe il numero massimo di componenti"),
