...
public abstract class Signature {
    ...
    /**
     * Costante utilizzata come parametro per la sessione di firma degli elenchi di versamento
     * fascicoli nell'action
     */
    public static final String FUTURE_ATTR_ELENCHI_FASC = "ATTR_FUTURE_SIGNATURE_ELENCHI_FASC";

    /**
     * Costante utilizzata come parametro per la sessione di firma degli elenchi indici AIP
     * nell'action
     */
