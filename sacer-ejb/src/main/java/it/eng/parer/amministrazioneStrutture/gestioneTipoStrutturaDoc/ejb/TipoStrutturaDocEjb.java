...
public class TipoStrutturaDocEjb {
    ...
    public DecTipoStrutDocRowBean getDecTipoStrutDocRowBean(BigDecimal idTipoStrutDoc,
            BigDecimal idStrut) {
        DecTipoStrutDocRowBean tipoStrutDocRowBean = getDecTipoStrutDoc(idTipoStrutDoc, null,
                idStrut);
        return tipoStrutDocRowBean;
    }

    public DecTipoStrutDocRowBean getDecTipoStrutDocRowBean(String nmTipoStrutDoc,
            BigDecimal idStrut) {
        DecTipoStrutDocRowBean tipoStrutDocRowBean = getDecTipoStrutDoc(BigDecimal.ZERO,
                nmTipoStrutDoc, idStrut);
        return tipoStrutDocRowBean;
    }

    private DecTipoStrutDocRowBean getDecTipoStrutDoc(BigDecimal idTipoStrutDoc,
        ...
        if (tipoStrutDoc != null) {
            try {
                tipoStrutDocRowBean = (DecTipoStrutDocRowBean) Transform
                        .entity2RowBean(tipoStrutDoc);
            } catch (Exception e) {
    ...
    public DecTipoStrutDocTableBean getDecTipoStrutDocTableBean(BigDecimal idStrut,
        ...
        try {
            if (!list.isEmpty()) {
                for (DecTipoStrutDoc tipoStrut : list) {
                    ...
                    if (tipoStrut.getDtIstituz().before(new Date())
                            && tipoStrut.getDtSoppres().after(new Date())) {
    ...
    public DecTipoCompDocRowBean getDecTipoCompDocRowBean(String nmTipoCompDoc,
            BigDecimal idTipoStrutDoc) {
        DecTipoCompDocRowBean tipoCompDocRowBean = getDecTipoCompDoc(BigDecimal.ZERO, nmTipoCompDoc,
                idTipoStrutDoc);
        return tipoCompDocRowBean;
    }
    ...
    public DecTipoCompDocTableBean getDecTipoCompDocTableBean(BigDecimal idStrut, Date data,
        ...
        List<DecTipoCompDoc> tipoCompDocList = helper.getDecTipoCompDocList(idStrut.longValue(),
                data, idTipoStrutDoc.longValue());
        if (tipoCompDocList != null && !tipoCompDocList.isEmpty()) {
            try {
                tipoCompDocTableBean = (DecTipoCompDocTableBean) Transform
                        .entities2TableBean(tipoCompDocList);
            } catch (ClassNotFoundException | NoSuchMethodException | InstantiationException
                    | IllegalAccessException | IllegalArgumentException
                    | InvocationTargetException ex) {
                logger.error("Errore durante il recupero dei tipi componente"
    ...
    public DecTipoCompDocTableBean getDecTipoCompDocTableBean(BigDecimal idTipoStrutDoc,
            boolean isFilterValid) {
        ...
        try {
            if (!list.isEmpty()) {
                for (DecTipoCompDoc tipoComp : list) {
                    ...
                    DecTipoCompDocRowBean tipoCompDocRow = (DecTipoCompDocRowBean) Transform
                            .entity2RowBean(tipoComp);
                    if (tipoComp.getDtIstituz().before(new Date())
                            && tipoComp.getDtSoppres().after(new Date())) {
                        tipoCompDocRow.setObject("fl_attivo", "1");
                    } else {
                        tipoCompDocRow.setObject("fl_attivo", "0");
                    }
                    DecXsdDatiSpec lastXsd = datiSpecHelper.getLastDecXsdDatiSpecForTipoCompDoc(
                            idStrut, tipoComp.getIdTipoCompDoc());
                    if (lastXsd != null) {
    ...
    public DecTipoStrutUnitaDocTableBean getDecTipoStrutUnitaDocTableBean(BigDecimal idTipoUnitaDoc,
        ...
        List<DecTipoStrutUnitaDoc> list = helper.getDecTipoStrutUnitaDocList(idTipoUnitaDoc,
                isFilterValid);
    ...
    public void insertDecTipoStrutDoc(LogParam param, DecTipoStrutDocRowBean tipoStrutDocRowBean)
        ...
        DecTipoStrutDoc tipoStrutDoc = (DecTipoStrutDoc) Transform
                .rowBean2Entity(tipoStrutDocRowBean);
    ...
    public void updateDecTipoStrutDoc(LogParam param, BigDecimal idTipoStrutDoc,
        ...
        DecTipoStrutDoc dbTipoStrutDoc = helper.getDecTipoStrutDocByName(
                tipoStrutDocRowBean.getNmTipoStrutDoc(), tipoStrutDocRowBean.getIdStrut());

        if (dbTipoStrutDoc != null
                && dbTipoStrutDoc.getIdTipoStrutDoc() != idTipoStrutDoc.longValue()) {
        ...
        // Potrebbe essere necessario modificarlo questo punto perché chiamato da qualche altra
        // parte che potrebbe
        // incartarsi!!
        sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                param.getNomeUtente(), param.getNomeAzione(),
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteAndInsertDecFormatoFileAmmesso(LogParam param,
            List<BigDecimal> idFormatoFileAmmessoToDeleteList, BigDecimal idTipoStrutDoc,
            BigDecimal idTipoCompDoc, List<BigDecimal> listaFormatiDaInserire) {
    ...
    private void insertDecFormatoFileAmmesso(BigDecimal idTipoCompDoc,
            BigDecimal idFormatoFileDoc) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void updateDecTipoCompDoc(LogParam param, BigDecimal idTipoCompDoc,
            DecTipoCompDocRowBean tipoCompDocRowBean) throws ParerUserError {
        DecTipoCompDoc dbTipoCompDoc = helper.getDecTipoCompDocByName(
                tipoCompDocRowBean.getNmTipoCompDoc(), tipoCompDocRowBean.getIdTipoStrutDoc()); // tipoCompDocRowBean
        ...
        if (dbTipoCompDoc != null
                && dbTipoCompDoc.getIdTipoCompDoc() != idTipoCompDoc.longValue()) {
            throw new ParerUserError(
        ...
        //
        /*
         * "Allineo" i formati GESTITI per il tipo componente SOLO se il flag è stato modificato,
         * altrimenti allineerei errorenamente
         */
        if (!StringUtils.equals(flGestitiDB, tipoCompDocRowBean.getFlGestiti())) {
            if (tipoCompDocRowBean.getFlGestiti().equals("1")) {
                /*
                 * Cerca nei DEC_FORMATO_FILE_DOC se ci sono dei formati GESTITI e in caso
                 * aggiungili
                 */
        ...
        /*
         * "Allineo" i formati IDONEI per il tipo componente SOLO se il flag è stato modificato,
         * altrimenti allineerei errorenamente
         */
        ...
        /*
         * "Allineo" i formati DEPRECATI per il tipo componente SOLO se il flag è stato modificato,
         * altrimenti allineerei errorenamente
         */
        if (!StringUtils.equals(flDeprecatiDB, tipoCompDocRowBean.getFlDeprecati())) {
            if (tipoCompDocRowBean.getFlDeprecati().equals("1")) {
                /*
                 * Cerca nei DEC_FORMATO_FILE_DOC se ci sono dei formati DEPRECATI e in caso
                 * aggiungili
                 */
    ...
    public void deleteDecTipoStrutDoc(LogParam param, long idTipoStrutDoc) throws ParerUserError {
        ...
        boolean existsRelationsWithStrutDoc = helper
                .existsRelationsWithStrutDoc(tipoStrutDoc.getIdTipoStrutDoc());
        ...
        logger.info("Cancellazione tipo struttura documento " + nmTipoStrutDoc + " della struttura "
                + idStrut + " avvenuta con successo!");
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecTipoCompDoc(LogParam param, DecTipoCompDocRowBean tipoCompDocRowBean)
            throws ParerUserError {
        DecTipoCompDoc tipoCompDoc = helper.findById(DecTipoCompDoc.class,
                tipoCompDocRowBean.getIdTipoCompDoc());
    ...
    public String deleteDecFormatoFileAmmesso(LogParam param, BigDecimal idFormatoFileAmmesso,
        ...
        DecFormatoFileAmmesso formatoFileAmmesso = helper.findById(DecFormatoFileAmmesso.class,
                idFormatoFileAmmesso);
        DecTipoCompDoc tipoCompDoc = helper.findById(DecTipoCompDoc.class,
        ...
        /*
         * La cancellazione di un formato, comporta sicuramente, nel caso fosse settato a 1,
         * l'azzeramento del relativo flag GESTITO, IDONEO o DEPRECATO
         */
        if (tiEsitoContrFormato
    ...
    public DecTipoRapprAmmessoTableBean getDecTipoRapprAmmessoTableBeanByIdTipoCompDoc(
        ...
        if (tipoRapprAmmessoTableBeanList != null && !tipoRapprAmmessoTableBeanList.isEmpty()) {
            try {
                for (DecTipoRapprAmmesso tipoRapprAmmesso : tipoRapprAmmessoTableBeanList) {
                    tipoRapprCompRowBean = (DecTipoRapprAmmessoRowBean) Transform
    ...
    public DecTipoRapprAmmessoTableBean getDecTipoRapprAmmessoTableBeanByIdTipoRapprComp(
            ...
            try {
                for (DecTipoRapprAmmesso tipoRapprAmmesso : tipoRapprAmmessoTableBeanList) {
                    DecTipoRapprAmmessoRowBean tipoRapprCompRowBean = (DecTipoRapprAmmessoRowBean) Transform
                            .entity2RowBean(tipoRapprAmmesso);
                    tipoRapprCompRowBean.setBigDecimal("id_tipo_strut_doc",
                            new BigDecimal(tipoRapprAmmesso.getDecTipoCompDoc().getDecTipoStrutDoc()
                                    .getIdTipoStrutDoc()));
                    tipoRapprCompRowBean.setString("nm_tipo_strut_doc", tipoRapprAmmesso
                            .getDecTipoCompDoc().getDecTipoStrutDoc().getNmTipoStrutDoc());
                    tipoRapprCompRowBean.setString("ds_tipo_strut_doc", tipoRapprAmmesso
                            .getDecTipoCompDoc().getDecTipoStrutDoc().getDsTipoStrutDoc());
    ...
    public DecTipoRapprCompTableBean getDecTipoRapprCompTableBeanByIdStrut(BigDecimal idStrut,
            Date data) {
        DecTipoRapprCompTableBean tipoRapprCompTableBean = new DecTipoRapprCompTableBean();
        List<DecTipoRapprComp> tipoRapprCompList = helper
                .getDecTipoRapprCompListByIdStrut(idStrut.longValue(), data);
        if (tipoRapprCompList != null && !tipoRapprCompList.isEmpty()) {
            try {
                tipoRapprCompTableBean = (DecTipoRapprCompTableBean) Transform
                        .entities2TableBean(tipoRapprCompList);
            } catch (ClassNotFoundException | NoSuchMethodException | InstantiationException
                    | IllegalAccessException | IllegalArgumentException
                    | InvocationTargetException ex) {
    ...
    public DecTipoRapprAmmessoRowBean getDecTipoRapprAmmessoRowBean(BigDecimal idTipoCompDoc,
            BigDecimal idTipoRapprComp) {
        DecTipoRapprAmmesso tipoRapprAmmesso = helper.getDecTipoRapprAmmessoByParentId(
                idTipoCompDoc.longValue(), idTipoRapprComp.longValue());
        ...
        try {
            ...
            row.setBigDecimal("id_tipo_strut_doc", new BigDecimal(
                    tipoRapprAmmesso.getDecTipoCompDoc().getDecTipoStrutDoc().getIdTipoStrutDoc()));
        } catch (ClassNotFoundException | NoSuchMethodException | InstantiationException
                | IllegalAccessException | IllegalArgumentException
                | InvocationTargetException ex) {
            logger.error("Errore durante il recupero del tipo componente"
                    + ExceptionUtils.getRootCauseMessage(ex), ex);
        }
        return row;
    }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void insertDecTipoRapprAmmesso(LogParam param, BigDecimal idTipoCompDoc,
            BigDecimal idTipoRapprComp) throws ParerUserError {
        if (helper.getDecTipoRapprAmmessoByParentId(idTipoCompDoc.longValue(),
                idTipoRapprComp.longValue()) != null) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void updateDecTipoRapprAmmesso(LogParam param, BigDecimal idTipoRapprAmmesso,
            BigDecimal idTipoCompDoc, BigDecimal idTipoRapprComp) throws ParerUserError {
        DecTipoRapprAmmesso dbTipoRapprAmmesso = helper.getDecTipoRapprAmmessoByParentId(
                idTipoCompDoc.longValue(), idTipoRapprComp.longValue());
        ...
        if (dbTipoRapprAmmesso.getDecTipoRapprComp().getIdTipoRapprComp() != idTipoRapprComp
                .longValue()
                || dbTipoRapprAmmesso.getDecTipoCompDoc().getIdTipoCompDoc() != idTipoCompDoc
                        .longValue()) {
            update = true;
        }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecTipoRapprAmmesso(LogParam param, BigDecimal idTipoRapprAmmesso,
            BigDecimal idTipoStrutDoc) {
        DecTipoRapprAmmesso tipoRapprAmmesso = helper.findById(DecTipoRapprAmmesso.class,
                idTipoRapprAmmesso);
    ...
    public void updateFlagTipoComponente(BigDecimal idTipoCompDoc) {
        ...
        for (DecFormatoFileDoc formatoFileDoc : formatoFileDocList) {
            /*
             * Per ognuno verifica se è GESTITO e in caso lo inserisco come tale in
             * DEC_FORMATO_FILE_AMMESSO
             */
            int lunghezza = formatoFileDoc.getDecUsoFormatoFileStandards().size();
            if (lunghezza > 0) {
                DecUsoFormatoFileStandard usoFormatoFileStandard = formatoFileDoc
