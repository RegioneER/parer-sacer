...
public class ModelliXsdUdHelper extends GenericHelper {
     ...
     *
     * @param idTiEntita    id entità
     * @param tiEntitaSacer tipi entità
     * @param tiUsoModello  VERS / MIGRAZ
     ...
     *
     * @param idModelloXsdUd id modello (opzionale)
     * @param idTiEntita     id entita
     * @param tiEntitaSacer  tipo entita
     * @param tiUsoModello   tipo uso
     * @param cdXsd          versione modello (opzionale)
     * @param flStandard     true = standard / false = altrimenti
     * @param filterValid    se valido (opzionale)\
     *
     ...
     * @param tiEntitaSacer     tipo entità
     *
     ...
     *
     * @param idModelloXsdUd id del modello
     * @param filterValid    se valido o meno
     *
     ...
     *
     * @param filtriModelliXsdUd filtro
     * @param idAmbientiToFind   lista id ambienti
     * @param tiUsoModelloXsd    tipo uso modello
     * @param filterValid        true = valido / false altrimenti
     *
     ...
     * @param dsXsd            Descrizione xsd
     * @param flDefault        flag default
     * @param tiModelloXsd     tipo di modello Xsd
     *
     * @return lista modelli xsd ud
     *
     */
     ...
     *
     * @param idStrut        id struttura
     * @param nmTipoUnitaDoc tipo unita doc
