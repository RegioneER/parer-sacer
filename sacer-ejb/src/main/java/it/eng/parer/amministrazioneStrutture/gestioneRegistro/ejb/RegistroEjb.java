...
public class RegistroEjb {
     ...
     *
     * @param idRegistroUnitaDoc registro unita doc
     *
    ...
    public boolean checkTipoSerieStandardForTipiUdAmmessi(BigDecimal idRegistroUnitaDoc) {
        ...
        DecRegistroUnitaDoc registro = helper.findById(DecRegistroUnitaDoc.class,
                idRegistroUnitaDoc);
        for (DecTipoUnitaDocAmmesso tipoUnitaDocAmmesso : registro.getDecTipoUnitaDocAmmessos()) {
            if (tipoUnitaDocAmmesso.getDecTipoUnitaDoc().getFlCreaTipoSerieStandard() != null
                    && tipoUnitaDocAmmesso.getDecTipoUnitaDoc().getFlCreaTipoSerieStandard()
                            .equals("1")) {
                result = true;
                break;
            }
    ...
    /**
     * Calcola la massima dimesione possibile per la componente Numero della chiave UD legata a
     * questo registro, in funzione della chiave di ordinamento calcolata e dell'URN UD (per
     * praticità non viene presa in considerazione la lunghezza dell'eventuale path di
     * memorizzazione su nastro, valida solo per i versamenti salvati su Tivoli).
     *
     * @param bean raw bean con dati registro
     *
     ...
     * @param registroUnitaDocRowBean bean contenente i dati del registro
     * @param criterioAutomRegistro   flag relativo alla creazione automatica del criterio di
     *                                raggruppamento
     *
     * @throws ParerUserError errore generico
     */
    public void insertDecRegistroUnitaDoc(LogParam param,
            DecRegistroUnitaDocRowBean registroUnitaDocRowBean, String criterioAutomRegistro)
            throws ParerUserError {
        RegistroEjb me = context.getBusinessObject(RegistroEjb.class);
        try {
            IamOrganizDaReplic replic = me.saveDecRegistroUnitaDoc(param, null,
                    registroUnitaDocRowBean, StruttureEjb.TipoOper.INS, criterioAutomRegistro, null,
                    null, null, null);
            if (replic != null) {
                struttureEjb.replicateToIam(replic);
            }
        } catch (ParerWarningException ex) {
            // Fittizio, non ci entrerà mai per il caso di inserimento. BonnieApproved per presa
            // visione.
        }
    }
     ...
     * @throws ParerUserError errore generico
     */
    public void duplicaRegistroUnitaDoc(LogParam param,
            DecRegistroUnitaDocRowBean registroUnitaDocRowBean, String criterioAutomRegistro)
            throws ParerUserError {
        RegistroEjb me = context.getBusinessObject(RegistroEjb.class);
        try {
            IamOrganizDaReplic replic = me.saveDecRegistroUnitaDoc(param, null,
                    registroUnitaDocRowBean, StruttureEjb.TipoOper.DUPLICA_REGISTRO,
                    criterioAutomRegistro, null, null, null, null);
            struttureEjb.replicateToIam(replic);
        } catch (ParerWarningException ex) {
            // Fittizio, non ci entrerà mai per il caso di inserimento. BonnieApproved per presa
            // visione.
     ...
     *
     * @param param                   parametro
     * @param azioneInsCriterio       azione da inserire su criterio
     * @param azioneModCriterio       azione da modificare su criterio
     * @param idRegistroUnitaDoc      id del registro da modificare
     * @param registroUnitaDocRowBean bean contenente i dati del registro
     * @param criterioAutomRegistro   flag relativo alla creazione automatica del criterio di
     *                                raggruppamento
     *
     ...
     */
    public void updateDecRegistroUnitaDoc(LogParam param, String azioneInsCriterio,
            String azioneModCriterio, BigDecimal idRegistroUnitaDoc,
            DecRegistroUnitaDocRowBean registroUnitaDocRowBean, String criterioAutomRegistro)
        ...
        DecRegistroUnitaDoc registroUnitaDocDB = helper.findById(DecRegistroUnitaDoc.class,
                idRegistroUnitaDoc);
        String flRegistroFiscaleDB = registroUnitaDocDB.getFlRegistroFisc();
        List<DecTipoUnitaDocAmmesso> tipoUnitaDocAmmessoList = registroUnitaDocDB
                .getDecTipoUnitaDocAmmessos();

        IamOrganizDaReplic replic = me.saveDecRegistroUnitaDoc(param, idRegistroUnitaDoc,
                registroUnitaDocRowBean, StruttureEjb.TipoOper.MOD, criterioAutomRegistro,
                azioneInsCriterio, azioneModCriterio, flRegistroFiscaleDB, tipoUnitaDocAmmessoList);
     ...
     *
     * @param param                   parametro
     * @param idRegistroUnitaDoc      id del registro da modificare (se != null)
     * @param registroUnitaDocRowBean bean contenente i dati del registro
     * @param tipoOper                tipo di operazione eseguita
     * @param criterioAutomRegistro   flag relativo alla creazione automatica del criterio di
     *                                raggruppamento
     * @param azioneInsCriterio       azione da inserire su criterio
     * @param azioneModCriterio       azione da mofificare su creterio
     * @param flRegistroFiscaleDB     si/no
     * @param tipoUnitaDocAmmessoList lista unita doc ammessa
     *
    ...
    public IamOrganizDaReplic saveDecRegistroUnitaDoc(LogParam param, BigDecimal idRegistroUnitaDoc,
        ...
        if (tipoOper.name().equals(StruttureEjb.TipoOper.INS.name())) {
            ...
            if (helper.getDecRegistroUnitaDocByName(registroUnitaDocRowBean.getCdRegistroUnitaDoc(),
                ...
                throw new ParerUserError(
                        "Registro gi\u00e0 esistente all'interno della struttura</br>");
            }
            ...
            while (helper.existsCdRegistroNormaliz(registroUnitaDocRowBean.getCdRegistroNormaliz(),
                ...
                registroUnitaDocRowBean.setCdRegistroNormaliz(
                        registroUnitaDocRowBean.getCdRegistroNormaliz().concat("_"));
            }

            BigDecimal idModelloTipoSerie = registroUnitaDocRowBean.getIdModelloTipoSerie();

            registroUnitaDoc = (DecRegistroUnitaDoc) Transform
                    .rowBean2Entity(registroUnitaDocRowBean);
            ...
            /*
             * TODO: Inserire anche la parte di default associata al periodo di validit\u00E0 creato
             * al punto precedente con le seguenti caratteristiche: a. Numero d?ordine
             * (ni_parte_numero_registro) = 1 b. Nome (nm_parte_numero_registro)= DEFAULT c.
             * Descrizione = DEFAULT d. Caratteri ammessi (ti_char_parte) = NUMERICO e. Numero
             * minimo di caratteri della parte (ni_min_char_parte) = 1 f. Numero massimo di
             * caratteri della parte (ni_max_char_parte) = Non definito g. Carattere separatore
             * (ti_char_sep) = Non definito h. Tipo di riempimento (ti_pad_sx_parte) = STANDARD i.
             * Valori accettati (dl_valori_parte) = Non definiti j. Coincidenza con l?anno della
             * chiave dell?unit\u00E0 documentaria (flag fl_aa_key_unita_doc) = Flag Non selezionato
             * k. Parte da utilizzare per i controlli di consecutivit\u00E0 (flag fl_parte_progr) =
             * Flag Non selezionato
             */
            ...
            if (dbRegistroUnitaDoc != null && dbRegistroUnitaDoc
                    .getIdRegistroUnitaDoc() != idRegistroUnitaDoc.longValue()) {
                throw new ParerUserError(
            ...
            if (modificaNome) {
                // Se è stato modificato il nome, devo modificare di conseguenza i tipi serie da
                // modello associati (e le
                // sue serie, se hanno un contenuto pari a 0)
                List<DecTipoSerie> retrieveDecTipoSerieForRegistro = tipoSerieHelper
                        .retrieveDecTipoSerieForRegistro(registroUnitaDocRowBean.getIdStrut(),
                                idRegistroUnitaDoc);
                for (DecTipoSerie tipoSerie : retrieveDecTipoSerieForRegistro) {
                    ...
                    if ((modelloTipoSerie = tipoSerie.getDecModelloTipoSerie()) != null) {
                        for (DecTipoSerieUd tipoSerieUd : tipoSerie.getDecTipoSerieUds()) {
                            ...
                            String nmTipoSerie = tipoSerieEjb.getNmTipoSerieForModello(
                                    modelloTipoSerie, registroUnitaDoc, tipoUnitaDoc,
                                    tipoSerie.getTiCreaStandard(),
                                    registroUnitaDocRowBean.getCdRegistroUnitaDoc());
                            // Verifico che non esista già un tipo serie con questo nome
                            if (StringUtils.isNotBlank(nmTipoSerie)
                                    && tipoSerieHelper.getDecTipoSerieByName(nmTipoSerie,
                                            struttura.getIdStrut()) == null) {
                                String dsTipoSerie = tipoSerieEjb.getDsTipoSerieForModello(
                                        modelloTipoSerie, registroUnitaDoc, tipoUnitaDoc,
                                        tipoSerie.getTiCreaStandard(),
                                        registroUnitaDocRowBean.getCdRegistroUnitaDoc());
                                String cdSerie = tipoSerieEjb.getCdSerieForModello(modelloTipoSerie,
                                        registroUnitaDoc, tipoUnitaDoc,
                                        tipoSerie.getTiCreaStandard(),
                                        registroUnitaDocRowBean.getCdRegistroUnitaDoc());
                                String dsSerie = tipoSerieEjb.getDsSerieForModello(modelloTipoSerie,
                                        registroUnitaDoc, tipoUnitaDoc,
                                        tipoSerie.getTiCreaStandard(),
                                        registroUnitaDocRowBean.getCdRegistroUnitaDoc());
                                ...
                                List<SerVerSerie> versioniSerieCorrentiByTipoSerie = serieHelper
                                        .getVersioniSerieCorrentiByTipoSerie(
                                ...
                                for (SerVerSerie verSerie : versioniSerieCorrentiByTipoSerie) {
                                    ...
                                    if (anniCalcolati.add(serie.getAaSerie())) {
                                        creaAutomBean = serieEjb.generateIntervalliSerieAutom(
                                                niMesiCreazioneSerie, tipoSerie.getCdSerieDefault(),
                                                tipoSerie.getDsSerieDefault(),
                                                serie.getAaSerie().intValue(),
                                                tipoSerie.getTiSelUd());
                                    }
                                    if (!serieAnnuale) {
                                        IntervalliSerieAutomBean tmpBean = new IntervalliSerieAutomBean(
                                                verSerie.getDtInizioSelSerie(),
                                                verSerie.getDtFineSelSerie(), null, null);
                                        IntervalliSerieAutomBean newInterval;
                                        int indexInterval;
                                        if (creaAutomBean != null && (indexInterval = creaAutomBean
                                                .getIntervalli().indexOf(tmpBean)) != -1) {
                                            newInterval = creaAutomBean.getIntervalli()
                                                    .get(indexInterval);
                                        ...
                                        IntervalliSerieAutomBean newInterval = creaAutomBean
                                                .getIntervalli().get(0);
                                        serie.setCdCompositoSerie(newInterval.getCdSerie());
                                        serie.setDsSerie(newInterval.getDsSerie());
                                    }
            ...
            if (idModelloTipoSerie != null) {
                ...
                if (registroUnitaDoc.getDecModelloTipoSerie() != null) {
                    if (registroUnitaDoc.getDecModelloTipoSerie()
                            .getIdModelloTipoSerie() != idModelloTipoSerie.longValue()) {
                        DecModelloTipoSerie modelloTipoSerieOld = registroUnitaDoc
                                .getDecModelloTipoSerie();
                        List<DecTipoSerie> tipiSerieVecchioModello = tipoSerieHelper
                                .retrieveDecTipoSerieList(
                                        registroUnitaDoc.getOrgStrut().getIdStrut(),
                                        modelloTipoSerieOld.getIdModelloTipoSerie());

                        boolean presenzaTiCreaStandard = false;
                        // Se il modello che si intende dismettere NON è collegato a tipologie di
                        // serie attive che hanno
                        // il flag "ti_crea_standard" = "BASATA_SU_REGISTRO" la modifica è
                        // consentita
                        for (DecTipoSerie tipoSerie : tipiSerieVecchioModello) {
                            if (tipoSerie.getTiCreaStandard().equals(
            ...
            registroUnitaDoc.setFlCreaTipoSerieStandard(
                    registroUnitaDocRowBean.getFlCreaTipoSerieStandard());
            registroUnitaDoc
                    .setNmTipoSerieDaCreare(registroUnitaDocRowBean.getNmTipoSerieDaCreare());
            registroUnitaDoc
                    .setDsTipoSerieDaCreare(registroUnitaDocRowBean.getDsTipoSerieDaCreare());
            ...
            registroUnitaDoc
                    .setFlConservIllimitata(registroUnitaDocRowBean.getFlConservIllimitata());
            ...
            sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                    param.getNomeUtente(), param.getNomeAzione(),
                    SacerLogConstants.TIPO_OGGETTO_REGISTRO, idRegistroUnitaDoc,
                    param.getNomePagina());

            // Gestione fiscalità
            List<DecCriterioRaggr> criteri = crHelper.getCriteriPerTipoDato(
                    idRegistroUnitaDoc.longValue(), TipoDato.REGISTRO, "1", null);
            if (!criteri.isEmpty()) {
                // Se il criterio standard sul registro esiste, e l'indicatore registro fiscale è
                // stato modificato
                // aggiorno il criterio con la nuova fiscalità se è cambiata
                if (!criteri.get(0).getFlCriterioRaggrFisc()
                        .equals(registroUnitaDocRowBean.getFlRegistroFisc())) {
                    param.setNomeAzione(azioneModCriterio);
                    criteri.get(0)
                            .setFlCriterioRaggrFisc(registroUnitaDocRowBean.getFlRegistroFisc());
                    sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                            param.getNomeUtente(), param.getNomeAzione(),
                            SacerLogConstants.TIPO_OGGETTO_CRITERIO_RAGGRUPPAMENTO,
                            BigDecimal.valueOf(criteri.get(0).getIdCriterioRaggr()),
                            param.getNomePagina());
            ...
            if (flRegistroFiscaleDB.equals("0")
                    && registroUnitaDocRowBean.getFlRegistroFisc().equals("1")) {
                // Per ogni tipo unita doc associato al registro
                for (DecTipoUnitaDocAmmesso tipoUnitaDocAmmesso : tipoUnitaDocAmmessoList) {
                    long idTipoUnitaDoc = tipoUnitaDocAmmesso.getDecTipoUnitaDoc()
                            .getIdTipoUnitaDoc();
                    ...
                    if (!critEjb.existsCriterioPerTipoDato(idTipoUnitaDoc,
                        ...
                        if (areAllRegistriFiscali) {
                            ...
                            // Se NON esiste
                            if (!critEjb.existsCriterioPerTipoDato(idRegistroUnitaDoc.longValue(),
                                    TipoDato.REGISTRO)) {
                                ...
                                if (tipoUnitaDocEjb.creaCriterioSulTipoUnitaDoc(param,
                                    ...
                                    warningMessage
                                            .append("Poiché per il tipo di unità documentaria ");
                                    warningMessage.append(tipoUnitaDocAmmesso.getDecTipoUnitaDoc()
                                            .getNmTipoUnitaDoc());
                        ...
                        List<DecCriterioRaggr> criteriEsistenti = crHelper.getCriteriPerTipoDato(
                                idTipoUnitaDoc, TipoDato.TIPO_UNITA_DOC, "1", "0");
                        if (!criteriEsistenti.isEmpty()) {
                            ...
                            sacerLogEjb.log(param.getTransactionLogContext(),
                                    ...
                                    SacerLogConstants.TIPO_OGGETTO_CRITERIO_RAGGRUPPAMENTO,
                                    BigDecimal
                                            .valueOf(criteriEsistenti.get(0).getIdCriterioRaggr()),
                                    param.getNomePagina());
                            warningMessage.append("Poiché per il tipo di unità documentaria ");
                            warningMessage.append(
                                    tipoUnitaDocAmmesso.getDecTipoUnitaDoc().getNmTipoUnitaDoc());
                            warningMessage.append(
                                    " è stato rilevato un criterio standard e non fiscale ed il registro associato è fiscale, ");
                            warningMessage.append(
                                    "si è provveduto a modificare il criterio definendolo fiscale.");
                            warningMessage.append("<br>");
                        }
                    }
                }
            ...
            for (DecTipoUnitaDocAmmesso tipoUnitaDocAmmesso : tipoUnitaDocAmmessoList) {
                ...
                List<String> criteriNonCoerenti = crHelper
                        .getCriteriNonCoerenti(BigDecimal.valueOf(idTipoUnitaDoc));
                if (!criteriNonCoerenti.isEmpty()) {
                    StringBuilder errorMessage = new StringBuilder();
                    errorMessage.append("Poiché il registro è ");
                    errorMessage.append(
                            registroUnitaDocRowBean.getFlRegistroFisc().equals("1") ? "fiscale "
                                    : "non fiscale ");
                    errorMessage.append(
                            "i seguenti criteri non sono coerenti con l’associazione fra il tipo di unità documentaria ");
                    errorMessage
                            .append(tipoUnitaDocAmmesso.getDecTipoUnitaDoc().getNmTipoUnitaDoc());
            ...
            if (warningMessage.length() > 0) {
                ...
                throw new ParerWarningException(warningMessage.toString(),
                        "warningModificaRegistro");
            }
            ...
            try {
                ...
                // Inserisco nell'entity duplicata i valori dei campi eventualmente cambiati
                // nell'online
                registroUnitaDoc
                        .setCdRegistroNormaliz(registroUnitaDocRowBean.getCdRegistroNormaliz());
                registroUnitaDoc
                        .setDsRegistroUnitaDoc(registroUnitaDocRowBean.getDsRegistroUnitaDoc());
                registroUnitaDoc.setFlRegistroFisc(registroUnitaDocRowBean.getFlRegistroFisc());
                registroUnitaDoc.setFlCreaSerie(registroUnitaDocRowBean.getFlCreaSerie());
                registroUnitaDoc.setNiAnniConserv(registroUnitaDocRowBean.getNiAnniConserv());
                registroUnitaDoc.setDtIstituz(registroUnitaDocRowBean.getDtIstituz());
                registroUnitaDoc.setDtSoppres(registroUnitaDocRowBean.getDtSoppres());
                registroUnitaDoc
                        .setCdRegistroUnitaDoc(registroUnitaDocRowBean.getCdRegistroUnitaDoc());
            ...
            tiOper = ApplEnum.TiOperReplic.MOD;
            modificatiNomeDescrizione = true;
            registroUnitaDocRowBean.setIdRegistroUnitaDoc(
                    new BigDecimal(registroUnitaDoc.getIdRegistroUnitaDoc()));
            struttura = helper.findById(OrgStrut.class,
                    registroUnitaDoc.getOrgStrut().getIdStrut());
        }

        /*
         * Se l’utente ha selezionato il check “Creazione in automatico del criterio di
         * raggruppamento sul registro” il sistema esegue la creazione in automatico del criterio di
         * raggruppamento standard NON automatico
         */
        if (criterioAutomRegistro != null && criterioAutomRegistro.equals("1")) {
            // FIXME: Non necessario questo metodo, basta fare una findById
            // PG: ma io non sono così sicuro che sulla vista tu possa fare la find, caro adc, cmq
            // prova quando vuoi...
        ...
        /*
         * La replica va fatta solo se il registro appartiene ad una struttura non appartenente ad
         * un ente di tipo template e se sono stati modificati nome e/o descrizione
         */
    ...
    private DecRegistroUnitaDoc duplicaRegistroEntity(DecRegistroUnitaDoc registroOriginale)
        ...
        final List<DecAaRegistroUnitaDoc> decAaRegistroUnitaDocs = registroOriginale
        ...
        if (decAaRegistroUnitaDocs != null && decAaRegistroUnitaDocs.size() > 0) {
            ...
            for (DecAaRegistroUnitaDoc u : decAaRegistroUnitaDocs) {
                ...
                final List<DecErrAaRegistroUnitaDoc> decErrAaRegistroUnitaDocs = u
                        .getDecErrAaRegistroUnitaDocs();
                ...
                final List<DecParteNumeroRegistro> decParteNumeroRegistros = u
        ...
        final List<DecTipoUnitaDocAmmesso> decTipoUnitaDocAmmessos = registroOriginale
                .getDecTipoUnitaDocAmmessos();
    ...
    /**
     * Ritorna il tableBean contenente la lista dei periodi di validità del registro dato come
     * parametro
     *
        ...
        if (list != null) {
            try {
                for (DecAaRegistroUnitaDoc row : list) {
                    DecAaRegistroUnitaDocRowBean rowBean = (DecAaRegistroUnitaDocRowBean) Transform
                            .entity2RowBean(row);
                    ...
                    rowBean.setString("controllo_formato_da_list", struttureHelper
                            .getDecVChkFmtNumeroForPeriodo(row.getIdAaRegistroUnitaDoc()));
    ...
    /**
     * Ritorna il tableBean contenente la lista di parti di registro per il periodo di validità dato
     * come parametro
     *
     ...
     * @return il tablebean
     */
    public DecParteNumeroRegistroTableBean getDecParteNumeroRegistroTableBean(
            BigDecimal idAaRegistroUnitaDoc) {
        DecParteNumeroRegistroTableBean tableBean = new DecParteNumeroRegistroTableBean();
        List<DecParteNumeroRegistro> parti = helper
                .getDecParteNumeroRegistroList(idAaRegistroUnitaDoc.longValue());
    ...
    private String calcolaEsempio(List<DecParteNumeroRegistro> parti) {
        ...
        for (DecParteNumeroRegistro parte : parti) {
            ...
            if (!StringUtils.isEmpty(parte.getDlValoriParte())) {
                // TODO: Chiedere a Paola quale pu\u00F2 essere il contenuto della colonna e
                // inserire solo il primo dei
                // caratteri possibili.
            ...
            } else if (!StringUtils.isEmpty(parte.getTiParte())
                    && parte.getTiParte().equals("ANNO")) {
                esempio += parte.getDecAaRegistroUnitaDoc().getAaMinRegistroUnitaDoc();
            } else if (!StringUtils.isEmpty(parte.getTiParte())
                    && parte.getTiParte().equals("REGISTRO")) {
                esempio += parte.getDecAaRegistroUnitaDoc().getDecRegistroUnitaDoc()
    ...
    public DecRegistroUnitaDocTableBean getRegistriUnitaDocAbilitati(long idUtente,
    ...
    public void checkPeriodiValiditaProgressivo(BigDecimal idRegistroUnitaDoc)
            throws ParerUserError {
        Long countPeriodiNoConsec = helper
                .countPeriodiValiditaConControlloConsec(idRegistroUnitaDoc);
        if (countPeriodiNoConsec != null) {
            ...
            throw new ParerUserError(
                    "Errore inaspettato nel controllo dei periodi di validit\u00E0");
        }
    }
    ...
    public String checkEditRegistroForTipiSerie(BigDecimal idStrut, BigDecimal idRegistroUnitaDoc,
        ...
        DecRegistroUnitaDoc registroUnitaDoc = helper.findById(DecRegistroUnitaDoc.class,
                idRegistroUnitaDoc);
        List<DecTipoSerie> retrieveDecTipoSerieForRegistro = tipoSerieHelper
                .retrieveDecTipoSerieForRegistro(idStrut, idRegistroUnitaDoc);
        for (DecTipoSerie tipoSerie : retrieveDecTipoSerieForRegistro) {
            DecModelloTipoSerie modelloTipoSerie;
            if ((modelloTipoSerie = tipoSerie.getDecModelloTipoSerie()) != null) {
                ...
                for (DecTipoSerieUd tipoSerieUd : tipoSerie.getDecTipoSerieUds()) {
                    ...
                    if (StringUtils.isNotBlank(nmTipoSerie)) {
                        if (tipoSerieHelper.getDecTipoSerieByName(nmTipoSerie,
                                idStrut.longValue()) == null) {
                            String dsTipoSerie = tipoSerieEjb.getDsTipoSerieForModello(
                                    modelloTipoSerie, registroUnitaDoc, tipoUnitaDoc,
                                    tipoSerie.getTiCreaStandard(), cdRegistroUnitaDocNew);
                            String cdSerie = tipoSerieEjb.getCdSerieForModello(modelloTipoSerie,
                                    registroUnitaDoc, tipoUnitaDoc, tipoSerie.getTiCreaStandard(),
                                    cdRegistroUnitaDocNew);
                            String dsSerie = tipoSerieEjb.getDsSerieForModello(modelloTipoSerie,
                            ...
                            message.append("\tLa denominazione del tipo serie [")
                                    .append(tipoSerie.getNmTipoSerie()).append("] diventer\u00E0 [")
                                    .append(nmTipoSerie).append("]#");
                            message.append("\tLa descrizione del tipo serie [")
                                    .append(tipoSerie.getDsTipoSerie()).append("] diventer\u00E0 [")
                                    .append(dsTipoSerie).append("]#");
                            message.append("\tIl codice serie [")
                                    .append(tipoSerie.getCdSerieDefault())
                                    .append("] diventer\u00E0 [").append(cdSerie).append("]#");
                            message.append("\tLa descrizione della serie [")
                                    .append(tipoSerie.getDsSerieDefault())
                                    .append("] diventer\u00E0 [").append(dsSerie).append("]#");
                            message.append(
                                    "\tLe serie associate al tipo serie verranno modificate di conseguenza#");
                        } else {
                            message.append(
                                    ...
                                    .append(nmTipoSerie)
                                    .append("]) \u00E8 gi\u00E0 presente nel sistema#");
                        }
                    }
                }
            }
    ...
    public DecRegistroUnitaDocRowBean getDecRegistroUnitaDocRowBean(BigDecimal idRegistroUnitaDoc,
            BigDecimal idStrut) {
        DecRegistroUnitaDocRowBean registroUnitaDocRowBean = getDecRegistroUnitaDoc(
                idRegistroUnitaDoc, null, idStrut);
        return registroUnitaDocRowBean;
    }

    public DecRegistroUnitaDocRowBean getDecRegistroUnitaDocRowBean(String cdRegistroUnitaDoc,
            BigDecimal idStrut) {
        DecRegistroUnitaDocRowBean registroUnitaDocRowBean = getDecRegistroUnitaDoc(BigDecimal.ZERO,
                cdRegistroUnitaDoc, idStrut);
        return registroUnitaDocRowBean;
    }

    /**
     * Ritorna il valore massimo del campo niAnniConserv contenuto nei registri legati al tipo serie
     * dato in input
     *
    ...
    private DecRegistroUnitaDocRowBean getDecRegistroUnitaDoc(BigDecimal idRegistroUnitaDoc,
            String cdRegistroUnitadoc, BigDecimal idStrut) {
        ...
        if (registroUnitaDoc != null) {
            try {
                registroUnitaDocRowBean = (DecRegistroUnitaDocRowBean) Transform
                        .entity2RowBean(registroUnitaDoc);
                registroUnitaDocRowBean.setString("controllo_formato", helper
                        .getDecVChkFmtNumeroForRegistro(registroUnitaDoc.getIdRegistroUnitaDoc()));

                // Data primo e ultimo versamento
                Object[] dateFirstLastVers = helper.retrieveDateFirstLastVersRegistro(
                        registroUnitaDoc.getIdRegistroUnitaDoc());
                if (dateFirstLastVers != null) {
                    Date d = (Date) dateFirstLastVers[0];
                    registroUnitaDocRowBean.setTimestamp("dt_first_vers",
                            new Timestamp(d.getTime()));
                    Date dLast = (Date) dateFirstLastVers[1];
                    registroUnitaDocRowBean.setTimestamp("dt_last_vers",
                            new Timestamp(dLast.getTime()));//
                }
    ...
    public DecRegistroUnitaDocTableBean getDecRegistroUnitaDocTableBean(BigDecimal idStrut,
        ...
        List<DecRegistroUnitaDoc> list = helper.retrieveDecRegistroUnitaDocList(idStrut.longValue(),
                filterValid);
            ...
            if (!list.isEmpty()) {
                for (DecRegistroUnitaDoc registro : list) {
                    ...
                    for (int index = 0; index < numeroPeriodi; index++) {
                        DecAaRegistroUnitaDoc anno = registro.getDecAaRegistroUnitaDocs()
                                .get(index);
                    ...
                    String flagStandard = crHelper.getCriterioStandardPerTipoDatoAnno(
                            registro.getIdRegistroUnitaDoc(), TipoDato.REGISTRO);
                    registroRow.setString("flag_criterio_standard", flagStandard);

                    // Controllo formato numero
                    String controlloFormato = helper
                            .getDecVChkFmtNumeroForRegistro(registro.getIdRegistroUnitaDoc());
    ...
    public DecRegistroUnitaDocTableBean getDecRegistroUnitaDocTableBean(BigDecimal idStrut) {
        List<DecRegistroUnitaDoc> registri = helper
                .retrieveDecRegistroUnitaDocList(idStrut.longValue(), false);
    ...
    /**
     * Business method per la cancellazione di un singolo registro passato come parametro. Il metodo
     * chiama a sua volta il metodo "deleteRegistroUnitaDoc" all'interno dello stesso contesto
     * transazionale. In caso ci siano problemi, si rilancia l'eccezione e l'annotation
     *
     * Sul metodo procede ad eseguire il rollback. Se invece il metodo non genera eccezioni viene
     * chiamata la replica su Iam. In questo caso, dovesse verificarsi un errore, la rollback
     * verrebbe gestita tramite IncoherenceException (del metodo replicateToIam) ed essendo stato un
     * creato un nuovo contesto transazionale (REQUIRES_NEW) la rollback avrebbe effetto solo sulla
     * replica (non voglio rollbackare tutto...)
     *
     * @param param              parametro
     ...
     * @throws ParerUserError errore generico
     */
    public void deleteDecRegistroUnitaDoc(LogParam param, long idRegistroUnitaDoc)
            throws ParerUserError {
        RegistroEjb me = context.getBusinessObject(RegistroEjb.class);
    ...
    public IamOrganizDaReplic deleteRegistroUnitaDocPuntuale(LogParam param,
            long idRegistroUnitaDoc) throws ParerUserError {
        ...
        // SacerLogConstants.TIPO_OGGETTO_REGISTRO, new BigDecimal(idRegistroUnitaDoc),
        // param.getNomePagina());
    ...
    public IamOrganizDaReplic deleteRegistroUnitaDocFromStruttura(LogParam param,
            long idRegistroUnitaDoc) throws ParerUserError {
        return eseguiDeleteRegistroUnitaDoc(param, idRegistroUnitaDoc, true);
    }

    /**
     * Business method per la cancellazione di un registro di una determinata struttura. Il metodo
     * esegue le seguenti istruzioni: 1) Controlla i legami con Tipologia Serie e Unità
     * documentarie; 2) Controllo i legami con criteri di raggruppamento e, se può, li elimina 3)
     * Esegue la cancellazione del Registro con cascade 4) Scrive il record dell'organizzazione da
     * replicare
     *
     * @param param              parametro
     * @param idRegistroUnitaDoc id registro unita doc
    ...
    private IamOrganizDaReplic eseguiDeleteRegistroUnitaDoc(LogParam param, long idRegistroUnitaDoc,
        ...
        boolean relationsWithTipiSerie = tipoSerieHelper.existsRelationsWithTipiSerie(
        ...
        boolean relationsWithUnitaDoc = unitaDocHelper.existsRelationsWithUnitaDoc(
                registroUnitaDoc.getIdRegistroUnitaDoc(), Constants.TipoDato.REGISTRO);
        ...
        List<DecCriterioFiltroMultiplo> criteriAssociati = struttureHelper
                .getRelationsWithCriteriRaggruppamento(registroUnitaDoc.getIdRegistroUnitaDoc(),
                        Constants.TipoDato.REGISTRO);
    ...
    public DecAaRegistroUnitaDocRowBean getDecAaRegistroUnitaDocRowBean(
            BigDecimal idAaRegistroUnitaDoc) {
        DecAaRegistroUnitaDocRowBean decAaRegistroUnitaDocRowBean = new DecAaRegistroUnitaDocRowBean();
        DecAaRegistroUnitaDoc decAaRegistroUnitaDoc = helper
                .getDecAARegistroUnitaDoc(idAaRegistroUnitaDoc);
        if (decAaRegistroUnitaDoc != null) {
            try {
                ...
                decAaRegistroUnitaDocRowBean.setFlUpdFmtNumero(
                        decAaRegistroUnitaDoc.getFlUpdFmtNumero().equals("1") ? "0" : "1");
                decAaRegistroUnitaDocRowBean.setString("controllo_formato",
                        struttureHelper.getDecVChkFmtNumeroForPeriodo(
                                decAaRegistroUnitaDoc.getIdAaRegistroUnitaDoc()));
            } catch (ClassNotFoundException | NoSuchMethodException | InstantiationException
                    | IllegalAccessException | IllegalArgumentException
                    | InvocationTargetException ex) {
                logger.error("Eccezione", ex);
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void deleteDecAaRegistroUnitaDoc(LogParam param,
            DecAaRegistroUnitaDocRowBean aaRegistroUnitaDocRowBean) throws ParerUserError {
        ...
        // Se aaMax non è presente, prendi l'anno corrente. Se però aaMin > anno corrente, allora
        // come aaMax assegna lo
        ...
        BigDecimal aaMaxRegistroUnitaDoc = aaRegistroUnitaDoc.getAaMaxRegistroUnitaDoc() != null
                ...
                : (aaMinRegistroUnitaDoc.compareTo(annoCorrente) > 0 ? aaMinRegistroUnitaDoc
                        : annoCorrente);

        long mon = helper.getMonAaUdRegistroNumber(
                aaRegistroUnitaDocRowBean.getAaMinRegistroUnitaDoc(),
        ...
        for (int i = aaMinRegistroUnitaDoc.intValue(); i <= aaMaxRegistroUnitaDoc.intValue(); i++) {
            ...
            List<DecCriterioRaggr> criterioRaggrList = crHelper
                    .getDecCriterioRaggrRegistroOTipiUdAssociatiList(new BigDecimal(
                            aaRegistroUnitaDoc.getDecRegistroUnitaDoc().getIdRegistroUnitaDoc()),
                            i);
            for (DecCriterioRaggr criterioRaggr : criterioRaggrList) {
                // Verifico se il criterio che ho ricavato è stato utilizzato per un elenco di
                // versamento
                // Se non è associato, lo elimino
                if (!crHelper.existElvElencoVersPerCriterioRaggr(
                        new BigDecimal(criterioRaggr.getIdCriterioRaggr()))) {
    ...
    public void checkDecAaRegistroUnitaDoc(BigDecimal idAaRegistroUnitaDoc,
            BigDecimal idRegistroUnitaDoc, BigDecimal aaMinRegistroUnitaDoc,
            BigDecimal aaMaxRegistroUnitaDoc) throws ParerUserError {
        logger.info("Verifico che il periodo indicato non si sovrapponga ad altri periodi");
        boolean periodiSovrapposti = helper.checkRangeDecAaRegistroUnitaDoc(idAaRegistroUnitaDoc,
                idRegistroUnitaDoc, aaMinRegistroUnitaDoc, aaMaxRegistroUnitaDoc);
    ...
    private void cloneDecAaRegistroUnitaDoc(DecRegistroUnitaDoc registro, DecAaRegistroUnitaDoc row,
        ...
        if (newAaRegistroUnitaDoc.getDecParteNumeroRegistros() == null) {
            newAaRegistroUnitaDoc
                    .setDecParteNumeroRegistros(new ArrayList<DecParteNumeroRegistro>());
        }
    ...
    public BigDecimal saveDecAaRegistroUnitaDoc(LogParam param, BigDecimal idRegistroUnitaDoc,
            BigDecimal aaMinRegistroUnitaDoc, BigDecimal aaMaxRegistroUnitaDoc,
            DecParteNumeroRegistroTableBean parti, String cdFormatoNumero, String dsFormatoNumero)
            throws ParerUserError {
        DecAaRegistroUnitaDoc aaRegistroUnitaDoc = new DecAaRegistroUnitaDoc();
        DecRegistroUnitaDoc registro = helper.findById(DecRegistroUnitaDoc.class,
                idRegistroUnitaDoc);
        ...
        sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                param.getNomeUtente(), param.getNomeAzione(),
                SacerLogConstants.TIPO_OGGETTO_REGISTRO, idRegistroUnitaDoc, param.getNomePagina());
    ...
    public void saveDecAaRegistroUnitaDoc(LogParam param, BigDecimal idAaRegistroUnitaDoc,
            BigDecimal aaMinRegistroUnitaDoc, BigDecimal aaMaxRegistroUnitaDoc,
            DecParteNumeroRegistroTableBean parti, Set<BigDecimal> idPartiEliminate,
            String cdFormatoNumero, String dsFormatoNumero) throws ParerUserError {
        DecAaRegistroUnitaDoc aaRegistroUnitaDoc = helper.findById(DecAaRegistroUnitaDoc.class,
        ...
        BigDecimal oldRegMaxValid = aaRegistroUnitaDoc.getAaMaxRegistroUnitaDoc() != null
                ? aaRegistroUnitaDoc.getAaMaxRegistroUnitaDoc()
                : new BigDecimal(9999);
        BigDecimal newRegMaxValid = aaMaxRegistroUnitaDoc != null ? aaMaxRegistroUnitaDoc
                : new BigDecimal(9999);

        checkDecAaRegistroUnitaDoc(idAaRegistroUnitaDoc,
                new BigDecimal(registro.getIdRegistroUnitaDoc()), aaMinRegistroUnitaDoc,
                newRegMaxValid);
        ...
        if (oldRegMaxValid.compareTo(newRegMaxValid) > 0) {
            ...
            if (udInRange) {
                cloneDecAaRegistroUnitaDoc(registro, aaRegistroUnitaDoc,
                        newRegMaxValid.add(BigDecimal.ONE),
                        aaRegistroUnitaDoc.getAaMaxRegistroUnitaDoc());
            }
        }
    ...
    public void checkUdNelPeriodoValidita(BigDecimal idAaRegistroUnitaDoc) {
        ...
        BigDecimal max = aaRegistroUnitaDoc.getAaMaxRegistroUnitaDoc() != null
                ...
                : new BigDecimal(Calendar.getInstance().get(Calendar.YEAR));
        boolean udInRange = helper.checkUnitaDocInDecAaRegUnitaDoc(idAaRegistroUnitaDoc,
                aaRegistroUnitaDoc.getAaMinRegistroUnitaDoc(), max,
                registro.getIdRegistroUnitaDoc(), registro.getCdRegistroUnitaDoc(), subStruts);
        if (!udInRange) {
    ...
    private void updateParteFields(DecParteNumeroRegistro parte,
            DecParteNumeroRegistroRowBean row) {
    ...
    public DecErrAaRegistroUnitaDocTableBean getDecErrAaRegistroUnitaDocTableBean(
            BigDecimal idAaRegistroUnitaDoc) {
        DecErrAaRegistroUnitaDocTableBean tableBean = new DecErrAaRegistroUnitaDocTableBean();
        List<DecErrAaRegistroUnitaDoc> errori = helper
                .getDecErrAaRegistroUnitaDocList(idAaRegistroUnitaDoc);
