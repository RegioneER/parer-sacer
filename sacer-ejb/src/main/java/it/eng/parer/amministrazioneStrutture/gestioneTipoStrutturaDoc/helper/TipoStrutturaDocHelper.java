...
public class TipoStrutturaDocHelper extends GenericHelper {
	...
	StringBuilder queryStr = new StringBuilder(
		"SELECT tipoStrutDoc FROM DecTipoStrutDoc tipoStrutDoc ");
	String clause = " WHERE ";
	if (idStrut != null) {
	...
	if (filterValid) {
	    queryStr.append(clause).append(
		    " tipoStrutDoc.dtIstituz <= :filterDate AND tipoStrutDoc.dtSoppres >= :filterDate ");
	}
	...
	Query query = getEntityManager()
		.createQuery("SELECT tipoCompDoc FROM DecTipoCompDoc tipoCompDoc "
    ...
    public DecTipoCompDoc getDecTipoCompDocByName(BigDecimal idStrut, String nmTipoStrutDoc,
    ...
    public List<DecTipoCompDoc> getDecTipoCompDocList(BigDecimal idTipoStrutDoc,
	    boolean filterValid) {
	StringBuilder queryStr = new StringBuilder(
	...
	if (idTipoStrutDoc != null) {
	    queryStr.append(clause)
		    .append(" tipoCompDoc.decTipoStrutDoc.idTipoStrutDoc = :idTipoStrutDoc");
	    clause = " AND ";
	}
	if (filterValid) {
	    queryStr.append(clause).append(
		    " tipoCompDoc.dtIstituz <= :filterDate AND tipoCompDoc.dtSoppres >= :filterDate ");
	}
    ...
    public List<DecTipoCompDoc> getDecTipoCompDocList(Long idStrut, Date data,
	    Long idTipoStrutDoc) {
	String queryStr = "SELECT u FROM DecTipoCompDoc u "
		+ "WHERE u.decTipoStrutDoc.orgStrut.idStrut = :idStrut "
    ...
    public List<DecTipoStrutUnitaDoc> getDecTipoStrutUnitaDocList(BigDecimal idTipoUnitaDoc,
	    boolean filterValid) {
	StringBuilder queryStr = new StringBuilder(
	...
	if (idTipoUnitaDoc != null) {
	    queryStr.append(clause)
		    .append("tipoStrutUnitaDoc.decTipoUnitaDoc.idTipoUnitaDoc = :idTipoUnitaDoc ");
	    clause = " AND ";
	}
	if (filterValid) {
	    queryStr.append(clause).append(
    ...
    public DecTipoStrutUnitaDoc getDecTipoStrutUnitaDocByName(BigDecimal idStrut,
    ...
    public List<DecTipoRapprAmmesso> retrieveDecTipoRapprAmmessoByIdTipoCompDoc(
	    Long idTipoCompDoc) {
	return retrieveDecTipoRapprAmmesso(idTipoCompDoc, null);
    }

    public List<DecTipoRapprAmmesso> retrieveDecTipoRapprAmmessoByIdTipoRapprComp(
	    Long idTipoRapprComp) {
	return retrieveDecTipoRapprAmmesso(null, idTipoRapprComp);
    }

    public List<DecTipoRapprAmmesso> retrieveDecTipoRapprAmmesso(Long idTipoCompDoc,
	    Long idTipoRapprComp) {
    ...
    public DecTipoRapprAmmesso getDecTipoRapprAmmessoByParentId(Long idTipoCompDoc,
	    Long idTipoRapprComp) {
	List<DecTipoRapprAmmesso> list = retrieveDecTipoRapprAmmesso(idTipoCompDoc,
		idTipoRapprComp);
	...
	String queryStr = "SELECT u FROM DecTipoRapprComp u "
    ...
    public DecFormatoFileAmmesso getDecFormatoFileAmmesso(BigDecimal idTipoCompDoc,
