...
public class TipoRappresentazioneEjb {
    ...
    public DecTipoRapprCompRowBean getDecTipoRapprCompRowBean(BigDecimal idTipoRapprComp,
            BigDecimal idStrut) {
        DecTipoRapprCompRowBean tipoRapprCompRowBean = getDecTipoRapprComp(idTipoRapprComp, null,
                idStrut);
        return tipoRapprCompRowBean;
    }

    public DecTipoRapprCompRowBean getDecTipoRapprCompRowBean(String nmTipoRapprComp,
            BigDecimal idStrut) {
        DecTipoRapprCompRowBean tipoRapprCompRowBean = getDecTipoRapprComp(BigDecimal.ZERO,
                nmTipoRapprComp, idStrut);
        return tipoRapprCompRowBean;
    }

    private DecTipoRapprCompRowBean getDecTipoRapprComp(BigDecimal idTipoRapprComp,
            String nmTipoRapprComp, BigDecimal idStrut) {
        ...
        if (tipoRapprComp != null) {
            try {
                ...
                tipoRapprCompRowBean = (DecTipoRapprCompRowBean) Transform
                        .entity2RowBean(tipoRapprComp);
    ...
    public DecTipoRapprCompTableBean getDecTipoRapprCompTableBean(BigDecimal idStrut,
        ...
        try {
            if (!list.isEmpty()) {
                for (DecTipoRapprComp tipoRappr : list) {
                    ...
                    if (tipoRappr.getDtIstituz().before(new Date())
                            && tipoRappr.getDtSoppres().after(new Date())) {
    ...
    public void insertDecTipoRapprComp(LogParam param, DecTipoRapprCompRowBean tipoRapprCompRowBean)
        ...
        if (tipoRapprCompRowBean.getIdFormatoConvertit() != null) {
            formatoConv = helper.findById(DecFormatoFileDoc.class,
                    tipoRapprCompRowBean.getIdFormatoConvertit());
        }
    ...
    public void updateDecTipoRapprComp(LogParam param, BigDecimal idTipoRapprComp,
        ...
        DecTipoRapprComp dbTipoRapprComp = helper.getDecTipoRapprCompByName(
                tipoRapprCompRowBean.getNmTipoRapprComp(), tipoRapprCompRowBean.getIdStrut());
        if (dbTipoRapprComp != null
                && dbTipoRapprComp.getIdTipoRapprComp() != idTipoRapprComp.longValue()) {
            throw new ParerUserError(
                    "Nome Tipo gi\u00E0 associato a questa struttura all'interno del database</br>");
        }
    ...
    public boolean checkRelation(BaseRow rowBean) {
        ...
        if (rowBean instanceof DecTipoRapprCompRowBean) {
            ...
            isRelated = helper
                    .checkRelationsAreEmptyForDecTipoRapprComp(tipoRapprComp.getIdTipoRapprComp());
    ...
    public void deleteDecTipoRapprComp(LogParam param, long idTipoRapprComp) throws ParerUserError {
        ...
        boolean existsRelations = helper
                .checkRelationsAreEmptyForDecTipoRapprComp(tipoRapprComp.getIdTipoRapprComp());
        if (existsRelations) {
            throw new ParerUserError(
        ...
        sacerLogEjb.logAfter(param.getTransactionLogContext(), param.getNomeApplicazione(),
                ...
                param.getNomePagina());
        logger.info("Cancellazione tipo rappresentazione componente " + nmTipoRapprComp
                + " della struttura " + idStrut + " avvenuta con successo!");
    }
    ...
    public DecTrasformTipoRapprTableBean getDecTrasformTipoRapprTableBean(
        ...
        List<DecTrasformTipoRappr> lista = helper.retrieveDecTrasformTipoRapprList(
                decTipoRapprCompRowBean.getIdTipoRapprComp().longValue());
    ...
    public DecTrasformTipoRapprRowBean getDecTrasformTipoRapprRowBean(
            BigDecimal idTrasformTipoRappr) {
        DecTrasformTipoRapprRowBean decTrasformTipoRapprRowBean = null;
        DecTrasformTipoRappr decTrasformTipoRappr = helper.findById(DecTrasformTipoRappr.class,
                idTrasformTipoRappr);
    ...
    public void updateTrasformTipoRappr(LogParam param, DecTrasformTipoRapprRowBean row) {
        ...
        if (row.getBlFileTrasform() == null) {
            ...
            decTrasformTipoRappr
                    .setTiStatoFileTrasform(CostantiDB.StatoFileTrasform.MODIFICATO.name());
        }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    // FIXME: TESTARE
    public void setDecTrasformTipoRapprStatusAtError(LogParam param,
            DecTrasformTipoRapprRowBean row, BigDecimal idTipoRapprComp) {
        BigDecimal idTrasformTipoRappr = row.getIdTrasformTipoRappr();
        DecTrasformTipoRappr decTrasformTipoRappr = helper.findById(DecTrasformTipoRappr.class,
                idTrasformTipoRappr);
        ...
        sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                param.getNomeUtente(), param.getNomeAzione(),
                SacerLogConstants.TIPO_OGGETTO_TIPO_RAPPRESENTAZIONE_COMPONENTE, idTipoRapprComp,
                param.getNomePagina());
    }
    ...
    public DecImageTrasformTableBean getDecImageTrasformTableBean(BigDecimal idTrasformTipoRappr) {
        ...
        String root = null;
        DecTrasformTipoRappr dttr = helper.findById(DecTrasformTipoRappr.class,
                idTrasformTipoRappr);
        ...
        if (lista != null && !lista.isEmpty()) {
            try {
                ...
                String pathTrasformatore = root + "/"
                        + MessaggiWSFormat.formattaSubPathVersatoreArk(vers);
                String prefix = dttr.getDecTipoRapprComp().getNmTipoRapprComp() + "-"
    ...
    public DecImageTrasformRowBean getDecImageTrasformRowBean(BigDecimal idImageTrasform) {
        ...
        DecImageTrasform decImageTrasform = helper.findById(DecImageTrasform.class,
                idImageTrasform);
        if (decImageTrasform != null) {
            BigDecimal idTrasform = new BigDecimal(
                    decImageTrasform.getDecTrasformTipoRappr().getIdTrasformTipoRappr());
            ...
            try {
                ...
                decImageTrasformRowBean = (DecImageTrasformRowBean) Transform
                        .entity2RowBean(decImageTrasform);
                CSVersatore vers = helper.getCSVersatoreForImageTrasform(idImageTrasform);
                String pathImages = root + "/" + MessaggiWSFormat.formattaSubPathVersatoreArk(vers);
                String pathTrasformatore = root + "/"
                        + MessaggiWSFormat.formattaSubPathVersatoreArk(vers);
                String nomeImg = dttr.getDecTipoRapprComp().getNmTipoRapprComp() + "-"
                        + dttr.getNmTrasform() + "-" + dttr.getCdVersioneTrasform() + "-"
                        + decImageTrasform.getNmImageTrasform();
    ...
    public boolean existDecImageTrasformByName(BigDecimal idTrasformTipoRappr, String nameImg) {
        DecImageTrasform decImageTrasform = helper.getDecImageTrasformByName(idTrasformTipoRappr,
                nameImg);
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    // FIXME: TESTARE
    public void updateImageTrasform(LogParam param, DecImageTrasformRowBean row,
    ...
    public void insertImageTrasform(LogParam param, DecImageTrasformRowBean decImageTrasformRowBean,
        ...
        sacerLogEjb.log(param.getTransactionLogContext(), param.getNomeApplicazione(),
                ...
                SacerLogConstants.TIPO_OGGETTO_TIPO_RAPPRESENTAZIONE_COMPONENTE, idTipoRapprComp,
                param.getNomePagina());
        decImageTrasformRowBean
                .setIdImageTrasform(new BigDecimal(decImageTrasform.getIdImageTrasform()));
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    // FIXME: TESTARE
    public void deleteDecImageTrasform(LogParam param, DecImageTrasformRowBean row,
            BigDecimal idTipoRapprComp) {
        BigDecimal idImageTrasform = row.getIdImageTrasform();
        DecImageTrasform decImageTrasform = helper.findById(DecImageTrasform.class,
                idImageTrasform);
    ...
    public String getDownLoadNameForTrasformTipoRappr(BigDecimal idTrasformTipoRappr,
            String nmTrasform, String cdVersioneTrasform) {
        String name = null;
        CSVersatore csVersatoreForTrasform = helper
                .getCSVersatoreForTrasformTipoRappr(idTrasformTipoRappr);
        StringBuilder path = new StringBuilder(
                MessaggiWSFormat.formattaSubPathVersatoreArk(csVersatoreForTrasform));
        path.append("-");
