...
public class FormatoFileDocHelper extends GenericHelper {
    ...
    public DecFormatoFileAmmesso getDecFormatoFileAmmessoByName(String nmFormatoFileDoc, String nmTipoCompDoc,
            String nmTipoStrutDoc, BigDecimal idStrut) {
    ...
    public List<DecFormatoFileDoc> getDecFormatoFileDocListSingoliContenabili(BigDecimal idStrut) {
        String queryStr = "SELECT formatoFileDoc FROM DecFormatoFileDoc formatoFileDoc "
                + "JOIN formatoFileDoc.decUsoFormatoFileStandards uso " + "JOIN uso.decFormatoFileStandard standard "
                + "WHERE formatoFileDoc.orgStrut.idStrut = :idStrut " + "AND standard.flFormatoConcat = '1' "
                + "AND uso.niOrdUso = '1' ";
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idStrut", longFromBigDecimal(idStrut));
        return query.getResultList();
    ...
    public List<Long> getDecFormatoFileAmmessoGestiti(BigDecimal idTipoCompDoc) {
        Query q = getEntityManager().createQuery(
                "SELECT formatoFileAmmesso.idFormatoFileAmmesso " + "FROM DecFormatoFileAmmesso formatoFileAmmesso "
    ...
    public void deleteDecFormatoFileAmmesso(List<Long> idFormatoFileAmmesso) {
        Query q = getEntityManager().createQuery(
                "DELETE FROM DecFormatoFileAmmesso u " + "WHERE u.idFormatoFileAmmesso IN (:idFormatoFileAmmesso) ");
    ...
    public void deleteDecFormatoFileDoc(List<Long> idFormatoFileDoc) {
        Query q = getEntityManager()
                .createQuery("DELETE FROM DecFormatoFileDoc u " + "WHERE u.idFormatoFileDoc IN (:idFormatoFileDoc) ");
        q.setParameter("idFormatoFileDoc", idFormatoFileDoc);
        q.executeUpdate();
        getEntityManager().flush();
    }
    ...
    private static final String FORMATI_STRUTTURA_SPECIFICA = "INSERT /*+ append */ INTO DEC_FORMATO_FILE_DOC (ID_FORMATO_FILE_DOC,ID_STRUT,NM_FORMATO_FILE_DOC,DS_FORMATO_FILE_DOC,CD_VERSIONE,DT_ISTITUZ,DT_SOPPRES) "
            ...
            + "WHERE standard1.fl_formato_concat = '0' " + "AND standard2.fl_formato_concat = '1')tmp)";
    ...
    private static final String USO_SINGOLO_STRUTTURA_SPECIFICA = "INSERT /*+ append */ INTO dec_uso_formato_file_standard "
            + "SELECT " + "SDEC_USO_FORMATO_FILE_STANDARD.nextval, " + "formatoFileDoc.id_formato_file_doc, "
            + "'1' as ni_ord_uso, " + "tab_a.id_formato_file_standard " + "FROM "
            + "dec_formato_file_doc formatoFileDoc " + " CROSS JOIN ( " + "        SELECT " + "            * "
            + "        FROM " + "            dec_formato_file_standard     ) tab_a "
    ...
    private static final String USO_CONCAT1_STRUTTURA_SPECIFICA = "INSERT /*+ append */ INTO dec_uso_formato_file_standard "
            + "SELECT " + "SDEC_USO_FORMATO_FILE_STANDARD.nextval, " + "formatoFileDoc.id_formato_file_doc, "
            + "'1' as ni_ord_uso, " + "(select id_formato_file_standard from dec_formato_file_standard "
            ...
            + "FROM " + "dec_formato_file_doc formatoFileDoc " + "WHERE formatoFileDoc.id_strut = :idStrut "
    ...
    private static final String USO_CONCAT2_STRUTTURA_SPECIFICA = "INSERT /*+ append */ INTO dec_uso_formato_file_standard "
            + "SELECT " + "SDEC_USO_FORMATO_FILE_STANDARD.nextval, " + "formatoFileDoc.id_formato_file_doc, "
            + "'2' as ni_ord_uso, " + "(select id_formato_file_standard from dec_formato_file_standard "
    ...
    private static final String FORMATO_SINGOLO = "INSERT /*+ append */ INTO dec_formato_file_doc " + "    SELECT "
            + "        sdec_formato_file_doc.NEXTVAL, " + "        tab_a.id_strut, "
            + "        nm_formato_file_standard, " + "        ds_formato_file_standard, " + "        cd_versione, "
            + "        TO_DATE('01/01/2011', 'dd/mm/yyyy') dt_istituz, "
            + "        TO_DATE('31/12/2444', 'dd/mm/yyyy') dt_soppres " + "    FROM "
            + "             dec_formato_file_standard a " + "        CROSS JOIN ( " + "            SELECT DISTINCT "
            + "                id_strut " + "            FROM " + "                dec_formato_file_doc "
            + "        ) tab_a " + "    WHERE " + "        id_formato_file_standard = ?1 ";

    private static final String USO_SINGOLO = "INSERT /*+ append */ INTO dec_uso_formato_file_standard " + "SELECT "
            + "SDEC_USO_FORMATO_FILE_STANDARD.nextval, " + "formatoFileDoc.id_formato_file_doc, "
            + "'1' as ni_ord_uso, " + "?1 " + "FROM " + "dec_formato_file_doc formatoFileDoc "
    ...
    private static final String FORMATO_CONCATENATO = "INSERT /*+ append */ INTO dec_formato_file_doc (ID_FORMATO_FILE_DOC,ID_STRUT,NM_FORMATO_FILE_DOC,DS_FORMATO_FILE_DOC,CD_VERSIONE,DT_ISTITUZ,DT_SOPPRES) "
            + "SELECT " + "    sdec_formato_file_doc.NEXTVAL, " + "    tab_b.id_strut, " + "    da_concatenare "
            ...
            + "    dec_formato_file_standard.cd_versione, " + "    TO_DATE('01/01/2011', 'dd/mm/yyyy') dt_istituz, "
            + "    TO_DATE('31/12/2444', 'dd/mm/yyyy') dt_soppres " + "FROM " + "         dec_formato_file_standard "
            + "    CROSS JOIN ( " + "        SELECT " + "            nm_formato_file_standard da_concatenare "
            + "        FROM " + "            dec_formato_file_standard " + "        WHERE "
            + "            fl_formato_concat = 0 " + "    ) tab_a " + "    CROSS JOIN ( " + "         SELECT DISTINCT "
            + "                id_strut " + "            FROM " + "                dec_formato_file_doc "
            + "    ) tab_b " + "WHERE " + "    nm_formato_file_standard = ?1 ";

    private static final String USO_CONCAT1 = "INSERT /*+ append */ INTO dec_uso_formato_file_standard " + "SELECT "
            + "SDEC_USO_FORMATO_FILE_STANDARD.nextval, " + "formatoFileDoc.id_formato_file_doc, "
            + "'1' as ni_ord_uso, " + "(select id_formato_file_standard from dec_formato_file_standard "
            + "where nm_formato_file_standard = SUBSTR(formatoFileDoc.nm_formato_file_doc, 1, INSTR(formatoFileDoc.nm_formato_file_doc, '.')-1)) as id_formato_file_standard "
            + "FROM " + "dec_formato_file_doc formatoFileDoc " + "WHERE formatoFileDoc.nm_Formato_File_Doc LIKE ?1";

    private static final String USO_CONCAT2 = "INSERT /*+ append */ INTO dec_uso_formato_file_standard " + "SELECT "
            + "SDEC_USO_FORMATO_FILE_STANDARD.nextval, " + "formatoFileDoc.id_formato_file_doc, "
            + "'2' as ni_ord_uso, " + "?1 " + "FROM " + "dec_formato_file_doc formatoFileDoc "
    ...
    public String getAmmessiSingoliQuery(String tipoFlag) {
        return "INSERT /*+ append */ INTO dec_formato_file_ammesso " + "SELECT  "
                ...
                + "   tmp.id_tipo_comp_doc,  a.id_formato_file_doc " + "FROM " + "         dec_formato_file_doc a "
                ...
                + "    CROSS JOIN (SELECT * FROM DEC_TIPO_COMP_DOC WHERE " + tipoFlag + " = '1') tmp "
    ...
    public String getAmmessiConcatenatiFlagSpuntatoQueryInsert(String tipoFlag, String tiEsitoContrFormato) {
        ...
        return "INSERT /*+ append */ INTO dec_formato_file_ammesso " + "SELECT  "
                ...
                + "    JOIN dec_tipo_strut_doc tipo_strut_doc on (tipo_strut_doc.id_tipo_strut_doc = tmp.id_tipo_strut_doc) "
                + "WHERE " + "    nm_formato_file_doc LIKE ?1 " + "    AND b.ni_ord_uso = 2 "
                + "AND c.ti_esito_contr_formato = ?2 " + "    AND a.id_strut = tipo_strut_doc.id_strut)tab1";
    }
    ...
    public String getAmmessiSingoloEConcatenatiQueryInsertForUpdateTiControFormato(String oldFlag, String newFlag) {
        ...
        return "INSERT /*+ append */ INTO dec_formato_file_ammesso " + "SELECT  "
                ...
                + "    JOIN dec_uso_formato_file_standard b ON a.id_formato_file_doc = b.id_formato_file_doc "
                + "    JOIN dec_formato_file_standard     c ON b.id_formato_file_standard = c.id_formato_file_standard "
                + "    CROSS JOIN (SELECT * FROM DEC_TIPO_COMP_DOC WHERE " + newFlag + " = '1' AND " + oldFlag
                + " = '0' ) tmp "
                + "    JOIN dec_tipo_strut_doc tipo_strut_doc on (tipo_strut_doc.id_tipo_strut_doc = tmp.id_tipo_strut_doc) "
                + "WHERE " + "    nm_formato_file_doc = ?1 " + "    AND b.ni_ord_uso = 1 "
                + "    AND a.id_strut = tipo_strut_doc.id_strut " + "UNION ALL " + "SELECT "
    ...
    public String getAmmessiSingoloEConcatenatiQueryDeleteForUpdateTiControFormato(String oldFlag, String newFlag) {
        ...
        return "delete from dec_formato_file_ammesso " + "where id_tipo_comp_doc IN "
                + "(select compDoc.id_tipo_comp_doc from dec_tipo_comp_doc compDoc " + "where " + oldFlag + " = 1 "
                + "AND " + newFlag + " = 0)" + "AND id_formato_file_doc IN "
    ...
    public String getQueryDeleteFormatiAmmessi() {
        return "DELETE FROM DEC_FORMATO_FILE_AMMESSO WHERE id_formato_file_ammesso IN (SELECT formato_file_ammesso.id_formato_file_ammesso FROM  DEC_TIPO_COMP_DOC comp_doc "
                ...
                + "UNION ALL " + "SELECT formato_file_ammesso.id_formato_file_ammesso FROM  DEC_TIPO_COMP_DOC comp_doc "
                + "JOIN DEC_FORMATO_FILE_AMMESSO formato_file_ammesso ON (formato_file_ammesso.id_tipo_comp_doc = comp_doc.id_tipo_comp_doc) "
                + "JOIN DEC_FORMATO_FILE_DOC formato_file_doc ON (formato_file_doc.id_formato_file_doc = formato_file_ammesso.id_formato_file_doc) "
                + "JOIN DEC_USO_FORMATO_FILE_STANDARD uso ON (uso.id_formato_file_doc = formato_file_doc.id_formato_file_doc) "
                + "JOIN DEC_FORMATO_FILE_STANDARD formato_file_standard ON (formato_file_standard.id_formato_file_standard = uso.id_formato_file_standard) "
                + "WHERE formato_file_standard.ti_esito_contr_formato = :tiEsitoContrFormato "
                //
                // Vince il ti esito del formato più esterno, per questo la condizione su ni_ord_uso è fatta così
    ...
    public String getQueryInsertFormatiAmmessi() {
        return "INSERT /*+ append */ INTO DEC_FORMATO_FILE_AMMESSO (ID_FORMATO_FILE_AMMESSO,ID_FORMATO_FILE_DOC,ID_TIPO_COMP_DOC)  "
                ...
                + "JOIN DEC_FORMATO_FILE_STANDARD formato_file_standard ON (formato_file_standard.id_formato_file_standard = uso.id_formato_file_standard) "
                + "WHERE formato_file_standard.ti_esito_contr_formato = :tiEsitoContrFormato "
                // Vince il ti esito del formato più interno, per questo la condizione su ni_ord_uso è fatta così
    ...
    public String getQuerySelectFormatiAmmessi() { //
        return "select * from  " + "(select  " + "ammesso.id_formato_file_ammesso as id_formato_file_ammesso, " // getQuerySelectFormatiAmmessi
                ...
                + "AND formato_file_doc.nm_formato_file_doc = formato_file_standard.nm_formato_file_standard "
                + "UNION ALL " + "select  " + "ammesso.id_formato_file_ammesso as id_formato_file_ammesso, "
                + "formato_file_doc.nm_formato_file_doc as nm_formato_file_doc, "
                //
    ...
    public String getQueryFormatiAmmissibiliDaAggiungere(String joinNomeFormato, String whereNomeFormato,
            String whereMimetypeFormato) {
        return "select tmp1.* from     (select  " + "formato_file_doc.id_strut as id_strut, "
                ...
                + "where tmp1.id_strut = :idStrut " + "and NOT EXISTS ( " + "select tmp.* from     (select      "
                ...
                + "                 JOIN DEC_USO_FORMATO_FILE_STANDARD uso ON (uso.id_formato_file_doc = formato_file_doc.id_formato_file_doc)   "
                + "                 JOIN DEC_FORMATO_FILE_STANDARD formato_file_standard ON (formato_file_standard.id_formato_file_standard = uso.id_formato_file_standard)   "
                + joinNomeFormato + "                 where ammesso.id_tipo_comp_doc = :idTipoCompDoc   "
                + whereNomeFormato + whereMimetypeFormato
                + "                 AND uso.ni_ord_uso = (SELECT min(ni_ord_uso) from dec_uso_formato_file_standard uso2 where uso2.id_formato_file_doc = formato_file_doc.id_formato_file_doc)   "
                + "                 AND formato_File_Doc.nm_formato_file_doc LIKE '%.%') tmp "
    ...
    public void insertDecFormatoFileDocStrutturaSpecificaNativeExcludedGiaPresenti(long idStrut) {
        Query query = getEntityManager().createNativeQuery(FORMATI_STRUTTURA_SPECIFICA_ESCLUDI_PRESENTI);
        query.setParameter("idStrut", idStrut);
        query.executeUpdate();
        Query query2 = getEntityManager().createNativeQuery(USO_SINGOLO_STRUTTURA_SPECIFICA_ESCLUDI_PRESENTI);
        query2.setParameter("idStrut", idStrut);
        query2.executeUpdate();
        Query query3 = getEntityManager().createNativeQuery(USO_CONCAT1_STRUTTURA_SPECIFICA_ESCLUDI_PRESENTI);
        query3.setParameter("idStrut", idStrut);
        query3.executeUpdate();
        Query query4 = getEntityManager().createNativeQuery(USO_CONCAT2_STRUTTURA_SPECIFICA_ESCLUDI_PRESENTI);
        query4.setParameter("idStrut", idStrut);
    ...
    public void insertDecFormatoFileDocSingoloNative(long idFormatoFileStandard, String nmFormatoFileStandard) {
        ...
        query2.executeUpdate();
        Query query3 = getEntityManager().createNativeQuery(FORMATO_SINGOLO_AGGIUNGI_CONCATENAZIONI);
    ...
    public void insertDecFormatoFileDocConcatenatiNative(long idFormatoFileStandard, String nmFormatoFileStandard) {
    ...
    public void insertDecFormatoFileAmmessoSingoloNative(String tipoFlag, String nmFormatoFileStandard) {
    ...
    public void insertDecFormatoFileAmmessoConcatenatiNative(String tipoFlag, String nmFormatoFileStandard) {
        Query query = getEntityManager().createNativeQuery(getAmmessiConcatenatiQueryInsert(tipoFlag));
        query.setParameter(1, nmFormatoFileStandard);
        query.executeUpdate();
        getEntityManager().flush();
    }
    ...
    public void insertDecFormatoFileAmmessoSingoloEConcatenatiNative(String tipoFlag, String nmFormatoFileStandard) {
        Query query = getEntityManager().createNativeQuery(getAmmessiSingoloEConcatenatiQueryInsert(tipoFlag));
        query.setParameter(1, nmFormatoFileStandard);
    ...
    public void deleteConcatenazioni(String nmFormatoFileStandard) {
        Query query = getEntityManager()
                .createNativeQuery("DELETE FROM DEC_FORMATO_FILE_DOC " + "WHERE nm_formato_file_doc LIKE ?1 ");
        query.setParameter(1, "%." + nmFormatoFileStandard);
        query.executeUpdate();
        getEntityManager().flush();
    }

    public void deleteOldTiEsitoContrFormato(String oldFlag, String newFlag, String nmFormatoFileStandard) {
        Query query = getEntityManager()
                .createNativeQuery(getAmmessiSingoloEConcatenatiQueryDeleteForUpdateTiControFormato(oldFlag, newFlag));
        query.setParameter(1, "%." + nmFormatoFileStandard);
        query.setParameter(2, nmFormatoFileStandard);
        query.executeUpdate();
        getEntityManager().flush();
    ...
    public void insertNewTiEsitoContrFormato(String oldFlag, String newFlag, String nmFormatoFileStandard) {
        Query query = getEntityManager()
                .createNativeQuery(getAmmessiSingoloEConcatenatiQueryInsertForUpdateTiControFormato(oldFlag, newFlag));
        query.setParameter(1, nmFormatoFileStandard);
        query.setParameter(2, "%." + nmFormatoFileStandard);
        query.executeUpdate();
        getEntityManager().flush();
    ...
    public boolean isFormatoAmmesso(String nmFormatoFileStandard) {
        String nativeQuery = "SELECT " + "    CASE " + "        WHEN EXISTS ( " + "            SELECT"
                + "                1 " + "            FROM "
    ...
    public List<DecFormatoFileDoc> getDecFormatoFileDocPersonalizzati(BigDecimal idStrut) {
        // Recupero i formati personalizzati per la struttura, ovvero quelli con una concatenazione dal terzo livello in
        // su
    ...
    public List<Object[]> getDecFormatoFileDocPersonalizzati2(BigDecimal idStrut) {
        ...
        String queryStr = "SELECT DISTINCT formatoFileDoc.idFormatoFileDoc, formatoFileDoc.nmFormatoFileDoc, formatoFileStandard.nmMimetypeFile,"
                ...
                + "JOIN uso.decFormatoFileDoc formatoFileDoc " + "JOIN uso.decFormatoFileStandard formatoFileStandard "
                + "WHERE uso.niOrdUso >= 3 " + "AND formatoFileDoc.orgStrut.idStrut = :idStrut ";
        Query q = getEntityManager().createQuery(queryStr);
        q.setParameter("idStrut", longFromBigDecimal(idStrut));
    ...
    public List<DecFormatoFileDoc> getDecFormatoFileDocPersonalizzatiTipoComp(BigDecimal idStrut,
        ...
        // Recupero i formati personalizzati per il tipo componente e di conseguenza per la struttura, ovvero quelli con
    ...
    public void insertFormatiAmmessi(long idStrut, BigDecimal idTipoCompDoc, String tiEsitoContrFormato) {
    ...
    public List<Object[]> getFormatiAmmissibiliDaAggiungere(BigDecimal idTipoCompDoc, BigDecimal idStrut,
            String nmFormatoFileStandard, String nmMimetypeFile) {
        ...
        Query query = getEntityManager()
                .createNativeQuery(getQueryFormatiAmmissibiliDaAggiungere(joinFormati, whereFormati, whereMimetype));
        query.setParameter("idTipoCompDoc", longFromBigDecimal(idTipoCompDoc));
        query.setParameter("idStrut", longFromBigDecimal(idStrut));
