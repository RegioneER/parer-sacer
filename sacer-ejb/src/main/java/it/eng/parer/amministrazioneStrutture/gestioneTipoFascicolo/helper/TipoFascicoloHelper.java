...
public class TipoFascicoloHelper extends GenericHelper {
    ...
    public List<DecTipoFascicolo> getDecTipoFascicoloList(BigDecimal idStrut, boolean filterValid) {
        ...
        if (filterValid) {
            queryStr.append(whereClause).append(
                    "tipoFascicolo.dtIstituz <= :filterDate AND tipoFascicolo.dtSoppres >= :filterDate ");
        }
    ...
    public List<DecTipoFascicolo> getTipiFascicoloAbilitati(long idUtente, BigDecimal idStrut,
            boolean filterValid) {
        StringBuilder queryStr = new StringBuilder(
        ...
        if (filterValid) {
            queryStr.append(
                    "AND tipoFascicolo.dtIstituz <= :filterDate AND tipoFascicolo.dtSoppres >= :filterDate ");
        }
     ...
     */
    public boolean isTipoFascicoloAbilitato(long idUtente, BigDecimal idStrut,
            BigDecimal idTipoFascicolo, boolean filterValid) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT tipoFascicolo FROM DecTipoFascicolo tipoFascicolo, IamAbilTipoDato iatd "
                        + "WHERE iatd.idTipoDatoApplic = tipoFascicolo.idTipoFascicolo "
                        + "AND iatd.nmClasseTipoDato = '" + Constants.TipoDato.TIPO_FASCICOLO + "' "
    ...
    public List<DecAaTipoFascicolo> getDecAaTipoFascicoloList(BigDecimal idTipoFascicolo) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT aaTipoFascicolo FROM DecAaTipoFascicolo aaTipoFascicolo ");
        String whereClause = " WHERE ";
        if (idTipoFascicolo != null) {
            queryStr.append(whereClause)
                    .append("aaTipoFascicolo.decTipoFascicolo.idTipoFascicolo = :idTipoFascicolo ");
        }
    ...
    public List<DecCriterioRaggrFasc> getDecCriterioRaggrFascList(BigDecimal idTipoFascicolo) {
        ...
        if (idTipoFascicolo != null) {
            queryStr.append(whereClause).append(
                    "selCritRaggrFasc.decTipoFascicolo.idTipoFascicolo = :idTipoFascicolo ");
            whereClause = " AND ";
        }
    ...
    public boolean existsDecTipoFascicoloCaseInsensitive(BigDecimal idStrut,
    ...
    public boolean existsDecCriterioRaggrFascStandard(BigDecimal idStrut,
        ...
        if (idStrut != null && idTipoFascicolo != null) {
            ...
            throw new IllegalArgumentException(
                    "Identificativo struttura e/o id tipo fascicolo nulli");
        }
    }
    ...
    public List<DecModelloXsdFascicolo> retrieveDecModelloXsdFascicolo(BigDecimal idAmbiente,
        ...
        if (idAmbiente != null) {
            queryStr.append(whereClause)
                    .append("modelloXsdFascicolo.orgAmbiente.idAmbiente = :idAmbiente ");
            whereClause = " AND ";
        }
        if (data != null) {
            queryStr.append(whereClause).append(
        ...
        final List<it.eng.parer.entity.constraint.DecModelloXsdFascicolo.TiModelloXsd> tiModelloXsd = Arrays
                ...
                .map(c -> it.eng.parer.entity.constraint.DecModelloXsdFascicolo.TiModelloXsd
                        .valueOf(c.name()))
    ...
    public List<DecParteNumeroFascicolo> getDecParteNumeroFascicoloList(
    ...
    public DecErrAaTipoFascicolo getDecErrAaTipoFascicolo(BigDecimal idAaTipoFascicolo,
            Integer aaFascicolo) {
    ...
    public List<DecUsoModelloXsdFasc> getDecUsoModelloXsdFascList(BigDecimal idAaTipoFascicolo,
        ...
        if (idAaTipoFascicolo != null) {
            queryStr.append(whereWord).append(
                    "usoModelloXsdFasc.decAaTipoFascicolo.idAaTipoFascicolo = :idAaTipoFascicolo ");
            whereWord = " AND ";
        }
        if (idModelloXsdFascicolo != null) {
            queryStr.append(whereWord).append(
                    "usoModelloXsdFasc.decModelloXsdFascicolo.idModelloXsdFascicolo = :idModelloXsdFascicolo ");
            whereWord = " AND ";
        }
        if (flStandard != null) {
    ...
    public boolean existPeriodiValiditaSovrappostiFascicoli(BigDecimal idAaTipoFascicoloExcluded,
        ...
        if (idAaTipoFascicoloExcluded != null) {
            queryStr.append(
                    " AND aaTipoFascicolo.idAaTipoFascicolo != :idAaTipoFascicoloExcluded )");
        } else {
            queryStr.append(")");
        }
        Query query = getEntityManager().createQuery(queryStr.toString());
        if (idAaTipoFascicoloExcluded != null) {
            query.setParameter("idAaTipoFascicoloExcluded",
                    longFromBigDecimal(idAaTipoFascicoloExcluded));
        }
        query.setParameter("idTipoFascicolo", idTipoFascicolo.longValue());
    ...
    public List<String> getNmAttribFascList(BigDecimal idAaTipoFascicolo,
            BigDecimal idTipoFascicolo) {
        StringBuilder queryStr = new StringBuilder(
        ...
        if (idTipoFascicolo != null) {
            queryStr.append(clause)
                    .append("attribFascicolo.decTipoFascicolo.idTipoFascicolo= :idTipoFascicolo");
        }
     ...
     */
    public DecModelloXsdAttribFascicolo getDecXsdAttribFascicoloByAttrib(
            BigDecimal idAttribFascicolo, BigDecimal idXsdFascicolo) {
    ...
    /**
     *
     * @param idAttribFascicolo id Attributo fascicolo
     *
     * @return DecModelloXsdAttribFascicolo
     */
    public DecModelloXsdAttribFascicolo getDecModelloXsdAttribFascicoloByAttrib(
    ...
    /**
     *
     * @param idAaTipoFascicolo     id periodo di validita fascicolo
     ...
     */
    public List<DecModelloXsdFascicolo> getDecModelloXsdFascicoloByTiModelloXsd(
            String tiModelloXsd) {
     ...
     * @return lista di elementi di tipo DecModelloXsdFascicolo
     */
    public List<DecModelloXsdFascicolo> getDecModelloXsdFascicoloByTiModelloXsdDetail(
            String tiModelloXsd) {
        return getDecModelloXsdFascicolo(tiModelloXsd, false);
    }

    private List<DecModelloXsdFascicolo> getDecModelloXsdFascicolo(String tiModelloXsd,
            boolean withDateFilter) {
        ...
        query.setParameter("tiModelloXsd",
                it.eng.parer.entity.constraint.DecModelloXsdFascicolo.TiModelloXsd
                        .valueOf(tiModelloXsd));
     ...
     *
     * @param nmTipoFascicolo nome tipo fascicolo
    ...
    public DecTipoFascicolo getDecTipoFascicoloByName(String nmTipoFascicolo, BigDecimal idStrut) {
        Query query = getEntityManager()
                .createQuery("SELECT tipoFascicolo FROM DecTipoFascicolo tipoFascicolo "
    ...
    public DecAaTipoFascicolo getDecAaTipoFascicoloByAaIni(BigDecimal idStrut,
            String nmTipoFascicolo, BigDecimal aaIniTipoFascicolo) {
    ...
    public DecSelCriterioRaggrFasc getDecSelCriterioRaggrFasc(BigDecimal idStrutturaCorrente,
            String nmCriterioRaggr, String nmTipoFascicolo) {
