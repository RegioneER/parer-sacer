...
public class ModelliXsdUdEjb {
     ...
     *
     * @param idTipoUniDoc    id tipo unita documentaria
     * @param tiUsoModelloXsd tipo uso modello xsd
     *
    ...
    /**
     * Resitutisce il dettaglio di un modello a partire dall'Id del modello e dall'id del tipo unità
     * documentaria
     *
     * @param idTipoUniDoc    id tipo unità doc
     * @param idModelloXsdUd  id modello xsd
     * @param tiUsoModelloXsd tipo uso modello xsd
     * @param cdXsd           versione modello xsd
     *
     * @return row bean
     */
     ...
     * @param tiUsoModello tipo uso modello
     *
     * @return table bean
     */
     ...
     *
     * @param param               log param
     * @param modelloXsdUdRowBean row bean
     *
    ...
    /**
     * Verifica se per il tipo entita sacer (UNI_DOC) esiste un modello standard in uso che non sia
     * idModelloXsdUd (lambda filter)
     *
     * @param idTipoUniDoc    id tipo uni doc
     * @param idModelloXsdUd  id modello xsd
     * @param tiUsoModelloXsd tipo uso modello xsd
     *
    ...
    /**
     * Verifica se per il tipo entita sacer (DOC) esiste un modello standard in uso che non sia
     * idModelloXsdUd (lambda filter)
     *
     * @param idTipoDoc       id tipo doc
     * @param idModelloXsdUd  id modello xsd
     ...
     * @param tiUsoModelloXsd tipo uso modello xsd
     * @param cdXsd           versione modello xsd
     * @param filterValid     true se nel periodo di valità / false altrimenti
     *
     * @return row bean
     */
     ...
     * Restituisce il row bean del modello
     *
     * @param idModelloXsdUd id modello xsd ud
     *
     * @return row bean
     */
     ...
     *
     * @param param               parametro logging
     * @param modelloXsdUdRowBean row bean del modello
     *
     * @throws ParerUserError eccezione generica
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
     ...
     * @param idTipoUniDoc      id topo unita documentaria
     * @param idUsoModelloXsdUd id uso modello xsd
     *
     * @throws ParerUserError eccezione generica
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
     ...
     * @param idStrut           id struttura
     * @param idTipoDoc         id tipo documento
     * @param idUsoModelloXsdUd id uso modello
     *
     * @throws ParerUserError eccezione generica
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
     ...
     * Verifica se il modello in uso nel tipo UNI_DOC
     *
     * @param idModelloXsdUd id modello
     *
     * @return true se esiste almeno una sessione di versamento / false altrimenti
     */
     ...
     *
     * @param filtriModelliXsdUd filtro modelli xsd
     * @param idAmbientiToFind   lista con id ambiente
