...
public class AmbientiHelper extends GenericHelper {
    ...
    public List<SIOrgEnteSiam> getEntiConvenzionatiAbilitati(long idUserIamCor, BigDecimal idAmbienteEnteConvenz) {
        ...
        for (OrgVRicEnteConvenzByEsterno ricEnteConvenz : ricEnteConvenzList) {
            entiSiamList.add(this.findById(SIOrgEnteSiam.class, ricEnteConvenz.getId().getIdEnteConvenz()));
        }
        return entiSiamList;
    }
    ...
    public OrgVRicEnteConvenzByEsterno findOrgVRicEnteConvenzByEsterno(BigDecimal idEnteConvenz) {
        ...
        final TypedQuery<OrgVRicEnteConvenzByEsterno> query = getEntityManager().createQuery(
                "SELECT e FROM OrgVRicEnteConvenzByEsterno e WHERE e.id.idEnteConvenz = :" + idEnteConvenzParam,
                OrgVRicEnteConvenzByEsterno.class);
        query.setParameter(idEnteConvenzParam, idEnteConvenz);
        query.setFirstResult(0);
        query.setMaxResults(1);
        // ritorna il primo risultato, questa vista fornisce record tutti uguali fatto salvo l'idUserCor che in questo
