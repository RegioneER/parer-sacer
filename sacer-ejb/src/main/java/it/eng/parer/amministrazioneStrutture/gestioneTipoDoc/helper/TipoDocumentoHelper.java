...
public class TipoDocumentoHelper extends GenericHelper {
     ...
     *
     * @param nmTipoDoc nome tipo documento
    ...
    /**
     * Recupera i tipi documento: tutti quelli non principali; solo quelli abilitati per l'utente se
     * si tratta invece di documenti principali
     *
    ...
    /**
     * Recupera i tipi documento: solo quelli abilitati per l'utente se si tratta invece di
    ...
    /**
     * Restituisce il tablebean contenente la lista dei TIPI DOCUMENTO ABILITATI per l'utente
     * corrente sulle strutture selezionate
     *
     * @param idUtente        id utente
     * @param idStrutturaList lista id struttura
     * @param docPrincipale   documento principale true/false
     *
