...
public class DatiSpecificiHelper extends GenericHelper {
     ...
     * @param nmAttribDatiSpec nome dell'attributo
     * @param tiEntitaSacer    tipo di entita di Sacer
     * @param tiUsoAttrib      tipo di uso dell'attributo (MIGRAZ, VERS)
     * @param idTipoUnitaDoc   se esistente, id del tipo ud
     * @param idTipoDoc        se esistente, id del tipo documento
     * @param idTipoCompDoc    se esistente, id del tipo componente
     * @param nmSistemaMigraz  sistema migrazione
     *
     * @return DecAttribDatiSpec o null se inesistente
     */
    public DecAttribDatiSpec getDecAttribDatiSpecById(Long idStrut, String nmAttribDatiSpec,
            String tiEntitaSacer, String tiUsoAttrib, Long idTipoUnitaDoc, Long idTipoDoc,
            Long idTipoCompDoc, String nmSistemaMigraz) {
        StringBuilder builder = new StringBuilder(
                "SELECT attribDatiSpec FROM DecAttribDatiSpec attribDatiSpec "
        ...
        if (StringUtils.isNotBlank(tiUsoAttrib)
                && (tiUsoAttrib.equals(CostantiDB.TipiUsoDatiSpec.MIGRAZ.name())
            ...
            case UNI_DOC:
                builder.append(
                        "AND attribDatiSpec.decTipoUnitaDoc.idTipoUnitaDoc = :idTipoUnitaDoc ");
                break;
            case DOC:
    ...
    public DecAttribDatiSpec getDecAttribDatiSpecById(BigDecimal idStrut, String nmAttribDatiSpec,
            String tiEntitaSacer, String tiUsoAttrib, Long idTipoUnitaDoc, Long idTipoDoc,
            Long idTipoCompDoc) {
        return getDecAttribDatiSpecById(idStrut.longValue(), nmAttribDatiSpec, tiEntitaSacer,
                tiUsoAttrib, idTipoUnitaDoc, idTipoDoc, idTipoCompDoc, null);
    }

    public DecAttribDatiSpec getDecAttribDatiSpecById(BigDecimal idStrut, String nmAttribDatiSpec,
            String tiEntitaSacer, String tiUsoAttrib, BigDecimal idTipoUnitaDoc,
            BigDecimal idTipoDoc, BigDecimal idTipoCompDoc) {
        return getDecAttribDatiSpecById(idStrut.longValue(), nmAttribDatiSpec, tiEntitaSacer,
                tiUsoAttrib, (idTipoUnitaDoc != null ? idTipoUnitaDoc.longValue() : null),
    ...
    public DecAttribDatiSpec getDecAttribDatiSpecById(Long idStrut, String nmAttribDatiSpec,
            String tiEntitaSacer, String tiUsoAttrib, String nmSistemaMigraz) {
        return getDecAttribDatiSpecById(idStrut, nmAttribDatiSpec, tiEntitaSacer, tiUsoAttrib, null,
                null, null, nmSistemaMigraz);
    }
     ...
     * @param tiEntitaSacer    tipo di entita di Sacer
     * @param tiUsoAttrib      tipo di uso dell'attributo (MIGRAZ, VERS)
     * @param nmTipoUnitaDoc   se esistente, nome del tipo ud
     * @param nmTipoDoc        se esistente, nome del tipo documento
     * @param nmTipoCompDoc    se esistente, nome del tipo componente
     * @param nmSistemaMigraz  sistema migrazione
     *
     * @return DecAttribDatiSpec o null se inesistente
     */
    public DecAttribDatiSpec getDecAttribDatiSpecByName(Long idStrut, String nmAttribDatiSpec,
            String tiEntitaSacer, String tiUsoAttrib, String nmTipoUnitaDoc, String nmTipoDoc,
            String nmTipoCompDoc, String nmSistemaMigraz) {
        StringBuilder builder = new StringBuilder(
                "SELECT attribDatiSpec FROM DecXsdAttribDatiSpec xsdAttrib "
    ...
    public DecAttribDatiSpec getDecAttribDatiSpecByName(BigDecimal idStrutCorrente,
            String tiUsoAttrib, String tiEntitaSacer, String nmTipoUnitaDoc, String nmTipoDoc,
            String nmTipoCompDoc, String nmTipoStrutDoc, String nmAttribDatiSpec) {
        String queryStr = "SELECT attribDatiSpec FROM DecAttribDatiSpec attribDatiSpec ";

        if (nmTipoUnitaDoc != null) {
            queryStr = queryStr
                    + "WHERE attribDatiSpec.decTipoUnitaDoc.orgStrut.idStrut = :idStrutCorrente "
                    + "AND attribDatiSpec.decTipoUnitaDoc.nmTipoUnitaDoc = :nmTipoUnitaDoc ";
        }

        if (nmTipoDoc != null) {
            queryStr = queryStr
                    + "WHERE attribDatiSpec.decTipoDoc.orgStrut.idStrut = :idStrutCorrente "
    ...
    public DecAttribDatiSpec getDecAttribDatiSpecByName(BigDecimal idStrut, String nmAttribDatiSpec,
            String tiEntitaSacer, String tiUsoAttrib, String nmTipoUnitaDoc, String nmTipoDoc,
            String nmTipoCompDoc) {
        return DatiSpecificiHelper.this.getDecAttribDatiSpecByName(idStrut.longValue(),
                nmAttribDatiSpec, tiEntitaSacer, tiUsoAttrib, nmTipoUnitaDoc, nmTipoDoc,
                nmTipoCompDoc, null);
    }
    ...
    public DecAttribDatiSpec getDecAttribDatiSpecByName(BigDecimal idStrut, String nmAttribDatiSpec,
            String tiEntitaSacer, String tiUsoAttrib, String nmSistemaMigraz) {
        return DatiSpecificiHelper.this.getDecAttribDatiSpecByName(idStrut.longValue(),
                nmAttribDatiSpec, tiEntitaSacer, tiUsoAttrib, null, null, null, nmSistemaMigraz);
    }

    public List<DecAttribDatiSpec> getPreviousVersionAttributesList(BigDecimal idXsdDatiSpec,
            BigDecimal idTipoUnitaDoc, BigDecimal idTipoDoc, BigDecimal idTipoCompDoc) {
        return getWhichAttributesList(idXsdDatiSpec, idTipoUnitaDoc, idTipoDoc, idTipoCompDoc,
                true);
    }

    public List<DecAttribDatiSpec> getWhichAttributesList(BigDecimal idXsdDatiSpec,
            BigDecimal idTipoUnitaDoc, BigDecimal idTipoDoc, BigDecimal idTipoCompDoc,
            boolean previous) {
    ...
    public List<String> getNmAttribDatiSpecList(BigDecimal idStrut, BigDecimal idTipoUnitaDoc,
            BigDecimal idTipoDoc, BigDecimal idTipoCompDoc, String tiEntitaSacer,
        ...
        if (idTipoDoc != null) {
            ...
            queryStr.append(clause)
                    .append("attribDatiSpec.decTipoUnitaDoc.idTipoUnitaDoc= :idTipoUnitaDoc");
        } else if (idTipoCompDoc != null) {
            queryStr.append(clause)
                    .append("attribDatiSpec.decTipoCompDoc.idTipoCompDoc= :idTipoCompDoc");
            ...
            throw new IllegalArgumentException(
                    "Parametri per ottenere gli attributi dati specifici non corretti");
        }
    ...
    /**
     * Ritorna l'attributo dei dati specifici per i parametri selezionati, all'ultima versione
     * esistente del xsd
     *
     * @param idStrut          id della struttura
     * @param nmAttribDatiSpec nome dell'attributo
     ...
     *
     * @param idStrut         id della struttura
     * @param tiUsoXsd        uso xsd
     * @param tiEntitaSacer   tipo di entita di Sacer
     * @param nmSistemaMigraz sistema migrazione
     *
     * @return la lista di xsd per i dati specifici
     */
    public List<DecXsdDatiSpec> retrieveDecXsdDatiSpecList(BigDecimal idStrut, String tiUsoXsd,
            String tiEntitaSacer, String nmSistemaMigraz) {
        return retrieveDecXsdDatiSpecList(idStrut, tiUsoXsd, tiEntitaSacer, null, null, null,
                nmSistemaMigraz);
    }

    public List<DecXsdDatiSpec> retrieveDecXsdDatiSpecList(BigDecimal idStrut, String tiUsoXsd,
            String tiEntitaSacer, BigDecimal idTipoUnitaDoc, BigDecimal idTipoDoc,
            BigDecimal idTipoCompDoc) {
        return retrieveDecXsdDatiSpecList(idStrut, tiUsoXsd, tiEntitaSacer, idTipoUnitaDoc,
                idTipoDoc, idTipoCompDoc, null);
    }

    public List<DecXsdDatiSpec> retrieveDecXsdDatiSpecList(BigDecimal idStrut, String tiUsoXsd,
            String tiEntitaSacer, BigDecimal idTipoUnitaDoc, BigDecimal idTipoDoc,
            BigDecimal idTipoCompDoc, String nmSistemaMigraz) {
        String clause = " AND ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT xsdDatiSpec FROM DecXsdDatiSpec xsdDatiSpec "
                        + "WHERE xsdDatiSpec.orgStrut.idStrut = :idStrut "
                        + "AND xsdDatiSpec.tiUsoXsd = :tiUsoXsd "
                        + "AND xsdDatiSpec.tiEntitaSacer = :tiEntitaSacer ");

        if (tiUsoXsd.equals(CostantiDB.TipiUsoDatiSpec.MIGRAZ.name())
                && StringUtils.isNotBlank(nmSistemaMigraz)) {
            ...
            if (idTipoDoc != null) {
                ...
                queryStr.append(clause)
                        .append("xsdDatiSpec.decTipoCompDoc.idTipoCompDoc = :idTipoCompDoc");
            }
        }
    ...
    public DecXsdDatiSpec getDecXsdDatiSpecByVersion(DecXsdDatiSpecRowBean xsdDatiSpec) {
        ...
        if (xsdDatiSpec.getNmSistemaMigraz() != null) {
            queryStr.append(" AND xsdDatiSpec.orgStrut.idStrut=:idStrut "
                    + " AND xsdDatiSpec.tiEntitaSacer = :tiSacerType "
        ...
        if (xsdDatiSpec.getNmSistemaMigraz() != null) {
            ...
            if (xsdDatiSpec.getIdTipoDoc() != null) {
                ...
                query.setParameter("idTipoUnitaDoc",
                        longFromBigDecimal(xsdDatiSpec.getIdTipoUnitaDoc()));
            } else if (xsdDatiSpec.getIdTipoCompDoc() != null) {
                query.setParameter("idTipoCompDoc",
                        longFromBigDecimal(xsdDatiSpec.getIdTipoCompDoc()));
            }
    ...
    public List<DecXsdDatiSpec> retrieveDecXsdDatiSpecList(OrgStrut strut, String tiUsoXsd,
            String tiEntitaSacer, BigDecimal idTipoUnitaDoc, BigDecimal idTipoDoc,
            BigDecimal idTipoCompDoc, String nmSistemaMigraz) {
        String clause = " AND ";
        StringBuilder queryStr = new StringBuilder(
                "SELECT xsdDatiSpec FROM DecXsdDatiSpec xsdDatiSpec "
                        + "WHERE xsdDatiSpec.orgStrut = :strut"
                        + "AND xsdDatiSpec.tiUsoXsd = :tiUsoXsd "
                        + "AND xsdDatiSpec.tiEntitaSacer = :tiEntitaSacer ");
    ...
    public boolean checkRelationsAreEmptyForDecXsdDatiSpec(long idXsdDatiSpec) {
        ...
        String queryStr = " select a from DecXsdDatiSpec a  "
                + " where a.idXsdDatiSpec=:idXsdDatiSpec "
    ...
    public boolean campiRegoleInUso(BigDecimal idXsdDatiSpec) {
        Query query = getEntityManager().createQuery(
                "SELECT COUNT(xsdAttrib.decAttribDatiSpec) FROM OrgCampoValSubStrut campo "
     ...
     */
    public DecXsdAttribDatiSpec getDecXsdAttribDatiSpecByAttrib(BigDecimal idAttribDatiSpec,
    ...
    public DecXsdAttribDatiSpec getMigrazDecXsdAttribDatiSpecByNameAndXsdId(String nmAttribDatiSpec,
            BigDecimal idStrut, String nmSistemaMigraz, String tiSacerType,
            BigDecimal idXsdDatiSpec) {
        String queryStr = "SELECT e FROM DecXsdAttribDatiSpec e JOIN e.decAttribDatiSpec a "
                + "WHERE a.nmAttribDatiSpec= :nmAttribDatiSpec "
                + "AND a.tiEntitaSacer LIKE :tiSacerType "
                + "AND a.nmSistemaMigraz LIKE :nmSistemaMigraz "
                + "AND a.orgStrut.idStrut = :idStrut "
    ...
    public DecXsdAttribDatiSpec getDecXsdAttribDatiSpecByNameAndXsdId(String nmAttribDatiSpec,
    ...
    public void deleteDecXsdDatiSpecMigraz(long idStrut) {
        Query q = getEntityManager().createQuery("DELETE FROM DecXsdDatiSpec xsdDatiSpec "
                + "WHERE xsdDatiSpec.orgStrut.idStrut = :idStrut "
                + "AND xsdDatiSpec.tiUsoXsd = 'MIGRAZ' ");
    ...
    /**
     * Ritorna lo xsd per i dati specifici dati i parametri in input NB. E' brutto creare un rowBean
     * così, purtroppo fare un overloading non era possibile a causa dell'uguaglianza dei tipi
     * parametro
     *
     ...
     *
     * @param idStrut       struttura
     * @param idTipoCompDoc tipo componente
     *
     ...
     *
     * @param idStrut   struttura
     * @param idTipoDoc tipo documento
     *
     ...
     *
     * @param xsdDatiSpecRowBean Bean contenente i parametri
     *
     * @return la lista di xsd per i dati specifici
     */
    public DecXsdDatiSpec getLastDecXsdDatiSpec(DecXsdDatiSpecRowBean xsdDatiSpecRowBean) {
        ...
        /*
         * Bisogna fare una subQuery con gli stessi dati, per ottenere il record con la massima
         * data. Questa è l'idea più veloce che mi sia venuta, in sostanza alla fine diventerà così
         * :
         *
         * 'AND xsdDatiSpec.dtIstituz = (SELECT MAX(subQuery.dtIstituz) FROM .... *stessi parametri
         * inseriti prima*)
         *
         */
        ...
        String subQuery2 = queryStr.toString()
                .replaceFirst("SELECT xsdDatiSpec FROM",
                        "SELECT MAX(xsdDatiSpec.cdVersioneXsd) FROM")
        ...
        if (StringUtils.isNotBlank(xsdDatiSpecRowBean.getNmSistemaMigraz())) {
            ...
            if (xsdDatiSpecRowBean.getIdTipoDoc() != null) {
                query.setParameter("idTipoDoc",
                        longFromBigDecimal(xsdDatiSpecRowBean.getIdTipoDoc()));
            } else if (xsdDatiSpecRowBean.getIdTipoUnitaDoc() != null) {
                query.setParameter("idTipoUnitaDoc",
                        longFromBigDecimal(xsdDatiSpecRowBean.getIdTipoUnitaDoc()));
            } else if (xsdDatiSpecRowBean.getIdTipoCompDoc() != null) {
                query.setParameter("idTipoCompDoc",
                        longFromBigDecimal(xsdDatiSpecRowBean.getIdTipoCompDoc()));
            }
        }
        Date now = Calendar.getInstance().getTime();
        query.setParameter("filterDate", now);
    ...
    public List<DecAttribDatiSpec> getDecAttribDatiSpecList(BigDecimal idStrut,
            String tiEntitaSacer, BigDecimal idEntity) {
        String entity;
        ...
        String queryStr = "SELECT attribDatiSpec FROM DecXsdAttribDatiSpec xsdAttrib "
                + "JOIN xsdAttrib.decAttribDatiSpec attribDatiSpec "
                + "WHERE attribDatiSpec.tiEntitaSacer = :tiEntitaSacer "
                + "AND attribDatiSpec.orgStrut.idStrut = :idStrut " + "AND attribDatiSpec." + entity
                + ":idEntity " + "AND xsdAttrib.decXsdDatiSpec.dtIstituz = "
                + "(select MAX(d.dtIstituz) FROM DecXsdDatiSpec d "
    ...
    /**
     * Verifico che per qualunque attributo dato specifico riferito all'XSD considerato, esista un
     * campo di tipo come quello/i passato/i nel parametro
     *
     * @param idXsdDatiSpec xsd dati specifici
     * @param tipiCampo     tipo compo (array opzinale)
     *
     * @return true/false
     */
    ...
    // TODO: Sarebbe da rifare meglio in quanto si dà per scontato che solo uno tra nmTipoUnitaDoc,
    // nmTipoDoc ed
    // nmTipocompdoc sia valorizzato
    public DecXsdDatiSpec getDecXsdDatiSpec(BigDecimal idStrutCorrente, String tiUsoXsd,
            String tiEntitaSacer, String nmTipoUnitaDoc, String nmTipoDoc, String nmTipoCompDoc,
            String nmTipoStrutDoc, String nmSistemaMigraz, String cdVersioneXsd) {
        String whereWord = " WHERE ";
        String queryStr = "SELECT xsdDatiSpec FROM DecXsdDatiSpec xsdDatiSpec ";

        if (nmTipoUnitaDoc != null) {
            queryStr = queryStr + whereWord
                    + " xsdDatiSpec.decTipoUnitaDoc.orgStrut.idStrut = :idStrutCorrente "
        ...
        if (nmTipoDoc != null) {
            queryStr = queryStr + whereWord
                    + " xsdDatiSpec.decTipoDoc.orgStrut.idStrut = :idStrutCorrente "
        ...
        queryStr = queryStr + whereWord + " xsdDatiSpec.tiUsoXsd = :tiUsoXsd "
                + "AND xsdDatiSpec.tiEntitaSacer = :tiEntitaSacer "
                + "AND xsdDatiSpec.cdVersioneXsd = :cdVersioneXsd ";
    ...
    public DecTipoStrutUdXsd getDecTipoStrutUdXsdByName(BigDecimal idStrutCorrente,
            String nmTipoStrutUnitaDoc, String tiUsoXsd, String tiEntitaSacer,
            String nmTipoUnitaDoc, String nmSistemaMigraz, String cdVersioneXsd) {
        ...
        if (tiUsoXsd.equals("MIGRAZ")) {
            queryStr = queryStr
                    + "AND tipoStrutUdXsd.decXsdDatiSpec.nmSistemaMigraz = :nmSistemaMigraz ";
        } else {
    ...
    public Long countXsdDatiSpecInUseInTipiSerie(BigDecimal idXsdDatiSpec) {
        String queryStr = "SELECT COUNT(attribDatiSpec) "
                + "FROM DecXsdAttribDatiSpec xsdAttribDatiSpec "
                + "JOIN xsdAttribDatiSpec.decAttribDatiSpec attribDatiSpec "
