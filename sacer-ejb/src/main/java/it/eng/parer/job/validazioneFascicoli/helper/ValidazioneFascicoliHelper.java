...
public class ValidazioneFascicoliHelper extends GenericHelper {
    ...
    public List<ElvElencoVersFascDaElab> getElvElencoVersFascDaElab(long idStrut,
            TiStatoElencoFascDaElab tiStato) {
        String queryStr = "SELECT elencoVersFascDaElab FROM ElvElencoVersFascDaElab elencoVersFascDaElab "
                ...
                + "WHERE elencoVersFascDaElab.tiStato = :tiStato "
                + "AND elencoVersFascDaElab.idStrut = :idStrut "
    ...
    public List<AroUnitaDoc> getUdFascicoloByStatoCons(long idFascicolo,
            String tiStatoConservazione) {
        String queryStr = "SELECT unitaDoc FROM FasUnitaDocFascicolo unitaDocFascicolo "
                + "JOIN unitaDocFascicolo.aroUnitaDoc unitaDoc "
    ...
    public boolean allUdFascicoloStatiConservazione(long idFascicolo,
            List<String> statiConservazione) {
    ...
    public void updateStatoConservazioneUdFascicolo(long idFascicolo, List<String> statiOld,
            String statoNew) {
        Query q = getEntityManager().createQuery(
                "UPDATE AroUnitaDoc unitaDoc SET unitaDoc.tiStatoConservazione = :statoNew "
    ...
    public boolean allAipFascInCoda(long idElencoVersFasc) {
        ElvVChkAllAipFascInCoda chkAllAipFascInCoda = getEntityManager()
                .find(ElvVChkAllAipFascInCoda.class, BigDecimal.valueOf(idElencoVersFasc));
    ...
    public VolVolumeConserv getVolumeUnitaDocPerDataMarcatura(long idUnitaDoc) {
        Query q = getEntityManager().createQuery(
                "SELECT volumeConserv FROM VolAppartUnitaDocVolume appartUnitaDocVolume "
                        + "JOIN appartUnitaDocVolume.volVolumeConserv volumeConserv "
                        + "JOIN appartUnitaDocVolume.aroUnitaDoc unitaDoc "
    ...
    public FasVLisUdByFasc getFasVLisUdByFasc(long idFascicolo, long idUnitaDoc) {
        String queryStr = "SELECT lisUdByFasc FROM FasVLisUdByFasc lisUdByFasc "
                + "WHERE lisUdByFasc.id.idFascicolo = :idFascicolo "
                + "AND lisUdByFasc.id.idUnitaDoc = :idUnitaDoc ";
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idFascicolo", bigDecimalFromLong(idFascicolo));
