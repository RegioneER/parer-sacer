...
public class CalcoloContenutoAggMetaEjb {
    ...
    private final org.slf4j.Logger logger = LoggerFactory
            .getLogger(CalcoloContenutoAggMetaEjb.class);
    ...
    private void manageStrut(long idStrut, Date data) {
        // Elimina da tabella MON_CONTA_SES_UPD_UD i record eventualmente presenti relativi alla
        // struttura ed al giorno
        // corrente
        ...
        List<Object[]> objList = monitoraggioAggMetaHelper.getAggMetaPerCalcoloContenuto3(idStrut,
                data);
        ...
        for (Object[] obj : objList) {
            ...
            conta.setMonKeyTotalUd(
                    monitoraggioAggMetaHelper.findById(MonKeyTotalUd.class, (BigDecimal) obj[0]));
        ...
        // Elimina da tabella MON_CONTA_SES_UPD_UD_KO i record eventualmente presenti relativi alla
        // struttura ed al
        // giorno corrente
        ...
        // Seleziona gli aggiornamenti metadati
        List<Object[]> obj2List = monitoraggioAggMetaHelper
                .getSesAggMetaPerCalcoloContenuto3(idStrut, data);
        ...
        for (Object[] obj : obj2List) {
            ...
            conta.setMonKeyTotalUdKo(
                    monitoraggioAggMetaHelper.findById(MonKeyTotalUdKo.class, (BigDecimal) obj[0]));
