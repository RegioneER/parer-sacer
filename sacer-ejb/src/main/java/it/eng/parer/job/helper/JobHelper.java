...
public class JobHelper implements Serializable {
	...
	return writeLogJob(job, opType, descr, idStrut, idRecord, nmTabellaRecord,
		appServerInstance.getName());
    }

    public LogJob writeLogJob(String job, String opType, String descr, Long idRecord,
	    String nmTabellaRecord) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public LogJob writeAtomicLogJob(String job, String opType, String descr, Long idRecord,
	    String nmTabellaRecord) {
	 ...
	 */
	RispostaControlli risp = controlli
