 ...
 * @author Iacolucci_M
 */
@Singleton(mappedName = "PreparaPartizioneDaMigrareTimer4")
@Lock(LockType.READ)
@LocalBean
@Interceptors({ it.eng.parer.aop.TransactionInterceptor.class })
public class PreparaPartizioneDaMigrareTimer4 extends PreparaPartizioneDaMigrareTimerSuperclass {

    @EJB
    private PreparaPartizioneDaMigrareTimer4 thisTimer;
     ...
     */
    public PreparaPartizioneDaMigrareTimer4() {
        super(JobConstants.JobEnum.PREPARA_PARTIZIONE_DA_MIGRARE_4.name());
        numeroJob = 4;
        logger.debug(PreparaPartizioneDaMigrareTimer4.class.getName() + numeroJob + " creato");
    }
