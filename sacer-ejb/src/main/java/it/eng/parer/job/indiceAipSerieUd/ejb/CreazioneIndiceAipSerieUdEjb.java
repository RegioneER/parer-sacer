...
public class CreazioneIndiceAipSerieUdEjb {
    ...
    public void creazioneIndiceAipSerieUd() throws Exception {
        ...
        /*
         * Scrivo nel LogJob la fine corretta dell'esecuzione del job di creazione indice AIP Serie
         * Ud
         */
    ...
    public void manageStrut(BigDecimal idStrut) throws Exception {
        ...
        /*
         * Il sistema determina le versioni correnti delle serie con stato corrente = VALIDATA della
         * struttura versante
         */
        ...
        try {
            for (SerVerSerieDaElab verSerieDaElab : verSerieDaElabList) {
                elaborazioneRigaIndiceAip.gestisciIndiceAipSerieUdDaElab(verSerieDaElab,
            ...
            log.error("{}--- Creazione Indice Aip Versione Serie Ud --- Errore: {}",
                    this.getClass().getSimpleName(), ExceptionUtils.getRootCauseMessage(ex));
