...
public class CreazioneIndiceAipSerieUdUtil {
    ...
    public IdCType generaIndiceAIPSerieUd(SerVerSerieDaElab verSerieDaElab, Date timeRef,
        ...
        popolaIdC(istanzaUnisincro, verSerieDaElab, timeRef, mappaAgenti,
     ...
     *
     * @param idc            entity IdCType
     * @param verSerieDaElab entity SerVerSerieDaElab
     * @param timeRef        timestamp riferimento
     * @param mappaAgenti    mappa chiave/valore
     */
    private void popolaIdC(IdCType idc, SerVerSerieDaElab verSerieDaElab, Date timeRef,
            Map<String, String> mappaAgenti, String creatingApplicationProducer) {
