...
public class AllineamentoEntiConvenzionatiEjb {
     ...
     *            lista oggetti di tipo {@link IamEnteConvenzDaAllinea}
     */
            ...
            try {
                ...
                if (client != null) {
                    ...
                    if (timeoutString != null && timeoutString.matches("^[0-9]+$")) {
                        ...
                        IAMSoapClients.changeRequestTimeout((BindingProvider) client, timeoutAllienaEnteConvenz);
                    } else {
                    ...
                    struttureHelper.writeEsitoIamEnteConvenzDaAllinea(enteConvenzDaAllinea.getIdEnteConvenzDaAllinea(),
                    ...
                    String posNeg = esitoServizio.name().equals(CostantiAllineaEntiConv.EsitoServizio.OK.name())
                            ? "positiva" : "negativa";
                    log.info("Allineamento Ente Convenzionato - Risposta WS " + posNeg + " per l'ente convenzionato "
                            + idEnteConvenz);
                    ...
                    log.error("Allineamento Ente Convenzionato - Risposta WS negativa per l'ente convenzionato "
                            + idEnteConvenz);
                    break;
                }
                ...
                log.error(
                        "Allineamento Ente Convenzionato - Risposta WS negativa per l'ente convenzionato "
                                + idEnteConvenz + " - Utente che attiva il servizio non riconosciuto o non abilitato",
                        e);
                replicaOK = false;
                break;
                ...
                log.error("Allineamento Ente Convenzionato - Risposta WS negativa per l'ente convenzionato "
                        + idEnteConvenz + " - Il servizio di allineamento ente convenzionato non risponde");
                replicaOK = false;
                break;
            } catch (Exception e) {
