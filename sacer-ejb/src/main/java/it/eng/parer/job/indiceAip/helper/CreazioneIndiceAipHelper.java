...
public class CreazioneIndiceAipHelper extends GenericHelper {
    ...
    /**
     * Metodo transazionale per la creazione dell'indice AIP attraverso la memorizzazione dei record
     * nelle apposite entity.
     *
     * @param udDaElab            ud da elaborare
     * @param annoMese            anno e mese
     * @param progressivoVersione progressivo versione
     * @param codiceVersione      codice versione
     * @param hash                valore
     * @param xml                 valore
     * @param versatore           valore
     * @param chiave              ud (anno/registro/numero)
     *
     ...
     * @param annoMese            anno e mese
     * @param progressivoVersione valore progressivo
     * @param codiceVersione      codice versione
     * @param hash                valore
     * @param xml                 valore
     * @param versatore           valore
     * @param chiave              chiave ud (anno/registro/numero)
     *
     * @return entity AroVerIndiceAipUd
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    ...
    // MEV#30395
    /**
     * Metodo transazionale per la memorizzazione del xml dell'indice aip attraverso l'inserimento
     * del record nella ARO_FILE_VER_INDICE_AIP_UD entity.
     *
     * @param verIndiceAip versione indice aip
     * @param annoMese     anno e mese
     * @param xml          indice aip
     *
     ...
     *
     * @param idUnitaDoc     id unita doc
     * @param idVerIndiceAip id versamento indice aip
     *
    ...
    // MAC#27786
    /**
     * Ottienti gli aggiornamenti metadati presenti tramite una count (non più effettuando una
     * fetch).
     *
     * @param idUnitaDoc     id unita doc
     * @param idVerIndiceAip id versamento indice aip
     *
     * @return true se esiste almeno un aggiornamento metadati che soddisfa i requisti. false
     *         altrimenti.
     */
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato dei documenti aggiunti nell'elenco il cui
     * elenco coincide con quello a cui si riferisce l'indice AIP
     *
     * @param idUnitaDoc   id unita doc
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato dei documenti nell'elenco il cui elenco
     * coincide con quello a cui si riferisce l'indice AIP
     *
     * @param idElencoVers  id elenco versamento
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato di gestione dei documenti appartenenti
     * all'elenco e aventi un insieme di stati passati in input
     *
     * @param idElencoVers            id elenco versamento
     * @param tiStatoDocElencoVersOld se null, porta tutte i doc nel nuovo stato di gestione elenco
     * @param tiStatoDocElencoVersNew tipo stato nuovo documento versato
     *
     * @return il numero di record aggiornati
     */
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato degli aggiornamenti metadati nell'elenco il
     * cui elenco coincide con quello a cui si riferisce l'indice AIP
     *
     * @param idUnitaDoc   id unita doc
     * @param idElencoVers id elenco versamento
     * @param stato        entity AroUpdUDTiStatoUpdElencoVers
     *
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato di gestione degli aggiornamenti metadati
     * appartenenti all'elenco e aventi un insieme di stati passati in input
     *
     * @param idElencoVers            id elenco versamento
     * @param tiStatoUpdElencoVersOld tipo stato elenco aggiornato corrente
     * @param tiStatoUpdElencoVersNew tipo stato elenco aggiornato nuovo
     *
     * @return il numero di record aggiornati
     */
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato dei documenti nell'elenco il cui stato di
     * conservazione della relativa ud è DIVERSO da quello passato in input e stato relativo ad
     * elenco UGUALE a quello passato in input
     *
     * @param idElencoVers            id elenco di versamento
     * @param tiStatoConservazione    se null, porta tutte i doc nel nuovo stato di gestione elenco
     * @param tiStatoDocElencoVersCor tipo stato docoumento in elenco
     * @param tiStatoElenco           tipo stato elenco
     *
     * @return il numero di record aggiornati
     */
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato degli aggiornamenti nell'elenco il cui stato
     * di conservazione della relativa ud è DIVERSO da quello passato in input e stato relativo ad
     * elenco UGUALE a quello passato in input
     *
     * @param idElencoVers            id elenco versamento
     * @param tiStatoConservazione    se null, porta tutte i doc nel nuovo stato di gestione elenco
     * @param tiStatoUpdElencoVersCor tipo stato elenco aggiornato su versamento corrente
     * @param tiStatoElenco           tipo stato elenco
     *
     * @return il numero di record aggiornati
     */
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato delle unità documentarie nell'elenco il cui
     * elenco coincide con quello a cui si riferisce l'indice AIP
     *
     * @param idElencoVers  id elenco versamento
     * @param tiStatoElenco tipo stato elenco
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato di gestione delle unità documentarie
     * appartenenti all'elenco e aventi un insieme di stati passati in input
     *
     * @param idElencoVers           id elenco versamento
     * @param tiStatoUdElencoVersOld se null, porta tutte le ud nel nuovo stato di gestione elenco
     * @param tiStatoUdElencoVersNew tipo stato elenco ud nuovo versamento
     *
     * @return il numero di record aggiornati
     */
    ...
    /**
     * Esegue una bulk update per aggiornare lo stato delle unità documentarie nell'elenco il cui
     * stato di conservazione è DIVERSO con quello passato in input e stato relativo ad elenco
     * UGUALE a quello passato in input
     *
     * @param idElencoVers           id elenco versamento
     * @param tiStatoConservazione   tipo stato conservazione
     * @param tiStatoUdElencoVersCor tipo stato ud in elenco versamento corrente
     * @param tiStatoElenco          tipo stato elenco
     *
     * @return il numero di record aggiornati
     */
