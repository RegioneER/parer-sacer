 ...
 * @author Iacolucci_M
 */
@Singleton(mappedName = "ProducerCodaDaMigrareTimer3")
@Lock(LockType.READ)
@LocalBean
@Interceptors({ it.eng.parer.aop.TransactionInterceptor.class })
public class ProducerCodaDaMigrareTimer3 extends ProducerCodaDaMigrareTimerSuperclass {

    @EJB
    private ProducerCodaDaMigrareTimer3 thisTimer;
     ...
     */
    public ProducerCodaDaMigrareTimer3() {
        super(JobConstants.JobEnum.PRODUCER_CODA_DA_MIGRARE_3.name());
        numeroJob = 3;
        logger.debug(ProducerCodaDaMigrareTimer3.class.getName() + numeroJob + " creato");
    }
