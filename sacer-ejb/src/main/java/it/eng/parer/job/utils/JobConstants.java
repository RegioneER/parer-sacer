...
public class JobConstants {
    ...
    public enum JobEnum {
        ...
        // SCARICO_CA,
        // SCARICO_CRL,
        CALCOLO_CONTENUTO_SACER, CALCOLA_STRUTTURA, CALCOLA_CHIAVE_UD_DOC, ALLINEAMENTO_ORGANIZZAZIONI,
        VERIFICA_MASSIVA_VERS_FALLITI, VERIFICA_VERS_FALLITI, CREAZIONE_INDICE_AIP, CREAZIONE_INDICE_AIP_FASC,
        CALCOLO_SERIE, INPUT_SERIE, GENERAZIONE_CONTENUTO_EFFETTIVO_SERIE_UD, CONTROLLA_CONTENUTO_SERIE_UD,
        ...
        CONTROLLO_AUTOMATICO_CONTENUTO_EFFETTIVO, INIZIALIZZAZIONE_LOG, ALLINEAMENTO_LOG, EVASIONE_RICH_ANNUL_VERS,
        CALCOLA_STRUTTURA_JOB, EVASIONE_RICH_REST_ARCH, CREAZIONE_ELENCHI_INDICI_AIP_UD,
