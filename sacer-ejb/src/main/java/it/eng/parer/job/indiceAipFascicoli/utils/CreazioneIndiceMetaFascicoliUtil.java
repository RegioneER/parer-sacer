...
public class CreazioneIndiceMetaFascicoliUtil {
    ...
    public void popolaIndiceMetaFascicolo(Fascicolo indiceMetaFascicolo, FasVVisFascicolo creaMeta,
            String cdXsd) throws DatatypeConfigurationException {
        /***************************************
         ...
         */
        List<FasAmminPartec> fasAmminPartecList = cimfHelper
                .getFasAmminPartec(creaMeta.getIdFascicolo().longValue());
        ...
        for (FasAmminPartec fasAmminPartec : fasAmminPartecList) {
            ...
            if (fasAmminPartec.getDsAmminPartec() != null
                    && fasAmminPartec.getCdAmminPartec() != null
        ...
        for (FasUniOrgRespFascicolo fasUniOrgRespFascicolo : FasUniOrgRespFascicoloList) {
            if (fasUniOrgRespFascicolo.getCdUniOrgResp() != null) {
                uniOrgResponsabili.getUnitaOrganizzativaResponsabile()
                        .add(fasUniOrgRespFascicolo.getCdUniOrgResp());
            }
        }
        ...
        /*
         * |----> CLASSIFICAZIONE ----> [VOCI CLASSIFICAZIONE] SEGNATURA ARCHIVISTICA ---| |---->
        ...
        if (creaMeta.getIdVoceTitol() != null && creaMeta.getCdCompositoVoceTitol() != null) {
            ...
            for (DecValVoceTitol decValVoceTitol : DecValVoceTitolList) {
                ...
                voceClassificazione.setCodiceVoce(cimfHelper
                        .findById(DecVoceTitol.class, creaMeta.getIdVoceTitol()).getCdVoceTitol());
