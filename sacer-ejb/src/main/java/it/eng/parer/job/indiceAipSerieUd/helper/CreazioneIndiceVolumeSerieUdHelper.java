...
public class CreazioneIndiceVolumeSerieUdHelper extends GenericHelper {
    ...
    public SerVolVerSerie registraVolVerSerie(long idVerSerie) {
        ...
        volVerSerie.setPgVolVerSerie(context.getBusinessObject(CreazioneIndiceVolumeSerieUdHelper.class)
    ...
    public SerIxVolVerSerie registraSerIxVolVerSerie(long idVolVerSerie, String cdVerXsdIxVol, String xml, String hash,
            BigDecimal idStrut) {
    ...
    /**
     * Ricava le ud appartenenti al contenuto di tipo EFFETTIVO per le quali la foreign key al volume è nulla
     *
     * @param idVerSerie
     *            id versamento serie
     * 
    ...
    public List<AroUdAppartVerSerie> getUdEffettiveSenzaVolume(Long idVerSerie) {
        String queryStr = "SELECT u FROM AroUdAppartVerSerie u " + "JOIN u.serContenutoVerSerie contenutoVerSerie "
                ...
                + "AND verSerie.idVerSerie = :idVerSerie " + "ORDER BY u.dsKeyOrdUdSerie ";
