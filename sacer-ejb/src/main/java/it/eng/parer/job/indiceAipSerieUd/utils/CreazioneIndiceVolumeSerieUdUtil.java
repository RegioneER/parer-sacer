...
public class CreazioneIndiceVolumeSerieUdUtil {
    ...
    public IndiceVolumeSerie generaIndiceVolumeSerie(SerVCreaIxVolSerieUd creaVol,
	    BigDecimal numeroTotaleVolumi) throws DatatypeConfigurationException {
    ...
    public void popolaIndiceVolumeSerie(IndiceVolumeSerie indiceVolumeSerie,
	    SerVCreaIxVolSerieUd creaVol, BigDecimal numeroTotVolumi)
	...
	// Progressivo volume
	indiceVolumeSerie.setProgressivoVolume(
		(civsudHelper.findById(SerVolVerSerie.class, creaVol.getIdVolVerSerie()))
	...
	if (creaVol.getDsAutoreCriterioOrdinamento() != null) {
	    ...
	    nota.setData(
		    XmlDateUtility.dateToXMLGregorianCalendar(creaVol.getDtCriterioOrdinamento()));
