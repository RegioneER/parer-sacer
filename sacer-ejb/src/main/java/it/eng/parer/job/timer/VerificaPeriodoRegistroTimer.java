...
import it.eng.parer.job.verificaCompRegistro.ejb.VerificaCompRegistroEjb;

/**
 *
 * @author fioravanti_f
 */
@Singleton(mappedName = "VerificaPeriodoRegistroTimer")
@LocalBean
@Lock(LockType.READ)
public class VerificaPeriodoRegistroTimer extends JobTimer {

    private Logger logger = LoggerFactory.getLogger(VerificaPeriodoRegistroTimer.class);

    @EJB
    VerificaPeriodoRegistroTimer thisTimer;
    @EJB
