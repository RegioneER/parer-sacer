...
public class ModelliFascicoliHelper extends GenericHelper {
     ...
     *
     * @param filtriModelliXsdTipiFasc filtro modelli xsd tipo fascicolo
     * @param idAmbienteList           lista id ambiente
     ...
     * Ottiene la lista di modelli xsd abilitati per l'ambiente
     *
     * @param idAmbienteList  lista di ID ambiente
     * @param tiUsoModelloXsd tipo uso del modello Xsd
     * @param filterValid     true per prendere i record attivi attualmente
