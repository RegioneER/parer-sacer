...
public class ElenchiVersFascicoliHelper extends GenericHelper {
	 ...
	 * stati CHIUSO, di molteplici stati FIRMATO, in modo da considerare solo lo stato di
	 * chiusura registrato prima della firma dell'elenco di versamento fascicolo
	 */
	queryStr.append(
