...
public class ConsumerCodaErratiMdb implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            if (migrazFile.getTiStatoCor()
                ...
                //
                migrazFile
                        .setTiStatoCor(it.eng.parer.entity.constraint.OstMigrazFile.TiStatoCor.MIGRAZ_IN_ERRORE.name());
                ...
                registraOstMigrazFileErr(migrazFile, codice, messaggio, hashCalcolato, timeStamp, tipologia.name());
            }
    ...
    private void registraOstMigrazFileErr(OstMigrazFile migrazFile, String codice, String descrizione, String hashCalc,
            long timeStamp, String tipologia) {
