...
public class XAUtil {
     ...
     *
     * @throws XAGenericException                    errore generico Xa
     * @throws DirectoryNotEmptyException            errore generico
     * @throws FileNotExistsException                errore file non presente
     * @throws FileUnderUseException                 errore generico su file
     * @throws InsufficientPermissionOnFileException errore su privilegi accesso file
     * @throws LockingFailedException                errore su lock accesso
     * @throws NoTransactionAssociatedException      errore generico su transazione
