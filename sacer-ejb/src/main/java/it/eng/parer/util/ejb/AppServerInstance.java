    ...
    protected void initSingleton() {
        try {
            ...
            RispostaControlli rispostaControlli = controlliSemantici
                    .caricaDefaultDaDBParametriApplic(CostantiDB.TipoParametroAppl.LOG_APPLIC);
            if (rispostaControlli.isrBoolean() == false) {
                // LOG.fatal("Inizializzazione singleton AppServerInstance fallita! " + rispostaControlli.getDsErr());
            ...
            if (xmlDefaults.get(CostantiDB.ParametroAppl.SERVER_NAME_SYSTEM_PROPERTY) != null) {
                String instance = System
                        .getProperty(xmlDefaults.get(CostantiDB.ParametroAppl.SERVER_NAME_SYSTEM_PROPERTY));
                if (instance != null) {
                    servername += "/" + instance;
                }
            }
            ...
            // LOG.fatal("Inizializzazione singleton AppServerInstance fallita! ", ex);
