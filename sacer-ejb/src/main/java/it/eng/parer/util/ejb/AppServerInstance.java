    ...
    protected void initSingleton() {
        try {
            ...
            if (rispostaControlli.isrBoolean() == false) {
                // LOG.fatal("Inizializzazione singleton AppServerInstance fallita! " +
            ...
            if (xmlDefaults.get(CostantiDB.ParametroAppl.SERVER_NAME_SYSTEM_PROPERTY) != null) {
                String instance = System.getProperty(
                        xmlDefaults.get(CostantiDB.ParametroAppl.SERVER_NAME_SYSTEM_PROPERTY));
                if (instance != null) {
                    servername += "/" + instance;
                }
            }
