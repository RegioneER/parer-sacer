...
public class DisciplinareTecnicoEjb {
    ...
    public byte[] generaDisciplinareTecnicoPDF(long idStrut) throws ParerUserError {
        ...
        try {
            ...
            par = disciplinareTecnicoHelper.getAplParamApplicReportByAppReport(nmApplic,
                    "DISCIPLINARE_TECNICO");
            ...
            if (par != null) {
                ...
                String xmlIntermedio = disciplinareTecnicoHelper.trasformaInXmlIntermedio(risultato,
                        par.getBlFile2());
                // ********** ESTRAE XML FOP *****************
                String xmlFo = disciplinareTecnicoHelper.trasformaInFo(xmlIntermedio,
                        par.getBlFile3());
                // ********** ESTRAE PDF *****************
                ...
                InputSource is = new InputSource(
                        new StringReader(new String(xmlIniziale, "UTF-8")));
        ...
        try {
            ...
            throw new SacerRuntimeException(
                    "ERRORE nella produzione del disciplinare per la struttura " + idStrut, ex,
                    SacerErrorCategory.INTERNAL_ERROR);
        }
        return arrayPDF;
    }
