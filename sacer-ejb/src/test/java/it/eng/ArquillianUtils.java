...
public class ArquillianUtils {
    ...
    public static Archive<WebArchive> createTestArchive(List<String> packages, Class... helperClasses) {
        WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "sacerTest.war");
        webArchive.addPackage(GenericHelper.class.getPackage()).addPackage(AroCompDocRowBean.class.getPackage())
                ...
                .addClass(AroCompDoc.class).addClass(AroStrutDoc.class).addClass(ArquillianUtils.class)
    ...
    public static JavaArchive createSacerJavaArchive(List<String> packages, Class... classes) {
        ...
        sacerEjbArchive.addPackage(GenericHelper.class.getPackage()).addPackage(AroCompDocRowBean.class.getPackage())
                ...
                .addClass(OracleSqlInterceptor.class).addClass(org.springframework.util.Assert.class)
                .addClass(org.springframework.beans.PropertyAccessor.class).addClass(it.eng.ArquillianUtils.class)
                // with subpackages
                .addPackages(true, "it.eng.spagoLite.form", "it.eng.parer.jboss.timer.common", "it.eng.spagoLite.db",
                        "it.eng.parer.entity", "it.eng.parer.grantedEntity", "it.eng.parer.viewEntity",
                        "org.codehaus.jettison.json", "org.apache.commons.fileupload", "org.apache.xmlbeans",
