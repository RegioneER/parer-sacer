...
public class FascicoliHelperTest extends HelperTest<FascicoliHelper> {
    ...
    public static Archive<?> createTestArchive() {
        return HelperTest.createEnterpriseArchive(FascicoliHelperTest.class.getSimpleName(),
                ...
                HelperTest.createSacerJavaArchive(Arrays.asList(""),
                        it.eng.parer.fascicoli.dto.RicercaFascicoliBean.class, FascicoliHelper.class,
                        FascicoliHelperTest.class, ApplEnum.class, ElencoEnums.class));
    }
    ...
    public void retrieveVLisFascKo_queryIsOk() {
        ...
        final CriteriaQuery criteriaQuery = helper.retrieveVLisFascKoCriteriaQuery(idUser, idAmbiente, idEnte, idStrut,
    ...
    public void retrieveVLisFasc_queryIsOk() {
        ...
        BigDecimal idStrut = aBigDecimal();
        BigDecimal idTipoFascicolo = aBigDecimal();
        Date[] dateValidate = { todayTs(), tomorrowTs() };
        BigDecimal rangeAnnoDa = aBigDecimal();
        BigDecimal rangeAnnoA = aBigDecimal();
        String rangeNumeroDa = aString();
        String rangeNumeroA = aString();
        ...
        final CriteriaQuery criteriaQuery = helper.retrieveVLisFascCriteriaQuery(idUser, idAmbiente, idEnte, idStrut,
                idTipoFascicolo, dateValidate, rangeAnnoDa, rangeAnnoA, rangeNumeroDa, rangeNumeroA, statoIndiceAip,
                statiConservazione, flSesFascicoloKo);
        lazyListHelper.getTableBean(criteriaQuery, l -> new BaseTable());
        assertTrue(true);
    }
    ...
    public void existFascicoliVersatiPerTipoFascicolo_queryIsOk() {
        ...
        helper.existFascicoliVersatiPerTipoFascicolo(idTipoFascicolo, aaIniTipoFascicolo, aaFinTipoFascicolo);
        assertTrue(true);
    }
    ...
    public void retrieveMonContaFascicoliByChiaveTotaliz_queryIsOk() {
        ...
        BigDecimal aaFascicolo = aBigDecimal();
        BigDecimal idUserIam = aBigDecimal();
        helper.retrieveMonContaFascicoliByChiaveTotaliz(idStrut, dtRifConta, idTipoFascicolo, aaFascicolo, idUserIam);
        assertTrue(true);
    }
    ...
    public void retrieveMonContaFascicoliNonVersByChiaveTotaliz_queryIsOk() {
        ...
        helper.retrieveMonContaFascicoliNonVersByChiaveTotaliz(idStrut, dtRifConta, idTipoFascicolo, aaFascicolo,
                tiStatoFacicolo);
        assertTrue(true);
    }
    ...
    public void retrieveMonContaFascicoliKoByChiaveTotaliz_queryIsOk() {
        ...
        helper.retrieveMonContaFascicoliKoByChiaveTotaliz(dtRifConta, orgStrut, tiStatoFascicoloKo, anno,
                decTipoFascicolo, false);
        helper.retrieveMonContaFascicoliKoByChiaveTotaliz(dtRifConta, orgStrut, tiStatoFascicoloKo, anno,
                decTipoFascicolo, true);
        assertTrue(true);
    }
    ...
    public void deleteDecSelCriterioRaggrFascNotInVoceTitolo_queryIsOk() {
        helper.deleteDecSelCriterioRaggrFascNotInVoceTitolo(aListOfBigDecimal(2), aDecCriterioRaggrFasc());
        assertTrue(true);
    }
    ...
    public void deleteDecSelCriterioRaggrFascNotInTipoFascicolo_queryIsOk() {
        helper.deleteDecSelCriterioRaggrFascNotInTipoFascicolo(aDecCriterioRaggrFasc(), aListOfBigDecimal(3));
        assertTrue(true);
    }
