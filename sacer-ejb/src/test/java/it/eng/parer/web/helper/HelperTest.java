...
public abstract class HelperTest<T> {
    ...
    public static JavaArchive createPaginatorJavaArchive() {
        final JavaArchive paginatorArchive = ShrinkWrap.create(JavaArchive.class, "paginator.jar")
                .addPackages(true, "it.eng.paginator").addAsResource(
                        HelperTest.class.getClassLoader().getResource("ejb-jar-paginator.xml"),
    ...
    public static JavaArchive createSacerLogJar() {
        return ShrinkWrap.create(JavaArchive.class, "sacerlog.jar")
                .addPackages(true, "it.eng.parer.sacerlog").addAsResource(
                        HelperTest.class.getClassLoader().getResource("ejb-jar-sacerlog.xml"),
                        "META-INF/ejb-jar.xml");
    }
    ...
    public static JavaArchive createSacerJavaArchive(List<String> packages, Class... classes) {
        ...
        sacerEjbArchive.addPackage(GenericHelper.class.getPackage())
                ...
                .addPackage(UsrVAbilAmbEnteConvenz.class.getPackage())
                .addPackage("it.eng.sequences.hibernate").addClass(AroCompDoc.class)
                .addClass(AroStrutDoc.class).addClass(HelperTest.class).addClass(Field.Type.class)
                ...
                .addClass(FascicoliHelperTest.class).addClass(org.springframework.util.Assert.class)
                ...
                .addAsResource(HelperTest.class.getClassLoader().getResource("ejb-jar.xml"),
                        "META-INF/ejb-jar.xml")
                // NO subpackages
                .addPackages(false, "it.eng.parer.slite.gen.viewbean", "org.apache.commons.lang",
                        "org.apache.tools.ant.taskdefs", "it.eng.parer.aop",
                        "it.eng.parer.exception", "it.eng.parer.web.helper.dto");
        for (Class c : classes) {
