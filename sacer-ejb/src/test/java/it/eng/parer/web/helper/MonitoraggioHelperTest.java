...
public class MonitoraggioHelperTest extends HelperTest<MonitoraggioHelper> {
    ...
    @Test
    public void contaDocNoUd_queryIsOk() {
        long idUtente = aLong();
    ...
    @Test
    public void contaDocUd_queryIsOk() {
        long idUtente = aLong();
    ...
    @Test
    public void contaDocStatoVolNoUd_queryIsOk() {
        long idUtente = aLong();
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStruttura = aBigDecimal();
    ...
    @Test
    public void contaDocStatoVolUd_queryIsOk() {
        long idUtente = aLong();
        BigDecimal idTipoUnitaDoc = aBigDecimal();
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
    ...
    @Test
    public void contaSessioniVersRisVer_queryIsOk() {
        long idUtente = aLong();
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStruttura = aBigDecimal();
    ...
    @Test
    public void contaSessioniAggRisVer_queryIsOk() {
        long idUtente = aLong();
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStruttura = aBigDecimal();
    ...
    @Test
    public void getMonVRiepStrutIamViewBean_queryIsOk() {
        long idUtente = aLong();
        int idAmbiente = aInt();
    ...
    @Test
    public void getMonVLisDocViewBean_queryIsOk() {
    ...
    @Test
    public void getMonVLisVersErrIamViewBean_queryIsOk() {
    ...
    @Test
    public void getMonVLisOperVolIamViewBean_queryIsOk() {
    ...
    @Test
    public void getElvVLisLogOperViewBean_queryIsOk() {
    ...
    @Test
    public void getMonVLisOperVolOutputAggregato_queryIsOk() {
        helper.getMonVLisOperVolOutputAggregato(aFiltriOperazioniVolumiPlain());
        assertTrue(true);
    }

    @Test
    public void getElvVLisLogOperOutputAggregato_queryIsOk() {
        helper.getElvVLisLogOperOutputAggregato(aFiltriOperazioniElenchiVersamentoPlain());
        assertTrue(true);
    }

    @Test
    public void getMonTotSacerTable_queryIsOk() {
    ...
    @Test
    public void getMonTotSacerForHomeTable_queryIsOk() {
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
    ...
    @Test
    public void getTotalMonTotSacer_queryIsOk() throws EMFError {
        helper.getTotalMonTotSacer();
        assertTrue(true);
    }

    @Test
    public void getNomeAmbienteFromId_queryIsOk() {
    ...
    @Test
    public void getNomeEnteFromId_queryIsOk() {
    ...
    @Test
    public void getNomeStrutturaFromId_queryIsOk() {
        BigDecimal idStruttura = aBigDecimal();
        try {
    ...
    @Test
    public void getNomeTipoUDFromId_queryIsOk() {
        long idTipoUD = aLong();
        try {
    ...
    @Test
    public void getSessioniErrateListTBWithoutFlagVerificato() {
        final int maxResults = 500;
        final VrsSessioneVersKoTableBean sessioniErrateListTB = helper.getSessioniErrateListTB(null, maxResults);
    ...
    @Test
    public void getMonVVisVersErrIamRowBean_queryIsOk() {
    ...
    @Test
    public void getMonVVisSesErrIam_queryIsOk() {
        BigDecimal idSessioneVers = aBigDecimal();
    ...
    @Test
    public void getFileListTableBean_queryIsOk() {
        BigDecimal idSessioneVers = aBigDecimal();
    ...
    @Test
    public void getLogVLisSchedViewBean_queryIsOk() {
    ...
    @Test
    public void getLogVLisSchedStrutViewBean_queryIsOk() throws EMFError {
        BigDecimal idStrut = aBigDecimal();
        String nomeJob = aString();
        Date dataOrarioDa = todayTs();
        Date dataOrarioA = tomorrowTs();
    ...
    @Test
    public void getAmbiente_queryIsOk() {
    ...
    @Test
    public void getIdAmbiente_queryIsOk() {
        BigDecimal idEnte = aBigDecimal();
    ...
    @Test
    public void getIdEnte_queryIsOk() {
        BigDecimal idStruttura = aBigDecimal();
        try {
    ...
    @Test
    public void contaVersFallitiDistintiUD_queryIsOk() {
        long idUtente = aLong();
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStruttura = aBigDecimal();
    ...
    @Test
    public void contaVersFallitiDistintiDoc_queryIsOk() {
        long idUtente = aLong();
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStruttura = aBigDecimal();
    ...
    @Test
    public void getMonVVisUdNonVers_queryIsOk() {
        BigDecimal idStrut = aBigDecimal();
    ...
    @Test
    public void getMonVVisDocNonVers_queryIsOk() {
        BigDecimal idStrut = aBigDecimal();
        String cdRegistroKeyUnitaDoc = aString();
        BigDecimal aaKeyUnitaDoc = aBigDecimal();
        String cdKeyUnitaDoc = aString();
        ...
        helper.getMonVVisDocNonVers(idStrut, cdRegistroKeyUnitaDoc, aaKeyUnitaDoc, cdKeyUnitaDoc, cdKeyDocVers);
        assertTrue(true);
    }

    @Test
    public void getMonVLisVersUdNonVersViewBean_queryIsOk() {
        BigDecimal idStrut = aBigDecimal();
        String cdRegistroKeyUnitaDoc = aString();
        BigDecimal aaKeyUnitaDoc = aBigDecimal();
        String cdKeyUnitaDoc = aString();

        helper.getMonVLisVersUdNonVersViewBean(idStrut, cdRegistroKeyUnitaDoc, aaKeyUnitaDoc, cdKeyUnitaDoc);
        assertTrue(true);
    }

    @Test
    public void getRegistriFromTotaleMonVLisVersErr_queryIsOk() {
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStrut = aBigDecimal();
        Long idUserIam = aLong();
    ...
    @Test
    public void getRegistriFromTotaleMonVLisUdNonVers_queryIsOk() {
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStrut = aBigDecimal();
        Long idUserIam = aLong();
    ...
    @Test
    public void getSessioniRecupero_queryIsOk() {
        BigDecimal idAmbiente = BigDecimal.ZERO;
        BigDecimal idEnte = BigDecimal.ZERO;
        BigDecimal idStruttura = aBigDecimal();
        Date[] dateAperture = aDateArray(2);
        Object[] chiavi = { aStringArray(2), aBigDecimal(), aString() };
        String tiStato = aString();
        String tiSessione = aString();
        String nmUserid = aString();
        helper.getSessioniRecupero(idAmbiente, idEnte, idStruttura, nmUserid, dateAperture, chiavi, tiStato,
                tiSessione);
        assertTrue(true);
    }
    ...
    public void getIamVLisOrganizDaReplicTableBean_queryIsOk() throws EMFError {
        ...
        helper.getIamVLisOrganizDaReplicTableBeanPlainFilters(100, idAmbiente, idEnte, idStrut, tiOper, tiStato);
        assertTrue(true);
    }

    @Test
    public void getMonVLisUniDocDaAnnulViewBean_queryIsOk() {
        long idUtente = aLong();
        MonitoraggioFiltriListaDocBean filtri = aMonitoraggioFiltriListaDocBean();
        helper.getMonVLisUniDocDaAnnulViewBean(idUtente, filtri, 100, l -> new MonVLisUniDocDaAnnulTableBean());
        assertTrue(true);
    }

    @Test
    @Ignore("could not resolve property: orgAmbitoTerrit of: it.eng.parer.entity.OrgEnte")
    public void getTotaliUdDocComp_queryIsOk() {
        MonitoraggioHelper.FiltriContenutoSacerPlain filtriCS = aFiltriContenutoSacerPlain();
        List<BigDecimal> idAmbitoTerritList = aListOfBigDecimal(2);
        long idUserIam = aLong();
    ...
    @Test
    public void getTotaliUdDocCompForHome_queryIsOk() {
        BigDecimal idAmbiente = aBigDecimal();
        BigDecimal idEnte = aBigDecimal();
        BigDecimal idStrut = aBigDecimal();
        Date dtRifDa = todayTs();
    ...
    public static Archive<?> createTestArchive() {
        ...
        final JavaArchive sacerJavaArchive = HelperTest.createSacerJavaArchive(
                ...
                MonitoraggioFiltriListaVersFallitiDistintiDocBean.class, BlobObject.class, ElencoEnums.class,
                Constants.class, Transform.class, MonitoraggioHelperTest.class);
        return HelperTest.createEnterpriseArchive(MonitoraggioHelperTest.class.getSimpleName(), sacerJavaArchive,
                createPaginatorJavaArchive(), createSacerLogJar());
    }

    @Test
    @Ignore("ha bisogno di un idSessioneVers reale")
    public void salvaDettaglio_queryIsOk() {
        ...
        helper.salvaDettaglio(idSessioneVers, flSessioneErrVerif, flSessioneErrNonRisolub, nmAmbientePerCalcolo,
                nmEntePerCalcolo, nmStrutPerCalcolo, idStrutPerCalcolo, registroUD, annoUD, numUD, chiaveDoc);
        assertTrue(true);
    }

    @Test
    public void getVrsSessioneVers_queryIsOk() {
        final BigDecimal idSessioneVers = BigDecimal.ZERO;
    ...
    public void saveFlVerificatiNonRisolubili_queryIsOk() {
        ...
        final String flSessioneErrNonRisolub = "0";
        try {
            helper.saveFlVerificatiNonRisolubili(idSessioneVers, flSessioneErrVerif, flSessioneErrNonRisolub);
    ...
    @Test
    public void getBlobboByteList_queryIsOk() {
        final BigDecimal idSessioneVers = BigDecimal.ZERO;
        try {
    ...
    @Test
    public void getLogVLisSchedViewBeanPlainFilters_queryIsOk() {
    ...
    @Test
    public void getIamVLisOrganizDaReplicTableBeanPlainFilters_queryIsOk() {
        ...
        helper.getIamVLisOrganizDaReplicTableBeanPlainFilters(maxResult, idAmbiente, idEnte, idStrut, tiOper, tiStato);
        assertTrue(true);
    }

    @Test
    public void getListaDifferenzaConsistenzaComp_queryIsOk() {
        final BigDecimal idStrut = BigDecimal.ZERO;
    ...
    @Test
    public void getListaDifferenzaConsistenzaVsCalcoloSacer_queryIsOk() {
        final BigDecimal idStrut = BigDecimal.ZERO;
        final Timestamp dtRifContaDa = todayTs();
        final Timestamp dtRifContaA = tomorrowTs();
    ...
    @Test
    public void getXmlsSesErr_queryIsOk() {
        try {
    ...
    @Test
    public void getXmlsVersErr_queryIsOk() {
        try {
    ...
    @Test
    public void getLastPositiveRunCalcoloContenutoSacer_queryIsOk() {
        final Calendar lastPositiveRunCalcoloContenutoSacer = helper.getLastPositiveRunCalcoloContenutoSacer();
