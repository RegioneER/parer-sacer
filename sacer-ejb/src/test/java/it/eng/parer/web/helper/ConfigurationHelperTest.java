...
public class ConfigurationHelperTest {
    ...
    public static Archive<?> createTestArchive() {
        return HelperTest.createEnterpriseArchive(ConfigurationHelperTest.class.getSimpleName(),
                ...
                HelperTest.createSacerJavaArchive(Arrays.asList(""), ConfigurationHelperTest.class,
                        ConfigurationHelper.class, ParamApplicNotFoundException.class, CostantiDB.class,
    ...
    public void getParamApplicMapValue_queryIsOk() {
        ...
        assertNotNull(helper.getParamApplicMapValue(nmParamApplicList, idAmbiente, idStrut, idTipoUnitaDoc,
                idAaTipoFascicolo, getVal));
    ...
    public void getAplValoreParamApplic_queryIsOk() {
        ...
        helper.getAplValoreParamApplic(nmParamApplic, tiAppart, idAmbiente, idStrut, idTipoUnitaDoc, idAaTipoFascicolo);
        assertTrue(true);
    }
    ...
    public void getValoreParamApplic_6args_queryIsOk() {
        ...
        assertGetValoreParamApplicIsOk(nmParamApplic, idAmbiente, idStrut, idTipoUnitaDoc, idAaTipoFascicolo,
    ...
    private void assertGetValoreParamApplicIsOk(String nmParamApplic, BigDecimal idAmbiente, BigDecimal idStrut,
            BigDecimal idTipoUnitaDoc, BigDecimal idAaTipoFascicolo,
            CostantiDB.TipoAplVGetValAppart tipoAplVGetValAppart) {
        try {
            switch (tipoAplVGetValAppart) {
            case AATIPOFASCICOLO:
                helper.getValoreParamApplicByAaTipoFasc(nmParamApplic, idAmbiente, idStrut, idAaTipoFascicolo);
                break;
            case TIPOUNITADOC:
                helper.getValoreParamApplicByTipoUd(nmParamApplic, idAmbiente, idStrut, idTipoUnitaDoc);
                break;
            case STRUT:
