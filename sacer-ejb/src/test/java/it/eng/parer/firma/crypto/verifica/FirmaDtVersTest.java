...
public class FirmaDtVersTest {
    ...
    /**
     * Esegui il corpo del job di verifica firme con un caso in cui il subject key id della ca del
     * firmatario sia valorizzato
     *
    ...
    /**
     * Esegui il corpo del job di verifica firme con un caso in cui il subject key id della ca del
     * firmatario non sia valorizzato
     *
     * @throws SignatureException   in caso di errore generico
     * @throws CRLNotFoundException in caso di CRL non trovata
     */
    @Test
    @Disabled("Errore multiple bags fetch su QUERY_ARO_COMP_DOC")
