...
public class CryptoInvokerTest {
    ...
    public static WebArchive createTestArchive() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "sacerInvokerTest.war")
                ...
                .addPackages(false, "it.eng.parer.sacerlog.entity", "it.eng.parer.sacerlog.viewEntity",
                        ...
                        "it.eng.parer.crypto")
                .addAsResource(CryptoInvokerTest.class.getClassLoader().getResource("persistence.xml"),
                        "META-INF/persistence.xml")
                .addAsResource(CryptoInvokerTest.class.getClassLoader().getResource("countselectlist.properties"),
                        "countselectlist.properties")
                .addAsResource(CryptoInvokerTest.class.getClassLoader().getResource("fir_file_per_firma.blob"),
                        "fir_file_per_firma.blob")
                .addAsWebInfResource(CryptoInvokerTest.class.getClassLoader().getResource("ejb-jar-invoker.xml"),
                        "ejb-jar.xml")
    ...
    @Test
    public void invokeCrlFromFirma() throws URISyntaxException, IOException {
        ...
        try (InputStream in = getClass().getResourceAsStream("/fir_file_per_firma.blob")) {
            ...
            Assert.assertNotNull(retrieveCRL);
        }
    }
}
