...
import it.eng.parer.elencoVersFascicoli.helper.ElencoVersFascicoliHelperTest;
...
public class ElenchiSignatureHelperTest extends HelperTest<ElenchiSignatureHelper> {
    ...
    public static Archive<?> createTestArchive() {
        return HelperTest.createEnterpriseArchive(ElenchiSignatureHelperTest.class.getSimpleName(),
                ...
                HelperTest.createSacerJavaArchive(Arrays.asList(""), ElenchiSignatureHelperTest.class,
                        ElenchiSignatureHelper.class, SigningHelper.class, ConfigurationHelper.class));
    }
