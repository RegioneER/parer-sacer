...
public class UniformResourceNameUtilHelperTest extends HelperTest<UniformResourceNameUtilHelper> {
    ...
    @Test
    public void existsCdKeyNormalizedQueryIsOk() {
        long idRegistro = 0L;
        BigDecimal aaKeyUnitaDoc = BigDecimal.valueOf(1900);
        String cdKeyUnitaDoc = "KEY";
        String cdKeyUnitaDocNormaliz = "KEYNORMALIZ";
        helper.existsCdKeyNormalized(idRegistro, aaKeyUnitaDoc, cdKeyUnitaDoc, cdKeyUnitaDocNormaliz);
        assertTrue(true);
    }

    @Test
    public void retrieveVrsVLisXmlUpdUrnDaCalcByUpdQueryIsOk(String methodName) throws Throwable {
        Class[] paramsType = { long.class };
        Object[] paramsValue = { 0L };
        assertTrueByReflection(paramsType, paramsValue, "retrieveVrsVLisXmlUpdUrnDaCalcByUpd");
    }

    @Test
    public void retrieveAroUpdUnitaDocByUdQueryIsOk() throws Throwable {
        Class[] paramsType = { long.class };
        Object[] paramsValue = { 0L };
    ...
    @Test
    public void retrieveAroVLisaipudUrndacalcByudQueryIsOk() throws Throwable {
        Class[] paramsType = { long.class };
        Object[] paramsValue = { 0L };
    ...
    @Test
    public void retrieveVrsVLisXmlDocUrnDaCalcByDocQueryIsOk() throws Throwable {
        Class[] paramsType = { long.class };
        Object[] paramsValue = { 0L };
    ...
    @Test
    public void retrieveVrsVLisXmlUdUrnDaCalcByUdQueryIsOk() throws Throwable {
        Class[] paramsType = { long.class };
        Object[] paramsValue = { 0L };
    ...
    private void assertTrueByReflection(Class[] paramsType, Object[] paramsValue, String methodName) throws Throwable {
    ...
    public static Archive<?> createTestArchive() {
        final JavaArchive sacerJavaArchive = createSacerJavaArchive(Arrays.asList("it.eng.parer.ws.dto"),
                UniformResourceNameUtilHelperTest.class, UniformResourceNameUtilHelper.class);
