...
import it.eng.parer.amministrazioneStrutture.gestioneDatiSpecifici.helper.DatiSpecificiHelperTest;
...
public class RegistroHelperTest {
    ...
    public static Archive<?> createTestArchive() {
        return HelperTest.createEnterpriseArchive(RegistroHelperTest.class.getSimpleName(),
                ...
                HelperTest.createSacerJavaArchive(Arrays.asList(""), RegistroHelperTest.class, RegistroHelper.class,
                        CSVersatore.class));
    }
    ...
    public void checkRegistroUnitaDoc_queryIsOk() {
        ...
        helper.checkRegistroUnitaDocByCampoStringa(nmCampo, valoreCampo, idStrut, idRegistroUnitaDoc);
        assertTrue(true);
    }
    ...
    public void checkRangeDecAaRegistroUnitaDoc_queryIsOk() {
        ...
        helper.checkRangeDecAaRegistroUnitaDoc(idAaRegistroUnitaDoc, idRegistroUnitaDoc, aaMinRegistroUnitaDoc,
                aaMaxRegistroUnitaDoc);
        assertTrue(true);
    }
    ...
    public void checkUnitaDocInDecAaRegUnitaDoc_queryIsOk() {
        ...
        helper.checkUnitaDocInDecAaRegUnitaDoc(idAaRegistroUnitaDoc, annoDa, annoA, idRegistroUnitaDoc,
                cdRegistroKeyUnitaDoc, subStruts);
        assertTrue(true);
    }
    ...
    public void getDecTipoStrutUdRegByName_queryIsOk() {
        ...
        String cdRegistroUnitaDoc = aString();
        helper.getDecTipoStrutUdRegByName(idStrutCorrente, nmTipoUnitaDoc, nmTipoStrutUnitaDoc, cdRegistroUnitaDoc);
        assertTrue(true);
    }
}
