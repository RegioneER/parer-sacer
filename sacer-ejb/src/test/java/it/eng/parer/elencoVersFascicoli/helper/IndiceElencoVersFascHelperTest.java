...
import it.eng.parer.job.allineamentoOrganizzazioni.ejb.AllineamentoOrganizzazioniHelperTest;
...
public class IndiceElencoVersFascHelperTest {
    ...
    public static Archive<?> createTestArchive() {
        return HelperTest.createEnterpriseArchive(IndiceElencoVersFascHelperTest.class.getSimpleName(),
                HelperTest.createSacerLogJar(), HelperTest.createPaginatorJavaArchive(),
                HelperTest.createSacerJavaArchive(Arrays.asList(""), IndiceElencoVersFascHelperTest.class,
                        IndiceElencoVersFascHelper.class, ElencoEnums.class));
    }

    @Test
    public void retrieveFasFascicoliInVolume_queryIsOk() {
    ...
    @Test
    public void retrieveElvVCreaIxElencoFasc_queryIsOk() {
    ...
    @Test
    public void retrieveElvVCreaLisFascElenco_queryIsOk() {
