...
public class AroVRicUnitaDocTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_CD_VERSIONE_XSD_UD, new ColumnDescriptor(COL_CD_VERSIONE_XSD_UD, Types.VARCHAR, 100, true));
        map.put(COL_CD_VERSIONE_XSD_DOC, new ColumnDescriptor(COL_CD_VERSIONE_XSD_DOC, Types.VARCHAR, 100, true));
