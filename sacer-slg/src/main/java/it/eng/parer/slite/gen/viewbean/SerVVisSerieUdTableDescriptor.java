...
public class SerVVisSerieUdTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DT_REG_UNITA_DOC_DA, new ColumnDescriptor(COL_DT_REG_UNITA_DOC_DA, Types.TIMESTAMP, 7, true));
        map.put(COL_DT_REG_UNITA_DOC_A, new ColumnDescriptor(COL_DT_REG_UNITA_DOC_A, Types.TIMESTAMP, 7, true));
        ...
        map.put(COL_DT_REG_STATO_VER_SERIE, new ColumnDescriptor(COL_DT_REG_STATO_VER_SERIE, Types.TIMESTAMP, 7, true));
        map.put(COL_DS_AZIONE, new ColumnDescriptor(COL_DS_AZIONE, Types.VARCHAR, 254, true));
        map.put(COL_DS_NOTA_AZIONE, new ColumnDescriptor(COL_DS_NOTA_AZIONE, Types.VARCHAR, 1024, true));
        map.put(COL_ID_USER_IAM_STATO, new ColumnDescriptor(COL_ID_USER_IAM_STATO, Types.DECIMAL, 22, true));
        ...
        map.put(COL_DT_REG_STATO_SERIE, new ColumnDescriptor(COL_DT_REG_STATO_SERIE, Types.TIMESTAMP, 7, true));
        map.put(COL_DS_AZIONE_STATO_SERIE, new ColumnDescriptor(COL_DS_AZIONE_STATO_SERIE, Types.VARCHAR, 254, true));
        ...
        map.put(COL_NM_USERID_STATO_SERIE, new ColumnDescriptor(COL_NM_USERID_STATO_SERIE, Types.VARCHAR, 100, true));
        ...
        map.put(COL_ID_CONTENUTO_CALC, new ColumnDescriptor(COL_ID_CONTENUTO_CALC, Types.DECIMAL, 22, true));
        ...
        map.put(COL_NI_UNITA_DOC_CALC, new ColumnDescriptor(COL_NI_UNITA_DOC_CALC, Types.DECIMAL, 22, true));
        ...
        map.put(COL_CD_LAST_UNITA_DOC_CALC, new ColumnDescriptor(COL_CD_LAST_UNITA_DOC_CALC, Types.VARCHAR, 254, true));
        map.put(COL_DT_LAST_UNITA_DOC_CALC, new ColumnDescriptor(COL_DT_LAST_UNITA_DOC_CALC, Types.TIMESTAMP, 7, true));
        map.put(COL_ID_CONTENUTO_ACQ, new ColumnDescriptor(COL_ID_CONTENUTO_ACQ, Types.DECIMAL, 22, true));
        map.put(COL_TI_STATO_CONTENUTO_ACQ, new ColumnDescriptor(COL_TI_STATO_CONTENUTO_ACQ, Types.VARCHAR, 30, true));
        map.put(COL_DT_STATO_CONTENUTO_ACQ, new ColumnDescriptor(COL_DT_STATO_CONTENUTO_ACQ, Types.TIMESTAMP, 7, true));
        ...
        map.put(COL_NI_UNITA_DOC_ACQ, new ColumnDescriptor(COL_NI_UNITA_DOC_ACQ, Types.DECIMAL, 22, true));
        map.put(COL_CD_FIRST_UNITA_DOC_ACQ, new ColumnDescriptor(COL_CD_FIRST_UNITA_DOC_ACQ, Types.VARCHAR, 254, true));
        map.put(COL_DT_FIRST_UNITA_DOC_ACQ, new ColumnDescriptor(COL_DT_FIRST_UNITA_DOC_ACQ, Types.TIMESTAMP, 7, true));
        map.put(COL_CD_LAST_UNITA_DOC_ACQ, new ColumnDescriptor(COL_CD_LAST_UNITA_DOC_ACQ, Types.VARCHAR, 254, true));
        map.put(COL_DT_LAST_UNITA_DOC_ACQ, new ColumnDescriptor(COL_DT_LAST_UNITA_DOC_ACQ, Types.TIMESTAMP, 7, true));
        ...
        map.put(COL_FL_FORNITO_ENTE, new ColumnDescriptor(COL_FL_FORNITO_ENTE, Types.VARCHAR, 1, true));
        map.put(COL_NM_USERID_FILE, new ColumnDescriptor(COL_NM_USERID_FILE, Types.VARCHAR, 100, true));
        map.put(COL_ID_CONTENUTO_EFF, new ColumnDescriptor(COL_ID_CONTENUTO_EFF, Types.DECIMAL, 22, true));
        map.put(COL_TI_STATO_CONTENUTO_EFF, new ColumnDescriptor(COL_TI_STATO_CONTENUTO_EFF, Types.VARCHAR, 30, true));
        map.put(COL_DT_STATO_CONTENUTO_EFF, new ColumnDescriptor(COL_DT_STATO_CONTENUTO_EFF, Types.TIMESTAMP, 7, true));
        ...
        map.put(COL_DT_FIRST_UNITA_DOC_EFF, new ColumnDescriptor(COL_DT_FIRST_UNITA_DOC_EFF, Types.TIMESTAMP, 7, true));
        map.put(COL_CD_LAST_UNITA_DOC_EFF, new ColumnDescriptor(COL_CD_LAST_UNITA_DOC_EFF, Types.VARCHAR, 254, true));
        map.put(COL_DT_LAST_UNITA_DOC_EFF, new ColumnDescriptor(COL_DT_LAST_UNITA_DOC_EFF, Types.TIMESTAMP, 7, true));
        map.put(COL_DS_HASH_IX_AIP, new ColumnDescriptor(COL_DS_HASH_IX_AIP, Types.VARCHAR, 50, true));
        map.put(COL_DS_ALGO_HASH_IX_AIP, new ColumnDescriptor(COL_DS_ALGO_HASH_IX_AIP, Types.VARCHAR, 254, true));
        map.put(COL_CD_ENCODING_HASH_IX_AIP,
                new ColumnDescriptor(COL_CD_ENCODING_HASH_IX_AIP, Types.VARCHAR, 20, true));
        map.put(COL_CD_VER_XSD_AIP, new ColumnDescriptor(COL_CD_VER_XSD_AIP, Types.VARCHAR, 100, true));
        map.put(COL_DT_CREAZIONE_IX_AIP, new ColumnDescriptor(COL_DT_CREAZIONE_IX_AIP, Types.TIMESTAMP, 7, true));
        map.put(COL_BL_FILE_IX_AIP, new ColumnDescriptor(COL_BL_FILE_IX_AIP, Types.BLOB, 4000, true));
        map.put(COL_DS_FMT_IX_AIP, new ColumnDescriptor(COL_DS_FMT_IX_AIP, Types.VARCHAR, 10, true));
