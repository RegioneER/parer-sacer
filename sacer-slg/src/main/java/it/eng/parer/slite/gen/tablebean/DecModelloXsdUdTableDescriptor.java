 ...
 * @author Sloth
 *
 *         Bean per la tabella Dec_Modello_Xsd_Ud
 *
 */
public class DecModelloXsdUdTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Dec_Modello_Xsd_Ud /**/";
    public static final String TABLE_NAME = "Dec_Modello_Xsd_Ud";
    public static final String COL_ID_MODELLO_XSD_UD = "id_modello_xsd_ud";
    ...
    static {
        map.put(COL_ID_MODELLO_XSD_UD, new ColumnDescriptor(COL_ID_MODELLO_XSD_UD, Types.DECIMAL, 22, true));
