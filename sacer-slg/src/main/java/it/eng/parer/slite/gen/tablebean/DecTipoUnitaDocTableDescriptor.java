...
public class DecTipoUnitaDocTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_TIPO_UNITA_DOC, new ColumnDescriptor(COL_DS_TIPO_UNITA_DOC, Types.VARCHAR, 254, false));
        ...
        map.put(COL_FL_VERS_MANUALE, new ColumnDescriptor(COL_FL_VERS_MANUALE, Types.VARCHAR, 1, false));
        map.put(COL_DL_NOTE_TIPO_UD, new ColumnDescriptor(COL_DL_NOTE_TIPO_UD, Types.VARCHAR, 1024, false));
