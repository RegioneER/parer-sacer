 ...
 * @author Sloth
 *
 *         Bean per la tabella Elv_V_Ric_Elenco_Fasc
 *
 */
public class ElvVRicElencoFascTableDescriptor extends TableDescriptor {

    /*
     * @Generated( value = "it.eg.dbtool.db.oracle.beangen.Oracle4JPAClientBeanGen$ViewBeanWriter",
     * comments = "This class was generated by OraTool", date = "Wednesday, 4 April 2018 12:07" )
     */

    public static final String SELECT = "Select * from Elv_V_Ric_Elenco_Fasc /**/";
    public static final String TABLE_NAME = "Elv_V_Ric_Elenco_Fasc";
