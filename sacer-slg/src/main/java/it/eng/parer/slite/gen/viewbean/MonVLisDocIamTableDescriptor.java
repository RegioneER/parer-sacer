 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Doc_Iam
 *
 */
public class MonVLisDocIamTableDescriptor extends TableDescriptor {

    /*
     * @Generated( value = "it.eg.dbtool.db.oracle.beangen.Oracle4JPAClientBeanGen$ViewBeanWriter",
     * comments = "This class was generated by OraTool", date = "Tuesday, 5 May 2015 16:37" )
     */

    public static final String SELECT = "Select * from Mon_V_Lis_Doc_Iam /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Doc_Iam";
