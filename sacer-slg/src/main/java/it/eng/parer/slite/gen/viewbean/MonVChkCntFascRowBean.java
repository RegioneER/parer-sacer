...
public class MonVChkCntFascRowBean extends BaseRow implements JEEBaseRowInterface {
	...
	setFlFascCorr(
		getNiFascCorr() != null && !getNiFascCorr().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFasc30gg(
		getNiFasc30gg() != null && !getNiFasc30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascB30gg(
		getNiFascB30gg() != null && !getNiFascB30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascAttesaSchedCorr(getNiFascAttesaSchedCorr() != null
		&& !getNiFascAttesaSchedCorr().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascAttesaSched30gg(getNiFascAttesaSched30gg() != null
		&& !getNiFascAttesaSched30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascAttesaSchedB30gg(getNiFascAttesaSchedB30gg() != null
		&& !getNiFascAttesaSchedB30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascNoselSchedCorr(getNiFascNoselSchedCorr() != null
		&& !getNiFascNoselSchedCorr().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascNoselSched30gg(getNiFascNoselSched30gg() != null
		&& !getNiFascNoselSched30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascNoselSchedB30gg(getNiFascNoselSchedB30gg() != null
		&& !getNiFascNoselSchedB30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascKoFallCorr(
		getNiFascKoFallCorr() != null && !getNiFascKoFallCorr().equals(BigDecimal.ZERO)
			? "1"
			: "0");
    }
	...
	setFlFascKoFall30gg(
		getNiFascKoFall30gg() != null && !getNiFascKoFall30gg().equals(BigDecimal.ZERO)
			? "1"
			: "0");
    }
	...
	setFlFascKoFallB30gg(
		getNiFascKoFallB30gg() != null && !getNiFascKoFallB30gg().equals(BigDecimal.ZERO)
			? "1"
			: "0");
    }
	...
	setFlFascKoVerifCorr(
		getNiFascKoVerifCorr() != null && !getNiFascKoVerifCorr().equals(BigDecimal.ZERO)
			? "1"
			: "0");
    }
	...
	setFlFascKoVerif30gg(
		getNiFascKoVerif30gg() != null && !getNiFascKoVerif30gg().equals(BigDecimal.ZERO)
			? "1"
			: "0");
    }
	...
	setFlFascKoVerifB30gg(
		getNiFascKoVerifB30gg() != null && !getNiFascKoVerifB30gg().equals(BigDecimal.ZERO)
			? "1"
			: "0");
    }
	...
	setFlFascKoNonVerifCorr(getNiFascKoNonVerifCorr() != null
		&& !getNiFascKoNonVerifCorr().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascKoNonVerif30gg(getNiFascKoNonVerif30gg() != null
		&& !getNiFascKoNonVerif30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascKoNonVerifB30gg(getNiFascKoNonVerifB30gg() != null
		&& !getNiFascKoNonVerifB30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascKoNonRisolubCorr(getNiFascKoNonRisolubCorr() != null
		&& !getNiFascKoNonRisolubCorr().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascKoNonRisolub30gg(getNiFascKoNonRisolub30gg() != null
		&& !getNiFascKoNonRisolub30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	setFlFascKoNonRisolubB30gg(getNiFascKoNonRisolubB30gg() != null
		&& !getNiFascKoNonRisolubB30gg().equals(BigDecimal.ZERO) ? "1" : "0");
    }
	...
	if (entity != null) {
	    ...
	    if (this.getFlFascKoVerifCorr().equals("1")
		    || this.getFlFascKoNonVerifCorr().equals("1")
		    || this.getFlFascKoNonRisolubCorr().equals("1")) {
		this.setFlFascKoFallCorr("1");
	    } else {
		this.setFlFascKoFallCorr("0");
	    }
	    if (this.getFlFascKoVerif30gg().equals("1")
		    || this.getFlFascKoNonVerif30gg().equals("1")
		    || this.getFlFascKoNonRisolub30gg().equals("1")) {
		this.setFlFascKoFall30gg("1");
	    } else {
		this.setFlFascKoFall30gg("0");
	    }
	    if (this.getFlFascKoVerifB30gg().equals("1")
		    || this.getFlFascKoNonVerifB30gg().equals("1")
