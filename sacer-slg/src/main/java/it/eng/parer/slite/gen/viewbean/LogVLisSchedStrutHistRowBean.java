...
/**
 * RowBean per la tabella Log_V_Lis_Sched_Strut_Hist
 *
 */
public class LogVLisSchedStrutHistRowBean extends BaseRow implements JEEBaseRowInterface {

    /*
     * @Generated( value = "it.eg.dbtool.db.oracle.beangen.Oracle4JPAClientBeanGen$ViewBeanWriter",
     * comments = "This class was generated by OraTool", date = "Tuesday, 2 December 2014 15:22" )
     */
    private static final long serialVersionUID = 1L;

    public static LogVLisSchedStrutHistTableDescriptor TABLE_DESCRIPTOR = new LogVLisSchedStrutHistTableDescriptor();

    public LogVLisSchedStrutHistRowBean() {
        super();
    }
    ...
    public void entityToRowBean(Object obj) {
        LogVLisSchedStrutHist entity = (LogVLisSchedStrutHist) obj;
    ...
    @Override
    public LogVLisSchedStrutHist rowBeanToEntity() {
        LogVLisSchedStrutHist entity = new LogVLisSchedStrutHist();
