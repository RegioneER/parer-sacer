 ...
 * @author Sloth
 *
 *         Bean per la tabella Aro_V_Doc_Ti_Ud_Range_Dt
 *
 */
public class AroVDocTiUdRangeDtTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Aro_V_Doc_Ti_Ud_Range_Dt /**/";
    public static final String TABLE_NAME = "Aro_V_Doc_Ti_Ud_Range_Dt";
