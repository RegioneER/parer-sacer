...
public class ElvElencoVersFascRowBean extends BaseRow implements JEEBaseRowInterface {
	...
	this.setIdElencoVersFasc(entity.getIdElencoVersFasc() == null ? null
		: BigDecimal.valueOf(entity.getIdElencoVersFasc()));
	...
	if (entity.getDecCriterioRaggrFasc() != null) {
	    this.setIdCriterioRaggrFasc(
		    new BigDecimal(entity.getDecCriterioRaggrFasc().getIdCriterioRaggrFasc()));
	}
	...
	if (this.getIdCriterioRaggrFasc() != null) {
	    ...
	    entity.getDecCriterioRaggrFasc()
		    .setIdCriterioRaggrFasc(this.getIdCriterioRaggrFasc().longValue());
	}
