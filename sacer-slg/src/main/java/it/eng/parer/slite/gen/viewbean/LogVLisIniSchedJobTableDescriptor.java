 ...
 * @author Sloth
 *
 *         Bean per la tabella Log_V_Lis_Ini_Sched_Job
 *
 */
public class LogVLisIniSchedJobTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Log_V_Lis_Ini_Sched_Job /**/";
    public static final String TABLE_NAME = "Log_V_Lis_Ini_Sched_Job";
