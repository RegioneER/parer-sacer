 ...
 *
 */
public class AroFirmaCompRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public void setDlDnFirmatario(String dl_dn_firmatario) {
        setObject("dl_dn_firmatario", dl_dn_firmatario);
    }
    ...
    public void entityToRowBean(Object obj) {
        ...
        AbstractRecord ar;
        this.setIdFirmaComp(new BigDecimal(entity.getIdFirmaComp()));
        if (entity._persistence_get_aroCompDoc_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) entity._persistence_get_aroCompDoc_vh()).getRow()) != null) {
                this.setIdCompDoc(new BigDecimal((Long) ar.get("ARO_FIRMA_COMP.ID_COMP_DOC")));
            }
        } else {
        ...
        if (entity._persistence_get_firCertifFirmatario_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) entity._persistence_get_firCertifFirmatario_vh()).getRow()) != null) {
                this.setIdCertifFirmatario(new BigDecimal((Long) ar.get("ARO_FIRMA_COMP.ID_CERTIF_FIRMATARIO")));
            }
        } else {
        ...
        if (entity._persistence_get_aroMarcaComp_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) entity._persistence_get_aroMarcaComp_vh()).getRow()) != null) {
                this.setIdMarcaComp(new BigDecimal((Long) ar.get("ARO_FIRMA_COMP.ID_MARCA_COMP")));
            }
        } else {
        ...
        if (entity._persistence_get_aroBustaCrittog_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) entity._persistence_get_aroBustaCrittog_vh()).getRow()) != null) {
                this.setIdBustaCrittog(new BigDecimal((Long) ar.get("ARO_FIRMA_COMP.ID_BUSTA_CRITTOG")));
            }
        } else {
