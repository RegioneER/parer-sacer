...
public class MonVVisUdUpdKoTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_ID_TIPO_UNITA_DOC_LAST,
                new ColumnDescriptor(COL_ID_TIPO_UNITA_DOC_LAST, Types.DECIMAL, 22, true));
        map.put(COL_NM_TIPO_UNITA_DOC_LAST,
                new ColumnDescriptor(COL_NM_TIPO_UNITA_DOC_LAST, Types.VARCHAR, 100, true));
        map.put(COL_ID_REGISTRO_UNITA_DOC_LAST,
                new ColumnDescriptor(COL_ID_REGISTRO_UNITA_DOC_LAST, Types.DECIMAL, 22, true));
        map.put(COL_ID_TIPO_DOC_PRINC_LAST,
                new ColumnDescriptor(COL_ID_TIPO_DOC_PRINC_LAST, Types.DECIMAL, 22, true));
        map.put(COL_NM_TIPO_DOC_PRINC_LAST,
                new ColumnDescriptor(COL_NM_TIPO_DOC_PRINC_LAST, Types.VARCHAR, 100, true));
        map.put(COL_TI_STATO_UPD_UD_KO,
                new ColumnDescriptor(COL_TI_STATO_UPD_UD_KO, Types.VARCHAR, 20, true));
        map.put(COL_ID_SES_UPD_UD_KO_LAST,
                new ColumnDescriptor(COL_ID_SES_UPD_UD_KO_LAST, Types.DECIMAL, 22, true));
        map.put(COL_ID_UPD_UNITA_DOC_KO,
                new ColumnDescriptor(COL_ID_UPD_UNITA_DOC_KO, Types.DECIMAL, 22, true));
        map.put(COL_DS_TS_INI_LAST_SES,
                new ColumnDescriptor(COL_DS_TS_INI_LAST_SES, Types.VARCHAR, 29, true));
        map.put(COL_DS_TS_FINE_LAST_SES,
                new ColumnDescriptor(COL_DS_TS_FINE_LAST_SES, Types.VARCHAR, 29, true));
        ...
        map.put(COL_BL_XML_RICH_LAST,
                new ColumnDescriptor(COL_BL_XML_RICH_LAST, Types.CLOB, 4000, true));
        map.put(COL_ID_XML_SES_UPD_KO_RISP_LAST,
                new ColumnDescriptor(COL_ID_XML_SES_UPD_KO_RISP_LAST, Types.DECIMAL, 22, true));
        map.put(COL_BL_XML_RISP_LAST,
                new ColumnDescriptor(COL_BL_XML_RISP_LAST, Types.CLOB, 4000, true));
    }
