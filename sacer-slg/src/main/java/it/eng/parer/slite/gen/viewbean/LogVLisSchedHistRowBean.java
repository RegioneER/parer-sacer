...
/**
 * RowBean per la tabella Log_V_Lis_Sched_HistRowBean
 *
 */
public class LogVLisSchedHistRowBean extends BaseRow implements JEEBaseRowInterface {
    ...
    public static LogVLisSchedHistTableDescriptor TABLE_DESCRIPTOR = new LogVLisSchedHistTableDescriptor();

    public LogVLisSchedHistRowBean() {
	super();
    }
	...
	LogVLisSchedHist entity = (LogVLisSchedHist) obj;
    ...
    @Override
    public LogVLisSchedHist rowBeanToEntity() {
	LogVLisSchedHist entity = new LogVLisSchedHist();
