...
public class DecTipoStrutDocTableDescriptor extends TableDescriptor {
	...
	map.put(COL_NM_TIPO_STRUT_DOC,
		new ColumnDescriptor(COL_NM_TIPO_STRUT_DOC, Types.VARCHAR, 100, false));
	map.put(COL_DS_TIPO_STRUT_DOC,
		new ColumnDescriptor(COL_DS_TIPO_STRUT_DOC, Types.VARCHAR, 254, false));
