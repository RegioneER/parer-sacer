...
public class ElvElencoVersFascTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_ID_CRITERIO_RAGGR_FASC, new ColumnDescriptor(COL_ID_CRITERIO_RAGGR_FASC, Types.DECIMAL, 22, false));
        map.put(COL_TS_CREAZIONE_ELENCO, new ColumnDescriptor(COL_TS_CREAZIONE_ELENCO, Types.TIMESTAMP, 11, false));
        map.put(COL_NI_FASC_VERS_ELENCO, new ColumnDescriptor(COL_NI_FASC_VERS_ELENCO, Types.DECIMAL, 22, false));
        ...
        map.put(COL_DS_URN_ELENCO, new ColumnDescriptor(COL_DS_URN_ELENCO, Types.VARCHAR, 254, false));
        ...
        map.put(COL_NI_MAX_FASC_CRIT, new ColumnDescriptor(COL_NI_MAX_FASC_CRIT, Types.DECIMAL, 22, false));
        map.put(COL_TI_SCAD_CHIUS_CRIT, new ColumnDescriptor(COL_TI_SCAD_CHIUS_CRIT, Types.VARCHAR, 20, false));
