 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Vers_Doc_Non_Vers
 *
 */
public class MonVLisVersDocNonVersTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Vers_Doc_Non_Vers /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Vers_Doc_Non_Vers";
