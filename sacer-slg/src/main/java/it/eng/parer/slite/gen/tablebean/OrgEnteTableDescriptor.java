...
public class OrgEnteTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_TIPO_DEF_TEMPLATE_ENTE, new ColumnDescriptor(COL_TIPO_DEF_TEMPLATE_ENTE, Types.VARCHAR, 30, false));
        map.put(COL_CD_ENTE_NORMALIZ, new ColumnDescriptor(COL_CD_ENTE_NORMALIZ, Types.VARCHAR, 100, false));
