 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Vis_Upd_Ud_Err
 *
 */
public class MonVVisUpdUdErrTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Vis_Upd_Ud_Err /**/";
    public static final String TABLE_NAME = "Mon_V_Vis_Upd_Ud_Err";
    ...
    public static final String COL_FL_ESISTE_STRUT = "fl_esiste_strut";
    public static final String COL_FL_ESISTE_REGISTRO = "fl_esiste_registro";
    public static final String COL_FL_ESISTE_TIPO_UNITA_DOC = "fl_esiste_tipo_unita_doc";
    public static final String COL_FL_ESISTE_TIPO_DOC_PRINC = "fl_esiste_tipo_doc_princ";
    public static final String COL_NM_USERID_WS = "nm_userid_ws";
    public static final String COL_ID_XML_SES_UPD_ERR_RICH = "id_xml_ses_upd_err_rich";
    public static final String COL_BL_XML_RICH = "bl_xml_rich";
    public static final String COL_ID_XML_SES_UPD_ERR_RISP = "id_xml_ses_upd_err_risp";
	...
	map.put(COL_FL_ESISTE_STRUT,
		new ColumnDescriptor(COL_FL_ESISTE_STRUT, Types.VARCHAR, 1, true));
	map.put(COL_FL_ESISTE_REGISTRO,
		new ColumnDescriptor(COL_FL_ESISTE_REGISTRO, Types.VARCHAR, 1, true));
	map.put(COL_FL_ESISTE_TIPO_UNITA_DOC,
		new ColumnDescriptor(COL_FL_ESISTE_TIPO_UNITA_DOC, Types.VARCHAR, 1, true));
	map.put(COL_FL_ESISTE_TIPO_DOC_PRINC,
		new ColumnDescriptor(COL_FL_ESISTE_TIPO_DOC_PRINC, Types.VARCHAR, 1, true));
	map.put(COL_NM_USERID_WS, new ColumnDescriptor(COL_NM_USERID_WS, Types.VARCHAR, 100, true));
	map.put(COL_ID_XML_SES_UPD_ERR_RICH,
		new ColumnDescriptor(COL_ID_XML_SES_UPD_ERR_RICH, Types.DECIMAL, 22, true));
	map.put(COL_BL_XML_RICH, new ColumnDescriptor(COL_BL_XML_RICH, Types.CLOB, 4000, true));
	map.put(COL_ID_XML_SES_UPD_ERR_RISP,
		new ColumnDescriptor(COL_ID_XML_SES_UPD_ERR_RISP, Types.DECIMAL, 22, true));
