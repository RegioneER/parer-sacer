...
public class MonVVisUpdUdErrTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_TS_FINE_SES, new ColumnDescriptor(COL_DS_TS_FINE_SES, Types.VARCHAR, 29, true));
        ...
        map.put(COL_FL_ESISTE_STRUT, new ColumnDescriptor(COL_FL_ESISTE_STRUT, Types.VARCHAR, 1, true));
        map.put(COL_FL_ESISTE_REGISTRO, new ColumnDescriptor(COL_FL_ESISTE_REGISTRO, Types.VARCHAR, 1, true));
