...
public class SerVRicSerieUdUsrTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_NI_UD_CONTENUTO, new ColumnDescriptor(COL_NI_UD_CONTENUTO, Types.DECIMAL, 22, true));
        map.put(COL_ID_FIRST_UNITA_DOC, new ColumnDescriptor(COL_ID_FIRST_UNITA_DOC, Types.DECIMAL, 22, true));
        map.put(COL_DS_CHIAVE_FIRST, new ColumnDescriptor(COL_DS_CHIAVE_FIRST, Types.VARCHAR, 242, true));
        map.put(COL_DT_REG_UNITA_DOC_FIRST, new ColumnDescriptor(COL_DT_REG_UNITA_DOC_FIRST, Types.TIMESTAMP, 7, true));
        map.put(COL_ID_LAST_UNITA_DOC, new ColumnDescriptor(COL_ID_LAST_UNITA_DOC, Types.DECIMAL, 22, true));
        map.put(COL_DS_CHIAVE_LAST, new ColumnDescriptor(COL_DS_CHIAVE_LAST, Types.VARCHAR, 242, true));
        map.put(COL_DT_REG_UNITA_DOC_LAST, new ColumnDescriptor(COL_DT_REG_UNITA_DOC_LAST, Types.TIMESTAMP, 7, true));
    }
