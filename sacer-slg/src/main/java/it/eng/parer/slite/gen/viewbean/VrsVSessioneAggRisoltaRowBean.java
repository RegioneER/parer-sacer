...
import it.eng.parer.viewEntity.VrsVSessioneAggRisoltaId;
 ...
 *
 */
public class VrsVSessioneAggRisoltaRowBean extends BaseRow implements JEEBaseRowInterface {
    ...
    public void entityToRowBean(Object obj) {
        ...
        if (entity.getVrsVSessioneAggRisoltaId() != null) {
            ...
            this.setTiStatoSessioneVers(entity.getVrsVSessioneAggRisoltaId().getTiStatoSessioneVers());
            if (entity.getVrsVSessioneAggRisoltaId().getDtChiusura() != null) {
                this.setDtChiusura(new Timestamp(entity.getVrsVSessioneAggRisoltaId().getDtChiusura().getTime()));
            }
