...
public class MonVLisDocNonVersIamTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_ID_DOC_NON_VERS, new ColumnDescriptor(COL_ID_DOC_NON_VERS, Types.DECIMAL, 22, true));
        ...
        map.put(COL_FL_DIVERSI_ERR, new ColumnDescriptor(COL_FL_DIVERSI_ERR, Types.VARCHAR, 2, true));
