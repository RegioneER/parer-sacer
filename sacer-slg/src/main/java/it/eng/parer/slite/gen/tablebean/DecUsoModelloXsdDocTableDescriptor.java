 ...
 * @author Sloth
 *
 *         Bean per la tabella Dec_Uso_Modello_Xsd_Doc
 *
 */
public class DecUsoModelloXsdDocTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Dec_Uso_Modello_Xsd_Doc /**/";
    public static final String TABLE_NAME = "Dec_Uso_Modello_Xsd_Doc";
    public static final String COL_ID_USO_MODELLO_XSD_UNI_DOC = "id_uso_modello_xsd_doc";
	...
	map.put(COL_ID_MODELLO_XSD_UNI_DOC,
		new ColumnDescriptor(COL_ID_MODELLO_XSD_UNI_DOC, Types.DECIMAL, 22, false));
