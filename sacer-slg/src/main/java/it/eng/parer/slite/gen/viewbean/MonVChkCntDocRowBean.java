 ...
 *
 */
public class MonVChkCntDocRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public void setFlDocCorr(String fl_doc_corr) {
        setObject("fl_doc_corr", fl_doc_corr);
    }
    ...
    public void setFlDocAttesaMemCorr(String fl_doc_attesa_mem_corr) {
        setObject("fl_doc_attesa_mem_corr", fl_doc_attesa_mem_corr);
    }
    ...
    public void setFlDocAttesaSchedCorr(String fl_doc_attesa_sched_corr) {
        setObject("fl_doc_attesa_sched_corr", fl_doc_attesa_sched_corr);
    }
    ...
    public void setFlDocNoselSchedCorr(String fl_doc_nosel_sched_corr) {
        setObject("fl_doc_nosel_sched_corr", fl_doc_nosel_sched_corr);
    }
    ...
    public void setNiDocCorr(BigDecimal ni_doc_corr) {
        setObject("ni_doc_corr", ni_doc_corr);
    }
    ...
    public void setNiDocAttesaMemCorr(BigDecimal ni_doc_attesa_mem_corr) {
        setObject("ni_doc_attesa_mem_corr", ni_doc_attesa_mem_corr);
    }
    ...
    public void setNiDocAttesaSchedCorr(BigDecimal ni_doc_attesa_sched_corr) {
        setObject("ni_doc_attesa_sched_corr", ni_doc_attesa_sched_corr);
    }
    ...
    public void setNiDocNoselSchedCorr(BigDecimal ni_doc_nosel_sched_corr) {
        setObject("ni_doc_nosel_sched_corr", ni_doc_nosel_sched_corr);
    }
