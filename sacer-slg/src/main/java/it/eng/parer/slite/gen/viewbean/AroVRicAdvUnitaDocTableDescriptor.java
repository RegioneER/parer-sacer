 ...
 *
 */
public class AroVRicAdvUnitaDocTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Aro_V_Ric_Adv_Unita_Doc /**/";
    public static final String TABLE_NAME = "Aro_V_Ric_Adv_Unita_Doc";
