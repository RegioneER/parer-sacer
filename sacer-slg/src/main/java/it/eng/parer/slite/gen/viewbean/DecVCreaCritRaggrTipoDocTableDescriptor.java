 ...
 * @author Sloth
 *
 *         Bean per la tabella Dec_V_Crea_Crit_Raggr_Tipo_Doc
 *
 */
public class DecVCreaCritRaggrTipoDocTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Dec_V_Crea_Crit_Raggr_Tipo_Doc /**/";
    public static final String TABLE_NAME = "Dec_V_Crea_Crit_Raggr_Tipo_Doc";
    ...
    static {
        ...
        map.put(COL_DS_CRITERIO_RAGGR, new ColumnDescriptor(COL_DS_CRITERIO_RAGGR, Types.VARCHAR, 377, true));
