...
public class SerVRicConsistSerieUdTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_NI_LACUNE_MANCANTI, new ColumnDescriptor(COL_NI_LACUNE_MANCANTI, Types.DECIMAL, 22, true));
        map.put(COL_NI_LACUNE_NON_PRODOTTE, new ColumnDescriptor(COL_NI_LACUNE_NON_PRODOTTE, Types.DECIMAL, 22, true));
        map.put(COL_DT_COMUNIC_CONSIST_VER_SERIE,
                new ColumnDescriptor(COL_DT_COMUNIC_CONSIST_VER_SERIE, Types.TIMESTAMP, 7, true));
        map.put(COL_FL_PRESENZA_CONTEN_EFF, new ColumnDescriptor(COL_FL_PRESENZA_CONTEN_EFF, Types.VARCHAR, 1, true));
    }
