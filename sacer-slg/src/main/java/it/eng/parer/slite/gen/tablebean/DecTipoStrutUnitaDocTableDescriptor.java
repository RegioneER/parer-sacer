...
public class DecTipoStrutUnitaDocTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_NUMERO_TIPO_STRUT_UNITA_DOC,
                new ColumnDescriptor(COL_DS_NUMERO_TIPO_STRUT_UNITA_DOC, Types.VARCHAR, 1024, false));
        ...
        map.put(COL_DS_COLLEGAMENTI_UD, new ColumnDescriptor(COL_DS_COLLEGAMENTI_UD, Types.VARCHAR, 1024, false));
        map.put(COL_DS_PERIODICITA_VERS, new ColumnDescriptor(COL_DS_PERIODICITA_VERS, Types.VARCHAR, 1024, false));
