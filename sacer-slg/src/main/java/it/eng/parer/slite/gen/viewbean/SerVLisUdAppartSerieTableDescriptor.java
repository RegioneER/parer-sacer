...
public class SerVLisUdAppartSerieTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_FL_PRESENTE_CONTENUTO_1, new ColumnDescriptor(COL_FL_PRESENTE_CONTENUTO_1, Types.VARCHAR, 1, true));
        map.put(COL_FL_PRESENTE_CONTENUTO_2, new ColumnDescriptor(COL_FL_PRESENTE_CONTENUTO_2, Types.VARCHAR, 1, true));
