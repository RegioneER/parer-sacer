 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Doc_Vers
 *
 */
public class MonVLisDocVersTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Doc_Vers /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Doc_Vers";
