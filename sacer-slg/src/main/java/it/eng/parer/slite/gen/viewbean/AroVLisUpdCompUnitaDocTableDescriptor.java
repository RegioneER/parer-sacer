...
public class AroVLisUpdCompUnitaDocTableDescriptor extends TableDescriptor {
    ...
    static {
        map.put(COL_ID_UPD_COMP_UNITA_DOC, new ColumnDescriptor(COL_ID_UPD_COMP_UNITA_DOC, Types.DECIMAL, 22, true));
        ...
        map.put(COL_FL_UPD_INFO_VERS, new ColumnDescriptor(COL_FL_UPD_INFO_VERS, Types.VARCHAR, 1, true));
