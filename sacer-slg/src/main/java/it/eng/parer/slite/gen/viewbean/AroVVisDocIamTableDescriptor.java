...
public class AroVVisDocIamTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_TI_STATO_ELENCO_VERS, new ColumnDescriptor(COL_TI_STATO_ELENCO_VERS, Types.VARCHAR, 20, true));
        ...
        map.put(COL_BL_XML_RICH_DOC, new ColumnDescriptor(COL_BL_XML_RICH_DOC, Types.CLOB, 4000, true));
        map.put(COL_DS_HASH_XML_RICH_DOC, new ColumnDescriptor(COL_DS_HASH_XML_RICH_DOC, Types.VARCHAR, 254, true));
        ...
        map.put(COL_DS_URN_XML_RICH_DOC, new ColumnDescriptor(COL_DS_URN_XML_RICH_DOC, Types.VARCHAR, 254, true));
        ...
        map.put(COL_BL_XML_RISP_DOC, new ColumnDescriptor(COL_BL_XML_RISP_DOC, Types.CLOB, 4000, true));
        map.put(COL_DS_HASH_XML_RISP_DOC, new ColumnDescriptor(COL_DS_HASH_XML_RISP_DOC, Types.VARCHAR, 254, true));
        ...
        map.put(COL_DS_URN_XML_RISP_DOC, new ColumnDescriptor(COL_DS_URN_XML_RISP_DOC, Types.VARCHAR, 254, true));
        ...
        map.put(COL_BL_XML_RAPP_DOC, new ColumnDescriptor(COL_BL_XML_RAPP_DOC, Types.CLOB, 4000, true));
        map.put(COL_DS_HASH_XML_RAPP_DOC, new ColumnDescriptor(COL_DS_HASH_XML_RAPP_DOC, Types.VARCHAR, 254, true));
        ...
        map.put(COL_DS_URN_XML_RAPP_DOC, new ColumnDescriptor(COL_DS_URN_XML_RAPP_DOC, Types.VARCHAR, 254, true));
