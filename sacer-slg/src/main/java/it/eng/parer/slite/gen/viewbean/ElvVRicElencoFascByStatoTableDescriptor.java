 ...
 * @author Sloth
 *
 *         Bean per la tabella Elv_V_Ric_Elenco_Fasc_By_Stato
 *
 */
public class ElvVRicElencoFascByStatoTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Elv_V_Ric_Elenco_Fasc_By_Stato /**/";
    public static final String TABLE_NAME = "Elv_V_Ric_Elenco_Fasc_By_Stato";
    ...
    public static final String COL_FL_ANNULL = "fl_annull";
    ...
    static {
        ...
        map.put(COL_TS_CREAZIONE_ELENCO,
                new ColumnDescriptor(COL_TS_CREAZIONE_ELENCO, Types.TIMESTAMP, 11, true));
        ...
        map.put(COL_NI_FASC_VERS_ELENCO,
                new ColumnDescriptor(COL_NI_FASC_VERS_ELENCO, Types.DECIMAL, 22, true));
        ...
        map.put(COL_DT_CREAZIONE_ELENCO_IX_AIP,
                new ColumnDescriptor(COL_DT_CREAZIONE_ELENCO_IX_AIP, Types.TIMESTAMP, 11, true));
        map.put(COL_FL_ANNULL, new ColumnDescriptor(COL_FL_ANNULL, Types.VARCHAR, 1, true));
    }
