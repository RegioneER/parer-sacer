...
public class DecCampoInpUdTableDescriptor extends TableDescriptor {
    ...
    static {
        map.put(COL_ID_CAMPO_INP_UD,
                new ColumnDescriptor(COL_ID_CAMPO_INP_UD, Types.DECIMAL, 22, true));
        ...
        map.put(COL_TI_TRASFORM_CAMPO,
                new ColumnDescriptor(COL_TI_TRASFORM_CAMPO, Types.VARCHAR, 20, false));
