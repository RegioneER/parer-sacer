 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Ses_Recup
 *
 */
public class MonVLisSesRecupTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Ses_Recup /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Ses_Recup";
    public static final String COL_ID_SESSIONE_RECUP = "id_sessione_recup";
    public static final String COL_TI_SESSIONE = "ti_sessione";
    public static final String COL_TI_OUTPUT_RECUP = "ti_output_recup";
    ...
    public static final String COL_ID_USER_CORR = "id_user_corr";
    ...
    public static final String COL_DS_URN_RICH = "ds_urn_rich";
    ...
    static {
        ...
        map.put(COL_TI_SESSIONE, new ColumnDescriptor(COL_TI_SESSIONE, Types.VARCHAR, 20, true));
        map.put(COL_TI_OUTPUT_RECUP,
                new ColumnDescriptor(COL_TI_OUTPUT_RECUP, Types.VARCHAR, 20, true));
        ...
        map.put(COL_TI_STATO, new ColumnDescriptor(COL_TI_STATO, Types.VARCHAR, 20, true));
        map.put(COL_DS_MSG_ERR, new ColumnDescriptor(COL_DS_MSG_ERR, Types.VARCHAR, 1127, true));
        map.put(COL_ID_USER_CORR, new ColumnDescriptor(COL_ID_USER_CORR, Types.DECIMAL, 22, true));
        ...
        map.put(COL_DS_URN_RICH, new ColumnDescriptor(COL_DS_URN_RICH, Types.VARCHAR, 143, true));
