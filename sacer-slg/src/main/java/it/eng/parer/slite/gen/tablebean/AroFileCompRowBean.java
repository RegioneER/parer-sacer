...
import it.eng.parer.entity.AroFileComp;
...
/**
 * RowBean per la tabella Aro_File_Comp
 *
 */
public class AroFileCompRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public void entityToRowBean(Object obj) {
        AroFileComp entity = (AroFileComp) obj;
        AbstractRecord ar;
        ...
        if (entity._persistence_get_aroCompDoc_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) entity._persistence_get_aroCompDoc_vh()).getRow()) != null) {
                this.setIdCompStrutDoc(new BigDecimal((Long) ar.get("ARO_FILE_COMP.ID_COMP_STRUT_DOC")));
            }
        } else {
    ...
    @Override
    public AroFileComp rowBeanToEntity() {
        AroFileComp entity = new AroFileComp();
