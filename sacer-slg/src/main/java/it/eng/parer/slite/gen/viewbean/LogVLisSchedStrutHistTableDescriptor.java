 ...
 * @author Sloth
 *
 *         Bean per la tabella Log_V_Lis_Sched_Strut_Hist
 *
 */
public class LogVLisSchedStrutHistTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Log_V_Lis_Sched_Strut /**/";
    public static final String TABLE_NAME = "Log_V_Lis_Sched_Strut";
