...
public class FasVVisFascicoloTableDescriptor extends TableDescriptor {
	...
	map.put(COL_CD_IPA_AMMIN_TITOL,
		new ColumnDescriptor(COL_CD_IPA_AMMIN_TITOL, Types.VARCHAR, 100, true));
	map.put(COL_TI_CODICE_AMMIN_TITOL,
		new ColumnDescriptor(COL_TI_CODICE_AMMIN_TITOL, Types.VARCHAR, 20, true));
	map.put(COL_DS_AMMIN_TITOL,
		new ColumnDescriptor(COL_DS_AMMIN_TITOL, Types.VARCHAR, 254, true));
	...
	map.put(COL_AA_KEY_UNITA_DOC_FIRST,
		new ColumnDescriptor(COL_AA_KEY_UNITA_DOC_FIRST, Types.DECIMAL, 22, true));
	map.put(COL_CD_KEY_UNITA_DOC_FIRST,
		new ColumnDescriptor(COL_CD_KEY_UNITA_DOC_FIRST, Types.VARCHAR, 100, true));
	map.put(COL_CD_REG_KEY_UNITA_DOC_LAST,
		new ColumnDescriptor(COL_CD_REG_KEY_UNITA_DOC_LAST, Types.VARCHAR, 100, true));
	map.put(COL_AA_KEY_UNITA_DOC_LAST,
		new ColumnDescriptor(COL_AA_KEY_UNITA_DOC_LAST, Types.DECIMAL, 22, true));
	map.put(COL_CD_KEY_UNITA_DOC_LAST,
		new ColumnDescriptor(COL_CD_KEY_UNITA_DOC_LAST, Types.VARCHAR, 100, true));
	...
	map.put(COL_CD_VERSIONE_XML_SIP,
		new ColumnDescriptor(COL_CD_VERSIONE_XML_SIP, Types.VARCHAR, 100, true));
	map.put(COL_CD_VERSIONE_XML_RAPP,
		new ColumnDescriptor(COL_CD_VERSIONE_XML_RAPP, Types.VARCHAR, 100, true));
	...
	map.put(COL_TI_MODELLO_XSD_PROFILO,
		new ColumnDescriptor(COL_TI_MODELLO_XSD_PROFILO, Types.VARCHAR, 30, true));
	...
	map.put(COL_BL_XML_VERS_SIP,
		new ColumnDescriptor(COL_BL_XML_VERS_SIP, Types.CLOB, 4000, true));
	map.put(COL_DS_HASH_XML_SIP,
		new ColumnDescriptor(COL_DS_HASH_XML_SIP, Types.VARCHAR, 254, true));
	map.put(COL_DS_ALGO_HASH_XML_SIP,
		new ColumnDescriptor(COL_DS_ALGO_HASH_XML_SIP, Types.VARCHAR, 254, true));
	map.put(COL_CD_ENCODING_HASH_XML_SIP,
		new ColumnDescriptor(COL_CD_ENCODING_HASH_XML_SIP, Types.VARCHAR, 100, true));
	map.put(COL_DS_URN_XML_SIP,
		new ColumnDescriptor(COL_DS_URN_XML_SIP, Types.VARCHAR, 254, true));
	map.put(COL_BL_XML_VERS_RAPP,
		new ColumnDescriptor(COL_BL_XML_VERS_RAPP, Types.CLOB, 4000, true));
	map.put(COL_DS_HASH_XML_RAPP,
		new ColumnDescriptor(COL_DS_HASH_XML_RAPP, Types.VARCHAR, 254, true));
	map.put(COL_DS_ALGO_HASH_XML_RAPP,
		new ColumnDescriptor(COL_DS_ALGO_HASH_XML_RAPP, Types.VARCHAR, 254, true));
	map.put(COL_CD_ENCODING_HASH_XML_RAPP,
		new ColumnDescriptor(COL_CD_ENCODING_HASH_XML_RAPP, Types.VARCHAR, 100, true));
	map.put(COL_DS_URN_XML_RAPP,
		new ColumnDescriptor(COL_DS_URN_XML_RAPP, Types.VARCHAR, 254, true));
	map.put(COL_BL_XML_VERS_PROFILO,
		new ColumnDescriptor(COL_BL_XML_VERS_PROFILO, Types.CLOB, 4000, true));
	map.put(COL_BL_XSD_VERS_PROFILO,
		new ColumnDescriptor(COL_BL_XSD_VERS_PROFILO, Types.CLOB, 4000, true));
	map.put(COL_CD_XSD_PROFILO,
		new ColumnDescriptor(COL_CD_XSD_PROFILO, Types.VARCHAR, 100, true));
	map.put(COL_DS_XSD_PROFILO,
		new ColumnDescriptor(COL_DS_XSD_PROFILO, Types.VARCHAR, 254, true));
	map.put(COL_FL_DEFAULT_PROFILO,
		new ColumnDescriptor(COL_FL_DEFAULT_PROFILO, Types.VARCHAR, 1, true));
	map.put(COL_BL_XML_SEGNATURA,
		new ColumnDescriptor(COL_BL_XML_SEGNATURA, Types.CLOB, 4000, true));
	map.put(COL_BL_XSD_SEGNATURA,
		new ColumnDescriptor(COL_BL_XSD_SEGNATURA, Types.CLOB, 4000, true));
	map.put(COL_CD_XSD_SEGNATURA,
		new ColumnDescriptor(COL_CD_XSD_SEGNATURA, Types.VARCHAR, 100, true));
	map.put(COL_DS_XSD_SEGNATURA,
		new ColumnDescriptor(COL_DS_XSD_SEGNATURA, Types.VARCHAR, 254, true));
	map.put(COL_FL_DEFAULT_SEGNATURA,
		new ColumnDescriptor(COL_FL_DEFAULT_SEGNATURA, Types.VARCHAR, 1, true));
	map.put(COL_BL_XML_NORMATIVO,
		new ColumnDescriptor(COL_BL_XML_NORMATIVO, Types.CLOB, 4000, true));
	map.put(COL_BL_XSD_NORMATIVO,
		new ColumnDescriptor(COL_BL_XSD_NORMATIVO, Types.CLOB, 4000, true));
	map.put(COL_CD_XSD_NORMATIVO,
		new ColumnDescriptor(COL_CD_XSD_NORMATIVO, Types.VARCHAR, 100, true));
	map.put(COL_DS_XSD_NORMATIVO,
		new ColumnDescriptor(COL_DS_XSD_NORMATIVO, Types.VARCHAR, 254, true));
	map.put(COL_FL_DEFAULT_NORMATIVO,
		new ColumnDescriptor(COL_FL_DEFAULT_NORMATIVO, Types.VARCHAR, 1, true));
	map.put(COL_BL_XML_SPECIFICO,
		new ColumnDescriptor(COL_BL_XML_SPECIFICO, Types.CLOB, 4000, true));
	map.put(COL_ID_MODELLO_XSD_PROFILO,
		new ColumnDescriptor(COL_ID_MODELLO_XSD_PROFILO, Types.DECIMAL, 22, true));
	...
	map.put(COL_BL_XSD_SPECIFICO,
		new ColumnDescriptor(COL_BL_XSD_SPECIFICO, Types.CLOB, 4000, true));
	map.put(COL_CD_XSD_SPECIFICO,
		new ColumnDescriptor(COL_CD_XSD_SPECIFICO, Types.VARCHAR, 100, true));
	map.put(COL_DS_XSD_SPECIFICO,
		new ColumnDescriptor(COL_DS_XSD_SPECIFICO, Types.VARCHAR, 254, true));
	map.put(COL_FL_DEFAULT_SPECIFICO,
		new ColumnDescriptor(COL_FL_DEFAULT_SPECIFICO, Types.VARCHAR, 1, true));
	map.put(COL_CD_INDICE_CLASSIF,
		new ColumnDescriptor(COL_CD_INDICE_CLASSIF, Types.VARCHAR, 100, true));
	map.put(COL_DS_INDICE_CLASSIF,
		new ColumnDescriptor(COL_DS_INDICE_CLASSIF, Types.VARCHAR, 254, true));
	map.put(COL_DS_INFO_CONSERVAZIONE,
		new ColumnDescriptor(COL_DS_INFO_CONSERVAZIONE, Types.VARCHAR, 1024, false));
    }
