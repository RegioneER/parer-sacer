 ...
 * @author Sloth
 *
 *         Bean per la tabella Log_V_Lis_Sched_Hist
 *
 */
public class LogVLisSchedHistTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Log_V_Lis_Sched /**/";
    public static final String TABLE_NAME = "Log_V_Lis_Sched";
