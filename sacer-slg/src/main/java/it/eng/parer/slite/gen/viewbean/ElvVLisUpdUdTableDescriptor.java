...
import static it.eng.parer.slite.gen.tablebean.AroUpdUnitaDocTableDescriptor.COL_TS_INI_SES;
...
public class ElvVLisUpdUdTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_URN_UPD_UNITA_DOC, new ColumnDescriptor(COL_DS_URN_UPD_UNITA_DOC, Types.VARCHAR, 283, true));
    }
