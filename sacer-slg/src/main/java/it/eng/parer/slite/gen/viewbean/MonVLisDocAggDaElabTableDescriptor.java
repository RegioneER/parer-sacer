 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Doc_Agg_Da_Elab
 *
 */
public class MonVLisDocAggDaElabTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Doc_Agg_Da_Elab /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Doc_Agg_Da_Elab";
