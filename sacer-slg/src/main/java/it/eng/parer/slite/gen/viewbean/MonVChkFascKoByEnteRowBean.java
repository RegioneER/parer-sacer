...
import it.eng.parer.viewEntity.MonVChkFascKoByEnteId;
 ...
 *
 */
public class MonVChkFascKoByEnteRowBean extends BaseRow implements JEEBaseRowInterface {
    ...
    public void entityToRowBean(Object obj) {
        ...
        if (entity.getMonVChkFascKoByEnteId() != null) {
            this.setIdEnte(entity.getMonVChkFascKoByEnteId().getIdEnte());
            this.setIdUserIam(entity.getMonVChkFascKoByEnteId().getIdUserIam());
        }
    ...
    public MonVChkFascKoByEnte rowBeanToEntity() {
        ...
        entity.setMonVChkFascKoByEnteId(new MonVChkFascKoByEnteId());
        entity.getMonVChkFascKoByEnteId().setIdEnte(this.getIdEnte());
        entity.getMonVChkFascKoByEnteId().setIdUserIam(this.getIdUserIam());
