...
public class MonVVisUpdUdKoTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_TI_STATO_SES_UPD_KO, new ColumnDescriptor(COL_TI_STATO_SES_UPD_KO, Types.VARCHAR, 20, true));
        ...
        map.put(COL_ID_XML_SES_UPD_KO_RICH, new ColumnDescriptor(COL_ID_XML_SES_UPD_KO_RICH, Types.DECIMAL, 22, true));
        map.put(COL_BL_XML_RICH, new ColumnDescriptor(COL_BL_XML_RICH, Types.CLOB, 4000, true));
        map.put(COL_ID_XML_SES_UPD_KO_RISP, new ColumnDescriptor(COL_ID_XML_SES_UPD_KO_RISP, Types.DECIMAL, 22, true));
