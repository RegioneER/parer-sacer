 ...
 * @author Sloth
 *
 *         Bean per la tabella Aro_V_Lis_Vol_No_Val_Doc
 *
 */
public class AroVLisVolNoValDocTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Aro_V_Lis_Vol_No_Val_Doc /**/";
    public static final String TABLE_NAME = "Aro_V_Lis_Vol_No_Val_Doc";
