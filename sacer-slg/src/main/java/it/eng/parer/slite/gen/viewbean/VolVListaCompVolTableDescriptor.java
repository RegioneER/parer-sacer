 ...
 * @author Sloth
 *
 *         Bean per la tabella Vol_V_Lista_Comp_Vol
 *
 */
public class VolVListaCompVolTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Vol_V_Lista_Comp_Vol /**/";
    public static final String TABLE_NAME = "Vol_V_Lista_Comp_Vol";
