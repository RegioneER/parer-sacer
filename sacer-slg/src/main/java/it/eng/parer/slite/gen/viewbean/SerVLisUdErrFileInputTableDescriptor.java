 ...
 * @author Sloth
 *
 *         Bean per la tabella Ser_V_Lis_Ud_Err_File_Input
 *
 */
public class SerVLisUdErrFileInputTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Ser_V_Lis_Ud_Err_File_Input /**/";
    public static final String TABLE_NAME = "Ser_V_Lis_Ud_Err_File_Input";
    public static final String COL_ID_UD_ERR_FILE_INPUT = "id_ud_err_file_input";
    ...
    static {
        map.put(COL_ID_UD_ERR_FILE_INPUT, new ColumnDescriptor(COL_ID_UD_ERR_FILE_INPUT, Types.DECIMAL, 22, true));
