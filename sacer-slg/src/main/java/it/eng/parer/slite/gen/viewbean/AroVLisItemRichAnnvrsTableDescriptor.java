 ...
 * @author Sloth
 *
 *         Bean per la tabella Aro_V_Lis_Item_Rich_Annvrs
 *
 */
public class AroVLisItemRichAnnvrsTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Aro_V_Lis_Item_Rich_Annvrs /**/";
    public static final String TABLE_NAME = "Aro_V_Lis_Item_Rich_Annvrs";
    ...
    public static final String COL_PG_ITEM_RICH_ANNUL_VERS = "pg_item_rich_annul_vers";
    public static final String COL_DS_KEY_ITEM = "ds_key_item";
    public static final String COL_TI_STATO_ITEM = "ti_stato_item";
    ...
    public static final String COL_TI_ITEM_RICH_ANNUL_VERS = "ti_item_rich_annul_vers";
    ...
    static {
        ...
        map.put(COL_TI_STATO_ITEM, new ColumnDescriptor(COL_TI_STATO_ITEM, Types.VARCHAR, 30, true));
        ...
        map.put(COL_DS_LISTA_ERR, new ColumnDescriptor(COL_DS_LISTA_ERR, Types.VARCHAR, 4000, true));
