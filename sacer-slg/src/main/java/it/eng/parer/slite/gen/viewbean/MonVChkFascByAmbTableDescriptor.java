 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Chk_Fasc_By_Amb
 *
 */
public class MonVChkFascByAmbTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Chk_Fasc_By_Amb /**/";
    public static final String TABLE_NAME = "Mon_V_Chk_Fasc_By_Amb";
