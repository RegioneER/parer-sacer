 ...
 * @author Sloth
 *
 *         Bean per la tabella Aro_V_Ric_Comp
 *
 */
public class AroVRicCompTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Aro_V_Ric_Comp /**/";
    public static final String TABLE_NAME = "Aro_V_Ric_Comp";
    ...
    public static final String COL_FL_RIF_TEMP_VERS = "fl_rif_temp_vers";
    ...
    static {
        ...
        map.put(COL_DS_URN_COMP_CALC_SHORT, new ColumnDescriptor(COL_DS_URN_COMP_CALC_SHORT, Types.VARCHAR, 386, true));
        ...
        map.put(COL_FL_RIF_TEMP_VERS, new ColumnDescriptor(COL_FL_RIF_TEMP_VERS, Types.VARCHAR, 1, true));
        ...
        map.put(COL_ID_STRUT_TIPO_STRUT, new ColumnDescriptor(COL_ID_STRUT_TIPO_STRUT, Types.DECIMAL, 22, true));
