 ...
 * @author Sloth
 *
 *         Bean per la tabella Dec_V_Crea_Crit_Raggr_Registro
 *
 */
public class DecVCreaCritRaggrRegistroTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Dec_V_Crea_Crit_Raggr_Registro /**/";
    public static final String TABLE_NAME = "Dec_V_Crea_Crit_Raggr_Registro";
    ...
    static {
        ...
        map.put(COL_NM_CRITERIO_RAGGR, new ColumnDescriptor(COL_NM_CRITERIO_RAGGR, Types.VARCHAR, 233, true));
        map.put(COL_DS_CRITERIO_RAGGR, new ColumnDescriptor(COL_DS_CRITERIO_RAGGR, Types.VARCHAR, 382, true));
        map.put(COL_NI_MAX_COMP, new ColumnDescriptor(COL_NI_MAX_COMP, Types.DECIMAL, 22, true));
        map.put(COL_TI_TEMPO_SCAD_CHIUS, new ColumnDescriptor(COL_TI_TEMPO_SCAD_CHIUS, Types.VARCHAR, 6, true));
        ...
        map.put(COL_FL_FILTRO_REGISTRO_KEY, new ColumnDescriptor(COL_FL_FILTRO_REGISTRO_KEY, Types.VARCHAR, 1, true));
        ...
        map.put(COL_FL_FILTRO_TIPO_DOC, new ColumnDescriptor(COL_FL_FILTRO_TIPO_DOC, Types.VARCHAR, 1, true));
        map.put(COL_FL_FILTRO_SISTEMA_MIGRAZ,
                new ColumnDescriptor(COL_FL_FILTRO_SISTEMA_MIGRAZ, Types.VARCHAR, 1, true));
        map.put(COL_TI_VALID_ELENCO, new ColumnDescriptor(COL_TI_VALID_ELENCO, Types.VARCHAR, 8, true));
        map.put(COL_TI_MOD_VALID_ELENCO, new ColumnDescriptor(COL_TI_MOD_VALID_ELENCO, Types.VARCHAR, 10, true));
    }
