...
public class SerVVisConsistSerieUdTableDescriptor extends TableDescriptor {
	...
	map.put(COL_CD_REGISTRO_FIRST,
		new ColumnDescriptor(COL_CD_REGISTRO_FIRST, Types.VARCHAR, 100, true));
	map.put(COL_AA_UNITA_DOC_FIRST,
		new ColumnDescriptor(COL_AA_UNITA_DOC_FIRST, Types.DECIMAL, 22, true));
	map.put(COL_CD_UNITA_DOC_FIRST,
		new ColumnDescriptor(COL_CD_UNITA_DOC_FIRST, Types.VARCHAR, 100, true));
	map.put(COL_CD_REGISTRO_LAST,
		new ColumnDescriptor(COL_CD_REGISTRO_LAST, Types.VARCHAR, 100, true));
	map.put(COL_AA_UNITA_DOC_LAST,
		new ColumnDescriptor(COL_AA_UNITA_DOC_LAST, Types.DECIMAL, 22, true));
	map.put(COL_CD_UNITA_DOC_LAST,
		new ColumnDescriptor(COL_CD_UNITA_DOC_LAST, Types.VARCHAR, 100, true));
	map.put(COL_ID_LACUNA_MANCANTI,
		new ColumnDescriptor(COL_ID_LACUNA_MANCANTI, Types.DECIMAL, 22, true));
	map.put(COL_DL_LACUNA_MANCANTI,
		new ColumnDescriptor(COL_DL_LACUNA_MANCANTI, Types.VARCHAR, 1024, true));
	map.put(COL_DL_NOTA_LACUNA_MANCANTI,
		new ColumnDescriptor(COL_DL_NOTA_LACUNA_MANCANTI, Types.VARCHAR, 1024, true));
	map.put(COL_ID_LACUNA_NON_PRODOTTE,
		new ColumnDescriptor(COL_ID_LACUNA_NON_PRODOTTE, Types.DECIMAL, 22, true));
