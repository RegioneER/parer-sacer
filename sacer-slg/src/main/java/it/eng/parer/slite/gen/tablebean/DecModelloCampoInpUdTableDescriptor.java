 ...
 * @author Sloth
 *
 *         Bean per la tabella Dec_Modello_Campo_Inp_Ud
 *
 */
public class DecModelloCampoInpUdTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Dec_Modello_Campo_Inp_Ud /**/";
    public static final String TABLE_NAME = "Dec_Modello_Campo_Inp_Ud";
    public static final String COL_ID_MODELLO_CAMPO_INP_UD = "id_modello_campo_inp_ud";
