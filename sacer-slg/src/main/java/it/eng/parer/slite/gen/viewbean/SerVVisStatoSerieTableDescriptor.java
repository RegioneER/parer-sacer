...
public class SerVVisStatoSerieTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_ID_STATO_VER_SERIE, new ColumnDescriptor(COL_ID_STATO_VER_SERIE, Types.DECIMAL, 22, true));
        map.put(COL_PG_STATO_VER_SERIE, new ColumnDescriptor(COL_PG_STATO_VER_SERIE, Types.DECIMAL, 22, true));
