...
public class DecModelloTipoSerieTableDescriptor extends TableDescriptor {
	...
	map.put(COL_NM_MODELLO_TIPO_SERIE,
		new ColumnDescriptor(COL_NM_MODELLO_TIPO_SERIE, Types.VARCHAR, 100, false));
	map.put(COL_DS_MODELLO_TIPO_SERIE,
		new ColumnDescriptor(COL_DS_MODELLO_TIPO_SERIE, Types.VARCHAR, 254, false));
	map.put(COL_TI_RGL_NM_TIPO_SERIE,
		new ColumnDescriptor(COL_TI_RGL_NM_TIPO_SERIE, Types.VARCHAR, 30, false));
	map.put(COL_NM_TIPO_SERIE_DA_CREARE,
		new ColumnDescriptor(COL_NM_TIPO_SERIE_DA_CREARE, Types.VARCHAR, 100, false));
	map.put(COL_TI_RGL_DS_TIPO_SERIE,
		new ColumnDescriptor(COL_TI_RGL_DS_TIPO_SERIE, Types.VARCHAR, 30, false));
	map.put(COL_DS_TIPO_SERIE_DA_CREARE,
		new ColumnDescriptor(COL_DS_TIPO_SERIE_DA_CREARE, Types.VARCHAR, 100, false));
	map.put(COL_TI_RGL_CD_SERIE,
		new ColumnDescriptor(COL_TI_RGL_CD_SERIE, Types.VARCHAR, 30, false));
	map.put(COL_CD_SERIE_DA_CREARE,
		new ColumnDescriptor(COL_CD_SERIE_DA_CREARE, Types.VARCHAR, 100, false));
	map.put(COL_TI_RGL_DS_SERIE,
		new ColumnDescriptor(COL_TI_RGL_DS_SERIE, Types.VARCHAR, 30, false));
	map.put(COL_DS_SERIE_DA_CREARE,
		new ColumnDescriptor(COL_DS_SERIE_DA_CREARE, Types.VARCHAR, 100, false));
	map.put(COL_TI_RGL_ANNI_CONSERV,
		new ColumnDescriptor(COL_TI_RGL_ANNI_CONSERV, Types.VARCHAR, 30, false));
	...
	map.put(COL_TI_RGL_FILTRO_TI_DOC,
		new ColumnDescriptor(COL_TI_RGL_FILTRO_TI_DOC, Types.VARCHAR, 30, false));
	...
	map.put(COL_TI_CONSERVAZIONE_SERIE,
		new ColumnDescriptor(COL_TI_CONSERVAZIONE_SERIE, Types.VARCHAR, 30, false));
	...
	map.put(COL_ID_TIPO_DOC_DATI_SPEC,
		new ColumnDescriptor(COL_ID_TIPO_DOC_DATI_SPEC, Types.DECIMAL, 22, false));
