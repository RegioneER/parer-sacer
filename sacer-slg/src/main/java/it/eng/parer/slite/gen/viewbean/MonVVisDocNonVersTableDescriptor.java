 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Vis_Doc_Non_Vers
 *
 */
public class MonVVisDocNonVersTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Vis_Doc_Non_Vers /**/";
    public static final String TABLE_NAME = "Mon_V_Vis_Doc_Non_Vers";
    ...
    static {
        ...
        map.put(COL_NM_AMBIENTE, new ColumnDescriptor(COL_NM_AMBIENTE, Types.DECIMAL, 22, true));
        ...
        map.put(COL_ID_STRUT, new ColumnDescriptor(COL_ID_STRUT, Types.VARCHAR, 100, true));
