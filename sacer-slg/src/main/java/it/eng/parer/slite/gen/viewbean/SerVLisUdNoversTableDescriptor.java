...
public class SerVLisUdNoversTableDescriptor extends TableDescriptor {
     ...
     * comments = "This class was generated by OraTool", date = "Tuesday, 4 August 2015 11:30" )
     */
    ...
    static {
        map.put(COL_ID_UD_NON_VERS_ERR,
                new ColumnDescriptor(COL_ID_UD_NON_VERS_ERR, Types.DECIMAL, 22, true));
        map.put(COL_ID_ERR_CONTENUTO_VER_SERIE,
                new ColumnDescriptor(COL_ID_ERR_CONTENUTO_VER_SERIE, Types.DECIMAL, 22, true));
        map.put(COL_ID_UNITA_DOC_NON_VERS,
                new ColumnDescriptor(COL_ID_UNITA_DOC_NON_VERS, Types.DECIMAL, 22, true));
