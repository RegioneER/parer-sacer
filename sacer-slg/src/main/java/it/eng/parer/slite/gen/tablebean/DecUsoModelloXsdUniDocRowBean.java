 ...
 *
 */
public class DecUsoModelloXsdUniDocRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public void entityToRowBean(Object obj) {
        ...
        if (entity._persistence_get_decTipoUnitaDoc_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) entity._persistence_get_decTipoUnitaDoc_vh()).getRow()) != null) {
                this.setIdTipoUnitaDoc(new BigDecimal((Long) ar.get("DEC_USO_MODELLO_XSD_UNI_DOC.ID_TIPO_UNITA_DOC")));
            }
        } else {
        ...
        if (entity._persistence_get_decModelloXsdUd_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) entity._persistence_get_decModelloXsdUd_vh()).getRow()) != null) {
                this.setIdModelloXsdUd(new BigDecimal((Long) ar.get("DEC_USO_MODELLO_XSD_UNI_DOC.ID_MODELLO_XSD_UD")));
            }
        } else {
        ...
        if (modelloXsdUd._persistence_get_aplSistemaMigraz_vh() instanceof DatabaseValueHolder) {
            if ((ar = ((DatabaseValueHolder) modelloXsdUd._persistence_get_aplSistemaMigraz_vh()).getRow()) != null) {
                this.setIdSistemaMigraz(new BigDecimal((Long) ar.get("DEC_MODELLO_XSD_UD.ID_SISTEMA_MIGRAZ")));
            }
        } else {
