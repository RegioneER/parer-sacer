 ...
 * @author Sloth
 *
 *         Bean per la tabella Ser_V_Vis_Err_Conten_Serie_Ud
 *
 */
public class SerVVisErrContenSerieUdTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Ser_V_Vis_Err_Conten_Serie_Ud /**/";
    public static final String TABLE_NAME = "Ser_V_Vis_Err_Conten_Serie_Ud";
    ...
    static {
        ...
        map.put(COL_TI_STATO_SERIE_COR, new ColumnDescriptor(COL_TI_STATO_SERIE_COR, Types.VARCHAR, 20, true));
