...
public class AroFileVerIndiceAipUdTableDescriptor extends TableDescriptor {
    ...
    static {
	map.put(COL_ID_FILE_VER_INDICE_AIP,
		new ColumnDescriptor(COL_ID_FILE_VER_INDICE_AIP, Types.DECIMAL, 22, true));
	map.put(COL_ID_VER_INDICE_AIP,
		new ColumnDescriptor(COL_ID_VER_INDICE_AIP, Types.DECIMAL, 22, false));
	map.put(COL_BL_FILE_VER_INDICE_AIP,
		new ColumnDescriptor(COL_BL_FILE_VER_INDICE_AIP, Types.CLOB, 4000, false));
