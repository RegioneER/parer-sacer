 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Upd_Ud_Da_Elab
 *
 */
public class MonVLisUpdUdDaElabTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Upd_Ud_Da_Elab /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Upd_Ud_Da_Elab";
    ...
    static {
        ...
        map.put(COL_TS_INI_SES, new ColumnDescriptor(COL_TS_INI_SES, Types.TIMESTAMP, 7, true));
        ...
        map.put(COL_FL_SES_UPD_KO_RISOLTI,
                new ColumnDescriptor(COL_FL_SES_UPD_KO_RISOLTI, Types.VARCHAR, 1, true));
