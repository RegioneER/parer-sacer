...
import it.eng.parer.viewEntity.ElvVListaCompElvId;
 ...
 *
 */
public class ElvVListaCompElvRowBean extends BaseRow implements JEEBaseRowInterface {
    ...
    public void entityToRowBean(Object obj) {
        ...
        if (entity.getElvVListaCompElvId() != null) {
            this.setIdFirmaComp(entity.getElvVListaCompElvId().getIdFirmaComp());
            this.setIdCompDoc(entity.getElvVListaCompElvId().getIdCompDoc());
        }
    ...
    public ElvVListaCompElv rowBeanToEntity() {
        ...
        entity.setElvVListaCompElvId(new ElvVListaCompElvId());
        entity.getElvVListaCompElvId().setIdCompDoc(this.getIdCompDoc());
        entity.getElvVListaCompElvId().setIdFirmaComp(this.getIdFirmaComp());
